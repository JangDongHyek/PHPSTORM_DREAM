...
if($order_tot > 0){
	...
	$heemang_deli = $order_row[heemang_deli];	
	$ment = $order_row[ment];
...
<script language='javascript'>
	_AceTM.Buy.bItem.push({
		pCode:'<?=$item_no_forcash?>',
		pName:'<?=$item_name?>',
		pQuantity:'<?=$quantity?>',
		pPrice:'<?=$sum_str?>'.replace(/[^0-9-]/g,''),
		oCode:'',
		oName:''
	});
</script>
...
?>                        
                        ...
                        <tr>
                          ...
                          <td>[
     						...
     						<tr>
                          <td bgcolor="#F7F7F7" class="text_14_s2"><img src="../image/icon_4.gif" align="absmiddle"> 전달메세지</td>
                          <td bgcolor="#FFFFFF">
						 ...
						 <tr>
                          <td bgcolor="#F7F7F7" class="text_14_s2"><img src="../image/icon_4.gif" align="absmiddle"> 희망배송일</td>
                          <td bgcolor="#FFFFFF">
							<?=$hope_date?>
