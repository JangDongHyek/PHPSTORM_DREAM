...
$memo = iconv("euckr", "utf8", "결제신청");

$home_dir = getenv("HTTP_HOST");
if($home_dir == "www.letsit.kr"){
	$home_dir .= "/~".$mart_id;
}

$feedbackurl = "http://".$home_dir."/market/cart/payapp_response2.php";
$returnurl = "http://".$home_dir."/market/cart/order_ok_new_payapp2.php?order_num=$order_num";
