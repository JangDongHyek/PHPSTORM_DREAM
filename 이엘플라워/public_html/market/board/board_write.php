...
<table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
						  <td height="30" align="center"  style="font-size:17px ;color:#111111; font-weight:bold; line-height:18px;">개인정보수집동의</td>
						</tr>
						  ...
						  <tr>
							<td>
								<table width="100%"  border="0" cellspacing="0" cellpadding="10">
									<tr>
										<td><div style="width:600px; border:1px solid #E1E1E1; border-radius:12px; padding:16px; line-height:2em; ">
                                          <p><strong>■ 개인정보의 수집·이용 목적</strong>
<br>서비스 제공 및 계약의 이행, 구매 및 대금결제, 물품배송 또는 청구지 발송, 회원관리 등을 위한 목적
<p><strong>■ 수집하려는 개인정보의 항목</strong>
<br>
이름, 주소, 연락처, 이메일 등
<p><strong>■ 개인정보의 보유 및 이용 기간</strong>
<br>회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외없이 해당정보를 파기합니다. 
<br>
                                          </div></td>
									</tr>
								</table>							
...
?>
						<tr>
							...
							<textarea name="content" id="content" rows="10" cols="100" style="width:667px; height:412px; display:none;"><?=$content?></textarea>
		...
		//ed.init(); //웹에디터 삽입
						...
						<tr>
						  <td height="50" align="center"><input type='image' onfocus='blur();' src="../image/helpdesk/bu_writeok.gif" border="0">&nbsp; 
							...
							<? if($_SESSION["MemberLevel"] == 1){  //입점몰?>

							<a href="board_list.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>"><img src="../image/helpdesk/bu_list2.gif" border="0" alt="목록"></a>
							<? }?>
							</td>
						</tr>
					</table>
...
#######################################################################
	...
	if($bbs_no==4||$bbs_no==5){
		echo "<script>
				alert('고객님의 문의 사항이 관리자에게 전달되었습니다.');
				location.href='../main/';
			</script>";
			exit;
