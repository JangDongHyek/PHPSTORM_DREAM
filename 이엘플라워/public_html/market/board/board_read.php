...
$encode_target = "$upload".("$userfile");
$encode_target1 = "$upload".("$userfile1");
//========================= userfile =====================================================
...
if( $board_class == 1 || $board_class == 3 ){ //자신의 글 수정,삭제는 본인,관리자만
	if( $username == "$UnameSess" || ($Mall_Admin_ID&&$MemberLevel==1)){
		...
		$mod_perm = "<img src='../image/helpdesk/bu_modify.gif'  border='0'>";
		$del_perm = "<img src='../image/helpdesk/bu_delete.gif'  border='0'>";
	}
}else{
	$mod_perm = "<a href='board_edit.php?mart_id=$mart_id&index_no=$index_no&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'><img src='../image/helpdesk/bu_modify.gif'  border='0'></a>";
            ...
            <td width="100%">
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="center" background="../image/helpdesk/table1_bg.gif"><span class="sitemap1">선택한 게시물</span>은 <span class="sitemap">비밀글</span>입니다.</td>
						...
						<table width="100%"  border="0" cellspacing="0" cellpadding="0">
							<tr>
							  <td  align="center">
								<input type='image' onfocus='blur();' src="../image/helpdesk/bu_ok.gif"  align="absmiddle" border="0">&nbsp;<a href="board_list.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>"><img src="../image/helpdesk/bu_list.gif" border="0"></a>								</td>
							</tr>
						</table>
						<!--버튼 End -->
...
?>
					...
					<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="../image/helpdesk/table1_bg.gif"> &nbsp;&nbsp;<b><?=$subject_new?></b></td>
							<td width="10"><img src="../image/helpdesk/table1_right.gif"></td>
						</tr>
</table>

					<table width="100%" align="center"  border="0" cellspacing="1" cellpadding="0" style="border-left:1px solid #e1e1e1;border-right:1px solid #e1e1e1">
						<tr>
...
?>
					...
					<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #e1e1e1">
						<tr>
							<td>&nbsp;</td>
						</tr>
<?
...
?>
						<tr>
							<td align="center"><a href='#1' onClick="window.open('big.html?file=<?=$userfile?>&mart_id=<?=$mart_id?>','원본사진보기','width=<?=$img_width?>,height=<?=$img_height?>,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no')" onFocus='blur();'><?=$img_file?></a></td>
						</tr>
<?
	}
?>
...
?>
						...
						<tr>
							<td align="center"><a href='#1' onClick="window.open('big.html?file=<?=$userfile1?>&mart_id=<?=$mart_id?>','원본사진보기','width=<?=$img_width1?>,height=<?=$img_height1?>,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no')" onFocus='blur();'><?=$img_file1?></a></td>
						</tr>
<?
	}
?>
						<tr>
							<td>
								<table width="100%"  border="0" cellspacing="0" cellpadding="10">
									<tr>
										<td valign="top" style="padding-left:10px;padding-right:10px"><p align='justify'><?=$content?></p></td>
									</tr>
								</table>
						  </td>
						</tr>
...
?>
					<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="50">
								<?=$mod_perm?>&nbsp;<?=$del_perm?>&nbsp<a href='board_reply.php?mart_id=<?=$mart_id?>&index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src="../image/helpdesk/bu_reply.gif" border="0"></a>							</td>
							<td align="right"><a href='board_list.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src="../image/helpdesk/bu_list.gif" border="0"></a>&nbsp;<a href='board_write.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src="../image/helpdesk/bu_write.gif" border="0"></a></td>
						</tr>
</table>
