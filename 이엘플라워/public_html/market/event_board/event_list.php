...
if(CheckPerm('CD', $perms) == false) {
	echo ("		
	<script>
		alert(\"쇼핑몰 신청후 입금확인이 되지않았거나 잠정적으로 사용중지된 쇼핑몰입니다.\");
		history.go(-1);
	</script>
	");
	exit;
...
.style9 {color: #006699}
.style10 {color: #3366CC;	font-weight: bold;}
-->
</style>
...
<!--타이틀 이미지 & 검색-->
<form name=search onsubmit='return frm_search(this)' action='../product/search.php' method="post">
<input type=hidden name='search_type' value='item'>
<input type=hidden name='mart_id' value='<?=$mart_id?>'>
<table width="990" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="30">&nbsp;</td>
		<td background="../images/template6/image/event/title_bg.gif"><img src="../images/template6/image/event/title.gif"><img src="../images/template6/image/event/title_type.gif" width="180" height="40"></td>
		<td align="right" background="../images/template6/image/event/title_bg.gif"><span class="text_right"><input name='itemname' type='text' class='input_search'>
        <a href='javascript:document.search.submit()'><img src='../images/template6/image/top/bu_search.gif' width='56' height='22' border='0' align='absmiddle'></a></span></td>
	</tr>
</table>
</form>
<!--타이틀 이미지 & 검색-->
...
//if(strstr($icon_module,"icon12")!=false) include( '../include/leftmenu_template6.inc' );
?>
...
<!-- 현재위치 -->
      ...
      <tr>
          <td><img src="../images/template6/image/event/subtitle_1.gif"></td>
        </tr>
      </table>
...
//$SQL = "select * from $EventboardTable where mart_id='$mart_id' and list_chk='Y' order by event_no desc";
$today = date("Y-m-d");
