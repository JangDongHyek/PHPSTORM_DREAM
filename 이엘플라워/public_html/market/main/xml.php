...
for($i=0;$i<sizeof($itemIds);$i++){
	...
	$product_info_url="http://www.elflower.co.kr/market/main/product_info.html?mart_id=elfower&category_num=$rows[category_num]&item_no=$itemIds[$i]";
	?>
	<item id="<?=$id?>">
	<name><![CDATA[<?=$name?>]]></name>
	<url><![CDATA[<?=$product_info_url?>]]></url>
	<description><![CDATA[<?=$description?>]]></description>
	<image>http://www.elflower.co.kr/co_img/elfower/<?=$rows[img_big]?></image>
	<thumb>http://www.elflower.co.kr/co_img/elfower/<?=$rows[img_sml]?></thumb>
	<price><?=$price?></price>
	<quantity><?=$quantity?></quantity>
	<category>
	<first id="MJ01">이엘플라워</first>
