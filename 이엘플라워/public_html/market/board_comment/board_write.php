...
<!---------------------- 게시판 시작 ---------------------------------------------------->
					...
					<table width="96%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="60" align="center" background="../image/helpdesk/table1_bg.gif"><img src="../image/helpdesk/subject.gif" width="20" height="11"></td>
...
?>
	※작성시 자동으로 비밀글 처리 됩니다
	<input type='hidden' name='if_secret' value='1'>
<?
}else{
...
*/?>							
						...
						<tr>
							<td height="30" align="center">평가</td>
							<td><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td ><input type="radio" checked value="5" name="point"><img src="../images/op_star.gif" width="11" height="11"><img src="../images/op_star.gif" width="11" height="11"><img src="../images/op_star.gif" width="11" height="11"><img src="../images/op_star.gif" width="11" height="11"><img src="../images/op_star.gif" width="11" height="11">&nbsp; 
									...
									<input type="radio" value="1" name="point"><img src="../images/op_star.gif" width="11" height="11"></td>
						</tr>
						<tr>
							<td bgcolor="E1E1E1" height="1" colspan="4"></td>
						</tr>
...
<script>
		...
		ed.init(); //웹에디터 삽입
					...
					<table width="96%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="50" align="center"><input type='image' onfocus='blur();' src="../image/helpdesk/bu_writeok.gif"  border="0" onMouseDown="_AceTM.ReView(<?=$item_no?>,$('input[name=\'subject_new\']').val(),$('input[name=\'point\']:checked').val());"><a href="board_list.php?item_no=<?=$item_no?>&mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>">&nbsp;<img src="../image/helpdesk/bu_cancel.gif"  border="0"></a></td>
						</tr>
					</table>
					</form>
<!---------------------- 게시판 끝 ------------------------------------------------------>
...
#######################################################################
	...
	if( $userfile_name ){
		...
		$userfile_name = $bbs_no."_".$index_no."_"."1"."_".date("YmdHis").".jpg";
	...
	if( $userfile1_name ){
		...
		$userfile1_name = $bbs_no."_".$index_no."_"."2"."_".date("YmdHis").".jpg";
	...
	$SQL = "insert into $New_BoardTable (index_no, bbs_no, notice_no,mart_id, username, writer, passwd, write_date, ansno, step, thread, email, subject_new, content, userfile, userfile1, if_secret, writer_ip, area, point) values ('$index_no', $bbs_no, '$max_notice','$mart_id', '$UnameSess', '$writer', '$passwd', '$write_date', '1', '0', '$thread', '$email', '$subject_new_tmp[0]', '$content', '$userfile_name', '$userfile1_name', '$if_secret', '$REMOTE_ADDR', '$item_no', '$point')";
	$dbresult = mysql_query($SQL, $dbconn);
	if( !$dbresult ){
		echo "
			<script>
	...
	if( $return == "product" ){
		...
		echo "<meta http-equiv='refresh' content='0; URL=board_list.php?item_no=$item_no&mart_id=$mart_id&bbs_no=$bbs_no'>";
	}
}
?>
<?
