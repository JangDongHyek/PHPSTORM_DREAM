...
if($flag == "comdel"){
	...
	if( $dbresult ){
		echo("
			...
			self.close();
			window.opener.location.href = 'board_read.php?item_no=$item_no&index_no=$index_no&bbs_no=$bbs_no&page=$page&mart_id=$mart_id&keyset=$keyset&searchword=$searchword';
			</script>
		");
	}else{
		echo("
...
#######################################################################
	...
	if( $dbresult3 ){
		echo "<meta http-equiv='refresh' content='0; URL=board_read.php?item_no=$item_no&index_no=$index_no&bbs_no=$bbs_no&page=$page&mart_id=$mart_id&keyset=$keyset&searchword=$searchword'>";
	}else{
		echo("
			<script>
