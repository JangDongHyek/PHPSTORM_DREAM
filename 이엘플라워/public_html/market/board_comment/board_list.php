...
<!---------------------- 검색 시작 ------------------------------------------------------>
						<table width='96%' align="center"  border='0' cellspacing='0' cellpadding='0'>
							...
							<input type="hidden" name="item_no" value="<?=$item_no?>">
								<td width="10">&nbsp;</td>
							  <td align='center'><img src='../image/helpdesk/search_type.gif' hspace='10' align='absmiddle'>
									<select name="keyset" class='input_03' style="width:60px; height:27px; background:#f7f9fa; border:1px solid #e3e3e3;">
					          <option value="subject_new" selected>제목</option>
										<option value="content">내용</option>
										<option value="writer">작성자</option>
										<option value="all">전체</option>
									</select>					  
									<input type='text' name='searchword' value='<?=$searchword?>' class='input_03' size='15' style="width:180px; height:27px; background:#f7f9fa; border:1px solid #dddddd;">
