...
if($numRows > 0){
	...
	$minimum_quantity = $ary["minimum_quantity"];
	$if_cash = $ary["if_cash"];
		...
		<td>
			...
			<!--내용 START~~--><br>
				...
				<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
					<tr>
				  <td width="90%" bgcolor="#FFFFFF"><strong>[한정판매 공동구매 상품수정]</strong> 상품을 수정합니다.<br>
				  <font color="#0000FF">① 공구총수량 : 공급가능한 상품의 
				  총수량을 적습니다.<br>
				  ② 최소 공구가능수량 : 공구가 체결되기 위한 최소한의 신청숫자를 
				  말합니다. <br>
				  &nbsp;&nbsp;&nbsp; 예를 들어, 최소 10명 이상은 되어야 공구진행이 
				  가능하다면, 이 항목에 10을 입력하시면 됩니다. <br>
				  &nbsp;&nbsp;&nbsp; 최소 인원에 관계없이 공구를 진행하시려면 
				  입력하시지 마십시오.</font></td>
				</tr>
...
<input type="hidden" name="reg_date" value='<?echo $reg_date?>'>
				  ...
				  <tr>
							...
							<tr>
								<td width="90%" bgcolor="#999999">
									...
									<tr>
										...
										<td width="35%" bgcolor="#FFFFFF" align="center">
											...
											<input name="item_name" size="14" value='<?echo $item_name?>' class="input_03" style="width:90%">
										</td>
										<td width="15%" bgcolor="#DDC5E4" align="left">
											<p align="center">제조사</td>
										<td width="35%" bgcolor="#FFFFFF" align="center">
											
											<input name="item_company" size="14" value='<?echo $item_company?>' class="input_03" style="width:90%">
										</td>
									</tr>
									<tr>
										<td width="15%" bgcolor="#DDC5E4" align="center">
										...
										<td width="35%" bgcolor="#FFFFFF" align="center">
											...
											<input name="price" size="14" value='<?echo $price?>' class="input_03" style="width:90%">
										</td>
										<td width="15%" bgcolor="#DDC5E4" align="left">
											<p align="center">상품코드</td>
										<td width="35%" bgcolor="#FFFFFF" align="center">
											
											<input name="item_code" size="14" value='<?echo $item_code?>' class="input_03" style="width:90%">
										</td>
									</tr>
									<tr>
										<td width="15%" bgcolor="#DDC5E4" align="center">
										...
										<td width="35%" bgcolor="#FFFFFF" align="center">
											...
											<input name="z_price" size="14" value='<?echo $z_price?>' class="input_03" style="width:90%">
										</td>
										<td width="15%" bgcolor="#DDC5E4" align="left">
											<p align="center">공구총수량</td>
										<td width="35%" bgcolor="#FFFFFF" align="center">
											
											<input name="limit_total" size="14" value='<?echo $limit_total?>' class="input_03" style="width:90%">
										</td>
									</tr>
									<tr>
										 <td width="15%" bgcolor="#DDC5E4" align="center">최소가능수량</td>
										 <td width="35%" bgcolor="#FFFFFF" align="center">
										 <input name="minimum_quantity" value='<?echo $minimum_quantity?>' size="14" class="input_03" style="width:90%"></td>
								...
								<tr>
										...
										<td width="25%" bgcolor="#FFFFFF" align="center">
											...
											<input name="op_name2" size="14" value='<?echo $op2[0]?>' class="input_03" style="width:90%"></td>
								...
								if(isset($opts[2]) && $opts[2] != ""){
									...
									<tr>
										...
										<td width="25%" bgcolor="#FFFFFF" align="center">
											...
											<input name="op_name3" size="14" value='<?echo $op3[0]?>' class="input_03" style="width:90%"></td>
										<td width="50%" bgcolor="#FFFFFF" align="left" colspan="3" rowspan="3">
											<p align="center">
					...
					<td width="100%" bgcolor="#FFFFFF" valign="top">
						...
						<input onclick="window.location.href='union_limit_item_list.php?union_no=<?echo $union_no?>'" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type="button" value="리스트로">
					</td>
					</tr>
...
<?
	...
	$SQL = "update $Union_ItemTable set item_name = '$item_name', price = $price, z_price = $z_price, limit_total = '$limit_total', minimum_quantity = '$minimum_quantity', img = '$img_new', item_explain = '$item_explain', reg_date = '$reg_date', item_company = '$item_company', item_code = '$item_code', icon_no = '$icon_no', opt='$opt', use_opt23 = '$use_opt23', if_cash='$if_cash' where item_no = $item_no and mart_id='$mart_id'";
	$dbresult = mysql_query($SQL, $dbconn);
