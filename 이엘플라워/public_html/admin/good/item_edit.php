...
-->
			        ...
			        <td bgColor="#ffffff">
			              ...
			              <tr>
			                ...
			                <td bgColor="#ffffff" colspan="4">
								<input type="radio" value="무료배송" name="fee" <?if($fee=="무료배송"){ echo "checked";}?>>무료배송 <input type="radio" value="착불" name="fee" <?if($fee=="착불"){ echo "checked";}?>>착불 <input type="radio" value="" name="fee" <?if($fee==""||$fee=="선불"){ echo "checked";}?>>선불 <input type="radio" value="기본설정" name="fee" <?if($fee=="기본설정"){ echo "checked";}?>>기본설정
							</td>
			              </tr>
			              <tr>
			                <td align="center" bgColor="#c8dfec" colSpan="2">
			            ...
			            <td bgColor="#ffffff" colspan="4">
									...
									<input type="radio" value="1" name="if_cash" <?if($if_cash == '1') echo "checked";?>>현금전용결제
									<input type="radio" value="2" name="if_cash" <?if($if_cash == '2') echo "checked";?>>포인트전용결제
								<br>
...
<table bgcolor=#ffffff border="0" width="100%" cellpadding=1 cellspacing=1>
	<tr>
		<td align=center bgcolor=#ffffff colspan=6>
			<input type=radio name="thumbnail" value="y" onClick="toggle1()" <?if($thumbnail=='y'){echo"checked";}?>>썸네일사용 <input type=radio name="thumbnail" value="n" onClick="toggle2()" <?if($thumbnail=='n'){echo"checked";}?>>개별등록하기
		</td>
	</tr>
</table>
...
?>
<input type="checkbox" name="del_big2" value="y">삭제
<?
}
?>
					      				</td>
...
?>
<input type="checkbox" name="del_big3" value="y">삭제
<?
}
?>
					      				</td>
...
?>
<input type="checkbox" name="del_big4" value="y">삭제
<?
}
?>
					      				</td>
...
?>
<input type="checkbox" name="del_big5" value="y">삭제
<?
}
?>
					      				</td>
...
?>
<input type="checkbox" name="del_sml" value="y">삭제
<?
}
?>
					      				</td>
...
?>
<input type="checkbox" name="del" value="y">삭제
<?
}
?>
										</td>
                	...
                	<input onclick="opt_del4(this.form)" class='butt_none' style='width:60' type="button" value="삭 제" style='cursor:hand'>
          			...
          			<td width="26%" bgcolor="#C8DFEC" align="center" colspan="2">옵션제목5</td>
								<td width="22%" bgcolor="#FFFFFF">
									...
									<input type="checkbox" name="if_opt_jaego5" value="1" <? if($if_opt_jaego5){echo "checked";}?>>재고관리
								</td>
               	<td width="53%" bgcolor="#FFFFFF" align="center" colspan="3" rowspan="5">
                	...
                	<input onclick="opt_del5(this.form)" class='butt_none' style='width:60' type="button" value="삭 제" style='cursor:hand'>
          			...
          			<td width="26%" bgcolor="#C8DFEC" align="center" colspan="2">옵션제목6</td>
								<td width="22%" bgcolor="#FFFFFF">
									...
									<input type="checkbox" name="if_opt_jaego6" value="1" <? if($if_opt_jaego6){echo "checked";}?>>재고관리
								</td>
