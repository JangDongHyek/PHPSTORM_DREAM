...
$SQL = "select category_num,category_name,if_hide,category_degree, special from $CategoryTable where mart_id='$mart_id' and prevno='0'  and category_num > 0 order by cat_order desc";
//echo "//$SQL\n";
$dbresult = mysql_query($SQL, $dbconn);
$numRows = mysql_num_rows($dbresult);
...
<?
	...
	$SQL2 = "select category_num,category_name,cat_order,if_hide,category_degree from $CategoryTable where mart_id='$mart_id' and prevno='$category_num' and category_degree='1' and category_num > 0 order by cat_order desc";
