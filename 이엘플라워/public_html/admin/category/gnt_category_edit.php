...
<?
if($flag == '') {
	$SQL = "select * from $GiveNTakeTable where seller_id='$Mall_Admin_ID' and state1='2' and category_num='$category_num'";
	$dbresult = mysql_query($SQL, $dbconn);
	mysql_data_seek($dbresult,0);
	$ary = mysql_fetch_array($dbresult);
	$gnt_category_name = $ary["gnt_category_name"];
	
	$SQL = "select * from $CategoryTable where category_num=$category_num";
	$dbresult = mysql_query($SQL, $dbconn);
	mysql_data_seek($dbresult,0);
	$ary = mysql_fetch_array($dbresult);
...
<form action='gnt_category_edit.php' name="up" method="post" onsubmit="return checkform(this)">
...
<tr>
	...
	<td width="646" bgcolor="#FFFFFF" valign="top">
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
  		<tr>
    		<td width="90%" bgcolor="#FFFFFF" valign="top">　<p style="padding-left: 10px"><strong><span class="cc">[카테고리 수정]</span></strong><span class="aa"> 등록된 
    			카테고리를 수정합니다.<br>
    			</span><br>
    		</td>
  		</tr>
        				...
        				<table border="0" width="100%" cellspacing="1" cellpadding="3">
          				<tr>
            				...
            				<td width="21%" bgcolor="#FFFFFF" align="center">
            					<span class="bb"><strong></strong><?echo $category_name?></span></td>
            				<td width="19%" bgcolor="#C8DFEC" align="left">
            					<span class="aa"><p align="center">변경할 카테고리명</span></td>
            				<td width="40%" bgcolor="#FFFFFF" align="center">
            					<span class="aa">
            					<input class="aa" name="gnt_category_name" value='<?echo $category_name?>' size="14" style="width:90%;BORDER-BOTTOM: rgb(136,136,136) 1px solid; BORDER-LEFT: rgb(136,136,136) 1px solid; BORDER-RIGHT: rgb(136,136,136) 1px solid; BORDER-TOP: rgb(136,136,136) 1px solid"></span>
            				</td>
          				</tr>
          			</table>
        			</td>
...
elseif ($flag == "update") {
	$SQL = "update $GiveNTakeTable set gnt_category_name='$gnt_category_name' where seller_id='$Mall_Admin_ID' and state1='2' and category_num='$category_num'";
	$dbresult = mysql_query($SQL, $dbconn);
