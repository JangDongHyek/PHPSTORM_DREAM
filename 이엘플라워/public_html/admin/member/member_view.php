...
if (isset($flag) == false) {
	...
	if($numRows > 0){
		...
		$sl = $ary['sl'];
		$company = $ary['company'];
		$company_number = $ary['company_number'];
		$boss_name = $ary['boss_name'];
		$ct1 = $ary['ct1'];
		$ct2 = $ary['ct2'];
		$charge = $ary['charge'];
		$charge_hp = $ary['charge_hp'];
		$addinfo=$ary[addinfo];
		$addinfo_date=$ary[addinfo_date];
		$recommand_id = $ary[recommand_id];
							...
							<table border="0" width="97%">
								<tr>
									<td width="100%" bgcolor="#999999">
										...
										<tr>
											<td bgcolor="#C8DFEC" align="left">회원구분</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<input type="hidden" name="division" value="<?php echo $division ?>">
												<?php echo $division ?>
											</td>
										</tr>
										<?php if($division == '일반회원'){ ?>
										<tr>
											<td bgcolor="#C8DFEC" align="left">성별</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<label><input type="radio" name="gender" id="gA" value="남성" <?php if($gender == '남성') echo 'checked'; ?>> 남성</label>
												<label><input type="radio" name="gender" id="gB" value="여성" <?php if($gender == '여성') echo 'checked'; ?>> 여성</label>
											</td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">생년월일</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<select name="birth1" id="birth1">
													<option value="">선택</option>
													<?php for($i=date('Y'); $i>=1920; $i--){ ?>
													<option value="<?php echo $i ?>" <?php if($birth1 == $i) echo 'selected'; ?>><?php echo $i ?></option>
													<?php } ?>
												</select>년&nbsp;
												...
												<select name="birth2" id="birth2">
													<option value="">선택</option>
													<?php for($i=1; $i<=12; $i++){ ?>
													<option value="<?php echo $i ?>" <?php if($birth2 == $i) echo 'selected'; ?>><?php echo $i ?></option>
													<?php } ?>
												</select>월&nbsp;
												...
												<select name="birth3" id="birth3">
													<option value="">선택</option>
													<?php for($i=1; $i<=31; $i++){ ?>
													<option value="<?php echo $i ?>" <?php if($birth3 == $i) echo 'selected'; ?>><?php echo $i ?></option>
													<?php } ?>
												</select>일&nbsp;

												<label><input type="radio" name="sl" id="s" value="양력" <?php if($sl == '양력') echo 'checked'; ?>> 양력</label>
												<label><input type="radio" name="sl" id="l" value="음력" <?php if($sl == '음력') echo 'checked'; ?>> 음력</label>
											</td>
										</tr>
										<?php }else{ ?>
										<tr>
											<td bgcolor="#C8DFEC" align="left">회사(법인)명</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<input name="company" value="<?php echo $company ?>" size="13" class="input_03" style="width:30%">
											</td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">사업자등록번호</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<input name="company_number" value="<?php echo $company_number ?>" size="13" class="input_03" style="width:30%">
											</td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">대표자명</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<input name="boss_name" value="<?php echo $boss_name ?>" size="13" class="input_03" style="width:30%">
											</td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">업태</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<input name="ct1" value="<?php echo $ct1 ?>" size="13" class="input_03" style="width:30%">
											</td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">종목</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<input name="ct2" value="<?php echo $ct2 ?>" size="13" class="input_03" style="width:30%">
											</td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">담당자</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<input name="charge" value="<?php echo $charge ?>" size="13" class="input_03" style="width:30%">
											</td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">담당자 연락처</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<input name="charge_hp" value="<?php echo $charge_hp ?>" size="13" class="input_03" style="width:30%">
											</td>
										</tr>
										<?php } ?>
										<!-- <tr>
										...
										<tr>
											...
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<input name="zip" id="zip" value='<?=$zip?>' size="13" style="BORDER-BOTTOM: rgb(136,136,136) 1px solid; BORDER-LEFT: rgb(136,136,136) 1px solid; BORDER-RIGHT: rgb(136,136,136) 1px solid; BORDER-TOP: rgb(136,136,136) 1px solid" readonly>
												<input onClick="sample6_execDaumPostcode();" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type="button" value="찾기">
											</td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">주소</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3"><input name="address" id="address" value='<?=$address?>' size="13" class="input_03" style="width:80%"></td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">상세주소</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3"><input name="address_d" id="address_d" value='<?=$address_d?>' size="13" class="input_03" style="width:80%"></td>
										</tr>
    ...
    function sample6_execDaumPostcode() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                document.getElementById("address_d").value = "";
                ...
                document.getElementById("address_d").focus();
										...
										<tr>
											<td bgcolor="#C8DFEC" align="left">기념일 날짜</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<?=$addinfo_date?>
												(<?=$addInfoArray[$addinfo]?>)
												
											</td>
										</tr>
										
										<tr>
											<td bgcolor="#C8DFEC" align="left">추천인 아이디</td>
											<td bgcolor="#FFFFFF" align="left" colspan="3">
												<? 
													 $recommand_id?$recommand_id_text=$recommand_id:$recommand_id_text="추천인 아이디가 없습니다.";
												 echo $recommand_id_text;
												 ?>
...
elseif ($flag == "update") {
	...
	if($password)
		$update_password_str = "password = old_password('$password'),";
	else
		$update_password_str = "";

	if($division == '일반회원'){
		$add_qry = ", gender='{$gender}', birth1='{$birth1}', birth2='{$birth2}', birth3='{$birth3}', sl='{$sl}'";
	}else{
		$add_qry = ", company='{$company}', company_number='{$company_number}', boss_name='{$boss_name}', ct1='{$ct1}', ct2='{$ct2}', charge='{$charge}', charge_hp='{$charge_hp}'";
	}

	$SQL = "update $Mart_Member_NewTable set name = '$name', $update_password_str email = '$email', tel = '$tel', tel1 = '$tel1', zip = '$zip', address = '$address', address_d = '$address_d', partner = '$partner', msg = '$msg', customer='$customer', job = '$job', com_name = '$com_name', homepage = '$homepage', hobby = '$hobby', religion = '$religion', ext1_content = '$ext1_content', ext2_content = '$ext2_content', ext3_content = '$ext3_content', ext4_content = '$ext4_content', sel_content = '$sel_content', if_maillist='$if_maillist' {$add_qry}  where username = '$username' and mart_id='$mart_id'";
	$dbresult = mysql_query($SQL, $dbconn);
