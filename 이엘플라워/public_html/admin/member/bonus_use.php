	 ...
	 <table cellSpacing="0" cellPadding="0" width="100%" border="0">
		<tr>
		  ...
		  <table width="100%" border="0">
			 <tr>
				<td width="100%" height="20"><p align="center"><b>[회원 포인트 현황]</b></td>
			 </tr>
		  </table>
		  </td>
		</tr>
		<tr>
		  ...
		  <table width="97%" border="0">
			 <tr>
				...
				<tr>
					<td align="middle" bgColor="#c8dfec">사용 No.</td>
					<td align="middle" bgColor="#c8dfec">사용일&nbsp;</td>
					<td align="middle" bgColor="#c8dfec">사용량</td>
					<td align="middle" bgColor="#c8dfec">내용</td>
					<td align="middle" bgColor="#c8dfec">구분</td>
<?
$sum_sql = "select sum(bonus) as bonus_total from $BonusTable where mart_id ='$mart_id' and mode='u'";
$sum_rs = mysql_query($sum_sql, $dbconn);
$sum_rows = mysql_fetch_array($sum_rs);
$bonus_total_str = $sum_rows[bonus_total];

$SQL = "select * from $BonusTable where mart_id ='$mart_id' and mode='u' order by num desc";
