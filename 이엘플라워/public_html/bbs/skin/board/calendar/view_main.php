	...
	<TD bgColor=#CCCCCC>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 style="table-layout:fixed">
		  <TR bgcolor=#FFFFFF height="25"> 
		    <TD width=12% align="right">일&nbsp;&nbsp;&nbsp;정&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0>
		    </TD>
		    <TD colspan="3" style='padding-left:10;' height="25"> 
		      <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td WIDTH=60%><b><SPAN TITLE='<?=$rg_title?>'><?=rg_cut_string($rg_title, 80, $suffix="..")?></span></b></td>
				  	<TD> 	일&nbsp;&nbsp;&nbsp;시&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0>&nbsp;&nbsp;<? $rg_ext5 = date("Y년 n월 j일",$rg_ext5); echo "$rg_ext5"; ?></TD>
		        </tr>
		      </table>
		    </TD>
		  </TR>
		...
		onload=set_img_init;
		  ...
		  <div id=ct class=contents><span id="content">
			<?=$show_ext1_begin?><?=$show_ext1_title?> : <?=$rg_ext1?><br><?=$show_ext1_end?>
			<?=$show_ext2_begin?><?=$show_ext2_title?> : <?=$rg_ext2?><br><?=$show_ext2_end?>
			<?=$show_ext3_begin?><?=$show_ext3_title?> : <?=$rg_ext3?><br><?=$show_ext3_end?>
