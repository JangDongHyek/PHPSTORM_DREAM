<?
	...
	if($act) {
		...
		rg_href("board_category.php?bbs_id=$bbs_id");
	}
    ...
    <td align="center">
        <table width="100%" cellspacing="0" style="border-collapse:collapse;">
          <tr>
            ...
            <td align="center" bgcolor="silver" class="line1" >분류명</td>
...
?>
        ...
        <table width="100%" cellspacing="0" style="border-collapse:collapse;">
          ...
          <tr> 
            <td height="22" class="line1" > &nbsp;&nbsp;선택한 분류의 글을 
          ...
          <tr>
            <td height="22" align="right" class="line1" ><input name="submit" type="submit" onClick="if(!confirm('확실합니까')) return false;cat_edit.mode.value='move'" value=" 변 경 ">
              후 분류를 
              <input name="submit" type="submit" value=" 삭 제 " onClick="if(!confirm('확실합니까')) return false;cat_edit.mode.value='delete'">
              &nbsp;&nbsp;</td>
          </tr>
          <tr> 
            <td height="22" class="line1" >&nbsp;&nbsp;분류명 
