...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td height="70"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        	<tr>
        		<td background="../../market/image/blank/title_bg.gif"><img src="../../market/image/blank/title_7.gif" width="190" height="70"></td>
        		<td width="20"><img src="../../market/image/blank/title_right.gif" width="20" height="70"></td>
        		</tr>
        	</table></td>
		<td width="10" rowspan="3"></td>
	</tr>
