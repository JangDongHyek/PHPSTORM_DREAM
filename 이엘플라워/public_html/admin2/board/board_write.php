...
<table border="1" cellpadding="0" cellspacing="0" width="99%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
	<form action='board_write.php' method="POST" name='writeform' enctype="multipart/form-data" onsubmit='return checkform();'> 
...
elseif ($flag == "write") {
	...
	$SQL = "insert into $New_BoardTable (index_no, bbs_no, notice_no, mart_id, code, username, writer, passwd, doc_type, if_secret , write_date, msgno, ansno, thread, email, subject_new, content, userfile, userfile1,open_chk) values ('$index_no', '$bbs_no', '$max_notice', '$mart_id', '$code', '$mart_id', '$writer', '$passwd', '$doc_type', '$if_secret', '$write_date', $maxMsgNo+1, '1', '$thread', '$email', '$subject_new_tmp[0]', '$content', '$file', '$file1', '$open_chk' )";
	$dbresult = mysql_query($SQL, $dbconn);
