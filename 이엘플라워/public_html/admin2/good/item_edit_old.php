		...
		<td>
			...
			<tr>
				<td width="90%" bgcolor="#FFFFFF" valign="top"><br>
					<p style="padding-left: 10px"><b>[주문 상품 정보]</b> <br><br>
				</td>
			</tr>
...
?>
			              ...
			              <tr>
			                <td width="100%" bgColor="#ffffff" colSpan="6" align="left">
								<img height="15" src="../images/tip.gif" width="30"> <font color="#0000ff"> 종류제한 : 이미지는 jpg,gif를 지원합니다.<br>							
								용량제한 : 1M(1000000byte)<BR>
								크기제한 : 가로,세로 2100px 이하<BR>
								결과 이미지의 사이즈는 600*600px로 자동 크기조절이 됩니다</font>
							</td>
			              </tr>
			              <tr>
                			<td width="15%" bgcolor="#C8DFEC" align="center" colspan="2">
