...
//================================= 상품 테이블 백업 시작 ================================
if( $table == "item" ){
	$query = "select item_no, item_name, item_company, member_price, g_margin, z_price, bonus, reg_date from $table where mart_id='$mart_id' and if_hide='0' order by reg_date desc";
