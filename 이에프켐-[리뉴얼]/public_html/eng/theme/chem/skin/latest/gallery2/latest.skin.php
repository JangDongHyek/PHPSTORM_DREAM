...
$imgwidth = 383; //표시할 이미지의 가로사이즈
$imgheight = 222; //표시할 이미지의 세로사이즈
...
<div id="oneshot_2_7_2">
	<!--게시판제목-->
	<div class="la_title">
		<h3 class="wow fadeInUp animated" data-wow-delay="0.3s" data-wow-duration="0.8s">PORTFOLIO</h3>
    ...
    <!--더보기버튼-->
	<div class="lt_more wow fadeInUp animated" data-wow-delay="1.2s" data-wow-duration="0.8s">
    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>"><span class="sound_only"><?php echo $bo_subject ?></span> MORE VIEW <i class="fal fa-angle-right"></i></a>
    </div><!--.lt_more-->
</div><!--#oneshot_2_7-->
