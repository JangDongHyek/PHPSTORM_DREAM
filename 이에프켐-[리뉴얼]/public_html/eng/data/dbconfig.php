...
define('G5_MYSQL_USER', 'efchem_re2');
define('G5_MYSQL_PASSWORD', 'yfqw5ev2');
define('G5_MYSQL_DB', 'efchem_re2');
...
$g5['menu_table'] = G5_TABLE_PREFIX.'menu_eng'; // 메뉴관리 테이블
$g5['submenu_table'] = G5_TABLE_PREFIX.'submenu_eng'; // 서브메뉴 테이블
