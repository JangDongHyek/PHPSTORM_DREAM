                ...
                <ul class="text_wrap">
                    ...
                    <div class="wow animate__animated animate__fadeInUp animate__delay-0.5s">
                        <li>
                            ...
                            <p>기존 상조 상품의 거품을 제거하고 월납입금 불입이 <br class="hidden-xs">필요없는 베네피아 후불제 상조 상품</p>
                        </li>
                        <li>
                            <strong class="step-num">
                                <span>02.</span>
                            </strong>
                            <h5 class="color-red">베네피아 혜택</h5>
                    ...
                    <div class="wow animate__animated animate__fadeInUp animate__delay-0.5s">
                        <ul class="">
                            <li>
                                ...
                                <h5>
                                    장례발생 시<br>
                                    <strong class="under-red">베네피아 전용 24시간 상황실</strong>
                                </h5>
                                <h2>
                                    <span class="color-red">1877-9950</span> 로 전화주세요
                                </h2>
                            </li>
                            <li>
                                ...
                                <h5>
                                    해피라이프 후불상조<br>
                                    <strong class="under-red">전국 동일 가격</strong>
                                </h5>
                                <h2>
                                    <span class="color-red">259만원 결제</span>
                                </h2>
                            </li>
                            <li>
                                ...
                                <h2>
                                    <span class="color-red">캐쉬백 200,000</span>
                                </h2>
                            </li>
                        </ul>
                    </div>
    ...
    <section class="s8">
        <div class="container">
            ...
            <div class="con_wrap">
                <div class="text_wrap">
                    ...
                    <div class="wow animate__animated animate__fadeInDown animate__delay-0.5s">
                       ...
                       <a data-toggle="modal" data-target="#modal_benepia" style="cursor:pointer">
                            <img src="<?php echo G5_THEME_IMG_URL ?>/landing02/product_benepia.png" alt="" class="s8_img01">
                        </a>
                    </div>
            ...
            <div class="wow animate__animated animate__fadeInUp animate__delay-0.5s btn_wrap">
                <a class="btn btn-black">24시간 베네피아 전용</a>
                <a class="btn btn-white">전화 1877-9950</a>
            </div>
        </div>
    </section>
...
-->
                    ...
                    <div class="wow animate__animated animate__fadeInUp animate__delay-0.5s">
                        <div class="process">
                            ...
                            <dl>
                                ...
                                <dt>02. 장례접수</dt>
                                <dd>베네피아 전용 대표번호 <br>1877-9950 24시간 365일</dd>
                            </dl>
                            <dl>
                                <div class="img_wrap">
    ...
    <div class="container fix_btn">
        <a href="https://www.benepia.co.kr/" target="#" class="btn btn-beige">24시간 베네피아 전용</a>
        <a href="tel:1877-9950" class="btn btn-white">전화 1877-9950</a>
    </div>
...
<!--캐시백 신청폼 모달-->
<div class="modal fade" tabindex="-1" role="dialog" id="modal_benepia">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="cashback_form">
                    ...
                    <ul>
                        <li>
                            <textarea class="input_form" disabled>- 캐시백 포인트는 신청 후 다음달 10일(공휴일 경우 익영업일)에 적립되며, 유효 기간은 5년 입니다.<br>
                            - 캐시백 포인트로 결제한 주문을 취소할 경우, 환불은 베네피아 포인트로 이루어지며, 환불 규정은 베네피아 이용 약관에 따릅니다.<br>
                            - 베네피아 회원이 탈퇴할 경우, 적립된 포인트는 모두 소멸됩니다</textarea>
            ...
            <div class="modal-footer">
                <button type="button" class="bttn btn-save" data-toggle="modal" data-target="#modal_benepia_msg">캐쉬백 신청하기</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<!--메시지 모달-->
<div class="modal fade" tabindex="-1" role="dialog" id="modal_benepia_msg">
