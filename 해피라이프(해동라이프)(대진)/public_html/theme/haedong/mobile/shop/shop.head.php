...
<ul class="topbtn">
    <li><a href="mailto:Happylife00@happylife1004.shop"><img src="<?php echo G5_THEME_IMG_URL ?>/main/top_btn01.png" alt="대리점문의"/></a></li>
    <li><a href="mailto:Happylife00@happylife1004.shop"><img src="<?php echo G5_THEME_IMG_URL ?>/main/top_btn02.png" alt="협력업체등록요청"/></a></li>
	<li><a href="<?php echo G5_THEME_URL ?>/down/리플릿.zip"><img src="<?php echo G5_THEME_IMG_URL ?>/main/top_down.png" alt="리플릿다운로드"/></a></li>
</ul>

<? if($pid == "benepia"){ ?>
<div class="rightbtn"><a href="tel:1877-9950"><img src="<?php echo G5_THEME_IMG_URL ?>/main/top_btn03_benepia.png" alt="24시간문의"/></a></div>
<? }else if($pid == "benecafe"){ ?>
<div class="rightbtn"><a href="tel:1899-2919"><img src="<?php echo G5_THEME_IMG_URL ?>/main/top_btn03_benecafe.png" alt="24시간문의"/></a></div>
<? }else { ?>
<div class="rightbtn"><a href="tel:18338881"><img src="<?php echo G5_THEME_IMG_URL ?>/main/top_btn03.png" alt="24시간문의"/></a></div>
<? } ?> 
...
<header id="hd">
    ...
    <?php if(defined('_INDEX_')) { // index에서만 실행
        ...
        <div id="tnb_wrapper" style="display:none;">
            <div class="tnb_in">
            	<p class="cl"><i class="fas fa-phone"></i> HELP DESK <span><?php echo $default['de_admin_company_tel']; ?></span></p>
                <ul id="tnb">
					<?php if ($is_member) { ?>
                    <?php if ($is_admin) {  ?>
                    <li><a href="<?php echo G5_ADMIN_URL ?>" class="adm"><b><i class="fas fa-cog"></i> 관리자</b></a></li>
                    <?php } else { ?>
        ...
        <div id="hd_wrapper">       
        	<div class="container">  
                ...
                <h1 id="logo"><a href="<?php echo G5_SHOP_URL; ?>/">
				<img src="<?php echo G5_THEME_IMG_URL ?>/common/logo.png" alt="<?php echo $config['cf_title']; ?>" /></a>
				<!--img src="<?php echo G5_THEME_IMG_URL ?>/common/kbs_logo.jpg" style="margin-left:10px"-->
                ...
                <div id="top_menu">
                	<ul>
						<?php if ($is_member) { ?>
                        <?php if ($is_admin) {  ?>
                        <li><a href="<?php echo G5_ADMIN_URL ?>" class="adm"><img src="<?php echo G5_THEME_IMG_URL ?>/tnb_icon01.png" /><p>관리자</p></a></li>
                        <?php } else { ?>
                        <li><a href="<?php echo G5_BBS_URL; ?>/member_confirm.php?url=register_form.php"><img src="<?php echo G5_THEME_IMG_URL ?>/tnb_icon07.png" /><p>정보수정</p></a></li>
                        <?php } ?>
                        <li><a href="<?php echo G5_BBS_URL; ?>/logout.php?url=shop"><img src="<?php echo G5_THEME_IMG_URL ?>/tnb_icon05.png" /><p>로그아웃</p></a></li>
                        <?php } else { ?>
                        <li><a href="<?php echo G5_BBS_URL; ?>/login.php?url=<?php echo $urlencode; ?>"><img src="<?php echo G5_THEME_IMG_URL ?>/tnb_icon06.png" /><p>로그인</p></a></li>
                        <li><a href="<?php echo G5_BBS_URL ?>/register.php" id="snb_join"><img src="<?php echo G5_THEME_IMG_URL ?>/tnb_icon03.png" /><p>회원가입</p></a></li>
                        <?php } ?>
                        <li><a href="<?php echo G5_SHOP_URL; ?>/cart.php"><img src="<?php echo G5_THEME_IMG_URL ?>/tnb_icon02.png" /><p>장바구니</p></a></li>
                        <li><a href="<?php echo G5_SHOP_URL; ?>/mypage.php"><img src="<?php echo G5_THEME_IMG_URL ?>/tnb_icon04.png" /><p>마이페이지</p></a></li>
                    </ul>
                </div><!--#top_menu-->
    		</div>
        </div><!--#hd_wrapper-->
    ...
    <div class="visible-xs">
        ...
        <div id="mgnb" class="hd_div">
            ...
            <ul id="mtnb">
                <?php if ($is_member) { ?>
                <?php if ($is_admin) {  ?>
                <li><a href="<?php echo G5_ADMIN_URL ?>"><i class="fas fa-cog"></i> 관리자</a></li>
                <?php } else { ?>
            ...
            ?>
                <li class="mgnb_1dli">
                   <a class="mgnb_1da" href="<?php echo $row['me_link']; ?>" target="_<?php echo $row['me_target']; ?>"><?php echo $row['me_name'] ?><i class="fas fa-angle-right"></i></a>
...
<div id="tgnb" class="visible-xs">
        ...
        ?>
            <li class="tgnb_1dli">
                <a class="tgnb_1da" href="<?php echo $row['me_link']; ?>" target="_<?php echo $row['me_target']; ?>"><?php echo $row['me_name'] ?></a>
            </li>
        <?php
        }
