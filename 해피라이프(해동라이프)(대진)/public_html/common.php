...
해피라이프
**********************************************************************/
define('G5_JS_VER',  '1.12');
define('G5_CSS_VER', '1.12');
define('MB_CERT_PATH', G5_DATA_PATH."/member_cert");
define('MB_CERT_URL', G5_DATA_URL."/member_cert");

define('SMS_SEND_NUM', '18338881');

// 회원가입
// - 가입구분
$member_group = array(1=>"일반회원", 2=>"콜센터", 3=>"제휴회원(스코피)", 4=>"제휴회원(SK매직)");
// - 제휴확인 (/bbs/register_aflt.php)
$partner_chk = array(3=>"스코피", 4=>"SK매직");

// - 가입경로
$regist_route = array("인터넷", "추천인", "TV", "광고배너");
// - 이메일
$regist_email = array("naver.com", "gmail.com", "hanmail.net", "nate.com");



//SSL 리다이렉트 시작
if(0 < strpos(G5_URL,"ttp://")){	goto_url("https://www.happylife1004.co.kr");
}
//SSL 리다이렉트 끝
