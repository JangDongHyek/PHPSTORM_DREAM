...
if($w == 'a')
    $result_url = G5_SHOP_URL.'/qaview.php?qa_id='.$qa_id.$qstr;
else if($w == 'u' && $write['qa_type'])
    $result_url = G5_SHOP_URL.'/qaview.php?qa_id='.$write['qa_parent'].$qstr;
else
    $result_url = G5_SHOP_URL.'/qalist.php'.preg_replace('/^&amp;/', '?', $qstr);
