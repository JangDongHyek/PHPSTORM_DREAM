...
<li><a href="#anc_sodr_chk">결제상세정보</a></li>
<li><a href="#anc_sodr_memo">상점메모</a></li>
<li><a href="#anc_sodr_orderer">주문자/배송지 정보</a></li>
</ul>';
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="od_delivery_company" id="od_delivery_company" value="<?php if ($od['od_delivery_company']) echo $od['od_delivery_company']; ?>" class="frm_input">
                    </td>
                </tr>
                <tr>
