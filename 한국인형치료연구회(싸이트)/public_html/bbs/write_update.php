...
if($board['bo_use_category'] && $bo_table!='apply01') {
...
if($wr_4 =='' && ($bo_table =='apply01' || $bo_table =='apply02' || $bo_table =='apply03'  )){
	alert("올바르게 다시 접수해 주세요.");
}
...
else if($bo_table =='apply01'){
	alert("신청이 완료되었습니다.",G5_BBS_URL.'/board.php?bo_table=edu&sca=인형상담심리상담사+2급과정');
}
else if($bo_table =='apply02'){
	alert("신청이 완료되었습니다.",G5_BBS_URL.'/board.php?bo_table=certify');
}
else if($bo_table =='apply03'){
	alert("신청이 완료되었습니다.",G5_BBS_URL.'/board.php?bo_table=academy');
}
else
