...
$recaptcha_secret = '6LcUekkpAAAAANVVVxmSMMldw7h_YLrr0FByoj3o';
$recaptcha_response = $g_token; // 이것은 클라이언트에서 전송한 토큰입니다.
...
// 만약 사용자의 IP가 특정 아이피와 일치하면 코드 실행
if ($user_ip === "121.140.204.65") {
    var_dump($result);
    //return;
}
