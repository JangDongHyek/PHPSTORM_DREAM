...
<input type="hidden" name="mb_1" value="<?php echo $mb['mb_1'] ?>">
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td><input type="text" name="mb_name" <?if($w=='u') echo 'readonly'?> value="<?php echo $mb['mb_name'] ?>" id="mb_name" required class="required frm_input" size="15" minlength="2" maxlength="20"></td>
	  <th scope="row"><label for="mb_4">생년월일<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_4" value="<?php echo $mb['mb_4'] ?>" id="mb_4" readonly required class="picker required frm_input" size="15" ></td>
	...
	<tr>
        ...
        <td colspan="3" class="td_addr_line">
            ...
            <input type="text" name="mb_addr1" readonly value="<?php echo $mb['mb_addr1'] ?>" id="mb_addr1" class="frm_input readonly" size="60">
	...
	*/ ?>
    ...
    <tr>
        ...
        <td colspan="3">
				...
				<?
					$today_y = date('Y');
					for($i=($today_y-10); $i<$today_y+10; $i++){
				?>
				<option value=<?=$i?> <?if($today_y==$i) echo 'selected'?>><?=$i?></option>
				<?}?>
				</select>
				납부일시 : <input type="text" name="annual_date" class="picker" readonly>
				금액 : <input type="number" name="annual_value" >
				납부여부 : 
				<select name="annual_flg">
				<option value="납부">납부</option>
				<option value="미납부">미납부</option>				
				</select>
				비고:<input type="text" name="annual_text" size = "120">
		</td>
    </tr>  
    <tr>
...
this.form.mb_intercept_date.value=this.form.mb_intercept_date.defaultValue; }">
 ...
 <table  class="tbl_member">
	...
	*/ ?>
    ...
    <tbody>
    <?php
		$sql ="select * from g5_member_annualfee where mb_id  = '{$mb['mb_id']}' order by pay_year desc";
...
<div><input type="button" value="선택기록삭제" onclick="delete_fee()"></div>
...
$("input:checkbox[name='chkall']").change(function(){
