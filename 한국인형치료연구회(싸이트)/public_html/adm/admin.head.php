...
<?
	$sql ="select  * from g5_write_edu";
	$list_edu = sql_query($sql);
	...
	<div class="modal">		
		<div class="content">
			<div class="area_txt">			
				...
				<?
					for ($i=0; $row=sql_fetch_array($list_edu); $i++){	
				?>
					<tr><td><input type="radio" name="edu_list" value="<?=$row['wr_id']?>|<?=$row['wr_subject']?>|<?=$row['ca_name']?>"></td>
		...
		<div class="madal_ft">
			<a class="close trigger"  href ="#">닫기</a>
		</div>
  </div>
</div>
<!-- // 모달 -->
