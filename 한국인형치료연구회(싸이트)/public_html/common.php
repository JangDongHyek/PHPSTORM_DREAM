...
if($bo_table == "store"){
    // 인형은 order.skin.php에서 수정해줘야함

    $PAY_MID = "pgfigure1m";
    $PAY_MerchantKey = "l3cSfx3iMg/oQJH85N3kCVY5hqlHByN/jhMx60AVuUOE4j3ATIsk0xZ6VFgaW4BwR/m/aOZXUuDoV0Mro5IqmQ==";
...
// 한국인형
//------------------------------------------------------------------------------
define('G5_CSS_VER', 0.5);
define('G5_JS_VER', 0.5);
