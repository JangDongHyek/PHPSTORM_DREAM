...
<div class="lt">
    ...
    <?php for ($i=0; $i<count($list); $i++) {  ?>
        <li>
            ...
            if ($list[$i]['is_notice'])
                echo "<h3 class=\"strong\">".$list[$i]['subject']."</h3>";
    ...
    <div class="lt_more"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>"><span class="sound_only"><?php echo $bo_subject ?></span><div><i></i><i></i></div></a></div>
</div>
