...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <?
//            $down_link = ($is_member) ? $temp_file[0]['href'] : "javascript:alert('로그인이 필요합니다.')";
            $down_link = $temp_file[0]['href'];
            ?>
			<!-- 다운로드 -->
			<td class="td_download"><a href="<?=$down_link?>" class="btn_downloads"><em>다운받기</em></a></td>
			<!-- //다운로드 -->
        </tr>
        <?php } ?>
