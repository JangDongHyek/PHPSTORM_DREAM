...
$sql ="select * from g5_write_apply01 where wr_4='{$eduid}' and mb_id = '{$member['mb_id']}'";
...
<section id="bo_w">
	...
	<tr>
        ...
        <tr>
            ...
            <td><input type="text" name="wr_orderby" value="<?php echo $wr_orderby ?>" id="wr_orderby" class="frm_input" size="4" <?=$readonly?>></td>
        </tr>
        <?php } ?>
