...
<div id="bo_list" class="edu" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for ($i=0; $i<count($list); $i++) {
         ...
         ?>
        <tr style="cursor:pointer;" onClick="location.href='<?php echo $list[$i]['href'] ?>'" class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            <td class="td_num">
            <?php
            ...
            <td class="td_data02"><span class="m_data">교육기간</span><?=$list[$i]['wr_3']?>~<br><?=$list[$i]['wr_4']?></td>
