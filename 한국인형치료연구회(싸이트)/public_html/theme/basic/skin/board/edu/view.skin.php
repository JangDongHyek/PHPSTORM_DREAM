...
if(!($str_start > $str_now || $str_end < $str_now)){
    $a_href = "./write.php?bo_table=apply01&eduid=".$wr_id."&cate=".$view['ca_name'];
...
<div class="btn_confirm">
    ...
    <?}?>
		<?if($is_admin){?><a href="./write.php?bo_table=edu&wr_id=<?=$wr_id?>&certifyid=<?=$wr_id?>&w=u" class="btn_submit">수정</a><?}?>
