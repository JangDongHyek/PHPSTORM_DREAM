    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for ($i=0; $i<count($list); $i++) {
			 ...
			 switch($list[$i]['wr_5']){
				...
				$sql ="select * from g5_write_certify where wr_id = {$list[$i]['wr_4']}";
         ...
         ?>
        <tr style="cursor:pointer;" onClick="location.href='<?php echo G5_BBS_URL?>/board.php?bo_table=certify&wr_id=<?=$list[$i]['wr_4']?>'" class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            <td class="td_number">
            <?php
            ...
            <td class="td_subject">
                ...
                <!--<a href="<?php echo G5_BBS_URL?>/board.php?bo_table=certify&wr_id=<?=$list[$i]['wr_4']?>">-->
						<?=$info_wr['wr_subject']?>
                <!--</a>-->
...
<!-- 			<td class="td_status"><span class="cancle">취소</span></td> -->
<!-- 	<td class="td_status"><span class="npass">불합격</span></td> -->
