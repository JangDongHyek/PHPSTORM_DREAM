...
$sql ="select * from g5_write_apply03 where wr_4='{$eduid}' and mb_id = '{$member['mb_id']}'";
...
if(!empty($cnt_apply)){
    ...
    $sql = "select * from `g5_order_list` where `bo_table` = 'academy' and `wr_id` = '$eduid' and `write_id` = '$cnt_apply[wr_id]'";
...
$sql ="select * from g5_write_academy where wr_id = {$eduid}";
...
<section id="bo_w">
    ...
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" method="post"  autocomplete="off" style="width:<?php echo $width; ?>">
        ...
        <input type="hidden" name="wr_4" value="<?php echo $eduid ?>">
        ...
        <div class="bo_edu wr">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="paymentMethod" id="bankTransfer" onclick="toggleFields(true)" checked>
                        <label for="bankTransfer">무통장입금</label>
                    </td>
                </tr>

                <tr id="depositDateRow">
