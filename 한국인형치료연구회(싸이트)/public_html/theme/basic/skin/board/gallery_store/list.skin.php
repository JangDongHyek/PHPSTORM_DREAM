            ...
            <ul class="gall_con">
                ...
                <li class="gall_href">
                    ...
                    <?php } else {
                        ...
                        $thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], 850, 850);
//						$thumb = get_file($board['bo_table'], $list[$i]['wr_id']);
	//					print_r($thumb);
                        if($thumb['src']) {
                ...
                <li class="gall_text_href">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="title">
                        ...
                        <h6 class="price"><strong><?= (empty($list[$i]['wr_10'])) ? "0" : number_format($list[$i]['wr_10']); ?></strong>원</h6>
                    </a>
                    <a href="./order.php?bo_table=<?=$bo_table?>&wr_id=<?=$list[$i]['wr_id']?>" class="btn-order">결제하기</a>
                    <?php
