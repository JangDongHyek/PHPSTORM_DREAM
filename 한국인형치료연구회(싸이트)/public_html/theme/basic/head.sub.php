...
<link rel="shortcut icon" href="<?php echo G5_THEME_URL ?>/img/common/favicon.jpg"/>
...
<link href="<?php echo G5_THEME_CSS_URL; ?>/swiper.min.css" rel="stylesheet" type="text/css"><!--swiper-->
...
<link href="<?php echo G5_THEME_CSS_URL; ?>/main.css?v=<?=G5_CSS_VER?>" rel="stylesheet" type="text/css"><!--메인컨텐츠-->
<link href="<?php echo G5_THEME_CSS_URL; ?>/sub.css?v=<?=G5_CSS_VER?>" rel="stylesheet" type="text/css"><!--서브페이지-->
<link href="<?php echo G5_THEME_CSS_URL; ?>/common.css" rel="stylesheet" type="text/css"><!--공통-->
<link href="<?php echo G5_THEME_CSS_URL; ?>/datepicker.min.css" rel="stylesheet" type="text/css"><!--데이트피커-->
...
<script src="<?php echo G5_THEME_JS_URL ?>/datepicker.min.js"></script><!--데이트피커-->
<!-- <script src="<?php echo G5_THEME_JS_URL ?>/datepicker.en.js"></script> -->
<!--데이트피커영문-->
