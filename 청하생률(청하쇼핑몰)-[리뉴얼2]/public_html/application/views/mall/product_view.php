	...
	<div class="area_top">
		...
		<div class="area_text">
			...
			<div class="option">
				<dl>
					<dt>기본가격</dt>
					<dd><strong class="txt_orange">9,000원</strong></dd>
				</dl>
				<dl>
					<dt>구매수량</dt>
					<dd>
				...
				<dl style="display: none;">
					...
					<dd>
						<select name="option" onchange="addOption(this)">
							...
							<option value="2725" data-name="1박스(30포)" data-price="39,600">1박스(30포) (+39,600원)</option>
							<option value="2726" data-name="5박스(150포)" data-price="198,000">5박스(150포) (+198,000원)
							</option>
							<option value="2727" data-name="10박스(300포)" data-price="363,000">10박스(300포) (+363,000원)
							</option>
						</select>
					</dd>
				</dl>
				<ul class="optionlist" style="display: none;">
					<li>
						...
						<div class="flex">
							...
							<strong class="op_price">39,600원</strong>
			...
			<div class="total">
				<div class="total_price">
					...
					<p class="price txt_green">353,500원</p>
				</div>
				<div class="btn_wrap">
					<a class="btn btn_middle btn_greenline">장바구니 담기</a>
					<a class="btn btn_middle btn_green">바로 주문</a>
				</div>
		...
		<div role="tabpanel">
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li role="presentation"><a href="#tab-review" aria-controls="tab-review" role="tab" data-toggle="tab">상품후기<strong
								class="txt_orange">(21)</strong></a></li>
				<li role="presentation"><a href="#tab-qna" aria-controls="tab-qna" role="tab"
										   data-toggle="tab">상품문의<strong class="txt_orange">(21)</strong></a></li>
			</ul>

			<!-- Tab panes -->
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="tab-view">...</div>
				...
				<div role="tabpanel" class="tab-pane" id="tab-review">
					...
					<div class="board_list">
						<p>총 <strong class="txt_green">6</strong>개 </p>
						<ul>
