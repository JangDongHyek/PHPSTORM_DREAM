...
<!--
						<li class="gnb_1dli">
							<a href="<?=PROJECT_URL?>/medicinal"  class="gnb_1da new">한방약재</a>
							<ul class="gnb_2dul">
								<li class="gnb_2dli"><a href="<?=PROJECT_URL?>/product" class="gnb_2da">한방약재</a></li>
							</ul>
						</li>
-->
                        
                        <li class="gnb_1dli"><a href="<?=PROJECT_URL?>/greet" class="gnb_1da ">회사소개</a></li>
                        <li class="gnb_1dli"><a href="<?=PROJECT_URL?>/medicinal" class="gnb_1da ">제품소개</a></li>
                        ...
                        <li class="gnb_1dli"><a href="<?=PROJECT_URL?>/mypage" class="gnb_1da ">내정보수정</a></li>
					</ul>
				</div>
			</div>
		</div>
