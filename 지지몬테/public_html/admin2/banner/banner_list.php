				...
				<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
					...
					<td width="100%" bgcolor="#FFFFFF" valign="top">
						...
						<table border="0" width="95%">
									...
									<tr>
										<td width="100%" bgcolor="#e7e7e7" colspan="3">
											...
											<table border="0" width="100%" cellspacing="0" cellpadding="0">
												...
												<td width="50%"><p align="right"><input class="aa" onclick="window.location.href='banner_write_new.php'" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type="button" value="배너 등록">&nbsp;&nbsp;&nbsp;<input class="aa" onclick="window.location.href='banner_order.php'" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type="button" value="순서조정"></td>
												</tr>
											</table>
										</td>
									</tr>
						  ...
						  ");
						  if($if_flash == 0){
							 if($img!='') echo "<a href='$ary[link]' target='_blank'><img src='$Co_img_DOWN$mart_id/$img' width='$img_width' height='$img_height' border='0'></a>";
						  }
						  else{
