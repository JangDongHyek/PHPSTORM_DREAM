		...
		<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
			...
			<tr>
			  ...
			  <table width="95%" border="0" align="center">
				 ...
				 <tr>
					<td colSpan="2">&nbsp;&nbsp;<b>날짜 : <?=$QryFromDate1?> ~ <?=$QryToDate1?></b>
					</td>
				 </tr>
			  </table>
			  </td>
...
?>
			...
			<tr height='30'>
				<td><input  onclick="location.href='inmall_cal_list.php?page=<?=$page1?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&QryFromDate=<?=$QryFromDate1?>&QryToDate=<?=$QryToDate1?>'" class='butt_none' style='width:60' type="button" style='cursor:hand' value="리스트"></td>
			</tr>
			<tr align="middle">
