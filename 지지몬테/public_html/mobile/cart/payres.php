...
include "../../market/include/getmartinfo.php";
	...
	*/
	...
	$configPath = "/home/zzmonte2r/public_html/mobile/cart/lgdacom"; //LG유플러스에서 제공한 환경파일("/conf/lgdacom.conf,/conf/mall.conf") 위치 지정. 
	...
	$tran_phone1 = "010-4761-7717";//받는 사람 번호 관리자
	$tran_callback1 = "010-4761-7717";//보내는 사람 번호



	$send_date = date("YmdHis");
	$mart_id = "zzmonte2r";
	$tran_msg1 = "[운곡한약품]주문번호:$order_num 주문이 들어왔습니다.";
