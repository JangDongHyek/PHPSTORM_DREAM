...
?>
	  ...
	  <td height="500">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="30" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>판매통계 > 기간별</b></td>
				</tr>
			</table>
			...
			<table border="1" cellpadding="5" cellspacing="0" width="100%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
              <tr>
                <td width="90%" bgcolor="#FFFFFF">판매에 대한 통계로써, 조건별로 검색하실 수 있습니다. 조건별 통계를 이용하여 이동하세요.<br>
                  배송완료된 상품만 통계에 포함됩니다.</td>
              </tr>
              <tr>
                                ...
                                <tr>
                                  <td width="100%" bgcolor="#F7F7F7" height="20"><table border="0" width="100%" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="67%" height="25" align="right"><select name="select" size="1" style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; height: 18px" onChange="goto_byselect(this, 'self')">
...
?>
                                              <form id=form1 name=form1 method=post onSubmit='return checkform(this)'>
                                                ...
                                                <tr>
                                                  <td width="100%" bgcolor="#E9F5F5" height="30"><table border="0" width="100%">
                                                              <tr>
                                                                <td width="7%"><input type="radio" value="month" name="out_form" <?if($out_form == 'month') echo "checked"?>>                                                                </td>
                                                                <td width="93%" colspan="2">기간을 정하여 검색합니다.</td>
                                                              </tr>
                                                              <tr>
                                                                <td width="7%"></td>
                                                                <td width="28%"><input name="QryFromDate" value="<?=$QryFromDate?>" class="input_03" size="8">
                                                                    <font color="#3d918a">~</font>
                                                                    <input name="QryToDate" value="<?=$QryToDate?>" class="input_03" size="7">
                                                                  &nbsp; &nbsp; </td>
                                                                <td width="70%"><input name="button" type='button' class='butt_none' style='width:40' onClick="fn_betdate('QryFromDate', 'QryToDate', 'M:1')" value='1개월'>
                                                                  &nbsp;
                                                                  <input name="button" type='button' class='butt_none' style='width:40' onClick="fn_betdate('QryFromDate', 'QryToDate', 'M:2')" value='2개월'>
                                                                  &nbsp;
                                                                  <input name="button" type='button' class='butt_none' style='width:40' onClick="fn_betdate('QryFromDate', 'QryToDate', 'M:3')" value='3개월'>
                                                                  &nbsp;
                                                                  <input name="button" type='button' class='butt_none' style='width:40' onClick="fn_betdate('QryFromDate', 'QryToDate', 'M:4')" value='4개월'>
                                                                  &nbsp;
                                                                  <input name="button" type='button' class='butt_none' style='width:40' onClick="fn_betdate('QryFromDate', 'QryToDate', 'M:5')" value='5개월'>
                                                                  &nbsp;
                                                                  <input name="button" type='button' class='butt_none' style='width:40' onClick="fn_betdate('QryFromDate', 'QryToDate', 'M:6')" value='6개월'>
                                                                  &nbsp;
                                                                  <input name="button" type='button' class='butt_none' style='width:40' onClick="fn_betdate('QryFromDate', 'QryToDate', 'M:12')" value='12개월'>                                                                </td>
                                                              </tr>
                                                              <tr>
                                                                <td width="7%" height="8"><input type="radio" value="day" name="out_form" <?if($out_form == 'day'||$out_form == '') echo " checked"?>>                                                                </td>
                                                                <td width="80%" colspan="2">월단위로 검색합니다.</td>
                                                              </tr>
                                                              <tr>
                                                                <td width="7%" height="8"></td>
                                                                <td width="80%" colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                      <td width="19%"><input name="QryMonth" value="<?=$QryMonth?>" class="input_03" size="7">                                                                      </td>
                                                                      <td width="81%"><input name="image" type='image' style='cursor:hand' src="../images/ggo.gif" width="39" height="18" border="0">                                                                      </td>
                                                                    </tr>
                                                                </table></td>
                                                              </tr>
                                              </form>
					 ...
					 <tr>
						<td width="90%" height="2"><table border="0" width="100%" cellspacing="0" cellpadding="0">
						  <tr>
...
if($out_form == 'day'||$out_form == ''){
	...
	for($i=0;$i<$numRows;$i++){
		...
		$opt_price=$ary[opt_price]+$ary[opt_price2]+$ary[opt_price3]+$ary[opt_price4];
		$sum_tot += $sum+$opt_price;	
	}
								...
								<tr>
								  ...
								  <table border='0' width='100%' cellspacing='0' cellpadding='0'>
									 <tr>
										...
										<td width='61%' height='25' align='right'><b><font color='#000000'>총매출 : <?=$sum_tot_str?>원 (<?=$numRows?>건)</font></b></td>
									 </tr>
								  </table>								  </td>
								</tr>
								<tr>
...
for($j=1;$j<=$end_day;$j++){
	...
	$SQL = "select order_num, z_price, quantity,opt_price,opt_price2,opt_price3,opt_price4 from $Order_ProTable where date='$query_date' and mart_id='$mart_id' and status*1>0";
	$dbresult = mysql_query($SQL, $dbconn);
	$numRows = mysql_num_rows($dbresult);
	...
	for($i=0;$i<$numRows;$i++){
		...
		$opt_price=mysql_result($dbresult,$i,3);
		$opt_price2=mysql_result($dbresult,$i,4);
		$opt_price3=mysql_result($dbresult,$i,5);
		$opt_price4=mysql_result($dbresult,$i,6);
		...
		$opt_tot=$opt_price+$opt_price2+$opt_price3+$opt_price4;
		
		$sum = ($z_price * $quantity)+$opt_tot;
...
if($out_form == 'month'){
	...
	$SQL = "select T1.z_price, T1.quantity,T1.opt_price,T1.opt_price2,T1.opt_price3,T1.opt_price4 from $Order_ProTable T1, $Order_BuyTable T2 where T1.mart_id='$mart_id' and T2.mart_id='$mart_id' and T2.status='3' and T1.order_num=T2.order_num and ( T2.date >= '$QryFromDate1' and T2.date <= '$QryToDate1' )"; //배송완료
	$dbresult = mysql_query($SQL, $dbconn);
	$numRows = mysql_num_rows($dbresult);
	$sum_tot = 0;
	$quantity_total = 0;
