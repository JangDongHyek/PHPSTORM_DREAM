...
<input type="hidden" name="ss[search_mode]" value="category">
	<tr>
	  <td bgcolor="ffffff"><div align="left" style="font-size:13px;">상품명 <?php /*?><input type='radio' name='ss[search_field]' value='item_name' <?if(($select_key=="item_name") || (!$select_key)){ echo "checked";}?>>&nbsp;&nbsp;&nbsp;제조사(브랜드)<?php */?>
