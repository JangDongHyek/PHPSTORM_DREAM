...
<div id="floater" style='position:absolute; margin:0px auto; padding:0px 0px 0px 0px; top:0px; left:50%; z-index:1;'>
<div style='position:absolute; top:238px; left:510px; width:94px;'>
<table width="94" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;">
  <tr>
    <td width="94"><img src="../images/banner_1.gif" width="94" /></td>
  </tr>
  <tr>
    <td width="94"><img src="../images/banner_2.gif" width="94" onClick="upPrdWings(prdWings)" style="cursor:hand" /></td>
  </tr>
  <tr>
    <td width="94" height="238" bgcolor="#FFFFFF">
			<div style="position:relative; height:238px; width:94px; overflow-x:hidden; overflow-y:hidden;">
				<table width="94" id="prdWings" cellpadding="0" align="left" cellspacing="0" border="0" style="position:absolute; table-layout:fixed;">
					<tr>
						<td height=1></td>
					</tr>
		<?
		...
		?>
					...
					<tr>
						<td>
							<table width="94" border="0" cellspacing="0" cellpadding="0" style='border:1 solid #CCCCCC;'>
								<tr>
  ...
  <tr>
    <td><a target='_self' href="../main/" onClick="this.style.behavior='url(#default#homepage)';this.setHomePage('<?=$home_dir?>');"><img src="../images/banner_4.gif" width="94" height="16"  border="0"></a></td>
  </tr>
    <tr>
      <td><img src="../images/banner_5.gif" width="94" height="16"  border="0" onClick="myFavorite();" style="cursor:hand;"></td>
    </tr>
    <tr>
