	...
	<tr>
		...
		<td height="70">
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
        		<tr>
        			<td align="center"><img src="../image/blank/title_6.gif"></td>
        		</tr>
        	</table>
		</td>
		<td width="10" rowspan="3"></td>
									...
									<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
										...
										<input type='hidden' name='flag' value='<?=$flag?>'>
											<td height="30" align="center">
												...
												<input type='image' src="../image/bu_search3.gif" border="0" align="absmiddle" onfocus='blur();'></a>
											</td>
										</form>
										</tr>
									</table>
...
?>
										<tr>
											<td class="text_name"><img src="../image/icon_4.gif" align="absmiddle"><a href="javascript:ReturnFocus('<?=$zipcode?>','<?=$sido?> <?=$gugun?> <?=$dong?>','<?=$bunji?>')"><?=$sido?> <?=$gugun?> <?=$dong?> <?=$bunji?></a></td>
...
?>
	...
	<tr>
		<td height="50">
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
        		<tr>
					<td align="center"><img src="../image/bu_close.gif" style="cursor:hand;" onClick="window.close()"></td>
