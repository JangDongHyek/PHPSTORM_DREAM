...
for($i=0;$i<sizeof($itemIds);$i++){
	...
	$product_info_url="http://www.hangphone.co.kr/market/main/product_info.html?mart_id=nbmss&category_num=$rows[category_num]&item_no=$itemIds[$i]";
	?>
	<item id="<?=$id?>">
	<name><![CDATA[<?=$name?>]]></name>
	<url><![CDATA[<?=$product_info_url?>]]></url>
	<description><![CDATA[<?=$description?>]]></description>
	<image>http://www.hangphone.co.kr/co_img/nbmss/<?=$rows[img_big]?></image>
	<thumb>http://www.hangphone.co.kr/co_img/nbmss/<?=$rows[img_sml]?></thumb>
	<price><?=$price?></price>
