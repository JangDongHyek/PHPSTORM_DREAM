...
if($paymethod == 'bycard' || $paymethod == 'bycard_point' ){
	...
	/*if($_SERVER['REMOTE_ADDR']=="183.103.22.103"){
		$url="http://www.gigimonte.co.kr/market/cart/innopay.html";
	}else{
		$url="http://www.gigimonte.co.kr/market/cart/card_account_xpay.html";
	}*/
	$url="/market/cart/innopay.html";
	echo "
		<script language = 'javascript'>
		<!--
		...
		<input type='hidden' name='Ret_URL' value='http://www.gigimonte.co.kr/market/cart/order_ok_new.html?mart_id=$mart_id&category_num=$category_num&category_num1=$category_num1&category_num2=$category_num2&cate_num=$cate_num&flag=$flag&item_no=$item_no&provider_id=$provider_id&paymethod=$paymethod&use_bonus_tot=$use_bonus_tot'>
		<input type='hidden' name='note_url' value='http://www.gigimonte.co.kr/market/cart/note_url.php'>
...
if($paymethod == 'byaccount' || $paymethod == 'byaccount_point' ){
	...
	echo "
		...
		<input type='hidden' name='OrderID' value='$order_num'>
		<input type='hidden' name='Amount' value='$mon_tot_freight'>
		<input type='hidden' name='Ret_URL' value='http://www.gigimonte.co.kr/market/cart/order_ok.html?mart_id=$mart_id&category_num=$category_num&category_num1=$category_num1&category_num2=$category_num2&cate_num=$cate_num&flag=$flag&item_no=$item_no&provider_id=$provider_id&paymethod=$paymethod'>
		<input type='hidden' name='note_url' value='http://www.gigimonte.co.kr/market/cart/note_url.php'>
		<input type='hidden' name='Name' value='$name'>
