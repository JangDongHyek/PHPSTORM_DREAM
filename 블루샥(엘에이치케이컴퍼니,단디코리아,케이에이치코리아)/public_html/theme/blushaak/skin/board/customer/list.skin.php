...
$wr_10Arr=array(""=>"접수","ing"=>"진행중","true"=>"답변완료");
$wr_10CssArr=array(""=>"answer-receipt","ing"=>"answer-ing","true"=>"answer-success");
?>
<style>
.answer-success{
	font-weight:bold;
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
			...
			<td align="center">
				<a class="<?php echo $wr_10CssArr[$list[$i][wr_10]]?>">
					 <?php echo $wr_10Arr[$list[$i][wr_10]]?>
				</a>
			</td>
