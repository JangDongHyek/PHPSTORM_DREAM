...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div class="clearfix header">       
            <div class="col-md-5 text-center r_padding60">
            ...
            <div class="col-md-7" style="padding:0 20px">
                   	<p class="pro_name"><img src="<?php echo G5_THEME_URL; ?>/img/common/logo.png" alt="블루샥" height="30PX"><?=$view['wr_5']?></p><!-- 매장명  -->
                    <p class="pro_size"><span>CONTURY </span>카테고리</p> <!-- 카테고리 -->
                    <p class="pro_size"><span>ADDRESS </span><?=$view['wr_subject']?></p> <!-- 매장 주소 -->
                    <p class="pro_size"><span>TEL</span><?=$view['wr_1']?></p> <!-- TEL -->
                    <p class="pro_size"><span>OPEN </span>&nbsp;<?=$view['wr_2']?></p> <!-- OPEN -->
                    <p class="pro_size"><span>SERVICE </span>&nbsp;<?=$view['wr_2']?></p><!-- SERVICE -->
        ...
        <div class="wrapper" style="padding: 20px">
                   	<p class="pro_name">Location</p>
			<!-- * 카카오맵 - 지도퍼가기 -->
<!-- 1. 지도 노드 -->
<div id="daumRoughmapContainer1678776435878" class="root_daum_roughmap root_daum_roughmap_landing" style="width: 100%"></div>
...
{
    window.open(href, "boardmove", "left=50, top=50, width=400, height=550, scrollbars=1");
}
</script>
