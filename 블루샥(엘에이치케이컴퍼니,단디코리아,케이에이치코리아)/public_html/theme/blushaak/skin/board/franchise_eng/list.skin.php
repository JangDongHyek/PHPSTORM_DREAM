...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl">
        <option value="wr_5"<?php echo get_selected($sfl, 'wr_5', true); ?>>Name</option>
...
<!-- } 게시물 검색 끝 -->
	...
	<div id="new_list">
		<div class="store_item"> <!--요소 반복-->
            ...
            <?php } ?>
				<div class="txt_area">
					<p class="title" style="">
						<span>CONTURY</span>NAME
					</p>
					<p class="address">
						ADDRESS
					</p>
					<p class="tel">
						<span><i class="far fa-phone-rotary"></i> </span> 000-0000-0000</p>
				</div>
				<div class="btn_area">
					<div class="btn">
						<span>
    ...
    <ul id="gall_ul">
            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="title">
                       <h6><?php echo $list[$i]['wr_5'] ?></h6><!-- 제품명 -->
                        <p class="pro_code"><?php echo $list[$i]['subject'] ?><!-- 코드 --></p>
                        <p class="pro_price color_red">￦ <?php echo $list[$i]['wr_1'] ?><!-- 가격 --></p>
                    </a>
                    <?php
        ...
        <?php } ?>
        <?php if (count($list) == 0) { echo "<li class=\"empty_list\">No search results found.</li>"; } ?>
    </ul>
