                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="area">
                        ...
                        <ul id="sido-search">
							...
							<li onclick="ajaxStoreSearch('DT')">드라이브스루</li>
                        </ul>
                        <div class="list">
...
<!--	<script type="text/javascript">flashWrite('<?php echo $board_skin_path; ?>/img/fran_area.swf','778','293')</script>-->
		...
		<legend>게시물 검색</legend>
			...
			<form name="fsearch" method="get">
				...
				<div class="shop_search">
					...
					<input type="submit" value="가맹매장 찾기" class="sch_btn">
				</div>
			</form>
	</fieldset>
	<!-- 게시물 검색 끝 } -->
    ...
    <div class="bo_fx">
        <div id="bo_list_total">
            <span style="font-size:11pt; font-weight:bold;"><?php if(!$si) echo "전체"; else echo $si." ".$gu." ".$dong; ?> 가맹매장 현황 <?php echo number_format($total_count) ?> 개</span>
            <?php echo $page ?> 페이지
        </div>
		...
		<div class="list_store">
			<dl>
				...
				<dd>
					...
					<ul class="fa-ul info">
                        <li><i class="fa-li fal fa-map-marker" aria-hidden="true"></i><strong>주　　소</strong> <span><?php echo $list[$i]['wr_1']; ?> <?php echo $list[$i]['wr_2']; ?></span></li>
                        <li><i class="fa-li fal fa-phone" aria-hidden="true"></i><strong>전화번호</strong> <span><?php echo $list[$i]['wr_4']; ?></span></li>
                        <li><i class="fa-li fal fa-car" aria-hidden="true"></i><strong>주차여부</strong> <span><?php echo $list[$i]['wr_6']; ?></span></li>
					</ul>
				</dd>
			</dl>
		</div>
