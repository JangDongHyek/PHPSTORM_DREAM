...
<aside id="bo_vc_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <div class="flex">
                <input type="text" name="wr_3[]" value="" class="frm_input tel"> -
                <input type="text" name="wr_3[]" value="" class="frm_input tel"> -
                <input type="text" name="wr_3[]" value="" class="frm_input tel">
                </div>
            </td>
		...
		<tr>
            <th scope="row"><label for="wr_count"><span class="check">*</span>동반자</label></th>
            <td><input type="text" name="wr_count" value="0" id="wr_count" class="frm_input"  maxlength="100">명</td>
        </tr>
