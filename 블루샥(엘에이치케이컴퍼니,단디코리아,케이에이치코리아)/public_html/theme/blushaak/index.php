...
<article>
   <div class="m_call wow fadeInUp" data-wow-delay="0.4s" style="padding: 0">
           <img src="<?php echo G5_THEME_IMG_URL;?>/main/main_quick01.jpg" alt="">
           <div class="menu_roll">
               <a href="https://블루샥.com" target="_blank" class="" style="color:#fff !important" data-transition="slide"><img src="<?php echo G5_THEME_IMG_URL;?>/main/main_quick02.jpg" alt=""></a>
           </div>
           <!--<p class="t1 text-center"><a href="https://블루샥.com" target="_blank" class="" style="color:#fff !important" data-transition="slide"><?php /*echo $config['cf_title']; */?> 창업상담&nbsp;<i class="fa fa-phone-square"></i></a></p>
                        ...
                        <div class="mbanner_list">
                            <ul>
                                ...
                                <li class="wow fadeInDown" data-wow-delay="0.9s">
                                     ...
                                     <p class="cont text-center"> 깊은 바디감의 진한 “나이트”<br />
부드럽고 산미가 느껴지는 “썬셋” <br />
"디카페인" 세가지 스타일의<br />
고품질 스폐셜 원두를 사용합니다.</p>
                                </li>
...
<section id="section3" class="cd-section">
	<div class="content-wrapper">
            ...
            <ul>
                <li>
                    <figure class="snip1425">
                      ...
                      <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu01"></a>
                    </figure>
                </li>
                <li>
                    <figure class="snip1425">
                ...
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">블루베리 요거트</h2>
                      <img src="<?php echo G5_THEME_IMG_URL;?>/main/port04.jpg" alt="" />
                      <figcaption><i class="fal fa-plus"></i>
                        <h4>Beverage</h4>
                        <h2>블루베리 요거트</h2>
                      </figcaption>
                      <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu03"></a>
                    </figure>
                </li>
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">민트 초코 프라페</h2>
                ...
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">월넛 초코 쿠키</h2>
                      <img src="<?php echo G5_THEME_IMG_URL;?>/main/port07.jpg" alt="" />
                      <figcaption><i class="fal fa-plus"></i>
                        <h4>Dessert</h4>
                        <h2>월넛 초코 쿠키</h2>
                      </figcaption>
                      <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu04"></a>
                    </figure>
                </li>
                <li>
                    <figure class="snip1425">
        ...
        <div class="t_margin30"><p class="more"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu01">+ 더 보기</a></p></div>
	</div>
</section>
<!-- //포트포리오 -->
                ...
                <div class="pt_150">    
                    <div class="direct_wrap02">
                        <div class="map_box02 wow fadeInRight" data-wow-delay="0.2s">
                            <!-- * Daum 지도 - 지도퍼가기 -->
                            <!-- 1. 지도 노드 -->
                            <div id="daumRoughmapContainer1636938981483" class="root_daum_roughmap root_daum_roughmap_landing" style="width:100% !important"></div>
                        ...
                        <div class="direct_box02 wow fadeInLeft" data-wow-delay="0.3s">
                            <ul class="direct_ul02">
                                <li><i class="fal fa-home-lg"></i><strong><?php echo $config['cf_title']; ?> 주식회사 단디코리아 - [SEOUL]</strong></li>
                ...
                <div class="">    
                    <div class="direct_wrap">
                        <div class="map_box wow fadeInLeft" data-wow-delay="0.2s">
                            <!-- * Daum 지도 - 지도퍼가기 -->
                            <!-- 1. 지도 노드 -->
                            <div id="daumRoughmapContainer1636939086601" class="root_daum_roughmap root_daum_roughmap_landing" style="width:100% !important"></div>
                        ...
                        <div class="direct_box wow fadeInRight" data-wow-delay="0.3s">
                            <ul class="direct_ul">
                                <li><i class="fal fa-home-lg"></i><strong><?php echo $config['cf_title']; ?> - [BUSAN]</strong></li>
                                <!--<li><i class="fal fa-user-check"></i><?php echo $config['cf_2_subj']; ?><?php echo $config['cf_2']; ?></li>
                                <li><i class="fal fa-phone-square"></i><?php echo $config['cf_3_subj']; ?><?php echo $config['cf_3']; ?></li>
                                <li><i class="fal fa-phone-square"></i><?php echo $config['cf_4']; ?> (프랜차이즈 창업 전문상담) </li>	-->	
                                <li><i class="fal fa-envelope-open"></i><?php echo $config['cf_6']; ?></li>
