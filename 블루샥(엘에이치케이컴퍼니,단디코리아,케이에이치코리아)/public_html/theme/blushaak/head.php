...
<div id="sitemap">
   ...
   <nav class="menu"> 
      ...
      <div class="menu_header">
         ...
         <div class="m_gmenu"><a href="<?php echo G5_URL ?>"><span>KOR</span></a><a href="<?php echo G5_URL ?>/eng"><span class="noncheck">ENG</span></a><a href="<?php echo G5_URL ?>/jpn"><span class="noncheck">JPN</span></a></div>
      ...
      <div class="menu_add t_margin30">
           ...
           <p class="copyright">COPYRIGHTⓒ2020 <?php echo $config['cf_title']; ?>. ALL RIGHTS RESERVED.</p>
      </div>
...
<div id="hd">
    <div class="gmenu fs">
                        <dl>
                                 <dt>KOR</dt>
                                    <dd>
                                      <a href="<?php echo G5_URL ?>">KOR</a>
                                      <a href="<?php echo G5_URL ?>/eng">ENG</a>
                                      <a href="<?php echo G5_URL ?>/jpn">JPN</a>
                                   </dd>
                        </dl>
    </div>
    <script>
...
<? if(defined('_INDEX_')) {?>
		...
		<? if($co_id == "introduce01" || $co_id == "introduce01_test" || $co_id == "introduce02" || $co_id == "introduce03" || $co_id == "introduce03_02" || $co_id == "menu01" || $co_id == "menu02" || $co_id == "menu03" || $co_id == "menu04"  || $co_id == "menu05" ||$co_id == "franchise01" ||$co_id == "franchise02" ||$co_id == "franchise03" ||$co_id == "introduce_app") {  ?>
        <div id="container100">
        <? }else if($bo_table == "" || $co_id == ""){ 
		?>
