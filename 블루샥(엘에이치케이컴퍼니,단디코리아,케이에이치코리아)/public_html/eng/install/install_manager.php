...
function setAuto(){
	...
	if(st == "success"){
		...
		document.getElementById("mysql_user").value = "<?php echo $account;?>";
		document.getElementById("mysql_db").value	= "<?php echo $account;?>";
		document.getElementById("mysql_pass").value = "sbtpsxja!@#";
		document.getElementById("admin_pass").value = "admin0808";
		document.getElementById("admin_email").value = "admin@domain.com";

		document.getElementById("super_pass").value = "3001";
