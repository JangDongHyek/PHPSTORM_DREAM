...
<div id="ft" class="clearfix">
  <div class="ft_area clearfix">
    <div class="flogo col-md-7">
        ...
        <?php echo $config['cf_6_subj']; ?> sales@dandikorea.com<?php /*echo $config['cf_6']; */?><br />
        Corporate Registration Number <?php echo $config['cf_3']; ?><br />
        <?php echo $config['cf_7_subj']; ?> 2nd floor, 246-14, Neung-dong, Gwangjin-gu, Seoul<br />
        <?php echo $config['cf_1_subj']; ?>
        <?php echo $config['cf_10_subj']; ?>#1907, IS Tower, 60 Centumbuk-daero, Haeundae-gu, Busan&nbsp;&nbsp;
    ...
    <div id="ft_copy" class="hidden-md hidden-lg">
        ...
        <!--상호-->
        <!--기본정보-->
        <?php echo $config['cf_2_subj']; ?>Dandi Korea Co., Ltd. – Blu Shaak <br />
        <!--<?php echo $config['cf_5_subj']; ?> <?php echo $config['cf_5']; ?><br />-->
        <?php echo $config['cf_6_subj']; ?> <?php echo $config['cf_6']; ?><br />
        Corporate Registration Number <?php echo $config['cf_3']; ?><br />
        <?php echo $config['cf_7_subj']; ?> 2nd floor, 246-14, Neung-dong, Gwangjin-gu, Seoul<br />
        <?php echo $config['cf_1_subj']; ?> #1907, IS Tower, 60 Centumbuk-daero, Haeundae-gu, Busan<br />
        <!--<p class="fmenu t_margin15">사이트이용약관&nbsp;&nbsp;<span>|</span>&nbsp;&nbsp;개인정보처리방침</p>-->
    ...
    <div class="col-md-3 bottom_pro hidden-sm hidden-xs t_margin40">
        <p class="tel"><span>Franchise Inquiry</span><br />+82 10-6555-0662</p>
        <p class="fax">E-mail : sales@dandikorea.com<?php /*echo $config['cf_6']; */?><!--<br />E-mail : <?php echo $config['cf_7']; ?>--></p>
    </div>
    ...
    <div class="col-md-2 t_margin40">
      ...
      <div class="bottom_sns clearfix">
         <div><a class="twitter" style="color:#fff" href="<?php echo G5_BBS_URL; ?>/write.php?bo_table=b_qna_eng"><i class="fal fa-pen"></i>Franchise Inquiry</a></div>
         <div class="t_margin5"><a class="facebook" style="color:#fff" href="<?php echo G5_BBS_URL; ?>/content.php?co_id=franchise01_eng"><i class="fal fa-building"></i>Procedure of opening</a></div>
      </div>
    </div>
