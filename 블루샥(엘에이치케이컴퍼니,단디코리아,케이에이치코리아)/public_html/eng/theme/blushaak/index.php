...
<section id="section1" class="cd-section wow fadeInUp">
	<div class="content-wrapper">
        ...
        <div class="slogan">
           ...
           <p class="t2 text-left wow fadeInDown" data-wow-delay="0.5s"><span>Carefully brewed from the<br /> finest materials with our utmost sincerity. </span></p>
           <!--<p class="bar wow bounceIn"  data-wow-delay="1.3s"></p>-->
        </div>
        
        <!--공지추출-->
        <div class="m_latest wow fadeInUp" data-wow-delay=".2s">
            <?php echo latest("theme/basic", "b_news_eng", "1", "30");?>
        </div>
...
<article>
   <div class="m_call wow fadeInUp" data-wow-delay="0.4s">
           <p class="t1 text-center"><a href="<?php echo G5_BBS_URL ?>/content.php?co_id=company" class="" style="color:#fff !important" data-transition="slide">Franchise Inquiry&nbsp;<i class="fa fa-phone-square"></i></a></p>
...
<section id="section2" class="cd-section wow fadeInUp" data-wow-delay="0.1s">
	<div class="content-wrapper">
        ...
        <p class="ht wow fadeInDown t_padding20" data-wow-delay="0.5s">Blu Shaak boosts the success of the store owner.</p>
		<p class="wow fadeInUp">Blu Shaak provides the best consulting and service suited for the environment of the store owner.</p>
                        ...
                        <div class="mbanner_list">
                            <ul>
                                <li class="wow fadeInDown" data-wow-delay="0.6s">
                                     ...
                                     <p class="cont text-center">Blu Shaak provides integrated service of competitive brand design and marketing to store owners.</p>
                                </li>
                                <li class="wow fadeInDown" data-wow-delay="0.7s">
                                     ...
                                     <p class="cont text-center">Blu Shaak is constantly researching and developing to improve BLU SHAAK.</p>
                                </li>
                                <li class="wow fadeInDown" data-wow-delay="0.8s">
                                     ...
                                     <p class="cont text-center">Blu Shaak values mutually beneficial win-win cooperation with the store owner more than anything else.</p>
                                </li>
                                <li class="wow fadeInDown" data-wow-delay="0.9s">
                                     ...
                                     <p class="cont text-center">Blu Shaak uses three types of high-quality special coffee beans: Rich “Night” with a deep body, “Sunset” with a soft and acidic taste, and “decaffeinated”</p>
                                </li>
                            </ul>
                        </div>
...
<section id="section3" class="cd-section">
	<div class="content-wrapper">
		<h2 class="wow bounceIn" data-wow-delay="0.3s">Blu Shaak Menu</h2>
            ...
            <ul>
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">Shaak Latte</h2>
                      <img src="<?php echo G5_THEME_IMG_URL;?>/main/port01.jpg" alt="" />
                      <figcaption><i class="fal fa-plus"></i>
                        <h4>Coffee</h4>
                        <h2>Shaak Latte</h2>
                      </figcaption>
                      <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu01_eng"></a>
                    </figure>
                </li>
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">Ice americano</h2>
                ...
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">Blueberry Yogurt</h2>
                      <img src="<?php echo G5_THEME_IMG_URL;?>/main/port04.jpg" alt="" />
                      <figcaption><i class="fal fa-plus"></i>
                        <h4>Beverage</h4>
                        <h2>Blueberry Yogurt</h2>
                      </figcaption>
                      <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu02_eng"></a>
                    </figure>
                </li>
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">Valrhona Mint Choco Frappe</h2>
                      <img src="<?php echo G5_THEME_IMG_URL;?>/main/port05.jpg" alt="" />
                      <figcaption><i class="fal fa-plus"></i>
                        <h4>Tea</h4>
                        <h2>Valrhona Mint Choco Frappe</h2>
                      </figcaption>
                      <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu02_eng"></a>
                    </figure>
                </li>
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">Mango Banana Frappe</h2>
                      <img src="<?php echo G5_THEME_IMG_URL;?>/main/port06.jpg" alt="" />
                      <figcaption><i class="fal fa-plus"></i>
                        <h4>Tea</h4>
                        <h2>Mango Banana Frappe</h2>
                      </figcaption>
                      <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu02_eng"></a>
                    </figure>
                </li>
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">Hazelnut financier</h2>
                      <img src="<?php echo G5_THEME_IMG_URL;?>/main/port07.jpg" alt="" />
                      <figcaption><i class="fal fa-plus"></i>
                        <h4>Dessert</h4>
                        <h2>Hazelnut financier</h2>
                      </figcaption>
                      <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu04_eng"></a>
                    </figure>
                </li>
                <li>
                    <figure class="snip1425">
                      <div class="gradi"></div>
                      <h2 class="tit">Canelé</h2>
        ...
        <div class="t_margin30"><p class="more"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=menu01_eng">+ View more</a></p></div>
	</div>
</section>
<!-- //포트포리오 -->
...
<section id="section5" class="cd-section">
	<div class="content-wrapper">
        ...
        <p class="ht_g wow fadeInDown t_padding20" data-wow-delay="0.5s">Blu Shaak is still conducting a lot of research and development</p>
		<p class="wow fadeInUp hc" data-wow-delay="0.8s">to deliver the unique taste of Blu Shaak.</p>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3163.0280196384633!2d127.0825908155882!3d37.554403632580055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca52ac45df0a5%3A0x743f2170999d2d19!2z7ISc7Jq47Yq567OE7IucIOq0keynhOq1rCDriqXrj5kgMjQ2LTE0IDLsuLU!5e0!3m2!1sko!2skr!4v1675839793081!5m2!1sko!2skr" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        ...
                        <div class="direct_box02 wow fadeInLeft" data-wow-delay="0.3s">
                            <ul class="direct_ul02">
                                <li><i class="fal fa-home-lg"></i><strong>Blu Shaak - Dandi Korea Co., Ltd. - [SEOUL]</strong></li>
                                <li><i class="fal fa-user-check"></i>CEO : Tae-woong Gye</li>
                                <li><i class="fal fa-phone-square"></i>Corporate Registration Number : <?php echo $config['cf_3']; ?></li>
                                <li><i class="fal fa-phone-square"></i>+82 10-6555-0662 (Franchise Inquiry) </li>
                                <li><i class="fal fa-envelope-open"></i>gye@dandikorea.com<?php /*echo $config['cf_6']; */?></li>
                                <li><i class="fal fa-map-marker-alt"></i>
                                    2nd floor, 246-14, Neung-dong, Gwangjin-gu, Seoul<br><br>
                ...
                <div class="">    
                    <div class="direct_wrap">
                        ...
                        <div class="direct_box wow fadeInRight" data-wow-delay="0.3s">
                            <ul class="direct_ul">
                                <li><i class="fal fa-home-lg"></i><strong>Blu Shaak - [BUSAN]</strong></li>
                                ...
                                <li><i class="fal fa-envelope-open"></i>gye@dandikorea.com<?php /*echo $config['cf_6']; */?></li>
                                <li><i class="fal fa-map-marker-alt"></i>
                                    #1907, IS Tower, 60 Centumbuk-daero, Haeundae-gu, Busan<br><br>
