...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div class="clearfix header">
            ...
            <div class="col-md-4 text-center wow bounceIn r_padding60">
            ...
            <div class="col-md-7">
                   	<p class="pro_name"><?=$view['wr_5']?></p><!-- 제품명 -->
                    <p class="pro_code"><?=$view['wr_subject']?></p> <!-- 제품코드 -->
                    <p class="pro_price color_red">￦ <?=$view['wr_1']?></p> <!-- 가격 -->
                    <p class="pro_size">사이즈<span>&nbsp;<?=$view['wr_2']?></span></p>
                    ...
                    <p class="pro_text"><?=$view['wr_4']?></p> <!-- 간략설명 -->
                    <p class="wow bounceIn" data-wow-delay="1s" style="width:100%; border-bottom:1px solid rgba(0,0,0,.1); margin:0px auto">&nbsp;</p>
					<!--<p class="t9 pt_20"><?=$view['wr_3']?><span>원</span></p>  제품가격 -->
                    <!--견적신청버튼-->
                    <div><a href="<?php echo G5_BBS_URL ?>/write.php?bo_table=qna" class="counsel"><i class="fal fa-keyboard"></i>&nbsp;상담신청</a></div>
                    <!--//견적신청버튼-->
            </div>
        </div>
