...
<section id="bo_w">
    ...
    <div class="text-right comment b_margin10">Items marked with <span style="color: #F33; font-size: .8em; opacity: .8; margin: 0 3px 0 0;">*</span> must be provided. </div>
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody class="cust">        
		<tr class="cust">
            <th class="cust" scope="row"><label for="wr_1"><span class="check">*</span>Store name<strong class="sound_only">필수</strong></label></th>
            <td class="cust">
				<input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input search required" size="10"> 
                <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#mySearch">Find a store</button>
            </td>
		...
		<tr>
            <th class="cust" scope="row"><label for="wr_2_1"><span class="check">*</span>Type of inquiry</label></th>
            <td class="cust">
		...
		<tr>
            <th class="cust" scope="row"><label for="wr_3_1"><span class="check">*</span>Method of use</label></th>
            <td class="cust">
                <div>
                  <input type="radio" name="wr_3" id="wr_3_1" onclick="dispList('0');" value="매장방문"<?php echo $write[wr_3]=="매장방문"||$w==""?" checked":"";?>><label for="wr_3_1">In-store visit </label>
                  <input type="radio" name="wr_3" id="wr_3_2" onclick="dispList('1');" value="매장방문 외"<?php echo $write[wr_3]=="매장방문 외"?" checked":"";?>> <label for="wr_3_2">Other than in-store visit</label>
                </div>
                <!--//#visit-->
                <div id="etc">
                        ...
                        <div class="route">
                          <span id="date">Date</span> <input type="text" name="wr_5" value="<?php echo $write[wr_5] ?>" placeholder="연도-월-일" id="wr_5" required class="frm_input search required" size="10" maxlength="20">
                        </div>
                        <div class="route">
                          <span>Payment time</span> <input type="text" name="wr_6" value="<?php echo $write[wr_6] ?>" id="wr_6" required class="frm_input search required" size="10" maxlength="20">
                        ...
                        <div class="route">
                          <span>Order menu</span> <input type="text" name="wr_7" value="<?php echo $write[wr_7] ?>" id="wr_7" required class="frm_input search required" size="10" maxlength="20">
                        </div>
                </div><!--//#etc-->
            </td>
        </tr>
		<tr>
            <th class="cust" scope="row"><label for="wr_8_1"><span class="check">*</span>Reply notification service</label></th>
            <td class="cust">
				<input type="radio" name="wr_8" id="wr_8_1" value="받지 않음"<?php echo $write[wr_8]=="받지 않음"||$w==""?" checked":"";?>><label for="wr_8_1">Do not use</label>
				<input type="radio" name="wr_8" id="wr_8_2" value="문자 답변"<?php echo $write[wr_8]=="문자 답변"?" checked":"";?>> <label for="wr_8_2">Text reply</label>
				<input type="radio" name="wr_8" id="wr_8_3" value="이메일 답변"<?php echo $write[wr_8]=="이메일 답변"?" checked":"";?>> <label for="wr_8_3">Email reply</label>
			</td>
        </tr>
        
        <?php if ($is_name) { ?>
        <tr>
            <th class="cust" scope="row"><label for="wr_name"><span class="check">*</span>Inquirer's name<strong class="sound_only">필수</strong></label></th>
        ...
        <?php if ($is_email) { ?>
        <tr>
            <th class="cust" scope="row"><label for="wr_email"><span class="check">*</span>E-mail</label></th>
			<?php
		...
		<tr>
			<th class="cust"><span class="check">*</span>Mobile phone</th>
			<?php
        ...
        <tr>
            <th class="cust" scope="row"><label for="wr_subject"><span class="check">*</span>Title<strong class="sound_only">필수</strong></label></th>
            <td class="cust">
        ...
        <tr>
            <th class="cust" scope="row"><label for="wr_content"><span class="check">*</span>Inquiry<strong class="sound_only">필수</strong></label></th>
