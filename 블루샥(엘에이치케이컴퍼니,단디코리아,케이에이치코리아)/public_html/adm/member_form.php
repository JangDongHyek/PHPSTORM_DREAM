...
<input type="hidden" name="mb_level" value="<?php echo $mb['mb_level']!=""&&$mb['mb_level']!="0"?$mb['mb_level']:"2"?>">
<?php /*for ($i=1; $i<=10; $i++) { ?>
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
        ...
        <td><input type="text" name="mb_email" value="<?php echo $mb['mb_email'] ?>" id="mb_email" maxlength="100"  class=" frm_input " size="30"></td>
		<th scope="row"><label for="mb_hp">휴대폰번호</label></th>
        <td><input type="text" name="mb_hp" value="<?php echo $mb['mb_hp'] ?>" id="mb_hp" class="frm_input" size="15" maxlength="20"></td>
    </tr>
	<tr>
        <th scope="row"><label for="mb_1">매장명<strong class="sound_only">필수</strong></label></th>
	...
	<tr>
		<th scope="row"><label for="mb_10">승인여부<strong class="sound_only">필수</strong></label></th>
        <td colspan="3"><input type="checkbox" name="mb_10" value="1" id="mb_10"<?php echo $mb[mb_10]=="1"?" checked":"";?>> <label for="mb_10">승인하기</a></td>
	</tr>
...
document.querySelector("#mb_10").addEventListener("click",function(){
	if(this.checked){
		if(confirm("이 점주를 승인하시겠습니까?")){
			this.checked=true;
		}else{
			this.checked=false;
		}
	}else{
		if(confirm("이 점주를 승인 해제하시겠습니까?")){
			this.checked=false;
		}else{
			this.checked=true;
		}
