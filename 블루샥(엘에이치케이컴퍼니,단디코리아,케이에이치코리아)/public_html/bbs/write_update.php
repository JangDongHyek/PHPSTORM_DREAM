...
if($bo_table == "presentation"){

	if($member['mb_level'] != 10){
		alert("로그인 후 이용해주세요.", G5_URL."/bbs/logout.php");
		exit;
	}
	...
	$_POST['wr_subject'] = "창업설명회";
	$_POST['wr_content'] = "창업설명회";
	$_POST['wr_2'] = $start_h;
	$_POST['wr_3'] = $start_m;
	$_POST['wr_4'] = $end_h;
	$_POST['wr_5'] = $end_m;
	$_POST['wr_6'] = $p_count;
	$_POST['wr_7'] = $location_str;
...
if ($w == '' || $w == 'r') {
	...
	/*if($bo_table=="b_qna"){
		...
		$content="창업희망지역 : ".$_POST['ca_name']."<br/>";
		$content.="연락처 :".$_POST['wr_1']."<br/>";
		$content.="점포유무 :".$_POST['wr_2']."<br/>";
		$content.="희망매장평수 :".$_POST['wr_3']."<br/>";
		$content.="연령대 :".$_POST['wr_4']."<br/>";
		$content.="창업비용 :".$_POST['wr_5']."<br/>";
		$content.="현직업 :".$_POST['wr_6']."<br/>";
		$content.="경험브랜드 :".$_POST['wr_7']."<br/><br/>";
		$content.= "내용<hr>".$_POST['wr_content'];
		/*itforoneMailer($wr_email,$wr_name,"kimnamhyong@naver.com","관리자",$wr_subject,$content);
		itforoneMailer($wr_email,$wr_name,"itforyou@hanmail.net","관리자",$wr_subject,$content);*/
		/*itforoneMailer($wr_email,$wr_name,"blueshaak@gmail.com","관리자",$wr_subject,$content);
		itforoneMailer($wr_email,$wr_name,"chunjabeer@hanmail.net","관리자",$wr_subject,$content);
		
	}*/
	if($bo_table=="b_order"){
		for($i=0;$i<count($_POST['chk_no']);$i++){
			$no = $_POST['chk_no'][$i];
			/*echo $_POST['item_name'][$no];
			echo $_POST['ea'][$no];
			echo $_POST['price'][$no];*/
