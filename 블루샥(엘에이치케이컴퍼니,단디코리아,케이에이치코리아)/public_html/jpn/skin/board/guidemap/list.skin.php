...
<style>
.sch_sel { width:25%; height:35px; padding:0 0 0 10px; border:1px solid #DBDBDB;; border-radius:3px; background:#fff ; -moz-border-radius:3px; -webkit-border-radius:3px; }
</style>
<!-- 게시판 목록 시작 { -->
<div id="bo_gall" style="width:<?php echo $width; ?>">
		...
		<legend>게시물 검색</legend>
			...
			<form name="fsearch" method="get">
				...
				<div class="shop_search" width="100%" style="padding-top:8px;">
					...
					<input type="submit" value="가맹학원 찾기" style="width:15%; height:35px; border:1px solid #DBDBDB;; border-radius:3px; background:#fff ; -moz-border-radius:3px; -webkit-border-radius:3px; background:#4B545E; color:#FFF; font-weight:bold;">
				</div>
			</form>
	</fieldset>
	<!-- 게시물 검색 끝 } -->
    ...
    <div class="bo_fx">
        <div id="bo_list_total">
            <span style="font-size:11pt; font-weight:bold;"><?php if(!$si) echo "전체"; else echo $si." ".$gu." ".$dong; ?> 가맹학원 현황 <?php echo number_format($total_count) ?> 개</span>
            <?php echo $page ?> 페이지
        </div>
		...
		<div class="list_store">
			<dl>
				...
				<dd>
					...
					<?php } ?>
					<span><?php echo $list[$i]['subject'] ?> <?php if (isset($list[$i]['icon_new'])) echo $list[$i]['icon_new']; ?></span>
					<div style="border-bottom: 1px solid #e5e5e5; margin: 6px 0 2px 0;"></div>
					<div class="small">
					<p style="margin:6px 0;"><strong>주소</strong> : <?php echo $list[$i]['wr_1']; ?> <?php echo $list[$i]['wr_2']; ?></p>
					<p style="margin:6px 0;"><strong>전화번호</strong> : <?php echo $list[$i]['wr_4']; ?></p>
					<p style="margin:6px 0;"><strong>주차여부</strong> : <?php echo $list[$i]['wr_6']; ?></p>
					</div>
				</dd>
			</dl>
		</div>
