...
define('G5_MYSQL_USER', 'blushaak');
define('G5_MYSQL_PASSWORD', 'q!4dm&fe');
define('G5_MYSQL_DB', 'blushaak');
...
$g5['menu_table'] = G5_TABLE_PREFIX.'menu_jpn'; // 메뉴관리 테이블
$g5['submenu_table'] = G5_TABLE_PREFIX.'submenu_jpn'; // 서브메뉴 테이블
