...
<div id="sitemap">
   ...
   <nav class="menu"> 
      ...
      <div class="menu_header">
         ...
         <div class="m_gmenu"><a href="<?php echo G5_URL2 ?>jpn"><span>JPN</span></a><a href="<?php echo G5_URL2 ?>eng"><span class="noncheck">ENG</span></a><a href="<?php echo G5_URL2 ?>"><span class="noncheck">KOR</span></a></div>
...
<? if(defined('_INDEX_')) {?>
		...
		<? if($co_id == "introduce01" || $co_id == "introduce01_test" || $co_id == "introduce02" || $co_id == "introduce03_jpn" || $co_id == "introduce03_02_jpn" || $co_id == "menu01" || $co_id == "menu02" || $co_id == "menu03" || $co_id == "menu04"  || $co_id == "menu05" ||$co_id == "franchise01" ||$co_id == "franchise02" ||$co_id == "franchise03") {  ?>
        <div id="container100">
        <? }else if($bo_table == "" || $co_id == ""){ 
		?>
