...
<style>
html, body{width:100%;height:100%;min-height:500px;background:url(<?php echo $member_skin_url ?>/img/bg2.jpg) no-repeat center fixed ; background-size:cover;}
</style>
    ...
    <?php }  ?>
		...
		<div class="resBox box-article">
			<div id="join_info" class="v1">
				<h2><?php if($w == ""){ ?>점주회원정보 입력<? }else { ?>회원정보 확인 및 수정<?php } ?> <p><span style="color:#2f8bbf;">*</span> 필수입력</p></h2>
				<div class="box-body">
					<dl class="row">
						...
						<dd class="status_ico <?=$pas?>"><i class="fal fa-check"></i></dd>
					...
					<dl class="row">
						...
						<dd class="status_ico lock_ico1"><i class="fal fa-lock-open"></i></dd>
						<dd class="error col-xs-12"></dd>
					</dl>
					...
					<dl class="row">
						...
						<dd class="status_ico lock_ico2"><i class="fal fa-lock"></i></dd>
						<dd class="error col-xs-12"></dd>
					</dl>
					...
					<dl class="row">
						<dd class="col-xs-1 req">*</dd>
						<dd class="col-xs-11">
							<label for="reg_mb_shop"  class="sound_only">매장명</label>
							<input type="text" name="mb_1" value="<?php echo $member['mb_1'] ?>" id="reg_mb_shop" class="regist-input required f_empty" required placeholder="매장명">
						</dd>
						<dd class="status_ico <?=$pas?>"><i class="fal fa-check"></i></dd>
						<dd class="error col-xs-12"></dd>
					</dl>
                    ...
                    <dl class="row adrBox">
						...
						<dd class="col-xs-11">
							...
							<input type="text" name="mb_zip" value="" id="reg_mb_zip" required class="required f_empty" size="5" maxlength="6" placeholder="우편번호" style="width:90px">
							<button class="addr_sch" type="button" onclick="win_zip('fregisterform', 'mb_zip', 'mb_addr1', 'mb_addr2', 'mb_addr3', 'mb_addr_jibeon');" style="height:37px">주소검색</button>
							
							<input type="text" name="mb_addr1" value="" id="reg_mb_addr1" required class="required f_empty" size="50" placeholder="기본주소">
							<input type="text" name="mb_addr2" value="" id="reg_mb_addr2" class="required f_empty" size="50" placeholder="상세주소">
							
							<br>
							<input type="hidden" name="mb_addr3" value="" id="reg_mb_addr3" class="f_empty" size="50" readonly="readonly">
							
							<input type="hidden" name="mb_addr_jibeon" value="">
							<!--
							<label for="reg_mb_addr"  class="sound_only">주소</label>
							<input type="text" name="mb_addr" id="reg_mb_addr" class="regist-input required f_empty" minlength="3" maxlength="50" required placeholder="주소" value=""><button class="addr_sch">주소검색</button>
                            <input type="text" name="mb_addr2" id="reg_mb_addr2" class="regist-input required f_empty" minlength="3" maxlength="50" required placeholder="상세주소" value="" style="border-top:1px solid #eee;">-->
						</dd>
						<dd class="status_ico "><i class="fal fa-check"></i></dd>
						<dd class="error col-xs-12"></dd>
					</dl>
