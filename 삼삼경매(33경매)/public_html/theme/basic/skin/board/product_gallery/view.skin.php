    ...
    <section id="bo_v_atc">
        ...
        <div class="clearfix header">
            ...
            <div class="col-md-6">
					...
					<p class="t4">냉방면적<span><?=$view['wr_2']?></span></p>
                    <? } else if( $bo_table =="pro_conditioner01"||$bo_table =="pro_conditioner02"||$bo_table =="pro_conditioner04"||$bo_table =="pro_conditioner05") { //전문가전 일때 ?>
                    <p class="t4">냉/난방면적<span><?=$view['wr_2']?></span></p>
                    <p class="t4">냉/난방능력<span><?=$view['wr_5']?></span></p>
                    <p class="t4">소비전력<span><?=$view['wr_6']?></span></p>
                    <? } else if( $bo_table =="pro_conditioner03") { //온풍기 일때 ?>
                    <p class="t4">난방면적<span><?=$view['wr_2']?></span></p>
                    <p class="t4">난방능력<span><?=$view['wr_5']?></span></p>
                    <p class="t4">소비전력<span><?=$view['wr_6']?></span></p>
                    <? } else if( $bo_table =="pro_conditioner06") { //천장카세트형 일때 ?>
                    <p class="t4">냉방면적<span><?=$view['wr_2']?></span></p>
                    <p class="t4">냉방능력<span><?=$view['wr_5']?></span></p>
                    <p class="t4">소비전력<span><?=$view['wr_6']?></span></p>
                    <? } else if( $bo_table =="pro_expert01") { //전문가전 일때 ?>
                    <p class="t4">소비전력<span><?=$view['wr_6']?></span></p>
                    ...
                    <p class="t4">일일제습량<span><?=$view['wr_2']?></span></p>
                    <p class="t4">제습능력<span><?=$view['wr_5']?></span></p>
                    <p class="t4">소비전력<span><?=$view['wr_6']?></span></p>
                    <p class="t4">색상<span><?=$view['wr_7']?></span></p>
                    <p class="t4">크기<span><?=$view['wr_8']?></span></p>
                    <p class="t4">물통용량<span><?=$view['wr_9']?></span></p>
                    <? } else if( $bo_table =="pro_expert03") { //냉장냉동고 일때 ?>
                    <p class="t4">총용량<span><?=$view['wr_2']?></span></p>
                    <!--<p class="t4">제습능력<span><?=$view['wr_5']?></span></p>-->
                    <p class="t4">소비전력<span><?=$view['wr_6']?></span></p>
                    <p class="t4">실내기크기<span><?=$view['wr_8']?></span></p>
                    <!--<p class="t4">물통용량<span><?=$view['wr_9']?></span></p>-->
                    <p class="t4">색상<span><?=$view['wr_7']?></span></p>
                    <? } else if( $bo_table =="pro_expert04") { //서큘레이터 일때 ?>
                    <p class="t4">색상<span><?=$view['wr_10']?></span></p>
                    <p class="t4">헤드사이즈<span><?=$view['wr_7']?></span></p>
                    <p class="t4">크기<span><?=$view['wr_8']?></span></p>
                    <p class="t4">무게<span><?=$view['wr_9']?></span></p>
                    <? } else if( $bo_table =="pro_expert05") { //의류건조기 일때 ?>
                    <p class="t4">색상<span><?=$view['wr_10']?></span></p>
                    <p class="t4">건조타입<span><?=$view['wr_7']?></span></p>
                    <p class="t4">크기<span><?=$view['wr_8']?></span></p>
                    <p class="t4">용량<span><?=$view['wr_9']?></span></p>
                    <p class="t4">소비전력<span><?=$view['wr_6']?></span></p>
                    <? } else if( $bo_table =="pro_expert06") { //와인셀러 일때 ?>
                    <p class="t4">적재<span><?=$view['wr_10']?></span></p>
                    <p class="t4">온도범위<span><?=$view['wr_7']?></span></p>
                    <p class="t4">크기<span><?=$view['wr_8']?></span></p>
                    <p class="t4">소비전력<span><?=$view['wr_6']?></span></p>
                    <? } else if( $bo_table =="pro_expert07") { //세탁기 일때 ?>
                    <p class="t4">세탁용량<span><?=$view['wr_10']?></span></p>
                    <p class="t4">색상<span><?=$view['wr_7']?></span></p>
                    <p class="t4">크기<span><?=$view['wr_8']?></span></p>
                    <p class="t4">중량<span><?=$view['wr_9']?></span></p>
                    <?php } else { //그 외 ?>
