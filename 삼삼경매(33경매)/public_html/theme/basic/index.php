            ...
            <div class="counter_area">
                ...
                <div class="counterareabg">
                    <div class="counter_wrap">
                        <p><span class="counter" data-start="0" data-end="57">0</span></p>
                ...
                <div class="swiper expert">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" v-for="item in datas">
                            <a :href="base_url + '/bbs/class.view.php?id=' + item._idx">
                                <div class="area_img">
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    var swiper = new Swiper(".review", {
        ...
        methods: {
            changePage(page) {
                window.location.href = `${this.base_url}/bbs/class.register.list.php?page=${this.filter.page}`;
            },
            postData : function() {
