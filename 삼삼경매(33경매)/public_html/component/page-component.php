<script type="text/x-template" id="page-component-template">
    <div class="b-pagination-outer" v-if="parseInt(total)">
        <ul id="border-pagination">
            <li v-on:click="setPage(1)"><a class="">«</a></li>
            <li  v-for="index in getPages()" v-on:click="setPage(index)"><a v-bind:class="{ active: (current == index) }">{{index}}</a></li>
            <li v-on:click="setPage(last)"><a>»</a></li>
        </ul>
    </div>
</script>
