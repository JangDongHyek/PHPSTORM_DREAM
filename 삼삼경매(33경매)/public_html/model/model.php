...
class Model {
    ...
    private $empty = false; //비어있는값 추출 할지 안할지
    ...
    function count($_param,$like=false){
    ...
    // 복수 데이터 조회
    function gets($_param,$like = false,$query = ""){
        ...
        $data["datas"] = array();
        $data["count"] = $this->count($param,$like);
    ...
    // 단수 데이터 조회
    function get($_param = array(),$like = false,$query = ""){
        $gets = $this->gets($_param,$like,$query)["datas"];
