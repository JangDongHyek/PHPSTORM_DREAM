<?php
//a:9:{s:4:"lang";s:2:"en";s:9:"auth_pass";s:32:"d41d8cd98f00b204e9800998ecf8427e";s:8:"quota_mb";i:0;s:17:"upload_ext_filter";a:0:{}s:19:"download_ext_filter";a:0:{}s:15:"error_reporting";s:0:"";s:7:"fm_root";s:0:"";s:17:"cookie_cache_time";i:1258620419;s:7:"version";s:5:"0.9.3";}
// + Header and Globals
// +--------------------------------------------------
...
function dir_list_form() {
    ...
    if ($opdir = @opendir($dir_atual)) {
        ...
        function upload(){
                var w = 400;
                var h = 200;
                window.open('".$path_info["basename"]."?action=10&dir_atual=$dir_atual', '', 'width='+w+',height='+h+',fullscreen=no,scrollbars=yes,resizable=yes,status=no,toolbar=no,menubar=no,location=no');
        }
        function execute(){
...
function upload_form(){
    ...
    if (count($_FILES)==0){
        ...
        for ($x=0;$x<$num_uploads;$x++){
            echo "<tr><td width=1 align=right><b>".et('File').":</td><td><nobr><input type=\"file\" name=\"file$x\"></nobr></td></tr>";
        ...
        <tr><td></td><td><input type=checkbox name=fechar value=\"1\"> <a href=\"JavaScript:troca();\">".et('AutoClose')."</a></td></tr>
...
function shell_form(){
    ...
    switch ($shell_form){
        case 1:
            ...
            <form name=\"data_form\">
            <tr><td><textarea name=data_out rows=42 cols=97 READONLY=\"1\"></textarea></td></tr>
            </form>
            </table>
            </body></html>";
        break;
