<?php
    ...
    $CST_MID                    = "lets08078";           //상점아이디(LG텔레콤으로 부터 발급받으신 상점아이디를 입력하세요)
     ...
     */    
    $LGD_CASNOTEURL				= "http://m.renemall.co.kr/mobile/cart/cas_noteurl.php";    

    /*
     * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
     */    
    $LGD_RETURNURL				= "http://m.renemall.co.kr/mobile/cart/returnurl.php";  
	
    /*
     * ISP 카드결제 연동중 모바일ISP방식(고객세션을 유지하지않는 비동기방식)의 경우, LGD_KVPMISPNOTEURL/LGD_KVPMISPWAPURL/LGD_KVPMISPCANCELURL를 설정하여 주시기 바랍니다. 
     */    
    $LGD_KVPMISPNOTEURL       	= "http://m.renemall.co.kr/mobile/cart/note_url.php";
    $LGD_KVPMISPWAPURL			= "http://m.renemall.co.kr/mobile/cart/mispwapurl.php?LGD_OID=".$LGD_OID;
    $LGD_KVPMISPCANCELURL     	= "http://m.renemall.co.kr/mobile/cart/cancel_url.php";
