...
if($mode == "update"){
	...
	echo "<meta http-equiv='refresh' content='0; URL=../cart/cart.html?mart_id=$mart_id&provider_id=$provider_id&item_no=$item_no&category_num=$category_num&category_num1=$category_num1&category_num2=$category_num2&cate_num=$cate_num&flag=$flag'>";
	exit;
}
