                  ...
                  <!--페이지 표시 테이블 시작 -->
						  <table width="300" border="0" cellspacing="0" cellpadding="0">
							<tr> 
							  ...
							  <a href='<?=$code_url?>?set=list&board=<?=$board?>&page=1&check_array=<?=$check_array?>&search_word=<?=$search_word?>&sort1=<?=$sort1?>&sort2=<?=$sort2?>'><img src="../oboard_com/images/table_bt_left2.jpg" width="17" height="14" border="0"></a>				  
							  <?
								if($block > 1){
									$pre_block=$first_page;
							   ?>	
									<a href='<?=$code_url?>?set=list&board=<?=$board?>&page=<?=$pre_block?>&check_array=<?=$check_array?>&search_word=<?=$search_word?>&sort1=<?=$sort1?>&sort2=<?=$sort2?>'><font color=\"#6699CC\"><img src="../oboard_com/images/table_bt_left1.jpg" width="13" height="14" border="0"> </font></a>
								<?
								}else{
								?>
									<font color=\"#6699CC\"><img src="../oboard_com/images/table_bt_left1.jpg" width="13" height="14" border="0"> </font>
								<?
								}
								...
								if($block < $total_block) {
									$my_page = $last_page+1;
								?>
									<a href='<?=$code_url?>?set=list&board=<?=$board?>&page=<?=$my_page?>&check_array=<?=$check_array?>&search_word=<?=$search_word?>&sort1=<?=$sort1?>&sort2=<?=$sort2?>'> <font color=\"#6699CC\"><img src="../oboard_com/images/table_bt_right1.jpg" width="13" height="14" border="0"></font></a>
								<?
								}else{
								?>
								 <font color=\"#6699CC\"><img src="../oboard_com/images/table_bt_right1.jpg" width="13" height="14" border="0"></font>
								<?
								}
								?>
								<a href='<?=$code_url?>?set=list&board=<?=$board?>&page=<?=$total_page?>&check_array=<?=$check_array?>&search_word=<?=$search_word?>&sort1=<?=$sort1?>&sort2=<?=$sort2?>'><img src="../oboard_com/images/table_bt_right2.jpg" width="17" height="14" border="0"></a>
							  </td>
							</tr>
						  </table>                  
				  <!--페이지 표시 테이블 끝 -->
