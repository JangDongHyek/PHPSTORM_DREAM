...
<input type="hidden" name="check_array">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="90%"><img src="../images/oboard_com_title.gif" width="673" height="88" border="0" usemap="#Map" /></td>
      </tr>
      <tr>
		...
		?>
			<a href="../oboard_com/logout.php"><b>로그아웃</b></a>
		<?
		}else{
		?>
			<a href="../main/reservation_com.html?set=auth"><b>로그인/의류도매신청하기</b></a>
		<?
		}
		?>
		</td>
...
업체명 
  ...
  <input type="checkbox" name="checkbox2" value="value13">구분 </td>
                      ...
                      <td width="101"><a href="#">
                        <!--검색버튼 -->
                        <img src="../oboard_com/images/search_btn.gif" width="60" height="22" border="0" align="top" onclick="Scheck_box(3)"></a></td>
                    </tr>
                  </table>
                  <!--검색 테이블 끝 -->
