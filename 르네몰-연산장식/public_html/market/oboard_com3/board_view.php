...
<form name="free_view" method="post">
		  ...
		  <table width="90%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#DDDDDD">
                  ...
                  <tr>
                    <td width="150" height="30" bgcolor="#FFFFFF"><div align="right"><b>발송지역</b></div></td>
                    <td bgcolor="#FFFFFF"><?=$ans[value2]?></td>
                  </tr>
                  <tr>
                    <td width="150" height="30" bgcolor="#FFFFFF"><div align="right"><b>배송지역</b></div></td>
              ...
              <tr> 
               ...
               <tr> 
                <td height="2" colspan="4" bgcolor="#FFFFFF">&nbsp;&nbsp;</td>
                      ...
                      <a href="<?=$code_url?>?set=list&board=<?=$board?>&check_array=<?=$check_array?>&search_word=<?=$search_word?>&page=<?=$page?>&sort1=<?=$sort1?>&sort2=<?=$sort2?>"><img src="../oboard_com3/images/list_btn.gif" width="68" height="22"></a>
                      &nbsp;&nbsp;&nbsp;
                   <?
									 	if($Mall_Admin_ID&&$MemberLevel==1){
										?>
											<a href="<?=$code_url?>?set=modify&uid=<?=$ans[id]?>&board=<?=$board?>&check_array=<?=$check_array?>&search_word=<?=$search_word?>&page=<?=$page?>&sort1=<?=$sort1?>&sort2=<?=$sort2?>"><img src="../oboard_com3/images/modify_btn.gif" width="64" height="22"></a>
                      &nbsp;&nbsp;&nbsp;
											<a href="../oboard_com3/board_write_process.php?code_url=<?=$code_url?>&mode=delete&board=<?=$board?>&uid=<?=$ans[id]?>&check_array=<?=$check_array?>&search_word=<?=$search_word?>&page=<?=$page?>&sort1=<?=$sort1?>&sort2=<?=$sort2?>"><img src="../oboard_com3/images/delete_btn.gif" width="64" height="22"></a>
										<?
