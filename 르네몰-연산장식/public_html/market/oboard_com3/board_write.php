...
function IDcheck()
{
		...
		winobject.document.location = "../oboard_com3/id_exist.php?value11=" + f.value11.value;
		winobject.focus();
		return false;
}
...
?>
                 <tr>
                    <td height="25" colspan="2" bgcolor="#FFFFFF" class="txt_B"><div align="center"><img src="../images/sa_title.gif" width="673" height="88" border="0" usemap="#Map" />
                        <map name="Map" id="Map">
                  ...
                  <tr>
                    <td width="100" height="25" bgcolor="#FFFFFF" class="txt_B"><div align="right"><b>발송지역</b></div></td>
                    <td bgcolor="#FFFFFF"><input name="value2" type="text" value="<?=$ans[value2]?>" size="8" class="input_03" id="name"></td>
                  </tr>
                   <tr>
                    <td width="100" height="25" bgcolor="#FFFFFF" class="txt_B"><div align="right"><b>배송지역</b></div></td>
                    <td bgcolor="#FFFFFF"><input name="value13" type="text" value="<?=$ans[value13]?>" size="8" class="input_03" id="name"></td>
                  </tr>
                 <tr>
				  ...
				  <? }?>
                  <tr>
                    <td height="40" colspan="2" bgcolor="#FFFFFF"><div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="image" src="../oboard_com3/images/confirm_btn2.gif">
                    &nbsp;<a href="<?=$code_url?>?set=list&board=<?=$board?>&check_array=<?=$check_array?>&search_word=<?=$search_word?>&page=<?=$page?>&sort1=<?=$sort1?>&sort2=<?=$sort2?>"> 
                        <img src="../oboard_com3/images/list_btn2.gif" /></a>
                      &nbsp;&nbsp;&nbsp;</div>                    
    </tr>
