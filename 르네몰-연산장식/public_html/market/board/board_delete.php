...
function board_checkform(){
 ...
 <? include("../include/top.html"); ?>
		...
		<section id="path">
			<ul>
				<li class="home"><a href="/html/mobile/main/main.html"><img src="/images/mobile/common/ic_home.png" alt="홈" /></a></li>
				<li><a href="#">11</a></li>
			</ul>
		</section>
		...
		<section id="content">
			<article id="contentSubTitle">
				<div class="subTitle">
					<h2><span class="ic"></span><?if($bbs_no==1){echo"공지사항";}else{echo"질문과답변";}?></h2>
				</div>
			</article>
