          ...
          <tr>
            <td width="100%">
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						...
						<table width="100%"  border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><img src="../image/helpdesk/view_table_top.gif" width="740" height="10"></td>
							</tr>
							<tr>
							...
							<tr>
								<td><img src="../image/helpdesk/view_table_bottom.gif" width="740" height="10"></td>
							</tr>
						</table>
						<!--비밀번호입력 End-->
						<!--버튼-->
...
function denyText(gubun){
	...
	var obj_Title_arr=document.getElementById("cmt_name").value.split(gubun);
	var obj_titles="";
	var obj_conetents="";
	var obj_Content_arr=document.getElementById("cmt_comment").value.split(gubun);
	...
	if(obj_Deny){
		for(var i=0;i<obj_DenyArr.length;i++){
			...
			if(chk1==obj_DenyArr[i]){
				return "이름에 "+chk1+"는(은) 사용할 수 없는 단어입니다.";
				break;
			}
...
<input type="Hidden" name="keyset" value="<?=$keyset?>">
<input type="Hidden" name="searchword" value="<?=$searchword?>">
<input type="hidden" name="bbs_deny_word" id="bbs_deny_word" value="선불폰,막폰,URL,싸이,투데이,방문자,추적,버그,boris,현대남,현대여,aphsun.info,목카드,도박,장비,특수렌즈,마킹카드,공장목,표시목,필승,화투,포르노,뽀르노,야동,화상채팅,대박이벤트,영계하고,데이또,재미짱,승률이,테크노,(바)카라,5000만원,입출금,생방송,바@카@라,천만원,키스,대박회원급증,용돈,㈓㈘㈑,강원랜드,야동,정력제,시알리스,비아그라,바카라,바/카/라,바카현이,섹스,폰섹,카지노,㉥┝㉪┝㉣┝,8억,추천id,추/천/인,바☆카☆라,바(카)라,남근확대,무료자료,viagra,비아그라,sialis,시알리스,씨알리스,동거,섹스,동거,섹스,프릴리지,바다이야기,피싱걸,황금성,물뽕,게임장,황 금 성,무료증정,경마,로얄,홍콩,부업,목카드,특수렌즈,도박,토토,href,www,url,cock,tatoos,nude,grandma,lesbian,fuck,suck,anal,sex,sexy,clitoris,Porn,nude,poker,casinos,viagra,cialis,phentermine,xanax,대포,통장,개인통장,막폰,후불유심,유심,팜니다,팝니다,막통장,걔인장,개인분,풀싸롱,룸싸롱,강남풀,매직미러,주민등록증,신분증,위조,개인x,통1장,오비상사,남부상사,민증위조,주민등록증위조,중고폰,미납폰,노리터,야마토,배팅,게임,http">
              			<tr>
                			<td bgColor="#FFFFFF" height="10" colspan="2"></td>
              			</tr>
              			<tr>
				...
				<table width="96%" align="center" border="0" cellspacing="0" cellpadding="0">
            	<tr>
            		<td><img src="../image/helpdesk/table3_top.gif" width="740" height="10"></td>
           		</tr>
            	<tr>
            		<td background="../image/helpdesk/table3_bg.gif"><table width="700"  border="0" align="center" cellpadding="0" cellspacing="0">
                	<tr>
                		<td width="40" height="30"><img src="../image/helpdesk/add_name.gif" width="34" height="20"></td>
                		<td width="80"><input type=text name=cmt_name id="cmt_name" size=10 class="input_03" maxlength=20 value='<?=$MemberName?>' <?=$writer_readonly?>>
							</td>



                		<td width="60"><?if(!$Mall_Admin_ID&&$MemberLevel!=1){?><img src="../image/helpdesk/add_pass.gif"><?}?></td>
                		<td><?if(!$Mall_Admin_ID&&$MemberLevel!=1){?><input type=password name=cmt_password  size=12 class="input_03"><?}?>&nbsp;</td>
                  	...
                  	<tr>
                  		<td width="40"><img src="../image/helpdesk/add_contents.gif" width="35" height="20"></td>
                  		<td>
								<textarea name=cmt_comment id="cmt_comment" cols="90" rows="3" class="input_03"></textarea></td>
                 		  <td align="right">
            	...
            	<tr>
            		<td><img src="../image/helpdesk/table3_bottom.gif" width="740" height="10"></td>
           		</tr>
            	</table>
					<!--덧글작성 End-->
					</td>
