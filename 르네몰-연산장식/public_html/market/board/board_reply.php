...
?>
				...
				<!--	<form method="POST" name='writeform' enctype="multipart/form-data" onsubmit='board_checkform(); return false' action="https://www.renemall.co.kr:8001/market/board/board_reply.php"> -->
						<form method="POST" name='writeform' enctype="multipart/form-data" onsubmit='board_checkform(); return false' action="../board/board_reply.php"> 
...
<? }?>
					...
					<table width="96%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="50" align="center"><input type='image' onfocus='blur();' src="../image/helpdesk/bu_reply.gif" width="70" height="30" border="0"><a href="board_list.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>"><img src="../image/helpdesk/bu_cancel.gif" width="70" height="30" border="0"></a></td>
						</tr>
					</table>
					</form>
<!---------------------- 게시판 끝 ------------------------------------------------------>
...
#######################################################################
	...
	//echo "<meta http-equiv='refresh' content='0; URL=http://www.renemall.co.kr/market/board/board_list.php?mart_id=$mart_id&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'>";
	echo "<meta http-equiv='refresh' content='0; URL=../board/board_list.php?mart_id=$mart_id&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'>";
}
?>
<?
mysql_close($dbconn);
