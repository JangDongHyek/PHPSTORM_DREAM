	...
	<td width="609" valign="top" bgcolor='#ffffff'>
    	...
    	<table border="0" width="500">
      	...
      	<tr>
        	<td width="100%">
        	<?
        	if($ti_agree_img != '' && file_exists("$Co_img_UP$mart_id/design2/$ti_agree_img")){
        		echo "	
        	<img src='$Co_img_DOWN$mart_id/design2/$ti_agree_img' WIDTH='89' HEIGHT='27'>
        		";
        	}
        	else{
        		echo "
        	<img src='../images/agree-title.gif' WIDTH='89' HEIGHT='27'>
        		";
        	}
        	?>
        	</td>
