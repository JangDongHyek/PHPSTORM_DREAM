...
<input type="hidden" name="check_array">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="90%"><img src="../images/oboard_com2_title.gif" width="673" height="88" border="0" usemap="#Map" /></td>
      </tr>
      <tr>
		...
		?>
			<a href="../oboard_com2/logout.php"><b>로그아웃</b></a>
		<?
		}else{
		?>
			<a href="../main/reservation_com2.html?set=auth"><b>로그인/무료입점</b></a>
		<?
		}
		?>
		</td>
	...
	<? 
		//include "../oboard_com2/power_board_list.php";
	?>
                  <!--검색 테이블 시작 -->
...
업체명 
  ...
  취급품목 
  <input type="checkbox" name="checkbox2" value="value13">구분 </td>
                      <td width="188" align="center"> <input name="search_word" type="text" size="16" maxlength="18" onkeypress="word_box()"></td>
                      <td width="101"><a href="#">
                        <!--검색버튼 -->
                        <img src="../oboard_com2/images/search_btn.gif" width="60" height="22" border="0" align="top" onclick="Scheck_box(3)"></a></td>
                    </tr>
                  </table>
                  <!--검색 테이블 끝 -->
...
<map name="Map" id="Map">
<!--<area shape="rect" coords="406,12,658,79" href="../site/usage2.htm" /> -->
</map>