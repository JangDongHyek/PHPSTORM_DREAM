...
if($name == "88952634"){
	echo"<script>location.href='http://naver.com'</script>";
	exit;
}
	...
	if(mysql_num_rows($dbresult)>0){
		echo ("
			...
			<form name='form' action='http://www.renemall.co.kr/market/member/join.html' method='post'>
	...
	//echo "<meta http-equiv='refresh' content='0; URL=http://www.renemall.co.kr/market/member/join_ok.html'>";
	echo "<meta http-equiv='refresh' content='0; URL=../member/join_ok.html'>";
