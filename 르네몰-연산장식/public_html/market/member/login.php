...
?>
            			<input class='bb' onclick="location.href='../member/article.php?mart_id=<?=$mart_id?>&from_order_sheet_flag=1'" style='background-color: white; color: #7B7D7B; height: 18px; border: 1px solid #7B7D7B' type='button' value='무료회원 가입'>&nbsp; 
<?
//}else{
?>
<?
...
?>		
        		...
        		<table cellspacing="1" background="/market/images/dot2.gif" width="75%" border="0">
          		...
          		<form name='f1' action='../cart/order_sheet_nomem.php' onsubmit='return checkform1(this)'>
          		<input type='hidden' name='mart_id' value='<?echo $mart_id?>'>
          		<!--
          		<tr>
            		<td bgcolor="#FFFFFF" valign="top">
          		...
          		<tr>
		            ...
		            <table border="0" width="70%">
		              ...
		              <tr>
		                ...
		                <td width="33%">
		                <input name="order_num" value='<?=$order_num?>' class="bb" style="BORDER-RIGHT: #7b7d7b 1px solid; BORDER-TOP: #7b7d7b 1px solid; BORDER-LEFT: #7b7d7b 1px solid; WIDTH: 93px; BORDER-BOTTOM: #7b7d7b 1px solid; HEIGHT: 18px" size="7"></td>
