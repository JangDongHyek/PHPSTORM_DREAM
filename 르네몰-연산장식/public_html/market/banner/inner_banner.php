...
<tr>
	...
	<td width="609" valign="top" bgcolor='#ffffff'>
    	...
    	<table border="0" width="500">
      	<?
      	$SQL = "select * from $BannerTable where mart_id='$mart_id' and banner_no = '$banner_no'";
		//echo "sql = $SQL"; 
		$dbresult = mysql_query($SQL, $dbconn);
		...
		if($numRows > 0) {
			...
			/*
			echo "
		<iframe scrolling='auto' frameborder='0' scrolling='yes' src='$link_str' width='600' height='600'></iframe>
			";
			*/
		}
		?>
