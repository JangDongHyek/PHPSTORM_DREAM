		...
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    <TD width=131 align=right bgColor=#fafafa class="bbs">* 상품명<B> &nbsp;</B></TD>
					    <TD align=left bgcolor="#fafafa"> <input name='rg_title' type=text style=width:50%;height:22; class=b_input id="rg_title"  value='<?=$rg_title?>' required itemname='상품명'><input type=hidden name="rg_cat_num" value="<?=$ss[fc]?>"><input type="hidden" name="rg_html_use" value="1"></TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
<?=$show_name_begin?>
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
	                    <TD width=131 align=right bgColor=#fafafa class="bbs">* 가격<B> &nbsp; </B></TD>
	                    <TD bgcolor="#fafafa"> 
                          <input name='rg_name' type=text id="rg_name" value='<?=$rg_name?>' maxlength=20 required itemname='가격' style=width:20%;height:22; class=b_input> ※숫자만 기입하세요 ex)10000
                        </TD>
					</TR>
				</TABLE>
			</TD>
		...
		<TR> 
			<TD height="50">
				<TABLE width="100%" height="100" border="0" cellPadding=1 cellSpacing=1 bordercolor="#ffffff">
					<TR> 
						<TD width=131 align=right bgColor=#fafafa class="bbs" onclick="document.form_write.rg_content.rows=document.form_write.rg_content.rows+2" style=cursor:hand>* 상세설명 ▼<B>&nbsp;</B></TD>
