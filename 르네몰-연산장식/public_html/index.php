...
if($_SERVER['SERVER_NAME'] == "m.renemall.co.kr"){
        echo "<script>location.href='http://renemall.co.kr/mobile/';</script>";
}
...
if ( /iphone/.test(ua) || /android/.test(ua) || /opera/.test(ua) || /bada/.test(ua) ) {
	document.location.replace('http://renemall.co.kr/mobile/');
//pc일때 이동하기
}else{
	document.location.replace('http://renemall.co.kr/market/main');
}
</script>
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
