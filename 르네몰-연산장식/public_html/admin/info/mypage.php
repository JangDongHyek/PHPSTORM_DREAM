...
<input type="hidden" name="flag" value="update" >
		<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
			...
			<td width="100%" bgcolor="#FFFFFF" valign="top">
				...
				<table border="0" width="90%">
					<tr>
						...
						<td width="15%" align=right>이전비밀번호 : <br>새 비밀번호 : <br>비밀번호확인 : </td>
						<td width="35%">
							<input type='password' name="old_password" value='<?echo $password?>' size="24" class="input_03"><br><input type='password' name="password1" value='<?echo $password?>' size="24" class="input_03"><br><input type='password' name="password2" value='<?echo $password?>' size="24" class="input_03"></td>
					</tr>
				</table>
			</td>
			</tr>
			...
			<td width="100%" bgcolor="#FFFFFF" height="0" valign="top">
				<table border="0" width="90%">
					<tr>
						<td width="25%">착불배송업체</td>
						<td width="25%"><input name="me_delivery" size="20" value='<?=$me_delivery?>' class="input_03"></td>
						<td width="25%">착불배송금액</td>
						<td width="25%"><input name="me_delivery_price" size="20" value='<?=$me_delivery_price?>' class="input_03"></td>
					</tr>					
				</table>
			</td>
			</tr>
...
elseif ($flag == "update") {
	...
	$SQL = "update $MemberTable set me_delivery='$me_delivery', me_delivery_price='$me_delivery_price' where mart_id='$mart_id'";
	$dbresult = mysql_query($SQL, $dbconn); 
