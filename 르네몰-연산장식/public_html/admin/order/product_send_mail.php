	...
	if(isset($opt)&&$opt!=""&&$opt!="!!"){
		...
		if($opts[1] != ""){
			...
			if($opts2_1[1] == 0 || $opts2_1[1] == ""){
				$mailcontent .= "<br>"."$opts2_1[0]";
			}else{
				$mailcontent .= "<br>"."$opts2_1[0](+$opts2_1[1] 원)";
			}
		}
		if($opts[2] != ""){
			$opts3_1=explode("^",$opts[2]);
			if($opts3_1[1] == 0 || $opts3_1[1] == ""){
				$mailcontent .= "<br>"."$opts3_1[0]";
			}else{
				$mailcontent .= "<br>"."$opts3_1[0](+$opts3_1[1] 원)";
			}
		}
	}
	$mailcontent .= "
											...
											<td width='90'>단가 : $z_price_str 원</td>
