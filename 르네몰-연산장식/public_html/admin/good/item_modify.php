...
if($flag == "update"){
	...
	$item_name2 = trim($item_name);
	if(!$item_name2 || $item_name2=="" || $item_name2== NULL){
		echo "
			<script>
				alert('지금 이경고창이 보이시면 연락주세요 051-891-0088 정재진대리');
				history.go(-1);
			</script>
		";
		exit;
