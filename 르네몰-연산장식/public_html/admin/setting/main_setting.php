...
?>
		...
		<td>
			...
			<tr>
				<td width="100%" height="50" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>쇼핑몰기본정보</b></td>
			</table>
