...
if($flag == "update"){
	...
	$SQL = "update $MartMngInfoTable set freight_limit = '$freight_limit', freight_cost = '$freight_cost', shopback_limit='$shopback_limit', shopback_cost='$shopback_cost',
	card_yes = '$card_yes', shopuser = '$shopuser', pur_limit = '$pur_limit', card_limit = '$card_limit', 
	init_bonus = '$init_bonus', if_union = '$if_union', if_notice = '$if_notice', if_chuchon = '$if_chuchon',
	...
	user_words = '$user_words', if_quiz = '$if_quiz', account_yes='$account_yes', bonus_ok='$bonus_ok', 
	...
	member_price_percent='$member_price_percent', if_customer_price='$if_customer_price' where mart_id='$mart_id'";
