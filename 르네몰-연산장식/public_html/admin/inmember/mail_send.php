						...
						<td width="100%" bgcolor="#999999">
							...
							if(!empty($grp_no)){
									 ...
									 mysql_data_seek($dbresult,0);
										...
										$bonus_to = $ary["bonus_to"];
										  ...
										  $today_year = date("y") + 100;
											...
											$SQL1 = "select count(*) from $MemberTable where mart_id='$mart_id' and perms='4'";
								...
								if($keyset == '' && $searchword == '') {
												...
												$SQL = "select * from $MemberTable where $keyset like '%$searchword%' and mart_id='$mart_id' and perms='4'";
												$dbresult = mysql_query($SQL, $dbconn);
												$numRows = mysql_num_rows($dbresult);
												$email_list = "";		
												for ($i=0; $i < $numRows; $i++) {
