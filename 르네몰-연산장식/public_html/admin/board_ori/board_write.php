...
<table border="1" cellpadding="0" cellspacing="0" width="99%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
	...
	<td width="100%">
		<table cellSpacing="0" cellPadding="0" width="100%" border="0">
			...
			<td width="100%">
				<table cellSpacing="0" cellPadding="0" width="100%" border="0">
<form action='board_write.php' method="POST" name='writeform' enctype="multipart/form-data"> 
...
?>
		...
		<tr>
			<td align="right" height="25" width="100%" bgcolor="#F6F6F6" align="center">
				<a href="javascript:checkform()"><img src="../../market/images/save.gif" border="0" WIDTH="48" HEIGHT="15"></a>
...
elseif ($flag == "write") {
	...
	$SQL = "insert into $New_BoardTable (index_no, bbs_no, mart_id, code, username, writer, passwd, doc_type, write_date, msgno, ansno, thread, email, subject_new, content, userfile, userfile1 ) values ('$index_no', '$bbs_no', '$mart_id', '$code', '$mart_id', '$writer', '$passwd', '$doc_type', '$write_date', $maxMsgNo+1, '1', '$thread', '$email', '$subject_new_tmp[0]', '$content', '$file', '$file1' )";
	$dbresult = mysql_query($SQL, $dbconn);
