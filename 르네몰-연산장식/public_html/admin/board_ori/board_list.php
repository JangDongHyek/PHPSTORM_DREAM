...
?> 		
							<tr align='middle' height='22'>
								...
								<td align='left'><?=$j_str?> <?=$code_str?> <a href='board_read.php?index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><?=$subject_new?></a> <?=$secret_str?></td>
