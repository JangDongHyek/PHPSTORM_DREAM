...
<?
	...
	if( $bbs_no == "6" && $item_no ){
		...
		$SQL = "insert into $New_BoardTable(index_no, bbs_no, mart_id, username, writer, passwd, write_date, msgno, ansno, step, thread, email, subject_new, content, userfile, userfile1, if_secret) values($maxIndex_no+1, $bbs_no, '$mart_id', '$mart_id', '$writer', '$passwd', '$write_date', $max_msgno+1, '$ansno', '$step', '$thread', '$email', '$subject_new_tmp[0]', '$content', '$file', '$file1', '$if_secret')";
	}
