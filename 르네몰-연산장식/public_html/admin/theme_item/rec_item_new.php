...
<br>
				...
				<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
					...
					<td width="90%" bgcolor="#FFFFFF" height="35">
						...
						추천상품으로 등록합니다.<br>
						등록한 추천상품은 메인화면의 추천상품영역에 출력됩니다.<br>
						추천상품 등록갯수제한은 없으나 3~6개 정도를 권장합니다.
						</td>
					</tr>
					<tr>
															...
															<td width="100%" bgcolor="#F7F7F7" height="20">
																...
																<tr>
																	...
																	<td width="50%"><strong><p align="right"></strong>
																		...
																		<option value="fav_item_new.php">히트상품 등록</option>
																		<option value="rec_item_new.php" selected>추천상품 등록</option>
																		</select></td>
																</tr>
																</table>
															</td>
