										...
										<td width="53%" bgcolor="#8FBECD" align="left" colspan="5" height="1">
											<table border="0" width="100%" cellspacing="0" cellpadding="0">
												<tr>
													...
													<td width="50%" align="right"><input onclick="window.location.href='fav_item_new.php'" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type="button" value="히트상품 등록"></td>
												</tr>
											</table>
										</td>
									</tr>
...
<!---------------------------- 특가상품 관리 시작 --------------------------------------->
									<!-- <tr>
										<td width="58%" bgcolor="#8FBECD" align="left" colspan="5" height="1">
											<table border="0" width="100%" cellspacing="0" cellpadding="0">
												<tr>
												<td width="50%"><b>특가상품 관리</b></td>
												<td width="50%" align="right">
													<input onclick="window.location.href='spe_item_new.php'" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type="button" value="특가상품 등록">
													</td>
												</tr>
											</table>
										</td>
...
?>
									<tr>
										<td width="58%" bgcolor="#FFFFFF" colspan="5" align="center">총 <?=$tot8?>개의 특가상품이 등록되어 있습니다.</td>
									</tr>
									<tr align="center" bgcolor="#FFFFFF">
										<td width="10%">번호</td>
										<td width="10%">순서</td>
...
for($i=0; $i < $tot8; $i++){
	...
	if($i < $tot8 - 1){
		$down_str = "<a href='theme_item.php?spe_item_no=$spe_item_no&spe_item_order=$spe_item_order&flag=down'><img src='../images/dn_subcategory.gif' width='13' height='13' border='0' alt='한단계내리기'>";
	}else{
		$down_str = "<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'> ";
	}

	if($i > 0){
		$up_str = "<a href='theme_item.php?spe_item_no=$spe_item_no&spe_item_order=$spe_item_order&flag=up'><img src='../images/up_subcategory.gif' width='13' height='13' border='0' alt='한단계올리기'>";
	}else{
		$up_str = "<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'>";
	}
...
?>
									<tr bgcolor='#FFFFFF' align='center'>
										...
										<td><?=$down_str?> <?=$up_str?></td>		
										<td align='left' colspan='2'><?=$category_name1?> > <?=$category_name2?> > <?=$category_name3?> >  <a onclick="window.open( '../good/item_edit_old.php?item_no=<?=$item_no?>', 'mainpage','toolbar=no,width=700,height=600,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no');" style='cursor:hand'><?=$item_name?></a></td>
										<td><input onclick="document.location.href='theme_item.php?flag=del&target=spe&spe_item_no=<?=$spe_item_no?>'" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='삭제'></td>
									</tr>
<?
	}else {
?>
