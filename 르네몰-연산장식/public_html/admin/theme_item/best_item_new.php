    	...
    	<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
      	<tr>
        	<td width="90%" bgcolor="#FFFFFF" valign="top">　
        		...
        		<strong><span class="cc">[베스트상품 등록]</span></strong> 등록되어진 제품 중 베스트상품으로 등록합니다.<br><br>
			</td>
      	</tr>
      	<tr>
...
if($flag == "to_best_item"){
	for($i=0; $i<count($checkSel); $i++) {
		...
		$SQL = "insert into $Best_ItemTable (item_no, firstno, prevno, category_num, mart_id, provider_id, best_item_order) values ( '$item_no', '$firstno', '$prevno', '$category_num', '$mart_id', '$provider_id', $maxBest_Item_order)";
