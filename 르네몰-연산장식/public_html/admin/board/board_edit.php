...
<?
	...
	$SQL = "update $New_BoardTable set code='$code', writer='$writer', doc_type = '$doc_type', email='$email', subject_new='$subject_new_tmp[0]', content='$content', write_date = '$write_date', if_secret='$if_secret' where index_no = $index_no and mart_id='$mart_id'";
