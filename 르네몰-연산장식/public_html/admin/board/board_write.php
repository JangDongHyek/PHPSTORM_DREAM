...
elseif ($flag == "write") {
	...
	$SQL = "insert into $New_BoardTable (index_no, bbs_no, mart_id, code, username, writer, passwd, doc_type, if_secret , write_date, msgno, ansno, thread, email, subject_new, content, userfile, userfile1) values ('$index_no', '$bbs_no', '$mart_id', '$code', '$mart_id', '$writer', '$passwd', '$doc_type', '$if_secret', '$write_date', $maxMsgNo+1, '1', '$thread', '$email', '$subject_new_tmp[0]', '$content', '$file', '$file1' )";
	$dbresult = mysql_query($SQL, $dbconn);
