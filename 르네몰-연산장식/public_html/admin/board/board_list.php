...
?> 		
							<tr align='middle' height='22'>
								...
								?>
								<?=$j_str?> <?=$code_str?> <a href='board_read.php?index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><?=$subject_new?></a> <?=$new_string?> <?=$secret_str?></td>
