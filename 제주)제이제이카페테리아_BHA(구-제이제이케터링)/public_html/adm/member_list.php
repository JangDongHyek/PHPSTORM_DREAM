...
if(empty($ss_mb_level)){
	$ss_mb_level ="2";
}

if($ss_mb_level){
	$sql_search .= " and mb_level = '$ss_mb_level'";
}
...
?>
<style>
	.active{font-weight:bold;background-color:#000;color:#fff}
</style>
...
<input type="hidden" name="ss_mb_level" value="<?=$ss_mb_level?>"/>
...
<div class="tbl_head02 tbl_wrap">
	<table>
		<tbody>
			<tr>
				<!-- <td class="<?php echo $ss_mb_level==""?"active":"";?>" style="cursor:pointer" onclick="location.href='?ss_mb_level=';" align="center">전체</td> -->
				<td class="<?php echo $ss_mb_level=="2"?"active":"";?>" style="cursor:pointer" onclick="location.href='?ss_mb_level=2';" align="center">학생</td>
				<td class="<?php echo $ss_mb_level=="3"?"active":"";?>" style="cursor:pointer" onclick="location.href='?ss_mb_level=3';" align="center">학부모</td>
				<td class="<?php echo $ss_mb_level=="4"?"active":"";?>" style="cursor:pointer" onclick="location.href='?ss_mb_level=4';" align="center">교직원</td>
			</tr>
		</tbody>
	</table>
    <table>
...
<!--         <th scope="col" colspan="6" id="mb_list_cert"><?php echo subject_sort_link('mb_certify', '', 'desc') ?>본인확인</a></th> -->
	<?if($ss_mb_level == 2){?>	
							<th scope="col" id="mb_list_mobile">학번</th>
							<th scope="col" id="mb_list_mobile">생년월일</th>
	<?}?>
	<?if($ss_mb_level == 3){?>	
							<th scope="col" id="mb_list_mobile">자녀이름</th>
							<th scope="col" id="mb_list_mobile">자녀학번</th>
	<?}?>
	<?if($ss_mb_level != 2){?>	<th scope="col" id="mb_list_mobile">휴대폰</th><?}?>
<!--         <th scope="col" id="mb_list_auth">상태/<?php echo subject_sort_link('mb_level', '', 'desc') ?>권한</a></th>
        <th scope="col" id="mb_list_lastcall"><?php echo subject_sort_link('mb_today_login', '', 'desc') ?>최종접속</a></th>
        <th scope="col"  id="mb_list_grp">접근<br>그룹</th> -->
 ...
 <!--    <tr>
    ...
    <tr class="<?php echo $bg; ?>">
      ...
      <!--   <td headers="mb_list_cert" colspan="6" class="td_mbcert">
        ...
        <td headers="mb_list_mobile" class="td_name"><?php echo get_text($row['mb_email']); ?></td>
        <?if($ss_mb_level == 2){?> 
				<td headers="mb_list_mobile" class="td_tel"><?php echo get_text($row['mb_1']); ?></td>
				<td headers="mb_list_mobile" class="td_tel"><?php echo get_text($row['mb_birth']); ?></td>
		<?}?>
		  <?if($ss_mb_level == 3){?> 
		...
		<?}?>
        <?if($ss_mb_level != 2){?> <td headers="mb_list_mobile" class="td_tel"><?php echo get_text($row['mb_hp']); ?></td><?}?>		
...
<?php echo get_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, '?'.$qstr.'&amp;ss_mb_level='.$ss_mb_level.'&amp;page='); ?>
