...
<section id="anc_cf_join">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="cf_1">회원가입약관(영문)</label></th>
            <td colspan="3"><textarea name="cf_1" id="cf_1" rows="10"><?php echo $config['cf_1'] ?></textarea></td>
        </tr>
		 <tr>
            <th scope="row"><label for="cf_2">개인정보처리방침(영문)</label></th>
            <td colspan="3"><textarea id="cf_2" name="cf_2" rows="10"><?php echo $config['cf_2'] ?></textarea></td>
        </tr>
        </tbody>
        </table>
    </div>
