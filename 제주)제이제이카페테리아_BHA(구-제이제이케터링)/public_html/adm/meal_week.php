...
$info_date = substr($desiredDate, 0, 7);
...
<div id="container">
    <h1 style="text-align: center">주간 식단표</h1>
        ...
        <div><div id="bo_tbtn">
            ...
            <div id="bo_list">
                ...
                <div id="bo_div" class="tbl_head01 tbl_wrap">
                    <?
                    $info->where("month",$info_date);
                    $infos = $info->where("sheet",$sheet)->get();
                    ?>
                    <table>
                        <tbody>
