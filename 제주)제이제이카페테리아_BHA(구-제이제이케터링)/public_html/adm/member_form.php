...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td colspan="1"><input type="text" name="mb_name" value="<?php echo $mb['mb_name'] ?>" id="mb_name" required class="required frm_input" size="15" minlength="2" maxlength="20"></td>
        <th scope="row"><label for="mb_nick">분류<strong class="sound_only">필수</strong></label></th>
        <td colspan="1">
            <select name="mb_level" class="frm_input">
                <option value="2" <?=$mb['mb_level']=='2' ? "selected" : ""?> >학생</option>
                <option value="3" <?=$mb['mb_level']=='3' ? "selected" : ""?> >학부모</option>
                <option value="4" <?=$mb['mb_level']=='4' ? "selected" : ""?> >교직원</option>
            </select>
        </td>
	...
	<tr>
        ...
        <td colspan="3"><input type="text" name="mb_birth" value="<?php echo $mb['mb_birth'] ?>" id="mb_birth" required class="required frm_input" size="15" minlength="2" maxlength="20"></td>
        <!--<th scope="row"><label for="mb_nick">닉네임<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_nick" value="<?php echo $mb['mb_nick'] ?>" id="mb_nick" required class="required frm_input" size="15" minlength="2" maxlength="20"></td>-->
    </tr>
	<tr>
        <th scope="row"><label for="mb_1">학번<strong class="sound_only">필수</strong></label></th>
        <td colspan="3"><input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1" required class="required frm_input" size="15" minlength="2" maxlength="20"></td>
        <!--<th scope="row"><label for="mb_nick">닉네임<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_nick" value="<?php echo $mb['mb_nick'] ?>" id="mb_nick" required class="required frm_input" size="15" minlength="2" maxlength="20"></td>-->
    </tr>
	<?php }?>
   <!--  <tr>
    <th scope="row"><label for="mb_level">회원 권한</label></th>
        ...
        <th scope="row">포인트</th>
        <td colspan="3"><a href="./point_list.php?sfl=mb_id&amp;stx=<?php echo $mb['mb_id'] ?>" target="_blank"><?php echo number_format($mb['mb_point']) ?></a> 점</td>
    </tr> -->
    <tr>
	...
	<?php
		if($mb[mb_level]=="3"){?>
	<tr>
        <th scope="row"><label for="mb_2">자녀이름<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_2" value="<?php echo $mb['mb_2'] ?>" id="mb_2" maxlength="100" required class="required frm_input" size="30"></td>
		<th scope="row"><label for="mb_3">자녀학번<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" maxlength="100" required class="required frm_input" size="30"></td>
    </tr>
	<?php }?>
	<!--
    <tr>
   ...
   <!-- <tr>
	...
	<tr>
        ...
        <td><input type="checkbox" name="mb_10" id="mb_10" value="1"<?php echo $mb[mb_10]=="1"?" checked":"";?>> 승인하기</td>
    </tr>
