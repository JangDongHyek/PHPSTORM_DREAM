...
if ($board['gr_id'] == "account") {
	$sub_menu = "400100";           // 게시판이  지정된 메뉴 번호 
}else if($board['gr_id'] == "customer"){
	$sub_menu = "500100";           // 게시판이  지정된 메뉴 번호 
}else if($_GET['bo_table'] == "event"){
	$sub_menu = "600100";           // 게시판이  지정된 메뉴 번호 
}else if($_GET['bo_table'] == "notice"){
	$sub_menu = "600200";           // 게시판이  지정된 메뉴 번호 
}else if($_GET['bo_table'] == "qna"){
	$sub_menu = "600300";           // 게시판이  지정된 메뉴 번호 
}
