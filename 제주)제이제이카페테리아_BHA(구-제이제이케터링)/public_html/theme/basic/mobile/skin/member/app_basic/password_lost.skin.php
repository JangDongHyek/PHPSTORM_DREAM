...
<div id="find_info" class="mbskin">
	...
	<div class="tab-content">
	  <input type="checkbox" name="mb_level" value="2" id="mb-level"><label for="mb-level">학생 아이디/비번찾기</label><br/>
	  <sub>학생인경우는 위 체크박스에 체크하셔야 합니다</sub>
	  ...
	  <div role="tabpanel" class="tab-pane active" id="id-find">
		...
		<fieldset id="info_fs" class="mb-hp">
			...
			<input type="text" name="" id="mb_val1" required class="required frm_input" size="30" placeholder="휴대폰번호">
		</fieldset>	
	  ...
	  <div role="tabpanel" class="tab-pane" id="pass-find">
		...
		<fieldset id="info_fs">
			...
			<input type="tel" name="mb_val2" id="mb_val2" required class="required frm_input" size="30" placeholder="휴대폰번호">
		</fieldset>
		<fieldset id="info_fs">
