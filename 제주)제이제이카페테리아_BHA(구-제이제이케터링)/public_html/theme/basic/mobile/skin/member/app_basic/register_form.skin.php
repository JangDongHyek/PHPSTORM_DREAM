            ...
            <div class="box-body">
                <dl class="row">
                    ...
                    <dd class="col-xs-11">
                        ...
                        <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" class="regist-input <?php echo $required ?> <?php if($w=="u") echo "readonly";?>" minlength="4" <?php echo $required ?> placeholder="아이디" <?php if($w=="u") echo "readonly";?>>
                    </dd>
                ...
                <dl class="row">
                    ...
                    <dd class="col-xs-11">
                        ...
                        <input type="password" name="mb_password" id="reg_mb_password" class="regist-input <?php echo $required ?>" minlength="4"  <?php echo $required ?> placeholder="비밀번호">
                    </dd>
                ...
                <dl class="row">
                    ...
                    <dd class="col-xs-11">
                        ...
                        <input type="password" name="mb_password_re" id="reg_mb_password_re" class="regist-input <?php echo $required ?>" minlength="4"  <?php echo $required ?> placeholder="비밀번호확인">
                    </dd>
...
<!--                	<dd class="col-xs-1 req">*</dd>-->
                    <dd class="col-xs-11">
                        <label for="reg_mb_1">학번</label>
                        <input type="text" name="mb_1" value="<?php echo $member['mb_1'] ?>" id="reg_mb_1" class="regist-input" placeholder="학번">
                    </dd>
                    <dd class="status_ico"><i class="fas fa-check"></i></dd>
                    <dd class="error col-xs-12"></dd>
                </dl>
				...
				<dl class="row level2" id="form_birth">
                    ...
                    <dd class="col-xs-11">
                        ...
                        <input type="text" name="mb_birth" value="<?php echo $member['mb_birth'] ?>" id="reg_mb_birth" class="regist-input picker" readonly placeholder="생년월일">
                    </dd>
                    <dd class="status_ico"><i class="fas fa-check"></i></dd>
                    <dd class="error col-xs-12"></dd>
                </dl>
...
<!--                	<dd class="col-xs-1 req">*</dd>-->
                    <dd class="col-xs-11">
                        ...
                        <input type="tel" name="mb_hp" value="<?php echo preg_replace("/[^0-9]*/s", "", $member['mb_hp']); ?>" id="reg_mb_hp" class="regist-input" placeholder="휴대번호" style="font-size:0.95em;" minlength="10" maxlength="14" >
                    </dd>
                    <dd class="status_ico"><i class="fas fa-check"></i></dd>
                    <dd class="error col-xs-12"></dd>
                </dl>
...
<!--                	<dd class="col-xs-1 req">*</dd>-->
                    <dd class="col-xs-11">
                        <label for="reg_mb_2">자녀이름</label>
                        <input type="text" name="mb_2" value="<?php echo $member['mb_2'] ?>" id="reg_mb_2" class="regist-input"  placeholder="자녀이름">
                    </dd>
                    <dd class="status_ico"><i class="fas fa-check"></i></dd>
                    <dd class="error col-xs-12"></dd>
                </dl>
...
<!--                	<dd class="col-xs-1 req">*</dd>-->
                    <dd class="col-xs-11">
                        <label for="reg_mb_3">자녀학번</label>
                        <input type="text" name="mb_3" value="<?php echo $member['mb_3'] ?>" id="reg_mb_3" class="regist-input"  placeholder="자녀학번">
                    </dd>
                    <dd class="status_ico"><i class="fas fa-check"></i></dd>
                    <dd class="error col-xs-12"></dd>
                </dl>
...
var register_flgs = <?if($w=='') echo 'new Array(0,0,0,0,0,0,0)'; else echo 'new Array(1,1,1,1,1,1,1)';?>;
...
$("input:radio[name='mb_level']").click(function(){
	...
	$("#reg_mb_birth").attr("required",false);
...
$(function (){
	...
	$("#reg_mb_password").keyup(function (){
		...
		if (regPassword.test(mb_password)){
			...
			$(this).parents(".row").find(".status_ico").removeClass("pas").addClass("err");
			$(this).parents(".row").find(".error").addClass("on").html("비밀번호는 4자~15자 영문,숫자 포함 되어야 합니다.");
			register_flgs[1] = 0;
		}
	});
...
//		var regName = /^[\uac00-\ud7a3]*$/;
		...
		if (regName.test(mb_name)){
			...
			$(this).parents(".row").find(".status_ico").removeClass("pas").addClass("err");
			$(this).parents(".row").find(".error").addClass("on").html("2글자 이상 한글,영문만 입력해주세요.");
			register_flgs[3] = 0;
		}
	});
