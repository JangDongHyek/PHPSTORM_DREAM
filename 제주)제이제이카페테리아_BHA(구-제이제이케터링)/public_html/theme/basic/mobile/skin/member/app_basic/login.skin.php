...
<div id="mb_login" class="mbskin">
	...
	<ul class="lang">
		<li>
			<a class="on" href="<?php echo G5_BBS_URL?>/login.php">KO</a>
			<a href="<?php echo G5_URL?>/eng/bbs/login.php">EN</a>
		</li>
	</ul>
    ...
    <aside id="login_info">
        ...
        <div>
            ...
            <a href="<?php echo G5_BBS_URL ?>/register_form.php" class="btn01">회원가입</a>
        </div>
    </aside>
...
//alert(token);
	document.flogin.token.value = token;
}
