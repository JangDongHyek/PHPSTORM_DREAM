...
<!-- <link href="<?php echo G5_CSS_URL ?>/import.css" rel="stylesheet" type="text/css"> -->
<?php
if (defined('G5_IS_ADMIN')) {
    if(!defined('_THEME_PREVIEW_'))
        echo '<link rel="stylesheet" href="'.G5_ADMIN_URL.'/css/admin.css"><link rel="stylesheet" href="'.G5_CSS_URL.'/css/board.css">'.PHP_EOL;
} else {
