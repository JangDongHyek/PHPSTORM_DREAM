...
function sendFcm($tokens, $message)
{
	...
	$fields = array(
        ...
        'data' => $message,
        'priority'          => 'high',
        'notification'      => array( 'title' => 'JJCafeteria_BHA', 'body' => $message['message'],'sound' => true,'url'=>$message['goUrl'])
    );
	$headers = array(
        'Authorization:key =AAAAD2t-J7c:APA91bEVlM1qpQrhnRHMQG3M2j61_zoX43wwZuXfSRejZQoxhSuk7GiONw4W_4pDk0DmZANHGL3bPMsroTsIiYI8zBbhG2KQgP8SAaVjFq9SXDnmBl2a-PPQdxZY1163O3Bev50drXre',
