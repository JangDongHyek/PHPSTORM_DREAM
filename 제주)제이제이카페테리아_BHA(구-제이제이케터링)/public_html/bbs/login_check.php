...
if(sql_num_rows($result)){
    $sql="update g5_fcm set token='".$_REQUEST['token']."' where mb_id = '".$mb['mb_id']." ' ";
}else{
    $sql="insert g5_fcm set mb_id='".$mb["mb_id"]."',token='".$_REQUEST['token']." '";
}
$result=sql_query($sql);
