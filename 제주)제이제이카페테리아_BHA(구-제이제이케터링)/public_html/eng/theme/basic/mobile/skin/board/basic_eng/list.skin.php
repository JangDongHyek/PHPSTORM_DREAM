...
<!--<fieldset id="bo_sch">
    ...
    <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="frm_input sch_input required">
...
<!-- } 게시판 검색 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php if ($is_checkbox) { ?>
            <th scope="col">
                <label for="chkall" class="sound_only">All current page posts</label>
            ...
            <th scope="col" class="hidden-xs"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>Hit</a></th>
    ...
    <div class="bo_fx">
        <?php if ($is_checkbox) { ?>
        <ul class="btn_bo_adm">
            <li><input type="submit" name="btn_submit" value="Select Delete" onclick="document.pressed=this.value"></li>
        </ul>
        <?php } ?>
