...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?><li><a href="<?php echo $prev_href ?>" class="btn_b01">Pre</a></li><?php } ?>
            <?php if ($next_href) { ?><li><a href="<?php echo $next_href ?>" class="btn_b01">Next</a></li><?php } ?>
        </ul>
        <?php } ?>

        <ul class="bo_v_com">
            <li><a href="javascript:modal_action('Declare','<?=$wr_id?>');" class="btn_b01">Report it</a></li>
            ...
            <?php if ($reply_href && $bo_table=="qna") { ?><li><a href="<?php echo $reply_href ?>" class="btn_b01">Answer</a></li><?php } ?>
