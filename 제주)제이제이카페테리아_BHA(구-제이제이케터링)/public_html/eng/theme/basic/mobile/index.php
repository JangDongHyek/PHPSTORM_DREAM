...
<div id="main">
    <a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=carte_eng&is_day=1">
        <img src="<?php echo G5_THEME_IMG_URL ?>/icon01.png" alt="">
        <br />Daily Menu
    </a>

    <a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=carte_eng" class="color">
    ...
    <a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=qna_eng" class="color">
        <img src="<?php echo G5_THEME_IMG_URL ?>/icon06.png" alt="">
        <br />Leave comments
    </a>

    <a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=notice_eng">
