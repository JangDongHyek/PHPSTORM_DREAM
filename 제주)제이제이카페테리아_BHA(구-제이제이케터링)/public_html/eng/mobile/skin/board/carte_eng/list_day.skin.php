...
<div id="bo_tbtn">
<a href="?bo_table=carte_eng&is_day=1&mktime=<?=$mktime?>&sme=<?=$sme?>&now_sheet=1">JKP,JK,SK</a>
<a href="?bo_table=carte_eng&is_day=1&mktime=<?=$mktime?>&sme=<?=$sme?>&now_sheet=0">J1~J5</a>
<a href="?bo_table=carte_eng&is_day=1&mktime=<?=$mktime?>&sme=<?=$sme?>&now_sheet=2">MS,SS</a>
</div>
<?
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">					
					<dl><input type="file" name="bf_file[]" placeholder="이미지파일#1" id="img_file1"/></dl>
					<dl><input type="file" name="bf_file[]" placeholder="이미지파일#2" id="img_file2"/></dl>
					<dl><input type="file" name="bf_file[]" placeholder="이미지파일#3" id="img_file3"/></dl>
					<dl><input type="file" name="bf_file[]" placeholder="이미지파일#4" id="img_file4"/></dl>
					<dl><input type="file" name="bf_file[]" placeholder="이미지파일#5" id="img_file5"/></dl>
				</div>
				<!-- Footer -->
