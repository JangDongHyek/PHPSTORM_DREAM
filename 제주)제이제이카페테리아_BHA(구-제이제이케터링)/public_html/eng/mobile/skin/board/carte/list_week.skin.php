...
<div id="bo_list">
	<div class="date_title">
		<a href="<?php echo $pweek_url?>" class="arrow_left">  </a> <?php echo $year?> . <?php echo $month?> Week <?php echo $week?>  <a href="<?php echo $nweek_url?>" class="arrow_right">  </a>
	</div>
...
<style>
.box{ padding:0 5px 20px 5px;letter-spacing:0; margin-bottom:30px; margin-top:20px; border-bottom:1px solid #ddd;}
...
.box .fc ul{ max-width:100%; display:flex; flex-direction: column; align-items: flex-start;}
.box .fc ul:after{ display:block; content:""; clear:both;}
.box .fc li{ float:left; padding-right:20px; margin-top:10px; border-bottom:1px dotted #e1e1e1;word-break: keep-all;word-wrap:break-word;}
