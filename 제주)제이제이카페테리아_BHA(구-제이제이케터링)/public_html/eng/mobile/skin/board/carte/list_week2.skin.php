...
$nweek_url = $bbs_url."/board.php?bo_table=".$bo_table."&mktime=".$nex_week."&now_sheet=".$now_sheet."&test=".$test;
$pweek_url = $bbs_url."/board.php?bo_table=".$bo_table."&mktime=".$pre_week."&now_sheet=".$now_sheet."&test=".$test;

add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/style.css">', 0);

?>
<div id="bo_tbtn">
<a href="?bo_table=carte&mktime=<?=$mktime?>&now_sheet=0">G1~G5</a>
<a href="?bo_table=carte&mktime=<?=$mktime?>&now_sheet=1">JKP,JK,SK</a>
<a href="?bo_table=carte&mktime=<?=$mktime?>&now_sheet=2">Cafeteria</a></div>
<div id="bo_list">
