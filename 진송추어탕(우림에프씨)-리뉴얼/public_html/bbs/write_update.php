...
if ($w == '' || $w == 'r') {
	...
	if($bo_table=="request"){
		goSms("01033053982","0553631995",$wr_name."님이 상담요청하였습니다. 고객번호:".$wr_subject);
		goSms("01022908719","0553631995",$wr_name."님이 상담요청하였습니다. 고객번호:".$wr_subject);		
		goSms("01092065282","0553631995",$wr_name."님이 상담요청하였습니다. 고객번호:".$wr_subject);		
	}
}  else if ($w == 'u') {
