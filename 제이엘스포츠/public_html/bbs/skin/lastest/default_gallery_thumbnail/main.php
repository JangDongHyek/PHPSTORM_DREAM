...
?>
	<td valign="top" align="center">
		<table style="table-layout:fixed">
			<tr>
				<td align="center">
				<table width="<?=$thum_width?>" height="<?=$thum_height?>" border="0" cellpadding="0" cellspacing="0" bgcolor="#E3E3E3">
				  <td align="center" valign="middle" bgcolor="#FFFFFF">
			  <?=$a_list?><img src="<?=$rg_thum1_url?>" width="130" height="125" hspace="1" vspace="1" border="0" onerror="this.src='<?=$skin_lastest_url?>blank_.gif'"></a></td></table></td>
			</tr>
			<tr>
