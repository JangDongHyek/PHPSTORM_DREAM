			...
			<TD height="50"> 
				<TABLE width="100%" height="100" border="0" cellPadding=1 cellSpacing=1 bordercolor="#ffffff">
					<TR> 
                        ...
                        <TD align=left height="100" bgcolor="#fafafa"> <textarea name="rg_content" id="rg_content"  rows=15  style=width:90%; class="b_textarea" required itemname='내용'><?=$rg_content?></textarea> <img width="1" height="1"></TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
