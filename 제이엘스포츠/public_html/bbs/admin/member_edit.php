...
<form name=mb_form method=post action='' onsubmit='return formcheck()' enctype='multipart/form-data' autocomplete=off>
  <table width="850" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#D4D4D4">
    ...
    <tr> 
      ...
      <td bgcolor="#FFFFFF"><input type=text name='mb_post' size=8 maxlength=7 readonly itemname='우편번호' value='<?=$mem[mb_post]?>'> 
...
?>      </td>
  ...
  <div align="center"> <br>
    <input name="submit" type=submit class=button value=' 수      정 ' style="font-size:12px; color:white; line-height:16px; background-color:#404040; border-width:1px; border-color:rgb(221,221,221); border-style:solid;">
  </div></p>
