  ...
  <tr>
    <td>
	    ...
	    <td width="50" align="center"><font color="#333333">포인트</font></td>
            ...
            <td width="70" align="center"><font color="#333333">수정/보기</font></td>
...
?>
            ...
            <td align="center" bgcolor="#FFFFFF"> 
              <?=$R[mb_log_count]?>            </td>
            <td align="center" bgcolor="#FFFFFF"><a href="member_edit.php?page=<?=$page?>&<?=$p_str?>&mode=edit&mb_num=<?=$R[mb_num]?>">수정/보기</a></td>
