...
?>
<style>
html, body{width:100%;height:100%;min-height:500px;background:#fff; background-size:cover; overflow-y:hidden; overflow-x:hidden;}
</style>

<!-- 로그인 시작 { -->
<div id="mb_login" class="mbskin">
    <h1><img src="<?php echo G5_THEME_IMG_URL ?>/common/logo.svg" alt="<?php echo $config['cf_title']; ?>"></h1>
