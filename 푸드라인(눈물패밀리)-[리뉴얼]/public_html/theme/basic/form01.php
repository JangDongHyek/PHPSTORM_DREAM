...
<div id="idx_wrapper">
		...
		<div class="scon_left">
			<div class="sub_title_wr wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
				...
				<p class="sub_desc ">일반 매장 배달대행 문의</p>
			</div>
		</div>
		...
		<div class="scon_right">
			...
			<div class="formWarp">
				...
				<form name="fwrite" id="fwrite" action="https://onnaplus.com/bbs/onlinewrite_update.php" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" target="bnk_ifr_aa">
					...
					<input type="hidden" name="bo_table" value="onlinewrite">					<input type="hidden" name="on_category" value="일반 매장 배달대행 문의">
					<input type="hidden" name="fname" value="fwrite">
					<input type="hidden" name="on_subject" value="일반 매장 배달대행 문의">
					<div class="formArea">
						<ul>							
							<li>
								<dl>
									...
									<dd>
										<input type="hidden" name="on_1_subj" value="매장명">
										<input type="text" name="on_1" placeholder="매장명" required="">
									</dd>
								</dl>
							</li>
							 <li>
								<dl>
									...
									<dd>
										<input type="hidden" name="on_2_subj" value="사업자번호">
										<input type="text" name="on_2" placeholder="사업자번호 (숫자 10자리)" required="" maxlength="12">
									</dd>
								</dl>
							</li>
							<li>
								<dl>
									...
									<dd>
										<input type="hidden" name="on_3_subj" value="매장 위치">
										<input type="text" name="on_3" placeholder="상세 주소 입력 (ex. 서울 종로구 효자로 12)" required="">
									</dd>
								</dl>
							</li>
							<li>
								<dl>
									...
									<dd>
										<input type="text" name="on_name" placeholder="이름을 입력해 주세요" required="">
									</dd>
								</dl>
							</li>
							<li>
							...
							<li>
								<dl>
									...
									<dd>
										<input type="text" name="on_email" placeholder="예) email@email.com" required="">
									</dd>
								</dl>
							</li>
							<li>
