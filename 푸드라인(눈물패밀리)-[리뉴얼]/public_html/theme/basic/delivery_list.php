		   ...
		   <div class="scontents wow fadeInDownBig" data-wow-delay="0.3s">
				...
				<div class="scon_left">
					<div class="sub_title_wr wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
						...
						<p class="sub_desc">원하시는 배달대행 서비스<br class="lview"> 단위를 선택해주세요.</p>
					</div>
				</div>
						...
						<ul>
							<li>
								<a href="<?php echo G5_URL ?>/form01.php">
									<img src="<?php echo G5_THEME_IMG_URL ?>/sub/delivery_iocn01.png">
									<strong>일반 매장<br>배달대행 문의</strong>
								</a>
							</li>
							<li>
								<a href="<?php echo G5_URL ?>/form02.php">
									<img src="<?php echo G5_THEME_IMG_URL ?>/sub/delivery_iocn02.png">
									<strong>기업 본사<br>배달제휴 문의</strong>
								</a>
							</li>
						</ul>
					</div>
