...
<!-- 상단 시작 { -->
<div id="hd" class="wow fadeInDownBig" data-wow-delay="0.3s">
    ...
    <div id="hd_wrapper">
        ...
        <!--<div class="tnb">
            <?php if ($is_admin) {  ?>
                <a href="<?php echo G5_BBS_URL ?>/logout.php"><i class="fa-sharp fa-solid fa-lock-keyhole-open"></i> 로그아웃</a>
            <?php } else {  ?>
                <a href="<?php echo G5_BBS_URL ?>/login.php" class="adm"><i class="fa-sharp fa-solid fa-lock-keyhole"></i> 관리자 로그인</a>
            <?php }  ?>
        </div>-->
    </div><!--#hd_wrapper-->
</div>
