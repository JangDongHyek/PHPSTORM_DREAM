...
if($bo_table == 'item' && $member['mb_level'] == 2){
	$g5['title'] = '주문하기';
	$g5_head_title = $g5['title'];
}
...
echo '<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/normalize.css">'.PHP_EOL;
...
echo '<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/font-awesome.min.css">'.PHP_EOL;
echo '<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css">'.PHP_EOL;
?>
<!--[if lte IE 8]>
