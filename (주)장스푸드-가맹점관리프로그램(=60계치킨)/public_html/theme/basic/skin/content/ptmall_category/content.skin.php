...
$sql = " select MAX(SUBSTRING(ca_id,$len2,2)) as max_subid from g5_ptmall_category
...
$list_sql = " select * from g5_ptmall_category order by ca_order desc, ca_idx asc ";
...
<div id="category_container">
	...
	<input type="hidden" name="shop_type" value="pointMall">
		...
		<tr>
			...
			<td class="list_td talgin_c <?php echo $td_bg ?>">
			<?php
			$it_cnt_sql = " select count(*) as cnt from g5_write_ptmall_item where wr_10='{$list_row['ca_idx']}' ";
		...
		?>
		<tr>
			<td class="list_td talgin_c" colspan="3">등록된 상품분류가 없습니다.</td>
		</tr>
		<?
		}
		?>
...
$(function(){
	...
	$(".btn_submit").on('click', function(){
		...
		$.ajax({
			...
			data: { ca_id: ca_id_val, ca_name: ca_name_val, shop_type : "pointMall" },
