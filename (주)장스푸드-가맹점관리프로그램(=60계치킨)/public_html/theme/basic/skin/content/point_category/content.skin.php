...
$sql = " select MAX(SUBSTRING(ca_id,$len2,2)) as max_subid from g5_point_category
...
$list_sql = " select * from g5_point_category order by ca_order desc, ca_idx asc ";
...
<div id="category_container">
	...
	<input type="hidden" name="shop_type" value="point">
		...
		<tr>
			...
			<td class="list_td talgin_c <?php echo $td_bg ?>">
			<?php
			$it_cnt_sql = " select count(*) as cnt from g5_write_point_item where wr_10='{$list_row['ca_idx']}' ";
...
$(function(){
	...
	$(".btn_submit").on('click', function(){
		...
		$.ajax({
			...
			data: { ca_id: ca_id_val, ca_name: ca_name_val, shop_type : "point" },
