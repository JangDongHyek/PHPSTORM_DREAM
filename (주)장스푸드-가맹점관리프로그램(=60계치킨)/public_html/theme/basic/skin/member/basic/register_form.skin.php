...
<div class="mbskin">
	...
	<input type="hidden" name="mb_mailling" id="reg_mb_mailling" value="1">
	<input type="hidden" name="mb_sms" id="reg_mb_sms" value="1">

	<table style="margin:0; padding:0 0; width:100%; border-collapse:collapse;">
	<tbody>
	<tr>
		<th style="margin:0; padding:10px 4px; border:1px solid #d2d2d2; background:#f7f7f7; text-align:center;">1</th>
		<td>2</td>
	</tr>
	</tbody>
	</table>
