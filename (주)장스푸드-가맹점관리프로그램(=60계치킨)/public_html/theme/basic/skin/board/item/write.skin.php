	...
	<div id="form_box">
		...
		<tr>
			...
			<td class="form_tbl_td x330">
				<select name="wr_10" id="wr_10">
					<?php echo item_cate_option($write['wr_10']) ?>
				</select>
			</td>
		...
		<tr>
			...
			<td class="form_tbl_td">
				<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" class="frm_text x300" maxlength="255">
			</td>
		</tr>
		<tr>
			<th class="form_tbl_th x110"><label for="wr_1">판매가격</label></th>
			<td class="form_tbl_td">
				<input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_text required x160" style="text-align:right; IME-MODE:disabled;" onkeypress="return chkNum(event);" onKeyDown="onOnlyNumber(this);">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="form_tbl_td" colspan="3">
				...
				<div class="opt_container">
					...
					<thead>
					<tr>
						<th class="opt_th">옵션항목</th>
						<th class="opt_th x180">옵션추가금액(원)</th>
						<th class="opt_th x110">삭제</th>
					</tr>
					</thead>
					<tbody id="tbody_opt1">
					<?php
