...
<article id="bo_v" style="width:<?php echo $width; ?>">
	...
	<form method="post" name="buy_frm" action="<?php echo G5_BBS_URL ?>/cart_in.php" onsubmit="">
	...
	<div id="cate_box" style="margin-top:30px; margin-left:2px;">
		<ul id="bo_cate_ul">
			<?php
			$c_sql = " select * from g5_category order by ca_order desc, ca_idx asc ";
...
$(function(){
	...
	$("#cart_btn").on('click', function(){
		...
		$.ajax({
			type : 'post',
			url : '<?php echo G5_BBS_URL ?>/cart_in.php',
			data : frm_query,
			dataType : 'html',
			success : function(html){
				if(confirm('장바구니에 상품이 담겼습니다.\n장바구니로 이동하시겠습니까?')){
					location.href = '<?php echo G5_BBS_URL ?>/content.php?co_id=cart';
				}else{
					return false;
				}
			},
