...
define('G5_MYSQL_USER', 'chicken60');
define('G5_MYSQL_PASSWORD', 'kiuosro1');
define('G5_MYSQL_DB', 'chicken60');
...
$g5['ipconfig_table'] = G5_TABLE_PREFIX.'ipconfig'; // 접속가능아이피 테이블
$g5['content_save_table'] = G5_TABLE_PREFIX.'content_save'; // 내용저장관리 테이블

$g5['mc_table'] = G5_TABLE_PREFIX.'member_category'; // 회원 카테고리 테이블
...
$g5['g5_shopitem_option_save_table'] = G5_SHOP_TABLE_PREFIX.'item_option_save'; // 추가 옵션저장 테이블
?>