...
fwrite($f, "\$g5['ipconfig_table'] = G5_TABLE_PREFIX.'ipconfig'; // 접속가능아이피 테이블\n");
fwrite($f, "\$g5['content_save_table'] = G5_TABLE_PREFIX.'content_save'; // 내용저장관리 테이블\n");
...
if($g5_shop_install) {
    ...
    fwrite($f, "\$g5['g5_shopitem_option_save_table'] = G5_SHOP_TABLE_PREFIX.'item_option_save'; // 추가 옵션저장 테이블\n");
}
