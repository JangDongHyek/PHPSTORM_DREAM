...
// 2017-09-14 고객정보 및 기타정보 불러오기 
include_once("./install_manager.php");
...
<div class="ins_inner">
	<a onclick="setAuto()" style="float:right; color:#FFF;">설정</a>
    <table class="ins_frm">
    ...
    <table class="ins_frm">
    <caption>최고관리자 정보입력(아이티포원)</caption>
    <colgroup>
        <col style="width:150px">
        <col>
    </colgroup>
    <tbody>
    <tr>
        <th scope="row"><label for="super_id">아이티포원 ID</label></th>
        <td>
            <input name="super_id" type="text" value="lets080" id="super_id">
        </td>
    </tr>
    <tr>
        <th scope="row"><label for="super_pass">비밀번호</label></th>
        <td>
            <input name="super_pass" type="text" id="super_pass">
        </td>
    </tr>
    </tbody>
    </table>
