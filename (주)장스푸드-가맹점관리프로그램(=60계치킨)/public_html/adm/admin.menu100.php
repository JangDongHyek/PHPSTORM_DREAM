...
if($_SESSION['ss_mb_id']=="lets080"){
	$menu['menu100'] = array (
		...
		array('100210', '서브메뉴설정', G5_ADMIN_URL.'/submenu_list.php',     'cf_menu', 1),
		...
		array('100510', '접속아이피관리',        G5_ADMIN_URL.'/ipconfig.php',       'cf_phpinfo'),
...
if($_SESSION['ss_mb_id']!="lets080" && $member['mb_level'] == 10){
	$menu['menu100'] = array (
		array('100000', '팝업관리', G5_ADMIN_URL.'/newwinlist.php', 'scf_poplayer'),
	);
}
