...
if($_SESSION['ss_mb_id']=="admin"){
	$menu['menu300'] = array (
		array('300000', '분류관리', ''.G5_ADMIN_URL.'/mc_list.php?level=3', ''),
		array('300100', '점주 분류관리', ''.G5_ADMIN_URL.'/mc_list.php?level=3', ''),
		array('300200', '임직원 분류관리', ''.G5_ADMIN_URL.'/mc_list.php?level=2', '')
	);
}
*/
?>