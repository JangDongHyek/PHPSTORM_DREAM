...
<select name="sfl" id="sfl">
	<option value="mb_2" <?php echo get_selected($_GET['sfl'], "mb_2"); ?>>매장명</option>
    <option value="mb_id"<?php echo get_selected($_GET['sfl'], "mb_id"); ?>>회원아이디</option>
    <option value="mb_name"<?php echo get_selected($_GET['sfl'], "mb_name"); ?>>이름</option>
</select>
<label for="stx" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
<input type="text" name="stx" value="<?php if($sfl != 'mb_level') echo $stx; ?>" id="stx" class="frm_input">
...
<div class="btn_add01 btn_add">
    <select id="sch_level" style="float:left; margin-top:9px;">
		<option value="">선택하세요</option>
		<option value="2" <?php if($stx == 2) echo 'selected'; ?>>점주</option>
		<option value="3" <?php if($stx == 3) echo 'selected'; ?>>임직원</option>
		<option value="10" <?php if($stx == 10) echo 'selected'; ?>>관리자</option>
	</select>
	<script>
	$(function(){
		$("#sch_level").on('change', function(){
			if($("#sch_level").val() != ''){
				location.href = '<?php echo G5_ADMIN_URL ?>/member_list.php?sfl=mb_level&stx='+$(this).val();
			}else{
				location.href = '<?php echo G5_ADMIN_URL ?>/member_list.php';
			}
		});
	});
	</script>
    ...
    <!--<a href="./member_list_excel.php" id="member_add">엑셀</a>-->
    <?php } ?>
</div>
<?php } ?>
...
<div class="tbl_head02 tbl_wrap">
	...
	<tr>
		...
		<th scope="col" id="mb_list_name"><?php echo subject_sort_link('mb_2') ?>매장명</a></th>
		<th scope="col" id="mb_list_name"><?php echo subject_sort_link('mb_name') ?>이름</a></th>
		<th scope="col" id="mb_list_auth"><?php echo subject_sort_link('mb_level', '', 'desc') ?>회원 권한</a></th>
		<th scope="col" id="mb_list_auth"><?php echo subject_sort_link('mb_level', '', 'desc') ?>회원 구분</a></th>
		<th scope="col" id="mb_list_mobile">휴대폰번호</th>
		<th scope="col" id="mb_list_cNo">사업자등록번호</th>
		<th scope="col" id="mb_list_ck">계육업체</th>
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td headers="mb_list_name" class="td_mbname"><?php echo $row['mb_2'] ?></td>
		...
		<td headers="mb_list_auth" class="td_mbstat"><?php echo $row['mb_1'] ?></td>
		<td headers="mb_list_mobile" class="td_tel"><?php echo get_text($row['mb_hp']); ?></td>
		<td headers="mb_list_cNo" class="td_center"><?php echo get_text($row['mb_3']); ?></td>
		<td headers="mb_list_ck" class="td_center"><?=$ck['co_name']?></td>
