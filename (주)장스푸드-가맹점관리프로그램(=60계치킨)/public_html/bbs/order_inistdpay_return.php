...
<?php
        require_once(G5_BBS_URL.'/libs/INIStdPayUtil.php');
        require_once(G5_BBS_URL.'/libs/HttpClient.php');
        require_once(G5_BBS_URL.'/libs/sha256.inc.php');
        require_once(G5_BBS_URL.'/libs/json_lib.php');
