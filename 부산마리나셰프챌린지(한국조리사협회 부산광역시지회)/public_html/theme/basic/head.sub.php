...
<link href="<?php echo G5_THEME_CSS_URL; ?>/font-awesome.min.css" rel="stylesheet" type="text/css"><!--부스스트랩-->
...
<script src="<?php echo G5_THEME_JS_URL ?>/jquery.menu.js?ver=2"></script><!--상단메뉴(pc및모바일) 및 그외 JS추가부분-->
<script src="<?php echo G5_JS_URL ?>/common.js"></script>
<script src="<?php echo G5_JS_URL ?>/wrest.js"></script>
<script src="<?php echo G5_JS_URL ?>/jquery-1.9.1.min.js"></script>
<?php /*?><script src="<?php echo G5_THEME_JS_URL ?>/bootstrap.min.js"></script><!--부트스트랩--><?php */?>
