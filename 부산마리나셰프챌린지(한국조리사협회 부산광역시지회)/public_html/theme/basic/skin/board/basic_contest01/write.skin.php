...
<section id="bo_w">
	...
	BUSAN MARINA CHEF CALLENGE 2024</p>
		<h1>라이브 단체경연 신청서</h1>
		<h2>A petition for a group contest</h2>
	</div>
	<!--신청서start-->
	<div class="btn_bg">
	<a href="<?php echo G5_THEME_URL ?>/dawnload/2024 마리나컵 단체경연 신청.hwp"><div class="btn btn-info">참가신청서 다운로드</div></a>
	...
	(E-mail)</th>
	 ...
	 (Occuption/Work)</th>
		...
		<tr>
		  ...
		  <td><input type="text" class="form-control" name="wr_29" value="<?=$write['wr_29']?>"></td>
		  <td><input type="text" class="form-control" name="wr_30" value="<?=$write['wr_30']?>"></td>
		</tr>
		<tr>
		  <th rowspan="2">팀장<br>(Team Leader)</th>
	...
	<div class="border">
	<p>* <strong>경연일정: 2024년 10월 4일(금) ~ 6일(일)</strong> (Contest schedule: 2024. Oct. 4.(Fri) ~ Oct. 6(Sun))</p>
	<p>* <strong>등 록 비 : 250,000원</strong>(Registration fee : 250,000won)</p>
