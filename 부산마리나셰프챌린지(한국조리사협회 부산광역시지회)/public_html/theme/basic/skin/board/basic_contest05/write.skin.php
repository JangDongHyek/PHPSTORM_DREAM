...
<section id="bo_w">
    ...
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);"
        ...
        <input type="hidden" name="wr_content" value="라이브 개인경연 신청서">
        <?php
        $option = '';
        $option_hidden = '';
        ...
        <div class="contest_title">
            ...
            <h1>라이브 1인 경연 신청서</h1>
            <h2>Live 1people Contest Application</h2>
        </div>
        ...
        <div class="btn_bg">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="contest_table">
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="wr_3" value="<?= $write['wr_3'] ?>" required></td>
                ...
                <!--		<tr>-->
                <!--		  <th>셰프2 (Chef2)</th>-->
                <!--		  <td><input type="text" class="form-control" name="wr_5" value="-->
                <? //=$write['wr_5']?><!--"></td>-->
                <!--		  <td><input type="text" class="form-control" name="wr_6" value="-->
                <? //=$write['wr_6']?><!--"></td>-->
                <!--		  <td><input type="text" class="form-control" name="wr_7" value="-->
                <? //=$write['wr_7']?><!--"></td>-->
                <!--		  <td><input type="text" class="form-control" name="wr_8" value="-->
                <? //=$write['wr_8']?><!--"></td>-->
                <!--		  <td><input type="text" class="form-control" name="wr_9" value="-->
                <? //=$write['wr_9']?><!--"></td>-->
                <!--		  <td><input type="text" class="form-control" name="wr_10" value="-->
                <? //=$write['wr_10']?><!--"></td>-->
                <!--		</tr>-->
                <? if (!$w) { ?>
                    <?php if ($is_password) { ?>
            ...
            <!--div class="contest_title">
                <h1>라이브 2인 경연(Live 2 people Contest)</h1>
            </div-->
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cha_table">
                ...
                <!--
		<tr>
		  <th rowspan="8">라이브2인</th>
		  <td>Class 1</td>
		  <td>BEEF</td>
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_11" id="wr_11" value="1" <? if ($write['wr_11']) {
                    echo "checked";
                } ?>>
		</label>
	  </div></td>
		...
		<tr>
		  ...
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_12" id="wr_12" value="1" <? if ($write['wr_12']) {
                    echo "checked";
                } ?>>
		</label>
	  </div></td>
		...
		<tr>
		  ...
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_13" id="wr_13" value="1" <? if ($write['wr_13']) {
                    echo "checked";
                } ?>>
		</label>
	  </div></td>
		...
		-->
                ...
                <tr>
                    <th rowspan="10">라이브 1인</th>
                    <td>Class 4</td>
                    <td>Meat &amp; Poultry</td>
                    <td>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="wr_14" id="wr_14" value="1" <? if ($write['wr_14']) {
                                    echo "checked";
                                } ?>>
                            </label>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="wr_15" id="wr_15" value="1" <? if ($write['wr_15']) {
                                    echo "checked";
                                } ?>>
                            </label>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="wr_16" id="wr_16" value="1" <? if ($write['wr_16']) {
                                    echo "checked";
                                } ?>>
                            </label>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="wr_17" id="wr_17" value="1" <? if ($write['wr_17']) {
                                    echo "checked";
                                } ?>>
                            </label>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="wr_18" id="wr_18" value="1" <? if ($write['wr_18']) {
                                    echo "checked";
                                } ?>>
                            </label>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="wr_19" id="wr_19" value="1" <? if ($write['wr_19']) {
                                    echo "checked";
                                } ?>>
                            </label>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="wr_20" id="wr_20" value="1" <? if ($write['wr_20']) {
                                    echo "checked";
                                } ?>>
                            </label>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="wr_21" id="wr_21" value="1" <? if ($write['wr_21']) {
                                    echo "checked";
                                } ?>>
                            </label>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="wr_22" id="wr_22" value="1" <? if ($write['wr_22']) {
                                    echo "checked";
                                } ?>>
                            </label>
                        </div>
        ...
        <? if (!$w) { ?>
            ...
            <div class="border">
                ...
                <p>* <strong>등 록 비 : 각 종목당 50,000원(1인 기준)</strong> (Registration fee : 50,000won) </p>
