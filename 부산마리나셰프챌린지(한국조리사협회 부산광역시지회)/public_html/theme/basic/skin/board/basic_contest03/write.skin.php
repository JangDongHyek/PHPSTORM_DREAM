    ...
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);"
        ...
        <div class="btn_bg">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="contest_table">
                ...
                <tr>
                    <th>셰프1 (Chef1)</th>
                    <td><input type="text" class="form-control" name="wr_name" value="<?= $write['wr_name'] ?>"
                               required></td>
                    <td><input type="text" class="form-control" name="wr_1" value="<?= $write['wr_1'] ?>"></td>
                    <td><input type="text" class="form-control" name="wr_2" value="<?= $write['wr_2'] ?>"></td>
                    <td><input type="text" class="form-control" name="wr_3" value="<?= $write['wr_3'] ?>"></td>
                    <td><input type="text" class="form-control email" name="wr_email" value="<?= $write['wr_email'] ?>">
                    </td>
		...
		<tr>
		  ...
		  <td><input type="text" class="form-control" name="wr_25" value="<?= $write['wr_25'] ?>"></td>
		  <td><input type="text" class="form-control" name="wr_26" value="<?= $write['wr_26'] ?>"></td>
		  <td><input type="text" class="form-control" name="wr_27" value="<?= $write['wr_27'] ?>"></td>
		  <td><input type="text" class="form-control" name="wr_28" value="<?= $write['wr_28'] ?>"></td>
		</tr>
		-->
                <? if (!$w) { ?>
                    <?php if ($is_password) { ?>
                        ...
                        <td colspan="6" style="text-align:left;">
                            ...
                            <?php if ($is_file_content) { ?>
                                <input type="text" name="bf_content[]"
                                       ...
                                       title="파일 설명을 입력해주세요." class="frm_file frm_input">
                            <?php } ?>
        ...
        <div class="contest_title">
            <h1>전시 경연 (Exhibition Contest)</h1>
        </div>
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cha_table">
            ...
            <tr>
                ...
                <td>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="wr_29" id="wr_29" value="1" <? if ($write['wr_29']) {
                                echo "checked";
                            } ?>>
                        </label>
                    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="wr_30" id="wr_30" value="1" <? if ($write['wr_30']) {
                                echo "checked";
                            } ?>>
                        </label>
                    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="wr_31" id="wr_31" value="1" <? if ($write['wr_31']) {
                                echo "checked";
                            } ?>>
                        </label>
                    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="wr_32" id="wr_32" value="1" <? if ($write['wr_32']) {
                                echo "checked";
                            } ?>>
                        </label>
                    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="wr_33" id="wr_33" value="1" <? if ($write['wr_33']) {
                                echo "checked";
                            } ?>>
                        </label>
                    </div>
            ...
            <!--
		<tr>
		  <th rowspan="4">2.로컬푸드<br>
	(Theme of Local Cuisine)</th>
		  <td>Class 1</td>
		  <td>핑거푸드/타파스 (Finger food or Tapas)</td>
		...
		<tr>
		  <td>Class 2</td>
		  <td>뷔페요리 플레터 (Buffet Platter)</td>
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_34" id="wr_34" value="1" <? if ($write['wr_34']) {
                echo "checked";
            } ?>>
		</label>
	  </div></td>
		...
		<tr>
		  <td>Class 3</td>
		  <td>3코스 채식요리 (3 Course Vegetarian) (Lacto Ovo)</td>
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_35" id="wr_35" value="1" <? if ($write['wr_35']) {
                echo "checked";
            } ?>>
		</label>
	  </div></td>
		...
		<tr>
		  <td>Class 4</td>
		  <td>3코스 요리 (3 Course Menu)</td>
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_36" id="wr_36" value="1" <? if ($write['wr_36']) {
                echo "checked";
            } ?>>
		</label>
	  </div></td>
		...
		<tr>
		  <th rowspan="4">3.프랜차이즈<br>
	(Theme of Franchise Restaurant)</th>
		  <td>Class 1</td>
		  <td>브런치 요리 (Brunch restaurant Menu)</td>
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_37" id="wr_37" value="1" <? if ($write['wr_37']) {
                echo "checked";
            } ?>>
		</label>
	  </div></td>
		...
		<tr>
		  <td>Class 2</td>
		  <td>가금류 요리 (Meat of Poultry Plate Dishes)</td>
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_38" id="wr_38" value="1" <? if ($write['wr_38']) {
                echo "checked";
            } ?>>
		</label>
	  </div></td>
		...
		<tr>
		  ...
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_39" id="wr_39" value="1" <? if ($write['wr_39']) {
                echo "checked";
            } ?>>
		</label>
	  </div></td>
		...
		<tr>
		  ...
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_40" id="wr_40" value="1" <? if ($write['wr_40']) {
                echo "checked";
            } ?>>
		</label>
	  </div></td>
		...
		<tr>
		  <th>4.푸드조각전시<br>
	(Carving competition)</th>
		  <td>&nbsp;</td>
		  <td>푸드조각 (Fruits or Vegetable)</td>
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_41" id="wr_41" value="1" <? if ($write['wr_41']) {
                echo "checked";
            } ?>>
		</label>
	  </div></td>
        ...
        <? if (!$w) { ?>
            <div class="border">
                <div class="scroll">
                    ...
                    부산마리나셰프챌린지사무국은 신청서를 진행함에 있어 다음의 이용정보를 수집, 이용하게 됩니다. 따라서 부산마리나셰프챌린지 사무국은 [개인정보보호법]에 따라 법률 사무 절차를 진행함에
                    있어 필수적인 신청자의 식별정보를 다음과 같이 수집하고자 합니다.
                    <br><br>
                    <p>▶ 개인정보 수집, 이용 목적</p>
