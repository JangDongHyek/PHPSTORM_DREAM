    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_con">
			<div class="contest_title">
				...
				<!--신청서start-->
				<div class="btn_bg">
				<!--a href="<?php echo G5_THEME_URL ?>/dawnload/RECIPE.hwp"><button type="button" class="btn btn-info">RECIPE 다운로드</button></a-->
				 ...
				 (Occuption/Work)</th>
					...
					*/
					...
					<tr>
					  ...
					  <td><?=$view['wr_name']?></td><!-- 국문이름 -->
					  <td><?=$view['wr_1']?></td><!-- 영문이름 -->
					  <td><?=$view['wr_2']?></td><!-- 생년월일 -->
					  <td><?=$view['wr_3']?></td><!-- 휴대전화 -->
					  <td><?=$view['wr_email']?></td><!-- 이메일 -->
					  <td><?=$view['wr_4']?></td><!-- 소속 -->
					</tr>
					<!--
					<tr>
					...
					<tr>
					  ...
					  <td colspan="2"><?=$view['wr_5']?></td>
					  <th class="table_color">주소(Address)</th>
					  <td colspan="2"><?=$view['wr_6']?></td>
					</tr>
                    <?/*<tr>
					  <th rowspan="2">셰프2 (Chef2)</th>
					  <td><?=$view['wr_7']?></td><!-- 국문이름 -->
					  <td><?=$view['wr_8']?></td><!-- 영문이름 -->
					  <td><?=$view['wr_9']?></td><!-- 생년월일 -->
					  <td><?=$view['wr_10']?></td><!-- 휴대전화 -->
					  <td><?=$view['wr_11']?></td><!-- 이메일 -->
					  <td><?=$view['wr_12']?></td><!-- 소속 -->
					</tr>*/?>
				  </tbody>
				</table>
...
<BR><BR>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="cha_table">
	  <tbody>
		...
		<label>
		  <input type="checkbox" name="wr_13" id="" value="1" <?if($write['wr_13']=='1'){echo "checked";}?> disabled>
		</label>
	  </div></td>
		</tr>
		<!-- <tr>
		  ...
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_15" id="" value="1" <?if($write['wr_15']=='1'){echo "checked";}?> disabled>
		</label>
			  </div></td>
		</tr> -->
		<!-- <tr>
		  ...
		  <td><div class="checkbox">
		<label>
		  <input type="checkbox" name="wr_14" id="" value="1" <?if($write['wr_14']=='1'){echo "checked";}?> disabled>
		</label>
			  </div></td>
		</tr>
		<tr>
