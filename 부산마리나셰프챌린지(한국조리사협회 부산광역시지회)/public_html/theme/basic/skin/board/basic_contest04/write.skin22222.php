...
<section id="bo_w">
	...
	<div class="contest_title">
		<p>부산마리나셰프챌린지 2020 <br>
	BUSAN MARINA CHEF CALLENGE 2020</p>
		<h1>카빙라이브 경연 신청서 </h1>
		<h2>A petition for a group contest</h2>
	</div>
	<!--신청서start-->
	<div class="btn_bg">
	<a href="<?php echo G5_THEME_URL ?>/dawnload/RECIPE.hwp"><div class="btn btn-info">RECIPE 다운로드</div></a>
...
<!-- 
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="cha_table">
	  <tbody>
		...
		<label>
		  <input type="checkbox" name="" id="" value="1" <?if($write['']){echo "checked";}?>>
		</label>
	  </div></td>
		</tr>
		<tr>
...
<div class="border">
	...
	<div class="border">
	<p>* <strong>경연일정 : 2020. 6월 19(금)~20일(토)</strong> (Contest schedule: 2020. June 19 (Fri) - 20 (Sat))</p>
	<p>* <strong>등 록 비 : 50,000원(1인 기준) </strong>(Registration fee : 50,000won per event (per person))</p>
