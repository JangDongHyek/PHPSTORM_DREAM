...
<section id="bo_w">
	...
	BUSAN MARINA CHEF CALLENGE 2024</p>
		<h1>카빙 단체 전시 경연 신청서</h1>
		<h2>Carving Group Exhibition Contest</h2>
	</div>
	<!--신청서start-->
	<div class="btn_bg">
	<a href="<?php echo G5_THEME_URL ?>/dawnload/2024 단체(3인 이상)경연 신청서.hwp"><div class="btn btn-info">참가신청서 다운로드</div></a>
