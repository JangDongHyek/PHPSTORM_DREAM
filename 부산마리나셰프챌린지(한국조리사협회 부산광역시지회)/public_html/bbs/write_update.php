...
if($bo_table == "live01"){
	$_POST['wr_subject'] = $_POST['wr_name']." 님의 라이브 단체경연 신청서입니다.";
}

if($bo_table == "live02"){
	$_POST['wr_subject'] = $_POST['wr_name']." 님의 라이브 개인경연 신청서입니다.";
}

if($bo_table == "live03"){
	$_POST['wr_subject'] = $_POST['wr_name']." 님의 전시경연 신청서입니다.";
}

if($bo_table == "live04"){
	$_POST['wr_subject'] = $_POST['wr_name']." 님의 라이브 카빙경연 신청서입니다.";
}
if($bo_table == "live05"){
    $_POST['wr_subject'] = $_POST['wr_name']." 님의 라이브 1인 경연 신청서입니다.";
}
if($bo_table == "live06"){
    $_POST['wr_subject'] = $_POST['wr_name']." 님의 카빙 단체 전시 경연 신청서입니다.";
}
...
if($bo_table != "live01" && $bo_table != "live02" && $bo_table != "live03" && $bo_table != "live04"){
...
if ($w == '' || $w == 'r') {
    ...
    if ($member['mb_id']) {
        $mb_id = $member['mb_id'];
		if($bo_table!="live02"&&$bo_table=="live01"&&$bo_table=="live03"){
	...
	if($bo_table == "live01"){
		for($wr_cnt=11;$wr_cnt<=30;$wr_cnt++){	
	...
	if($bo_table == "live03"){
		for($wr_cnt=11;$wr_cnt<=41;$wr_cnt++){	
			$wr_column .= ", wr_".$wr_cnt." = '".${"wr_".$wr_cnt}."' ";	
		}
	}
	if($bo_table == "live04"){
	...
	if($bo_table == "live01"){
		for($wr_cnt=11;$wr_cnt<=24;$wr_cnt++){	
			$wr_column .= ", wr_".$wr_cnt." = '".${"wr_".$wr_cnt}."' ";	
		}
	}
