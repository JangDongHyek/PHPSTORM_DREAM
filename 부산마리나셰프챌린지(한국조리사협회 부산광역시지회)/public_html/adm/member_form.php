    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
            ...
            <tr>
                ...
                <th scope="row"><label for="mb_gender">성별<strong class="sound_only">필수</strong></label></th>
                <td>
                    <input type="hidden" id="mb_gender_val" value="<?php echo $mb['mb_gender'] ?>">
                    <select name="mb_gender" id="mb_gender" class="frm_input" >
            ...
            <tr>
                ...
                <td><input type="text" name="mb_birth" value="<?php echo $mb['mb_birth'] ?>" id="mb_birth" required class="required frm_input" size="15" minlength="2" maxlength="8"></td>
                <th scope="row"><label for="mb_school">소속/학교명<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="mb_school" value="<?php echo $mb['mb_school'] ?>" id="mb_school" required class="required frm_input" size="15" minlength="2" maxlength="20"></td>
            </tr>
            <tr>
...
<script>
    ...
    $(document).ready(function () {
        ...
        // console.log(value);
        $("#mb_gender").val(value).prop("selected", true);
    })
</script>
