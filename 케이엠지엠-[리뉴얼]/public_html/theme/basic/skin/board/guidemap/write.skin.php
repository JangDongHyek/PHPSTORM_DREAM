...
*/ ?>
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=35cb8003d8c11cad471ec9edd09b2bfa&libraries=services"></script>
...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_subject">체인점명<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="wr_content">체인점 소개<strong class="sound_only">필수</strong></label></th>
            <td class="wr_content">
        ...
        <tr>
            ...
            <td style="position:relative;">
				...
				<input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input2" size="40" placeholder="주소 검색을 사용해주세요."><br/>
				<input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input2" size="40" placeholder="상세주소"><br/>
				<input type=button value="주소검색" class="add_btn" onclick="daumPostcode()">
			</td>
        </tr>
    ...
    <div class="btn_confirm">
        ...
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_submit2">취소</a>
    </div>
    </form>
