...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <footer>
            <ul class="bo_vc_act">
                <?php if ($list[$i]['is_reply']) { ?><li><a href="<?php echo $c_reply_href;  ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;">Answer</a></li><?php } ?>
...
<aside id="bo_vc_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php } ?>
        <tr>
            <th scope="row"><label for="wr_secret">Secret Text</label></th>
        ...
        ?>
        <tr>
            <th scope="row">SNS Registration</th>
    ...
    <div class="btn_confirm">
        <input type="submit" id="btn_submit" class="btn_submit" value="Comments">
    </div>
