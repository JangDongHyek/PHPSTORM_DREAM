...
<div id="bo_list" style="width:<?php echo $width; ?>">
	...
	<fieldset id="bo_sch">
		...
		<div class="searchBox">
			<ul class="clearfix">
    		<li class="bo_explain col-md-6 col-xs-12"><span class="bo_title">FAQ</span> | 자주 묻는 질문들입니다. 궁금사항은 먼저 검색해 보세요.</li>
       ...
       ?>
        <table>
           <tr>
            ...
            <td class="td_subject" style="font-weight: bold; font-size: 1.20em !important;">
                <?php
