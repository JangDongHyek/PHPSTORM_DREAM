...
<section id="bo_w">
    ...
    ?>
        ...
        <div class="radio_group parkname">
            <span><input type="radio" name="wr_subject" id="01" value="명성주차장" required="" <?php echo $wr_subject=="명성주차장"?" checked":"";?>>
                <label for="01">명성주차장</label></span>
            <span><input type="radio" name="wr_subject" id="02" value="유니티주차장" required="" <?php echo $wr_subject=="유니티주차장"?" checked":"";?>>
                <label for="02">유니티주차장</label></span>
            <br class="hidden-lg hidden-md hidden-sm" />
            <span><input type="radio" name="wr_subject" id="03" value="유카주차장" required="" <?php echo $wr_subject=="유카주차장"?" checked":"";?>>
                <label for="03">유카주차장</label></span>
            <span><input type="radio" name="wr_subject" id="04" value="신공항주차장" required="" <?php echo $wr_subject=="신공항주차장"?" checked":"";?>>
...
<p>
    ...
    본 약관은 2021년 11월 01일부터 적용됩니다.
        ...
        <div class="form-agree">
            ...
            <dl>
                ...
                <dd><input type="checkbox" name="agree" id="p_chk2" required=""><label for="p_chk2">개인정보 수집 및 이용에 동의합니다.</label></dd>
            </dl>
        </div>
        ...
        <div class="form-agree">
            <dl>
                ...
                <dd><input type="checkbox" name="agree2" id="p_chk3" required=""><label for="p_chk3">개인정보활용에 동의합니다.</label></dd>
            </dl>
        </div>
    ...
    <script>
        ...
        function fwrite_submit(f) {
            ...
            if (!f.agree.checked) {
                alert("개인정보 수집 및 이용에 대한 안내의 내용에 동의하셔야 예약 하실 수 있습니다.");
                f.agree.focus();
                return false;
            }
