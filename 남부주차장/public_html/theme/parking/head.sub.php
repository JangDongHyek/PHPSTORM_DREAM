...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/all.min.css"><!--Font awesome-->
<link href='//spoqa.github.io/spoqa-han-sans/css/SpoqaHanSans-kr.css' rel='stylesheet' type='text/css'><!--스포카 한 산스//무료폰트 눈누체 https://noonnu.cc/-->
<?php
...
<!--<script src="<?php echo G5_THEME_JS_URL ?>/jquery-1.9.1.min.js"></script><!--메인슬라이더에 필요한 js-->
<script src="<?php echo G5_JS_URL ?>/jquery.menu.js"></script><!--상단메뉴(pc및모바일) 및 그외 JS추가부분-->
<script src="<?php echo G5_THEME_JS_URL ?>/headeron.js"></script>
