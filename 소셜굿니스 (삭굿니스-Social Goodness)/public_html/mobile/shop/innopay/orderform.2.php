...
<input type="hidden" name="ReturnURL" value="<?=G5_HTTPS_MSHOP_URL?>/innopay.return.php" placeholder="">
...
<div id="display_pay_button" class="btn_confirm">
    <span id="show_req_btn"><input type="button" name="submitChecked" onClick="pay_approval();" value="참여진행" class="btn_submit"></span>
    <span id="show_pay_btn" style="display:none;"><input type="button" onClick="forderform_check();" value="참여진행" class="btn_submit"></span>
