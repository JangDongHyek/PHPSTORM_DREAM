...
?>
    ...
    <ul class="sod_list">
        ...
        <li class="sod_li">
            ...
            <div class="li_prqty">
                <span class="prqty_price li_prqty_sp"><span>예치금 </span><?php echo number_format($row['ct_price']); ?></span>
                <span class="prqty_qty li_prqty_sp"><span>수량 </span><?php echo number_format($sum['qty']); ?></span>
                <span class="prqty_sc li_prqty_sp"><span>배송비(선정자해당) </span>후불<!--?php echo $ct_send_cost; ?--></span>
            </div>
			        &nbsp;&nbsp;※ 배송비는 기부하기 참가자에게는 부과되지 않습니다.
            <div class="li_total">
                <span class="total_price total_span"><span>예치금 </span><strong><?php echo number_format($sell_price); ?></strong></span>
    ...
    <dl id="sod_bsk_tot">
        ...
        <?php } ?>
        <dt class="sod_bsk_dvr">배송비(선정자만 해당) </dt>
        <dd class="sod_bsk_dvr"><strong><?php echo number_format($send_cost); ?> 원</strong></dd>
        <dt class="sod_bsk_cnt">총계(선불)</dt>
    ...
    <section id="sod_frm_pay">
        ...
        <div class="odf_tbl">
            ...
            <tr>
             ...
             <tr>
                <th>선정 후 배송비 </th>
                <td><!-- <span id="od_send_cost2">0</span>원 --> 후불(선정된 참가자에 한해 배송비가 발생하게 됩니다.)</td>
            </tr>
            </tbody>
            </table>
			<div style="margin-top:6px">※ 배송비는 기부하기 참가자에게는 해당되지 않습니다.</div>
        </div>

        <?php
        if (!$default['de_card_point'])
            echo '<p id="sod_frm_pt_alert">신용카드 및 후불결제 수단으로 입금된 예치금은 카드사 및 후불결제사의 수수료 또는 일부 결제비용이 제외된 예치금이 포인트로 반환 지급됩니다. 이용약관을 참조 하시길 바랍니다.</p>';
...
//					pf.BuyerEmail.value = pf.od_email.value;//이메일
					pf.BuyerTel.value = pf.od_tel.value;//연락처
					/* 주소 */
