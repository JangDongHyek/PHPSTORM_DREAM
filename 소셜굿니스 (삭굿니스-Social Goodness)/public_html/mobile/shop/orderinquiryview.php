...
<div id="sod_fin">
    ...
    <div id="sod_fin_no">구매 및 참여번호 <strong><?php echo $od_id; ?></strong></div>
    ...
    <section class="sod_fin_list">
        ...
        <ul id="sod_list_inq" class="sod_list">
            ...
            ?>
                ...
                <div class="li_prqty">
                    <span class="prqty_price li_prqty_sp"><span>가격 </span><?php echo number_format($opt_price); ?></span>
                    ...
                    <span class="prqty_stat li_prqty_sp"><span>상태 </span><?php echo $opt['ct_status']; ?></span>                </div>
                <div class="li_total" style="padding-left:<?php echo $image_width + 10; ?>px;height:auto !important;height:<?php echo $image_height; ?>px;min-height:<?php echo $image_height; ?>px">
                    ...
                    <span class="total_price total_span"><span>금액 </span><?php echo number_format($sell_price); ?></span>
        ...
        <div id="sod_sts_wrap">
            ...
            <div id="sod_sts_explan">
                <dl id="sod_fin_legend">
                    <dt>신청</dt>
                    <dd>참여 신청이 접수 되었습니다.</dd>
                    <dt>입금</dt>
                    <dd>입금 확인되었습니다.</dd>
                    <dt>참여</dt>
                    <dd>참여 중입니다.</dd>
                    <dt>달성</dt>
                    <dd>지정된 참여율이 달성되어 선정자를 선정 예정</dd>
                    <dt>선정</dt>
                    <dd>선정되어 상품 배송중 또는 수령 예정입니다.</dd>
                </dl>
    ...
    <div id="sod_fin_view">
                        ...
                        if($od['od_settle_case'] == '신용카드' || is_inicis_order_pay($od['od_settle_case']) )
                        {
                            if($od['od_pg'] == 'lg') {
                                ...
                                $card_receipt_script = 'window.open(\'https://iniweb.inicis.com/DefaultWebApp/mall/cr/cm/mCmReceipt_head.jsp?noTid='.$od['od_tno'].'&noMethod=1\',\'receipt\',\'width=430,height=700\');';
																...
																$card_receipt_script = 'window.open(\'https://pg.innopay.co.kr/pay/issue/CardIssue.jsp?TID='.$od['od_tno'].'\', \'winreceipt\', \'width=470,height=815,scrollbars=yes,resizable=yes\');';
														}else {
        ...
        <section id="sod_fin_dvr">
            ...
            <div  class="odf_tbl">
                ...
                ?>
                <tr>
                    <td class="empty_table" colspan="2">배송은 선정자에 한해서만 상품이 배송됩니다.</td>
                </tr>
                <?php
                }
                ?>
    ...
    <section id="sod_fin_cancel">
        ...
        if ($cancel_price == 0) {
            if ($custom_cancel) {
        ?>
        <button type="button" onclick="document.getElementById('sod_fin_cancelfrm').style.display='block';">취소하기</button>
...
<script type="text/javascript" src="<?php echo G5_JS_URL?>/socket.io.js"></script>
<script type="text/javascript">

 //var host="clibe-kimnamhyong.c9users.io";
	var host="14.48.175.184";
    var port="8081";
    var socket;
		var inviData;
		var rankuTime;
  ...
  function sendMessage(){
	...
	var od_id="<?=$od_id?>";	
	var id="lets080";
    var output={od_id:od_id,name:name,id:id};
    if (socket == undefined) {
