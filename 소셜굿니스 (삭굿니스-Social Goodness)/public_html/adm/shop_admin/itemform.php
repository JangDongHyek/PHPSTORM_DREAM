...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <?php } else { ?>
                    ...
                    <a href="<?php echo G5_SHOP_URL; ?>/item.php?it_id=<?php echo $it_id; ?>" class="btn_frmline">펀딩확인</a>
		...
		<tr>
            <th scope="row"><label for="it_cust_price">현재참가율</label></th>
            <td>
                <input type="text" name="it_1" value="<?php echo $it['it_1']; ?>" id="it_cust_price" class="frm_input" size="8"> %
            </td>
        </tr>
		<tr>
            <th scope="row"><label for="it_2">공지사항</label></th>
            <td>
                <input type="text" name="it_2" value="<?php echo $it['it_2']; ?>" id="it_2" class="frm_input" size="95"> 
            </td>
        </tr>
		<tr>
            <th scope="row"><label for="it_4">유효기간</label></th>
            <td>
                <input type="text" name="it_4" value="<?php echo $it['it_4']; ?>" id="it_4" class="frm_input" size="30" placeholder="ex)2019년 01월 31일까지">
            </td>
        </tr>
		<tr>
            <th scope="row"><label for="it_basic">설명</label></th>
            <td>
		...
		<tr>
            <th scope="row"><label for="it_basic">SNS 상품흥보</label></th>
            <td>
                <input type="checkbox" name="it_5" value="facebook"<?php echo $it[it_5]=="facebook"?" checked":"";?>>페이스북
				<input type="checkbox" name="it_6" value="twitter"<?php echo $it[it_6]=="twitter"?" checked":"";?>>트위터
            </td>
        </tr>
        <!--
        <tr>
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="it_3">회원</label></th>
            <td>
                <input type="text" name="it_3" value="<?php echo $it['it_3']; ?>" id="it_3" class="frm_input" size="20" placeholder="ex)20% 할인">
            </td>
        </tr>
        <tr>
