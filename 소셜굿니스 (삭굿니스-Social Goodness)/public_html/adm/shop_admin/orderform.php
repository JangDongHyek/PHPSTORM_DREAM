...
<section id="anc_sodr_list">
	...
	<!--a href="./excel.orderitem.php?od_id=<?=$od_id?>">주문 상품 엑셀다운로드</a-->
    ...
    <div class="btn_list02 btn_list">
        <p>
            ...
            <input type="submit" name="ct_status" value="신청" onclick="document.pressed=this.value" class="btn_02 color_01">
            <input type="submit" name="ct_status" value="입금" onclick="document.pressed=this.value" class="btn_02 color_02">
            <input type="submit" name="ct_status" value="참여" onclick="document.pressed=this.value" class="btn_02 color_03">
            <input type="submit" name="ct_status" value="달성" onclick="document.pressed=this.value" class="btn_02 color_04">
            <input type="submit" name="ct_status" value="선정" onclick="document.pressed=this.value" class="btn_02 color_05">
            <input type="submit" name="ct_status" value="미달" onclick="document.pressed=this.value" class="btn_02 color_06">
            <input type="submit" name="ct_status" value="환불" onclick="document.pressed=this.value" class="btn_02 color_06">
            <input type="submit" name="ct_status" value="말료" onclick="document.pressed=this.value" class="btn_02 color_06">
        </p>
    </div>

    <div class="local_desc01 local_desc">
        <p>신청, 입금, 참여, 달성, 선정은 장바구니와 주문서 상태를 모두 변경하지만, 미달, 환불, 말료는 장바구니의 상태만 변경하며, 주문서 상태는 변경하지 않습니다.</p>
