...
<div class="sit_option_frm_wrapper">
    ...
    <tr>
		...
		<th scope="col">상품금액(도매)</th>
		<th scope="col">상품금액(소매)</th>
        <th scope="col">재고수량</th>
        <th scope="col">통보수량</th>
		<th scope="col">사용여부(도매)</th>
		<th scope="col">사용여부(소매)</th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr>
        ...
        <td class="td_numsmall">
            <label for="spl_price_<?php echo $i; ?>" class="sound_only">상품금액(도매)</label>
            <input type="text" name="spl_price[]" value="<?php echo $spl_price; ?>" id="spl_price_<?php echo $i; ?>" class="frm_input" size="5">
        </td>
		<td class="td_numsmall">
            <label for="spl_price_<?php echo $i; ?>" class="sound_only">상품금액(소매)</label>
            <input type="text" name="spl_price2[]" value="<?php echo $spl_price2; ?>" id="spl_price_<?php echo $i; ?>" class="frm_input" size="5">
        </td>
        <td class="td_num">
        ...
        <td class="td_mng">
            <label for="spl_use_<?php echo $i; ?>" class="sound_only">사용여부(도매)</label>
		...
		<td class="td_mng">
            <label for="spl_use_<?php echo $i; ?>" class="sound_only">사용여부(소매)</label>
            <select name="spl_use2[]" id="spl_use_<?php echo $i; ?>">
                <option value="1" <?php echo get_selected('1', $spl_use2); ?>>사용함</option>
                <option value="0" <?php echo get_selected('0', $spl_use2); ?>>사용안함</option>
            </select>
        </td>
    </tr>
    <?php
    ...
    <tr>
		...
		<td class="td_numsmall">
            <label for="spl_price_<?php echo $i; ?>" class="sound_only">상품금액(소매)</label>
            <input type="text" name="spl_price2[]" value="<?php echo $spl_price2; ?>" id="spl_price_<?php echo $i; ?>" class="frm_input" size="9">
        </td>
        <td class="td_num">
            <label for="spl_stock_qty_<?php echo $i; ?>" class="sound_only">재고수량</label>
            <input type="text" name="spl_stock_qty[]" value="<?php echo $spl_stock_qty; ?>" id="spl_stock_qty_<?php echo $i; ?>" class="frm_input" size="5">
