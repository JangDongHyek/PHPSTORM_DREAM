...
<div class="sit_option_frm_wrapper">
    ...
    <tr>
        ...
        <th scope="col">옵션</th>
        <th scope="col">추가금액(도매)</th>
		<th scope="col">추가금액(소매)</th>
    ...
    <tr>
		...
		<td class="td_numsmall">
            <label for="opt_price_<?php echo $i; ?>" class="sound_only"></label>
            <input type="text" name="opt_price2[]" value="<?php echo $opt_price2; ?>" id="opt_price_<?php echo $i; ?>" class="frm_input" size="9">
        </td>
        <td class="td_num">
		...
		<td class="td_mng">
            <label for="opt_use_<?php echo $i; ?>" class="sound_only"></label>
            <select name="opt_use2[]" id="opt_use_<?php echo $i; ?>">
                <option value="1" <?php echo get_selected('1', $opt_use2); ?>>사용함</option>
                <option value="0" <?php echo get_selected('0', $opt_use2); ?>>사용안함</option>
            </select>
        </td>
    </tr>
    <?php
