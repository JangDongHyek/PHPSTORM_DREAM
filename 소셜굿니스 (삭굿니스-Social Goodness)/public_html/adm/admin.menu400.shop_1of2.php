...
$menu['menu400'] = array (
    array('400000', '관리', G5_ADMIN_URL.'/shop_admin/', 'shop_config'),
    array('400100', '설정', G5_ADMIN_URL.'/shop_admin/configform.php', 'scf_config'),
    ...
    array('400300', '펀딩관리', G5_ADMIN_URL.'/shop_admin/itemlist.php', 'scf_item'),
	array('400410', '미완료주문', G5_ADMIN_URL.'/shop_admin/inorderlist.php', 'scf_inorder', 1),
    array('400500', '펀딩옵션재고관리', G5_ADMIN_URL.'/shop_admin/optionstocklist.php', 'scf_item_option'),
