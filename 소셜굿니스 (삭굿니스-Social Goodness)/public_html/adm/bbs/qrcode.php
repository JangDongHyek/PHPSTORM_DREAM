...
class QR_BarCode{
    ...
    public $googleChartAPI = 'http://chart.apis.google.com/chart';
    // Code data
    public $codeData;
    ...
    public function made_qr($size){

        $googleChartAPI = 'http://chart.apis.google.com/chart?';
        $url = $googleChartAPI ."chs={$size}x{$size}&cht=qr&chl=" . urlencode($this->codeData);
