        ...
        socket.on('response', function(response) {
          console.log(JSON.stringify(response));
			 ...
			 socket.on('message',function(data){
				 ...
				 var strHtml=json.name+"님이 방금 주문하셨습니다.<br>주문 내역을 보러가시겠습니까?<br>";
				 strHtml+="<a href='<?=G5_ADM_SHOP_URL?>/orderform.php?od_id="+json.od_id+"'>내역보기</a>";
				 strHtml+="<a href='javascript:;' onclick='messageClose(this)'>닫기</a>";
				 $(".order-message").html(strHtml);
       ...
       <div id="logo"><a href="<?php echo G5_ADMIN_URL ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/logo.png" alt="<?php echo $config['cf_title'] ?> 관리자"></a></div>
        ...
        <div id="tnb">
            <ul>
				...
				<li class="tnb_li"><a href="https://admin.innopay.co.kr/mer/" target="_blank">상점관리자</a></li>
