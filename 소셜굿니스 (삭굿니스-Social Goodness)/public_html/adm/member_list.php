...
<div class="tbl_head01 tbl_wrap">
    ...
    <thead>
    <tr>
        <th width="10%" rowspan="2" id="mb_list_chk" scope="col" >
        ...
        <!--추천인-->
        <th width="10%" id="mb_list_mailc_2" scope="col">추천인이름</th>
        <th width="10%" id="mb_list_open" scope="col"><?php echo subject_sort_link('mb_open', '', 'desc') ?>정보공개</a></th>
        <th width="10%" id="mb_list_mailr" scope="col"><?php echo subject_sort_link('mb_mailling', '', 'desc') ?>메일수신</a></th>
        <th width="10%" id="mb_list_auth" scope="col">상태</th>
        <th width="10%" id="mb_list_mobile" scope="col">휴대폰</th>
        <th width="10%" id="mb_list_lastcall" scope="col"><?php echo subject_sort_link('mb_today_login', '', 'desc') ?>최종접속</a></th>
        <th width="10%" id="mb_list_grp" scope="col">접근그룹</th>
        <th width="10%" rowspan="2" id="mb_list_mng" scope="col">관리</th>
    </tr>
    <tr>
        <th width="10%" id="mb_list_name" scope="col"><?php echo subject_sort_link('mb_name') ?>이름</a></th>
        <th width="10%" id="mb_list_nick" scope="col"><?php echo subject_sort_link('mb_nick') ?>닉네임</a></th>
        <!--추천인-->
        <th width="10%" id="mb_list_open_2" scope="col">추천인이메일</th>
        <th width="10%" id="mb_list_adultc" scope="col"><?php echo subject_sort_link('mb_adult', '', 'desc') ?>성인인증</a></th>
        <th width="10%" id="mb_list_auth" scope="col"><?php echo subject_sort_link('mb_intercept_date', '', 'desc') ?>접근차단</a></th>
        <th width="10%" id="mb_list_deny" scope="col"><?php echo subject_sort_link('mb_level', '', 'desc') ?>권한</a></th>
        <th width="10%" id="mb_list_tel" scope="col">전화번호</th>
        <th width="10%" id="mb_list_join" scope="col"><?php echo subject_sort_link('mb_datetime', '', 'desc') ?>가입일</a></th>

        <th width="10%" id="mb_list_point" scope="col"><?php echo subject_sort_link('mb_point', '', 'desc') ?> 포인트</a></th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_id" colspan="2" class="td_name sv_use">
            ...
            ?>        </td>
        <!--추천인-->
        <td haders="mb_list_mailc_2"><?php echo $row['mb_1'] ?></td>

        <td headers="mb_list_open">
            <label for="mb_open_<?php echo $i; ?>" class="sound_only">정보공개</label>
            <input type="checkbox" name="mb_open[<?php echo $i; ?>]" <?php echo $row['mb_open']?'checked':''; ?> value="1" id="mb_open_<?php echo $i; ?>">        </td>
        <td headers="mb_list_mailr">
            <label for="mb_mailling_<?php echo $i; ?>" class="sound_only">메일수신</label>
            <input type="checkbox" name="mb_mailling[<?php echo $i; ?>]" <?php echo $row['mb_mailling']?'checked':''; ?> value="1" id="mb_mailling_<?php echo $i; ?>">        </td>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <!--추천인-->
        <td headers="mb_list_open_2"><?php echo $row['mb_3'] ?></td>

        <td headers="mb_list_adultc">
            <label for="mb_adult_<?php echo $i; ?>" class="sound_only">성인인증</label>
            <input type="checkbox" name="mb_adult[<?php echo $i; ?>]" <?php echo $row['mb_adult']?'checked':''; ?> value="1" id="mb_adult_<?php echo $i; ?>">        </td>
