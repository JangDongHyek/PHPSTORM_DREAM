...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td colspan="3"><input type="text" name="mb_name" value="<?php echo $mb['mb_name'] ?>" id="mb_name" required class="required frm_input" size="15"  maxlength="20"></td>
	...
	<? if($mb[mb_level]=="3"){?>
	 <tr>
        <th scope="row">상호명</th>
        <td>
            <input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1" maxlength="100" size="30" class="frm_input">
        </td>
        <th scope="row">사업자등록번호</th>
        <td>
            <input type="text" name="mb_2" value="<?php echo $mb['mb_2'] ?>" id="mb_2" maxlength="100" size="30" class="frm_input">
			<input type="hidden" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" maxlength="100" size="30" class="frm_input"><br/>
			<? /*if($mb[mb_3]){
				imageRotation(G5_DATA_PATH."/member/".$mb['mb_3']);
			?>
			<a href="javascript:;" onclick="window.open('<?=G5_DATA_URL?>/member/<?=$mb['mb_3']?>','','fullscreen')">
			<img src="<?=G5_DATA_URL?>/member/<?=$mb['mb_3']?>" width="300">
			</a>
			<? }*/?>
        </td>
    </tr>
