...
if($member['mb_id'] == "lets080"){
	$menu['menu300'] = array (
		...
		array('301100', '아이템업로드 리스트', G5_ADMIN_URL.'/itemupload_list.php', '', 1),
		array('301200', '광고신청 리스트', G5_ADMIN_URL.'/adupload_list.php', '', 1),
		array('300000', '설정', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=funding', 'board'),
		array('300100', '펀딩설정', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=funding', 'board'),
		array('300200', '영상설정', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=movie', 'board')


	);
} else {
	$menu['menu300'] = array (
		array('301100', '아이템업로드', G5_ADMIN_URL.'/itemupload_list.php', '', 1),
		array('301200', '광고신청 리스트', G5_ADMIN_URL.'/adupload_list.php', '', 1),
		array('300000', '설정', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=funding', 'board'),
		array('300100', '펀딩설정', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=funding', 'board'),
		array('300200', '영상설정', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=movie', 'board')
