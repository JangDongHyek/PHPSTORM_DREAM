...
<header id="hd">
    ...
    <?php if(defined('_INDEX_')) { // index에서만 실행
        ...
        <div id="hd_wrapper">       
        	<div class="container">                
                ...
                <div id="logo_color"><a href="<?php echo G5_SHOP_URL; ?>/"><img src="<?php echo G5_THEME_IMG_URL ?>/logo_color.png" alt="<?php echo $config['cf_title']; ?>" /></a></div>                
                <div id="top_menu">
                	<ul>
						<?php if ($is_member) { ?>
                        <?php if ($is_admin) {  ?>
                        <li><a href="<?php echo G5_ADMIN_URL ?>/shop_admin/" class="adm"><p>관리자</p></a></li>
                        <?php } else { ?>
                        <li><a href="<?php echo G5_BBS_URL; ?>/member_confirm.php?url=register_form.php"><p>정보수정</p></a></li>
                        <?php } ?>
                        <li><a href="<?php echo G5_BBS_URL; ?>/logout.php?url=shop"><p>로그아웃</p></a></li>
                        <?php } else { ?>
                        <li><a href="<?php echo G5_BBS_URL; ?>/login.php"><p>로그인</p></a></li>
                        <li><a href="<?php echo G5_BBS_URL ?>/register.php" id="snb_join"><p>회원가입</p></a>
							<!--<div class="sign">
								1000포인트 즉시지급
							</div>-->
						</li>
                        <?php } ?>
                        <?php /*?><li class="cart"><a href="<?php echo G5_SHOP_URL; ?>/cart.php"><img src="<?php echo G5_THEME_IMG_URL ?>/tnb_icon02.svg" /><p>장바구니</p></a></li><?php */?>
                        <li><a href="<?php echo G5_SHOP_URL; ?>/mypage.php"><p>마이페이지</p></a></li>
                    </ul>
                </div><!--#top_menu-->
    		</div>
        </div><!--#hd_wrapper-->
    ...
    <button type="button" id="hd_sch_open" class="hd_opener"><i class="fal fa-search"></i><span class="sound_only"> 열기</span></button>
        <div class="hd_div">
            <div id="sch_div"> 
        ...
        <button type="button" id="sch_close" class="hd_closer"><span class="sound_only">닫기 </span><i class="fal fa-times"></i></button>
        </div>
    ...
    <div id="sbanner">   
      ...
      <!--pc-->
        <div class="swiper-wrapper ">
          ...
          <img src="<?php echo G5_THEME_IMG_URL ?>/sbanner01.jpg" alt="" class="pc_swipe" />
          ...
          <img src="<?php echo G5_THEME_IMG_URL ?>/sbanner02.jpg" alt="" class="pc_swipe" />
          ...
          <img src="<?php echo G5_THEME_IMG_URL ?>/sbanner03.jpg" alt="" class="pc_swipe" />
