...
<div id="bo_list" style="width:<?php echo $width; ?>">
	...
	<tr>
		...
		<td>
			...
			<?php }?>
			<div class="txt_area"><a href="<?php echo $list[$i]['href']?>">
			<ul>
				<li class="zine_tit"><?php echo $list[$i]['wr_subject']?></li>
				<li class="zine_info">추천 <?php echo $list[$i]['wr_good']?> | 비추천 <?php echo $list[$i]['wr_nogood']?> | 등록일 <?php echo $list[$i]['wr_datetime']?></li>
