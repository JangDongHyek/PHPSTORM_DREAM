...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
        <input type="hidden" name="wr_name" value="관리자" id="wr_name" required class="frm_input required" size="10" maxlength="20">
				<? /*
        <?php if ($is_password) { ?>
        <tr>
        ...
        <tr>
            ...
            <td>
                <strong>
                <input type="radio" id="mb_2_1" name="wr_2" value="t" <? if($write['wr_2']=='t'){?>checked<?}?>>
                <label for="mb_2_1">노출</label>
                &nbsp;
                <input type="radio" id="mb_2_2" name="wr_2" value="f" <? if($write['wr_2']=='f'){?>checked<?}?>>
                <label for="mb_2_2">미노출</label>
                    </strong></td>
        ...
        <tr>
            <th scope="row"><label for="wr_1">보여줄 상품의 펀딩코드<strong class="sound_only">필수</strong></label></th>
            <td>
              <div id="autosave_wrapper">
                    <input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input required"><br>
                    * <strong>펀딩코드를 ,(콤마)로 구분</strong>해주세요 (ex : 1714707451,1714705522)                </div>
            </td>
        </tr>

        <?php for ($i=0; $is_file && $i<$file_count; $i++) { ?>
        <tr>
            <th scope="row">동영상 #<?php echo $i+1 ?></th>
            <td>
