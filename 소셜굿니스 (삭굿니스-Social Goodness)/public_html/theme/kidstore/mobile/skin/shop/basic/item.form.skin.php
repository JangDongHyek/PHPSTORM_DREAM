...
.bx-wrapper .bxslider li{ height:350px !important;}
...
#sit_pvi img{width:100% !important;}
}
...
<div id="sit_ov_wrap">
    ...
    <section id="sit_ov" class="col-lg-6 col-md-6 col-xs-12">
        <h2>상품간략정보 및 구매기능</h2>
        ...
        <div class="sit_ov_tbl col-lg-12 col-md-12">
			...
			<?php
				if($it[it_5]!=""||$it[it_6]!=""){?>
			<tr>
				<th scope="row">SNS 상품흥보</th>
				<td>
					<!--
					<?php
						if($it[it_5]){?>
						<img src="<?php echo G5_THEME_URL?>/img/icon_facebook.gif" border="0" onclick="goShare('facebook','<?=$it[it_name]?>')">
					<?php }
						if($it[it_6]){?>
						<img src="<?php echo G5_THEME_URL?>/img/icon_twitter.gif" border="0" onclick="goShare('twitter','<?=$it[it_name]?>')">
					<?php }?>
					-->
                    <div class="share_btn">
						<button type="button" name="shareButton" data-platform="facebook"><img src="<?php echo G5_THEME_URL?>/img/sns_face.svg"></button>
						<button type="button" name="shareButton" data-platform="twitter"><img src="<?php echo G5_THEME_URL?>/img/sns_twitter.svg"></button>
						<button type="button" name="shareButton" data-platform="kakao"><img src="<?php echo G5_THEME_URL?>/img/sns_kakao.svg"></button>
						<button type="button" name="shareButton" data-platform="basic"><i class="fas fa-share-alt"></i></button>
                    </div>
				</td>
			</tr>
			<script type="text/javascript">
				...
				$('button[name=shareButton]').on('click', function() {
					const platform = $(this).data('platform'); // 버튼의 data-platform 속성에서 플랫폼을 읽음
					shareContent(platform, {
					  url: "<?=G5_SHOP_URL?>/item.php?it_id=<?=$it_id?>",
					  title: "<?=$it['it_name']?>",
					  //text: "<?=$it['it_basic']?>",
					  text: "<?=$it['it_name']?>",
					  imageUrl: "",
				...
				function shareContent(platform, { url, title, text, imageUrl }) {
				  switch (platform) {
					case 'facebook':
					  window.open(
					...
					case 'twitter':
					  ...
					  break;
					case 'kakao':
					  Kakao.init('dbd9d17fe701f8a391df0d070454e3a5');
            ...
            */
            ...
            if($it['it_sc_type'] == 1)
                ...
                if($it['it_sc_method'] == 1)
                    $sc_method = '수령후 지불 <p class="red">5만원 이상 주문 시 무료배송</p>';
                    ...
                    $sc_method = '<select name="ct_send_cost" id="ct_send_cost">
								  ...
								  <p class="red">5만원 이상 주문 시 무료배송</p>
								  ';
                }
                else
                    $sc_method = '주문시 결제 <p class="red">5만원 이상 주문 시 무료배송</p>';
            }
            ?>
         <!--   <tr>
        ...
        <div id="bt_btn">
                ...
                <div id="sit_ov_btn">
                    ...
                    <input type="submit" onclick="document.pressed=this.value;" value="참여하기" id="sit_btn_buy">
                    <?php } ?>
				...
				<div id="sit_sns" style="margin-top:10px; display:none;">
...
<div role="tabpanel" id="sit_tab">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="#info" aria-controls="info" role="tab" data-toggle="tab"><span class="hidden-xs">참여</span>정보</a></li>
        <li role="presentation"><a href="#review" aria-controls="review" role="tab" data-toggle="tab"><span class="hidden-xs">참여응원글</span><span class="item_use_count"><?php echo $item_use_count; ?></span></a></li>
        <li role="presentation"><a href="#qa" aria-controls="qa" role="tab" data-toggle="tab">참여문의<span class="item_qa_count"><?php echo $item_qa_count; ?></span></a></li>
