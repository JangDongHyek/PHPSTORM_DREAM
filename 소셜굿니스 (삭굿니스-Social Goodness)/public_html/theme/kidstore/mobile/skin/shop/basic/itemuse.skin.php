...
<div id="sit_use_list">
    ...
    if (!$i) echo '<p class="sit_empty">참여응원글이 없습니다.</p>';
    ?>
</div>
...
<div id="sit_use_wbtn">
    ...
    <a href="<?php echo $itemuse_form; ?>" class="qa_wr itemuse_form " onclick="return false;">참여응원글 쓰기<span class="sound_only"> 새 창</span></a>
</div>
