...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/common.css?v=<?php echo date('Y h:i:s A'); ?>">
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/all.min.css"><!--폰트어썸-->
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/mobile_shop.css?v=<?php echo date('Y h:i:s A'); ?>">
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/sub.css?v=<?php echo date('Y h:i:s A'); ?>">
<?php /*?><?php
