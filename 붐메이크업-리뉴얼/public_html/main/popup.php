...
if(!mysql_num_rows($rs))
{
	...
	if($file1)
		$background = " background='../bbs/editor/upload/". $file1 ."' ";

	$memo = $col[memo];

	$memo = str_replace("../editor","../bbs/editor",$memo);
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" align="center" width="100%" height="100%">
                      <tr> 
                        <td align="center" valign="top" style="padding:2"> 
                          <table <?=$background?> <?=$width?> <?=$height?> border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                        ...
                        <td height="30" bgcolor="ECECEC"> 
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr> 
                              <td align="right"> 
                                <?if ($cookie==1) {?>
                                <input type=CHECKBOX name="closepop" value="" onClick="controlCookie(this)" style="border:0">오늘은 그만열기&nbsp;<?}?>
