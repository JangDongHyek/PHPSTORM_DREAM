...
<!--
	...
	function sendForm() {
		...
		sendVal=sendVal+"<input type='hidden' name='search' value='<?= $search ?>'>";
		sendVal=sendVal+"<input type='hidden' name='keyword' value='<?= $keyword ?>'>";
		...
		*/
		...
		sendVal=sendVal+"<input type='hidden' name='status' value='<?=$row[STATUS]?>'>";
		sendVal=sendVal+"<input type='hidden' name='sortno' value='<?=$row[SORTNO]?>'>";
		sendVal=sendVal+"<input type='hidden' name='ref' value='<?=$row[REF]?>'>";
              ...
              <tr>
                ...
                <td><TABLE class=board cellSpacing=0 cellPadding=0 width="95%" border=0 align="center">
                  ...
                  <TR class=bg_board02>
                    ...
                    <TD class=padd01>&nbsp;
                        <INPUT class="b_input" style="WIDTH: 150px" maxLength="20" name="writer" value="<?= $writer ?>">					</TD>
                    <TD class=padd width="69"><p align="center">비밀번호</TD>
                    <TD width="1"><IMG src="img/bullet02.gif"></TD>
                    <TD class=padd01>&nbsp;
...
?>
              ...
              <tr>
                ...
                <td><TABLE cellSpacing=0 cellPadding=0 width="95%" bgColor=#ffffff border=0 align="center">
                  <TR>
                    <TD align=middle bgColor=#FFFFFF height="30"><div align="center">제목</div></TD>
                  ...
                  <TR>
                    ...
                    <TEXTAREA class="b_textarea" name="content" rows=10 cols="72" style="width:99%"><?= $content ?>
                  </TEXTAREA></TD>
                  </TR>
                </TABLE></td>
              </tr>
