              ...
              <table width="197" border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top" bgcolor="#000000"><div align="center">
                      <? $num = "2"; include "../inc/mem_menu2.php"; ?>
                  </div></td>
                </tr>
              </table>
            </div></td>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="203"><table width="100" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="../images/mem_t5.gif" width="203" height="21"></td>
                    </tr>
                    <tr>
          ...
          <tr>
            <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><div align="center"><img src="../images/login/leave.gif" width="468" height="91"></div></td>
              </tr>
              <tr>
                            ...
                            <tr>
                              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td><input name="mb_id" type="text" class="input_01" style="width:200px;height:20px;padding-left:3px"></td>
                                  </tr>
                              </table></td>
                            </tr>
                            <tr>
