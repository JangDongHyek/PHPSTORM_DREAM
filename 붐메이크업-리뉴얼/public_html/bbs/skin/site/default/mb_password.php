              ...
              <table width="197" border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top" bgcolor="#000000"><div align="center">
                      <? $num = "3"; include "../inc/mem_menu.php"; ?>
                  </div></td>
                </tr>
              </table>
            </div></td>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="203"><table width="100" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="../images/mem_t4.gif" width="203" height="21"></td>
                    </tr>
                    <tr>
          ...
          <tr>
            <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="45" valign="top"><div align="center"><img src="../images/login/find1.gif" width="545" height="29"></div></td>
              </tr>
              <tr>
                <td><table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
                    <form name=mblogin method=post action='' onSubmit="return checkval();">
                      ...
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="75"><img src="../images/login/name.gif" width="65" height="12"></td>
                                    <td><input name="mb_name" type="text" class="input_01" id="mb_name" style="width:200px;height:20px;padding-left:3px"></td>
                                  </tr>
                              </table></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="75"><img src="../images/login/email.gif" width="65" height="12"></td>
                                    <td><input name="mb_email" type="password" class="input_01" id="mb_email" style="width:200px;height:20px;padding-left:3px"></td>
                                  </tr>
                              </table></td>
                            </tr>
                        </table></td>
                        <td width="116"><input name="image" type="image" style="border:0px;"  src="../images/login/leave_btn.gif"></td>
                      </tr>
                    </form>
                </table></td>
              </tr>
              ...
              <tr>
                <td height="45" valign="top"><div align="center"><img src="../images/login/find2.gif" width="545" height="29"></div></td>
              </tr>
              <tr>
                <td><table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
                    <form name=mblogin2 method=post action='' onSubmit="return checkval2();">
                      ...
                      <tr>
                            ...
                            <tr>
                              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td><input name="mb_id" type="text" class="input_01" id="mb_id" style="width:200px;height:20px;padding-left:3px"></td>
                                  </tr>
                              </table></td>
                            </tr>
                            <tr>
                        ...
                        <td width="116"><input name="image2" type="image" style="border:0px;"  src="../images/login/leave_btn.gif"></td>
                      </tr>
                    </form>
                </table></td>
              </tr>
