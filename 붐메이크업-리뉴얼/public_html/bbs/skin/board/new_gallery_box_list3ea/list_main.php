    ...
    <td height="100" background="<?=$skin_board_url?>/img/gallery_list_view02.gif"><div align="center"> <?=$a_list_view?>
          <table border="0" cellspacing="1" cellpadding="1" bgcolor="#e6e6e6">
            <tr>
              <td bgcolor="#FFFFFF"> 
                <?=$a_list_view?>
                <img src="<?=$rg_thum1_url?>" border="0" width="<?=$rg_thum1_width?>" height="<?=$rg_thum1_height?>" onerror="this.src='<?=$skin_board_url?>blank_.gif'" ('<?=$rg_file1_url?>','<?=$rg_title?>') style="cursor:hand;" vspace="2" hspace="2"></td>
            </tr>
        </table></div></td>
  </tr>
  <tr>
...
?></td>
  ...
  <tr>
    <td> <?=$a_list_view?><img src="<?=$skin_board_url?>/img/gallery_list_view05.gif"></a></td>
  </tr>
</table>
	</td>
<? /*
