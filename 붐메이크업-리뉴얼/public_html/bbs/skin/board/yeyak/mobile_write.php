...
<input type="hidden" name="rg_title" value=".">
		...
		<div class="bbs_write">
		   <span bgColor=#fafafa class="bbs_write_title">* 이름&nbsp;&nbsp;</span>
...
<?
	...
	<div class="bbs_write">
		...
		<span class="bbs_write_form">  <input type="text" name="rg_ext3_1" value="<?=$rg_ext3_ex[0]?>" size="4" required itemname="연락처" >
						 -
						 <input type="text" name="rg_ext3_2" value="<?=$rg_ext3_ex[1]?>" size="4" required itemname="연락처" >
						 -
						 <input type="text" name="rg_ext3_3" value="<?=$rg_ext3_ex[2]?>" size="4" required itemname="연락처" ></span>
	</div>
<?=$show_ext3_end?>
<?=$show_ext4_begin?>
	<div class="bbs_write">
