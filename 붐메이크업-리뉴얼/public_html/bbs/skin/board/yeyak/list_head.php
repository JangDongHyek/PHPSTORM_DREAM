		...
		<td height="26" valign="top" align="center">
			<table cellpadding="0" cellspacing="0" border="0" width=100%>
				<tr>
				    ...
				    <?=$show_category_end?>
					<td align="right" style="font-weight:bold; font-size:15px;color:#242C52">
	...
	<tr>
		<td valign="top">
				  <table cellpadding="0" cellspacing="1" border="0" bgcolor=<?=$table_line?> width=100%>
				    <tr bgcolor="#FFFFFF">
					  <td height="20" width="14%"  bgcolor=<?=$table_color?> align="center">
					  ...
					  <td width="14%" bgcolor=<?=$table_color?> align="center">
