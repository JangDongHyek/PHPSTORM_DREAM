...
<div class="bbs_cal_list" >
	<ul>
		<li ><a href="mobile_write.php?bbs_id=<?=$bbs_id?>&book=<?=$book?>&year=<?=$year?>&month=<?=$month?>"><?=$day?>일</a> <a href="mobile_write.php?bbs_id=<?=$bbs_id?>&book=<?=$book?>&year=<?=$year?>&month=<?=$month?>"><img src="<?=$skin_board_url?>images/write.gif" align="absmiddle"></a></li>
		<li>
		<span >
		<?
