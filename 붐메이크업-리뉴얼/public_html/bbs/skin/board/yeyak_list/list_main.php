...
?>
	<TR height=26> 
		...
		<TD align=middle class="bbs"><?=$a_list_view?>
            <?if($rg_ext11=="접수") {
                echo"<font color=black><b>접수</b></font>";
            }if($rg_ext11=="완료") {
                echo"<font color=blue><b>완료</b></font>";
            }
            if($rg_ext11=="네이버") {
                echo"<font color=#2DB400><b>네이버</b></font>";
            }
            ?>
        </TD>
		...
		<TD align=middle class="bbs"><?=$a_list_view?><?=$rg_ext7?></TD>
