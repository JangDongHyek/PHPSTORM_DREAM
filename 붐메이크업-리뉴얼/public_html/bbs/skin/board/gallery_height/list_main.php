		  ...
		  <tr>
			<td align="center" valign="bottom"> 
			  <table border="0" cellspacing="1" cellpadding="0" bgcolor="#e6e6e6">
				<tr>
				  <td bgcolor="#FFFFFF"> 
					<img src="<?=$rg_file1_url?>" border="0" width="<?=$thum_width?>" height="<?=$thum_height?>" onerror="this.src='<?=$skin_board_url?>blank_.gif'" onmouseover="change_image('<?=$rg_file1_url?>','<?=$rg_file1_info[0]?>', '<?=$rg_title?>')" style="cursor:hand;" height="94" vspace="4" hspace="4"></td>
				</tr>
			  </table>
			</td>
		  </tr>
