...
<TR> 
    ...
    <TR> 
		...
		<TR>
				...
				<TD width=130 align=right><INPUT type=image onfocus=this.blur() src="<?=$skin_board_url?>images/submit.gif"> <a href="javascript:history.back()" onfocus=this.blur()><IMG src="<?=$skin_board_url?>images/cancel.gif" border=0></a></TD>
			</TR>
			</TABLE>
			    </TD>
		</TR>
