...
<?=$show_upload_end?>
			...
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
						...
						<font color=red size=3><b><?=$span_num?></b></font>
						<input type=hidden name="rg_spam1" id="rg_spam1" value="<?=$span_num?>">
						<input name='rg_spam2' id="rg_spam2" type=text style=width:10%;height:22; class=b_input id="rg_spam2" required itemname='스팸방지 번호'> ※앞의 붉은색 숫자를 빈칸에 입력해주세요.</TD>
					</TR>
				</TABLE>
			</TD>
		</TR>	
		<?
			...
			echo "<input type=hidden name=\"rg_spam1\" id=\"rg_spam1\" value=''>";
		}
		?>
<?=$show_ext1_begin?>
		<TR> 
