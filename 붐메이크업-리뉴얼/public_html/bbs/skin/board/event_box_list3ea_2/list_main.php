...
?>
    ...
    <table width="180" border="0" cellspacing="0" cellpadding="0" height="300">
  <tr>
    <td height="14"><img src="<?=$skin_board_url?>/img/gallery_list_view01.gif" width="230" height="14"></td>
  </tr>
  <tr>
    <td background="<?=$skin_board_url?>/img/gallery_list_view02.gif"><div align="center"> <?=$a_list_view?>
          <table border="0" cellspacing="1" cellpadding="1" bgcolor="#e6e6e6">
            <tr>
              <td bgcolor="#FFFFFF"> 
                <?=$a_list_view?>
                <img src="<?=$rg_thum1_url?>" border="0" width="<?=$rg_thum1_width?>" height="<?=$rg_thum1_height?>" onerror="this.src='<?=$skin_board_url?>blank_.gif'" style="cursor:hand;" vspace="2" hspace="2"></td>
            </tr>
        </table></div></td>
  </tr>
  <tr>
    <td height="30" background="<?=$skin_board_url?>/img/gallery_list_view04.gif"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" style="table-layout:fixed;"><?=$show_chk_begin?>
...
?></td>
  ...
  <tr>
    <td height="37"> <?=$a_list_view?><img src="<?=$skin_board_url?>/img/gallery_list_view05.gif"></a></td>
  </tr>
</table>
	</td>
<? /*
