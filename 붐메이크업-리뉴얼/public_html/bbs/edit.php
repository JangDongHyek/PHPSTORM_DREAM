...
//			$rg_home_url = $data[mb_homepage]; // 2003-10-15 항상홈페이지입력가능
		...
		if($bbs_id == "yeyak"){
			...
			$admin_orderby_query=",complete='$complete'";
		}else{
			$rg_ext5_query=", `rg_ext5` = '$rg_ext5'";
		}

		if($bbs_id == "yeyak_list"){
			
			if($rg_ext1 != $old_rg_ext1){
				$rg_ext1_ex = explode("/",$rg_ext1);
				$rg_ext1 = $rg_ext1_ex[2]."-". $rg_ext1_ex[0]."-". $rg_ext1_ex[1];
			}
			if($rg_ext2 != $old_rg_ext2){
				$rg_ext2_ex = explode("/",$rg_ext2);
				$rg_ext2 = $rg_ext2_ex[2]."-". $rg_ext2_ex[0]."-". $rg_ext2_ex[1];
			}
		$yeyak_list_query1=", `rg_ext6` = '$rg_ext6', `rg_ext7` = '$rg_ext7', `rg_ext8` = '$rg_ext8', `rg_ext9` = '$rg_ext9', `rg_ext10` = '$rg_ext10', `rg_ext11` = '$rg_ext11', `rg_ext12` = '$rg_ext12', `rg_ext13` = '$rg_ext13'";
		}
		...
		$dbqry="
			UPDATE `$bbs_table` SET
				...
				`rg_ext2` = '$rg_ext2',
				`rg_ext3` = '$rg_ext3',
				`rg_ext4` = '$rg_ext4' $rg_ext5_query $yeyak_list_query1 $admin_orderby_query";
