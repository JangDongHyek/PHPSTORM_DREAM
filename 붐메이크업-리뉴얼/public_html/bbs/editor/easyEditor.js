...
var easyConfig = {
	...
	//----------------------------------------------------
	filepath : "./editor",	
	imgpath : "./editor/img/easy",		//¹öÆ° ÀÌ¹ÌÁö°æ·Î
	...
	BtnTemplate  : {
		all : ["save","preview","bar","all","undo","redo","bar",
				...
				"unlink","bar","table","upload_image","bar","source"],
...
{	
	...
	this._text.style.lineHeight = "15%";
	//iframe
...
var easyUtil = {	
	...
	{	
		...
		d.style.font = "9pt µ¸¿ò";	d.style.lineHeight ="40%";	
	...
	tblSet_font : function()
	{
		...
		for(var i=0; i<font.length; i++)
		{
			...
			s += "<a href='javascript:;' onclick=\"easyUtil._editor.cmd(null, easyUtil.order,'"+font[i]+"');\" style='font:10pt "+font[i]+";line-height:40%'>"+txt+" ("+font[i]+")</a><br />";
		}
...
function (self){
 ...
 window.open(easyConfig.filepath+"/upload_image.php?op_id="+self._iframe.id,"image","width=300,height=390,status=1");
}];
