...
// *-- LIB_INC_INCLUDED START --*
	...
	require_once("{$site_path}include/mobile.config.inc.php");
	...
	$skin_site_url = "../bbs/skin/".$skin_site_dir.$skin_site_id.'/';
	$skin_site_path = $skin_path.$skin_site_dir.$skin_site_id.'/';
...
//		$a_member_memo="<a href={$site_url}mb_memo.php $class[link_header]>";
		...
		$a_login="<a href=mobile_mb_login.php?url=".urlencode($HTTP_SERVER_VARS['REQUEST_URI'])." $class[link_header]>";
