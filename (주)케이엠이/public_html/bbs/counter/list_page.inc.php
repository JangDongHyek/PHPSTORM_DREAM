<?
	...
	$data=array();
	$dbqry="
		SELECT rg_counter_log.*,rg_counter_page.page_url,rg_counter_ip.ip_ip
		FROM `rg_counter_log` 
...
?>
  <tr> 
    ...
    <td> 
      &nbsp;<a href="javascript:ref_open('<?=urlencode($r['page_url'])?>')" title="<?=$r['page_url']?>"><?=rg_cut_string($r['page_url'], 100, "..")?></a></td>
