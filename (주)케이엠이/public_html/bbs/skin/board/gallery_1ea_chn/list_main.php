	...
	<tr>
		...
		<tr>
          ...
          <input type=checkbox name=chk_rg_num[] value='<?=$rg_doc_num?>'>
				<?=$show_chk_end?>
				<span style="font-size:14pt; color:#0093D5; line-height:55px"><?=$rg_title?></span><BR><?=nl2br($rg_ext1)?></td>
		</tr>
		<tr>
			<td align="right" valign="bottom"><a href="./view.php?bbs_id=<?=$bbs_id?>&page=<?=$page?>&doc_num=<?=$rg_doc_num?>"><img src="../images_eng/sub/detail.gif" align="absmiddle" border=0 /></a></td>
		</tr>
		<tr>
			<td height="10" colspan="2"></td>
		</tr>
