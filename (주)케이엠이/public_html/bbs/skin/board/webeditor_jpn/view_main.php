...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 style="table-layout:fixed">
  <TR bgcolor=#FFFFFF height=21> 
    <TD width=12% bgcolor=#ffffff height="25"> 
      <div align="right">Subject&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=#ffffff height="21"> 
      <div align="right">Writer&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
