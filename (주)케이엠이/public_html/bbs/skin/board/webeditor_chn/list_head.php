...
<form name=fcategory>
	<td width=50%> 
    <?=$show_category_begin?>
    <IMG src="<?=$skin_board_url?>images/category.gif" border=0> <select name=ca_id onChange="location='<?=$u_category?>'+this.value;" class=select><option value=''>All</option><?=$category_list_option?></select>
    <?=$show_category_end?>
    </td>
</form>
	<td width=50% align="right" class="bbs_total"><?=$page?>/<?=$total_page?>, Total : <?=$total_doc_count?></td>
</tr>
</table>
...
<TR> 
	...
	<TR height=38>
		...
		<TD width=80 align=middle class="bbs" background="<?=$skin_board_url?>images/head_bg.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center"><font color="#000000">Date</td>
              <td width="1" align="right"><img src="<?=$skin_board_url?>images/bar03.gif" /></td>
            </tr>
          </table></TD>
		...
		<TD width=50 align=middle class="bbs" background="<?=$skin_board_url?>images/head_bg.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><font color="#000000">Download</td>
            <td width="1" align="right"><img src="<?=$skin_board_url?>images/bar03.gif" /></td>
          </tr>
        </table>
		  <?=$show_download_end?>
		...
		<TD width=50 align=middle class="bbs" background="<?=$skin_board_url?>images/head_bg.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              <td align="center"><font color="#000000">HIT</td>
		...
		<?=$show_vote_yes_begin?>
		<TD width=40 align=middle class="bbs">Recommendation</TD>
		<?=$show_vote_yes_end?>
		
		<?=$show_vote_no_begin?>
		<TD width=40 align=middle class="bbs">Dislike</TD>
		<?=$show_vote_no_end?>
