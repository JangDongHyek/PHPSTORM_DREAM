...
<?=$show_mb_logout_end?>
	<tr>
		...
		<table width=100%>
		<tr> 
			<td width=50 align=center class=bbs onclick="document.form_comment.cmt_comment.rows=document.form_comment.cmt_comment.rows+2" style=cursor:hand>Content ▼
			<td><textarea rows=5 name=cmt_comment class=b_textarea style='width:100%' required itemname='코멘트내용'></textarea></td>
			<td width="80" height="100%"><input type=submit value='  Write  ' style='background-color:#FFFFFF;color:#555555;border:1 solid;height:100%;width:100%;cursor:hand;' class=input_text></td>
		</tr> 
		</table>
		</td>
	</tr>
