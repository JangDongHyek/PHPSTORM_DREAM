...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 style="table-layout:fixed">
  <TR bgcolor=#FFFFFF height=21> 
    <TD width=12% bgcolor=F7F7F7 height="30"> 
      <div align="right"><b style="color:#848484;">제품명</b>&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=F7F7F7 height="30"> 
      <div align="right"><b style="color:#848484;">작성자</b>&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
