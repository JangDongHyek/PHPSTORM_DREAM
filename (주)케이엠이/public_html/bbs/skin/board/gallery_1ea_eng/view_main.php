...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 style="table-layout:fixed">
  <TR bgcolor=#FFFFFF height=21> 
    <TD width=12% bgcolor=F7F7F7 height="30"> 
      <div align="right"><b style="color:#848484;">Product</b>&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=F7F7F7 height="30"> 
      <div align="right"><b style="color:#848484;">Writer</b>&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
    <TD colspan="3" style='padding-left:10;' height=30><span onClick="rg_layer('<?=$site_url?>', '<?=$bbs_id?>','<?=$mb_id?>', '<?=$rg_name?>', '<?=$rg_email_enc?>', '<?=$rg_home_url?>', '<?=$mb_open_info?>')" style='cursor:hand;'> 
      </span> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=#ffffff height=21> 
      <div align="right">Homepage&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=#ffffff height=21> 
      <div align="right">Download #1&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
    <TD colspan=3 style='padding-left:10;' height=21> 
      <?=$a_file1?>
      <?=$rg_file1_name?>
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=#ffffff height=21> 
      <div align="right">Download #2 &nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
    <TD colspan=3 style='padding-left:10;' height=21> 
      <?=$a_file2?>
      <?=$rg_file2_name?>
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=#ffffff height=21> 
      <div align="right">Link #1&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
    <TD colspan=3 style='padding-left:10;' height=21> 
      <?=$a_link1?>
      <?=$rg_link1_url?></a>
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=#ffffff height=21> 
      <div align="right">Link #2&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
    <TD colspan=3 style='padding-left:10;' height=21> 
      <?=$a_link2?>
      <?=$rg_link2_url?></a>
