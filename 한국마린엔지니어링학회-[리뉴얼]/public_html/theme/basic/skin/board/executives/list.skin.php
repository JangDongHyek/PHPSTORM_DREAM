    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_chk">
                ...
                <input type="checkbox" name="chk_wr_id[]" value="<?php echo $row['wr_id'] ?>" id="chk_wr_id_<?php echo $i ?>">            </td>
            <?php } ?>
            <td class="td_subject">
              

                <a href="<?php echo $list[$i]['href'] ?>">
                    <?php echo $list[$i]['subject'] ?>                </a>            </td>
            <td><a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['wr_1'] ?>년 ~ <?php echo $list[$i]['wr_2']?>년</a></td>
            <td><div align="left"><a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['wr_3'] ?></a></div></td>
            <td><div align="left"><a href="<?php echo $list[$i]['href'] ?>"><?php echo nl2br($list[$i]['wr_content']) ?></a></div></td>
        </tr>
        <?php } ?>
