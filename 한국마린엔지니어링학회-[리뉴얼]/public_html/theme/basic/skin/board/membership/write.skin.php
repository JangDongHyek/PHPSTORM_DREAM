...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php if ($is_category) { ?>
        <tr>
            <th scope="row"><label for="ca_name">직위<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="wr_content">근무처/직위<strong class="sound_only">필수</strong></label></th>
            <td>
                <div id="autosave_wrapper">
        ...
        <?php } ?>
		<!-- <tr>
		            <th scope="row"><label for="wr_10">우선순위</label></th>
		            <td><input type="text" name="wr_10" value="<?php echo $write[wr_10]==""?"0":$write[wr_10] ?>" id="wr_2" class="frm_input" ></td>
		        </tr> -->
        </tbody>
        </table>
    </div>
