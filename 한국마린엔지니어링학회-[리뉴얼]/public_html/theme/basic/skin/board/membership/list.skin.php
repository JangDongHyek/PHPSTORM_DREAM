...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col">직위</th>
            <th scope="col" colspan="2">근무처/사내 직위</th>
        </tr>
        </thead>
        <tbody>
		<?php
			$caName=explode("|",$board[bo_category_list]);
			for($a=0;$a<count($caName);$a++){
				$sql="select * from g5_write_".$bo_table." where ca_name='$caName[$a]' order by (wr_10+0) desc,wr_id asc";
            ...
            <?php } ?>
				...
				<?php if($i==0){?>
				<td rowspan="<?=$rowCount?>" valign="top"><?=$row[ca_name]?></td>
				<?php }?>
				<td onclick="location.href='<?=G5_BBS_URL?>/board.php?bo_table=<?=$bo_table?>&wr_id=<?=$row[wr_id]?>';" style="cursor:pointer">
                    <div class="info cf">
                        <div class="mg">
                            <?php
                            ...
                            if($thumb['src']) {
                                ...
                                $img_content = '<span style="width:'.$board['bo_gallery_width'].'px;line-height:'.$board['bo_gallery_height'].'px" class="noimg">준비중</span>';
                            }
                        ...
                        <div class="mg_right">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="in_tb">
                                    <colgroup>
                                       <col style="width:25%" />
                                       <col style="width:25%" />
                                       <col style="width:25%" />
