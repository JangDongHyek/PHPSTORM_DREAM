...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_link<?php echo $i ?>">유투브<br />링크주소</label></th>
            <td>
				<input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="frm_input" size="50" placeholder="해당 영상의 주소창에 있는 유투브 URL를 입력해주세요.">
