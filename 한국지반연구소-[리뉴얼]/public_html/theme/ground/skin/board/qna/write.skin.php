...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
       ...
       <?php /*?> <?php if ($is_email) { ?>
        ...
        <!-- 회사명 필드 -->
        <tr>
            <th scope="row"><label for="wr_9">회사명<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_9" value="<?php echo isset($write['wr_9']) ? $write['wr_9'] : ''; ?>" id="wr_9" required class="frm_input" size="10"></td>
        </tr>

        <!-- 회사부서 필드 -->
        <tr>
            <th scope="row"><label for="wr_10">회사부서<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_10" value="<?php echo isset($write['wr_10']) ? $write['wr_10'] : ''; ?>" id="wr_9" required class="frm_input" size="10"></td>
        </tr>

        <!-- 작성자 필드 -->
        <!--<tr>
            <th scope="row"><label for="wr_11">작성자<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_11" value="<?php /*echo isset($write['wr_11']) ? $write['wr_11'] : ''; */?>" id="wr_9" required class="frm_input" size="11"></td>
        </tr>-->

        <!-- 이메일 필드 -->
        <tr>
            <th scope="row"><label for="wr_8">E-mail<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_8" value="<?php echo $write['wr_8'] ?>" id="wr_8" required class="frm_input" size="10"></td>
        </tr>

        <!-- 연락처 필드 -->
        <tr>
            <th scope="row"><label for="wr_7">연락처<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_7" value="<?php echo isset($write['wr_7']) ? $write['wr_7'] : ''; ?>" id="wr_7" required class="frm_input" size="10"></td>
        </tr>
