...
?>
	...
	<div class="sear_box">
   <span class="sear_t">불사검색</span>
   <input type="text" name="wr_subject_search" value="<?php echo stripslashes($wr_subject_search) ?>" id="wr_subject_search" class="frm_input sch_input" maxlength="20">
<BR>
   <span class="sear_t">불자검색</span>
   <input type="text" name="wr_2_search" value="<?php echo stripslashes($wr_2_search) ?>" placeholder="불자명" id="wr_2_search" class="frm_input sch_input" maxlength="20"> 
   <input type="text" name="wr_4_search" value="<?php echo stripslashes($wr_4_search) ?>"  placeholder="핸드폰번호" id="wr_4_search" class="frm_input sch_input" maxlength="20">
