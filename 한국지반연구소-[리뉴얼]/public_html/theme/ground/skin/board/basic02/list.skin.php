...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="hidden-xs">
            ...
            <?php } ?>
            <th scope="col">분야</th>
            <th scope="col">세부분야</th>
            <th scope="col">과업명</th>
            <th scope="col">발주처</th>
            <th scope="col">과업기간</th>
        </tr>
        </thead>
        <tbody>
        <?php
...
<!--           세부분야-->    
            <td class="hidden-xs"><?php echo $list[$i]['wr_3']?></td>    

<!--           과업명-->
            <td class="td_subject mwidth" style="text-align:left;">
                ...
                <p class="visible-xs">발주처 : <?php echo $list[$i]['wr_1']?></p>
                <p class="visible-xs">과업기간 : <?php echo $list[$i]['wr_2']?></p>
                <?php
...
<!--                    발주처         -->
           <td class="hidden-xs"><?php echo $list[$i]['wr_1']?></td>
           
            
<!--            과업기간-->
            <td class="hidden-xs"><?php echo $list[$i]['wr_2']?></td>
        </tr>
        <?php } ?>
