...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
        	<th scope="row"><label for="ca_name">세부분야<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_3"id="wr_3" value="<?php echo $write[wr_3]?>" class="frm_input" ></td>
        </tr>
        
        <tr>
        	<th scope="row"><label for="ca_name">발주처<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_1"id="wr_1" value="<?php echo $write[wr_1]?>" class="frm_input" ></td>
        </tr>
        
        <tr>
        	<th scope="row"><label for="ca_name">과업기간<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_2"  id="wr_2" value="<?php echo $write[wr_2]?>" class="frm_input" ></td>
        </tr>
        
        <tr>
            <th scope="row"><label for="wr_subject">과업명<strong class="sound_only">필수</strong></label></th>
            <td>
