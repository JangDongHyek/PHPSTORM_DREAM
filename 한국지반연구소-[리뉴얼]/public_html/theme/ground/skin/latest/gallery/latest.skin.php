...
#oneshot_2_7 .img_set{width:<?php echo $imgwidth ?>px; height:<?php echo $imgheight ?>px; background-color:#f8f8f8;padding:0;}
#oneshot_2_7 .img_left{opacity:1; transition:all 0.3s;}
#oneshot_2_7 .img_left:hover{opacity:0.8;}
...
#oneshot_2_7 li { width:25%; height:90px;}
#oneshot_2_7 .img_set{width:100%; height:100%;}
#oneshot_2_7 .img_left{ width:100%;}
...
<div id="border">
			...
			<!--<div class="subject_set">
				<div class="sub_title">			
				<a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=case"><?php echo cut_str($list[$i]['subject'], 36, "..") ?></a></div>
