...
<div id="bo_list" style="width:<?php echo $width; ?>">
		...
		<legend>게시물 검색</legend>
			...
			<form name="fsearch" method="get">
				...
				<div class="shop_search" width="100%" style="padding-top:8px;">
					<select name="sch_wr_2" id="sch_wr_2" class="sch_sel">
						<option value="">전체</option>
						<option value="수리" <?php if($sch_wr_2 == '수리') echo 'selected'; ?>>수리</option>
						<option value="판매" <?php if($sch_wr_2 == '판매') echo 'selected'; ?>>판매</option>
					</select>
	...
	<div style="padding:5px 0 15px 0;">
		...
		<tr>
			...
			<th class="l_th_th">고객명</th>
			<th class="l_th_th x80">수리/판매일자</th>
			<th class="l_th_th x80">H.P</th>
			<th class="l_th_th x80">모델</th>
			<th class="l_th_th x70">수리/판매금액</th>
		...
		<tr>
			...
			<td class="l_tb_td talign_c"><?php echo $list[$i]['wr_8'] ?></td>
			<td class="l_tb_td talign_c"><?php echo $list[$i]['wr_9'] ?></td>
			<td class="l_tb_td talign_r"><?php echo number_format($list[$i]['wr_10']).'원' ?></td>
			<td class="l_tb_td talign_c">
