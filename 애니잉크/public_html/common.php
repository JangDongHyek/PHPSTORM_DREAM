...
if (isset($_REQUEST['sch_wr_3'])) { // 리스트 페이지
    $sch_wr_3 = trim($_REQUEST['sch_wr_3']);
    if ($sch_wr_3)
        $qstr .= '&amp;sch_wr_3=' . $sch_wr_3;
} else {
    $sch_wr_3 = '';
}

if (isset($_REQUEST['sch_wr_7'])) { // 리스트 페이지
    $sch_wr_7 = trim($_REQUEST['sch_wr_7']);
    if ($sch_wr_7)
        $qstr .= '&amp;sch_wr_7=' . $sch_wr_7;
} else {
    $sch_wr_7 = '';
}
