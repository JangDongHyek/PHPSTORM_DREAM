<?
	...
	if($act) {
		...
		$bbs_reg_date = $now;
		$bbs_cfg = ',A,A,A,A,N,N,N,N,A,A,A,D,A,A,D,A,,,,0,0,1,0,0,0,1,0,,,,0,1,1,,,,,,';
...
//		rg_href("board_edit.php?$p_str&mode=edit&bbs_num=$bbs_num");
	...
	if($mode!='edit') {
		...
		$R[bbs_deny_word] = '8억,새끼,개새끼,소새끼,병신,지랄,씨팔,십팔,니기미,찌랄,지랄,쌍년,쌍놈,빙신,좆까,니기미,좆같은게,잡놈,벼엉신,바보새끼,씹새끼,씨발,씨팔,시벌,씨벌,떠그랄,좆밥,추천인,추천id,추천아이디,추천id,추천아이디,추/천/인,쉐이,등신,싸가지,미친놈,미친넘,찌랄,죽습니다,님아,님들아,씨밸넘';
