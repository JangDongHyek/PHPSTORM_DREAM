<?
  ...
  $order_str='';
	...
	include($skin_board_path."mobile_list_head.php");
	...
	// 스킨 체크
	$bbs_notice_skin_file = "mobile_list_main.php";
	$bbs_secret_skin_file = "mobile_list_main.php";
	$bbs_current_doc_skin_file = "mobile_list_main.php";
	$bbs_deleted_skin_file = "mobile_list_main.php";


	if (file_exists($skin_board_path."mobile_list_notice.php")) 
    $bbs_notice_skin_file = "mobile_list_notice.php";
	if (file_exists($skin_board_path."mobile_list_secret.php")) 
    $bbs_secret_skin_file = "mobile_list_secret.php";
	if (file_exists($skin_board_path."mobile_list_current.php")) 
    $bbs_current_doc_skin_file = "mobile_list_current.php";
	if (file_exists($skin_board_path."mobile_list_delete.php")) 
	...
	while ($data=mysql_fetch_array($rs)) {
		...
		if($rg_doc_num == $current_doc_num) { // 현재글 
			...
			include($skin_board_path."mobile_list_main.php");
		}
	}

	include($skin_board_path."mobile_list_foot.php");
?>	
