<div class="bbs_view_first">
	<div class="bbs_view_title"><?=$rg_title?></div>
	<div class="bbs_view_info">작성자 : <?=$rg_name?> 날 짜 :<?=substr($rg_reg_date,0,10)?> 조회수 : <?=$rg_doc_hit?></div>
</div>
<div class="bbs_view_second">
	<?=$show_file1_view_begin?>
    <img src="<?=$rg_file1_url?>" border="0" onerror="this.src='<?=$skin_board_url?>images/blank_.gif'" onclick="img_new_window('<?=urlencode($rg_file1_url)?>','<?=urlencode($rg_title)?>')" style="cursor:hand;" id=img_file1 width=300> 
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 style="table-layout:fixed">
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=#ffffff height="21"> 
      <div align="right">작성자&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
