...
onload=set_img_init;
    ...
    <p align='center'><img src="<?=$rg_file1_url?>" width=700 border="0" onerror="this.src='<?=$skin_board_url?>blank_.gif'" onclick="img_new_window('<?=urlencode($rg_file1_url)?>','<?=urlencode($rg_title)?>')" style="cursor:hand;" id=img_file1></p>
    <script language="JavaScript" type="text/JavaScript">
img1_exist = true;
function set_img1() {
	if(img1_width==0) {
	...
	<p align="center"><img src="<?=$rg_file2_url?>" width=700 border="0" onerror="this.src='<?=$skin_board_url?>blank_.gif'" onclick="img_new_window('<?=urlencode($rg_file2_url)?>','<?=urlencode($rg_title)?>')" style="cursor:hand;" id=img_file2></p> 
    <script language="JavaScript" type="text/JavaScript">
img2_exist = true;
function set_img2() {
	if(img2_width==0) {
