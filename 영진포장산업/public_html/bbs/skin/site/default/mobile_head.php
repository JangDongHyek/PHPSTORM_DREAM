...
<div class="subm">
		<dl>
		 <dd><a href="../bbs/mobile_list.php?bbs_id=pro_gal01" <?if($bbs_id == "pro_gal01"){?>class="on"<?}?>>창호부</a></dd>
		</dl>
</div>
<?}?>
<?if($bbs_id == "pro_gal02"){?>
<div class="subm">
		<dl>
		 <dd><a href="../bbs/mobile_list.php?bbs_id=pro_gal02" <?if($bbs_id == "pro_gal02"){?>class="on"<?}?>>잡철부</a></dd>
		</dl>
</div>
<?}?>
<?if($bbs_id == "pro_gal03"){?>
<div class="subm">
		<dl>
		 <dd><a href="../bbs/mobile_list.php?bbs_id=pro_gal03" <?if($bbs_id == "pro_gal03"){?>class="on"<?}?>>판넬부</a></dd>
		</dl>
</div>
<?}?>
-->
