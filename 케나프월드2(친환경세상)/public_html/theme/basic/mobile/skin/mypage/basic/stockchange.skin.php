...
foreach ($stocks as $stock) {
    $totalHoldingCount += $stock['holding_count']; // 각 주식의 보유량을 더함
}

?>
<div class="change_info">
※ 시장공급가액이 1주당 10,000원 이상일때 본인의 주식계좌로 받을 수 있습니다.
<p>※ 주식 지급시  소정의  세금이  부가됩니다</p>
</div>
<div class="wal-cotainer" id="wal_cotainer">
	<article class="wal-frm">
		<div class="wal-req">
			...
			<dl>
				<dt class="wc-price">보유주식수 <span><?php echo $totalHoldingCount?></span> <span style="color:#333;">주</span></dt>
			</dl>
			<!--<dl>
				<dd class="row">
                    ...
                    foreach ($stocks as $row) {
                        ...
                        <dd class="row">
                            <p class="col-xs-4">
                                ...
                                <span class="sc-line" style="color:#333;">주</span>
                            ...
                            <p class="col-xs-8 text-right">
                                <span class="box-ico">주당 <?php echo $row['stock_price'];?>원</span>
