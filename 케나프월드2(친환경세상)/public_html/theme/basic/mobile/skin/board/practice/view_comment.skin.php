	...
	<div id="review_list">
		...
		<div id="review_wirte" style="<?php if($com) echo "display:none;";?>">
			...
			<div class="btn_confirm">
				<input type="submit" id="btn_submit" class="btn btn-danger" value="리뷰<?php echo $com?"수정":"등록";?>" style="width:100%;">
			</div>
		...
		<?php } ?>
		<?php } ?>
		<?php if ($i == 0) { //댓글이 없다면 ?><div class="review">등록된 리뷰가 없습니다.</div><?php } ?>
	</div><!--review_list-->
</div><!--boxin-->
