...
<div id="reg_result" class="mbskin">
    ...
    <div class="btn_confirm">
        ...
        <!--<a href="javascript:alert('준비중입니다.')" class="btn02">새만금 잼버리부지 케나프 특구지정 청원서쓰고 주식받기</a>-->
        <!--<a href="<?php /*echo G5_BBS_URL */?>/petition.php" class="btn02">새만금 잼버리부지 케나프 특구지정 청원서쓰고 주식받기</a>-->
    </div>
