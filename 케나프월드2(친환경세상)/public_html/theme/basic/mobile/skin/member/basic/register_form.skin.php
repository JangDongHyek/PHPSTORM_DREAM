			...
			<div class="box-body" style="margin-bottom:0;">
				...
				<div class="box-content box-bottom clearfix" style="border:none;">
					<!--<dl style="border:1px solid #EDEDED; padding:10px; height:150px; overflow-y:auto; ">
                        ...
                        <dl style="border:1px solid #EDEDED; padding:10px; height:150px; overflow-y:auto; ">
                            <p>『개인정보보호법」 제15조, 제22조에 의거하여 농업회사법인 친환경세상(주)는 고객님의 개인정보에 대해 개인정보 수집 및 활용 동의서를 받고 있습니다.
                            <br><br>
                            개인정보 제공자가 동의한 내용 외에 다른 목적으로 활용하지 않으며, 제공된 개인정보의 이용을 거부하고자 할 때에는 개인정보 관리 책임자를 통해 열람, 정정 혹은 삭제를 요구할 수 있습니다. 개인정보 제공을 동의하지 않을 경우 이용에 제약이 있을 수 있습니다. 14세 미만의 아동은 보호자의 동의가 필요합니다.
                            <br><br>
                            이 정보에는 새만금 잼버리부지의 케나프 특구지정 청원서 작성과 이에 관련된 연락 및 안내가 있을 수 있습니다.
                            </p>
                            <br><br>
                            <dt>수집 이용에 관한 사항</dt>
                            <dd>1. 개인정보의 수집⦁이용자 : 농업회사법인 친환경세상 주식회사</dd>
                            <dd>2. 이벤트 정보<br>
                                ⦁이벤트 명칭: 새만금 세계스카우트 잼버리 축제장 케나프 재배 성공 기념 주식지분 나눔 이벤트<br>
                                ⦁이벤트 내용: 새만금 잼버리부지 케나프 특구지정 청원서 작성 및 제출을 통한 주식지분 나눔</dd>
                            <dd>3. (필수동의) 개인정보 수집 및 이용 동의
                                <div class="table">
                                <table>
                                    <thead>
                                    <tr>
                                    ...
                                    <tbody>
                                    <tr>
                                        <td>성명,성별,생년월일,연락처,이메일,주소,신청경로,활동사진</td>
                                        <td>새만금 잼버리부지 케나프 특구지정 청원서 작성 및 제출<br>
                                            청원서 작성 및 제출과 관련된 연락 및 안내<br>
                                            서비스 이용자의 개인 식별 및 서비스 이용에 따른 이력 관리</td>
                                        <td>청원서 작성 및 제출 완료일까지</td>
                                    </tr>
                                    </tbody>
                                </table>
                                </div>
                                ⦁개인정보 수집 및 이용에 대한 동의를 거부할 수 있습니다.
                                ⦁개인정보 수집 및 이용에 대한 동의를 거부할 경우, 프로그램 이용(주식지분 나눔 등)에 제한이 있을 수 있습니다.
                            </dd>
                            <dd>4. (선택동의) 홍보 및 마케팅에 대한 동의
                                <div class="table">
                                <table>
                                    <thead>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>[수집 및 보유할 개인정보 항목]
                                            (예시)성명, 연락처, 이메일, 주소, 신청경로, 활동사진</td>
                                        <td>홍보 및 마케팅</td>
                                        <td>보유기간 기재 필요
                                            청원서 작성 및 제출 완료일까지 혹은 2024년 12월31일까지</td>
                                    </tr>
                                    </tbody>
                                </table>
                                </div>
                                ⦁개인정보 수집 및 이용에 대한 동의를 거부할 수 있습니다.<br>
                                ⦁개인정보 수집 및 이용에 대한 동의를 거부할 경우, 프로그램 이용에 제한이 있을 수 있습니다.
                            </dd>
                        </dl>
				</div>
				<div style="padding-top:10px;">
