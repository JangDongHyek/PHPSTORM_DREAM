...
<div id="mb_login" class="mbskin">
    <div class="login_frm_box container">
        <h1>
        <a href="<?php echo G5_SHOP_URL; ?>/" class="logo"><img src="<?php echo G5_THEME_IMG_URL ?>/logo.jpg" alt="<?php echo $config['cf_title']; ?> 메인"></a><br>
		<?php echo $config['cf_title']; ?> <?php echo $g5['title'] ?>
        </h1>
