...
<aside id="stv">
	<div id="stv_nb">
        <ul class="row">
            <li class="col-xs-4"><a href="<?php echo G5_SHOP_URL; ?>/cart.php"><img src="<?php echo G5_THEME_IMG_URL ?>/quick02.png" alt="장바구니">장바구니</a></li>
            <li class="col-xs-4"><a href="<?php echo G5_SHOP_URL; ?>/wishlist.php"><img src="<?php echo G5_THEME_IMG_URL ?>/quick04.png" alt="위시리스트">위시리스트</a></li>
            <li class="col-xs-4"><a href="<?php echo G5_SHOP_URL; ?>/orderinquiry.php"><img src="<?php echo G5_THEME_IMG_URL ?>/quick03.png" alt="배송조회">배송조회</a></li>
        </ul>
    </div>
    <div id="stv_list">
        <h2>
