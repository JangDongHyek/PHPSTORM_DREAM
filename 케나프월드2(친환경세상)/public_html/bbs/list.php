...
if($bo_table == "asset")
	$sst = "CONVERT(wr_content, SIGNED) desc";
...
if ($sca || $stx) {
    $sql = " select wr_id as wr_parent from {$write_table} where wr_is_comment = 0 and {$sql_search} {$sql_order} limit {$from_record}, $page_rows ";
} else {
