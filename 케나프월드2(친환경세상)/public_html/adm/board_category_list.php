...
$sql_search = " where (1) and gr_id = 'basic'";
...
<form name="fboardlist" id="fboardlist" action="./board_category_update.php" onsubmit="return fboardlist_submit(this);" method="post">
...
<p class="text-right" style="color:#5b747e">분류와 분류 사이는 | 로 구분하세요. (예: 질문|답변) 첫자로 #은 입력하지 마세요. (예: #질문|#답변 [X])')</p>
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td>
			<input type="text" name="bo_category_list[<?php echo $i ?>]" value="<?php echo $row['bo_category_list'];?>" id="bo_category_list_<?php echo $i ?>" class="frm_input bo_subject full_input">
        </td>
		<td class="td_chk">
            <input type="checkbox" name="bo_use_category[<?php echo $i ?>]" value="1" id="bo_use_category_<?php echo $i ?>" <?php if($row['bo_use_category']) echo "checked";?>>
		</td>
    </tr>
    <?php
    }
