...
if(!sql_query(" DESCRIBE g5_shop_item_option_save ", false)) {
    sql_query(" CREATE TABLE IF NOT EXISTS g5_shop_item_option_save (
                    `is_no` int(11) NOT NULL AUTO_INCREMENT,
...
if($db_reload){
    alert("DB를 갱신합니다.", G5_ADMIN_URL.'/shop_admin/itemoptionsaveform.php?it_id='.$it_id); 
}
