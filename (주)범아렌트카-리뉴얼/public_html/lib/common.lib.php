...
function goSms($reserv_phone, $send_phone, $msg)
{
	...
	$sms_query = "Insert into mms_com.em_tran (tran_pr,tran_id,tran_phone,tran_callback,tran_status,tran_date,tran_msg) values (null,'$mart_id','$tran_phone1','$tran_callback1','1','$send_date','$tran_msg1')";
...
function goMMS($reserv_phone, $send_phone, $content, $type, $img="", $img2="") {
