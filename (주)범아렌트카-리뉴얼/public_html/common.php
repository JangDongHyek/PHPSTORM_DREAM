...
//단기 대여 분류
$ca_nameArr=array("경차/소형차량","중형","준대형/대형차량","SUV/승합차량","수입차량");
$modelArr=array(
				array("스파크/모닝","레이","아반떼/K3/SM3/벨로스터/클리오","I30/아이오닉"),
				array("쏘나타,K5,SM6,말리부","SM(L),쏘나타,K5(L)&(H)","G70 2.OT(G),스팅어2.OT(G)"),
				array("그랜져 IG 2.4(G), 2.2(D)/K7 2.4(G), 2.2(D)","그랜져 IG 3.0 / K7 3.0 / G0 2.2(D) /<br/> 스팅어 2.2(D) / 임팔라 2.5)","G80 2.2(D) / G80 3.3 / K9 3.3 /<br/>임팔라 3.6","G80 3.3T, 3.8 / K9 3.8","G90 3.3T, 3.8","G90 5.0"),
				array("스토닉 / 코나 / 셀토스 / 니로 / QM3 / 티볼리 / 코란도 / 트랙스","투싼 / 스포티지 / 이쿼녹스","싼타페 / 쏘렌토 / QM6","펠리세이드 / G4렉스턴","모하비","GV80","스타리아 11인승","카니발 9인승","카니발 7인승 리무진","카니발 7인승 / 9인승 하이리무진"),
				array(" BENZ C220 / BMW 320i , 320d","BENZ E220d / BMW 520d, 523d","BENZ GLC 300","BENZ E250, E300, GLE 400d","BENZ CLS450 AMG","BENZ S350d")
		  );




if(0 < strpos(G5_URL,"ttp://")){
	goto_url("https://www.bumarentcar.co.kr");
}
