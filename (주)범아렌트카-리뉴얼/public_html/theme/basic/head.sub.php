...
<link href="<?php echo G5_THEME_CSS_URL; ?>/all.css" rel="stylesheet" type="text/css"><!--메인컨텐츠-->
...
<script src="<?php echo G5_THEME_JS_URL ?>/moments.js"></script>
...
<!-- <script src="<?php echo G5_JS_URL ?>/jquery-1.9.1.min"></script> -->
