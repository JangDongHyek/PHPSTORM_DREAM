...
<div id="subContainer">
    <section class="sstion w1200">
        <div class="titBox">
            <h3>서비스 이용약관<p>(주)범아렌터카에 오신것을 환영합니다.</p>
            </h3>
        </div>
		<div class="contBox">
			<p class="text_pr">
...
<b>제1조(목적) </b><br>
이 약관은 (주)범아렌터카(이하 회사)이 운영하는 사이트 회사에서 제공하는 인터넷 관련 서비스를 이용함에 있어 이를 이용하는 이용자와 회사의 권리·의무 및 책임사항을 규정함을 목적으로 한다. 
</p>
<p class="text_pr">
<b>제2조 (용어의 정의) </b><br>
...
<p class="text_pr">
<b>제13조 (자료내용의 책임과 회사의 정보 관련 권한) </b><br>
...
<p class="text_pr">
<b>제16조 (회원의 가입해지/서비스중지/자료삭제) </b><br>
...
(시행일) 이 약관은 2021년 09월 01일부터 시행한다.
			</p>
			</div>
        <!-- /contBox -->
    </section>
