    ...
    <section id="bo_v_atc">
        ...
        <div class="clearfix header">
            ...
            <div class="col-md-6">
                    ...
                    <p class="deposit_price"><span class="t">보증금</span><span><?=number_format($view['wr_1'])?></span> 원</p>
                    <p class="rent_price"><span class="t">월렌트료</span><span><?=number_format($view['wr_2'])?></span> 원</p>
                    <p class="v_allprice"><span class="t">차량가격</span><span><?=number_format($view['wr_3'])?></span> 원</p>
					
					<?php
						if($view[wr_4]){?>
						<p class="v_time"><span class="t">계약기간</span> <span><?=$view[wr_4]?></span></p>
					<?php }?>
                    <!--견적신청버튼-->
                    <div>
                        <a href="<?php echo G5_BBS_URL ?>/write.php?bo_table=contact&f_wr_id=<?=$view[wr_id]?>" class="counsel">견적문의</a>
						<a href="<?php echo $list_href ?>" class="counsel st2">목록으로</a>
						<?php 
							if($is_admin){
						?>
						<a href="<?php echo G5_BBS_URL?>/board.php?bo_table=contact&f_wr_id=<?=$wr_id?>" class="counsel">견적목록보기</a>
						<?php }?>
                    </div>
                    <!--//견적신청버튼-->
            </div>
