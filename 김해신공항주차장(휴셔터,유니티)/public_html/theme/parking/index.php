...
<script src="<?php echo G5_THEME_JS_URL ?>/swiper.min.js"></script>
    ...
    <div id="rolling_tab" class="swiper-container">
        ...
        <!--//shape-->
        <div class="m_text">
                <h3 class="wow fadeInDown" data-wow-delay="0.1s">김해국제공항 - 남부주차장<br />최고의 주차설비를 자랑합니다.</h3>
               ...
               <div class="m_content00">
                  <div class="clearfix">
                      <div class="col-md-6 col-xs-12 m_box">
                          ...
                          <p class="text-left c wow fadeInDown" data-wow-delay='0.1s'>평일 및 주말 공휴일 상관 없이 <span>1일~2일 20,000원</span>
                          <br class="hidden-sm hidden-xs" />3일차 부터 요금 할인 적용을 통한 주차비를 산정하고 있습니다.
                      ...
                      <div class="col-md-6 col-xs-12">
                            <div class="box02 wow fadeInDown" data-wow-delay='0.5s'>
                                ...
                                <a href="javascript:alert('채널 준비중입니다.');" onfocus="this.blur()" title="김해신공항주차장 카카오톡 채널 바로가기"><p class="more"></p></a>
                            </div>
