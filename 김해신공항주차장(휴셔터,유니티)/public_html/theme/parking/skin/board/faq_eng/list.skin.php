...
<div id="bo_list" style="width:<?php echo $width; ?>">
	...
	<fieldset id="bo_sch">
		...
		<div class="searchBox">
			<ul class="clearfix">
    		<li class="bo_explain col-md-6 col-xs-12"><span class="bo_title">FAQ</span> | Frequently asked questions. Please search for any questions first.</li>
    		<li class="bo_search col-md-12 col-xs-12"><input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx"  class="frm_input required" size="25" maxlength="15" style="height:40px"/> <input type="submit" value="Search" class="btn_submit" style="height:40px"></li>
    		</ul>
		</div>
		</form>
	</fieldset>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
			...
			<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">Registration</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
