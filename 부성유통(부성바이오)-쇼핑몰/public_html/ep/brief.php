...
$item_sql = "select * from item where z_price > '0' and if_hide='0' and update_time > '$prev_time' and update_time <= '$now_time' order by item_no desc";
...
$txt_data .= "\n{$mapid}{$tab}{$pname}{$tab}{$price}{$tab}{$pgurl}{$tab}{$igurl}{$tab}{$cate1_name}{$tab}{$cate2_name}{$tab}{$djqtdma}{$tab}{$cate4}{$tab}{$row['it_model']}{$tab}{$brand}{$tab}{$maker}{$tab}{$origin}{$tab}{$point}{$tab}{$deliv}{$tab}{$class}{$tab}{$utime}";
