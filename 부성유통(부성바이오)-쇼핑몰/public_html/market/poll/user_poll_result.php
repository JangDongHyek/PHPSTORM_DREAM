...
<tr>
    <td width="100%">
      	<table border="0" width="100%" class="aa" cellspacing="0" cellpadding="0">
<?
	$vote_sum = 0;
        ...
        <tr>
          	<td width="100%" bgcolor="#FFFFFF">
            	<table border="0" width="100%">
              	<tr>
                	<td width="100%" class="aa" colspan="2"><?=$content?></td>
              	</tr>
              	<tr>
                	<td width="100%" class="bb" colspan="2">
                  		<p align="right">전체응답자 수 : <?=$vote_sum_real?>명 / 등록일 : <?=substr($date,0,10)?></td>
              	</tr>
              	<tr>
              	...
              	if($answer1 != ""){
					echo ("	
				<tr>
                	<td width='41%' class='aa'>1. $answer1 </td>
                	<td width='59%' class='aa'><img src='../images/graph.gif' height='13' width='$width1'>
              	...
              	if($answer2 != ""){
					echo ("	
				<tr>
                	<td width='41%' class='aa'>2. $answer2 </td>
                	<td width='59%' class='aa'><img src='../images/graph.gif' height='13' width='$width2'>
              	...
              	if($answer3 != ""){
					echo ("	
				<tr>
                	<td width='41%' class='aa'>3. $answer3 </td>
                	<td width='59%' class='aa'><img src='../images/graph.gif' height='13' width='$width3'>
              	...
              	if($answer4 != ""){
					echo ("	
				<tr>
                	<td width='41%' class='aa'>4. $answer4 </td>
                	<td width='59%' class='aa'><img src='../images/graph.gif' height='13' width='$width4'>
              	...
              	if($answer5 != ""){
					echo ("	
				<tr>
                	<td width='41%' class='aa'>5. $answer5 </td>
                	<td width='59%' class='aa'><img src='../images/graph.gif' height='13' width='$width5'>
              	...
              	if($answer6 != ""){
					echo ("	
				<tr>
                	<td width='41%' class='aa'>6. $answer6 </td>
                	<td width='59%' class='aa'><img src='../images/graph.gif' height='13' width='$width6'>
              	...
              	if($answer7 != ""){
					echo ("	
				<tr>
                	<td width='41%' class='aa'>7. $answer7 </td>
                	<td width='59%' class='aa'><img src='../images/graph.gif' height='13' width='$width7'>
              	...
              	if($answer8 != ""){
					echo ("	
				<tr>
                	<td width='41%' class='aa'>8. $answer8 </td>
                	<td width='59%' class='aa'><img src='../images/graph.gif' height='13' width='$width8'>
              	...
              	if($answer9 != ""){
					echo ("	
				<tr>
                	<td width='41%' class='aa'>9. $answer9 </td>
                	<td width='59%' class='aa'><img src='../images/graph.gif' height='13' width='$width9'>
            	...
            	<p align="center">
            	<input class="aa" onclick='window.close()' style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type="button" value="닫기">
            	<br>
            	<br>
            	</p>
          	</td> 
