...
if( $board_class == 1 || $board_class == 3 ){
	...
	if($numRows < 1 && !$_SESSION["Mall_Admin_ID"]){
		echo ("		
			...
			parent.location.href='../member/login.html?url=/market/board/epilogue.html&mart_id=bobmukja&mart_id=$mart_id';
			</script>
		");
		exit;
	}
...
<script>
function open_firm(){
	window.open("./work_writeform_search.php","업체검색","scrollbars=yes,menubar=no,resizable=yes,toolbar=no,left=50,top=50,width=500,height=300");
}
</script>
					<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="70" height="30" align="center"><img src="../image/helpdesk/view_product.gif" alt="제품명" width="60" height="30" /></td>
							<td width="1"><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td><input type="text" class="input_03" size="40" name="item_name" value='' readonly onclick="open_firm();" style='ime-mode:active'>←여기를 클릭해주세요.
							</td>
						</tr>
						<tr>
