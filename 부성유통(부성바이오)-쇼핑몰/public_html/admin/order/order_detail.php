...
?>
	...
	<input onclick="window.open('<?=$csturl?>','','width=400,height=820,scrollbars=yes,resizable=no');" target="mainpage" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #7b7d7b 1px solid; BORDER-LEFT: #7b7d7b 1px solid; BORDER-RIGHT: #7b7d7b 1px solid; BORDER-TOP: #7b7d7b 1px solid; COLOR: #7b7d7b; HEIGHT: 18px; width=120" type="button" value="카드결제 내역">
<?}?>
<?###################################################################End 현금영수증 ####################################################################?>
...
if($paymethod=="byescro")
{
	$pay_info_str = "KB에스크로 결제확인후 배송처리 하세요.";
}
