    	...
    	<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
      	<tr>
        	<td width="90%" bgcolor="#FFFFFF" valign="top">　
        		...
        		<strong>[신상품 등록]</strong> 등록되어진 제품 중 
        		신상품으로 등록합니다.<br>
        		등록한 신상품은 메인화면의 신상품영역에 출력됩니다.<br>
        		신상품 등록갯수제한은 없으나 3~6개 정도를 권장합니다.<br>
        		<br>
        		</td>
      	</tr>
      	<tr>
                        					...
                        					<td width="100%" bgcolor="#F7F7F7" height="20">
                        						...
                        						<tr>
                        							...
                        							<td width="50%"><strong><p align="right"></strong>
                        								...
                        								<option value="new_item.php" selected>신상품등록</option>
                        								<option value="fav_item.php">베스트상품 등록</option>
                        								<option value="rec_item.php">추천상품 등록</option>
                        								</select></td>
                        						</tr>
                        						</table>
                        					</td>
...
for ($i=0; $i<$numRows; $i++) {
	...
	for ($j=0; $j<$numRows1; $j++) {
		...
		$SQL2 = "select * from $CategoryTable where prevno=$category_num1 order by cat_order desc";
		//echo "sql=$SQL";
          		...
          		<tr>
            		<td width="100%" bgcolor="#CCCCCC">
            			<table border="0" width="100%" bgcolor="#F7F7F7" cellspacing="1" cellpadding="3">
              			...
              			<form action='new_item.php' method='post' name='list'>
...
if ($flag == "to_new_item"){
	for($i=0; $i<count($checkSel); $i++) {
		...
		$maxNew_Item_no_order = $maxNew_Item_order + 1;
		
		$SQL = "insert into $New_ItemTable (item_no, mart_id, provider_id, new_item_order) values ($item_no, '$mart_id', '$provider_id', $maxNew_Item_order)";
		$dbresult = mysql_query($SQL, $dbconn);
