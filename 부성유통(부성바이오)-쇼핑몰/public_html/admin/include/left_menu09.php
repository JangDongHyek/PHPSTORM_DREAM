...
<tr>
	<td height="50" bgcolor="#2d87ff" class="smenu_t">통계 관리</td>
  </tr>
<tr>
	<td><!--2차메뉴-->
            <div class="smenu">
	             <ul>
	             	<li><a href="../stat/member_region.php">회원 통계</a></li>
                    <li><a href="../counter.php">방문 통계</a></li>
                    <li><a href="../stat/sale_period.php">판매 통계</a></li>
                    <li><a href="../stat/item_count.php">상품 조회수</a></li>
	             </ul>
             </div>
<!--//2차메뉴--></td>
</tr>
