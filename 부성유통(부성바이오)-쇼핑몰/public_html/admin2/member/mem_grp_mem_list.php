  ...
  <tr>
    ...
    <table cellSpacing="0" cellPadding="0" width="100%" border="0">
      ...
      <tr>
        ...
        <small>▶</small> <font face="돋움">쇼핑몰에 가입한<strong> 회원을 
        ...
        <table width="100%" border="0">
          <tr>
            ...
            <table border="0" width="100%">
              <tr>
                <td width="84%"><p align="left"><strong><span class="cc">[회원그룹관리&gt;개별그룹관리]</span></strong></td>
          ...
          <tr>
            ...
            <?echo $grp_name?> 
            현재 회원수 : 총 <font color="#ff0000"><?echo $numRows1?></font> 명</span></strong></td>
