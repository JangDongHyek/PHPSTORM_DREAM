...
if (!in_array($bo_table, array('sub02_01','sub02_01_02','sub02_01_03','sub02_01_04'))) {
...
if ($w == '' || $w == 'r') {
    ...
    if ($member['mb_id']) {
        $mb_id = $member['mb_id'];
        if($bo_table == "sub02_01" || $bo_table == "sub02_01_02" || $bo_table == "sub02_01_03" || $bo_table == "sub02_01_04") {
