...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
		...
		<!-- 추가 -->
        <tr>
            <th scope="row"><label for="">회사명<strong class="sound_only">필수</strong></label></th>
            <td><?php echo $view[wr_subject]?></td>
        </tr>
        <tr>
            <th scope="row"><label for="wr_name">담당자 명<strong class="sound_only">필수</strong></label></th>
		...
		<!-- 전화 추가 -->
        <tr>
            <th scope="row"><label for="">전화번호<strong class="sound_only">필수</strong></label></th>
            <td><?php echo $view[wr_1]?></td>
        </tr>
		<!-- 팩스 추가 -->
        <tr>
            <th scope="row"><label for="">팩스번호<strong class="sound_only">필수</strong></label></th>
            <td><?php echo $view[wr_2]?></td>
        </tr>

		<!-- 회사주소 추가 input 누르면 주소창..뜨도록--> 
        <tr>
            <th scope="row"><label for="">회사주소<strong class="sound_only">필수</strong></label></th>
            <td>
