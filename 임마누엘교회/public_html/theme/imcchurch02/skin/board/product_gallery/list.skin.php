...
<!-- } 게시물 검색 끝 -->
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($_SESSION['ss_mb_id']=="admin") { ?><li><a href="./board.php?bo_table=product_request" class="btn_admin"><i class="fa fa-bars"></i> 견적서 보기</a></li><?php } ?>
            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="title">
                        <p class="t9"><?php echo $list[$i]['wr_subject'] ?><!-- 제목 --></p>
                        <p class="t16">
							<?php
								$sql="select * from g5_part where wr_id='".$list[$i][wr_id]."' and is_view='1' and 0 < partprice ";
								
								$result2=sql_query($sql);
								$priceArr=Array();
								$totalPrice=0;
								for($k=0;$row2=sql_fetch_array($result2);$k++){
									$totalPrice+=$row2[partprice];
								}
							if(0 < $totalPrice){
								echo number_format($totalPrice)."원";
							}else{?>
							<?echo $list[$i][wr_1]?"₩".$list[$i]['wr_1']."원":"가격문의"?><!-- 가격 -->
							<?php }?>
						</p>
