...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td align="center"><?php echo $list[$i][wr_1]?></td>
			<td align="center"><?php echo $list[$i][wr_2]?></td>
			<td align="center"><?php echo $list[$i][wr_3]?></td>
			<td align="center"><?php echo $list[$i][wr_4]?></td>
        </tr>
        <?php } ?>
