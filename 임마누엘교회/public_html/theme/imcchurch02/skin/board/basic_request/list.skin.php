        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>">
                    <?php echo $list[$i][name]."에서 ".$list[$i]['subject']." 부품 견적서를 보냈습니다." ?>
			...
			<td>
				<select name="wr_3" onchange="stateChange('<?php echo $list[$i][wr_id]?>',this)">
					<option value="접수">접수</option>
					<option value="확인"<?php echo $list[$i][wr_3]=="확인"?" selected":""?>>확인</option>
				</select>
			</td>
...
function stateChange(wr_id,t){
	$.ajax({
		url:g5_bbs_url+"/ajax.state_change.php",
		data:{wr_id:wr_id,wr_3:t.value},
		dataType:"html",
		type:"POST",
