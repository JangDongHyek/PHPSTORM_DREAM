...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <? }else { ?>
            ...
            <tr>
                <th scope="row"><label for="">성별<strong class="sound_only">필수</strong></label></th>
                <td>
                    <?php echo $view[wr_5]?>
                </td>
            </tr>
        ...
        <tr>
            <th scope="row"><label for="">핸드폰번호<strong class="sound_only">필수</strong></label></th>
        ...
        <tr>
            <th scope="row"><label for="">어떻게 교회를 알게 되셨나요?<strong class="sound_only">필수</strong></label></th>
            <td>
                <?php echo $view[wr_6]?>
            </td>
        </tr>
        ...
        <? }else if($bo_table == "sub02_01_03"){ ?>
            <tr>
                <th scope="row"><label for="">학교와  학년을 적어주세요.<strong class="sound_only">필수</strong></label></th>
                <td>
                    <?php echo $view[wr_7]?>
                </td>
            </tr>
        <? }else { ?>
            <tr>
                <th scope="row"><label for="">인도자가 있다면 적어주세요.<strong class="sound_only">필수</strong></label></th>
                <td>
                    <?php echo $view[wr_7]?>
                </td>
            </tr>
