        ...
        <div class="agree">
            ...
            <div class="txt cf">
                ...
                <div class="bx"><strong>수집하려는 개인정보의 항목</strong>
                    <div class="con">성명, 휴대전화번호, 이메일 등</div>
                </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="data" name="wr_subject" value="<?php echo $subject?>" id="wr_subject" required class="frm_input required"></td>
