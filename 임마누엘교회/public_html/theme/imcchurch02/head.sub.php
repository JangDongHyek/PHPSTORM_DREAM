...
<link rel="shortcut icon" href="<?php echo G5_THEME_URL ?>/img/common/bi.svg"/>
...
<link href="<?php echo G5_THEME_CSS_URL; ?>/main.css?v=<?php echo date('Y h:i:s A'); ?>" rel="stylesheet" type="text/css"><!--메인컨텐츠-->
<link href="<?php echo G5_THEME_CSS_URL; ?>/sub.css?v=<?php echo date('Y h:i:s A'); ?>" rel="stylesheet" type="text/css"><!--서브페이지-->
...
<script src="<?php echo G5_THEME_JS_URL ?>/jquery.ba-hashchange.1.3.min.js"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/hash.eazy-0.3.js"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/slick.min.js"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/mainslider.js"></script>
