...
<script type="text/x-template" id="<?=$componentName?>-template">
    <div v-if="load">
        <div class="box_radius box_white table">
            ...
            <p>-</p>
            <button  v-if="admin || mb_no == data.user_idx" class="btn btn_large btn_gray2" type="button" @click="jl.deleteData(data,'rental_hall',{message : '예약 취소시 데이터는 삭제됩니다 삭제하시겠습니까?',href : './rental_hall'})">예약 취소</button>
    ...
    Jl_components.push({name : "<?=$componentName?>",object : {
            ...
            methods: {
                async putData() {
                    ...
                    await this.jl.postData(this.data,'rental_hall');
                }
            },
            computed: {
