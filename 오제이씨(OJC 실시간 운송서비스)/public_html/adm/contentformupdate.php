...
if(!$co_no){
	...
	$sql = " select * from {$g5['content_save_table']} where co_id = '$co_id' and co_no = '{$co_no}' ";
	$row = sql_fetch($sql);

	$prev_path = G5_DATA_PATH."/content_save/".$co_id."_h ".$row['co_datetime'];
	$dest_path = G5_DATA_PATH."/content/".$co_id."_h";
	...
	$prev_path = G5_DATA_PATH."/content_save/".$co_id."_t ".$row['co_datetime'];
	$dest_path = G5_DATA_PATH."/content/".$co_id."_t";
