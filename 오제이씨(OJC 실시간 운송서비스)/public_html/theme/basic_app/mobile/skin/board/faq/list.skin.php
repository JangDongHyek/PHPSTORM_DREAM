...
<div id="bo_list" style="width:<?php echo $width; ?>">
	...
	<fieldset id="bo_sch">
		...
		<div class="searchBox">
			<ul class="clearfix">
    		<li class="bo_explain col-md-6 col-xs-12"><span class="bo_title">FAQ</span> | <?php echo $g5['title'] ?>입니다. 궁금한 질문은 검색해보세요 </li>
    		<li class="bo_search col-md-12 col-xs-12"><input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx"  class="frm_input required" size="25" maxlength="15" style="height:40px"/> <input type="submit" value="검색" class="btn_submit" style="height:40px"></li>
    		</ul>
		</div>
		</form>
	</fieldset>
...
<div class="tbl_head01 tbl_wrap">
        ...
        <table>
           <tr>
            ...
            <td class="td_subject">
                ...
                <span class="td_modify"><a href="<?=$write_href?>&w=u&wr_id=<?=$list[$i][wr_id]?>&page=<?=$page?>" class="btn_b01">수정</a></span>
                <? } ?>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
			<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02"><i class="fa-light fa-plus"></i><span>등록하기</span></a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
