...
define('IsTest', ($member['mb_id'] == 'test' || $member['mb_id'] == 'driver01')); /* 테스트계정 여부 */
define('IsCompany', ($ip == "183.103.22.103")); /* 회사 IP주소 */
define('LastFileVer', '?version='.strtotime(date('Y-m-d H:i:s'))); /* 파일버전 공통 */

define('KakaoJsKey', '8896f5151c8f582627de4389e589ca8b'); /* KAKAO JS KEY */ 
define('KakaoRestApiKey', '72bfa2fb511b6cf8b9c57363ea5b7c64'); /* KAKAO REST API KEY */ 
define('RfcApiUrl', 'http://14.48.175.186:8080'); /* RFC API IP */

/* cms.catchloc.com 관련 변수 */
define('CatchApiKey', 'b438e51116f23ace6b9088dc0b5300b0bb502525');
define('CatchServerKey', 'b6373da1b91836518820643200e20100fa10e876');

/* 앱 관련 변수 */

define('CUSTOMER', 'customer'); /* 고객 */
define('DELIVERY', 'delivery'); /* 배송기사 */

define('StatusCode', array( /* 관리자 배송상태 코드 */
    0 => array('code' => '0', 'name' => '전체'),
    1 => array('code' => '1', 'name' => '대기'),
    2 => array('code' => '2', 'name' => '배차'),
    3 => array('code' => '3', 'name' => '출차'),
    4 => array('code' => '4', 'name' => '완료')
));

define('DisStatusCode', array( /* 관리자 긴급상태 코드 */
    0 => array('code' => '0', 'name' => '해당없음'),
    1 => array('code' => '1', 'name' => '출고지연'),
    2 => array('code' => '2', 'name' => '배차지연'),    
    3 => array('code' => '3', 'name' => '배송지연')
));

define('ShippingPoint', array( /* 관리자 출하 지점 */
    1100 => array('code' => '1100', 'name' => '울산'),
    1200 => array('code' => '1200', 'name' => '전주')
));

define('TODAY', date('Y-m-d')); /* 금일 날짜 */
define('AMonthAgo', date('Y-m-d', strtotime(TODAY."-1 month"))); /* 한 달 전 날짜 */
...
for($h=$minHour; $h<=$maxHour; $h+=2){
    $data = array(
        'fromTime' => sprintf('%02d', $h).':00:00',
        'toTime' => sprintf('%02d', ($h + 2)).':00:00',
    );
...
/* 와이드샷 알림톡 */
define('WIDESHOT_SERVER', 'https://apimsg.wideshot.co.kr');
define('WIDESHOT_KEY', 'bW01ZEIzWitMaGdIYXRlMlZNN2hLS1FpbEZ2N2NSakpsbXgwVWplSUVpRmdHYU1iS0pRN00zRzNXenhpNElzQg=='); /* 와이드샷 키 */    
define('WIDESHOT_PULSFRIEND', "@오제이씨주식회사"); /* 카카오채널 이름 */
define('WIDESHOT_CH_KEY', "62ca44561a75a662faaccf979d254369e991be6d"); /* 발신프로필키 */
