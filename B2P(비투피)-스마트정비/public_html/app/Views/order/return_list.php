...
?>
        ...
        <div class="state_wrap">
            ...
            <div class="grid grid4 w100">
                <p>반품요청 <span class="color-blue">10</span>건</p>
                <p>반품수거완료 <span class="color-blue">10</span>건</p>
                <p>환불보류 <span class="color-blue">10</span>건</p>
                <p>환불승인완료 (1개월) <span class="color-blue">10</span>건</p>
            </div>
        </div>
            ...
            <div class="box">
                    ...
                    <div class="flex gap5">
                        <div class="input_select">
                            <select class="border_gray w100">
                                ...
                                <option value="GN">상품번호</option>
                                <option value="BN">구매자명</option>
                                <option value="RN">수령인명</option>
                                <option value="BI">구매자ID</option>
                                <option value="GM">상품명</option>
                                <option value="IN">원송장번호</option>
                                <option value="RIN">반품송장번호</option>
                                <option value="CN">장바구니번호</option>
                            </select>
                        </div>
                ...
                <div>
                    ...
                    <div class="input_select">
                        <select class="border_gray">
                            ...
                            <option value="RR">반품요청</option>
                            <option value="RP">반품수거완료</option>
                            <option value="RH">환불보류</option>
                            <option value="RF">환불승인완료</option>
                        </select>
                    </div>
                </div>
                <div>
                    ...
                    <div class="input_select">
                        <select class="border_gray">
                            ...
                            <option value="R1">보상요청</option>
                            <option value="R5">보상검토중</option>
                            <option value="R6">보상완료</option>
                            <option value="R7">보상불가</option>
                            <option value="R8">보상요청취소</option>
                        </select>
                    </div>
                </div>
                <!--
                ...
                <div>
                    ...
                    <div class="input_select">
                        <select class="border_gray">
                            <option value="">전체</option>
                            <option value="">빠른환불</option>
                            <option value="">일반환불</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="result_wrap">
            <div class="top_text">
                ...
                <div class="wrap w100 flex">
                    <button type="button" class="btn btn-blue btn-mini" data-toggle="modal" data-target="#orderReturnModal">반품처리</button>
                    <button type="button" class="btn btn-white btn-mini" data-toggle="modal" data-target="#orderReExchangeModal">교환처리</button>
                    <button type="button" class="btn btn-white btn-mini" data-toggle="modal" data-target="#orderRewardModal">보상요청</button>
