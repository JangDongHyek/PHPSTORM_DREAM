...
<div id="adm_content">
    ...
    <div class="con_wrap">
        ...
        <div class="tit_wrap">
            ...
            <div class="menu02">
                <a href="<?=base_url('/admin/sell_list')?>">판매 관리</a>
                <a href="<?=base_url('/admin/ship_list')?>" class="active">배송 관리</a>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="btn_wrap">
                                    <a onclick="shipping01_modal();" class="btn btn-sm btn-skyblue">송장</a>
