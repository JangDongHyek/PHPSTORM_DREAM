...
<div id="adm_content">
    ...
    <div class="con_wrap">
        ...
        <div class="tit_wrap">
            ...
            <div class="menu02">
                <a href="<?=base_url('/jejo/member_list')?>" class="active">제조사 정보관리</a>
            </div>
        </div>
        ...
        <div class="write_wrap">
            <div class="top_wrap">
                <h1>제조사 정보 수정하기</h1>
                <div class="btn_wrap">
                    <a href="<?=base_url('/jejo/member_list')?>" class="btn btn-sm btn-gray">목록</a>
                    <a href="<?=base_url('/jejo/member_list')?>" class="btn btn-sm btn-blue">저장</a>
                </div>
            </div>
            <div class="box">
