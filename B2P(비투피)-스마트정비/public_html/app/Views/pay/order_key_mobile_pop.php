...
require APPPATH . 'ThirdParty/KCP_autoPay/mobile_auth/pp_cli_hub_lib.php'; // library [수정불가]
?>
...
//log_message('error','order_key_mobile_pop.php $_POST: ' . print_r($_POST,true));
//log_message('error','order_key_mobile_pop.php $c_PayPlus: ' . print_r($c_PayPlus,true));
?>
<html>
<head>
...
<form name="pay_info" method="post" action="<?=base_url()?>pay/OrderKeyMobileResult">
