...
//log_message('error','order_key_mobile.php $_POST: ' . print_r($_POST,true));
...
<div class="wrap">
    ...
    <form name="order_info" method="post" action="<?=base_url()?>pay/OrderKeyMobilePop" accept-charset="euc-kr" onsubmit="document.charset='euc-kr';">
        ...
        <div id="skipCont" class="contents">
            ...
            <ul class="list-type-1">
                ...
                <li>
                    ...
                    <div class="right">
                        <div class="ipt-type-1 pc-wd-2">
                            <input type="text" name="good_name" value="" maxlength="40" />
                            <a href="#none" class="btn-clear"></a>
                        </div>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="right">
                        <div class="ipt-type-1 pc-wd-2">
                            <input type="text" name="buyr_name" value="B2P"  />
                            <a href="#none" class="btn-clear"></a>
                        </div>
                    </div>
                </li>
            ...
            <div Class="Line-Type-1">
                <ul class="list-btn-2">
                    ...
                    <!--
                    <li><button>배치키 발급 요청22</button></li>
                    -->
...
<form name="pay_form" method="post" action="<?=base_url()?>pay/OrderKeyMobilePop">
