                                ...
                                <div class="box__category">
                                    <div class="box__category-inner"><span class="text__category">대분류</span>
                                        <ul class="list__category" role="listbox" id="cate1">
                                            <li class="list-item is-selected" role="presentation" data-cate_no="">
                                                <button class="button__category" type="button" onclick="getCategory('cate1','','자동차용품', false)">자동차용품</button><button class="button__category--more"><i class="fa-light fa-chevron-right"></i></button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
