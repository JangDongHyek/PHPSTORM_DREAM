...
/*            if ($is_admin || $is_secret==1) {
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="text" name="wr_name" value="<?php echo $name==""?"작성자":$name ?>" id="wr_name" required class="frm_input required" size="10" maxlength="20"></td>
        </tr>
        <?php } ?>
		...
		<tr>
            ...
            <td><input type="text" name="wr_1" id="wr_1"  value="<?=$write[wr_1]?>" class="frm_input" maxlength="20"></td>
        </tr>
        <tr>
