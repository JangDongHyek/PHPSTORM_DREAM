...
--
-- Table structure for table `g5_content_save`
--

DROP TABLE IF EXISTS `g5_content_save`;
CREATE TABLE IF NOT EXISTS `g5_content_save` (
...
--
-- Table structure for table `g5_ipconfig`
--

DROP TABLE IF EXISTS `g5_ipconfig`;
CREATE TABLE IF NOT EXISTS `g5_ipconfig` (
  `ip_id` int(11) NOT NULL AUTO_INCREMENT,
  `ip_code` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`ip_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `g5_submenu`
--

DROP TABLE IF EXISTS `g5_submenu`;
CREATE TABLE IF NOT EXISTS `g5_submenu` (
  `sm_id` int(11) NOT NULL AUTO_INCREMENT,
  `sm_code` varchar(255) NOT NULL DEFAULT '',
  `sm_name` varchar(255) NOT NULL DEFAULT '',
  `sm_link` varchar(255) NOT NULL DEFAULT '',
  `sm_target` varchar(255) NOT NULL DEFAULT '',
  `sm_order` int(11) NOT NULL DEFAULT '0',
  `sm_use` tinyint(4) NOT NULL DEFAULT '0',
  `sm_mobile_use` tinyint(4) NOT NULL DEFAULT '0',
  `sm_type` varchar(255) NOT NULL DEFAULT '',
  `sm_tid` varchar(255) NOT NULL DEFAULT '',
  `sm_course` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`sm_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `member_gcm`
--

DROP TABLE IF EXISTS `member_gcm`;
CREATE TABLE IF NOT EXISTS `member_gcm` (
  `idx` int(20) NOT NULL auto_increment,
  `ID` char(50) default NULL,
  `RegID` char(250) default NULL,
  `DeviceID` char(100) default NULL,
  `delete` char(2) default '0',
  `app_type` int(1) NOT NULL default '0',
  PRIMARY KEY  (`idx`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;