			...
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    ...
					    <TD align=left class="bbs" bgcolor="#fafafa"> 
                          <input name='rg_file3' type=file style=width:100%;height:22; class=b_input id="rg_file3"  itemname='파일 #2'>
			...
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    ...
					    <TD align=left class="bbs" bgcolor="#fafafa"> 
                          <input name='rg_file4' type=file style=width:100%;height:22; class=b_input id="rg_file4"  itemname='파일 #2'>
