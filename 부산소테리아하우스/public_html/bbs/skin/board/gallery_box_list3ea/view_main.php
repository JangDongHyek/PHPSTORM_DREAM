...
function set_img_init() {
	...
	if(img3_exist) setInterval(set_img3, 100);
	if(img4_exist) setInterval(set_img4, 100);
...
function set_img2() {
	...
	<p align="center"><img src="<?=$rg_file3_url?>" border="0" onerror="this.src='<?=$skin_board_url?>blank_.gif'" id=img_file3></p> 
    <script language="JavaScript" type="text/JavaScript">
img2_exist = true;
function set_img2() {
	if(img2_width==0) {
		img2_width = img_file3.width;
	}
	set_img('img_file3',img2_width,contents.offsetWidth)
}
</script>
    <br>
    <?=$show_file3_view_end?>
	 <?=$show_file4_view_begin?>
	<p align="center"><img src="<?=$rg_file4_url?>" border="0" onerror="this.src='<?=$skin_board_url?>blank_.gif'" id=img_file4></p> 
    <script language="JavaScript" type="text/JavaScript">
img2_exist = true;
function set_img2() {
	if(img2_width==0) {
		img2_width = img_file4.width;
	}
	set_img('img_file4',img2_width,contents.offsetWidth)
}
</script>
    <br>
    <?=$show_file4_view_end?>
