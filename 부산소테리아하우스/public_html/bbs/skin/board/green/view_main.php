...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 style="table-layout:fixed">
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=F7F7F7 height=21> 
      <div align="right">다운로드 #3 &nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
    <TD colspan=3 style='padding-left:10;' height=21> 
      <?=$a_file3?>
      <?=$rg_file3_name?>
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=F7F7F7 height=21> 
      <div align="right">다운로드 #4 &nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
    <TD colspan=3 style='padding-left:10;' height=21> 
      <?=$a_file4?>
      <?=$rg_file4_name?>
...
var img3_exist = false;
var img4_exist = false;
...
function set_img2() {
	...
	<?=$show_file3_view_begin?>
    <img src="<?=$rg_file3_url?>" border="0" onerror="this.src='<?=$skin_board_url?>images/blank_.gif'" onclick="img_new_window('<?=urlencode($rg_file3_url)?>','<?=urlencode($rg_title)?>')" style="cursor:hand;" id=img_file3> 
    <script language="JavaScript" type="text/JavaScript">
img3_exist = true;
function set_img3() {
	if(img3_width==0) {
		img3_width = img_file3.width;
	}
	set_img('img_file3',img3_width,contents.offsetWidth)
}
</script>
    <br>
    <?=$show_file3_view_end?>
	<?=$show_file4_view_begin?>
    <img src="<?=$rg_file4_url?>" border="0" onerror="this.src='<?=$skin_board_url?>images/blank_.gif'" onclick="img_new_window('<?=urlencode($rg_file4_url)?>','<?=urlencode($rg_title)?>')" style="cursor:hand;" id=img_file4> 
    <script language="JavaScript" type="text/JavaScript">
img4_exist = true;
function set_img4() {
	if(img4_width==0) {
		img4_width = img_file4.width;
	}
	set_img('img_file4',img4_width,contents.offsetWidth)
}
</script>
    <br>
    <?=$show_file4_view_end?>
