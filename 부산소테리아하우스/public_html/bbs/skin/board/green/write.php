...
<?
	if($bbs_id=="noticee"){
?>
<input type="hidden" name="rg_files_count" value="4">
<? }?>
				...
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    ...
					    <TD align=left class="bbs" bgcolor="#fafafa"> 
                          ...
                          <br> <input name='del_file3' type=checkbox id="del_file2" value='1'>
                          삭제 ( <?=$rg_file3_name?> ) 
			...
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    ...
					    <TD align=left class="bbs" bgcolor="#fafafa"> 
                          <input name='rg_file4' type=file style=width:90%;height:22; class=b_input id="rg_file4"  itemname='파일 #4'>
                          <?=$show_file4_delete_begin?>
                          <br> <input name='del_file4' type=checkbox id="del_file2" value='1'>
                          삭제 ( <?=$rg_file4_name?> ) 
