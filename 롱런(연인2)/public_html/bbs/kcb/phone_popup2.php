...
$SITE_URL 	=   "dreamforone.co.kr/~lover2"; //"lover.itforone.co.kr/";
...
$RETURN_URL = G5_URL."/bbs/kcb/phone_popup3.php";// 인증 완료 후 리턴될 URL (도메인 포함 full path)
...
//if ($_SERVER['REMOTE_ADDR'] == "183.103.22.103") $popupUrl = "https://tsafe.ok-name.co.kr:4430/CommonSvl";	// 운영 URL 
...
if ($_REQUEST['req_page'] == "find") {
	$action_url = G5_BBS_URL."/password_lost.php";
}
...
<script>
	...
	window.onload = function() {
        sessionStorage.setItem("req_page", "<?=$_REQUEST['req_page']?>");
        ...
        <?php } else { ?>
        alert('본인확인에 실패하였습니다. 다시 시도해 주세요.');
