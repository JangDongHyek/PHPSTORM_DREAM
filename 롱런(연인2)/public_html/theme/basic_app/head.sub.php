...
<meta name="facebook-domain-verification" content="gfrt3dxon91adysf3n1jj2kpi387x8" />
<?php
if (G5_IS_MOBILE) {
...
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/default.css?ver='.G5_CSS_VER.'">',1);
...
var is_web_longlun = "<?=$long_run_web? "Y" : "N" ?>";
</script>
...
<?php
// 23.03.30 롱런 웹사이트 Facebook SDK 추가 (페이스북 픽셀)
if ($long_run_web) {
?>
<!-- Meta Pixel Code -->
<script>
    ...
    fbq('init', '612081443800383');
    fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=612081443800383&ev=PageView&noscript=1"/></noscript>
<!-- End Meta Pixel Code -->
<? } ?>
</head>
