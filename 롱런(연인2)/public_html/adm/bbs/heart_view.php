...
$sql = "SELECT A.*, B.mb_name,
        ...
        FROM g5_bbs_heart A LEFT JOIN g5_member B ON A.mb_no = B.mb_no 
...
<article id="bo_v" class="max1200">
    ...
    <div id="bo_v_top">
        <?php ob_start(); ?>
        <ul class="bo_v_com">
            <li><a href="./heart_form.php?idx=<?=$idx?>&<?=$qstr?>" class="btn_b01">수정</a></li>
            <li><a href="javascript:void(0)" onclick="deleteBbsOne('heartDelete', <?=$idx?>)" class="btn_b01">삭제</a></li>
            <li><a href="./heart.php?<?=$qstr?>" class="btn_b01">목록</a></li>
        </ul>
        <?php
