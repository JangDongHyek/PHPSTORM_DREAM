...
// 공통쿼리
$sql_common = "FROM g5_bbs_heart A LEFT JOIN g5_member B ON A.mb_no = B.mb_no WHERE A.del_yn = 'N' ";
...
$sql = "SELECT A.*, B.mb_no, B.mb_id, B.mb_name,
        ...
        (SELECT COUNT(idx) FROM g5_bbs_reply WHERE del_yn = 'N' AND tbl_name = 'heart' AND tbl_idx = A.idx) AS reply_cnt
...
<div id="bo_list">
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            <li><a href="./heart_form.php" class="btn_b02">등록하기</a></li>
        </ul>
    </div>
    ...
    <form name="fboardlist" id="fboardlist" method="post">
            ...
            <table>
                ...
                <?php
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        $link = "./heart_view.php?idx=".$row['idx'];
        ...
        <div class="bo_fx">
            <ul class="btn_bo_adm">
                <li><input type="button" name="btn_submit" value="선택삭제" onclick="deleteBbsList('heartDelete')"></li>
            </ul>
            <?/*
            <ul class="btn_bo_user">
