...
// 공통쿼리
$sql_common = "FROM g5_bbs_basic WHERE del_yn = 'N' AND tbl_name = 'event'";
...
?>
    <ul data-last-page="Y">
        <li><a href="javascript:void(0)"><p class="title">등록된 이벤트가 없습니다.</p></a></li>
    </ul>
<? } else { ?>
    <ul data-last-page="<?=$last_page?>">
        <? while($row = sql_fetch_array($result)) { ?>
        <li>
            <!--<a href="./event_view.php?idx=<?/*=$row['idx']*/?>">-->
            <a href="#event<?=$row['idx']?>">
                <p class="title"><strong>이벤트</strong><?=$row['subject']?></p>
