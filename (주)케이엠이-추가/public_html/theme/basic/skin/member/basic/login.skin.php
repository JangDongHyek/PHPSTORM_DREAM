...
?>
<style>
html, body{width:100%;height:100%;min-height:500px; background-color:#f2f2f2;/*background:url(<?php echo $member_skin_url ?>/img/bg2.jpg) no-repeat center fixed ; background-size:cover; overflow-y:hidden; overflow-x:hidden;*/}
</style>
