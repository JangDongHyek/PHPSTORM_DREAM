...
define('G5_HTTP_DOMAIN', ''); // 21.06.02 https->http로 보내기 추가
...
if(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS']=='on') {   //https 통신일때 daum 주소 js
    ...
    // (210129) http->https로 보내기
//    if(strpos($_SERVER['REQUEST_URI'], '/adm') !== false) {
//        header('Location: '.G5_HTTPS_DOMAIN.'/adm/');
//    }
//    else if(strpos($_SERVER['REQUEST_URI'], '/qna') !== false) {} // 21.06.02 /qna 경로 http->https 예외 처리
//    else {
