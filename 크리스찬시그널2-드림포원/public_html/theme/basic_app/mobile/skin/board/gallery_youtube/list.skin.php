...
<!-- 게시판 목록 시작 { -->
<div id="bo_gall">
<!--  view에 인클루드 걸려있어서 wr_id 없을 경우만 나오게 했음.  -->
    <?php if ($is_category && $wr_id == "") { ?>
    <nav id="bo_cate">
    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:<?php echo $board['bo_gallery_width'] ?>px">
            ...
            <ul class="gall_con">
            	<a href="<?php echo $list[$i]['href'] ?>"><p class="youtube_icon"><i class="fab fa-youtube"></i></p></a>
                <li class="gall_href">
...
<!--
                    <div id="lecture_writer_list">
                                <div class="mb">
                                    ...
                                    <div class="mb_info">
                                        <p><?php echo $list[$i]['name'] ?>&nbsp;&nbsp;<span><i class="fas fa-star"></i>&nbsp;4.5</span></p>
                                    </div>
                                </div>
                    </div>
-->
    ...
    <div class="btn_wrap">
        <?php if ($is_checkbox) { ?>
        <ul class="btn_bo_adm" style="padding-left: 0px;">
        ...
        <div class="btn_bo_user">
            <?php if ($list_href) { ?><a href="<?php echo $list_href ?>" class="btn_st1">목록</a><?php } ?>
            <?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn_st1">등록하기</a><?php } ?>
        </div>
        <?php } ?>
    </div>
    <?php } ?>
