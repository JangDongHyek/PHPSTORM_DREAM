...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<div class="wr_content">
			<textarea id="wr_content" name="wr_content" style="width:100%;height:300px" placeholder="답변을 입력해주세요"><?=$write['wr_content']?></textarea>
		</div>
        </div>
    </div>
    ...
    <div class="btn_confirm" id="ft_btn">
        <input type="submit" value="<?php echo $w == '' ? '등록' : '수정'; ?>하기" id="btn_submit" accesskey="s" class="btn">
    </div>
    </form>
