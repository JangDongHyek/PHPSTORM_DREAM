...
<section id="bo_w">
    ...
    <input type="hidden" name="report_mb_no" value="<?php echo $report_mb_no ?>">
    <?php
    $option = '';
    $option_hidden = '';
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <label for="wr_subject">분류<strong class="sound_only">필수</strong></label>
        <div id="autosave_wrapper">
            <select name="wr_subject" value="<?=$write['wr_subject']?>" id="wr_subject" required class="frm_input">
