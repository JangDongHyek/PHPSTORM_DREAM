...
<div id="reg_result" class="mbskin">
    ...
    <h2>
        <strong><?php echo get_text($mb['mb_name']); ?>님</strong><br>반갑습니다.
    </h2>
    ...
    <p class="scom">
        프로필을 작성하시면<br />크리스찬시그널에서 제공하는<br />
    ...
    <div class="btn_confirm2 ft_btn">
        <a href="<?=G5_BBS_URL?>/my_profile01.php?mb_id=<?=$mb['mb_id']?>" class="wbtn2">프로필 작성하러 가기</a>
    </div>
