...
<div id="find_info" class="mbskin">
	...
	<div class="tab-content">
	  ...
	  <div role="tabpanel" class="tab-pane" id="pass-find">
		...
		<fieldset id="info_fs">
			<label for="mb_hp">휴대폰번호<strong class="sound_only">필수</strong></label>
			<input type="tel" name="mb_hp" id="mb_hp2" required class="required frm_input" size="30" placeholder="휴대폰번호" onkeyup="only_number(this);" maxlength="11">
		</fieldset>	
<!--		<fieldset id="info_fs">-->
...
<!--		</fieldset>-->
		...
		<div class="win_btn">
			<input type="button" value="임시비밀번호 발송" onclick="pw_send_sms()" class="btn03">
			<button type="button" onclick="javascript:history.back();" class="btn01">뒤로</button>
		</div>
		</form>
	  </div>
