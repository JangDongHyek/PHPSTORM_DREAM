...
-->
    ...
    <div class="section02">
        ...
        <ul class="user_list">
            <?php
            for($i = 0; $row = sql_fetch_array($new_result); $i++){
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="area_secret">
                        <ul>
                            <li>
                                <i>01</i>
                                <span>회원가입비 100,000 만원 (2,000 만나 지급)</span>
                            </li>
                            <li>
                                <i>02</i>
                                <span>회원가입 2000 만나 모두 소진전에 회원탈퇴시 만나 사용한 만큼 현금화하여 탈퇴비용 적용됩니다.</span>
                            </li>
                            <li>
                                <i>03</i>
                                <span>사진 30만나, 나의정보 50만나, 메세지 20만나 차감적용됩니다.</span>
                            </li>
                            <li>
                                <i>04</i>
                ...
                <div class="modal-footer">
                    ...
                    <?php }else{ ?>
                        <button type="button" class="btn btn-default" data-dismiss="modal"  onclick="payment(100000)">확인</button>
                    <?php } ?>
