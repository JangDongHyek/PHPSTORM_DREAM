	...
	<li onclick="location.href='<?php echo $list[$i]['href'] ?>'" onmouseover="window.status='<?php echo $list[$i]['href'] ?>'" onmouseout="window.status=''">
		...
		<p>
			...
			<ul>
				...
				<li class="zine_con"><?php echo $list[$i]['name'] ?></li>
				<li class="zine_info"><span><?php echo $list[$i]['datetime']?></span> <span>조회 <strong><?php echo number_format($view['wr_hit']) ?></strong></span></li>
				<li></li>
			</ul>
			</div>
		</p>
