...
<div class="mbskin">
    <ul class="profilecate cf">
        ...
        <li class="active"><a href="javascript:void(0);" onclick="save('register_form03.php');">나의정보</a></li>
	...
	<article class="box-article">
		...
		<button onclick="location.href='./register_form04.php'" class="btn_submit ft_btn">다음 단계</button>
	</article>
</div>
