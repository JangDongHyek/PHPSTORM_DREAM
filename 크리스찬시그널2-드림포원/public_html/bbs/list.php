...
if($page_rows > 0) {
    ...
    while ($row = sql_fetch_array($result))
    {
        ...
        /*// 비회원문의 게시판 비밀번호 입력 후 조회
        if($bo_table == 'qna' && $member['mb_level'] != 10) {
            $list[$i]['href'] = './password.php?w=u&amp;bo_table='.$bo_table.'&amp;wr_id='.$row['wr_parent'].'&amp;page='.$page.$qstr;
        }*/
...
$write_href = '';
if ($member['mb_level'] >= $board['bo_write_level'] || $bo_table == 'qna') {
