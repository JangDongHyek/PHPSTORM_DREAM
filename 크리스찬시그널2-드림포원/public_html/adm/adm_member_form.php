...
<form name="fmember" id="fmember" action="./member_form_admin_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
        ...
        <table>
			...
			*/ ?>
            ...
            <tr>
                ...
                <td><input type="text" name="mb_name" id="mb_name" value="<?=$mb['mb_name']?>" class="frm_input" size="15" maxlength="20"></td>
            </tr>
            <? /*
	<tr>
	...
	*/ ?>
    ...
    <div class="btn_confirm01 btn_confirm">
        ...
        <a href="./adm_member_list.php?<?php echo $qstr ?>">목록</a>
    </div>
</form>
