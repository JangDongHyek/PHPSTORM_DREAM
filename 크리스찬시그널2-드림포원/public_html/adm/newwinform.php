...
<form name="frmnewwin" action="./newwinformupdate.php" onsubmit="return frmnewwin_check(this);" method="post" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
            ...
            <tr>
                <th scope="row"><label for="nw_number">팝업 순서<strong class="sound_only"> 필수</strong></label></th>
                <td>
                    <input type="text" name="nw_number" value="<?php echo $nw['nw_number'] ?>" id="nw_number"  class="frm_input" size="5">
                    <p>* 클수록 먼저 노출됩니다.</p>
                </td>
            </tr>
            <tr>
