...
$(function() {
    ...
    $(document).on("click", "#add_manual", function() {
        ...
        add_menu_list(me_name, me_link, "<?php echo $code; ?>", 0);
    });
    ...
    $(document).on("click", ".add_select", function() {
        ...
        add_menu_list(me_name, me_link, "<?php echo $code; ?>", 1);
    });
});

function add_menu_list(name, link, code, stat)
{
    ...
    list += "<label for=\"me_course_"+ms+"\"  class=\"sound_only\">경로</label>";
    list += "<select name=\"me_course[]\" id=\"me_course_"+ms+"\">";
