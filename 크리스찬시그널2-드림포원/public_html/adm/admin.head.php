...
<header id="hd">
    <div id="hd_wrap">
        ...
        <ul id="tnb">
            <li><a href="<?php echo G5_ADMIN_URL ?>/member_form_admin.php?w=u&amp;mb_id=<?php echo $member['mb_id'] ?>">관리자정보</a></li>
            ...
            <?php } ?>
            <li id="tnb_logout"><a href="<?php echo G5_BBS_URL ?>/logout.php?param=admin">로그아웃</a></li>
        </ul>
