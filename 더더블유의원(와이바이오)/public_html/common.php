...
define('NAVER_CLIENT_ID', 'lxY7CkSkSfXmTR0Wbxwv');
define('NAVER_CLIENT_SECRET', 'Z1Z30cGng5');
define('NAVER_CALLBACK_URL', 'https://www.thewclinic.co.kr/bbs/naver_login.php');
?>
