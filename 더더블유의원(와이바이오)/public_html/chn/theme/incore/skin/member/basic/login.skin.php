...
?>
<style type="text/css">
body{background:#b1bfcc url("<?php echo $member_skin_url;?>/img/login_bg.jpg") center 0 no-repeat;}
...
<div id="mb_login" class="mbskin">
	<h1><?php echo $config['cf_title']; ?> ADMIN LOGIN</h1>
	...
	<div class="login-wrap">
		<fieldset id="login_fs">
			...
			<div class="login-box login-id">
				...
				<div class="login-input"><i class="fa fa-user"></i><span class="placeholder" style="width:80%"><input type="text" name="mb_id" id="login_id" required class="i_text required" maxlength="20" /><label for="login_id">아이디를 입력해 주세요.</label></span></div>
			</div>
			<div class="login-box login-pwd">
				<div class="login-label">PASSWORD</div>
				<div class="login-input"><i class="fa fa-gear"></i><span class="placeholder" style="width:80%"><input type="password" name="mb_password" id="login_pw" required class="i_text required" maxlength="20" /><label for="login_pw">패스워드를 입력해 주세요.</label></span></div>
			</div>
