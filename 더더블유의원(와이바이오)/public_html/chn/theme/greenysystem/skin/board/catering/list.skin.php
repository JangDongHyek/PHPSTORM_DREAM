                    ...
                    <ul>
                        <li class="gall_text_href">
                            ...
                            if ($is_category && $list[$i]['ca_name']) {
                             ?>
                            <p href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></p>
                            <?php } ?><?php */?>
                            <p class="title">
                        ...
                        <div class="gall_subject">
                            <?php /*?><span>작성자 </span><?php echo $list[$i]['name'] ?>
                            <span>작성일 </span><?php echo $list[$i]['datetime'] ?>
                            <span>조회 </span><?php echo $list[$i]['wr_hit'] ?><?php */?>
                        </div>
