...
<div id="wrapper">
    ...
    <div id="container_index">
	 ...
	 <!--서브상단비주얼-->
     <? if($co_id == "cn_greet01" || $co_id == "cn_greet02" || $bo_table=="greet03" || $bo_table=="greet04" || $bo_table=="greet05" || $bo_table=="greet06" || $co_id=="greet06" || $co_id=="greet07" || $co_id=="greet08" || $bo_table =="aca" || $bo_table =="media" || $bo_table =="writing" || $co_id=="greet11") {  ?>
	...
	<!--
     ...
     <? } else if ($co_id =="cn_s1_01" || $co_id =="cn_s1_02" || $co_id =="cn_s1_03" || $co_id =="cn_s1_04" || $co_id =="cn_s1_05") { ?>
     ...
     <? } else if ($co_id =="cn_s3_01" || $co_id =="cn_s3_02" || $co_id =="cn_s3_03" || $co_id =="cn_s3_04" || $co_id =="cn_s3_05" || $co_id =="cn_s3_06" || $co_id =="cn_s3_07" || $co_id =="cn_s3_08" || $co_id =="cn_s3_09" || $co_id =="cn_s3_10") { ?>
