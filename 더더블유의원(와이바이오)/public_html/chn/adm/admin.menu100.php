...
if($_SESSION['ss_mb_id']=="lets080"){
	$menu['menu100'] = array (
		...
		array('', 'CHN테마설정', G5_ADMIN_URL.'/theme.php',     'cf_theme', 1),
		array('', 'CHN메뉴설정', G5_ADMIN_URL.'/menu_list.php',     'cf_menu', 1),
		array('100210', 'CHN서브메뉴설정', G5_ADMIN_URL.'/submenu_list.php',     'cf_menu', 1),
