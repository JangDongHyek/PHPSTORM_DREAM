...
$g5_url_arr = explode('/',G5_URL);
$g5_url2 = "";
for($g5_w=0; $g5_w<(count($g5_url_arr)-1); $g5_w++){
	$g5_url2 .= $g5_url_arr[$g5_w].'/';
}
define('G5_URL2', $g5_url2);
...
define('G5_SESSION_PATH',   str_replace('chn/','',G5_DATA_PATH).'/'.G5_SESSION_DIR);
