...
define('G5_MYSQL_USER', 'thewdoctor');
define('G5_MYSQL_PASSWORD', '&%#pyb!k');
define('G5_MYSQL_DB', 'thewdoctor');
...
$g5['menu_table'] = G5_TABLE_PREFIX.'menu_chn'; // 메뉴관리 테이블
$g5['submenu_table'] = G5_TABLE_PREFIX.'submenu_chn'; // 서브메뉴 테이블
