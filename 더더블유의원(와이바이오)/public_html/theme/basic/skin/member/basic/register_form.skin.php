...
<div class="mbskin new_join">
    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption class="hide">사이트 이용정보 입력</caption>
        <tbody>
        <tr>
            <th scope="row"><label for="reg_mb_id">아이디<strong class="sound_only">필수</strong></label></th>
            <td>
            	<!--<span class="frm_info">영문자, 숫자, _ 만 입력 가능. 최소 3자이상 입력하세요.</span>-->
                <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" placeholder="영문과 숫자, 4 ~ 12자리까지 가능">
                <span id="msg_mb_id"></span>
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="reg_mb_password">비밀번호<strong class="sound_only">필수</strong></label></th>
            <td><input type="password" name="mb_password" id="reg_mb_password" <?php echo $required ?> class="frm_input <?php echo $required ?>" minlength="3" maxlength="20" placeholder="8자~15자 영문,숫자,특수문자 포함"></td>
        </tr>
        <tr>
            <th scope="row"><label for="reg_mb_password_re">비밀번호 확인<strong class="sound_only">필수</strong></label></th>
            <td><input type="password" name="mb_password_re" id="reg_mb_password_re" <?php echo $required ?> class="frm_input <?php echo $required ?>" minlength="3" maxlength="20" placeholder="비밀번호 재입력"></td>
        </tr>
        </tbody>
        </table>
    </div>
    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption class="hide">개인정보 입력</caption>
        <tbody>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>" id="reg_mb_nick" required class="frm_input required nospace" size="10" maxlength="20" placeholder="공백없이 한글,영문,숫자만 입력 가능 (한글2자, 영문4자 이상)">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" required class="frm_input email required" size="70" maxlength="100" placeholder="예:test@naver.com">
            </td>
        </tr>
    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption class="hide">기타 개인설정</caption>
        <tbody>
    ...
    <div class="btn_confirm">
        <input type="submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" id="btn_submit" class="btn_submit join_newbtn" accesskey="s">
        <a href="<?php echo G5_URL ?>" class="btn_cancel cancel_newbtn">취소</a>
		<?php if($w=="u"){?>
		<a href="<?php echo G5_BBS_URL?>/member_confirm.php?url=<?php echo G5_BBS_URL?>/member_leave.php" class="btn_cancel cancel_newbtn">회원탈퇴</a>
		<?php }?>
    </div>
    </form>
