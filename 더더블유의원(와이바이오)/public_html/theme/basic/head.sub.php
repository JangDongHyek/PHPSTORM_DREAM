...
<link href="<?php echo G5_THEME_CSS_URL; ?>/swiper-bundle.min.css" rel="stylesheet" type="text/css"><!--slick슬라이드-->
...
<script src="<?php echo G5_THEME_JS_URL ?>/swiper-bundle.min.js"></script><!--swiper슬라이드-->
