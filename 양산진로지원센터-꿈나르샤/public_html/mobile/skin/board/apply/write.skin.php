...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="frm_input required" style="width:100%" maxlength="20"></td>
        </tr>
       
		<tr>
            <th scope="row"><label for="wr_2">학생연락처<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_2" value="<?php echo $write[wr_2] ?>" id="wr_2" required class="frm_input required" style="width:100%" maxlength="100"></td>
        </tr>
		<tr>
            <th scope="row"><label for="wr_3">학부모성함<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_3" value="<?php echo $write[wr_3] ?>" id="wr_3" required class="frm_input required" style="width:100%" maxlength="20"></td>
        </tr>
		<tr>
            <th scope="row"><label for="wr_4">학부모연락처<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_4" value="<?php echo $write[wr_4] ?>" id="wr_4" required class="frm_input required" style="width:100%" maxlength="100"></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input required" style="width:100%" maxlength="255">
                </div>
            </td>
        </tr>
		<tr>
            <th scope="row"><label for="wr_content">학년<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_content" value="<?php echo $write[wr_content] ?>" id="wr_content" required class="frm_input required" style="width:100%" maxlength="20"></td>
        </tr>
		<tr>
