...
<div id="programText">
<div class="counselimg"><img src="<?php echo G5_URL; ?>/img/identifyimg.jpg" width="100%" border=0 /></div><br>
<p class="subtext" style="font-size:12px; line-height:22px;">
...
&nbsp;- 사전취소 요청없이 <span>무단 상담불참시 향후 센터 활동에 불이익</span>을 당할 수 있습니다.<br>
</p>
</div>
...
<div>
	...
	<p style="margin:0; padding:10px 0px 5px 0px; font-size:15px;">■ 예약자 정보 조회</p>
	<div style="position:relative; margin-left:1%; width:98%;">
	<ul style="position:relative; margin:0; padding:0px 0px; list-style:none; text-decoration:none;">
		<li style="float:left; margin-left:-1px; width:30%; height:25px; line-height:25px; border:1px solid #3a8476; border-right:0px; background:#3a8476;"><label style="padding-left:10px; font-size:13px; color:#ffffff;">학생명</label></li>
		<li style="float:left; margin-left:-1px; width:70%; height:25px; line-height:25px; border:1px solid #3a8476; border-left:0px;">
			<input type="text" name="b_name" value="" style="width:70%; margin-left:10px; border:1px solid #ccc;" />
		</li>
		<li style="float:left; margin-left:-1px; margin-top:-1px; width:30%; height:25px; line-height:25px; border:1px solid #3a8476; border-right:0px; background:#3a8476;"><label style="padding-left:10px; font-size:13px; color:#ffffff;">학생연락처</label></li>
		<li style="float:left; margin-left:-1px; margin-top:-1px; width:70%; height:25px; line-height:25px; border:1px solid #3a8476; border-left:0px;">
			<input type="tel" name="b_tel" value="" style="width:70%; margin-left:10px; border:1px solid #ccc; IME-MODE:disabled;" onkeypress="return chkNum(event);" onKeyDown="onOnlyNumber(this);" />
		</li>
	</ul>
	</div>
