...
<meta name="viewport" content="user-scalable=yes, initial-scale=0.3, maximum-scale=1.0, minimum-scale=0.3, width=device-device-dpi" />
...
<link rel="stylesheet" type="text/css" href="<?php echo G5_CSS_URL; ?>/owl.carousel.css" />
<link rel="stylesheet" type="text/css" href="<?php echo G5_CSS_URL; ?>/owl.theme.css" />
<link rel='stylesheet prefetch' href='http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css'>
<link rel="shortcut icon" href="<?php echo G5_IMG_URL; ?>/favicon.ico"/>
<?php
...
if(G5_IS_MOBILE) {
    ...
    echo '<script src="'.G5_JS_URL.'/mobile_smenu.js"></script>'.PHP_EOL; 
}
if(!defined('G5_IS_ADMIN'))
