...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <ul id="tnb">
            ...
            <?php if ($is_member) {  ?>
            <?php if ($is_admin) {  ?>
            <li class="login"><a href="./adm/newwinlist.php"><strong>팝업관리</strong></a></li>
            <?php }  ?>
    ...
    <ul>
        ...
        <li class="d1">
            ...
            <ul class="d2">
				...
				<li><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk04">꿈을 만나는 인문학 캠프</a></li>
                <li><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk05">꿈을 실현하는 진로·진학 컨설팅</a></li>
			    <li><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk08">퓨처트리 미래교육</a></li>
                <li><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk07">직업세계체험동아리 양산미래IN</a></li>							
                <li><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk01">진로상담 '한걸음'</a></li>
                <li><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk06">진학 멘토링 '수시 All kill'</a></li>
                <li><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk02">진로·진학 박람회</a></li>
			</ul><!--.d2-->
        </li><!--.d1-->
		
		
        <li class="d1">
            <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_rang01" class="m">교육연수 · 세미나</a>
            <ul class="d2">
                <li><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_rang01">교원연수</a></li>
                <li><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_rang02">진로 체험 멘토단 연수</a></li>
...
$(".gnb").mouseover(function(){
	$(".subBg").stop().animate({height:220},100)
}).mouseout(function(){
        ...
        <? }else if($bo_table == "" || $co_id == ""){ ?>
            ...
            <div id="container">
                ...
                <div id="left">
                        ...
                        <? } else if ($co_id == "pro_jung03" || $co_id == "pro_tuk01" || $co_id == "pro_tuk02" || $co_id == "pro_tuk03" || $co_id == "pro_tuk04" || $co_id == "pro_tuk05" || $co_id == "pro_tuk06" || $co_id == "pro_tuk07"  || $co_id == "pro_tuk08"){ // 특색 프로그램 ?>
                           <dl>
                                <dt>특화사업</dt>
								  ...
								  <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk04"><dd>꿈을 만나는 인문학 캠프</dd></a>
								  <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk05"><dd>꿈을 실현하는 진로·진학 컨설팅</dd></a>
								  <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk08"><dd>퓨처트리 미래교육</dd></a>
								  <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk07"><dd>직업세계체험동아리 양산미래IN</dd></a>						
								  <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk01"><dd>진로상담 '한걸음'</dd></a>
								  <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk06"><dd>진학 멘토링 '수시 All kill'</dd></a>
								  <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_tuk02"><dd>진로·진학 박람회</dd></a>
                           </dl>
						   
                        <? } else if ($co_id == "pro_rang01" || $co_id == "pro_rang02" || $co_id == "pro_rang03" ){ // 역량강화 프로그램 ?>
                           <dl>
                                <dt>교육연수·세미나</dt>
                                <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_rang01"><dd>교원연수</dd></a>
                                <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_rang02"><dd>진로 체험 멘토단 연수</dd></a>
                                <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=pro_rang03"><dd>직원연수</dd></a>
                           </dl>
                        ...
                        <? } else if ($co_id == "job" || $bo_table == "exp" || $co_id == "maching"){ // 꿈길 직업체험처 ?>
                           <dl>
                                ...
                                <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=maching"><dd>진로직업체험</dd></a>
