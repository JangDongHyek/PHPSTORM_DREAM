...
$(function() {
    ...
    $(document).on("click", "#add_manual", function() {
        ...
        add_submenu_list(sm_name, sm_link, sm_tid, "<?php echo $code; ?>");
    });
...
function add_submenu_list(name, link, sm_tid, code)
{
	...
	list += "<input type=\"hidden\" name=\"sm_type[]\" value=\""+sm_type+"\">";
	list += "<input type=\"hidden\" name=\"sm_tid[]\" value=\""+sm_tid+"\">";
