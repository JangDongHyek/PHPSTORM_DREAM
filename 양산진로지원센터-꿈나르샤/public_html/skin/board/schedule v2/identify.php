...
?>
	...
	?>
	<form method="post" name="book_form" action="./board.php?bo_table=<?php echo $bo_table; ?>&mode=identify">
		...
		<div style="margin:0; padding-bottom:15px;">
			...
			<input type="submit" style="float:right; padding:4px 8px; background-color:#eb4b3e; color:#fff; border:1px solid #eb4b3e;" value="예약취소" />
			
			<input type="button" style="float:right; padding:4px 8px; background-color:#eb4b3e; color:#fff; border:1px solid #eb4b3e;margin-right:3px" value="수정하기" onclick="location.href='./board.php?bo_table=counsel&b_wr_id=<?=$b_wr_id?>&mode=book&w=u&b_idx=<?=$row[b_idx]?>';"/>
			...
			<tr>
				<th style="margin:0; padding:4px 4px; width:15%; border:1px solid #d1dee2; background-color:#e5ecef; font-weight:bold;"><label>학생명</label></th>
			...
			<tr>
				...
				<td style="margin:0; padding:4px 4px; width:35%; border:1px solid #d1dee2; background-color:#ffffff;"><?php if($row['b_class'] != ''){ echo $row['b_class']; } ?></td>
			</tr>
			<tr>
				<th style="margin:0; padding:4px 4px; width:15%; border:1px solid #d1dee2; background-color:#e5ecef; font-weight:bold;"><label>학생연락처</label></th>
