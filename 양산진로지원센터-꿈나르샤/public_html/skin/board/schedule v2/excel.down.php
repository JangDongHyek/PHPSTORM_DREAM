...
<tr>
	...
	<td style="margin:0; padding:5px 5px; border:1px solid #000; text-align:center; font-weight:bold; background-color:#dbdbdb;">학부모성함</td>
	<td style="margin:0; padding:5px 5px; border:1px solid #000; text-align:center; font-weight:bold; background-color:#dbdbdb;">학부모연락처</td>
</tr>
</thead>
<tbody>
<?php
...
<tr>
	...
	<td style="margin:0; padding:5px 5px; border:1px solid #000; text-align:center;mso-number-format:\@;"><?php echo $row['b_tel']; ?></td>
	<td style="margin:0; padding:5px 5px; border:1px solid #000; text-align:center;"><?php echo $row['b_email']; ?></td>
	<td style="margin:0; padding:5px 5px; border:1px solid #000; text-align:center;"><?php echo $row['b_parent_name']; ?></td>
	<td style="margin:0; padding:5px 5px; border:1px solid #000; text-align:center;mso-number-format:\@;"><?php echo $row['b_parent_tel']; ?></td>
</tr>
<?php
	}
}
