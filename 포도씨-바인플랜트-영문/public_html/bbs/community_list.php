...
<div id="area_community">
	<div id="sub_bn">
		<div class="txt">
			...
			<a href="<?php echo G5_BBS_URL ?>/community_write.php"><span>Create a post</span></a>
		</div>
	...
	<div class="community_cate">
		<div class="inr v3">
			<ul class="list_cate">
                <li><a <?php echo $op == '' ? 'class="active"' : ''; ?> href="<?php echo G5_BBS_URL ?>/community.php">All</a></li>
                <li><a <?php echo $op == 'tab1' ? 'class="active"' : ''; ?> href="<?php echo G5_BBS_URL ?>/community_list.php?op=tab1">Tips</a></li>
                <li><a <?php echo $op == 'tab2' ? 'class="active"' : ''; ?> href="<?php echo G5_BBS_URL ?>/community_list.php?op=tab2">Casual talk</a></li>
                <li><a <?php echo $op == 'tab3' ? 'class="active"' : ''; ?> href="<?php echo G5_BBS_URL ?>/community_list.php?op=tab3">Company/on-site stories</a></li>
                <li><a <?php echo $op == 'tab4' ? 'class="active"' : ''; ?> href="<?php echo G5_BBS_URL ?>/community_list.php?op=tab4">Maritime industry news</a></li>
			</ul>
			<div class="box_sch">
			...
			<div class="tab_container">
				<div class="tab_content">
					<div class="top_filter">
						<span class="view">Total <span class="blue"><?=number_format($total_count)?></span></span>
						<ul class="sort_list">
                            <li class="selected"><span>By Latest</span></li>
							<li><span>By Popularity</span></li>
						</ul>
						<div class="msort_list">
							<span data-toggle="modal" data-target="#listModal">By Latest</span>
						</div>
					</div>
