...
<li>
    ...
    <!-- 댓글 수정 삭제 -->
    <ul class="edit">
        <li class="modify"><a href="javascript:reply_action_info(<?=$helpme_an_idx?>, <?=$reply['idx']?>, '<?=$reply['contents']?>');">Edit</a></li>
        <li class="delete"><a href="javascript:reply_action(<?=$helpme_an_idx?>, 'd', <?=$reply['idx']?>);">Delete</a></li>
    </ul>
    <!-- //댓글 수정 삭제 -->
    <?php } ?>
</li>
