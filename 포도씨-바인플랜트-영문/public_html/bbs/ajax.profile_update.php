...
if($mode == 'profile01') { //회원소개
    ...
    $sql = " update g5_member set mb_nick = '{$mb_nick}', mb_introduce = '{$mb_introduce}', mb_si = '{$mb_si}', mb_img_idx = '{$img_idx}', profile_updatetime = '".G5_TIME_YMDHIS."' where mb_id = '{$member['mb_id']}' ";
    ...
    $sql_common = " mb_education = '{$mb_education}', profile3_open = '{$profile3_open}' ";
