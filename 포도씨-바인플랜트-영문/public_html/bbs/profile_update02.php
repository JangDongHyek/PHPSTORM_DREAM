                ...
                <div id="join_info">
                    ...
                    <div class="profile_content">
						...
						<div class="box_private">
							...
							<h5>Make work history public</h5>
						</div>

                        <!-- 클릭했을때 클래스 checked 추가 / 삭제 -->
                        <div class="area_check" id="free_check" onclick="free_check();">
                            <span>Please check here box if you're a freelancer.</span>
                        ...
                        <dl class="row">
                            ...
                            <dd>
                                <div class="input">
                                    <input type="text" id="mb_company" name="mb_company" value="<?=$member['mb_company']?>" class="regist-input no_free" required placeholder="E.g.) Podosea">
                                </div>
                            </dd>
                        </dl>
                        <dl class="row">
                            ...
                            <dd>
                                <div class="input">
                                    <input type="text" id="mb_department" name="mb_department" value="<?=$member['mb_department']?>" class="regist-input no_free" required placeholder="E.g.) Development Team">
                                </div>
                            </dd>
                        </dl>
                        <dl class="row">
                            ...
                            <dd>
                                <div class="input">
                                    <input type="text" id="mb_position" name="mb_position" value="<?=$member['mb_position']?>" class="regist-input no_free" required placeholder="E.g.) Staff">
                                </div>
                            </dd>
                        </dl>
                        <!-- // 프리랜서 체크 했을때 입력안되게 해주세여~ -->
                        ...
                        <div class="area_btn">
                            <a href="javascript:void(0);" class="btn_prev"><span onclick="pre_move('update01');"><em class="pc">Return to </em>previous step</span></a>
                            <!-- input 다작성하면 a class="active" 추가 -->
                            <?php if($skip_flag) { ?>
                            <a href="<?php echo G5_BBS_URL ?>/profile_update03.php" class="btn_next active">Next</a>
                            <?php } else { ?>
