    ...
    <form id="fcareer" name="fcareer" method="post" autocomplete="off" action="<?=G5_BBS_URL?>/career_write_update.php">
        ...
        <div class="inr v3">
            ...
            <div class="w_filter career">
                ...
                <div class="area_tag">
                    <input type="text" class="input_tag" id="input_tag" placeholder="#질문에 맞는 태그를 입력해 주세요(엔터로 구분, 최대 5개)" onkeyup="add_hash(this);lengthChk(this);">
                    <ul class="tag_list">
                    <?php
...
<script>
    $(function() {
        ...
        // 수정
        if($('#w').val() == 'u') {
            $('#editor').summernote('code', $("textarea[name=cr_contents]").val());
        }
    });
