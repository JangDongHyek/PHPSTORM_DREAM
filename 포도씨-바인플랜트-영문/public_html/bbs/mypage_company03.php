            ...
            <div class="mypage_cont">
                <div class="box">
                    ...
                    <ul id="snb">
                        ...
                        <li><a class="active" href="<?php echo G5_BBS_URL ?>/mypage_company03.php">RFQ Received</a></li>
                    </ul>
                    <div class="box_cont">
						...
						<!-- 삭제버튼 -->
                        <div class="btn_box">
                            <input type="button" value="Delete Selected" onclick="myInquiryDelete('company03');">
                        </div>
                    </div>
                </div>
            </div>
