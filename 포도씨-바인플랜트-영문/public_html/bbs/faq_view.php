...
if($faq['category'] == 'General member FAQ') {
    $g = 'm';
} else if($faq['category'] == 'Podosea member FAQ') {
    $g = 'c';
} else {
    $g = '';
}
	...
	<div class="inr v3">
			...
			<div class="help_question top">
				<div class="title">
                    ...
                    <ul class="edit_list edit_list_q" style="display: none;">
                        <li class="modify"><a href="<?=G5_BBS_URL?>/faq_write.php?idx=<?=$faq['idx']?>&w=u">Edit</a></li>
                        <li class="delete"><a href="javascript:faqDel();">Delete</a></li>
                    </ul>
				</div>
				<div class="bottom">
					<div class="cont">
		...
		<div id="area_popular">
			...
			<div class="area_write">
				<a href="<?php echo G5_BBS_URL ?>/faq_write.php"><span>Write</span></a>
			</div>
            <?php } ?>
			...
			<div class="list_best">
				...
				<ul>
					...
					<li><a href="javascript:;"><?=$faq['category']?><br>What are you curious about?</a></li>
                    <?php
                    $rlt = sql_query(" select * from g5_cs_faq where 1=1 and category = '{$faq['category']}' order by idx asc limit 10 ");
		...
		<div class="area_btn"><a class="btn_list" href="faq_list.php?g=<?=$g?>"><span>List</span></a></div>
