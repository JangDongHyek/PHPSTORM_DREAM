                ...
                <div id="join_info">
                    ...
                    <div class="profile_content">
                        <dl class="row add first">
                            <dt>Brands and Services we Handle<em>*optional</em><button type="button" onclick="add('goods');">+Add</button></dt>
                            <dd>
                                <div class="input">
                                    <ul class="catalog_list goods_list">
                                        ...
                                        <li class="goods_1">
                                            ...
                                            <input type="text" id="mb_goods_1" name="mb_goods[]" class="regist-input goods" placeholder="Enter Brands and Services">
                                        </li>
                                        <?php } ?>
                                        <?php
                                        ...
                                        <li class="goods_<?=$i+1?>">
                                            ...
                                            <input type="text" id="mb_goods_<?=$i+1?>" name="mb_goods[]" value="<?=$mb_goods[$i]?>" class="regist-input goods" placeholder="Enter Brands and Services">
                                        </li>
                                        <?php
                                            }
                                        }
                        ...
                        <dl class="row add">
                            <dt>Brands<em>*optional</em><button type="button" onclick="add('brand');">+Add</button></dt>
                            <dd>
                                <div class="input">
                                    <ul class="catalog_list brand_list">
                                        ...
                                        <li class="brand_1">
                                            ...
                                            <input type="text" id="mb_brand_1" name="mb_brand[]" class="regist-input brand" placeholder="Enter Brand">
                                        </li>
                                        <?php } ?>
                                        <?php
                                        ...
                                        <li class="brand_<?=$i+1?>">
                                            ...
                                            <input type="text" id="mb_brand_<?=$i+1?>" name="mb_brand[]" value="<?=$mb_brand[$i]?>" class="regist-input brand" placeholder="Enter Brand">
                                        </li>
                                        <?php
                                            }
                                        }
                        ...
                        <div class="area_btn">
                            <a href="javascript:void(0);" class="btn_prev"><span onclick="pre_move('company_update03', '<?=$company?>');">Go to <em class="pc">Previous step</em></span></a>
                            <!-- input 작성하면 다음버튼으로 나오게 해주세요 -->
                            <a href="<?php echo G5_BBS_URL ?>/profile_company_update05.php" class="btn_next active">NEXT</a>
...
<script>
    ...
    function form_check() {
        ...
        $('.home').attr('href', 'javascript:profile_update("company", "profile04", "update05", "", "home");');
    }
    ...
    function add(gubun) {
        ...
        var txt = "";
        if(gubun == 'goods') { num = num1; txt = "Brands and Services" }
        else if(gubun == 'brand') { num = num2; txt = "Brand"}

        var html = '<li class="'+gubun+'_'+num+'"><button type="button" class="btn_close" onclick="del(\''+gubun+'\','+num+');"></button><input type="text" id="mb_'+gubun+'_'+num+'" name="mb_'+gubun+'[]" class="regist-input '+gubun+'" placeholder="Enter '+txt+'" onkeyup="form_check();"></li>';
