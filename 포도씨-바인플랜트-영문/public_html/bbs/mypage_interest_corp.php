...
$name = "cmypage";
$g5['title'] = 'Companies of Interest';
					...
					<div class="box">
						...
						<div class="box_cont">
							<div id="help_list" class="inquiry">
								<ul class="list full">
                                    <?php
                                    $result = sql_query(" select com.*, mb.mb_no, mb.mb_category, mb.mb_company_name, mb.mb_company_introduce, mb.mb_hashtag from g5_like_company as com left join g5_member as mb on mb.mb_id = com.company_mb_id where com.mb_id = '{$member['mb_id']}' and mb.mb_level != 1 order by idx desc ");
                                    $i = 0;
                                    ...
                                    <li class="company">
                                        <a href="<?php echo G5_BBS_URL ?>/company.php?mb_no=<?=$row['mb_no']?>">
                                            ...
                                            <div class="cont">
                                                ...
                                                <div class="list_info">
                                                    <span class="reply">Total Transactions <em>0</em></span>
                                                    <span>Numer of Reviews <em>0</em></span>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nodata full">
                                        <p>There is no companies of interest.</p>
                                    </li>
                                    <?php
                                    }
                                    ?>
