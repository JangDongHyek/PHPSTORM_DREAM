<div id="area_my" class="help">
    ...
    <ul class="my_qna left">
        ...
        ?>
        <li><a href="javascript:void(0);"><?=number_format($q_count)?></a><em>Question</em></li>
        <li><a href="javascript:void(0);"><?=number_format($a_count)?></a><em>Answer</em></li>
        <li><a href="javascript:void(0);"><?=number_format($s_count)?></a><em>Chosen answer</em></li>
    </ul>
