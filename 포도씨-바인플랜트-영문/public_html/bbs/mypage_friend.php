                                    ...
                                    <li class="help_question">
                                        <a href="javascript:;">
                                            ...
                                            <div class="profile_info">
                                                <h4 class="toggle"><?=$row['friend_mb_id']?><?=$cnt > 0 ? '<i class="badge">Mutual friends</i>' : ''; ?></h4><!-- 아이디-->
                                                <div class="list_info">
                                                ...
                                                <ul class="list_<?=$row['idx']?> user_list answer01 sm">
                                                    ...
                                                    <li onclick="likeFriend('<?=$row['friend_mb_id']?>', 'del');">Delete friend</li> <!--친구등록/삭제-->
                                                    <li onclick="chatting('<?=$row['friend_mb_id']?>');">Chat</li>
                                                    <li onclick="reportOpen('<?=$row['mb_id']?>', 'g5_helpme_answer', '<?=$row['idx']?>')">Report</li>
                                                </ul>
                                                <!-- //토글메뉴 -->
                                            </div>
                                            </div>
                                            <button type="button" class="btn_delete" onclick="likeFriend('<?=$row['friend_mb_id']?>', 'del');">Delete</button>
                                        </a>
                                    </li>
