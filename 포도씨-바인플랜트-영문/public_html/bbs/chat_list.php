...
<div id="area_chat">
    <div class="chat_list_wrap">
        ...
        <?php if(!$is_admin) { ?>
        <button type="button" class="btn_confirm violet" onclick="chatting('admin');">Contact Administrator</button>
        <?php } ?>

        <div class="box_sch">
            <form name="fsearch" method="get">
                <input type="text" id="stx" name="stx" placeholder="Search" value="<?=$stx?>"><button type="submit"></button>
            </form>
        </div> <!-- 채팅방 이름 검색 -->
