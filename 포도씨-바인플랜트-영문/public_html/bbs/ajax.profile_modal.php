...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="appModalLabel"><?=getNickOrId($mb['mb_id'])?> PROFILE</h4>
    </div>
            ...
            <div class="myinfo">
                <div class="top_box first_box">
                    <div class="box_wrap">
                        ...
                        <div class="area_nm">
                            <em>My Podosea sea miles</em> <span class="blue"><?=number_format($mb['mb_grade_point'])?>NM</span>
                        </div>
						<div class="ranking">Bunker Ranking : <span class="blue"><?=getRanking($mb['mb_id'])?></span>th</div>
                    </div>
                </div>
                <div class="top_box second_box">
                    <div class="area_box">
                        ...
                        <?php } ?>
                        <?php } else { ?>
                        <div class="nodata"><p>This is non-public information.</p></div>
                        <?php } ?>
                    </div>
                    <div class="area_box">
