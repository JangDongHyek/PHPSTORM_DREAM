    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" name="bo_use_dhtml_editor" value="1" <?php if($board['bo_use_dhtml_editor'] || $w=="") echo 'checked'; ?> id="bo_use_dhtml_editor">
                사용
            </td>
            <td class="td_grpset">
        ...
        <tr>
            <th scope="row"><label for="bo_orderby_level">우선순위 사용</label></th>
            <td>
                <?php echo help('숫자가 높은 게시물 부터 우선 출력합니다.') ?>
				
                <input type="checkbox" name="bo_orderby" value="1" id="bo_orderby" <?php echo $board['bo_orderby']?'checked':''; ?>>
                사용
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_grp_orderby" value="1" id="chk_grp_orderby">
                <label for="chk_grp_orderby">그룹적용</label>
                <input type="checkbox" name="chk_all_orderby" value="1" id="chk_all_orderby">
                <label for="chk_all_orderby">전체적용</label>
            </td>
        </tr>
        </tbody>
        </table>
