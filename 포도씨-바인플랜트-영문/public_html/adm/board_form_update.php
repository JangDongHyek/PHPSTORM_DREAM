...
//2016-03-31 게시판 순서 컬럼추가
$columns = set_columns('bo_orderby', $g5['board_table'], 'int(11)');
...
if (is_checked('chk_grp_orderby'))                $grp_fields .= " , bo_orderby = '{$bo_orderby}' ";
for ($i=1; $i<=10; $i++) {
...
if (is_checked('chk_all_orderby'))              $all_fields .= " , bo_orderby = '{$bo_orderby}' ";
for ($i=1; $i<=10; $i++) {
