...
<div id="menulist" class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?> menu_list menu_group_<?php echo substr($row['me_code'], 0, 2); ?>">
		...
		<td class="td_mng">
			<label for="me_course" class="sound_only">경로<strong class="sound_only"> 필수</strong></label>
            <select name="me_course[]" id="me_course_<?php echo $i; ?>">
                <option value="0" <?php echo get_selected($row['me_course'], '0', true); ?>>절대</option>
                <option value="1" <?php echo get_selected($row['me_course'], '1', true); ?>>상대</option>
            </select>
		</td>
        <td class="td_mng">
