...
$sql_common = " from g5_bunker_withdraw as bw left join g5_member as mb on mb.mb_id = bw.mb_id ";
...
$sql = " select bw.*, mb.mb_name, mb.mb_bunker {$sql_common} {$sql_search} {$sql_order} limit {$from_record}, {$rows} ";
...
<select name="sfl" id="sfl">
    <option value="mb_id"<?php echo get_selected($_GET['sfl'], "bw.mb_id"); ?>>아이디</option>
</select>
...
<div class="tbl_head02 tbl_wrap mb_tbl">
    ...
    <tr>
        <th>No.</th>
        <th><?php echo subject_sort_link('bw.mb_id') ?>아이디</th>
        <th><?php echo subject_sort_link('bw.mb_name') ?>이름</th>
        <th>은행</th>
        <th>계좌번호</th>
        <th>예금주</th>
        <th>주민번호</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td><?=number_format($row['exchange_krw'])?>원</td>
        <td>
