...
?>
    ...
    <div id="hd_pops_<?php echo $nw['nw_id'] ?>" class="hd_pops" style="top:<?php echo $nw['nw_top']?>px;left:<?php echo $nw['nw_left']?>px;">
        ...
        <div class="hd_pops_footer">
            <?
            $rejectMsg = "It will not be viewed again for ".$nw['nw_disable_hours']." hours.";
            $closeMsg = "Close";
            ?>
            <button class="hd_pops_reject hd_pops_<?php echo $nw['nw_id']; ?> <?php echo $nw['nw_disable_hours']; ?>"><strong><?=$rejectMsg?></button>
            <button class="hd_pops_close hd_pops_<?php echo $nw['nw_id']; ?>"><?=$closeMsg?></button>
        </div>
    </div>
<?php }
