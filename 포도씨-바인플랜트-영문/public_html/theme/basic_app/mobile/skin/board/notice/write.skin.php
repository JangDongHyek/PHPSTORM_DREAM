...
<? if($name=="notice") { ?>
	<body<?php echo isset($g5['body_script']) ? $g5['body_script'] : ''; ?> class="notice wt">
<?}?>

<link rel="stylesheet" href="<?=G5_URL?>/css/style.css?v=<?= G5_CSS_VER ?>">

<?php include_once('top_visual.php'); ?> 

<div id="area_community" class="write notice">
<div class="inr v3">
...
<div id="help_list" class="write">	
    ...
    if ($is_notice || $is_html || $is_secret || $is_mail) {
        $option = '';
        if ($is_notice) {
            $option .= PHP_EOL.'<input type="checkbox" id="notice" name="notice" value="1" '.$notice_checked.'>'.PHP_EOL.'
			<label for="notice">
				<span></span>
				<em>Notice</em>
			</label>';
	...
	<?php if ($option) { ?>
		<div class="w_filter">
			<h3>Notice</h3>
			<ul class="area_filter"><li><?php echo $option ?></li></ul>
		</div>
	 <?php } ?>

	<div class="help_write">
		<div class="title">
			<h3><input type="text" class="subject" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" placeholder="Enter title."> </h3>
		</div>

		<div class="bottom wr_content" >
	...
	<div class="w_filter">
		...
		<ul class="area_filter">
			<li>
				<input type="checkbox" id="private" name="co_open" value="private" <?php echo $comm['co_open'] == 'private' ? 'checked' : ''; ?> onclick="checkOnlyOne(this);">
				<label for="private">
					<span></span>
					<em>익명으로 등록하기</em>
				</label>
	...
	<button type="button" class="btn_confirm fixed" ><하기</button>
	-->
	<!--
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" id="bf_file_del<?php echo $i ?>" name="bf_file_del[<?php echo $i; ?>]" value="1"> <label for="bf_file_del<?php echo $i ?>"><?php echo $file[$i]['source'].'('.$file[$i]['size'].')'; ?> 파일삭제</label>
                <?php } ?>
            </td>
        </tr>
        <?php } ?>
    ...
    <div class="btn_confirm">
        <input type="submit" value="Completed" id="btn_submit" class="btn_submit" accesskey="s">
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_cancel">Cancle</a>
    </div>
    </form>
	</div>
</section>
