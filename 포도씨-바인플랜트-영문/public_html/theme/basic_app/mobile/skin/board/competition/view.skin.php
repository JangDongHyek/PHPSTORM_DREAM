...
<article id="bo_v" style="width:<?php echo $width; ?>">
  ...
  <!--   <?php if($cnt) { ?>
    ...
    <div id="bo_v_top" class="btn_bo_user btn_add01 btn_add">
        <?php
        ob_start();
         ?>
        <?php if ($prev_href || $next_href) { ?>
        <?php /*?><ul class="bo_v_nb">
    ...
    <section id="bo_v_atc">
		...
		*/
		...
		<dl>
        	<dt>주소</dt>
            <dd><?php echo $view['wr_content']. $view['wr_3'] ?></dd>
        </dl>        
