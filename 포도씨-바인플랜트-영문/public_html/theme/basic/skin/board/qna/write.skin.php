...
<section id="bo_w">
	...
	<? if(!$is_admin){?>
    <div class="agree">
    	<h2><i class="fas fa-check-circle"></i> 개인정보수집동의</h2>
        <div class="txt">
          <strong>1. 개인정보의 수집&middot;이용 목적</strong> <br>
           - 서비스 제공 및 계약의 이행 등을 목적으로 개인정보를 처리합니다.<br>
          <strong>2. 수집하려는 개인정보의 항목</strong> <br>
           - 이름, 이메일 등 <br>
          <strong>3. 개인정보의 보유 및 이용 기간</strong> <br>
           - 병원은 개인정보 수집 및 이용목적이 달성된 후에는 예외없이 해당정보를 파기합니다.
        </div>
        <div class="agree_ch">
