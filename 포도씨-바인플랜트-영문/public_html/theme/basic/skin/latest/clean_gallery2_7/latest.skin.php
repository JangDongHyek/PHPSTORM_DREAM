...
#border {border:1px solid #DFDFDF; height:auto; min-height:240px;}
...
/*추출금액/대지*/
.motel_area{margin-left:10px; margin-top:6px; line-height:1.8em; font-size:1.1em; color:#666;}
.motel_price{margin-left:10px; color:#2c8cc5; font-size:1.3em; font-weight:bold; }
.motel_price span{display: inline-block; margin-right:4px; width:25px; font-weight:normal;letter-spacing:1.2px; background:#079df6; font-size:0.72em; color:#fff; padding:1px 5px 3px 5px; text-align:center; border-radius:2px;}



#oneshot_2_7 ul {list-style:none;clear:both;margin:0;padding:0;}
/*이미지 좌우간격*/
#oneshot_2_7 li {list-style:none;float:left;text-decoration:none;padding:0px 9px 0px 9px}
...
<div id="border">
			...
			<div class="subject_set">
                ...
                <div class="motel_area">대지 : <?php echo $list[$i]['wr_4'] ?>㎡ / 건물 : <?php echo $list[$i]['wr_5'] ?>㎡</div>
                <div class="motel_price"><span>금액</span><?php echo $list[$i]['wr_6'] ?></div>
...
<span style="font-size:12px;font-weight:bold;"><font color="#CC6633"><?=$list[$i]["good"]?></font></span>-->
				...
				<?=cut_str(strip_tags($list[$i]['wr_content']), 100, '..')?></div>*/?>
