...
<section id="anc_cf_join">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="cf_matching">소개팅 관련정보수신 동의</label></th>
            <td colspan="3"><textarea id="cf_matching" name="cf_matching" rows="10"><?php echo $config['cf_matching'] ?></textarea></td>
        </tr>
        </tbody>
        </table>
    </div>
