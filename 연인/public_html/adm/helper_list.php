...
$sql_search = " where mb_level = 10 AND mb_status = '헬퍼' AND mb_3 != 'out' ";
...
<div class="btn_add01 btn_add">
    <a href="./helper_form.php" id="member_add">헬퍼등록</a>
</div>
<? } ?>
...
<div class="tbl_head02 tbl_wrap mb_tbl">
    ...
    if ($i == 0)
        echo "<tr><td colspan='10' class=\"empty_table\">조회된 헬퍼가 없습니다.</td></tr>";
    ?>
    </tbody>
    </table>
</div>
...
function fnHelperDel() {
	...
	if (confirm('선택하신 헬퍼를 삭제하시겠습니까?') == true) {
		$.ajax({  
			type : "post",  
