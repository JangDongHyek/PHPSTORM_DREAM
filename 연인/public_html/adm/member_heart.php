...
?>
    ...
    <script>
        ...
        function changeHeart(f) {
            ...
            if (!confirm("포인트를 변경하시겠습니까?")) return false;
        ...
        <div class="tbl_head02 tbl_wrap">
            ...
            <form method="post" onsubmit="return changeHeart(this)" autocomplete="off">
                ...
                <table id="ht_tbl">
                    ...
                    <tbody>
                    <tr>
                        <td><?=number_format($mb_heart)?>P</td>
                        <td><input type="text" name="new_heart" class="frm_input f_num2" value="" size="10" required> P</td>
                    </tr>
                    </tbody>
                </table>
