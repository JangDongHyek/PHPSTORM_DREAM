...
<link rel="stylesheet" href="<?=G5_THEME_CSS_URL?>/font.css"><!--폰트-->
...
<link rel="stylesheet" href="<?=G5_THEME_CSS_URL?>/main.css?ver=<?=G5_CSS_VER?>"><!--메인-->
<link rel="stylesheet" href="<?=G5_THEME_CSS_URL?>/sub.css?ver=<?=G5_CSS_VER?>"><!--서브-->
<link rel="stylesheet" href="<?=G5_CSS_URL?>/board.css?ver=<?=G5_CSS_VER?>"><!--게시판공통-->
<link rel="stylesheet" href="<?=G5_THEME_CSS_URL?>/common.css"><!--공통-->

    <link rel="stylesheet" href="<?=G5_THEME_CSS_URL?>/new.css?ver=<?=G5_CSS_VER?>"><!--24.01 new-->
    <!-- Swiper  -->
...
<?php /*?><script src="<?php echo G5_THEME_JS_URL ?>/jquery.menu.js"></script><!--상단메뉴(pc및모바일) 및 그외 JS추가부분--><?php */?>
