...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr style="text-align:center;">
            ...
            <?php } ?>
            <td>
				<a href="<?php echo $list[$i]['href'] ?>"><?=$list[$i]['wr_subject']?></a>
				<? if ($comment_cnt > 0) { ?><strong style="font-size:0.9em;">(<?=$comment_cnt?>)</strong><? } ?>
        ...
        <?php } ?>
        <?php if (count($list) == 0) { echo '<tr><td colspan="7" class="empty_table">등록된 글이 없습니다.</td></tr>'; } ?>
        </tbody>
        </table>
    </div>
