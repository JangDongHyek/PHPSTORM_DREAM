...
<fieldset id="bo_sch">
    ...
    <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="frm_input sch_input required" placeholder="검색어를 입력해주세요" style="border:0px !important; background:#fff0 !important;outline-style: none;">
...
<div id="bo_list" style="width:<?php echo $width; ?>">
	...
	*/ ?>
        ...
        <p class="b_write"><a href="<?php echo G5_BBS_URL ?>/write.php?bo_table=b_event">글쓰기</a></p>
    <!-- 게시판 페이지 정보 및 버튼 시작 { -->
    <div class="bo_fx">
    ...
    <div class="tbl_head01 tbl_wrap">
		...
		<tr style="text-align:center;">
			...
			<td style="text-align:left;">
				<a href="<?php echo $list[$i]['href'] ?>"><!--<strong>[<?php echo $list[$i]['ca_name'] ?>]</strong>--><?php echo $list[$i]['subject'] ?> <? if (isset($list[$i]['icon_new'])) echo $list[$i]['icon_new']; ?></a>
			</td>
