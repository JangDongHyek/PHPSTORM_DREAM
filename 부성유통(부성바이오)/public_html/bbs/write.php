...
//		$rg_reply_mail 
		...
		if($bbs_id == "flash"){
			...
			if($tot_cot > 100){
				rg_href("list.php?bbs_id=$bbs_id&ss[fc]=$rg_cat_num","100개까지만 등록이 가능합니다");
			}
...
*/
		...
		switch($bbs[bbs_act_after]){
			case '' : 
			case '0' : 
					rg_href("list.php?$p_str&page=$page&bbs_id=$bbs_id&doc_num=$rg_doc_num&ss[fc]=$rg_cat_num");
					break;
			case '1' : 
					rg_href("view.php?$p_str&page=$page&bbs_id=$bbs_id&doc_num=$rg_doc_num&ss[fc]=$rg_cat_num");
					break;
			default : 
