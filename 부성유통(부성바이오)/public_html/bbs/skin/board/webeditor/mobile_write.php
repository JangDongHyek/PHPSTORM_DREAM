...
<?=$show_upload_begin?>
	<div class="bbs_write">
		...
		<span class="bbs_write_form">
			<input name='rg_file1' type=file style=width:80%;height:22; class=b_input id="rg_file1"  itemname='파일 #1' onclick="javascript:prepareForPicker();"> 
	...
	<div class="bbs_write">
		...
		<span class="bbs_write_form">
			<input  name='rg_file2' type=file style=width:80%;height:22; class=b_input id="rg_file2"  itemname='파일 #2' onclick="javascript:prepareForPicker();">
	...
	<?=$show_upload_end?>
	<span class="bbs_write_new"><span class="button large"><input type="submit" value="글쓰기"></span> &nbsp; <span class="button large"><a href="javascript:history.back()" onfocus=this.blur()>취소</a></span>
</form>
