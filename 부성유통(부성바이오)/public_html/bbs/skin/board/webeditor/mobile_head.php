...
<!--// 탑메뉴-->
<!--2DEPTH MENU -->
<?if($bbs_id == "noticee" || $bbs_id == "qnaa"){?>
<div class="subm2">
		<dl>
		 <dd><a href="../bbs/mobile_list.php?bbs_id=noticee" <?if($bbs_id == "noticee"){?>class="on"<?}?>>공지사항</a></dd>
		 <dd><a href="../bbs/mobile_list.php?bbs_id=qnaa" <?if($bbs_id == "qnaa"){?>class="on"<?}?>>자주하는 질문</a></dd>
 		</dl>
</div>
<?}?>
<!--    <div class="subm3">
            <dl>
                ...
                <dd><a href="../mobile/s2_2.htm">XH+핵산</a></dd>
                <dd><a href="../mobile/s2_3.htm">건강한피부&amp;예쁜몸매</a></dd>
            </dl>
    </div>
    <div class="subm3">
            <dl>
                <dd><a href="../bbs/mobile_list.php?bbs_id=pro_gal02">핵산과 건강</a></dd>
    ...
    <div class="subm">
            <dl>
                <dd><a href="../bbs/mobile_list.php?bbs_id=pro_gal01" class="on">핵산 동영상 자료</a></dd>
            </dl>
    </div>
-->
<!--//2DEPTH MENU -->
