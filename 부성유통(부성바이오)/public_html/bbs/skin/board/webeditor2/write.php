			...
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    ...
					    <TD bgcolor="#fafafa">
							<?
								$rg_cat_num?$rg_cat_num=$rg_cat_num:$rg_cat_num=$ss[fc];
								$bbs_category="rg_".$bbs_id."_category";
								$sql="select * from $bbs_category where cat_num='$rg_cat_num'";
...
<?=$show_upload_begin?>
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR>
                        <TD width=131 align=right valign="top" bgColor=#fafafa class="bbs" style="padding-top:5px">첨부화일 #1<B>&nbsp;&nbsp; </B></TD>
		...
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    <TD width=131 align=right valign="top" bgColor=#fafafa class="bbs" style="padding-top:5px">첨부화일 #2<B>&nbsp;&nbsp; </B></TD>
					    <TD align=left class="bbs" bgcolor="#fafafa"> 
