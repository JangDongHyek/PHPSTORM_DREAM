...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="37" valign="top" background="images/line.gif" style="padding-top:12">&nbsp;<img src="images/t06.gif" width="65" height="13"></td>
  </tr>
</table>
<br>
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
...
<input name="act" type="hidden" value="ok">
  <tr> 
    <td width="200" height="34"><span style="font-size:10pt;"> 상태 : 
...
?>
    ...
    <td align="right"><span style="font-size:10pt;">검색:</span> <select name="ss[0]" id="ss[0]">
        <?
	$ss_list = array("질문");
	while(list($key,$value)=each($ss_list)) {
    if ($key==$ss[0])
