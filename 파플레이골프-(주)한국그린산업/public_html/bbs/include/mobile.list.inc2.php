<?
  ...
  $order_str='';
	...
	include($skin_board_path."mobile_list_head2.php");
	$dbqry="
		SELECT `$bbs_table`.*,
	...
	// 스킨 체크
	$bbs_notice_skin_file = "mobile_list_main2.php";
	$bbs_secret_skin_file = "mobile_list_main.php";
	$bbs_current_doc_skin_file = "mobile_list_main2.php";
	$bbs_deleted_skin_file = "mobile_list_main2.php";


	if (file_exists($skin_board_path."mobile_list_notice2.php")) 
    $bbs_notice_skin_file = "mobile_list_notice2.php";
	if (file_exists($skin_board_path."mobile_list_secret2.php")) 
    $bbs_secret_skin_file = "mobile_list_secret2.php";
	if (file_exists($skin_board_path."mobile_list_current2.php")) 
    $bbs_current_doc_skin_file = "mobile_list_current2.php";
	if (file_exists($skin_board_path."mobile_list_delete2.php")) 
    $bbs_deleted_skin_file = "mobile_list_delete.php";
	...
	while ($data=mysql_fetch_array($rs)) {
		...
		if($skin[list_view]) {
			// 글보기 해석
			include("{$site_path}include/mobile.view.inc.php");
		} else {
		...
		if($rg_doc_num == $current_doc_num) { // 현재글 
			...
			include($skin_board_path."mobile_list_main2.php");
		}
	}

	include($skin_board_path."mobile_list_foot2.php");
?>	
