		...
		<td>
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					if($book == "1379430000"){
						$sql="SELECT * FROM $bbs_category LIMIT 0,73";
					}elseif($book == "1379602800"){
						$sql="SELECT * FROM $bbs_category WHERE cat_num>='27'  limit 0,73";
					}else{
						$sql="select * from $bbs_category where 1 order by cat_order asc limit 0,73";
					}
