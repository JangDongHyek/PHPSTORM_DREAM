...
<TR> 
	...
	<TR height=26 bgcolor=#477816>
		<TD width=40 align=middle class="bbs"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><img src="<?=$skin_board_url?>images/bbs_title01.gif" /></td>
		...
		<TD align=middle class="bbs"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center"><img src="<?=$skin_board_url?>images/bbs_title02.gif"/></td>
              <td width="1" align="right"><img src="<?=$skin_board_url?>images/bar03.gif" /></td>
            </tr>
          </table></TD>
		<TD width=80 align=middle class="bbs"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center"><img src="<?=$skin_board_url?>images/bbs_title10.gif"/></td>
              <td width="1" align="right"><img src="<?=$skin_board_url?>images/bar03.gif" /></td>
            </tr>
          </table></TD>
		<TD width=80 align=middle class="bbs"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<TD width=50 align=middle class="bbs"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><font color="#000000"><img src="<?=$skin_board_url?>images/head_down.gif"/></font></td>
            <td width="1" align="right"><img src="<?=$skin_board_url?>images/bar03.gif" /></td>
          </tr>
        </table>
		  <?=$show_download_end?>
		...
		<TD width=50 align=middle class="bbs"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center"><font color="#000000"><img src="<?=$skin_board_url?>images/bbs_title04.gif" /></font></td>
