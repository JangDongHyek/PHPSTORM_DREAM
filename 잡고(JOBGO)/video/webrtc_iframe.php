...
<header id="header">
            ...
            <div class="logout_wrap">
                <span class="user_name">홍닥터</span> 선생님, 반갑습니다.
...
<div id="remote_treat" class="container">
    <div id="btn-change" style="display: none" onclick="videoChange('environment')"></div>
    <!-- 내 카메라 -->
    <div id="draggable">
    </div>
    <!-- 상대방 카메라 -->
    <div class="screen" id="youVideo">
        <a class="btn blue large">입장하기</a>
    </div>
    ...
    <!--<div class="btn_set">
        ...
        <button><img src="img/hospital/btn_hang_up.svg"></button>
    </div>-->
</div>
