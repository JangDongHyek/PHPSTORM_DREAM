...
$sql = " select me.* from new_recommend re right join {$g5['member_table']} me on re.register_mb_id =  me.mb_id where re.mb_id='$member[mb_id]' order by re.recom_idx desc";
$re_result = sql_query($sql);


$cnt  = sql_num_rows($re_result);



include_once($member_skin_path.'/my_suggest_list.skin.php');
