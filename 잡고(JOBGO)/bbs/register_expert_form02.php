...
//    alert('잘못된 경로로 접근하셨습니다.', G5_URL.'/index.php');
//}
//
//if ($_SESSION['ss_form1'] == ''){
//    alert('만료된 페이지입니다.',G5_URL);
//}
if ($w == "") {
...
include_once($member_skin_path.'/register_expert_form02.skin.php');
