...
$returnurl = G5_BBS_URL."/nice/register_success.php";		// 성공시 이동될 URL
$errorurl = G5_BBS_URL."/nice/register_fail.php";			// 실패시 이동될 URL
...
// 모듈로드 실패시
if ($returnMsg != "") {
    alert("본인인증 서비스를 불러오는데 실패하였습니다. 다시 시도해 주세요.", G5_URL);
    exit;
}
?>
...
<script>
    ...
    function fnNicePopup(){
        ...
        /*if(user_agent.indexOf('mallcar') > -1) {

            // 1) 앱이면 (안드로이드)
            // var url = g5_bbs_url + '/nice/inapp.php';
