...
<!--                    -->
                    <?php for ($i = 0; $i < count($competition_ctg2); $i ++){ ?>
                        ...
                        <div class="list cf">
                            ...
                            <div class="thm">
                                    <div class="mg">
                                        ...
                                        <div class="heart" id="heart_div_<?=$row['cp_idx']?>">
                                            ...
                                            if (isset($like_row['li_idx'])){ ?>
                                                <button type="button" class="heart on" onclick="like_chk('off',<?=$row['cp_idx']?>,'competition')"><img src="<?php echo G5_THEME_IMG_URL ?>/main/heart_on.png" alt="좋아요on" title="좋아요on"></button><!--좋아요 누른후-->
                                            <?php }else{ ?>
                                ...
                                <div class="info">
                                        ...
                                        <div class="cont"><?= cut_str($row['cp_logo_content'], 170, "…") ?></div><!--공모전 설명(최대2줄까지만 추출, 나머지는 ... 처리함)-->
                                        <div class="rate cf">
...
<script>
    $(document).ready(function() {
        //2차 카테고리 체크해주기
        $('#li_<?=$common_code2[0]['idx']?>').addClass('check');
    });
	//탭메뉴 스크롤 애니메이트
	$(function(){
		$("#bo_cate_on").each(function(){
			var offset = $(this).offset().left;	
			$("#bo_cate_ul").animate({scrollLeft:offset-($(window).width()/2)+40},1000);
