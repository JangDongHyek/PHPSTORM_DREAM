	...
	<div class="tab-content">
	  ...
	  <div role="tabpanel" class="tab-pane active" id="id-find">
		...
		<fieldset id="info_fs">
            ...
            <button onclick="id_send_sms();" class="btn_certi"><i class="fal fa-keyboard"></i> 인증번호 발송</button>
		</fieldset>
          <fieldset id="info_fs">
		...
		<div class="win_btn">
			<button type="button" class="btn03" id="id-btn" style="margin:0 !important">확인</button>
	  ...
	  <div role="tabpanel" class="tab-pane" id="pass-find">
		...
		<div class="win_btn">
			<input type="button" onclick="pw_send_sms()" value="임시비밀번호 발송" class="btn03">
			<button type="button" onclick="javascript:history.back();" class="btn01">뒤로</button>
		</div>
		</form>
	  </div>
