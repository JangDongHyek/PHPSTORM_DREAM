       ...
       <?php /*?> <?php if ($is_email) { ?>
        ...
        <?php } ?>
		 ...
		 <tr>
            ...
            <td><input type="text" name="wr_name" value="<?php echo $wr_content ?>" required id="wr_name" class="frm_input required" ></td>
        </tr>
		 <tr>
            <th scope="row"><label for="wr_1">나이</label></th>
            <td><input type="text" name="wr_1" value="<?php echo $wr_content ?>" required id="wr_1" class="frm_input required" ></td>
        </tr>

		 <tr>
            <th scope="row"><label for="wr_2">성별</label></th>
            <td>
				<input type="radio" name="wr_2" value="남성"  required  checked class="frm_input required" > 남성
				&nbsp
				<input type="radio" name="wr_2" value="여성"  required   class="frm_input required" > 여성
			</td>
        </tr>
				 <tr>
            <th scope="row"><label for="wr_2">결혼</label></th>
            <td>
				<input type="radio" name="wr_3" value="초혼"  required  checked class="frm_input required" > 초혼
				&nbsp
				<input type="radio" name="wr_3" value="재혼"  required  class="frm_input required" > 재혼
			</td>
        </tr>

		<tr>
            <th scope="row"><label for="wr_content">거주지</label></th>
            <td><input type="text" name="wr_content" value="<?php echo $wr_content ?>" required id="wr_content" class="frm_input required" ></td>
        </tr>
        ...
        <tr>
	     ...
	     <tr>
            <th scope="row"><label for="wr_email">이메일</label></th>
            <td><input type="text" name="wr_email" value="<?php echo $wr_email ?>" required id="wr_email" class="frm_input required" ></td>
        </tr>
		   
    <!--     <tr>
            <th scope="row"><label for="wr_content">거주지<strong class="sound_only">필수</strong></label></th>
            <td class="wr_content">
