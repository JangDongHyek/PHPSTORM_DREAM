...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="row"><label for="cr_use">사용유무<strong class="sound_only">필수</strong></label></th>
        <td>
            <select id="cr_use" name="cr_use" class="frm_input">
...
<div class="btn_confirm01 btn_confirm">
    ...
    <a href="./cancel_rule_list.php?<?php echo $qstr ?>">목록</a>
</div>
...
<script>
    $(document).ready(function() {
        $("[name='cr_category1']").val(<?= $row['cr_category1']?>);
        $("[name='cr_use']").val(<?= $row['cr_use']?>);
