...
$sub_config = $_REQUEST['sub_config'];

if ($sub_config == 'Y'){

    $sql_common = " cf_possible_ip = '" . trim($_POST['cf_possible_ip']) . "',
    ...
    $sql_common = "cf_title = '{$_POST['cf_title']}',
...
if ($sub_config  == 'Y') {
    alert('완료되었습니다.','./config_form_adm.php', false);
}else{
