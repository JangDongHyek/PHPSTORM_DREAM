...
*/
define('G5_DOMAIN', '');
define('G5_HTTPS_DOMAIN', 'https://www.jobgo.ac');
define('G5_HTTP_DOMAIN', 'http://www.jobgo.ac');
...
define('G5_BNR_PATH', G5_DATA_PATH.'/'.G5_BANNER_DIR);
...
if(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS']=='on') {   //https 통신일때 daum 주소 js
    ...
    if(strpos($_SERVER['REQUEST_URI'], '/qna') !== false) {} // 21.06.02 /qna 경로 http->https 예외 처리
    else { header('Location: '.G5_HTTPS_DOMAIN); }
}
?>