...
define('G5_MYSQL_USER', 'jobgo');
define('G5_MYSQL_PASSWORD', '*av%s%kk');
define('G5_MYSQL_DB', 'jobgo');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');
define('NEW_TABLE_PREFIX', 'new_');
...
$g5['content_save_table'] = G5_TABLE_PREFIX.'content_save'; // 내용(컨텐츠)저장정보 테이블
...
$g5['submenu_table'] = G5_TABLE_PREFIX.'submenu'; // 서브메뉴 테이블
$g5['ipconfig_table'] = G5_TABLE_PREFIX.'ipconfig'; // 접속가능아이피

//새로만든 테이블
$g5['talent_table'] = NEW_TABLE_PREFIX.'talent'; // 재능등록ㄴ
$g5['pay_talent_table'] = NEW_TABLE_PREFIX.'pay_talent'; // 재능가격정보
$g5['category_service_table'] = NEW_TABLE_PREFIX.'category_service'; // 재능 하위카테고리 서비스
$g5['code_table'] = NEW_TABLE_PREFIX.'code'; // 재능 하위카테고리 서비스
$g5['profile_table'] = NEW_TABLE_PREFIX.'profile'; // 프로필 서비스
$g5['category_service_table'] = NEW_TABLE_PREFIX.'category_service'; // 옵션 테이블
$g5['talent_qna_table'] = NEW_TABLE_PREFIX.'talent_qna'; // qna 테이블
$g5['like_table'] = NEW_TABLE_PREFIX.'like'; // like 테이블
