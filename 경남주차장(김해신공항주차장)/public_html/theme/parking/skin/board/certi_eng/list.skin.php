...
<div id="bo_gall" style="width:<?php echo $width; ?>">
            ...
            <ul class="gall_con">
                ...
                <li class="gall_href">
                    ...
                    if ($list[$i]['is_notice']) { // 공지사항  ?>
                        <strong style="width:<?php echo $board['bo_gallery_width'] ?>px;line-height:<?php echo $board['bo_gallery_height'] ?>px">Notice</strong>
                    <?php } else {
                ...
                <?php /*?><div class="gall_subject">
                    <span>Wirter </span><?php echo $list[$i]['name'] ?>
                    <span>Date </span><?php echo $list[$i]['datetime'] ?>
                    <span>조회 </span><?php echo $list[$i]['wr_hit'] ?> 
                </div><?php */?>
                
                <?php if ($is_good) { ?><li><span class="gall_subject"></span><strong><?php echo $list[$i]['wr_good'] ?></strong></li><?php } ?>
                <?php if ($is_nogood) { ?><li><span class="gall_subject"></span><strong><?php echo $list[$i]['wr_nogood'] ?></strong></li><?php } ?>
            </ul>
        </li>
        <?php } ?>
        <?php if (count($list) == 0) { echo "<li class=\"empty_list\">No postings found.</li>"; } ?>
    </ul>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">Wirte</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
