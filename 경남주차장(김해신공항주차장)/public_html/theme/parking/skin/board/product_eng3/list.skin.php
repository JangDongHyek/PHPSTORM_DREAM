...
<!-- 게시판 목록 시작 { -->
<div id="bo_gall" style="width:<?php echo $width; ?>; float:left">

<a href="" class="cate_btn">Download PDF Catalog of Full version</a>

<div class="bo_txt">INNOVATIVE CORE TECHNOLOGIES OF MEDICAL DEVICES</div>

<!-- 게시물 검색 시작 { -->
<fieldset id="bo_sch">
    <legend style="border-bottom:0px">게시물 검색</legend>
    ...
    <select name="sfl" id="sfl">
        ...
        <option value="wr_content"<?php echo get_selected($sfl, 'wr_content'); ?>>Contents</option>
				<option value="wr_7"<?php echo get_selected($sfl, 'wr_7'); ?>>Keyword</option>
...
<!-- } 게시물 검색 끝 -->
    ...
    <?php if ($is_checkbox) { ?>
    <div id="gall_allchk">
        <label for="chkall" class="sound_only">Total Page</label>
...
<!-- 				    <p class="t16"><?php// echo $list[$i]['wr_1'] ?>제품코드</p> -->
						<p class="gth_st">COVID-19 detection kit
</p>
...
<!-- 						<p class="t6 t_margin20 text-right"><?php// echo $list[$i]['wr_3'] ?>가격안내 -->
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_adm">
            ...
            <li><input type="submit" name="btn_submit" value="Select Copy" onclick="document.pressed=this.value"></li>
            <li><input type="submit" name="btn_submit" value="Select Move" onclick="document.pressed=this.value"></li>
        </ul>
        <?php } ?>
...
function fboardlist_submit(f) {
    ...
    if(document.pressed == "Select Copy") {
        select_copy("copy");
        return;
    }

    if(document.pressed == "Select Move") {
        select_copy("move");
        return;
    }
