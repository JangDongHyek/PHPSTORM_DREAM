            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="title">
                        ...
                        <p class="t10"><?php echo $list[$i]['wr_2'] ?><!-- 냉난방면적 --></p>
                        <? } else if( $bo_table =="pro_expert04") { //에어서큘레이터 일때 ?>
                        <p class="t10"><?php echo $list[$i]['wr_7'] ?><!-- 크기 --></p>                      
                        <? } else if( $bo_table =="pro_expert01"||$bo_table =="pro_expert02"||$bo_table =="pro_expert03"||$bo_table =="pro_expert05"||$bo_table =="pro_expert06") { //전문가전 일때 ?>
                        <p class="t10"><?php echo $list[$i]['wr_6'] ?><!-- 크기 --></p>
                        <? } else if( $bo_table =="pro_expert07") { //세탁기 일때 ?>
                        <p class="t10"><?php echo $list[$i]['wr_10'] ?><!-- 세탁용량 --></p>
                        <?php } else { //그 외 ?>
                        <p class="t10"><?php echo $list[$i]['wr_2'] ?><!-- 냉난방면적 --></p>
                        <? } ?>
