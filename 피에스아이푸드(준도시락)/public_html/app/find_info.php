...
$action_url = APP_URL."/find_info_password.php";

// add_stylesheet('css 구문', 출력순서); 숫자가 작을 수록 먼저 출력됨
add_stylesheet('<link rel="stylesheet" href="'.$member_skin_url.'/style.css?ver='.G5_CSS_VER.'">', 0);
?>
...
<div id="find_info" class="mbskin">
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane active" id="id-find">
            <fieldset id="info_fs">
                <label for="mb_name">업체명&현장명<strong class="sound_only">필수</strong></label>
                <input type="text" name="" id="mb_name1" class="frm_input" size="30" placeholder="업체명&현장명">
            </fieldset>
            <fieldset id="info_fs">
