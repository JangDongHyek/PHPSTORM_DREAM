...
if ($_SESSION['ss_mb_id']) { // 로그인중이라면
    ...
    if ($tmp_mb_id = get_cookie('ck_mb_id')) {
        ...
        if (strtolower($tmp_mb_id)) { // 22.02.17 업체 요청으로 관리자페이지 자동로그인 허용
...
// 준도시락
//------------------------------------------------------------------------------
define('G5_CSS_VER', 1.3);
define('G5_JS_VER', 1.7);
define("APP_INDEX", G5_URL."/app/index.php");
define("APP_URL", G5_URL."/app");
define("APP_PATH", G5_PATH."/app");

//// 인앱체크 변수 // 앱자동로그인
//$is_inapp = false;
//$inapp_vercode = 0;
//if (strpos($_SERVER['HTTP_USER_AGENT'], "JUNDORISAK") !== false) {
//    $is_inapp = true;
//    // 앱버전확인
...
$kakao_javascript_key = '572bdb79de35442c948ebbe6e4c127d7';
?>
