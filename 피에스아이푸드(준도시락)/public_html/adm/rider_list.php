...
<div class="btn_add01 btn_add">
    <a href="./rider_form.php" id="rider_add">기사등록</a>
</div>
<?php } ?>

<form name="friderlist" id="friderlist" action="./rider_list_update.php" onsubmit="return friderlist_submit(this);" method="post">
...
<div class="tbl_head02 tbl_wrap mb_tbl">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        $s_mod = '<a href="./rider_form.php?'.$qstr.'&amp;w=u&amp;mb_id='.$row['mb_id'].'">보기/수정</a>';
