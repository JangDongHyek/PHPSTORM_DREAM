            ...
            <div id="join_info">
                ...
                <div class="box-body">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-xs-11">
                            <label for="reg_mb_email">명세서수신이메일주소</label>
                            <input type="text" name="mb_email" id="reg_mb_email" class="regist-input <?php echo $required ?>" minlength="3" maxlength="50" <?php echo $required ?> placeholder="명세서수신이메일주소" value="<?php echo $member['mb_email']; ?>">
                            * 월 명세서 및 세금계산서를 받으실 이메일주소 기입부탁드립니다.
                        </dd>
                        <dd class="status_ico"><i class="fas fa-check"></i></dd>
                        <dd class="error col-xs-12"></dd>
                    </dl>
