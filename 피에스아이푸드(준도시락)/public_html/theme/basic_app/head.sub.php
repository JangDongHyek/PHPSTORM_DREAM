...
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=5.0,user-scalable=no,target-densitydpi=medium-dpi"> <!--user-scalable=yes 줌 못하게 하기 위하여 no로 변경-->
<?php
if (G5_IS_MOBILE) {
...
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/swiper.min.css">', 0);//slick슬라이드
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/slick.css">', 0);//slick슬라이드
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/slick-theme.css">', 0);//slick슬라이드
...
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/common.css">', 10);//공통
...
<script src="<?php echo G5_THEME_JS_URL ?>/slick.min.js"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/ui.js"></script>
...
<script src="./js/lunarCalendar.js?v=<?=G5_JS_VER?>"></script><!--양력을 음력으로 변환-->
