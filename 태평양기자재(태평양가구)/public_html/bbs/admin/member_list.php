  ...
  <tr>
    <td>
	    ...
	    <td width="50" align="center"><font color="#333333">포인트</font></td>
            ...
            <td width="100" align="center"><font color="#333333">로그인아이피</font></td>
            <td width="40" align="center"><font color="#333333">접속</font></td>
            <td width="35" align="center"><font color="#333333">수정</font></td>
...
?>
          <tr onmouseover='this.style.backgroundColor="#DAEDED"' onmouseout='this.style.backgroundColor=""'> 
            <td width="20" height="24" align="center" bgcolor="#FFFFFF"> <input name="bg_num[]" type="checkbox" id="bg_num[]2" value="<?=$R[bg_num]?>">            </td>
	    ...
	    <td align="center" bgcolor="#FFFFFF">
            ...
            <td align="center" bgcolor="#FFFFFF"> 
              <?=$R[mb_log_count]?>            </td>
            <td align="center" bgcolor="#FFFFFF"><a href="member_edit.php?<?=$p_str?>&mode=edit&mb_num=<?=$R[mb_num]?>">수정</a></td>
...
<? include("navigation.php"); ?>
        ...
        <table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            <td> <a href="member_edit.php?<?=$p_str?>&page=<?=$page?>" title="신규회원등록"><img src="images/plus_mb.gif"   border="0"></a>&nbsp;<a href="#" onClick="javascript:window.open('member_mail.php','mailing', 'left=50,top=50,width=650,height=650,scrollbars=1');"><img src="images/btn_m01.gif" width="110" height="26" border="0"></a>&nbsp;<a href="#" onClick="javascript:window.open('member_mail.php?condition=<?=urlencode("SELECT * FROM $db_table_member WHERE (1=1) ".$qstr)?>','mailing', 'left=50,top=50,width=650,height=650,scrollbars=1');"><img src="images/btn_m02.gif" border="0"></a>&nbsp;<a href="excel.php?qstr=<?=$qstr?>"><img src="images/btn_m03.gif" width="101" height="26" border="0"></a></td>
          </tr>
        </table>
        <!--				
        <p align="center"> 
