...
<input name="act" type="hidden" value="ok">
        ...
        <table width="850" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="37" valign="top" background="images/line.gif" style="padding-top:12">&nbsp;<img src="images/t01.gif" width="77" height="13"></td>
          </tr>
        </table>
        <br>
        <table width="850" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#D5D5D5" >
          <tr> 
            <td align="right" bgcolor="#f7f7f7">사이트이름&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_site_name" type="text" id="st_site_name" value="<?=$site[st_site_name]?>" size="50"></td>
          </tr>
          <tr>
...
?>
		  ...
		  <tr> 
            ...
            <td bgcolor="#FFFFFF" > <input name="st_join_agreement" type="checkbox" id="st_join_agreement" value="1" <?=($site[st_join_agreement])?'checked':''?>>
		  ...
		  <tr> 
            ...
            <td bgcolor="#FFFFFF" > <input name="st_join_agreement_url" type="text" id="st_join_agreement_url" value="<?=$site[st_join_agreement_url]?>" size="50"></td>
          </tr>
		  <tr> 
            <td align="right" bgcolor="#f7f7f7" >&nbsp;개인정보 보호정책 iframe URL&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" > <input name="st_privacy_protect_policy_url" type="text" id="st_privacy_protect_policy_url" value="<?=$site[st_privacy_protect_policy_url]?>" size="50"></td>
          </tr>
		  <tr> 
            <td align="right" bgcolor="#f7f7f7" >회원가입 기타&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF"><input name="st_name_validate" type="checkbox" id="st_name_validate" value="1" <?=($site[st_name_validate])?'checked':''?>>  
              실명인증사용 
          </tr>
          <tr> 
            <td width="150" align="right" bgcolor="#f7f7f7">회원가입후 이동할 URL&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_join_ok_url" type="text" id="st_join_ok_url" value="<?=$site[st_join_ok_url]?>" size="50"> 
            </td>
          </tr>
          <tr> 
            <td align="right" bgcolor="#f7f7f7" >가입후 자동로그인&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" > <input name="st_join_auto_login" type="checkbox" id="st_join_auto_login" value="1" <?=($site[st_join_auto_login])?'checked':''?>>
            자동로그인 </td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >로그인후 이동할 URL&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_login_ok_url" type="text" id="st_login_ok_url" value="<?=$site[st_login_ok_url]?>"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >관리이메일&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_email" type="text" id="st_email" value="<?=$site[st_email]?>"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >로그아웃후 이동할 URL&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_logout_ok_url" type="text" id="st_logout_ok_url" value="<?=$site[st_logout_ok_url]?>"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >기본포인트&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_default_point" type="text" id="st_default_point" dir="rtl" value="<?=$site[st_default_point]?>"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >하루에 최고포인트&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_today_max_point" type="text" id="st_today_max_point" dir="rtl" value="<?=$site[st_today_max_point]?>"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >로그인포인트&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_login_point" type="text" id="st_login_point" dir="rtl" value="<?=$site[st_login_point]?>"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >기본레벨&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" > <select name="st_default_level">
...
?>            </td>
          ...
          <tr> 
            ...
            <td bgcolor="#FFFFFF" ><input name="st_connect_time" type="text" id="st_connect_time" dir="rtl" value="<?=$site[st_connect_time]?>" size="10">
            <font color="#FF0000">초단위 0 이면 사용하지 않음 (ex:60 = 1분)</font></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목1&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" > <select name="st_mb_ext_type[1]" id="st_mb_ext_type[1]">
...
?>
          ...
          <tr> 
            ...
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value1" type="text" id="st_mb_ext_value1" value="<?=$site[st_mb_ext_value1]?>" size="50"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목2&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><select name="st_mb_ext_type[2]" id="st_mb_ext_type[2]">
                <option value="0">사용안함</option>
                <?
...
?>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목설정값&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value2" type="text" id="st_mb_ext_value2" value="<?=$site[st_mb_ext_value2]?>" size="50"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목3&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><select name="st_mb_ext_type[3]" id="st_mb_ext_type[3]">
                <option value="0">사용안함</option>
                <?
...
?>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목설정값&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value3" type="text" id="st_mb_ext_value3" value="<?=$site[st_mb_ext_value3]?>" size="50"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목4&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><select name="st_mb_ext_type[4]" id="st_mb_ext_type[4]">
                <option value="0">사용안함</option>
                <?
...
?>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목설정값&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value4" type="text" id="st_mb_ext_value4" value="<?=$site[st_mb_ext_value4]?>" size="50"></td>
          </tr>
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목5&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><select name="st_mb_ext_type[5]" id="st_mb_ext_type[5]">
                <option value="0">사용안함</option>
                <?
...
?>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목설정값&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value5" type="text" id="st_mb_ext_value5" value="<?=$site[st_mb_ext_value5]?>" size="50"></td>
          </tr>
		  <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목6&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><select name="st_mb_ext_type[6]" id="st_mb_ext_type[6]">
                <option value="0">사용안함</option>
                <?
...
?>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목설정값&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value6" type="text" id="st_mb_ext_value6" value="<?=$site[st_mb_ext_value6]?>" size="50"></td>
          </tr>
		  <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목7&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><select name="st_mb_ext_type[7]" id="st_mb_ext_type[7]">
                <option value="0">사용안함</option>
                <?
...
?>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목설정값&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value7" type="text" id="st_mb_ext_value7" value="<?=$site[st_mb_ext_value7]?>" size="50"></td>
          </tr>
		  <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목8&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><select name="st_mb_ext_type[8]" id="st_mb_ext_type[8]">
                <option value="0">사용안함</option>
                <?
...
?>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목설정값&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value8" type="text" id="st_mb_ext_value8" value="<?=$site[st_mb_ext_value8]?>" size="50"></td>
          </tr>
		  <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목9&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><select name="st_mb_ext_type[9]" id="st_mb_ext_type[9]">
                <option value="0">사용안함</option>
                <?
...
?>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목설정값&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value9" type="text" id="st_mb_ext_value9" value="<?=$site[st_mb_ext_value]?>" size="50"></td>
          </tr>
		  <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목10&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><select name="st_mb_ext_type[10]" id="st_mb_ext_type[10]">
                <option value="0">사용안함</option>
                <?
...
?>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" >추가항목설정값&nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" ><input name="st_mb_ext_value10" type="text" id="st_mb_ext_value10" value="<?=$site[st_mb_ext_value10]?>" size="50"></td>
          </tr>
		  <tr> 
            <td height="22" align="right" bgcolor="#f7f7f7" > 참고 &nbsp;:&nbsp;</td>
            <td bgcolor="#FFFFFF" >text  : required|itemname|value|size<br>
        ...
        <br>
        <table width="796" border="1" align="center" cellpadding="3" cellspacing="0" bordercolorlight="#E1E1E1" bordercolordark="white">
          <tr> 
