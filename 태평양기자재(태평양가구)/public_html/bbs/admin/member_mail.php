...
<form name="mail_list" method="post" action="?" onSubmit="return editor_wr_ok();">
    ...
    <td align="center">
        <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#E1E1E1" bordercolordark="white">
          ...
          <tr> 
            ...
            <td><?=myEditor(1,'../editor','mail_list','content','100%','200');?>
			<!-- <textarea name="content" cols="80" rows="20" class="input1" id="content" required itemname="이메일내용"><?=$content?></textarea> --></td>
          </tr>
          <tr> 
            <td align="center" bgcolor="#f0f0f0">발송조건</td>
            <td><textarea name="condition" cols="80" rows="4" class="input1" id="condition"required itemname="발송조건"><?=$condition?></textarea> 
