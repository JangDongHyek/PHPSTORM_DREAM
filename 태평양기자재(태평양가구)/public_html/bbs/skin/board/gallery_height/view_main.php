...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 style="table-layout:fixed">
  <TR bgcolor=#FFFFFF height=21> 
    <TD width=12% bgcolor=#ffffff height="25"> 
      <div align="right">제&nbsp;&nbsp;&nbsp;목&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
  ...
  <TR bgcolor=#FFFFFF height=21> 
    <TD bgcolor=#ffffff height="21"> 
      <div align="right">글쓴이&nbsp;&nbsp;<img src="<?=$skin_board_url?>images/head_img09.gif" border=0></div>
    </TD>
...
onload=set_img_init;
    ...
    <?=$show_file1_view_begin?>
	 <p align="center"><font color="#CC0000">※그림을 클릭하시면 원본을 보실 수 있습니다.</font></p>
    <p align='center'><img src="<?=$rg_file1_url?>" border="0" onerror="this.src='<?=$skin_board_url?>blank_.gif'" onclick="img_new_window('<?=urlencode($rg_file1_url)?>','<?=urlencode($rg_title)?>')" style="cursor:hand;" id=img_file1></p>
    <script language="JavaScript" type="text/JavaScript">
img1_exist = true;
function set_img1() {
	if(img1_width==0) {
	...
	<p align="center"><img src="<?=$rg_file2_url?>" border="0" onerror="this.src='<?=$skin_board_url?>blank_.gif'" onclick="img_new_window('<?=urlencode($rg_file2_url)?>','<?=urlencode($rg_title)?>')" style="cursor:hand;" id=img_file2></p> 
    <script language="JavaScript" type="text/JavaScript">
img2_exist = true;
function set_img2() {
	if(img2_width==0) {
