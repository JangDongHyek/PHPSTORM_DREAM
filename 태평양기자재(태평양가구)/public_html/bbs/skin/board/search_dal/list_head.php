		...
		<td height="26" valign="top" align="center">
			<table cellpadding="0" cellspacing="0" border="0" width=100%>
				<tr>
					...
					<img src=<?=$skin_board_url?>images/arrow_1.gif border=0 align=absmiddle> <?=$year?>년 <?=$month?>월
					</td>
				</tr>
				<tr>
					<td width="50%" align=right>
			        <a href="list.php?form_name=<?=$form_name?>&input_location=<?=$input_location?>&bbs_id=<?=$bbs_id?>&year=<?=$prevyeary?>&month=<?=$pmonth?>"><img src=<?=$skin_board_url?>images/prev_year.gif border=0 align=absmiddle alt="<?=$prevyeary?>년 <?=$pmonth?>월 보기"></a>
					<a href="list.php?form_name=<?=$form_name?>&input_location=<?=$input_location?>&bbs_id=<?=$bbs_id?>&year=<?=$prevyear?>&month=<?=$prevmonth?>"><img src=<?=$skin_board_url?>images/prev_month.gif border=0 align=absmiddle alt="<?=$prevyear?>년 <?=$prevmonth?>월 보기"></a>
					<a href="list.php?form_name=<?=$form_name?>&input_location=<?=$input_location?>&bbs_id=<?=$bbs_id?>&year=<?=$thisyear?>&month=<?=$thismonth?>"><img src=<?=$skin_board_url?>images/this_month.gif border=0 align=absmiddle alt="<?=$thisyear?>년 <?=$thismonth?>월 보기"></a>
					<a href="list.php?form_name=<?=$form_name?>&input_location=<?=$input_location?>&bbs_id=<?=$bbs_id?>&year=<?=$nextyear?>&month=<?=$nextmonth?>"><img src=<?=$skin_board_url?>images/next_month.gif border=0 align=absmiddle alt="<?=$nextyear?>년 <?=$nextmonth?>월 보기"></a>
					<a href="list.php?form_name=<?=$form_name?>&input_location=<?=$input_location?>&bbs_id=<?=$bbs_id?>&year=<?=$nextyeary?>&month=<?=$pmonth?>"><img src=<?=$skin_board_url?>images/next_year.gif border=0 align=absmiddle alt="<?=$nextyeary?>년 <?=$pmonth?>월 보기"></a>
				  ...
				  <table cellpadding="0" cellspacing="1" border="0" bgcolor=<?=$table_line?> width=100%>
				    <tr bgcolor="#FFFFFF">
					  <td height="20" width="14%">
					    <table height="20" cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#ffffff">
						  <tr>
					  ...
					  <td width="14%">
					    <table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" width="100%" height="20">
						  <tr>
					...
					<td valign="top" height=<?=$height?> width='<?=$width1?>' <?=$today_bg?>>
						<table cellpadding="0" cellspacing="0" border="0" width=100% style="table-layout:fixed;">
						  <tr>
							...
							<?=$show_write_begin?>
							<a href="#" onclick="use('<?=$year?>-<?=$month?>-<?=$day?>')">
							<?=$show_write_end?>
...
<script language="JavaScript" type="text/JavaScript">
	function use(date)
	{
		opener.<?=$form_name?>.<?=$input_location?>.value=date;
		self.close();
	}
</script>