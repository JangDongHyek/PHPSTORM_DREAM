...
******************************************************************/
?>
<table height="2" border="0" cellpadding="0" cellspacing="0" width="<?=$width?>" bgcolor="32AAC2">
  <tr>
    <td></td>
  </tr>
</table>
...
<TR> 
    ...
    <TR> 
		...
		<TR> 
			<TD height=30 align=middle><B> &nbsp;&nbsp;※ 새글작성</B> (<font color="#FF0000"><strong>*</strong></font>)표시가 있는 부분은 필수항목입니다.</TD>
		</TR>
		<TR> 
		...
		<TR> 
			<TD>
                <TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
                   <TR> 
	                    <TD width=131 align=right bgColor=E3F4F7 class="bbs">글종류<B> 
                          &nbsp; </B></TD>
...
<?=$show_name_begin?>
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
	                    <TD width=131 align=right bgColor=E3F4F7 class="bbs"><strong><font color="#FF3300">*</font> 이름</strong><B> &nbsp; </B></TD>
	                    <TD bgcolor="#FFFFFF"> 
                          <input name='rg_name' type=text id="rg_name" value='<?=$rg_name?>' maxlength=20 required itemname='이름' style=width:99%;height:22; class=b_input>                        </TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
...
<?=$show_password_begin?>
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    <TD width=131 align=right bgColor=E3F4F7 class="bbs"><strong><font color="#FF0000">*</font> 비밀번호</strong><B> 
                          &nbsp; </B></TD>
					    <TD align=left class="bbs" bgcolor="#FFFFFF"> 
                          <input name='rg_password' type=password style=width:99%;height:22; class=b_input id="rg_password" maxlength=20 <?=(!$mode_edit && !$mb)?'required':''?> itemname='암호'>
                        &nbsp;</TD>
					</TR>
				</TABLE>
			</TD>
...
<?=$show_category_begin?>
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    <TD width=131 align=right bgColor=E3F4F7 class="bbs">* 분류 &nbsp;</TD>
...
<?=$show_html_begin?>
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    <TD width=131 align=right bgColor=E3F4F7 class="bbs">html 사용 &nbsp; </TD>
...
<?=$show_html_end?>
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    <TD width=131 align=right bgColor=E3F4F7 class="bbs"><strong><font color="#FF3300">*</font> 제목</strong><B> &nbsp;</B></TD>
					    <TD align=left bgcolor="#FFFFFF"> <input name='rg_title' type=text style=width:99%;height:22; class=b_input id="rg_title"  value='<?=$rg_title?>' required itemname='제목'></TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
		<TR> 
			<TD height="50"> 
				<TABLE width="100%" height="100" border="0" cellPadding=1 cellSpacing=1 bordercolor="#ffffff">
					<TR> 
					    <TD width=131 align=right bgColor=E3F4F7 class="bbs" onclick="document.form_write.rg_content.rows=document.form_write.rg_content.rows+2" style=cursor:hand><strong><font color="#FF0000">*</font> 내용</strong> ▼<B>&nbsp;</B></TD>					              
                        <TD align=left height="100" bgcolor="#FFFFFF"> <textarea name="rg_content" id="rg_content"  rows=15  style=width:99%; class="b_textarea" required itemname='내용'><?=$rg_content?></textarea> <img width="1" height="1"></TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
<?=$show_link_begin?>
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
						<TD width=131 align=right bgColor=E3F4F7 class="bbs">링크 #1<B> &nbsp;</B></TD>
					    <TD align=left bgcolor="#FFFFFF"> <input name='rg_link1_url' type=text style=width:99%;height:22; class=b_input id="rg_link1_url"  value='<?=$rg_link1_url?>' itemname='링크 #1'></TD>
					</TR>
				</TABLE>
			</TD>
		</TR>																						
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
                        <TD width=131 align=right bgColor=E3F4F7 class="bbs">링크 #2<B> &nbsp;</B></TD>
					    <TD align=left bgcolor="#FFFFFF"> 
                          <input name='rg_link2_url' type=text style=width:99%;height:22; class=b_input id="rg_link2_url"  value='<?=$rg_link2_url?>' itemname='링크 #2'>                        </TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
...
<?=$show_upload_begin?>
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR>
                        <TD width=131 align=right bgColor=E3F4F7 class="bbs">첨부화일 #1<B>&nbsp;&nbsp; </B></TD>
					    <TD align=left class="bbs" bgcolor="#FFFFFF"> <input name='rg_file1' type=file style=width:99%;height:22; class=b_input id="rg_file1"  itemname='파일 #1'> 
		...
		<TR> 
			<TD>
				<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
					<TR> 
					    <TD width=131 align=right bgColor=E3F4F7 class="bbs">첨부화일 #2<B>&nbsp;&nbsp; </B></TD>
					    <TD align=left class="bbs" bgcolor="#FFFFFF"> 
                          <input name='rg_file2' type=file style=width:99%;height:22; class=b_input id="rg_file2"  itemname='파일 #2'>
...
<?=$show_ext5_end?>
	...
	<TR> 
		<TD align=middle bgColor=A9D3E5><BR> 
