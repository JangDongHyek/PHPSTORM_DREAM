				...
				<div class="mypage_cont">
					<div class="tab_cont">
                        ...
                        <dl>
                            <dt>성별</dt>
                            <dd class="box">
                                <input type="radio" id="mb_sex_m" name="mb_sex" value="M" <?php if($member["mb_sex"] == "M") echo "checked"?>>
                                <label for="mb_sex_m">남성</label>
                                <input type="radio" id="mb_sex_w" name="mb_sex" value="W" <?php if($member["mb_sex"] == "W") echo "checked"?>>
                        ...
                        <dl>
                            <dt>현재직업</dt>
                            <dd class="box">
                                <?php foreach($jobs as $index => $i) { ?>
                                    <input type="radio" id="mb_job_<?=$index?>" name="mb_job" value="<?=$i?>" <?php if($member["mb_job"] == $i) echo "checked";?>>
                                    <label for="mb_job_<?=$index?>"><?=$i?></label>
                                <?php } ?>
                            </dd>
                        </dl>
                        ...
                        <dl>
                            <dt>관심분야</dt>
                            <dd class="box">
                                <?php foreach($interests as $index => $i) { ?>
                                    <input type="checkbox" id="mb_interest_<?=$index?>" name="mb_interest[]" value="<?=$i?>" <?php if(in_array($i, $mb_interests)) echo "checked"; ?>>
                                    <label for="mb_interest_<?=$index?>"><?=$i?></label>
                                <?php } ?>
                            </dd>
                        </dl>
                        <dl>
                        ...
                        <dl>
                            ...
                            <? for($i=1; $i<7; $i++ ) { ?>
                                <dd id="addFile<?=$i?>" class="addFile">
                                    <a class="btn" onclick="document.getElementById('file<?=$i?>').click();">파일 선택</a>
                                    <span id="file_name<?=$i?>">선택된 파일 없음</span>
                                    <input type="file" name="file<?=$i?>" id="file<?=$i?>" style="display: none;" onchange="updateFileName(<?=$i?>)">
                                    <? if($member['file'.$i] != "") { ?>
                                        <label for="file_d<?=$i?>">
                                            <input type="checkbox" id="file_d<?=$i?>"> <?=$member['file_name'.$i]?>  삭제하기
                                        </label>
                                    <? } ?>
                                </dd>
                            <? } ?>
