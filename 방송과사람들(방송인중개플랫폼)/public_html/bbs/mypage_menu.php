...
<div id="mypage_menu">
    ...
    <?php if ($member['mb_level'] > 2) /*전문가*/{ ?>
        ...
        <li><a href="<?php echo G5_BBS_URL ?>/mypage_project_request.php">프로젝트 지원 LIST</a></li>
        <li><a onclick="utils.showToast('준비중입니다.')">MY등급</a></li>
        <li><a onclick="utils.showToast('준비중입니다.')">광고신청관리</a></li>
        <li><a onclick="utils.showToast('준비중입니다.')">리뷰관리</a></li>
        <li><a onclick="utils.showToast('준비중입니다.')">MY혜택</a></li>
