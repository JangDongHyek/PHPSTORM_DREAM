    ...
    <div id="hd_wrapper" <?php if(defined('_INDEX_')){ echo "class='idx wow fadeInDown animated'"; } ?> data-wow-delay="0.5s" data-wow-duration="0.3s">
        ...
        <div class="hd_idx">
            ...
            <div class="hd_icon_right">
                ...
                <?php }?>
                    <a href="#hash-search" id="hash_search" data-role="button" data-url="<?php echo G5_PLUGIN_URL;?>/hash/" data-ref="1" data-animation="left"><i class="fa-light fa-magnifying-glass"></i></a>
            </div>
        </div><!--idx-->
                ...
                <ul id="gnb_1dul">
					<li class="gnb_1dli all_menu">
						...
						<ul class="gnb_2dul">
							...
							<li class="gnb_2dli">
								<a href="<?php echo G5_BBS_URL ?>/item_list.php?ctg=<?=$big_ctg[$i]["c_idx"]?>" class="gnb_2da"><?=$big_ctg[$i]["c_name"]?></a>
								<div class="gnb_2dli_list" style="display:none">
									<ul class="gnb_2dul ver02" style="display:none">
                                        <?php for ($a = 0; $a< count($small_ctg); $a++){ ?>
										<li class="gnb_2dli"><a href="<?php echo G5_BBS_URL ?>/item_list.php?ctg=<?=$small_ctg[$a]["c_idx"]?>" class="gnb_2da"><?=$small_ctg[$a]["c_name"]?></a></li>
                                        <?php } ?>
									</ul>
								</div>
							</li>
                    ...
                    <?php for ($i = 0; $i< count($big_ctg); $i++){
                        ...
                        <li class="gnb_1dli">
                            <a href="<?php echo G5_BBS_URL ?>/item_list.php?ctg=<?=$big_ctg[$i]["c_idx"]?>" class="gnb_1da <?=$on?>"><?=$big_ctg[$i]["c_name"]?><span></span></a>
                        </li>
                    <?php } ?>
