...
<article id="contest_view">
    ...
    <div class="wrapper inr">
        <div class="tabs cf">
            ...
            <label for="tab2"><span class="hidden-xs">프로젝트 </span>참여<?php if ($member['mb_id'] == $row['mb_id'] || $member['mb_id'] == 'admin' ){ ?><span class="badge"><?= comp_apply_cnt($row['cp_idx'])?></span><?php } ?></label>
                        ...
                        <div class="cont sample">
                            ...
                            <ul>
                                ...
                                for($i = 0; $img = sql_fetch_array($sub_result); $i++){
                                    $sub_file = G5_DATA_PATH.'/file/competition/'.$img['bf_file'];
                                    if (file_exists($sub_file) && $img['bf_file'] != "") {
                                        $html = "<li><a href='".G5_URL."/bbs/download.php?no=".$img['bf_no']."&bo_table=competition&wr_id={$cp_idx}'>다운로드</a></li>";
                                        echo $html;
                                    }
                                }
                                if ($i == 0){
                                ...
                                for ($i = 0; $comment = sql_fetch_array($comment_result); $i++){
                                    ...
                                    <div class="list cf">
                                        <a href="javascript:;">
                                            ...
                                            <div class="info">
                                                <div class="nick"><span><i class="fas fa-user-circle"></i></span><?=$mb['mb_id']?></div><!--닉네임 일부분 노출-->
