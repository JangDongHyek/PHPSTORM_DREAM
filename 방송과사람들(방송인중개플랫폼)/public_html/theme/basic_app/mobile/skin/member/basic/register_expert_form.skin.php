...
<div class="mbskin">
    ...
    <form name="fregisterform" id="fregisterform" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <input type="hidden" name="mb_level" id="mb_level" value="<? if($w == "") { echo $level; } else { echo $member['mb_level']; } ?>">
        <input type="hidden" name="mb_join_division" id="mb_join_division" value="<? if($w == "") { echo $level; } else { echo $member['mb_join_division']; } ?>">
        ...
        <article class="box-article">
            ...
            <div id="area_join">
                <div id="join_info">
                    <h2><?php if($w == ""){ echo $text ?>가입<? }else { ?>회원정보 확인 및 수정<?php } ?> <p></h2>
                    <div class="box-body">
                                ...
                                <dd>
                                    ...
                                    <?php if($w == "") { ?>
                                        <div class="input cert">
                                            <input type="tel" style="background-color: #f9f9f9 !important;" name="cert_no" value="" id="cert_no" disabled class="regist-input" placeholder="인증번호를 입력해 주세요." maxlength="6">
                                        </div>
                                    <?php } ?>
                                </dd>
                                <dd class="error col-xs-12"></dd>
...
<script>
    ...
    $(function (){
        ...
        $("#reg_mb_password").keyup(function (){
            ...
            // if(!chk_flag) {
            //     state.removeClass("pas").addClass("err");
            //     err.addClass("on").html("영문, 숫자, 특수문자 중 2종류 이상 조합하여 4자리 이상 입력해 주세요.");
            // } else {
            //     state.removeClass("err").addClass("pas");
            //     err.html("");
            // }
