			...
			<h2><?php if($w == ""){ ?>일반회원가입<? }else { ?>회원정보 확인 및 수정<?php } ?> <p></h2>
				<div class="box-body">
					...
					<dl class="row">
						...
						<dd>
							<div class="input">
								<input type="text" name="mb_email" id="reg_mb_email" class="regist-input required f_empty email" minlength="3" maxlength="50" required placeholder="이메일을 입력해 주세요." value="<?php echo $member['mb_email']; ?>">
							</div>
						</dd>
						<dd class="error col-xs-12"></dd>
					</dl>
					...
					<dl class="row hp">
						...
						<dd>
							<div class="input">
								<input style="width: 100% !important;" type="tel" name="mb_hp" value="<?php echo $member['mb_hp'] ?>" id="reg_mb_hp" class="regist-input required" required placeholder="휴대폰번호를 입력해 주세요." minlength="10" maxlength="13">
								<!--<button type="button" class="btn_hp">인증번호</button>-->
							</div>
						</dd>
						<dd class="error col-xs-12"></dd>
					</dl>
