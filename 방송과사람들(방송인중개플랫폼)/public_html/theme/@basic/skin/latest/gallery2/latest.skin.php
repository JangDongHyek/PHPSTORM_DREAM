...
<div id="oneshot_2_7">
	<!--게시판제목-->
	<?php /*?><div class="la_title">
		<?php echo $bo_subject ?>
	</div><?php */?>
	
    <!--더보기버튼-->
	<div class="lt_more">
    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>"><span class="sound_only"><?php echo $bo_subject ?></span><?php echo $bo_subject ?> 더보기 +</a>
    </div><!--.lt_more-->
