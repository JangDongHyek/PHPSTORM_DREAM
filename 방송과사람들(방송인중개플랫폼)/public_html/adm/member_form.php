...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
        ...
        <td style="width: 40%" ><input type="text" name="mb_email" value="<?php echo $mb['mb_email'] ?>" id="mb_email" maxlength="100" required class="required frm_input email" size="30"></td>
