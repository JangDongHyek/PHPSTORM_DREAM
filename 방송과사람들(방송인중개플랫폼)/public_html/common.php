...
$main_ctg = array(
        1 => array("name"=>"촬영·편집", "code" => "shot"),
        2 => array("name"=>"유튜브 제작", "code" => "youtube"),
        3 => array("name"=>"드론 촬영", "code" => "drone"),
        4 => array("name"=>"애니메이션", "code" => "animation"),
        5 => array("name"=>"3D·VR", "code" => "3d"),
        6 => array("name"=>"인트로·로고", "code" => "intro"),
        7 => array("name"=>"영상 자막", "code" => "subtitles"),
        8 => array("name"=>"사진·영상·보정", "code" => "picture"),
        9 => array("name"=>"음악·사운드", "code" => "sound"),
        10 => array("name"=>"모델·MC·공연", "code" => "model"),
);
...
$competition_ctg2 = array(
    1 => array("name" => '방송비지니스' , "idx" => "1"),
    2 =>  array("name" => '방송레슨' , "idx" => "2"),
);
?>
