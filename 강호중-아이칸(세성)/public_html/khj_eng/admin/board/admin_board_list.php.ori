...
for($i=0; $i<$numRows; $i++){
	...
	echo (" 	
									...
									<td width='26%' bgcolor='#FFFFFF' align='center'>
										<input class='aa' onclick=\"window.location.href='admin_board_config.php?bbs_no=$bbs_no'\" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='설정'>
	");
	if($board_type == ''){      				
		echo "
										<input class='aa' onclick=\"board_view('$bbs_no', '$Mall_Admin_ID')\" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='보기'>
											<input class='aa' onclick=\"del('$bbs_no')\" style='background-color: white; color: black; height: 18; width: 40; border: 1px solid #5a5a5a' type='button' value='삭제'>
		";
	}
	if($board_type == '1'){      				
		echo "
										...
										<input class='aa' onclick=\"car_board_del('$bbs_no')\" style='background-color: white; color: black; height: 18; width: 40; border: 1px solid #5a5a5a' type='button' value='삭제'>
		";
	}
	echo ("</td></tr>");
}
