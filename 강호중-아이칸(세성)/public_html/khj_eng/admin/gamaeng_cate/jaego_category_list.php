			...
			<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
				<tr>
					<td width="90%" bgcolor="#FFFFFF" valign="top">
						각 분류와 하부분류를 클릭하시면 재고현황을 열람하실 수 있습니다.<br>
						또한, 분류와 상관없이 전체상품중의 품절상품/위험상품등을 
						검색하여 확인하실 수 있습니다.<br>
					</td>
				</tr>
					...
					<table border="0" width="95%">
						<tr>
							<td width="90%" bgcolor="#ffffff">
								...
								<tr>
									<td width="40%" bgcolor="#FFFFFF"  align="center">분류명</td>
...
for ($i=0; $i<$numRows; $i++){
	...
	$SQL2 = "select * from jungbo_cate where prevno=$category_num and mart_id='$mart_id' order by category_num desc";
...
<?
	for($j=0;$j<$numRows2;$j++){
		...
		$SQL4 = "select * from jungbo_cate where prevno='$category_num2' and mart_id='$mart_id' order by category_num desc";
