...
?>
			...
			10일:<input type=text name="gigan_money10" value="<?=$rows[gigan_money10]?>" size=10>원<br>
			20일:<input type=text name="gigan_money20" value="<?=$rows[gigan_money20]?>" size=10>원<br>
			30일:<input type=text name="gigan_money30" value="<?=$rows[gigan_money30]?>" size=10>원
