...
?>
<img src='../images/btn_list.gif' onClick="location.href='item_list.php?prevno=<?=$prevno?>&prevno2=<?=$prevno2?>&category_num=<?=$category_num_ori?>&page=<?=$page?>&searchword=<?=$searchword?>&pu=<?=$pu?>'" style='cursor:hand;'>
