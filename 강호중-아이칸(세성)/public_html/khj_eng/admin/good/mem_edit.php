		...
		<td>
			...
			<tr>
				<td width="90%" bgcolor="#FFFFFF" valign="top"><br>
					<p style="padding-left: 10px" class="stitle2">[회원 정보]<br><br>
				</td>
			</tr>
      	...
      	<tr>
        	<td width="100%" bgcolor="#FFFFFF" valign="top" align="center">
				...
				<form action='mem_modify.php?item_no=<?=$item_no?>&flag=update&page=<?=$page?>&searchword=<?=$searchword?>&prevno=<?=$prevno?>&prevno2=<?=$prevno2?>&category_num=<?=$category_num_ori?>&pu=<?=$pu?>' method="post" name='writeform' onsubmit="return checkform(this)" enctype="multipart/form-data">
            			...
            			<table border="0" width="100%" cellspacing="0" cellpadding="0" class="box2">
               			<tr>
                			...
                			<td width="35%" bgcolor="#FFFFFF" colspan=4>
								...
								<input class="aa" type="text" name="last_num" value='<?=$last_num?>' size="3" maxlength=2 readonly>
<?
$sql1 = "select sudong_num from item where sudong_num != '' and sea_num='$sea_num' and sung_num='$sung_num' and khan_num='$khan_num' and last_num='$last_num' order by item_code desc limit 1";
...
?>
								<input class="aa" type="text" name="sudong_num" value='<?=$row1[sudong_num]?>' size="5" maxlength=4>
							</td>

              			</tr>
						<tr>
                			<td width="15%" class="title"align="center" colspan="2">
                				성명
							</td>
                			...
                			<td width="35%" bgcolor="#FFFFFF">
<?
$sql2 = "select item_code from item where sea_num='$sea_num' and sung_num='$sung_num' and khan_num='$khan_num' and last_num='$last_num' order by item_code desc limit 1";
$res2 = mysql_query($sql2,$dbconn);
$row2 = mysql_fetch_array($res2);
?>

                				<input class='input' name="item_code" value="<?=$row2[item_code]+1?>" size="16"> 
							</td>
              			</tr>
              			<tr>
                			<td width="15%" class="title" align="center" colspan="2">
...
<table border="0" width="100%" cellpadding=0 cellspacing=0 class="box2">
              			<tr>
                			<td width="100%" class="title" align="center" colspan="6">
                				메 모
							</td>
              			</tr>
              			<tr>
                			<td width="100%" bgcolor="#FFFFFF" colspan="6">
								<textarea name="short_explain" rows='3' cols='128'><?=$short_explain?></textarea>
                			</td>
              			</tr>
              			...
              			<tr>
                			<td width="47%"class="title" align="center" colspan="3">등록일</td>
      	...
      	<tr>
        	<td width="100%" bgcolor="#FFFFFF" valign="top"><p align="center"><br>
				...
				<!--
					function delete_mem(pu,item_no, tmp_category_num, mart_id){						
						if (confirm("현재회원을 삭제 하시겠습니까?")){
							location.href='mem_edit.php?pu='+pu+'&item_no='+item_no+'&category_num='+tmp_category_num+'&flag=delete';
						}
					}	
				...
				<input class='butt_none' style='width:80' type="submit" value="회원등록" style='cursor:hand'> &nbsp;&nbsp;
