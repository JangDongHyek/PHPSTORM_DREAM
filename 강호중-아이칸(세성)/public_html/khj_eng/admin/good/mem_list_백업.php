...
$SQL = "select count(item_no) from $ItemTable where mart_id='$mart_id' and if_hide='0' and sea_num='$cate_sea_num' and sung_num='$cate_sung_num' and khan_num='$cate_khan_num' and last_num='$cate_last_num'";
$dbresult = mysql_query($SQL, $dbconn);
...
//총회원수
$SQL1 = "select count(item_no) from $ItemTable where mart_id='$mart_id' and if_hide='0' and sea_num='$cate_sea_num' and sung_num='$cate_sung_num' and khan_num='$cate_khan_num' and last_num='$cate_last_num'";
...
?>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="30" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>대기회원 리스트</b></td>
				</tr>
			</table>
...
$SQL = "select * from $ItemTable where mart_id='$mart_id' and provider_id='' and if_hide='0' and sea_num='$cate_sea_num' and sung_num='$cate_sung_num' and khan_num='$cate_khan_num' and last_num='$cate_last_num' order by item_order desc, item_no desc ";
//echo $SQL;
						...
						<td width="100%" bgcolor="#999999">
							...
							<tr>
								<td width="100%" bgcolor="#8FBECD" colspan="9">
									...
									<tr>
										<td width="50%">&nbsp;
											<b><span class="dd">대기회원 리스트</span></b>
										</td>
										<td width="50%"></td>
									</tr>
									</table>
...
?>
							...
							<tr onMouseOver="this.style.backgroundColor='#DDF0FF'" onMouseOut="this.style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF" align='center'>
								...
								<td><?=$mobile?></td>
								<td><?=$reg_date?></td>
								<td><input type=button value="삭제" onClick="mem_del('<?=$item_no?>');"></td>
							</tr>
<?
}
?>
