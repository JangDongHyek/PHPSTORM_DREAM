...
###########################################################################################
	...
	*/
	...
	if( $dbresult ){
		if($request_mode == "ok"){
			echo "<meta http-equiv='refresh' content='0; URL=request_item_edit.php?item_no=$item_no&category_num=$category_num&page=$page&searchword=$searchword&pu=$pu'>";
		}else{
