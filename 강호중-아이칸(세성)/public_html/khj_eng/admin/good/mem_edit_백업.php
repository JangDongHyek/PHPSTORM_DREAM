...
<?
$sql1 = "select sudong_num from item where sea_num='$sea_num' and sung_num='$sung_num' and khan_num='$khan_num' and last_num='$last_num' order by item_code desc limit 1";
...
<table border="0" width="100%" cellpadding=1 cellspacing=1>
      	...
      	<tr>
        	<td width="100%" bgcolor="#FFFFFF" valign="top"><p align="center"><br>
        		...
        		<input class='butt_none' style='width:60' type="submit" value="회원등록" style='cursor:hand'> &nbsp;&nbsp;&nbsp;&nbsp;
