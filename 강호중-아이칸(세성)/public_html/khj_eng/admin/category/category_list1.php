...
$SQL = "select count(category_num) from $CategoryTable where mart_id='$mart_id' and special = 'y'";
$dbresult = mysql_query($SQL, $dbconn);
$numRows = mysql_result($dbresult,0,0);
...
/*
	...
	while( $cat_row1 = mysql_fetch_array( $cat_res1 ) ){
		...
		$cat_sql2 = "select * from $CategoryTable where mart_id='$mart_id' and prevno='$category_num1' order by cat_order desc";
		...
		while( $cat_row2 = mysql_fetch_array( $cat_res2 ) ){
			...
			$cat_sql3 = "select * from $CategoryTable where mart_id='$mart_id' and prevno='$category_num2' order by cat_order desc";
