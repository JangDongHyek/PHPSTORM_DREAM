...
?>
						...
						<tr>
							...
							-->
								...
								?>
									<input style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type=button onclick="javascript:location.href='category_write.php';" value="그룹 등록">
								<?
