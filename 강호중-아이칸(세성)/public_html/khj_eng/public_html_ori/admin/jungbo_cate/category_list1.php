...
?>
		...
		<td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="50" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>분류 관리 </b> [1차 분류수 : <?=$numRows?>개]</td>
				</tr>
			</table>
			...
			<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
				...
				<td width="90%" bgcolor="#FFFFFF" valign="top">
					쇼핑몰에 등록될 분류를 생성/수정/삭제, 또한 해당 분류에 대한 상품을 관리하실 수 있습니다.<br>
					분류명을 클릭하시면 하위분류와 상품을 등록/관리하실 수 있습니다.<br>
				</td>
				</tr>
				<tr>
...
?>
						...
						<tr>
							<td width="50%"><b>
								[총 <?=$numRows_t?>개의 분류가 생성되어 있습니다]</b></td>
...
<?
		if($i < $numRows - 1){
?>
										<a href='category_modify.php?prevno=0&category_num=<?=$category_num?>&cat_order=<?=$cat_order?>&flag=down'><img src='../images/dn_subcategory.gif' width='13' height='13' border='0' alt='한단계내리기'> 
<?
		}else{
?>
...
<?
		...
		if($i > 0){	
?>
										<a href='category_modify.php?prevno=0&category_num=<?=$category_num?>&cat_order=<?=$cat_order?>&flag=up'><img src='../images/up_subcategory.gif' width='13' height='13' border='0' alt='한단계올리기'> 
<?
		}
		else{
?>
...
?>
									...
									<td>
										&nbsp;<input type='text' class='input_01' name='category2_name' size='8'> <input type='submit' value='추 가' style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px'>&nbsp;
...
<?
		if($j < $tot2 - 1){
?>
										<a href='category_modify.php?prevno=<?=$category_num?>&category_num=<?=$category_num2?>&cat_order=<?=$cat_order2?>&flag=down'><img src='../images/dn_subcategory.gif' width='13' height='13' border='0' alt='한단계내리기'> 
<?
		}else{
?>
										<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'> 
<?
		...
		if($j > 0){	
?>
										<a href='category_modify.php?prevno=<?=$category_num?>&category_num=<?=$category_num2?>&cat_order=<?=$cat_order2?>&flag=up'><img src='../images/up_subcategory.gif' width='13' height='13' border='0' alt='한단계올리기'> 
<?
		}
		else{
?>
...
?>				
									...
									<td>
										&nbsp;<input type='text' class='input_01' name='category3_name' size='8'> <input type='submit' value='추 가' style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px'>&nbsp;
...
<?
				if($m < $tot6 - 1){
?>
										<a href='category_modify.php?prevno=<?=$prevno3?>&category_num=<?=$category_num3?>&cat_order=<?=$cat_order3?>&flag=down'><img src='../images/dn_subcategory.gif' width='13' height='13' border='0' alt='한단계내리기'> 
<?
				}else{
?>
										<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'> 
<?
				...
				if($m > 0){	
?>
										<a href='category_modify.php?prevno=<?=$prevno3?>&category_num=<?=$category_num3?>&cat_order=<?=$cat_order3?>&flag=up'><img src='../images/up_subcategory.gif' width='13' height='13' border='0' alt='한단계올리기'> 
<?
				}
				else{
?>
...
?>
								<tr bgcolor='#FFFFFF'>
									<td colspan='3' align='center'><?=$tot6?>개 3차 분류</td>
								</tr>
<?
		//}
?>								
...
?>
								<tr bgcolor='#CCCCCC'>
									<td colspan='3' align='center'><?=$tot2?>개 2차 분류</td>
								</tr>
<?
}
?>
		...
		echo ("
								...
								<tr>
									...
									<td width='53%' bgcolor='#FFFFFF' align='left' colspan='3'>
										...
										$numRows2 개의 하위 분류가 등록되어 있습니다.</td>
								</tr>
									");
