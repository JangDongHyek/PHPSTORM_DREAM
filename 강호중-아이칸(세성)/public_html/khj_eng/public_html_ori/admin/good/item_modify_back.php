...
if($flag == "add"){
	...
	echo "<meta http-equiv='refresh' content='0; URL=item_list.php?category_num=$category_num'>";
}
//========================================================================================
//================== 상품을 수정함 =======================================================
if($flag == "update"){
	...
	if( $dbresult ){
		if( $back = "back" ){
			echo "<meta http-equiv='refresh' content='0; URL=item_edit_back.php?back=$back&item_no=$item_no&category_num=$category_num&page=$page&searchword=$searchword'>";
		}else{
			echo "<meta http-equiv='refresh' content='0; URL=item_edit.php?item_no=$item_no&category_num=$category_num&page=$page&searchword=$searchword'>";
		}
	}else{
		echo "
			<script>
