		...
		<td>
      	...
      	<tr>
        	<td width="100%" bgcolor="#FFFFFF" valign="top" align="center">
				...
				<input type="hidden" name="request_mode" value='ok'>
          		...
          		<tr>
            		<td width="90%" bgcolor="#999999">
            			<table border="0" width="100%" cellspacing="1" cellpadding="3">
               			<tr>
                			...
                			<td width="35%" bgcolor="#FFFFFF" colspan=4>
								<input class="aa" type="text" name="sea_num" value='<?=$sea_num?>' size="3" maxlength=2 readonly>
								...
								<input class="aa" type="text" name="sudong_num" value='<?=$sudong_num?>' size="20" readonly>
							</td>
						...
						<tr>
                			...
                			<td width="35%" bgcolor="#FFFFFF">
                				<input class='input' name="item_code" value="<?=$item_code?>" size="16"> 비밀번호:<input class='input' name="item_pw" size="10">
							</td>
              			</tr>
						<tr>
						...
						<tr>
			              ...
			              <tr>
			                ...
			                <td bgColor="#ffffff">
								<input name="address2" class='input' value="<?=$address2?>" size="34">
							</td>
			                <td bgColor="#c8dfec" colspan="2" align="center">
								칸카드
							</td>
...
<table border="0" width="100%" cellpadding=1 cellspacing=1>
      	...
      	<tr>
        	<td width="100%" bgcolor="#FFFFFF" valign="top"><p align="center"><br>
				...
				<!--
					function delete_mem(pu,item_no, tmp_category_num, mart_id){						
						if (confirm("현재회원을 삭제 하시겠습니까?")){
							location.href='request_item_edit.php?pu='+pu+'&item_no='+item_no+'&category_num='+tmp_category_num+'&flag=delete';
						}
					}	
				...
				<!--<input class='butt_none' style='width:60' type="submit" value="수 정" style='cursor:hand'> -->
				<input class='butt_none' style='width:60' type="button" onclick="javascript:window.close();" value="닫 기" style='cursor:hand'> 
