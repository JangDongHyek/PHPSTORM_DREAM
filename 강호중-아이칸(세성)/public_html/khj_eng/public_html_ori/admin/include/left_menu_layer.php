...
function moveRightEdge() {
	...
	if (isDOM) {
		...
		yMenuTo     = (isNS ? window.pageYOffset : document.body.scrollTop) + 112; // 위쪽 위치
	}
...
<div style='position:absolute; top:0px; left:50%; z-index:1;'>
<div id="divMenu" style='position:absolute;top:320px;left:-505px'> 
  <!--//시작 : 여기에 해당 메뉴 .... -->
<?
if($left_menu == "1")
...
else if($left_menu == "11")
	include "../include/left_menu11.php"; 
