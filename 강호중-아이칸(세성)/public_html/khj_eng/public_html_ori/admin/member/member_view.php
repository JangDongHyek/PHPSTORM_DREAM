							...
							<table border="0" width="97%">
								<tr>
									<td width="100%" bgcolor="#999999">
										...
										<tr>
											<td bgcolor="#C8DFEC" align="left">하고싶은말</td>
											<td bgcolor="#FFFFFF" align="left" colspan='3'><textarea cols="55" name="msg" rows="4" class="input_03" style="width:80%"><?=$msg?></textarea></td>
										</tr>
										<tr>
											...
											<td bgcolor="#C8DFEC" align="left">직장/학교명</td>
											<td bgcolor="#FFFFFF" align="left"><input name="com_name" value='<?=$com_name?>' size="13" class="input_03" style="width:80%"></td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">홈페이지 주소</td>
											<td bgcolor="#FFFFFF" align="left"><input name="homepage" value='<?=$homepage?>' size="13" class="input_03" style="width:80%"></td>
											<td bgcolor="#C8DFEC" align="left">취미</td>
											<td bgcolor="#FFFFFF" align="left"><input name="hobby" value='<?=$hobby?>' size="13" class="input_03" style="width:80%"></td>
										</tr>
										<tr>
											<td bgcolor="#C8DFEC" align="left">종교</td>
											<td bgcolor="#FFFFFF" align="left"><input name="religion" value='<?=$religion?>' size="13" class="input_03" style="width:80%"></td>
