					 ...
					 <tr>
						<td width="90%" bgcolor="#999999"><table border="0" width="100%" cellspacing="1" cellpadding="3">
						  ...
						  <tr>
							 ...
							 <br>
							 가로길이&nbsp;&nbsp; 
							 <input name="img_width" value='250' class="input_03" size="4"> &nbsp;&nbsp;&nbsp; 세로길이&nbsp;&nbsp; 
							 <input name="img_height" value='<?echo $img_height?>' class="input_03" size="4">&nbsp;&nbsp;&nbsp; <br>
							 <font color="#0000ff">쇼핑몰 배너들어갈 자리 이미지 가로넓이의 기본값이자 최대넓이값은 250픽셀입니다.</font>
							 </td>
						  </tr>
						  <tr>
						  ...
						  <tr>
							 ...
							 <td width="44%" bgcolor="#FFFFFF" align="left">
							 <input name="if_newwin" type="radio" value="f" checked>현재창
							 <input name="if_newwin" type="radio" value="t">새창 
							 </td>
						  </tr>
						  <tr>
							 <td width="10%" bgcolor="#C8DFEC" align="left">
							 ...
							 <br>
							  가로길이&nbsp;&nbsp;
							 <input name="flash_width" class="input_03" size="4" value="250">
							 &nbsp;&nbsp;&nbsp; 세로길이&nbsp;&nbsp;
							 <input name="flash_height" class="input_03" size="4">&nbsp;&nbsp;&nbsp; <br>
							 <font color="#0000ff"><br>
							 플래시 가로넓이의 기본값이자 최대넓이값은 250픽셀입니다.</font></td>
						  </tr>
						</table>
						</td>
					 </tr>
...
elseif ($flag == "write") {
	...
	$SQL = "insert into $BannerTable (banner_no, mart_id, info,  img, img_width, img_height, link, date, 
