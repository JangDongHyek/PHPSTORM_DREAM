...
if($sea_num && $sung_num && $khan_num){
	$add_query = " and sea_num='$sea_num' and sung_num='$sung_num' and khan_num='$khan_num' ";
}
elseif($sea_num && $sung_num && !$khan_num){
	$add_query = " and sea_num='$sea_num' and sung_num='$sung_num' ";
}
elseif($sea_num && !$sung_num && !$khan_num){
	$add_query = " and sea_num='$sea_num'";
}
      ...
      <tr>
        ...
        <td valign="top" ><div align="right">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><div align="right"><img src="../img/top_icon.gif" width="13" height="15" align="absmiddle"> <span class="text_gray2_t">현재페이지</span><span class="text_gray2"> : <a href="../index.html">HOME</a> &gt; </span><span class="text_gray2_c">그룹장검색 </span> </div></td>
            </tr>
            <tr>
              <td height="28">&nbsp;</td>
            </tr>
	...
	<tr valign="top">
		 <td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="50" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>그룹장검색 결과 </b></td>
				</tr>
			</table>
          				...
          				<tr>
            				...
            				<td width="40%" bgcolor="#FFFFFF" align="center">
								...
								?>
									...
									<input class="aa" type="text" name="last_num" value='<?=$last_num?>' size="3"  readonly>
									<?}?>
								<?
								}
								?>
						...
						<tr>
          				...
          				<tr>
            				...
            				<td width="40%" bgcolor="#FFFFFF" align="left">
            					<input class="aa" type="text" name="gr_tel" value='<?=$gr_tel?>' size="15" <?=$readonly?>>	
							</td>
            				<td width="10%" bgcolor="#C8DFEC"  align="center">
								휴대폰
							</td>
            				<td width="40%" bgcolor="#FFFFFF" align="left">
            					<input class="aa" type="text" name="gr_mobile" value='<?=$gr_mobile?>' size="15" <?=$readonly?>>					
            				</td>
          				</tr>
          				<tr>
            				<td width="10%" bgcolor="#C8DFEC" align="center">
          				...
          				<tr>
            				<td bgcolor="#C8DFEC" align="center">사진</td>
            				<td bgcolor="#FFFFFF" colspan='3'>&nbsp;&nbsp;<?=$cate_target_img?> 
							</td>
          				</tr>  
