...
?>
					<table width="680" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td align="right"><a href='board_list.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src="../image/helpdesk/bu_list.gif" width="80" height="30" border="0"></a>
