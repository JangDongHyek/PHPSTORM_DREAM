...
if( $board_class == 1 || $board_class == 3 ){ //자신의 글 수정,삭제는 본인만
	if( $username == "$UnameSess" ){
		$mod_perm = "<a href='board_edit.php?item_no=$item_no&mart_id=$mart_id&index_no=$index_no&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'><img src='../image/helpdesk/bu_modify.gif' width='70' height='30' border='0'></a>";
	...
	$mod_perm = "<a href='board_edit.php?item_no=$item_no&mart_id=$mart_id&index_no=$index_no&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'><img src='../image/helpdesk/bu_modify.gif' width='70' height='30' border='0'></a>";
	$del_perm = "<a href='board_delete.php?item_no=$item_no&mart_id=$mart_id&flag=del&index_no=$index_no&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'><img src='../image/helpdesk/bu_delete.gif' width='70' height='30' border='0'></a>";
}
...
?>
					<table width="680" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="50">
								<?=$mod_perm?><?=$del_perm?><a href='board_reply.php?item_no=<?=$item_no?>&mart_id=<?=$mart_id?>&index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src="../image/helpdesk/bu_reply.gif" width="70" height="30" border="0"></a>
							</td>
							<td align="right"><a href='board_list.php?item_no=<?=$item_no?>&mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src="../image/helpdesk/bu_list.gif" width="80" height="30" border="0"></a><a href='board_write.php?item_no=<?=$item_no?>&mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src="../image/helpdesk/bu_write.gif" width="70" height="30" border="0"></a></td>
						</tr>
</table>
