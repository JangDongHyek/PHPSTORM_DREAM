...
if( $board_class == 1 || $board_class == 3 ){
	if( $UnameSess ){ //로그인했을때 글쓰기 페이지 링크함
		$write_img = "<a href='board_write.php?item_no=$item_no&mart_id=$mart_id&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'><img src='../image/helpdesk/bu_write.gif' width='70' height='30' border='0'></a>";
	}else{
		$write_img = "<img src='../image/helpdesk/bu_write.gif' width='70' height='30' border='0' onclick=\"membercheck();\" style='cursor:hand'>";
	}
...
<!---------------------- FAQ 메뉴 시작 -------------------------------------------------->
						<table width="96%" align="center"  border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td height="50">&nbsp;</td>
								<td width="99"><a href="board_list.php?bbs_no=<?=$bbs_no?>&code=1"><img src="../image/helpdesk/faq_bu_01<?=$code_img1?>.gif" width="99" height="39" border="0"></a></td>
								<td width="66"><a href="board_list.php?bbs_no=<?=$bbs_no?>&code=2"><img src="../image/helpdesk/faq_bu_02<?=$code_img2?>.gif" width="66" height="39" border="0"></a></td>
								<td width="108"><a href="board_list.php?bbs_no=<?=$bbs_no?>&code=3"><img src="../image/helpdesk/faq_bu_03<?=$code_img3?>.gif" width="108" height="39" border="0"></a></td>
								<td width="125"><a href="board_list.php?bbs_no=<?=$bbs_no?>&code=4"><img src="../image/helpdesk/faq_bu_04<?=$code_img4?>.gif" width="125" height="39" border="0"></a></td>
								<td width="69"><a href="board_list.php?bbs_no=<?=$bbs_no?>&code=5"><img src="../image/helpdesk/faq_bu_05<?=$code_img5?>.gif" width="69" height="39" border="0"></a></td>
							    <td width="115"><a href="board_list.php?bbs_no=<?=$bbs_no?>&code=6"><img src="../image/helpdesk/faq_bu_06<?=$code_img6?>.gif" width="115" height="39" border="0"></a></td>
							</tr>
						</table>
<!---------------------- FAQ 메뉴 끝 ---------------------------------------------------->
						<table width="96%" align="center"  border="0" cellspacing="0" cellpadding="0">
...
?>
									<a href='board_list.php?item_no=<?=$item_no?>&bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=1&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src='../image/helpdesk/arrow_1_big.gif' width='21' height='14' align='absmiddle' border='0'></a>
<?
}
?>
<?
if($start_page > 1){
?>
									<a href='board_list.php?item_no=<?=$item_no?>&bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$prev_start_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src='../image/helpdesk/arrow_1.gif' width='16' height='14' align='absmiddle' border='0'></a>
<?
}else{
?>
...
if($end_page < $total_page){
?>
									<a href='board_list.php?item_no=<?=$item_no?>&bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$next_start_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src='../image/helpdesk/arrow_2.gif' width='16' height='14' align='absmiddle' border='0'></a>
<?
}else{
?>
...
if($page < $total_page){
?>
									<a href='board_list.php?item_no=<?=$item_no?>&bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$total_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src='../image/helpdesk/arrow_2_big.gif' width='21' height='14' align='absmiddle' border='0'></a>
<?
}else{
?>
