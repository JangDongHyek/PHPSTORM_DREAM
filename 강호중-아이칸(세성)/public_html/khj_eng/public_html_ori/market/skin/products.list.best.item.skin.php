...
<table width="96%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><table width="100%" border="0" align="center" cellpadding="10" cellspacing="5" bgcolor="FFDFD5">
              <tr>
                <td bgcolor="#FFFFFF"><?
...
for( $k = 0; $fav_row = mysql_fetch_array($fav_res); $k++ ){
	...
	if( $k == 0 ){
		...
		if($img[0] != "" && file_exists("$Co_img_UP$mart_id/$img[0]")){
			$target0 = "../..$Co_img_DOWN$mart_id/$img[0]";
			...
			if (strstr(strtolower(substr($img[0],-4)),'.jpg') || strstr(strtolower(substr($img[0],-4)),'.gif')){
				$img_str0 = "<img src='../..$Co_img_DOWN$mart_id/$img[0]' border='0'>";
				$a_ste0 = "../main/product_info.html?mart_id=$mart_id&category_num=$cate_num&item_no=$item_no1";
			}
		}else{
			$img_str0 = "<img src='../image/noimage_m.gif' border='0'>";
			$a_ste0 = "../main/product_info.html?mart_id=$mart_id&category_num=$cate_num&item_no=$item_no1";
		}
	}
	if( $k == 1 ){
		...
		if($img_sml[1] != "" && file_exists("$Co_img_UP$mart_id/$img_sml[1]")){
			$target1 = "../..$Co_img_DOWN$mart_id/$img[1]";
			...
			if (strstr(strtolower(substr($img_sml[1],-4)),'.jpg') || strstr(strtolower(substr($img_sml[1],-4)),'.gif')){
				$img_str1 = "<img src='../..$Co_img_DOWN$mart_id/$img[1]' border='0'>";
...
if(!$a_ste0){
	$a_ste0 = "<img src='../image/noimage_m.gif' border='0'>";
}
if(!$a_ste1){
	$a_ste1 = "<img src='../image/noimage_m.gif' border='0'>";
}
...
if( $fav_res1 ){
	...
	if($z_price_str0 == 0 && $img_str0){
		$z_price_str0 = "가격문의";
	}
		
	if($z_price_str1 == 0 && $img_str1){
		$z_price_str1 = "가격문의";
	}
?>
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="50%"><!--왼쪽 상품테이블-->
                            <table width="240"  border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="240" height="230" align="center"><a href="<?=$a_ste0?>"><?=$img_str0?></a>
																<!--
                        ...
                        <td><table width="240"  border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="240" height="230" align="center"><a href="<?=$a_ste1?>"><?=$img_str1?></a>
														<!--
