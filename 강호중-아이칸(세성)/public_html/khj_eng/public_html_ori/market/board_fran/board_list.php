...
<input type=hidden name="keyset" value="all">	
    ...
    <tr>
      ...
      <td width=35% bgcolor="#FFFFFF">
		...
		<SELECT id=sung_area name=sung_area onchange="selectChange(this, form.khan_area, arrItems2, arrItemsGrp2);"><option value=0 SELECTED>=선택=</option></SELECT>
		...
		<td align=center width=15% bgcolor="#c8dfec">상호</td> 
		</td>
		<td width=35% bgcolor="#FFFFFF">
			<input type='text' name='subject_new' value='' class='input_03' size='15'>
		</td>
    </tr>
    <tr>
      ...
      <td width=35% bgcolor="#FFFFFF">
								...
								<?
								$today = date("Y-m-d");
								$sql = "select * from gamaeng_cate where 1 order by binary(category_name)";
	...
	<tr>
      ...
      <td align=center width=15% bgcolor="#c8dfec">할인율</td>
      <td width=35% bgcolor="#FFFFFF">
								<input type='text' name='halin' value='' class='input_03' size='15'>
	  </td>
    </tr>
...
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=1&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>&nochul_end=<?=$nochul_end?>'><img src='../image/helpdesk/arrow_1_big.gif' width='21' height='14' align='absmiddle' border='0'></a>
<?
}
?>
<?
if($start_page > 1){
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$prev_start_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>&nochul_end=<?=$nochul_end?>'><img src='../image/helpdesk/arrow_1.gif' width='16' height='14' align='absmiddle' border='0'></a>
<?
}else{
?>
...
if($end_page < $total_page){
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$next_start_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>&nochul_end=<?=$nochul_end?>'><img src='../image/helpdesk/arrow_2.gif' width='16' height='14' align='absmiddle' border='0'></a>
<?
}else{
?>
...
if($page < $total_page){
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$total_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>&nochul_end=<?=$nochul_end?>'><img src='../image/helpdesk/arrow_2_big.gif' width='21' height='14' align='absmiddle' border='0'></a>
<?
}else{
?>
