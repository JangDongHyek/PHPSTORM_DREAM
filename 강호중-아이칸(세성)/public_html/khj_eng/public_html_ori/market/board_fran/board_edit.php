...
<?}?>
						...
						<tr>
							<td width="70" height="30" align="center"><b>분류</td>
						...
						<tr>
							<td width="70" height="30" align="center"><b>할인율</td>
							<td width="1"><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td><input type="text" class="input_03" size="4" name="halin" value='<?=$halin?>' style='ime-mode:active'>%
						    </td>
						</tr>
						<tr>
						  <td bgcolor="E1E1E1" height="1" colspan="4"></td>
						...
						<tr>
							<td height="30" align="center">주소</td>
							<td><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td ><input name="address" value='<?=$address?>' type="text" class="input_03" size="30" style='ime-mode:inactive' > </td>
						</tr>
						<tr>
							<td bgcolor="E1E1E1" height="1" colspan="4"></td>
						</tr>						
						...
						<tr>
							<td height="30" align="center">전화번호</td>
							<td><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td ><input name="tel" value='<?=$tel?>' type="text" class="input_03" size="30" style='ime-mode:inactive' > </td>
						</tr>
						<tr>
							<td bgcolor="E1E1E1" height="1" colspan="4"></td>
						</tr>
...
<?
	...
	$SQL = "update $New_BoardTable set writer='$writer', code='$code', email='$email', subject_new='$subject_new_tmp[0]', bunryu='$bunryu', content='$content', if_secret='$if_secret', halin='$halin' $notice_sql $end_date_sql where index_no ='$index_no' and bbs_no='$bbs_no' and mart_id='$mart_id'";
