...
$sql0 = "select * from $New_BoardTable where del_chk='n' and bbs_no = '$bbs_no'";
$result0 = mysql_query($sql0,$dbconn);
$rows0 = mysql_num_rows($result0);


$sql1 = "select * from $New_BoardTable where end_date >= '$now_date' and del_chk='n' and bbs_no = '$bbs_no'";
$result1 = mysql_query($sql1,$dbconn);
$rows1 = mysql_num_rows($result1);


//기간만료
$sql2 = "select * from $New_BoardTable where end_date < '$now_date' and del_chk='n' and bbs_no = '$bbs_no'";
...
<?if($_SESSION["MemberLevel"] == 10){?>
	...
	<table border="0" width="170" cellspacing="1" cellpadding="1" bgcolor=#808080>
								...
								<tr>
									<td width="50%" bgcolor="#8FBECD" align="center" colspan="2">
										<a href="<?=$PHP_SELF?>?nochul_end=y">게시기간 만료</a>
									</td>
									<td width="50%" bgcolor="#ffffff" align="center" colspan="2">
										<?=number_format($rows2)?>
									</td>
...
<a href="<?=$PHP_SELF?>?my_list=y&bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>"><b><img src="../images/board/view_border_butten.gif"></b></a></div>
						...
						<input type="hidden" name="page1" value="<?=$page?>">
							<tr>
								...
								<td width='60' align='center' background='../image/helpdesk/table1_bg.gif'><b>번호</b></td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='100' align='center' background='../image/helpdesk/table1_bg.gif'><b>분야</b></td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='100' align='center' background='../image/helpdesk/table1_bg.gif'><b>부분</b></td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='100' align='center' background='../image/helpdesk/table1_bg.gif'><b>상호</b></td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='100' align='center' background='../image/helpdesk/table1_bg.gif'><b>할인율</font></td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='100' align='center' background='../image/helpdesk/table1_bg.gif'><b>등록자</td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='100' align='center' background='../image/helpdesk/table1_bg.gif'><b>등록일</td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='60' align='center' background='../image/helpdesk/table1_bg.gif'><b>조회수</td>
...
<?
	...
	$SQL1 = "select count(*) from $New_BoardTable where $open_chk_query and del_chk='n' and bbs_no = '$bbs_no' $end_date_query $open_auth_query  $add_query $add_query2   "; 
	...
	$SQL1 = "select * from $New_BoardTable where $open_chk_query and del_chk='n' and bbs_no = '$bbs_no' $end_date_query $open_auth_query  $add_query $add_query2  "; 
	$SQL2 = "and binary $keyset like '%$searchword%' ";
	$SQL2_1 = "and (binary writer like '%$searchword%' or binary subject_new like '%$searchword%' or binary content like '%$searchword%') ";
...
?>
							<tr height='30' align='center'>
								...
								<td class='help' align='center'>
																...
																<?
								$sql9 = "select * from gamaeng_cate where category_num='$bunryu'";
								...
								<td align='center'><?=$halin?>%</td>
								<td align='center'><?=$member_img?></td>
								<td align='center' class='point'><?=$write_date_str?></td>
								<td align='center' class='point'><?=$read_num?></td>
							</tr>
							<tr>
								<td bgcolor='E1E1E1' height='1' colspan='8'></td>
							</tr>
