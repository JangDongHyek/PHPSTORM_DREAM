		...
		<td>
					...
					<table border="0" width="100%" cellpadding=1 cellspacing=1>
              			...
              			<tr>
                			<td width="100%" bgcolor="#FFFFFF" colspan="6">
								<input type=radio name="content" value="10">10일
								<input type=radio name="content" value="20">20일
								<input type=radio name="content" value="30">30일
      	...
      	<tr>
        	<td width="100%" bgcolor="#FFFFFF" valign="top" align="center"><br>
				<input type=submit style='width:60' type="submit" value="연장하기" style='cursor:hand'>&nbsp;&nbsp;
...
if($flag=="add"){
	...
	//회원기간도 추출해서 insert하기
	$sql = "insert into request_update_board (seq_num,firstno,prevno,thirdno,category_num,item_no,content,content2,update_yn,regdate,index_no,bbs_no) values ('','$firstno','$prevno','$thirdno','$category_num','$item_no','$content','$content2','n','$regdate','$index_no','$bbs_no')";
	$res = mysql_query($sql,$dbconn);


	echo "
		<script>
			alert('기간을 연장하였습니다.');window.close();
		</script>
	";
	exit;
}
