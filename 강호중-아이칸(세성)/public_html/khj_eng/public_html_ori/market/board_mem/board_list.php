     ...
     <tr>
      <td align=center width=15% bgcolor="#c8dfec">정보구분</td> 
        <td width=35% bgcolor="#FFFFFF">
			<select name="jungbo_gubun">
				<option value="">=선택=</option>
				<option value="sell">판매정보</option>
				<option value="buy">구입정보</option>
				<option value="gujik">구직정보</option>
				<option value="guin">구인정보</option>
			</select>
		</td>
       <td align=center width=15% bgcolor="#c8dfec">기타</td> 
        <td width=35% bgcolor="#FFFFFF">
			<input type=checkbox name="my_search" value='y'>내회원 정보검색&nbsp;
			<input type=checkbox name="daegi_search" value='y'>승인대기검색
		</td>
	</tr>
<?}else{?>
     <tr>
...
<?}?>
	...
	<tr>
      ...
      <td width=35% bgcolor="#FFFFFF">
		...
		<SELECT id=sung_area name=sung_area onchange="selectChange(this, form.khan_area, arrItems2, arrItemsGrp2);">
		<option value=0 SELECTED>=선택=</option></SELECT>

		<SELECT id=khan_area name=khan_area ><option value=0 SELECTED>=선택=</option></SELECT>
		  
		&nbsp;
			
		</td>
		<td align=center width=15% bgcolor="#c8dfec">단위</td> 
		</td>
		<td width=35% bgcolor="#FFFFFF">
			<input type='text' name='danwi' value='' class='input_03' size='15'>
		</td>
    </tr>
    <tr>
      ...
      <td width=35% bgcolor="#FFFFFF">
								<input type='text' name='bubun' value='' class='input_03' size='15'>
	  </td>
    </tr>
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">작성자/내용</td> 
      <td width=35% bgcolor="#FFFFFF">
								<input type='text' name='searchword' value='<?=$searchword?>' class='input_03' size='15'>		
	  </td>
      <td align=center width=15% bgcolor="#c8dfec">금액</td>
      <td width=35% bgcolor="#FFFFFF">
								<input type='text' name='price' value='' class='input_03' size='15'>
	  </td>
    </tr>
...
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=1&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>'><img src='../image/helpdesk/arrow_1_big.gif' width='21' height='14' align='absmiddle' border='0'></a>
<?
}
?>
<?
if($start_page > 1){
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$prev_start_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>'><img src='../image/helpdesk/arrow_1.gif' width='16' height='14' align='absmiddle' border='0'></a>
<?
}else{
?>
...
if($end_page < $total_page){
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$next_start_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>'><img src='../image/helpdesk/arrow_2.gif' width='16' height='14' align='absmiddle' border='0'></a>
<?
}else{
?>
...
if($page < $total_page){
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$total_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>'><img src='../image/helpdesk/arrow_2_big.gif' width='21' height='14' align='absmiddle' border='0'></a>
<?
}else{
?>
