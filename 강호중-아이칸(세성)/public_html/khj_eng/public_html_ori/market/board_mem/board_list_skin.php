						...
						<input type="hidden" name="page1" value="<?=$page?>">
							<tr>
								...
								<td width='100' align='center' background='../image/helpdesk/table1_bg.gif'><b>정보구분</b></td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='100' align='center' background='../image/helpdesk/table1_bg.gif'><b>분야</b></td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='240' align='center' background='../image/helpdesk/table1_bg.gif'><b>부분</b></td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='80' align='center' background='../image/helpdesk/table1_bg.gif'><b>가격</font></td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='80' align='center' background='../image/helpdesk/table1_bg.gif'><b>등록자</td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>

								<td width='80' align='center' background='../image/helpdesk/table1_bg.gif'><b>등록일</td>
								<td width='1'><img src='../image/helpdesk/table1_line.gif' width='2' height='40'></td>
...
?>
							<tr height='30' align='center'>
								...
								?>								
								<?=$j_str?><a href='board_read.php?index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&mart_id=<?=$mart_id?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>'><?if($row[notice_no] >= '100000'){?><b><?}?><?=$bubun?></a> <?=$secret_str?><?=$new_string?>
