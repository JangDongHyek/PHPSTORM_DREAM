...
$goyu_num = $rows[country_num].$rows[sea_num].$rows[sung_num].$rows[khan_num].$rows[sudong_num];
...
<table width="850" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#D4D4D4">
    ...
    <tr>
      <td align=center width=15% bgcolor="#c8dfec">정보구분</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			...
			<input type=radio name="jungbo_gubun" value="gujik">구직정보
			<input type=radio name="jungbo_gubun" value="guin">구인정보
		</td>
    </tr>
    <tr>
      <td align=center width=15% bgcolor="#c8dfec">분야</td> 
      ...
      <td align=center width=15% bgcolor="#c8dfec">부분</td>
      <td width=35% bgcolor="#FFFFFF">
		 <input type=text name="bubun" id="bubun" value="">
	  </td>
    </tr>
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">부분선택<br>(선택하세요)</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
	...
	<tr>
      <td align=center bgcolor="#c8dfec">단위</td> 
      <td bgcolor="#FFFFFF"><input type="text" class="input_03" size="12" name="danwi" value='<?=$danwi?>'></td>
      <td align=center bgcolor="#c8dfec">금액</td>
      <td bgcolor="#FFFFFF"><input type="text" class="input_03" size="12" name="price" value='<?=$price?>'>원</td>
    </tr>
	<tr>
      <td align=center bgcolor="#c8dfec">기간선택</td> 
      <td bgcolor="#FFFFFF">
			<input type=radio name="gigan_day" value="10" onclick="addDay('<?=date("Ymd")?>','10');">10일:<input type=text name="gigan_money10" id="gigan_money10" value="<?=$gigan_money10?>" size=7 readonly>원<br>
			<input type=radio name="gigan_day" value="20" onclick="addDay('<?=date("Ymd")?>','20');">20일:<input type=text name="gigan_money20" id="gigan_money20" value="<?=$gigan_money20?>" size=7 readonly>원<br>
			<input type=radio name="gigan_day" value="30" onclick="addDay('<?=date("Ymd")?>','40');">30일:<input type=text name="gigan_money30" id="gigan_money30" value="<?=$gigan_money30?>" size=7 readonly>원

	  </td>
      <td align=center bgcolor="#c8dfec">게시기간</td>
      <td bgcolor="#FFFFFF">
	...
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">작성자</td> 
	...
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">주소</td> 
	...
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">회원번호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3><input name="address" value='<?=$address?>' type="text" class="input_03" size="50" style='ime-mode:inactive' readonly> <input type=radio name="open_address" value="n" checked>비공개 <input type=radio name="open_address" value="y">공개</td>
    </tr>
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">거래용주소</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
...
<SELECT id=khan_area name=khan_area ></SELECT>
	  ...
	  <input type=radio name="open_address2" value="n" checked>비공개 <input type=radio name="open_address2" value="y">공개</td>
    </tr>
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">이메일</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3><input name="email" value='<?=$email?>' type="text" class="input_03" size="30" style='ime-mode:inactive' readonly> <input type=radio name="open_email" value="n" checked>비공개 <input type=radio name="open_email" value="y">공개</td>
    </tr>
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">전화번호</td> 
	...
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">계좌정보</td> 
	...
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">회원번호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3><input name="goyu_num" value='<?=$goyu_num?>' type="text" class="input_03" size="10" style='ime-mode:inactive' readonly> <input type=radio name="open_num" value="n" checked>비공개 <input type=radio name="open_num" value="y">공개</td>
    </tr>
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">내용</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
...
?>
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">첨부파일1</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type='file' name='userfile' size="50" class="input_03">
	  </td>
    </tr>
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">첨부파일2</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
