...
?>
							<tr height='30' align='center'>
								...
								<td width='80'><a href='board_read.php?index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&mart_id=<?=$mart_id?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>'><?=$row[ext8]?></td>
								<td width='80'><?=$row[ext11]?></td>
								<td width='80'><?=$row[ext1]?></td>
								<td width='80'><?=$row[ext9]?></td>
