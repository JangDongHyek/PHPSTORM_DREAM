...
?>
					...
					<table width="680" align="center"  border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td width="70" height="30" align="center">분류</td>
						...
						<tr>
							<td width="70" height="30" align="center">가격</td>
							<td width="1"><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
...
?>
						...
						<tr>
							<td width="70" height="30" align="center">거래용주소</td>
							<td width="1"><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td><?=$address2?>
...
?>
						...
						<tr>
							<td width="70" height="30" align="center">이메일</td>
							<td width="1"><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td><?=$email?></td>
						</tr>
...
?>
						...
						<tr>
							<td width="70" height="30" align="center">취미</td>
							<td width="1"><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td><?=$hobby?></td>
						</tr>
...
?>
						...
						<tr>
							<td width="70" height="30" align="center">계좌정보</td>
							<td width="1"><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td><?=$my_bank_name?> <?=$my_bank_account?> (예금주:<?=$my_bank_master?>) </td>
						</tr>
<?}?>
		...
		?>
						...
						<tr>
							<td height="30" align="center">게시기간</td>
							<td><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
