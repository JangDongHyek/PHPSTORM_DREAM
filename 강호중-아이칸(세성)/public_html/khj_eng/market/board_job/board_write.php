...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0" class="box2">
    ...
    <tr>
     ...
     <tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="address22" id="address22" value="">
		</td>
    </tr>
	<tr>
      <td align=center width=15% class="title">이름</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext5" id="ext5" value="">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">전화번호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext6" id="ext6" value="">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">사업자번호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext7" id="ext7" value="">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">회사상호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext8" id="ext8" value="">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">급여</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext9" id="ext9" value="">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">경력</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext10" id="ext10" value="">
		</td>
    </tr>
	<tr>
...
<table width="60%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="50" align="center"><input type='image' onfocus='blur();' src="../image/helpdesk/info_write.gif" border="0">&nbsp;&nbsp;&nbsp;<a href="board_list.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>"><img src="../image/helpdesk/bu_cancel.gif" border="0"></a></td>
						</tr>
					</table>
					</form>
<!---------------------- 게시판 끝 ------------------------------------------------------>
...
*/
	...
	$SQL = "insert into $New_BoardTable (index_no, firstno, prevno, thirdno, category_num, country_num,sea_num,sung_num,khan_num,bbs_no, notice_no, mart_id, code, username, writer, passwd, write_date, ansno, step, thread, email, subject_new, content, userfile, userfile1, if_secret, writer_ip, area, address,address2,tel,hobby,goyu_num,open_num,open_address,open_address2,open_tel,open_hobby,open_email,my_bank_name,my_bank_account,my_bank_master,open_bank,end_date,open_auth,del_chk,bunryu,bubun,price,jungbo_gubun,gigan_day,danwi,sea_area,sung_area,khan_area,ext1,ext2,ext3,ext4,ext5,ext6,ext7,ext8,ext9,ext10,ext11) values ('$index_no', '$firstno', '$prevno', '$thirdno', '$category_num','$country_num','$sea_num','$sung_num','$khan_num', '$bbs_no', '$max_notice', '$mart_id', '$code', '$_SESSION[Mall_Admin_ID]', '$writer', '$passwd', '$write_date', '1', '0', '$thread', '$email', '$subject_new_tmp[0]', '$content', '$file', '$file1', '$if_secret', '$REMOTE_ADDR', '$item_no', '$address22','$address2','$tel','$hobby','$goyu_num','$open_num','$open_address','$open_address2','$open_tel','$open_hobby','$open_email','$my_bank_name','$my_bank_account','$my_bank_master','$open_bank','$end_date','n','n','$bunryu','$bubun','$price','$jungbo_gubun','$gigan_day','$danwi','$sea_area','$sung_area','$khan_area','$ext1','$ext2','$ext3','$ext4','$ext5','$ext6','$ext7','$ext8','$ext9','$ext10','$ext11')";
