      ...
      <td align=center width=15% class="title">정보구분</td> 
        <td width=35% bgcolor="#FFFFFF" colspan=3>
			<select name="jungbo_gubun">
				...
				<option value="gujik" <?if($jungbo_gubun=="gujik"){echo "selected";}?>>구직정보</option>
				<option value="guin" <?if($jungbo_gubun=="guin"){echo "selected";}?>>구인정보</option>
			</select>		</td>
    </tr>
<?}?>
	...
	<tr>
      ...
      <td width=35% bgcolor="#FFFFFF">
								<input type='text' name='price' value='' class='input_03' size='15'>	  </td>
    </tr>
</table>
<br>
<div align=center>
