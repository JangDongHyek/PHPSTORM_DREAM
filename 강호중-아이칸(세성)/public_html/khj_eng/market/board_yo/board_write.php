...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0" class="box2">
    ...
    <tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="address22" id="address22" value="" size=12>
		</td>
    </tr>
    ...
    <tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext9" id="ext9" value="" size=4>박
			<input type=text name="ext10" id="ext10" value="" size=4>일
			<input type=text name="ext8" id="ext8" value="" size=10>원
		</td>
    </tr>
