...
function codeAddress(event) {
  ...
  geocoder.geocode( {'address': address}, function(results, status) {
   ...
   { alert("입력하신 주소가 올바르지 않습니다." + status); 
   }
  });
}
...
<body onload="initialize()<?if($address_pop){?>;codeAddress()<?}?>">
  <div id="map_canvas" style="width:98%; height:85%"></div>
  <p> 주소 : <input type="text" size="60" id="addr1" name="address" value="<?=$address_pop?>">  <input name="submit" type="submit" value="Search" onclick='codeAddress(); return false;' /> </p>
  <br>
 </body>
</html>
