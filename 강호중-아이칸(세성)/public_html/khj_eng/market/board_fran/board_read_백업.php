...
<table width="850" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#D4D4D4">
    ...
    <tr>
      <td align=center width=15% bgcolor="#c8dfec">분류</td> 
      <td width=35% bgcolor="#FFFFFF">
<?
$SQL5 = "select * from gamaeng_cate where category_num='$bunryu' and mart_id='$mart_id'";
...
?>
	...
	<tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3><?=$ary[subject_new]?>
	...
	<tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3><?=$halin?>%</td>
    </tr>				
				
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">작성자</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3><?=$member_img?>
...
?>
	...
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">지역</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
...
-->	  
	...
	<tr>
      <td align=center width=15% bgcolor="#c8dfec">연락처</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3><?=$tel?></td>
    </tr>	
	...
	<tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3><?=$address?>
	  <?$addr = str_replace("부산시 진구","부산시 부산진구",$address);?>
		...
		?>
						<tr>
						  <td align=center width=15% bgcolor="#c8dfec">등록일</td> 
						  <td width=85% bgcolor="#FFFFFF" colspan=3><?=$write_date_str?></td>
						</tr>
		<?
		}
		?>
						<tr>
						  <td align=center width=15% bgcolor="#c8dfec">조회수</td> 
						  <td width=85% bgcolor="#FFFFFF" colspan=3><?=$read_num?></td>
						</tr>
						
						<tr>
						  <td align=center width=15% bgcolor="#c8dfec">게시기간</td> 
						  <td width=85% bgcolor="#FFFFFF" colspan=3><?=$end_date?> 까지</td>
						</tr>
<? 
		if( $userfile ){ 
?>
						...
						<tr>
						  <td align=center width=15% bgcolor="#c8dfec">사진1</td> 
						  <td width=85% bgcolor="#FFFFFF" colspan=3><a href='<?=$target?>' target="_blank"><?=$userfile?></a> (<?=$size?>)&nbsp;</td>
						</tr>	
<?
		}
?>
...
?>
						...
						<tr>
						  <td align=center width=15% bgcolor="#c8dfec">사진1</td> 
						  <td width=85% bgcolor="#FFFFFF" colspan=3><a href='<?=$target1?>' target="_blank"><?=$userfile1?></a> (<?=$size1?>)&nbsp;</td>
						</tr>	
<?
		}
?>
					...
					<table width="680" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							*/
							...
							<a href='board_list.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>'><img src="../image/helpdesk/bu_list.gif" width="80" height="30" border="0"></a>
