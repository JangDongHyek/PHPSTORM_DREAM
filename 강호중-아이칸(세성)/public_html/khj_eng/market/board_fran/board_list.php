...
<table width="1152" border="0" align="center" cellpadding="0" cellspacing="0" class="box2">
...
<input type=hidden name="keyset" value="all">	
    ...
    <tr>
      ...
      <td width=35% bgcolor="#FFFFFF">
		...
		<td align=center width=15% class="title">상호</td> 
		<td colspan="2"><input type='text' name='subject_new' value='' class='input_03' size='15'></td>
				
	</tr>

	<tr>
      <td align=center width=15% class="title">작성자/내용</td> 
      <td width=35% bgcolor="#FFFFFF">
								<input type='text' name='searchword' value='<?=$searchword?>' class='input_03' size='15'>	  </td>
      <td align=center width=15% class="title">할인율</td>
      <td width=35% bgcolor="#FFFFFF">
								<input type='text' name='halin' value='' class='input_03' size='15'>	  </td>
    </tr>
	<tr>
      <td align=center width=15% class="title">유효검색</td> 
      <td width=35% bgcolor="#FFFFFF" colspan=3>
								<input type='radio' name='view_type' value='' <?if($view_type==""){echo"checked";}?>>전체보기
								<input type='radio' name='view_type' value='on' <?if($view_type=="on"){echo"checked";}?>>유효기간
								<input type='radio' name='view_type' value='off' <?if($view_type=="off"){echo"checked";}?>>유효기간만료	  </td>
    </tr>
</table>
<br>
<div align=center>
...
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=1&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>&nochul_end=<?=$nochul_end?>'><img src='../image/helpdesk/arrow_1_big.gif' align='absmiddle' border='0'></a>
<?
}
?>
<?
if($start_page > 1){
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$prev_start_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>&nochul_end=<?=$nochul_end?>'><img src='../image/helpdesk/arrow_1.gif' align='absmiddle' border='0'></a>
<?
}else{
?>
...
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$i?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>&nochul_end=<?=$nochul_end?>'><?=$i?></a>
<?
	}
}
?>
...
if($end_page < $total_page){
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$next_start_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>&nochul_end=<?=$nochul_end?>'><img src='../image/helpdesk/arrow_2.gif' align='absmiddle' border='0'></a>
<?
}else{
?>
...
if($page < $total_page){
?>
									<a href='board_list.php?bbs_no=<?=$bbs_no?>&mart_id=<?=$mart_id?>&page=<?=$total_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>&bunryu=<?=$bunryu?>&searchword_area1=<?=$searchword_area1?>&searchword_area2=<?=$searchword_area2?>&nochul_end=<?=$nochul_end?>'><img src='../image/helpdesk/arrow_2_big.gif' align='absmiddle' border='0'></a>
<?
}else{
?>
