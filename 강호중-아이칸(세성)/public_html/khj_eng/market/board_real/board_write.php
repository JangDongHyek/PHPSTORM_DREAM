...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0" class="box2">
	...
	<tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext1" id="ext1" value="">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">용도</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext2" id="ext2" value="">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">공시지가</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext3" id="ext3" value="">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">준공일자</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext4" id="ext4" value="">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">가격</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			임대(보증금:<input type=text name="ext5" id="ext5" value="">만원 임대료:<input type=text name="ext6" id="ext6" value="">만원)<br>
			전세<input type=text name="ext7" id="ext7" value="">만원<br>
			매매<input type=text name="ext8" id="ext8" value="">만원
		</td>
    </tr>
	<tr>
