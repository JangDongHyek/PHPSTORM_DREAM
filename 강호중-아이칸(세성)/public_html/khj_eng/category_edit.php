...
<?
						...
						<tr>
            				...
            				<td width="90%" bgcolor="#FFFFFF" align="left" colspan=3>
								<input name='charge_price' type=text size=15 class=b_input id="charge_price"  value='<?=$charge_price?>' required='required' itemname='충전금액설정'>
							</td>
						</tr>
						...
						<tr>
            				...
            				<td width="90%" bgcolor="#FFFFFF" align="left" colspan=3>
								<input name='charge_gigan' type=text size=15 class=b_input id="charge_gigan"  value='<?=$charge_gigan?>' required='required' itemname='회원기간설정'>
							</td>
							</td>
						</tr>
