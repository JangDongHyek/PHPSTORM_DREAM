...
<?
	...
	$SQL = "update $New_BoardTable set writer='$writer', code='$code', email='$email', subject_new='$subject_new_tmp[0]', bunryu='$bunryu', content='$content', if_secret='$if_secret', halin='$halin' $notice_sql $end_date_sql where index_no ='$index_no' and bbs_no='13' and mart_id='$mart_id'";
