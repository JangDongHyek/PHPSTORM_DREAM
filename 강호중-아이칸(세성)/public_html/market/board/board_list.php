...
//========================== 회원제 게시판일때 회원만 글쓰기 가능하게 함 =======
	...
	if($_SESSION["MemberLevel"] == 10){ 
		$write_img = "<a href='board_write.php?mart_id=$mart_id&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'><img src='../image/helpdesk/bu_write.gif' width='70' border='0'></a>";
	}
...
<!---------------------- 검색 시작 ------------------------------------------------------>
						<table width='98%' align="center"  border='0' cellspacing='0' cellpadding='0'>
							...
							<input type="hidden" name="bbs_no" value="<?=$bbs_no?>">
								<td width='10'><img src='../image/helpdesk/table2_left.gif' width='10' height='40' class="hidden-sm"></td>
								<td align='center' background='../image/helpdesk/table2_bg.gif' class="bg_none"><img src='../image/helpdesk/search_type.gif' hspace='10' align='absmiddle' style="margin-bottom: 4px;"><br class="visible-sm">
									...
									<input type='text' name='searchword' value='<?=$searchword?>' class='input_03' size='15'><input type='image' src='../image/bu_search3.gif' hspace='10' border='0' align='absmiddle' onfocus='blur();'><a href='<?=$PHP_SELF?>?&bbs_no=<?=$bbs_no?>&page=<?=$page?>'><img src='../image/bu_cancel2.gif' border='0' align='absmiddle' onfocus='blur();'></a>
                                    <br class="visible-sm">
								...
								<td width='10'><img src='../image/helpdesk/table2_right.gif' width='10' height='40' class="hidden-sm"></td>
