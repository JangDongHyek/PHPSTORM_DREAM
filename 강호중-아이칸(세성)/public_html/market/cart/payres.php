...
while($ok_row = mysql_fetch_array($ok_res)){
	...
	$quantity = $ok_row[quantity];
		...
		if(isset($opt)&&$opt!=""&&$opt!="!!"){
					...
					if($opts[3] != ""){
						$opts4_1=explode("^",$opts[3]);
					}
					if($opts[4] != ""){
						$opts5_1=explode("^",$opts[4]);
					}


		}
		$sum = ($z_price+$opts1_1[2]+$opts2_1[2]+$opts3_1[2]+$opts4_1[2]+$opts5_1[2])*$quantity;
...
if(isset($opt)&&$opt!=""&&$opt!="!!"){
			...
			if($opts[0] != ""){		
				...
				if($opts1_1[2] == 0){
					echo "<br>&nbsp;$opts1_1[0] : $opts1_1[1]";
				}elseif($opts1_1[2] < 0){
					echo "<br>&nbsp;$opts1_1[0] : $opts1_1[1]($opts1_1[2] 원)";
				}else{
					echo "<br>&nbsp;$opts1_1[0] : $opts1_1[1](+$opts1_1[2] 원)";
				}
			...
			if($opts[1] != ""){
				...
				if($opts2_1[2] == 0){
					echo "<BR>&nbsp;$opts2_1[0] : $opts2_1[1]";
				}elseif($opts2_1[2] < 0){
					echo "<BR>&nbsp;$opts2_1[0] : $opts2_1[1]($opts2_1[2] 원)";
				}else{
					echo "<BR>&nbsp;$opts2_1[0] : $opts2_1[1](+$opts2_1[2] 원)";
				}			
			}
			if($opts[2] != ""){
				...
				if($opts3_1[2] == 0){
					echo "<BR>&nbsp;$opts3_1[0] : $opts3_1[1]";
				}elseif($opts3_1[2] < 0){
					echo "<BR>&nbsp;$opts3_1[0] : $opts3_1[1]($opts3_1[2] 원)";
				}else{
					echo "<BR>&nbsp;$opts3_1[0] : $opts3_1[1](+$opts3_1[2] 원)";
				}			
			}
			...
			if($opts[3] != ""){
				...
				if($opts4_1[2] == 0){
					echo "<BR>&nbsp;$opts4_1[0] : $opts4_1[1]";
				}elseif($opts4_1[2] < 0){
					echo "<BR>&nbsp;$opts4_1[0] : $opts4_1[1]($opts4_1[2] 원)";
				}else{
					echo "<BR>&nbsp;$opts4_1[0] : $opts4_1[1](+$opts4_1[2] 원)";
				}			
			}
			...
			if($opts[4] != ""){
				...
				if($opts5_1[2] == 0){
					echo "<BR>&nbsp;$opts5_1[0] : $opts5_1[1]";
				}elseif($opts5_1[2] < 0){
					echo "<BR>&nbsp;$opts5_1[0] : $opts5_1[1]($opts5_1[2] 원)";
				}else{
					echo "<BR>&nbsp;$opts5_1[0] : $opts5_1[1](+$opts5_1[2] 원)";
				}			
			}
