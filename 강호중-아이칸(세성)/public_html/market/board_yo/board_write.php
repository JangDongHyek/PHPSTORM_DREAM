...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box2">
    ...
    <tr>
	  ...
	  <!--
		...
		$big_value = 6;
		?>
		<select class="select_01" name=bunryu onchange="location.href='<?=$PHP_SELF?>?big_value=<?=$big_value?>&bunryu='+this.options[this.selectedIndex].value">
      ...
      <td width=35% bgcolor="#FFFFFF">
		 ...
		 <select class="select_01" name=bubun onchange="location.href='<?=$PHP_SELF?>?big_value=<?=$big_value?>&bunryu=<?=$bunryu?>&bubun='+this.options[this.selectedIndex].value">
    ...
    <tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="address22" id="address22" value="" size=12 class="input_03">
		</td>
    </tr>


    <tr>
      <td align=center width=15% class="title">여행기간</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
          <p class="flex"><input type=text name="ext9" id="ext9" value="" size=4 class="input_03">박</p>
          <p class="flex"><input type=text name="ext10" id="ext10" value="" size=4 class="input_03">일</p>
          <p class="flex"><input type=text name="ext8" id="ext8" value="" size=10 class="input_03">원</p>
		</td>
    </tr>
	...
	<td align=center width=15% class="title">게시기간선택</td> 
      <td bgcolor="#FFFFFF">
      	<div class="bb10">
            ...
            <div class="rb2 flex"><input type=text name="gigan_money10" id="gigan_money10" value="<?=$rows[gigan_money10]?>" size=7 readonly class="input_03">원</div>
        </div>
      	...
      	<div class="bb10">
            ...
            <div class="rb2 flex"><input type=text name="gigan_money20" id="gigan_money20" value="<?=$rows[gigan_money20]?>" size=7 readonly class="input_03">원</div>
        </div>
      	...
      	<div class="bb10">
            ...
            <div class="rb2 flex"><input type=text name="gigan_money30" id="gigan_money30" value="<?=$rows[gigan_money30]?>" size=7 readonly class="input_03">원</div>
        </div>
    ...
    <tr>
      <td align=center width=15% class="title">식사</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3 class="flex">
			<!--<input type=checkbox name="ext3" id="ext3" value="조식">조식
			<input type=checkbox name="ext4" id="ext4" value="중식">중식
			<input type=checkbox name="ext5" id="ext5" value="석식">석식-->
            
        <div class="check_box">    
          <div class="check_ico">
          <input type="checkbox" name="ext3" id="ext3" value="조식">
          <label class="check_label" for="ext3">조식</label>
          </div>
          <div class="check_ico">
          <input type="checkbox" name="ext4" id="ext4" value="중식">
          <label class="check_label" for="ext4">중식</label>
          </div>
          <div class="check_ico">
          <input type="checkbox" name="ext5" id="ext5" value="석식">
          <label class="check_label" for="ext5">석식</label>
          </div>
        </div>    
    ...
    <tr>
      <td align=center width=15% class="title">짐참물</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext6" id="ext6" value="" class="input_03">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">이동수단</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
