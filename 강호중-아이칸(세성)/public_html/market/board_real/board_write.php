...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box2">
    ...
    <tr>
	  ...
	  <!--
		...
		$big_value = 8;
		?>
		<select class="select_01" name=bunryu onchange="location.href='<?=$PHP_SELF?>?bbs_no=<?php echo $bbs_no?>&big_value=<?=$big_value?>&bunryu='+this.options[this.selectedIndex].value">
      ...
      <td width=35% bgcolor="#FFFFFF">
		 ...
		 <select class="select_01" name=bubun onchange="location.href='<?=$PHP_SELF?>?bbs_no=<?php echo $bbs_no?>&big_value=<?=$big_value?>&bunryu=<?=$bunryu?>&bubun='+this.options[this.selectedIndex].value">
	...
	<tr>
      <td align=center width=15% class="title">면적</td>
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext1" id="ext1" value="" class="input_03">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">용도</td>
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext2" id="ext2" value="" class="input_03">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">공시지가</td>
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext3" id="ext3" value="" class="input_03">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">준공일자</td>
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext4" id="ext4" value="" class="input_03">
		</td>
    </tr>
    <tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3>
      	<ul class="rb_li">
			<li><strong>임대</strong>
                <br class="visible-sm">
                <span class="flex"> (보증금 : &nbsp;<input type=text name="ext5" id="ext5" value="" class="input_03">만원 &nbsp;</span>
                <span class="flex">/&nbsp; 임대료 : &nbsp;<input type=text name="ext6" id="ext6" value=""  class="input_03">만원)</span></li>
			<li><span class="flex"><strong>전세</strong><input type=text name="ext7" id="ext7" value=""  class="input_03">만원</span></li>
			<li><span class="flex"><strong>매매</strong><input type=text name="ext8" id="ext8" value=""  class="input_03">만원</span></li>
         </ul>
		</td>
    </tr>
	<tr>
	...
	<tr>
      <td align=center width=15% class="title">상세설명</td>
      <td width=85% bgcolor="#FFFFFF" colspan=3>
