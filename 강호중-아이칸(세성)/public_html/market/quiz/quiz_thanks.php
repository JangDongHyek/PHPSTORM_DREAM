    	...
    	<table border="0" width="500">
      	...
      	<tr>
        	<td width="100%" height="10">
        		<p align="center"><span class="bb"><br>
        		<br>
        		<br>
        		<br>
        		응모하여 주셔서 감사합니다.<br>
        		...
        		<span class="zz">
        		<strong>
        		<input class="bb" onclick="window.location.href='../main/index.php?mart_id=<?=$mart_id?>'" style="background-color: white; color: #7B7D7B; height: 18px; border: 1px solid #7B7D7B" type="button" value="첫화면">
        		</strong>
        		</span>
        	</td>
      	</tr>
