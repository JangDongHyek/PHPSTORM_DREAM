...
<!---------------------- 게시판 시작 ---------------------------------------------------->
					...
					<input type="hidden" name="sudong_num" value="<?=$sudong_num?>">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box2">
    ...
    <tr>
	  ...
	  <!--
		...
		$big_value = 5;
		?>
		<select class="select_01" name=bunryu onchange="location.href='<?=$PHP_SELF?>?bbs_no=<?=$bbs_no?>&big_value=<?=$big_value?>&bunryu='+this.options[this.selectedIndex].value">
      ...
      <td width=35% bgcolor="#FFFFFF">
		 ...
		 <select class="select_01" name=bubun onchange="location.href='<?=$PHP_SELF?>?bbs_no=<?=$bbs_no?>&big_value=<?=$big_value?>&bunryu=<?=$bunryu?>&bubun='+this.options[this.selectedIndex].value">
    ...
    <tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3>
          ...
          <div class="radio_box">
              <div class="radio_ico">
              <input type="radio" name="jungbo_gubun" id="sell" value="sell">
              <label class="radio_label" for="sell">판매정보</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="jungbo_gubun" id="buy" value="buy">
              <label class="radio_label" for="buy">구입정보</label>
              </div>
          </div>
	...
	<tr>
      ...
      <td bgcolor="#FFFFFF" class="flex"><input type="text" class="input_03" size="12" name="price" value='<?=$price?>'>원</td>
    </tr>
	<?
	...
	<tr>
      ...
      <td bgcolor="#FFFFFF">
      	<div class="bb10">
            ...
            <div class="rb2 flex"><input type=text name="gigan_money10" id="gigan_money10" value="<?=$rows[gigan_money10]?>" size=10 readonly class="input_03">원</div>
        </div>
        ...
        <div class="bb10">    
            ...
            <div class="rb2 flex">
            <input type=text name="gigan_money20" id="gigan_money20" value="<?=$rows[gigan_money20]?>" size=10 readonly class="input_03">원
            </div>
         </div>
        ...
        <div class="bb10">    
            ...
            <div class="rb2 flex">
            <input type=text name="gigan_money30" id="gigan_money30" value="<?=$rows[gigan_money30]?>" size=10 readonly class="input_03">원
            </div>
        </div> 
	...
	<tr>
      ...
      <div class="radio_box rb">
          <div class="radio_ico">
          <input type="radio" name="open_tel" id="n3" value="n">
          <label class="radio_label" for="n3">비공개</label>
          </div>
          <div class="radio_ico">
          <input type="radio" name="open_tel" id="y3" value="y">
	...
	<tr>
      ...
      <div class="radio_box rb">
          <div class="radio_ico">
          <input type="radio" name="open_mobile" id="n6" value="n">
          <label class="radio_label" for="n6">비공개</label>
          </div>
          <div class="radio_ico">
          <input type="radio" name="open_mobile" id="y6" value="y">
          <label class="radio_label" for="y6">공개</label>
          </div>
      </div>
      </td>
    </tr>
...
?>
	...
	<!--<tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type='file' name='userfile1' size="50" class="">
	  </td>
    </tr>-->
...
*/
	...
	$SQL = "insert into $New_BoardTable (index_no, firstno, prevno, thirdno, category_num, country_num,sea_num,sung_num,khan_num,bbs_no, notice_no, mart_id, code, username, writer, passwd, write_date, ansno, step, thread, email, subject_new, content, userfile, userfile1, if_secret, writer_ip, area, address,address2,tel,mobile,hobby,goyu_num,open_num,open_address,open_address2,open_tel,open_mobile,open_hobby,open_email,my_bank_name,my_bank_account,my_bank_master,open_bank,end_date,open_auth,del_chk,bunryu,bubun,price,jungbo_gubun,gigan_day,danwi,sea_area,sung_area,khan_area) values ('$index_no', '$firstno', '$prevno', '$thirdno', '$category_num','$country_num','$sea_num','$sung_num','$khan_num', '$bbs_no', '$max_notice', '$mart_id', '$code', '$_SESSION[Mall_Admin_ID]', '$writer', '$passwd', '$write_date', '1', '0', '$thread', '$email', '$subject_new_tmp[0]', '$content', '$file', '$file1', '$if_secret', '$REMOTE_ADDR', '$item_no', '$address','$address2','$tel','$mobile','$hobby','$goyu_num','$open_num','$open_address','$open_address2','$open_tel','$open_mobile','$open_hobby','$open_email','$my_bank_name','$my_bank_account','$my_bank_master','$open_bank','$end_date','y','n','$bunryu','$bubun','$price','$jungbo_gubun','$gigan_day','$danwi','$sea_area','$sung_area','$khan_area')";
