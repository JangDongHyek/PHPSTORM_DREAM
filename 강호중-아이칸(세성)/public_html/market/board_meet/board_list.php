...
<?
	...
	if($address){
		$address_qry=" and address like '%$address%'";
	}

	if($address22){
		$address22_qry=" and address22 like '%$address22%'";
	}



	$SQL1 = "select count(*) from $New_BoardTable where bbs_no='$bbs_no' $open_chk_query and code='$code' and mart_id='$mart_id' $address_qry $address22_qry"; 
	...
	$SQL1 = "select * from $New_BoardTable where bbs_no='$bbs_no' $open_chk_query and code='$code' and mart_id='$mart_id' $address_qry $address22_qry"; 
	$SQL2 = "and binary $keyset like '%$searchword%' ";
	$SQL2_1 = "and (binary writer like '%$searchword%' or binary subject_new like '%$searchword%' or binary content like '%$searchword%') ";
...
<input type=hidden name="my_list" value="<?=$my_list?>">	
	...
	<tr>
      ...
      <td width=35% bgcolor="#FFFFFF">
		...
		<td colspan="2"><input type='text' name='address22' value='' class='input_03' size='15'></td>		
	</tr>
...
<?}?>
	...
	<tr>
      <td align=center width=15% class="title">관련검색</td> 
      <td width=35% bgcolor="#FFFFFF">
								<input type='text' name='searchword' value='<?=$searchword?>' class='input_03' size='15'>	  </td>
        <td align=center width=15% class="title">만남장소</td>
      <td width=35% bgcolor="#FFFFFF">
								<input type='text' name='address' value='<?=$address?>' class='input_03' size='15'>	  </td>
