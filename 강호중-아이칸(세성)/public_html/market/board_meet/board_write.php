...
$sum_sql = "select sum(bonus) as bonus_total from $BonusTable where  id='$goyu_num'";
...
function board_checkform(){
	...
	if(f.meet_point.value == ''){
		alert("포인트를 입력해주세요.")
		f.meet_point.focus();
		return;
	}

	//if(f.meet_point.value > <?=$bonus_total_str?>){
		//alert("잔여포인트가 부족합니다.")
		//f.meet_point.focus();
		//return;
	//}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box2">
	...
	<tr>
      ...
      <td width=35% bgcolor="#FFFFFF"><input type="text" class="input_03" size="20" name="writer" value='<?=$item_name?>' style='ime-mode:active'></td>
	        <td align=center width=15% class="title">성별</td>
      <td width=35% bgcolor="#FFFFFF">
          <!--<input type=radio name="ext1" id="ext1" value="남" <?if($sex=="남"){echo "checked";}?>>남
          <input type=radio name="ext1" id="ext13" value="여" <?if($sex=="여"){echo "checked";}?>>여-->
         
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="ext1" id="ext1" value="남" <?if($sex=="남"){echo "checked";}?>>
              <label class="radio_label" for="ext1">남</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext1" id="ext13" value="여" <?if($sex=="여"){echo "checked";}?>>
              <label class="radio_label" for="ext13">여</label>
              </div>
          </div>
	</td>
    </tr>
	<tr>
      ...
      <td width=35% bgcolor="#FFFFFF"><input name="goyu_num" value='<?=$goyu_num?>' type="text" class="input_03" size="15" style='ime-mode:inactive' readonly> 
         <!-- <input type=radio name="open_num" value="n" checked>비공개 
          <input type=radio name="open_num" value="y">공개-->
      
          <div class="radio_box radio_box2 rb">
              <div class="radio_ico">
              <input type="radio" name="open_num" id="n" value="n">
              <label class="radio_label" for="n">비공개</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="open_num" id="y" value="y">
              <label class="radio_label" for="y">공개</label>
              </div>
          </div>
      
      </td>
      <td align=center width=15% class="title">포인트</td> 
      <td width=35% bgcolor="#FFFFFF"><input name="meet_point" value='<?=$meet_point?>' type="text" class="input_03" size="15" style='ime-mode:inactive'>
          <br class="visible-sm">※포인트를 입력하세요.</td>
    </tr>
...
<input name="address" value='<?=$address?>' type="text" class="input_03" size="50" style='ime-mode:inactive' readonly>
...
<!--
      ...
      <div class="radio_box rb">
          <div class="radio_ico">
          <input type="radio" name="open_address" id="n2" value="n">
          <label class="radio_label" for="n2">비공개</label>
          </div>
          <div class="radio_ico">
          <input type="radio" name="open_address" id="y2" value="y">
    ...
    <tr>
      <td align=center width=15% class="title">예명및암구호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext2" id="ext2" value="" class="input_03">
		</td>
    </tr>

    <tr>
      <td align=center width=15% class="title">계좌번호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext3" id="ext3" value="<?=$my_bank_name?> <?=$my_bank_account?> <?=$my_bank_master?>" size=40  class="input_03"> 
            <!--<input type=radio name="open_bank" value="n" checked>비공개 
            <input type=radio name="open_bank" value="y">공개-->
            
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="open_bank" id="n3" value="n">
              <label class="radio_label" for="n3">비공개</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="open_bank" id="y3" value="y">
    ...
    <tr>
      <td align=center width=15% class="title">생년월일</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext4" id="ext4" value="<?=$birth?>" size=12  class="input_03"> 
            <!--<input type=radio name="open_birth" value="n" checked>비공개 
            <input type=radio name="open_birth" value="y">공개-->
            
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="open_birth" id="n4" value="n">
              <label class="radio_label" for="n4">비공개</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="open_birth" id="y4" value="y">
              <label class="radio_label" for="y4">공개</label>
              </div>
          </div>
		</td>
    </tr>
	...
	<tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3><input name="tel" value='<?=$tel?>' type="text" class="input_03" size="30" style='ime-mode:inactive' readonly> 
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="open_tel" id="n5" value="n">
              <label class="radio_label" for="n5">비공개</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="open_tel" id="y5" value="y">
	...
	<tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3><input name="mobile" value='<?=$mobile?>' type="text" class="input_03" size="30" style='ime-mode:inactive' readonly> 
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="open_mobile" id="n8" value="n">
              <label class="radio_label" for="n8">비공개</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="open_mobile" id="y8" value="y">
              <label class="radio_label" for="y8">공개</label>
              </div>
          </div>
      </td>
    </tr>
	...
	?>
	<td align=center width=15% class="title">게시기간선택</td> 
      <td bgcolor="#FFFFFF">
			<!--<input type=radio name="gigan_day" value="10" onclick="addDay('<?=date("Ymd")?>','10');">10일:
            <input type=text name="gigan_money10" id="gigan_money10" value="<?=$rows[gigan_money10]?>" size=7 readonly>원<br>
			<input type=radio name="gigan_day" value="20" onclick="addDay('<?=date("Ymd")?>','20');">20일:
            <input type=text name="gigan_money20" id="gigan_money20" value="<?=$rows[gigan_money20]?>" size=7 readonly>원<br>
			<input type=radio name="gigan_day" value="30" onclick="addDay('<?=date("Ymd")?>','40');">30일:
            <input type=text name="gigan_money30" id="gigan_money30" value="<?=$rows[gigan_money30]?>" size=7 readonly>원-->
        ...
        <div class="bb10">    
            <div class="radio_ico">
         	  ...
         	  <label class="radio_label" for="30">1년 : </label>
            </div>
	...
	<tr>
      <td align=center width=15% class="title">기타내용</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
...
$SQL = "insert into $New_BoardTable (index_no, firstno, prevno, thirdno, category_num, country_num,sea_num,sung_num,khan_num,bbs_no, notice_no, mart_id, code, username, writer, passwd, write_date, ansno, step, thread, email, subject_new, content, userfile, userfile1, if_secret, writer_ip, area, address,address2,tel,mobile,hobby,goyu_num,open_num,open_address,open_address2,open_tel,open_mobile,open_hobby,open_email,open_birth,open_file1,open_file2,my_bank_name,my_bank_account,my_bank_master,open_bank,end_date,open_auth,del_chk,bunryu,bubun,price,jungbo_gubun,gigan_day,danwi,sea_area,sung_area,khan_area,ext1,ext2,ext3,ext4,ext5,ext6,ext7,ext8,ext9,ext10,ext11,meet_point) values ('$index_no', '$firstno', '$prevno', '$thirdno', '$category_num','$country_num','$sea_num','$sung_num','$khan_num', '$bbs_no', '$max_notice', '$mart_id', '$code', '$_SESSION[Mall_Admin_ID]', '$writer', '$passwd', '$write_date', '1', '0', '$thread', '$email', '$subject_new_tmp[0]', '$content', '$file', '$file1', '$if_secret', '$REMOTE_ADDR', '$item_no','$address22','$address2','$tel','$mobile','$hobby','$goyu_num','$open_num','$open_address','$open_address2','$open_tel','$open_mobile','$open_hobby','$open_email','$open_birth','$open_file1','$open_file2','$my_bank_name','$my_bank_account','$my_bank_master','$open_bank','$end_date','y','n','$bunryu','$bubun','$price','$jungbo_gubun','$gigan_day','$danwi','$sea_area','$sung_area','$khan_area','$ext1','$ext2','$ext3','$ext4','$ext5','$ext6','$ext7','$ext8','$ext9','$ext10','$ext11','$meet_point')";
