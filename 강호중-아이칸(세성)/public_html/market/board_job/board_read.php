...
<tr>
	...
	<tr>
      <td align=center class="title">구분</td> 
      <td bgcolor="#FFFFFF" colspan=3><?=$ext11?></td>
    </tr>
	<tr>
      <td align=center class="title">모집구분</td> 
      <td bgcolor="#FFFFFF"><?=$ext1?></td>
      <td align=center class="title">성별</td>
      <td bgcolor="#FFFFFF"><?=$ext2?></td>
    </tr>
	<tr>
      <td align=center class="title">연령대</td> 
      <td bgcolor="#FFFFFF" colspan=3>
			<?=$ext3?>
	  </td>
	...
	<tr>
      <td align=center class="title">이름</td> 
      <td bgcolor="#FFFFFF" colspan=3><?=$ext5?></td>
    </tr>
    <?
    if($ary[open_num] == 'y'){
        ?>
...
<?}?>
<tr>
      <td align=center class="title">사업자번호</td> 
      <td bgcolor="#FFFFFF"><?=$ext7?></td>
      <td align=center class="title">상호</td>
      <td bgcolor="#FFFFFF"><?=$ext8?>원</td>
    </tr>
	<tr>
      <td align=center class="title">급여</td> 
      <td bgcolor="#FFFFFF"><?=$ext9?></td>
      <td align=center class="title">경력</td>
      <td bgcolor="#FFFFFF"><?=$ext10?>원</td>
    </tr>
	<tr>
					...
					<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							*/
							...
							<?
							//자기글일때 수정요청,삭제요청	
							if($username == $_SESSION[Mall_Admin_ID] || $_SESSION[Admin_type]=="jjob"){
							?>
							...
							<?
							//자기글일때 수정요청,삭제요청	
							}elseif($_SESSION[Admin_type]=="jjob" && $_SESSION[Admin_level]=="3"){
							?>
								<span style="cursor:hand;" onclick="javascript:window.open('./request_update.php?bbs_no=<?=$bbs_no?>&index_no=<?=$index_no?>','','width=500,height=500,top=100,left=200');"><img src="../images/board/modify_butten.gif" border=0></span>
