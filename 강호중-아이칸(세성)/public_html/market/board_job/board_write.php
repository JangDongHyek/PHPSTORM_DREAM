...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box2">
	  ...
	  <!--
		...
		$big_value = 7;
		?>
		<select name=bunryu onchange="location.href='<?=$PHP_SELF?>?big_value=<?=$big_value?>&bunryu='+this.options[this.selectedIndex].value" class="select_01">
      ...
      <td width=35% bgcolor="#FFFFFF">
		 ...
		 <select name=bubun onchange="location.href='<?=$PHP_SELF?>?big_value=<?=$big_value?>&bunryu=<?=$bunryu?>&bubun='+this.options[this.selectedIndex].value" class="select_01">
	...
	<tr>
	  ...
	  <!--<input type=radio name="open_address" value="n" checked>비공개 
      <input type=radio name="open_address" value="y">공개-->
    
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="open_address" id="n" value="n">
              <label class="radio_label" for="n">비공개</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="open_address" id="y" value="y">
              <label class="radio_label" for="y">공개</label>
              </div>
          </div>
      </td>
    </tr>
    ...
    <tr>
        ...
        <td width=85% bgcolor="#FFFFFF" colspan=3><input name="goyu_num" value='<?=$goyu_num?>' type="text" class="input_03" size="15" style='ime-mode:inactive' readonly>       <!--<input type=radio name="open_num" value="n" checked>비공개 <input type=radio name="open_num" value="y">공개-->


            <div class="radio_box rb">
                <div class="radio_ico">
                    <input type="radio" name="open_num" id="n5" value="n">
                    <label class="radio_label" for="n5">비공개</label>
                </div>
                <div class="radio_ico">
                    <input type="radio" name="open_num" id="y5" value="y">
                    <label class="radio_label" for="y5">공개</label>
                </div>
            </div>
        </td>
    </tr>
	...
	<tr>
      ...
      <td bgcolor="#FFFFFF">
			<!--<input type=radio name="gigan_day" value="10" onclick="addDay('<?=date("Ymd")?>','10');">10일:
            <input type=text name="gigan_money10" id="gigan_money10" value="<?=$rows[gigan_money10]?>" size=7 readonly class="input_03">원<br>
			<input type=radio name="gigan_day" value="20" onclick="addDay('<?=date("Ymd")?>','20');">20일:
            <input type=text name="gigan_money20" id="gigan_money20" value="<?=$rows[gigan_money20]?>" size=7 readonly class="input_03">원<br>
			<input type=radio name="gigan_day" value="30" onclick="addDay('<?=date("Ymd")?>','40');">30일:
            <input type=text name="gigan_money30" id="gigan_money30" value="<?=$rows[gigan_money30]?>" size=7 readonly class="input_03">원-->
            
      	<div class="bb10">
            <div class="radio_ico">
         	  <input type="radio" name="gigan_day" id="10" value="1" onclick="addDay('<?=date("Ymd")?>','1');">
         	  <label class="radio_label" for="10">일 : </label>
            </div>
            <div class="rb2"><input type=text name="gigan_money10" id="gigan_money10" value="<?=$rows[gigan_money10]?>" size=7 readonly class="input_03">원</div>
        </div>
        
        <div class="bb10">    
            <div class="radio_ico">
         	  <input type="radio" name="gigan_day" id="20" value="30" onclick="addDay('<?=date("Ymd")?>','30');">
         	  <label class="radio_label" for="20">월 : </label>
            </div>
            
            <div class="rb2">
            <input type=text name="gigan_money20" id="gigan_money20" value="<?=$rows[gigan_money20]?>" size=7 readonly class="input_03">원
            </div>
         </div>
         
        <div class="bb10">    
            <div class="radio_ico">
         	  <input type="radio" name="gigan_day" id="30" value="365"  onclick="addDay('<?=date("Ymd")?>','365');">
         	  <label class="radio_label" for="30">년 : </label>
            </div>
      ...
      <td bgcolor="#FFFFFF">
		<?=date("Y-m-d");?> ~ <input name='end_date' type=date size=15 class="b_input input_03" id="end_date"  value='<?=$end_date?>' required='required' itemname='등록일'>	  
	  </td>
    </tr>
	
	
	<tr>
      <td align=center width=15% class="title">구분</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<!--<input type=radio name=ext11 value="구인" checked>구인
			<input type=radio name=ext11 value="구직">구직-->
            
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="ext11" id="g1" value="구인">
              <label class="radio_label" for="g1">구인</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext11" id="g2" value="구직">
              <label class="radio_label" for="g2">구직</label>
              </div>
          </div>
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">직원선택</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<!--<input type=radio name=ext1 value="정직원" checked>정직원
			<input type=radio name=ext1 value="인턴사원">인턴사원
			<input type=radio name=ext1 value="아르바이트">아르바이트
			<input type=radio name=ext1 value="일용직">일용직-->
            
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="ext1" id="j1" value="정직원">
              <label class="radio_label" for="j1">정직원</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext1" id="j2" value="인턴사원">
              <label class="radio_label" for="j2">인턴사원</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext1" id="j3" value="아르바이트">
              <label class="radio_label" for="j3">아르바이트</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext1" id="j4" value="일용직">
              <label class="radio_label" for="j4">일용직</label>
              </div>
          </div>
     ...
     <tr>
      <td align=center width=15% class="title">성별선택</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<!--<input type=radio name=ext2 value="남" checked>남
			<input type=radio name=ext2 value="여">여
			<input type=radio name=ext2 value="무관">무관-->
            
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="ext2" id="w1" value="남">
              <label class="radio_label" for="w1">남</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext2" id="w2" value="여">
              <label class="radio_label" for="w2">여</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext2" id="w3" value="무관">
              <label class="radio_label" for="w3">무관</label>
              </div>
          </div>
    ...
    <tr>
      <td align=center width=15% class="title">연령선택</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<!--<input type=radio name=ext3 value="20대" checked>20대
			<input type=radio name=ext3 value="30대">30대
			<input type=radio name=ext3 value="40대">40대
			<input type=radio name=ext3 value="50대">50대
			<input type=radio name=ext3 value="무관">무관-->
            
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="ext3" id="e1" value="20대">
              <label class="radio_label" for="e1">20대</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext3" id="e2" value="30대">
              <label class="radio_label" for="e2">30대</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext3" id="e3" value="40대">
              <label class="radio_label" for="e3">40대</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext3" id="e4" value="50대">
              <label class="radio_label" for="e4">50대</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="ext3" id="e5" value="무관">
              <label class="radio_label" for="e5">무관</label>
              </div>
          </div>
		</td>
    </tr>
     ...
     <tr>
      ...
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="address22" id="address22" value="" class="input_03">
		</td>
    </tr>
	<tr>
      <td align=center width=15% class="title">이름</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext5" id="ext5" value="" class="input_03">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">전화번호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input name="tel" value='<?=$tel?>' type="text" class="input_03" size="30" style='ime-mode:inactive' readonly> 
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="open_tel" id="n2" value="n">
              <label class="radio_label" for="n2">비공개</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="open_tel" id="y2" value="y">
              <label class="radio_label" for="y2">공개</label>
              </div>
          </div>
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">휴대전화</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input name="mobile" value='<?=$mobile?>' type="text" class="input_03" size="30" style='ime-mode:inactive' readonly> 
          <div class="radio_box rb">
              <div class="radio_ico">
              <input type="radio" name="open_mobile" id="n3" value="n">
              <label class="radio_label" for="n3">비공개</label>
              </div>
              <div class="radio_ico">
              <input type="radio" name="open_mobile" id="y3" value="y">
              <label class="radio_label" for="y3">공개</label>
              </div>
          </div>
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">사업자번호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext7" id="ext7" value="" class="input_03">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">회사상호</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext8" id="ext8" value="" class="input_03">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">급여</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext9" id="ext9" value="" class="input_03">
		</td>
    </tr>
    <tr>
      <td align=center width=15% class="title">경력</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
			<input type=text name="ext10" id="ext10" value="" class="input_03">
		</td>
    </tr>
	<tr>
	...
	<tr>
      <td align=center width=15% class="title">사진/동영상</td> 
      <td width=85% bgcolor="#FFFFFF" colspan=3>
		<input type='file' name='userfile[]' size="50" class="" multiple>
	  </td>
    </tr>
...
<?if($_SESSION["Mall_Admin_ID"]){?>
							<input type='image' onfocus='blur();' src="../image/helpdesk/info_write.gif" border="0">
							&nbsp;&nbsp;&nbsp;<a href="board_list.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>"><img src="../image/helpdesk/bu_cancel.gif" border="0"></a>
<?}else{?>
							<img onclick="javascript:alert('칸에 등록 후 이용가능합니다.');" src="../image/helpdesk/info_write.gif" border="0">
...
*/
	...
	$SQL = "insert into $New_BoardTable (index_no, firstno, prevno, thirdno, category_num, country_num,sea_num,sung_num,khan_num,bbs_no, notice_no, mart_id, code, username, writer, passwd, write_date, ansno, step, thread, email, subject_new, content, userfile, userfile1, if_secret, writer_ip, area, address,address2,tel,mobile,hobby,goyu_num,open_num,open_address,open_address2,open_tel,open_mobile,open_hobby,open_email,my_bank_name,my_bank_account,my_bank_master,open_bank,end_date,open_auth,del_chk,bunryu,bubun,price,jungbo_gubun,gigan_day,danwi,sea_area,sung_area,khan_area,ext1,ext2,ext3,ext4,ext5,ext6,ext7,ext8,ext9,ext10,ext11) values ('$index_no', '$firstno', '$prevno', '$thirdno', '$category_num','$country_num','$sea_num','$sung_num','$khan_num', '$bbs_no', '$max_notice', '$mart_id', '$code', '$_SESSION[Mall_Admin_ID]', '$writer', '$passwd', '$write_date', '1', '0', '$thread', '$email', '$subject_new_tmp[0]', '$content', '$file', '$file1', '$if_secret', '$REMOTE_ADDR', '$item_no', '$address22','$address2','$tel','$mobile','$hobby','$goyu_num','$open_num','$open_address','$open_address2','$open_tel','$open_mobile','$open_hobby','$open_email','$my_bank_name','$my_bank_account','$my_bank_master','$open_bank','$end_date','y','n','$bunryu','$bubun','$price','$jungbo_gubun','$gigan_day','$danwi','$sea_area','$sung_area','$khan_area','$ext1','$ext2','$ext3','$ext4','$ext5','$ext6','$ext7','$ext8','$ext9','$ext10','$ext11')";
	...
	foreach ($_FILES['userfile']['name'] as $f => $name) {   
		$name = $_FILES['userfile']['name'][$f];
		$filename=FileUploadName( "", "$upload_dir", $_FILES['userfile']['tmp_name'][$f], $name );
		$no = $f+1;
		$sql="insert into new_board_file set 
				bbs_no='$bbs_no',
				index_no='$index_no',
				file_no='$no',
				file_name='$filename'";
	...
	if( $return == "product" ){
        ...
        //23.10.27 글작성완료시 alert하고 링크이동
        echo "
			<script>
				window.alert('글을 작성했습니다');
				window.close();
		        location.href='board_list.php?mart_id=$mart_id&bbs_no=$bbs_no';
			</script>
		";
