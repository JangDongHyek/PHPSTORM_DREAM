...
<input type=hidden name="my_list" value="<?=$my_list?>">	
	...
	<tr>
      ...
      <td width=35% bgcolor="#FFFFFF">
		...
		<td colspan="2"><input type='text' name='ext8' value='' class='input_03' size='15'></td>		
	</tr>
      ...
      <td align=center width=15% class="title">정보구분</td> 
        <td width=35% bgcolor="#FFFFFF">
			<select name="ext11" class="select_01">
				<option value="">=선택=</option>
				<option value="구직">구직정보</option>
				<option value="구인">구인정보</option>
			</select>		</td>
     ...
     <tr>
      <td align=center width=15% class="title">정보구분</td> 
        <td width=35% bgcolor="#FFFFFF" colspan=3>
			<select name="ext11" class="select_01">
				<option value="">=선택=</option>
				<option value="구직" <?if($ext11=="구직"){echo "selected";}?>>구직정보</option>
				<option value="구인" <?if($ext11=="구인"){echo "selected";}?>>구인정보</option>
			</select>		</td>
    </tr>
<?}?>
	...
	<tr>
      ...
      <td width=35% bgcolor="#FFFFFF" colspan="<?php echo $my_list=="y"?"":"3";?>"><input type='text' name='searchword' value='<?=$searchword?>' class='input_03' size='15'>
      </td>
	  <?php
