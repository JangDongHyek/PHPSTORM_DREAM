...
<tr>
	...
	<tr>
      <td align=center class="title">종목</td> 
      <td bgcolor="#FFFFFF" colspan=3><?=$ext1?></td>
    </tr>
	<tr>
      <td align=center class="title">총인원</td> 
      <td bgcolor="#FFFFFF" colspan=3><?=$ext2?></td>
    </tr>
	<tr>
      <td align=center class="title">금액</td> 
      <td bgcolor="#FFFFFF" colspan=3><?=$ext3?></td>
    </tr>
	<tr>
      <td align=center class="title">결제사인</td> 
      <td bgcolor="#FFFFFF" colspan=3><?=$ext4?></td>
    </tr>
	<tr>
