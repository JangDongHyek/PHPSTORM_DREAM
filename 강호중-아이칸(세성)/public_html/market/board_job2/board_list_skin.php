...
<script language="javascript">
						...
						<table width='85%' align="center"  border='0' cellspacing='0' cellpadding='0' class="box1">
						...
						<input type="hidden" name="page1" value="<?=$page?>">
							<tr>
								...
								<td width='240' align='center' class="title">종목</td>
								<td width='80' align='center' class="title">총인원</td>
								<td width='80' align='center' class="title">금액</td>
								<td width='80' align='center' class="title">결제싸인</td>
								<td width='80' align='center' class="title">고유번호</td>
							</tr>
						</table>
...
<?
	...
	$SQL2 = "and binary $keyset like '$searchword$searchword2%' ";
...
?>
			...
			?>
								<a href='board_read.php?index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&mart_id=<?=$mart_id?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>'><?=$row[ext1]?></a> <?=$new_string?>
			...
			if($_SESSION[Mall_Admin_ID]){		
			?>
								<a href='board_read.php?index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&mart_id=<?=$mart_id?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>'><?=$row[ext2]?>
			...
			<?}?>						
								...
								<td width='80'><?=$row[ext3]?></td>
								<td width='80'><?=$row[ext4]?></td>
								<td width='80'><?=$row[ext5]?></td>
							</tr>
							<tr>
								<td bgcolor='E1E1E1' height='1' colspan='8'></td>
							</tr>
