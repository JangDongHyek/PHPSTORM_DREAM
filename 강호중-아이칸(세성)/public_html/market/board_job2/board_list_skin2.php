<script language="javascript">
						...
						<input type="hidden" name="page1" value="<?=$page?>">
							<tr>
								...
								<td width='240' align='center' class="title">근로업체</td>
								<td width='80' align='center' class="title">공수</td>
								<td width='80' align='center' class="title">금액</td>
								<td width='80' align='center' class="title">용역업체명</td>
								<td width='80' align='center' class="title">구입협력업체명</td>
								<td width='80' align='center' class="title">상태</td>
							</tr>
						</table>
...
?>
							<tr height='30' align='center'>
								...
								<td width='80'><a href='board_read.php?index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&mart_id=<?=$mart_id?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&my_list=<?=$my_list?>'><?=$row[ext2]?></td>
								<td width='80'><?=$row[ext3]?></td>
								<td width='80'><?=$row[ext4]?></td>
								<td width='80'><?=$row[ext5]?></td>
								<td width='80'><?=$row[ext6]?></td>
								<td width='80'><?=$row[ext7]?></td>
							</tr>
							<tr>
								<td bgcolor='E1E1E1' height='1' colspan='8'></td>
							</tr>
