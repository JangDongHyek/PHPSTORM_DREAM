...
<!-- 
function input_chk(){ 
	var exchange = ed.getHtml(); //대체한 textarea에 작성한HTML값 전달
	if(exchange=="")
	{
			alert("내용을 적어주세요!");
			ed.focus();
          ...
          <tr>
            ...
            <td valign="top" background="../img/top_2_bg.gif"><div align="right">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><div align="right"><img src="../img/top_icon.gif" width="13" height="15" align="absmiddle"> <span class="text_gray2_t">현재페이지</span><span class="text_gray2"> : <a href="../good/board_frame8.html">HOME</a> &gt; </span><span class="text_gray2_c">기본설정</span> &gt; <span class="text_gray2_c">교환반품안내 설정 </span> </div></td>
                </tr>
                <tr>
                  <td height="28">&nbsp;</td>
                </tr>
			...
			<!--내용 START~~--><br>
				...
				<input type='hidden' name='flag' value='update'>
					...
					<tr>
						...
						<textarea name="exchange" id="exchange"><?=$exchange?></textarea>	
 <script>
		var ed = new easyEditor("exchange"); //초기화 id속성값
		ed.init(); //웹에디터 삽입
</script>						</td>
					</tr>
					<tr>
