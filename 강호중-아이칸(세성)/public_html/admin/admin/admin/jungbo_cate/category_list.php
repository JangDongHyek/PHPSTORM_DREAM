	...
	<tr valign="top">
		<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top" background="../img/top_2_bg.gif"><div align="right">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td><div align="right"><img src="../img/top_icon.gif" width="13" height="15" align="absmiddle"> <span class="text_gray2_t">현재페이지</span><span class="text_gray2"> : <a href="../good/board_frame8.html">HOME</a> &gt; </span><span class="text_gray2_c">정보분류 관리 </span> </div></td>
                          </tr>
                          <tr>
                            <td height="28">&nbsp;</td>
                          </tr>
			...
			<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="50" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>정보분류 관리 </b> </td>
				</tr>
		  </table>
						...
						<tr>
							<td width="90%" bgcolor="a7a7a7">
								...
								<tr>
									...
									<td width="34%" bgcolor="#FFFFFF" align="left">
										<p align="center">기간별금액
								  </td>
...
<?
//================== 1차 분류 ========================================================
$SQL = "select * from jungbo_cate_bunya where mart_id='$mart_id' and category_num > 28 and prevno='0' order by cat_order desc";
...
for ($i=0; $i<$numRows; $i++){
	...
	$cat_sql1 = "select * from jungbo_cate_bunya where mart_id='$mart_id' and prevno='$category_num' order by cat_order desc";
	...
	*/
	...
	$SQL2 = "select category_num,category_name,cat_order,if_hide,category_degree from jungbo_cate_bunya where mart_id='$mart_id' and prevno='$category_num' and category_degree='1' order by cat_order desc";
...
?>
									...
									<td align='left'>10일:<?=number_format($gigan_money10)?>원<br>
									20일:<?=number_format($gigan_money20)?>원<br>
									30일:<?=number_format($gigan_money30)?>원
									</td>
									<td align=center>
