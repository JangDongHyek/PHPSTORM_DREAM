...
//if($admin){nalog_admin_check("login.php?go=admin_counter.php?counter=$counter");}
if(!$set){nalog_error($lang[counter_main_not_exist]);}

if($mode==0){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a>";}
if($mode==1){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_hour]";}
if($mode==2){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_day]";}
if($mode==3){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_week]";}
if($mode==4){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_month]";}
if($mode==5){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_year]";}
if($mode==6){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_refer]";}
if($mode==7){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_refer_detail]";}
if($mode==8){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_os]";}
if($mode==9){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_visitor]";}
if($mode==10){$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $lang[counter_main_title_config] : $counter";}
...
if($handle && $id){
	...
	if(!trim($plugin[name])){continue;}
		...
		{
		$title="<a href=admin_counter.php?counter=$counter>$lang[counter_main_title]</a> > $plugin[name]";
		$plugin[dir]=$dir;
		$found=1;
		break;
		}
          ...
          <tr>
            ...
            <td valign="top" background="../img/top_2_bg.gif"><div align="right">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><div align="right"><img src="../img/top_icon.gif" width="13" height="15" align="absmiddle"> <span class="text_gray2_t">현재페이지</span><span class="text_gray2"> : <a href="../good/board_frame8.html">HOME</a> &gt; </span> <span class="text_gray2_c">통계관리</span> &gt; <span class="text_gray2_c">방문통계</span> </div></td>
                </tr>
                <tr>
                  <td height="28">&nbsp;</td>
                </tr>
...
?>
		...
		<td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="30" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>방문통계</b></td>
				</tr>
			</table>
...
<!----------------------------------- 내용 시작 ----------------------------------------->
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr><td colspan=2><?include"admin_menu.php"?></td></tr>
					<tr><td colspan=2>
					<?
					$plugin=$plugin_temp;
					...
					<tr><td colspan=2 height=3 bgcolor=#B2B3B5>asdas</td></tr>
