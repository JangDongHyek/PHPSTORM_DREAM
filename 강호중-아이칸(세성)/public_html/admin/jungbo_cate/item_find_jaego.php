			...
			<!--내용 START~~--><br>
				...
				<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
					<tr>
					  ...
					  상품 중 분류별 개별상품 및 원하는 상품을 검색하여 수정하실 
					  수 있습니다.<br>
							...
							<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							  <tr>
								 ...
								 <table border="0" width="103%" cellspacing="0" cellpadding="0">
									...
									<tr>
									  <td width="18%" height="25">&nbsp; 분류별 검색</td>
...
<?
$SQL = "select * from jungbo_cate where mart_id='$mart_id' and prevno=0 and if_hide='0' order by category_num desc";
...
for ($i=0; $i<$numRows; $i++) {
	...
	$SQL = "select * from jungbo_cate where mart_id='$mart_id' and prevno=$category_num and if_hide='0' order by category_num desc";
							...
							<table cellSpacing="1" cellPadding="3" width="100%" bgColor="#f7f7f7" border="0">
							  ...
							  $searchword = trim($searchword);
									...
									if($keyset == 'item_name')
										...
										where mart_id='$mart_id' and binary lower($keyset) like lower('%$searchword%') 
											UNION 
											select T1.mart_id, T1.item_no, T1.item_name, T1.item_company, T1.z_price, T1.reg_date, T1.jaego, T1.jaego_use
											from $ItemTable T1, $Gnt_ItemTable T2 
											where T2.seller_id='$Mall_Admin_ID' and T1.item_no= T2.item_no and binary lower(T1.$keyset) like lower('%$searchword%') order by $order Asc";
										if($keyset == 'category_num')
											$SQL = "select mart_id, item_no, item_name, item_company, z_price, reg_date, jaego, jaego_use 
											from $ItemTable 
										where mart_id='$mart_id' and $keyset= '$searchword' 
											UNION 
											select T1.mart_id, T1.item_no, T1.item_name, T1.item_company, T1.z_price, T1.reg_date, T1.jaego, T1.jaego_use
											from $ItemTable T1, $Gnt_ItemTable T2 
											where T2.seller_id='$Mall_Admin_ID' and T1.item_no= T2.item_no and T2.$keyset ='$searchword' order by $order Asc";
							  ...
							  <tr>
								 ...
								 <td align='middle' width='65%' bgcolor='$bgcolor'><p align='left'>
									";
									if($mart_id_tmp == $Mall_Admin_ID){
										echo "
								 <a href='win_item_edit.php?item_no=$item_no' onfocus='this.blur()' target='mainpage' onclick='OpenWindow()'>
										";
									}
									else{
										echo "
								 <a href='win_item_view_gnt_item.php?item_no=$item_no' onfocus='this.blur()' target='mainpage' onclick='OpenWindow()'>
										";
									}
									echo "
								 $item_name</a></td>
								 ...
								 <input name='jaego[]' value='$jaego' class='input_03' size='10'>
										...
										echo "
								 <input name='jaego[]' value='$jaego' class='input_03' size='10' readonly>
										";
									}
									echo "
									</td>
								 ...
								 <option value='0'
									...
									>No</option>
										...
										echo "
								 <input type='hidden' name='jaego_use[]' value='$jaego_use'>
								 <select name='jaego_use[]'  style='BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid; HEIGHT: 18px' size='1' disabled>
								 <option value='1'
										";
										if($jaego_use == '1') echo " selected";
										echo ">Yes</option>
