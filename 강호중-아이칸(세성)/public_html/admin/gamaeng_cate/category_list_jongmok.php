	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><div align="right">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td><div align="right"><img src="../img/top_icon.gif" width="13" height="15" align="absmiddle"> <span class="text_gray2_t">현재페이지</span><span class="text_gray2"> : <a href="../index.html">HOME</a> &gt; </span><span class="text_gray2_c">직업종목 관리 </span> </div></td>
                          </tr>
                          <tr>
                            <td height="28">&nbsp;</td>
                          </tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="50" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>직업종목 관리 </b> </td>
				</tr>
		  </table>
			...
			<table border="1" cellpadding="5" cellspacing="0" width="100%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
				...
				<td width="100%" bgcolor="#FFFFFF" height="3" valign="top">
					...
					<table border="0" width="100%">
						<tr>							
							<td width="100%" align=center><a href="./category_edit_jongmok.php?flag=insert">[종목등록]</a></td>
					  </tr>
					</table>
					</td>
				 </tr>
...
for ($i=0; $i<$numRows; $i++){
	...
	$cat_sql1 = "select * from job_jongmok where mart_id='$mart_id' and prevno='$category_num' order by cat_order desc";
	...
	*/
	...
	$SQL2 = "select category_num,category_name,cat_order,if_hide,category_degree from job_jongmok where mart_id='$mart_id' and prevno='$category_num' and category_degree='1' order by cat_order desc";
...
?>
									...
									<td align=center>
										...
										<input class='aa' onClick="location.href='category_edit_jongmok.php?flag=update&category_num=<?=$category_num?>'" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='수정'>
