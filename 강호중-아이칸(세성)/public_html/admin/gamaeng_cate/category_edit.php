      ...
      <tr>
        ...
        <td valign="top" background="../img/top_2_bg.gif"><div align="right">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><div align="right"><img src="../img/top_icon.gif" width="13" height="15" align="absmiddle"> <span class="text_gray2_t">����������</span><span class="text_gray2"> : <a href="../index.html">HOME</a> &gt; </span><span class="text_gray2_c">�о� ���� </span> </div></td>
            </tr>
            <tr>
              <td height="28">&nbsp;</td>
            </tr>
	...
	<tr valign="top">
		 <td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="50" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>�о� ���� </b></td>
				</tr>
			</table>
        				...
        				<table border="0" width="100%" cellspacing="1" cellpadding="3">
          				...
          				<tr>
            				...
            				<td bgcolor="#FFFFFF" colspan='3'>&nbsp;&nbsp;
								<input type=text name="gigan" value="<?=$gigan?>" size=4>��
							</td>
          				</tr>          				
