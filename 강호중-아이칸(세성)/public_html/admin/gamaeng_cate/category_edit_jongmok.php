...
<?
if($flag=="update"){
	$SQL = "select * from job_jongmok where category_num=$category_num and mart_id='$mart_id'";
...
<form action='jongmok_modify.php?category_num=<?=$category_num?>' name="up" method="post" onSubmit="return checkform(this)" enctype="multipart/form-data">
        				...
        				<table border="0" width="100%" cellspacing="1" cellpadding="3">
          				<tr>
            				...
            				<td width="21%" bgcolor="#FFFFFF" align="center">
            					<input type=text name="category_name" value="<?=$category_name?>" size=30>
							</td>
          				</tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
      			<tr>
					<td width="100%" bgcolor="#FFFFFF" valign="top"><p align="center"><br>
						...
						<input class="aa" onClick="window.location.href='category_list_job.php'" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type="button" value="목록">
    				</td>
  				</tr>
  				<tr align="center">
