...
?>
<?
$SQL = "select * from job_gubun where category_num=$category_num and mart_id='$mart_id'";
...
<form action='job_modify.php?category_num=<?=$category_num?>' name="up" method="post" onSubmit="return checkform(this)" enctype="multipart/form-data">
        				...
        				<table border="0" width="100%" cellspacing="1" cellpadding="3">
          				...
          				<tr>
            				...
            				<td bgcolor="#FFFFFF" colspan='3'>
								10일:<input type=text name="gigan_money10" value="<?=$gigan_money10?>" size=10>원<BR>
