...
$sql = "select * from item where sea_num='$sea_num' and sung_num='$sung_num' and khan_num='$khan_num' and sudong_num='$sudong_num'";
...
$sql = "select * from item where sea_num='$sea_num' and sung_num='$sung_num' and khan_num='$khan_num' and item_code='$item_code'";
$res = mysql_query($sql,$dbconn);
$count = mysql_num_rows($res);
if($count > 0){
			echo ("
...
###########################################################################################
	...
	*/
	...
	$sql09 = "SELECT * FROM category WHERE sea_num='$row0[sea_num]' AND sung_num='$row0[sung_num]' AND khan_num='$row0[khan_num]'";
