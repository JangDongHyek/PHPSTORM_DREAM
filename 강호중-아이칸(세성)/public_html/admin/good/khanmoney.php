...
?>
				<p align="center"><b>[회원 칸머니 보내기 및 내역] </b><br>
				<br>
				<!--<b>총 칸머니 : <?=number_format($bonus_total_str1);?>원 &nbsp; 사용한칸머니 : <?=number_format($bonus_total_str2);?>원</b>-->


			이체할 회원번호 : <input type=text name="" value="" size=20> <input type=submit value=" 보내기 ">
