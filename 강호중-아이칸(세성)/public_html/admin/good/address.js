var sojaeji = new Array();
    ...
    sojaeji['경기->고양시 덕양구'] = '주교동,원당동,신원동,원흥동,도내동,성사동,북한동,효자동,지축동,오금동,삼송동,동산동,용두동,벽제동,선유동,고양동,대자동,관산동,내유동,토당동,내곡동,대장동,화정동,강매동,행주내동,행주외동,신평동,행신동,화전동,현천동,덕은동,향동동,원신동,흥도동,성사1동,성사2동,신도동,창릉동,능곡동,화정1동,화정2동,행주동,행신1동,행신2동,행신3동,대덕동';
    sojaeji['경기->고양시 일산동구'] = '식사동,중산동,정발산동,장항동,마두동,백석동,풍동,산황동,사리현동,지영동,설문동,문봉동,성석동,풍산동,백석1동,백석2동,마두1동,마두2동,장항1동,장항2동,고봉동';
    sojaeji['경기->고양시 일산서구'] = '일산동,주엽동,탄현동,대화동,덕이동,가좌동,구산동,법곳동,일산1동,일산2동,일산3동,주엽1동,주엽2동,송포동,송산동';    
    ...
    sojaeji['경기->수원시 권선구'] = '세류동,평동,고색동,오목천동,평리동,서둔동,구운동,탑동,금곡동,호매실동,곡반정동,권선동,장지동,대황교동,입북동,당수동,세류1동,세류2동,세류3동,금호동,권선1동,권선2동,곡선동';
    sojaeji['경기->수원시 장안구'] = '파장동,정자동,이목동,율전동,천천동,영화동,송죽동,조원동,연무동,상광교동,하광교동,율천동,정자1동,정자2동,정자3동,조원1동,조원2동';
    sojaeji['경기->수원시 팔달구'] = '팔달로1가,팔달로2가,팔달로3가,남창동,영동,중동,구천동,남수동,매향동,북수동,신풍동,장안동,교동,매교동,매산로1가,매산로2가,매산로3가,고등동,화서동,지동,우만동,인계동,매산동,화서1동,화서2동,우만1동,우만2동,행궁동';
    sojaeji['경기->수원시 영통구'] = '매탄동,원천동,이의동,하동,영통동,신동,망포동,매탄1동,매탄2동,매탄3동,매탄4동,영통1동,영통2동,태장동';
    ...
    sojaeji['경기->양주시'] = '유양동,어둔동,남방동,마전동,산북동,광사동,만송동,삼숭동,고읍동,덕정동,봉양동,회암동,율정동,옥정동,고암동,덕계동,회정동,백석읍,은현면,남면,광적면,장흥면,양주1동,양주2동,회천1동,회천2동,회천3동,회천4동';
    ...
    sojaeji['경기->용인시 수지구'] = '풍덕천동,죽전동,동천동,고기동,신봉동,성복동,상현동,풍덕천1동,풍덕천2동,죽전1동,죽전2동,상현1동,상현2동';
    sojaeji['경기->용인시 기흥구'] = '신갈동,구갈동,상갈동,하갈동,보라동,지곡동,공세동,고매동,농서동,서천동,영덕동,언남동,마북동,청덕동,동백동,중동,상하동,보정동,기흥동,서농동,구성동';
    sojaeji['경기->용인시 처인구'] = '김량장동,역북동,삼가동,남동,유방동,고림동,마평동,운학동,호동,해곡동,포곡읍,모현면,남사면,이동면,원삼면,백암면,양지면,중앙동,역삼동,유림동,동부동';
    ...
    sojaeji['경기->파주시'] = '금촌동,아동동,금능동,야동동,검산동,맥금동,교하동,야당동,다율동,오도동,상지석동,산남동,동패동,당하동,문발동,송촌동,목동동,하지석동,서패동,신촌동,연다산동,와동동,문산읍,파주읍,법원읍,조리읍,월롱면,탄현면,광탄면,파평면,적성면,군내면,장단면,진동면,진서면,금촌1동,금촌2동,금촌3동,운정1동,운정2동,운정3동';
    ...
    sojaeji['경기->포천시'] = '신읍동,어룡동,자작동,선단동,설운동,동교동,소흘읍,군내면,내촌면,가산면,신북면,창수면,영중면,일동면,이동면,영북면,관인면,화현면,포천동';
    ...
    sojaeji['경기->화성시'] = '남양동,신남동,장덕동,안석동,활초동,온석동,무송동,북양동,송림동,수화동,장전동,신외동,문호동,시동,원천동,진안동,병점동,능동,기산동,반월동,반정동,황계동,배양동,기안동,송산동,안녕동,반송동,석우동,봉담읍,우정읍,향남읍,매송면,비봉면,마도면,송산면,서신면,팔탄면,장안면,양감면,정남면,동탄면,병점1동,병점2동,기배동,화산동,동탄1동,동탄2동,동탄3동';
    ...
    sojaeji['경남->창원시 진해구'] = '동상동,도천동,도만동,신흥동,현동,비봉동,태평동,충의동,무송동,인의동,숭인동,대영동,남빈동,앵곡동,제황산동,속천동,대죽동,안곡동,수송동,회현동,익선동,창선동,대천동,광화동,통신동,중앙동,부흥동,중평동,근화동,송죽동,화천동,송학동,대흥동,평안동,충무동,인사동,여좌동,태백동,경화동,석동,이동,자은동,덕산동,풍호동,장천동,행암동,북부동,성내동,서중동,남문동,제덕동,수도동,연도동,명동,죽곡동,원포동,남양동,마천동,소사동,대장동,두동,청안동,안골동,용원동,가주동,병암동,웅천동,웅동1동,웅동2동';
	sojaeji['경남->창원시 마산합포구'] = '가포동,교방동,교원동,남성동,대내동,대성동1가,대성동2가,대외동,대창동,덕동동,동성동,두월동1가,두월동2가,두월동3가,문화동,반월동,부림동,산호동,상남동,서성동,성호동,수성동,신월동,신창동,신포동1가,신포동2가,신흥동,완월동,월남동1가,월남동2가,월남동3가,월남동4가,월남동5가,월영동,월포동,예곡동,오동동,우산동,유록동,자산동,장군동1가,장군동2가,장군동3가,장군동4가,장군동5가,중성동,중앙동1가,중앙동2가,중앙동3가,창동,창포동1가,창포동2가,창포동3가,청계동,추산동,평화동,화영동,해운동,현동,홍문동,구산면,진동면,진북면,진전면,중앙동,동서동,노산동,합포동';
	sojaeji['경남->창원시 마산회원구'] = '구암동,두척동,봉암동,석전동,양덕동,합성동,회성동,회원동,내서읍,회원1동,회원2동,석전1동,석전2동,양덕1동,양덕2동,합성1동,합성2동,구암1동,구암2동';
	sojaeji['경남->창원시 성산구'] = '토월동,사파정동,가음정동,외동,대방동,남산동,삼정자동,천선동,불모산동,안민동,내동,남지동,상복동,완암동,창곡동,월림동,적현동,양곡동,반송동,귀산동,귀곡동,귀현동,신촌동,반지동,중앙동,반림동,상남동,성주동,웅남동,사파동,가음동,성산동,남양동';
	sojaeji['경남->창원시 의창구'] = '내리동,대산면,대원동,덕정동,도계동,동읍,동정동,두대동,명곡동,명서동,반계동,반송동,봉곡동,봉림동,북동,북면,사림동,사화동,삼동동,서곡동,서상동,소계동,소답동,신월동,용동,용지동,용호동,의창동,중동,지귀동,차용동,퇴촌동,팔룡동,팔용동';
    ...
    sojaeji['경남->양산시'] = '강서동,교동,남부동,다방동,덕계동,동면,매곡동,명곡동,명동,물금읍,북부동,북정동,산막동,삼성동,삼호동,상북면,서창동,소주동,신기동,양주동,어곡동,용당동,원동면,유산동,주남동,주진동,중부동,중앙동,평산동,하북면,호계동,';
    ...
    sojaeji['서울->성동구'] = '금호1가동,금호2/3가동,금호4가동,금호동1가,금호동2가,금호동3가,금호동4가,도선동,마장동,사근동,상왕십리동,성수1가1동,성수1가2동,성수2가1동,성수2가3동,성수동1가,성수동2가,송정동,옥수동,왕십리2동,왕십리도선동,용답동,응봉동,하왕십리동,행당1동,행당2동,행당동,홍익동';
    ...
    sojaeji['서울->용산구'] = '갈월동,남영동,도원동,동빙고동,동자동,문배동,보광동,산천동,서계동,서빙고동,신계동,신창동,용문동,용산2가동,용산동1가,용산동2가,용산동3가,용산동4가,용산동5가,용산동6가,원효로1가,원효로1동,원효로2가,원효로2동,원효로3가,원효로4가,이촌1동,이촌2동,이촌동,이태원1동,이태원2동,이태원동,주성동,청암동,청파동,청파동1가,청파동2가,청파동3가,한강로1가,한강로2가,한강로3가,한강로동,한남동,효창동,후암동,';
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function sidochange2() 
    {
        var f = document.fwrite;

        gugunview2(f.sido2.value);
        dongview2(f.sido2.value, f.gugun2.value);
    }

    function gugunchange2() 
    {
        var f = document.fwrite;
    ...
    function dongview2(sido2, gugun2)
    {
        var f = document.fwrite;

        f.dong2.options.length = 1;
        f.dong2.options[0].text = "읍/면/동(전체)";
        f.dong2.options[0].selected = true;
        if (!sido2 || !gugun2) {
            return;
        }

        sojae2 = sojaeji[sido2+"->"+gugun2].split(",");
        f.dong2.options.length = sojae2.length+1;
        for (i=0; i<sojae2.length; i++) {
            f.dong2.options[i+1].value = sojae2[i];
            f.dong2.options[i+1].text = sojae2[i];

        }
    }

    function gugunview2(sido2)
    {
        var f = document.fwrite;

        f.gugun2.options.length = 1;
        f.gugun2.options[0].text = "시/군/구(전체)";
        f.gugun2.options[0].selected = true;
        if (!sido2) {
            return;
        }

        sojae2 = sojaeji[sido2].split(",");
        f.gugun2.options.length = sojae2.length+1;
        for (i=0; i<sojae2.length; i++) {
            f.gugun2.options[i+1].value = sojae2[i];
            f.gugun2.options[i+1].text = sojae2[i];
 ...
 function sidoview2()
    {
        ...
        f.sido2.options.length = 1;
        f.sido2.options[0].text = "시/도(전체)";
        sojae2 = sojaeji["시도"].split(",");
        f.sido2.options.length = sojae2.length+1;
        for (i=0; i<sojae2.length; i++) {
            f.sido2.options[i+1].value = sojae2[i];
            f.sido2.options[i+1].text = sojae2[i];
        }
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function sidochange3() 
    {
        var f = document.fwrite;

        gugunview3(f.sido3.value);
        dongview3(f.sido3.value, f.gugun3.value);
    }

    function gugunchange3() 
    {
        var f = document.fwrite;
    ...
    function dongview3(sido3, gugun3)
    {
        var f = document.fwrite;

        f.dong3.options.length = 1;
        f.dong3.options[0].text = "읍/면/동(전체)";
        f.dong3.options[0].selected = true;
        if (!sido3 || !gugun3) {
            return;
        }

        sojae3 = sojaeji[sido3+"->"+gugun3].split(",");
        f.dong3.options.length = sojae3.length+1;
        for (i=0; i<sojae3.length; i++) {
            f.dong3.options[i+1].value = sojae3[i];
            f.dong3.options[i+1].text = sojae3[i];

        }
    }

    function gugunview3(sido3)
    {
        var f = document.fwrite;

        f.gugun3.options.length = 1;
        f.gugun3.options[0].text = "시/군/구(전체)";
        f.gugun3.options[0].selected = true;
        if (!sido3) {
            return;
        }

        sojae3 = sojaeji[sido3].split(",");
        f.gugun3.options.length = sojae3.length+1;
        for (i=0; i<sojae3.length; i++) {
            f.gugun3.options[i+1].value = sojae3[i];
            f.gugun3.options[i+1].text = sojae3[i];
 ...
 function sidoview3()
    {
        ...
        f.sido3.options.length = 1;
        f.sido3.options[0].text = "시/도(전체)";
        sojae3 = sojaeji["시도"].split(",");
        f.sido3.options.length = sojae3.length+1;
        for (i=0; i<sojae3.length; i++) {
            f.sido3.options[i+1].value = sojae3[i];
            f.sido3.options[i+1].text = sojae3[i];
        }
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function sidochange4() 
    {
        var f = document.fwrite;

        gugunview4(f.sido4.value);
        dongview4(f.sido4.value, f.gugun4.value);
    }

    function gugunchange4() 
    {
        var f = document.fwrite;
    ...
    function dongview4(sido4, gugun4)
    {
        var f = document.fwrite;

        f.dong4.options.length = 1;
        f.dong4.options[0].text = "읍/면/동(전체)";
        f.dong4.options[0].selected = true;
        if (!sido4 || !gugun4) {
            return;
        }

        sojae4 = sojaeji[sido4+"->"+gugun4].split(",");
        f.dong4.options.length = sojae4.length+1;
        for (i=0; i<sojae4.length; i++) {
            f.dong4.options[i+1].value = sojae4[i];
            f.dong4.options[i+1].text = sojae4[i];

        }
    }

    function gugunview4(sido4)
    {
        var f = document.fwrite;

        f.gugun4.options.length = 1;
        f.gugun4.options[0].text = "시/군/구(전체)";
        f.gugun4.options[0].selected = true;
        if (!sido4) {
            return;
        }

        sojae4 = sojaeji[sido4].split(",");
        f.gugun4.options.length = sojae4.length+1;
        for (i=0; i<sojae4.length; i++) {
            f.gugun4.options[i+1].value = sojae4[i];
            f.gugun4.options[i+1].text = sojae4[i];
 ...
 function sidoview4()
    {
        ...
        f.sido4.options.length = 1;
        f.sido4.options[0].text = "시/도(전체)";
        sojae4 = sojaeji["시도"].split(",");
        f.sido4.options.length = sojae4.length+1;
        for (i=0; i<sojae4.length; i++) {
            f.sido4.options[i+1].value = sojae4[i];
            f.sido4.options[i+1].text = sojae4[i];
        }
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function sidochange5() 
    {
        var f = document.fwrite;

        gugunview5(f.sido5.value);
        dongview5(f.sido5.value, f.gugun5.value);
    }

    function gugunchange5() 
    {
        var f = document.fwrite;
    ...
    function dongview5(sido5, gugun5)
    {
        var f = document.fwrite;

        f.dong5.options.length = 1;
        f.dong5.options[0].text = "읍/면/동(전체)";
        f.dong5.options[0].selected = true;
        if (!sido5 || !gugun5) {
            return;
        }

        sojae5 = sojaeji[sido5+"->"+gugun5].split(",");
        f.dong5.options.length = sojae5.length+1;
        for (i=0; i<sojae5.length; i++) {
            f.dong5.options[i+1].value = sojae5[i];
            f.dong5.options[i+1].text = sojae5[i];

        }
    }

    function gugunview5(sido5)
    {
        var f = document.fwrite;

        f.gugun5.options.length = 1;
        f.gugun5.options[0].text = "시/군/구(전체)";
        f.gugun5.options[0].selected = true;
        if (!sido5) {
            return;
        }

        sojae5 = sojaeji[sido5].split(",");
        f.gugun5.options.length = sojae5.length+1;
        for (i=0; i<sojae5.length; i++) {
            f.gugun5.options[i+1].value = sojae5[i];
            f.gugun5.options[i+1].text = sojae5[i];
 ...
 function sidoview5()
    {
        ...
        f.sido5.options.length = 1;
        f.sido5.options[0].text = "시/도(전체)";
        sojae5 = sojaeji["시도"].split(",");
        f.sido5.options.length = sojae5.length+1;
        for (i=0; i<sojae5.length; i++) {
            f.sido5.options[i+1].value = sojae5[i];
            f.sido5.options[i+1].text = sojae5[i];
        }
    }
