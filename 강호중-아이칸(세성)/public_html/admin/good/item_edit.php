...
<table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0" align=center>
	<tr valign="top">
		<td>
			...
			<tr>
				<td width="98%" bgcolor="#FFFFFF" valign="top"><br>
					<p style="padding-left: 10px" class="stitle">[회원 정보]<br><br>
				</td>
			</tr>
						...
						<tr>
						  ...
						  <tr>
			                ...
			                <td bgColor="#ffffff">
								...
								<font style='cursor:hand;' onclick="window.open('../../market/board_mem/map.php?address_pop=<?=$addr?>','','width=820,height=360,top=100,left=100,scrollbars=no')">[위치확인]</font>	
							</td>
			                <td colspan="2" align="center" class="title">
								우편번호
							</td>
			              ...
			              <tr>
			                ...
			                <td bgColor="#ffffff">
								...
								if($img_big != '' && file_exists("$Co_img_UP$mart_id/$img_big")){
									if (strstr(strtolower(substr($img_big,-4)),'.jpg')){
										?>
									<iframe src="./imgrotate.php?img_big=<?=$img_big?>" width=91 height=121 frameborder=0 scrolling=no></iframe>
									<?
									}
...
<table border="0" width="100%" cellpadding=0 cellspacing=0 class="box2">
              			...
              			<tr>
                			<td width="47%"  align="center" colspan="3" class="title">등록일</td>
...
if( $back == "ok" ){
?>
        		<img src='../images/btn_list.gif' onClick="location.href='item_list_ok.php?back=<?=$back?>&prevno=<?=$prevno?>&prevno2=<?=$prevno2?>&category_num=<?=$category_num?>&page=<?=$page?>&searchword=<?=$searchword?>&select_key=<?=$select_key?>&date_expire=<?=$date_expire?>&pu=<?=$pu?>'" style='cursor:hand;'>
				
<?
}else{
?>
<img src='../images/btn_list.gif' onClick="location.href='item_list.php?gamaeng=<?=$gamaeng?>&prevno=<?=$prevno?>&prevno2=<?=$prevno2?>&category_num=<?=$category_num_ori?>&page=<?=$page?>&searchword=<?=$searchword?>&pu=<?=$pu?>'" style='cursor:hand;'>
