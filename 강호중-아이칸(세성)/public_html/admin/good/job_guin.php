...
<BR>
				<p align="center"><b>[구인업체 검색 및 저장] </b><br>
		  ...
		  <table width="97%" border="0">
			 <tr>
				...
				<tr>
					<td align="middle" bgColor="#c8dfec">No.</td>
					<td align="middle" bgColor="#c8dfec">업체명</td>
					<td align="middle" bgColor="#c8dfec">월별근무현황</td>
				
					<!--
					<td align="middle" bgColor="#c8dfec">관리</td>
...
$SQL = "select * from my_list where my_id='$_SESSION[Mall_Admin_ID]' and type='1'";
...
for ($i=$skipNum; $i < ($cnfPagecount+$skipNum); $i++) {
	...
	$SQL2 = "select * from item where job_gubun='1' and  job_end_date >= '$now_date' and item_id='$ary[id]'";
...
?>
				<tr>
					...
					<td width='20%' bgColor='#ffffff' align='center'>
						<a href="./job_month_list.php?id=<?=$ary[id]?>">[보기]</a>  
