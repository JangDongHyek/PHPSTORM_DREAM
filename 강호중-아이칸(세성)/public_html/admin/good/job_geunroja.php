...
<BR>
				<p align="center"><b>[근로자 검색 및 저장] </b>
		...
		<tr>
		  ...
		  <table width="97%" border="0">
			 <tr>
				...
				<tr>
					<td align="left" width="12%" bgColor="#c8dfec">분야별검색</td>
...
?>
				...
				<tr>
					...
					<td align="middle" bgColor="#c8dfec" width="20%">이름</td>
					<td align="middle" bgColor="#c8dfec" width="20%">연락처</td>
					<td align="middle" bgColor="#c8dfec" width="30%">고유번호</td>
					<td align="middle" bgColor="#c8dfec" width="30%">저장</td>
					<!--
...
?>
				<tr>
					...
					<td width='30%' bgColor='#ffffff' align='center'>
						<a href="<?=$PHP_SELF?>?flag=add&guin_id=<?=$item_id?>&guenroja_type=<?=$ary[guenroja_type]?>">[저장]</a>  
		...
		<tr>
		  ...
		  <?
				if($page == 1){
					...
					echo ("
					<a href='job_geunroja.php?username=$rows[item_code]&page=1&search_category_num=$search_category_num'>처음</a> 
					");
				}
				...
				if($page == $total_page){
					...
					echo ("
					<a href='job_geunroja.php?username=$rows[item_code]&page=$total_page&search_category_num=$search_category_num'>끝</a> 
					");
				}
				?>
				</td>
		...
		<tr>
		  ...
		  <?
				if($page == 1){
					...
					echo ("
					<a href='job_geunroja.php?username=$rows[item_code]&page=1&search_category_num2=$search_category_num2'>처음</a> 
					");
				}
				...
				if($page == $total_page){
					...
					echo ("
					<a href='job_geunroja.php?username=$rows[item_code]&page=$total_page&search_category_num2=$search_category_num2'>끝</a> 
					");
				}
				?>
				</td>
