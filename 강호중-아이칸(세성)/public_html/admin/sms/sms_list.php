...
echo"<script>alert('유료서비스 입니다. 서비스 신청후 이용바랍니다. Tel.051-891-0088');history.go(-1);</script>";
          ...
          <tr>
            ...
            <td valign="top" background="../img/top_2_bg.gif"><div align="right">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><div align="right"><img src="../img/top_icon.gif" width="13" height="15" align="absmiddle" /> <span class="text_gray2_t">현재페이지</span><span class="text_gray2"> : <a href="../good/board_frame8.html">HOME</a> </span>&gt; <span class="text_gray2_c">문자전송내역</span> </div></td>
                </tr>
                <tr>
                  <td height="28">&nbsp;</td>
                </tr>
...
?>
		...
		<td>
			...
			<tr>
				<td width="100%" height="30" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>문자전송내역</b></td>
			</table>
              ...
              <tr>
                <td><div align="center">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr>
                      <td><input name="button" type="button" class="box" onClick="javascript:location.href='<?=$PHP_SELF?>?mode=list&type=<?=$type?>'" value="목록">
                      </td>
                      <td align="right"><?
