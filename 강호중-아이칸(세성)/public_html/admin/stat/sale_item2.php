                    ...
                    <td width="100%" bgcolor="#F7F7F7" height="20"><table border="0" width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="67%" height="25" align="right">
							...
							<option value="sale_item2.php" selected>상품별</option>
                ...
                <td width="100%" bgcolor="#7BBEBD"><table border="0" width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="100%" bgcolor="#7BBEBD">
						<form id=form1 action='sale_item2.php' name=form1 method=post>
...
<?          	
	...
	for($i=$skipNum; $i < ($cnfPagecount+$skipNum); $i++){	
		...
		$query = "insert into item_sale_count (uid,item_name_tmp,quantity_tot_3_str,quantity_tot_4_str,quantity_tot_5_str,quantity_tot_etc_str,sum_tot_3_str,sum_tot_4_str,sum_tot_5_str,sum_tot_etc_str) values ('','$item_name_tmp','$quantity_tot_3','$quantity_tot_4','$quantity_tot_5','$quantity_tot_etc','$sum_tot_3','$sum_tot_4','$sum_tot_5','$sum_tot_etc')";
		$dbresult_last = mysql_query($query, $dbconn);
		...
		$query2 = "select * from item_sale_count where 1 order by sum_tot_3_str desc";
		echo $query2;
		$dbresult_last2 = mysql_query($query2, $dbconn);
		for($ii = 0 ; $rows = mysql_fetch_array($dbresult_last2); $ii++){
?>	
						<tr>
							<td width='39%' height='52' align='center' bgcolor='#FFFFFF'><?=$rows[item_name_tmp]?> </td>
							<td width='15%' height='52' align='right' bgcolor='#FFFFFF'>
								<table border='0' width='100%' cellspacing='1' cellpadding='2'>
									<tr>
										<td width='12%'><img src='../images/tt-1.gif' width='11' height='11'></td>
										<td width='88%' align='right'><b><font color='#588ECD'><?=$rows[quantity_tot_3_str]?> EA</font></b</td>
									</tr>
									<tr>
										<td><img src='../images/tt-2.gif' width='11' height='10'></td>
										<td align='right'><font color='#A5BEE7'><?=$rows[quantity_tot_4_str]?> EA</font></td>
									</tr>
									<tr>
										<td><img src='../images/tt-3.gif' width='11' height='10'></td>
										<td align='right'><font color='#42BEB5'><?=$rows[quantity_tot_5_str]?> EA</font></td>
									</tr>
									<tr>
										<td><img src='../images/tt-4.gif' width='11' height='10'></td>
										<td align='right'><font color='#FFAE31'><?=$rows[quantity_tot_etc_str]?> EA</font></td>
									</tr>
								</table>
							</td>
							<td width='48%' height='52' align='left' bgcolor='#FFFFFF'>
								<table border='0' width='100%' cellspacing='1' cellpadding='2'>
									<tr>
										<td width='12%'><img src='../images/tt-1.gif' width='11' height='11'></td>
										<td width='88%' align='right'><b><font color='#588ECD'><?=$rows[sum_tot_3_str]?> 원</font></b></td>
									</tr>
									<tr>
										<td><img src='../images/tt-2.gif' width='11' height='10'></td>
										<td align='right'><font color='#A5BEE7'><?=$rows[sum_tot_4_str]?> 원</font></td>
									</tr>
									<tr>
										<td><img src='../images/tt-3.gif' width='11' height='10'></td>
										<td align='right'><font color='#42BEB5'><?=$rows[sum_tot_5_str]?> 원</font></td>
									</tr>
									<tr>
										<td><img src='../images/tt-4.gif' width='11' height='10'></td>
										<td align='right'><font color='#FFAE31'><?=$rows[sum_tot_etc_str]?> 원</font></td>
									</tr>
								</table>
							</td>
						</tr>
<?
	...
	$sql_llast = "delete from item_sale_count";
	$dbresult_llast2 = mysql_query($sql_llast, $dbconn);
?>
                  </table>
                </td>
              </tr>
...
if($page == 1){
	...
	echo ("
	<a href='sale_item2.php?page=1&flag=$flag&search_flag=$search_flag&item_name=$item_name&category_num=$category_num&order1=$order1&order2=$order2&QryFromDate=$QryFromDate&QryToDate=$QryToDate&QryMonth=$QryMonth&out_form=$out_form'>처음</a> 
	");
}

if($start_page > 1){
			echo ("
			<a href='sale_item2.php?page=$prev_start_page&flag=$flag&search_flag=$search_flag&item_name=$item_name&category_num=$category_num&order1=$order1&order2=$order2&QryFromDate=$QryFromDate&QryToDate=$QryToDate&QryMonth=$QryMonth&out_form=$out_form'>
			◁&nbsp; 
			</a>
			");
}else{
...
for($i=$start_page;$i<=$end_page;$i++){
	...
	[<b>$i</b>]
		...
		echo ("
			<a href='sale_item2.php?page=$i&flag=$flag&search_flag=$search_flag&item_name=$item_name&category_num=$category_num&order1=$order1&order2=$order2&QryFromDate=$QryFromDate&QryToDate=$QryToDate&QryMonth=$QryMonth&out_form=$out_form'>$i</a> 
		");
	}
}
if($end_page < $total_page){
	echo ("
			<a href='sale_item2.php?page=$next_start_page&flag=$flag&search_flag=$search_flag&item_name=$item_name&category_num=$category_num&order1=$order1&order2=$order2&QryFromDate=$QryFromDate&QryToDate=$QryToDate&QryMonth=$QryMonth&out_form=$out_form'>
			&nbsp;▷
			</a>
	");
}else{
...
if($page == $total_page){
	...
	echo ("
	<a href='sale_item2.php?page=$total_page&flag=$flag&search_flag=$search_flag&item_name=$item_name&category_num=$category_num&order1=$order1&order2=$order2&QryFromDate=$QryFromDate&QryToDate=$QryToDate&QryMonth=$QryMonth&out_form=$out_form'>끝</a> 
	");
}
?>
        		</td>
