...
?>
			...
			<table border="1" cellpadding="0" cellspacing="0" width="98%" bordercolordark="white"  align="center">
      			<tr>
          				...
          				<tr>
            				...
            				<td width="40%" bgcolor="#FFFFFF" align="center">
								...
								?>
									...
									<?if($_SESSION["MemberLevel"] == 10){?>
									<input class="aa" type="text" name="sea_area" value='<?=$sea_area?>' size="6" >
									<?}?>
								<?
								}elseif($category_degree==1){
								?>
									<input class="aa" type="text" name="sea_num" value='<?=$sea_num?>' size="4" maxlength=3 >
									<?if($_SESSION["MemberLevel"] == 10){?>
									<input class="aa" type="text" name="sea_area" value='<?=$sea_area?>' size="6" >
									<?}?>
									-
									...
									<?if($_SESSION["MemberLevel"] == 10){?>
									<input class="aa" type="text" name="sung_area" value='<?=$sung_area?>' size="6" >
									<?}?>
								<?
								}elseif($category_degree==2){
								?>
									...
									<?if($_SESSION["MemberLevel"] == 10){?>
									<input class="aa" type="text" name="khan_area" value='<?=$khan_area?>' size="6"  >
...
<?
						...
						<tr>
            				...
            				<td width="90%" bgcolor="#FFFFFF" align="left" colspan=3>
								<input name='login_point' type=text size=15 class=b_input id="login_point"  value='<?=$login_point?>' required='required' itemname='로그인 포인트'> 이상일때 로그인가능
							</td>
							</td>
						</tr>
