...
?>
						...
						?>>
			              ...
			              <tr>
			                ...
			                <td bgColor="#ffffff" colspan="4">
								<input type="radio" value="무료배송" name="fee" <?if($fee=="무료배송"){ echo "checked";}?>>무료배송 <input type="radio" value="착불" name="fee" <?if($fee=="착불"){ echo "checked";}?>>착불 <input type="radio" value="" name="fee" <?if($fee==""||$fee=="선불"){ echo "checked";}?>>선불 <input type="radio" value="고객선택" name="fee" <?if($fee=="고객선택"){ echo "checked";}?>>고객선택
							</td>
			              </tr>
			              <tr>
			                <td align="center" bgColor="#c8dfec" colSpan="2">
