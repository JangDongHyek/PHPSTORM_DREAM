...
?>
						...
						?>>
			              ...
			              <tr>
			                ...
			                <td bgColor="#ffffff" colspan="4">
								<input type="radio" value="무료배송" name="fee">무료배송 <input type="radio" value="착불" name="fee" >착불 <input type="radio" value="" name="fee" checked>선불 <input type="radio" value="고객선택" name="fee" checked>고객선택
							</td>
			              </tr>
			              <tr>
			                <td align='center' width="15%" bgColor="#c8dfec" colSpan="2">
...
function MakeThum1($FileName,$ori_path,$maxItem_no_1,$mart_id,$unique) 
{
		...
		exec ("convert -geometry 800x $FileName $ThumFileName600");
