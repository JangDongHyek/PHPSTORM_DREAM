		...
		<?
			...
			for ($i=0; $i<$numRows; $i++) {
				...
				echo "
								  ...
								  ";
								  if($if_flash == 0){
										 if($img!='') echo "<img src='$Co_img_DOWN$mart_id/$img' width='600' height='30'>";
									  }
									  else{
...
if($flag == "up"){
	$SQL = "select banner_order from $AdminMainTable where banner_order > $banner_order and mart_id='$mart_id' order by banner_order Asc";
	$dbresult = mysql_query($SQL, $dbconn);
	$numRows = mysql_num_rows($dbresult);
	...
	$SQL = "select banner_no from $AdminMainTable where banner_order = $up_banner_order and mart_id='$mart_id'";
	$dbresult = mysql_query($SQL, $dbconn);
	$numRows = mysql_num_rows($dbresult);
	mysql_data_seek($dbresult, 0);	
	$ary=mysql_fetch_array($dbresult);	
	...
	$SQL = "update $AdminMainTable set banner_order = $up_banner_order where banner_no = $banner_no and mart_id='$mart_id'";
	$dbresult = mysql_query($SQL, $dbconn);
	
	
	$SQL = "update $AdminMainTable set banner_order = $banner_order where banner_no = $up_banner_no and mart_id='$mart_id'";
	$dbresult = mysql_query($SQL, $dbconn);
...
if($flag == "down"){
	$SQL = "select banner_order from $AdminMainTable where banner_order < $banner_order and mart_id='$mart_id' order by banner_order Desc";
	$dbresult = mysql_query($SQL, $dbconn);
	$numRows = mysql_num_rows($dbresult);
	mysql_data_seek($dbresult, 0);	
	$ary=mysql_fetch_array($dbresult);	
	...
	$SQL = "select banner_no from $AdminMainTable where banner_order = $down_banner_order and mart_id='$mart_id'";
	$dbresult = mysql_query($SQL, $dbconn);
	$numRows = mysql_num_rows($dbresult);
	$ary=mysql_fetch_array($dbresult);	
	$down_banner_no = $ary["banner_no"];
	
	$SQL = "update $AdminMainTable set banner_order = $down_banner_order where banner_no = $banner_no and mart_id='$mart_id'";
	$dbresult = mysql_query($SQL, $dbconn);
	
	$SQL = "update $AdminMainTable set banner_order = $banner_order where banner_no = $down_banner_no and mart_id='$mart_id'";
	$dbresult = mysql_query($SQL, $dbconn);
