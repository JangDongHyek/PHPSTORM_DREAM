...
?>
							<td width="<?=intval(100/$rows_count)?>%">
								<table width=100% height=100% border=0 cellpadding=0 cellspacing=0 >
									<tr>
										<td align="center">
											<table width="<?=$gallery_img_width+20?>" height="<?=$gallery_img_height+20?>" border=0 cellpadding=0 cellspacing=0>
												...
												<tr>
													<td></td>
													<td align=center bgcolor=#F7F7F7 width=100% height=100%><a href='board_read.php?index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&mart_id=<?=$mart_id?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src="<?=$target?>" width="800" height="430" border="0"></a></td>
													<td></td>
												</tr>
									...
									<tr>
										<td align=center nowrap height=25><a href='board_read.php?index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&mart_id=<?=$mart_id?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><?=$subject_new?></a> <?=$secret_str?><?=$new_string?><?if($_SESSION["Mall_Admin_ID"]){echo"($admin_orderby)";}?></td>
							        </tr>
								</table>
							</td>
