...
$sql = "select * from $CategoryTable where category_num='$category_num' and if_hide='0' ";
...
$sql = "select * from category where category_num='$category_num'";
$res = mysql_query($sql,$dbconn);
$row = mysql_fetch_array($res);
...
if($row[category_degree] == 0){
        ...
        $sql2 = "select * from item where prevno='0' and category_num='$category_num'";
