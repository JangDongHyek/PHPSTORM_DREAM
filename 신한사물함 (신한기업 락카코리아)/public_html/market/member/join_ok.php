...
?>
      	...
      	<tr>
        	<td width="100%" height="5"><span class="zz"><strong><p align="center">
        		<input class="bb" onclick="window.location.href='../main/index.php?mart_id=<?=$mart_id?>'" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #7b7d7b 1px solid; BORDER-LEFT: #7b7d7b 1px solid; BORDER-RIGHT: #7b7d7b 1px solid; BORDER-TOP: #7b7d7b 1px solid; COLOR: #7b7d7b; HEIGHT: 18px" type="button" value="첫화면">&nbsp;
        		<?
        		if($from_order_sheet_flag == 1){
        			echo ("
        		<input class='bb' onclick=\"window.location.href='../cart/order_sheet.php?mart_id=$mart_id'\" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #7b7d7b 1px solid; BORDER-LEFT: #7b7d7b 1px solid; BORDER-RIGHT: #7b7d7b 1px solid; BORDER-TOP: #7b7d7b 1px solid; COLOR: #7b7d7b; HEIGHT: 18px' type='button' value='구매 계속하기'>&nbsp;</strong></span>
        			");
        		}
        		?>
        	</td>
