<?
	...
	if($act) {
		...
		$bbs_reg_date = $now;
		$bbs_cfg = ',A,A,A,N,N,N,N,N,A,A,A,D,A,A,D,A,,,,0,0,1,0,0,0,1,0,,,,0,1,1,,,,,,';
...
//		rg_href("board_edit.php?$p_str&mode=edit&bbs_num=$bbs_num");
	...
	if($mode!='edit') {
		...
		$R[bbs_html_text] = 'script,xml';
             $R[bbs_deny_word] = '라이브,바/카/라,역할,키스,만남,스와핑,대행,실시간,바카라,도우미,도움,모텔,마사지,여성,온라인,사이트,강원랜드,비아그라,시알리스,레비트라,섹스,화상,채팅,정품,현금,룰렛,인터넷,성인,pc,현금,게임,파트너,블랙잭,8억,새끼,개새끼,소새끼,병신,지랄,씨팔,십팔,니기미,찌랄,지랄,쌍년,쌍놈,빙신,좆까,니기미,좆같은게,잡놈,벼엉신,바보새끼,씹새끼,씨발,씨팔,시벌,씨벌,떠그랄,좆밥,추천인,추천id,추천아이디,추천id,추천아이디,추/천/인,쉐이,등신,싸가지,미친놈,미친넘,찌랄,죽습니다,님아,님들아,씨밸넘';
		$R[bbs_point_write] = '1';
		$R[bbs_point_reply] = '1';
...
<table width="796" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#E1E1E1" bordercolordark="white">
  <tr> 
    <td width="796" height="30" align="center" bgcolor="#F7F7F7"> <font color="#404040">게시판 설정</font></td>
  </tr>
</table>
