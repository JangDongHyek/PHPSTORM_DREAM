...
//			$rg_home_url = $data[mb_homepage]; // 2003-10-15 항상홈페이지입력가능
		...
		if($bbs_id=="gujik"){
			$add_query=",rg_ext6='$rg_ext6',rg_ext7='$rg_ext7',rg_ext8='$rg_ext8',rg_ext9='$rg_ext9',rg_ext10='$rg_ext10',rg_ext11='$rg_ext11',rg_ext12='$rg_ext12',rg_ext13='$rg_ext13',rg_ext14='$rg_ext14',rg_ext15='$rg_ext15',rg_ext16='$rg_ext16',rg_ext17='$rg_ext17',rg_ext18='$rg_ext18',rg_ext19='$rg_ext19'";
		}
		...
		$dbqry="
			UPDATE `$bbs_table` SET
				...
				`rg_ext3` = '$rg_ext3',
				`rg_ext4` = '$rg_ext4',
				`rg_ext5` = '$rg_ext5' $admin_orderby_query $add_query";
		}else{
		$dbqry="
			UPDATE `$bbs_table` SET
				$sql_password
				...
				`rg_level1` = '$rg_level1',
				`rg_edu_ju` = '$rg_edu_ju',
				`rg_edu_time` = '$rg_edu_time',
				`rg_school` = '$rg_school',
				`rg_jumin` = '$rg_jumin',
				`rg_post` = '$rg_post',
				`rg_address` = '$rg_address',
				`rg_jakyuk1` = '$rg_jakyuk1',
				`rg_jakyuk2` = '$rg_jakyuk2',
				`rg_jakyuk3` = '$rg_jakyuk3',
				`rg_jakyuk4` = '$rg_jakyuk4',
				`rg_jakyuk5` = '$rg_jakyuk5',
				`rg_date` = '$rg_date'";
		}
