...
<div class="bbs_page">
	...
	<?
		...
		if($auth[bbs_write]){
	?>
		<a href="../bbs/mobile_mb_login.php?url=../bbs/mobile_list.php?bbs_id=<?=$bbs_id?>"><img src="<?=$skin_board_url?>images/write.gif" border=0></a>
	<?
		}
	}
	?>
...
<TABLE width="<?=$width?>" cellSpacing=0 cellPadding=6 border=0>
  <TR height=40 bgcolor="#f7f7f7"> 
	...
	if($auth[bbs_write] || $bbs_id=="noticee") {
	?>
      <?=$a_write?><img src="<?=$skin_board_url?>images/write.gif" border=0></a>
	<?
	}else{
	?>
		<a href="../bbs/mb_login.php?url=../bbs/list.php?bbs_id=<?=$bbs_id?>"><img src="<?=$skin_board_url?>images/write.gif" border=0></a>
	<?
	}
	?>     
<?=$show_chk_begin?>
