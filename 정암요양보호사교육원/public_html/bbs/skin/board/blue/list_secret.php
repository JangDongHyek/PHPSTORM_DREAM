...
?>
	<TR bgColor='<?=($no%2==1)?"#ffffff":"#ffffff"?>' height=26> 
		...
		<?=$rg_reply?> <?=$rg_secret_icon?><?=$a_list_view?>수강신청서</a> <span style='font-size:8pt;'><?=$rg_cmt_count?></span> <?=$rg_new_icon?></TD></xmp></xml></font>
		...
		<TD align=middle class="bbs"><?=$rg_phone?></TD>
	...
	<TR> 
		<TD align=middle bgColor=#E7E7E7 colSpan='<?=$colspan+1?>' height=1><IMG height=1 src="<?=$skin_board_url?>images/blank_.gif" width="100%" border=0></TD>
	</TR>