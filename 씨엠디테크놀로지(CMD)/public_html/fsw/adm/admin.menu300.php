...
if($_SESSION['ss_mb_id']=="lets080"){
    ...
    $menu['menu300'] = array (
        array('300000', '로봇제품관리', ''.G5_ADMIN_URL.'/product_list.php', 'board'),
        array('300100', '로봇제품관리', ''.G5_ADMIN_URL.'/product_list.php', 'bbs_group'),
        array('300200', '분류관리', ''.G5_ADMIN_URL.'/category_list.php', 'bbs_board'),
    );
}
?>