...
?>
    ...
    <div id="idx_wrapper">
        ...
        <div id="visual" class="wow fadeInUp animated">
            <div class="area_txt">
                <span>THE BEST OF FSW ROBOTICS</span>
                <h2>창의적인 기계 설계를 지향하는</h2>
                <h3>FSW 마찰교반용접</h3>
                <p>FSW만의 혁신적이고, 차별화된 설계로<br>
            ...
            <div class="bx_left">
                ...
                <div class="area_notice">
                    <?php echo latest("theme/basic", "fsw_notice", 2, 30); ?>
                </div>
            </div>
            <div class="bx_right">
                <div class="area_bn">
                    <h2>산업용로봇
                        <strong>CMD TECHNOLOGY</strong></h2>
                    <a href="../index2.php">사이트바로가기<i></i></a>
                </div>
            </div>
        </div><!-- //visual -->
    </div><!--  #idx_wrapper -->
    ...
    <div id="content">
        <section class="area_robot">
            <div class="inr">
                ...
                <?php
                    //분류 쿼리문
                    $sql="select * from g5_write_fsw_category order by wr_id asc";
                ...
                <ul class="type_list">
                    ...
                    <li onclick="location.href='<?php echo G5_BBS_URL ?>/board.php?bo_table=fsw_product&sca=<?php echo $categorys[0][wr_subject]?>'">
                        <div class="txt">
                    ...
                    <li onclick="location.href='<?php echo G5_BBS_URL ?>/board.php?bo_table=fsw_product&sca=<?php echo $categorys[1][wr_subject]?>'">
                        <div class="txt">
                    ...
                    <li onclick="location.href='<?php echo G5_BBS_URL ?>/board.php?bo_table=fsw_product03'">
                        <div class="txt">
                            <h3>FSW TOOL</h3>
                            <p>
                                고강도, 표준, 실리콘 강철, 구리 알루미늄<br>
                                교반용접 공구 홀더
                            </p>
                            <div class="brand">
                                <span>
        ...
        <section class="area_product">
            ...
            <div role="tabpanel">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#product" aria-controls="product" role="tab" data-toggle="tab">MCT TYPE</a></li>
                    <li role="presentation">
                        <a href="#product02" aria-controls="product02" role="tab" data-toggle="tab">ROBOT TYPE</a>
                    </li>
                    <li role="presentation">
                        <a href="#product03" aria-controls="product03" role="tab" data-toggle="tab">FSW TOOL</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="product">
                        <?php
                            $sql="select * from g5_write_fsw_product where 1 order by wr_id desc limit 0,15";
                            $result=sql_query($sql);
                        ?>
                        <!-- Swiper -->
                        <div class="swiper productSwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <ul class="gall_con">
                                        <li class="gall_href">
                                            <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=fsw_product&wr_id=<?php echo $row[wr_id]?>">
                                                <div class="over"></div>
                                                <?php
                                                $thumb = get_list_thumbnail("fsw_product", $row['wr_id'], 360, 320);
                                        ...
                                        <li class="gall_text_href">
                                            <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=fsw_product&wr_id=<?php echo $row[wr_id]?>&sca=<?php echo $categorys[0]['wr_subject']?>'&swr2=<?php echo $row[wr_2]?>"
                                            ...
                                            <?php
                                                if($member[mb_id] != ""){
                                                    ...
                                                    if($row2[bf_no]){
                                            ?>
                                            <a class="down_btn" href="<?php echo G5_BBS_URL?>/download.php?bo_table=fsw_product&wr_id=<?php echo $row[wr_id]?>&no=1">
                                                사용자 메뉴얼
                    ...
                    <div role="tabpanel" class="tab-pane" id="product02">
                        <!-- 협동로봇 제품 시작 -->
                        <?php
                        $sql="select * from g5_write_fsw_product02 where 1 order by wr_id desc limit 0,15";
                        $result=sql_query($sql);
                        ?>
                        <!-- Swiper -->
                        <div class="swiper productSwiper">
                                        ...
                                        <ul class="gall_con">
                                            <li class="gall_href">
                                                <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=fsw_product&wr_id=<?php echo $row[wr_id]?>">
                                                    <div class="over"></div>
                                                    <?php
                                                    $thumb = get_list_thumbnail("fsw_product02", $row['wr_id'], 360, 320);
                                            ...
                                            <li class="gall_text_href">
                                                <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=fsw_product&wr_id=<?php echo $row[wr_id]?>&sca=<?php echo $categorys[1]['wr_subject']?>'&swr2=<?php echo $row[wr_2]?>"
                                                   class="bo_cate_link"><?php echo $row[wr_2]?></a>
                                                <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=fsw_product&wr_id=<?php echo $row[wr_id]?>"
                                                   class="title">
                                                    <p class="t9"><?php echo $row['wr_subject']?><!-- 제목 --></p>
                    ...
                    <div role="tabpanel" class="tab-pane" id="product03">
                        <!-- 주변기기/그리퍼 제품 시작 -->
                        <?php
                        $sql="select * from g5_write_fsw_product03 where 1 order by wr_id desc limit 0,15";
                        $result=sql_query($sql);
                        ?>
                        <!-- Swiper -->
                        <div class="swiper productSwiper">
                                        ...
                                        <ul class="gall_con">
                                            <li class="gall_href">
                                                <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=fsw_product&wr_id=<?php echo $row[wr_id]?>">
                                                    <div class="over"></div>
                                                    <?php
                                                    $thumb = get_list_thumbnail("fsw_product03", $row['wr_id'], 360, 320);
                                            ...
                                            <li class="gall_text_href">
                                                <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=fsw_product&wr_id=<?php echo $row[wr_id]?>&sca=<?php echo $categorys[2]['wr_subject']?>'&swr2=<?php echo $row[wr_2]?>"
                                                   class="bo_cate_link"><?php echo $row[wr_2]?></a>
                                                <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=fsw_product&wr_id=<?php echo $row[wr_id]?>"
                                                   class="title">
                                                    <p class="t9"><?php echo $row['wr_subject']?><!-- 제목 --></p>
            ...
            <div class="text-center">
                <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=fsw_product&sca=<?php echo $categorys[0]['wr_subject']?>" class="more_btn">제품 바로가기 <i
        ...
        <section class="area_news">
            ...
            <div class="inr">
                <div class="title">
                    <h3>FSW NEWS</h3>
                    <p>industry news</p>
                    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=fsw_news" class="more_btn">더보기<i
                                class="fa-light fa-plus"></i></a>
                </div>
                <div class="list flex">
                    <?php echo latest("theme/webzine_news", "fsw_news", 3, 60); ?>
                </div>
            </div>
            ...
            <div class="inr">
                <div class="case">
                    <div class="title flex js">
                        <h3>ROBOT 적용사례</h3>
                        <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=fsw_case" class="more_btn">더보기<i
                                    class="fa-light fa-plus"></i></a>
                    </div>
                    <?php echo latest("theme/webzine", "fsw_case", 3, 60); ?>
                </div>
                <div class="contact">
                    <div class="title">
                        <h3>CMD 고객센터</h3>
                    ...
                    <div class="btn_wrap">
                        <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=fsw_faq">FAQ<i
