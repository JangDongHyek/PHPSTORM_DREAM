...
<div id="aside">
    <ul>
        ...
        <!--<li><a><img src="<?php /*echo G5_THEME_IMG_URL */?>/main/aside_icon01.png" class="icon"><p>적용사례</p></a></li>-->
        <li><a><img src="<?php echo G5_THEME_IMG_URL ?>/main/aside_icon02.png" class="icon"><p>고객지원</p></a></li>
        <li class="call">
            <span class="txt_mapo">FSW</span><br><strong class="txt_blue">055.</strong><br>905.<br>2098
        </li>
...
<div id="hd" <?php if(!defined('_INDEX_')){ echo "class='sub'"; } ?>>
    ...
    <div id="hd_wrapper">
        <div id="logo">
            <a class="white" href="<?php echo G5_URL ?>"><img src="<?php echo G5_THEME_IMG_URL ?>/common/logo_fsw.svg" alt="<?php echo $config['cf_title']; ?>"></a>
            <a class="color" href="<?php echo G5_URL ?>"><img src="<?php echo G5_THEME_IMG_URL ?>/common/logo_fsw.svg" alt="<?php echo $config['cf_title']; ?>"></a>
        </div><!--#logo-->
        ...
        <nav id="gnb">
            ...
            <div id="tnb">
                <a class="hd_btn" href="<?php echo G5_BBS_URL ?>/board.php?bo_table=fsw_faq">FAQ</a>
                <div class="nav_open">
                ...
                <ul class="area_login">
                    <?php if ($is_member) {  ?>
                        ...
                        <?php if ($is_admin) {  ?>
                            <li><a href="<?php echo G5_ADMIN_URL ?>/member_list.php" title="관리자페이지" target="_blank"><b><i class="fa-light fa-user"></i></b></a></li>
                        <?php } else {  ?>
	...
	<div id="container">
        ...
        <div class="inr">
                ...
                <div class="container_title">
                      <?php if($bo_table) {?>
                            <?php
                                //FIXME fsw_product, fsw_product02 테이블 나누면 해당 코드는 이전으로 복구할것
                                if($board['bo_subject'] === 'FSW 마찰교반용접기[MCT TYPE]'){
                                    echo $_GET['sca'];
                                }else{
