            ...
            <div class="list_wrap">
                ...
                <ul>
                    ...
                    for ($i=0; $i<count($list[$idx]) && $k<$rows; $i++, $k++) {
                        ...
                        $thumb = get_list_thumbnail($search_table[$idx], $list[$idx][$i]['wr_id'], 198, 198);
                        if($thumb['src']) {
                            $img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" width="198" height="198" class="img">';
                        } else {
                            $img_content = '';
                        }
                        ?>
                        ...
                        <li>
                            ...
                            <div class="area_txt">
                                ...
                                <a href="<?php echo $list[$idx][$i]['href'] ?><?php echo $comment_href ?>" target="_blank" class="blank_btn">새창</a>
                ...
                <div class="sch_more"><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;<?php echo $search_query ?>"><strong><?php echo $bo_subject[$idx] ?></strong> 결과 더보기 <i class="fa-light fa-angle-right"></i></a></div>
            </div>
        <?php }  ?>
