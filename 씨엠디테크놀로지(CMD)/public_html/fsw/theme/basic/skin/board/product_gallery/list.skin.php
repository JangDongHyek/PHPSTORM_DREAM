...
<h2 id="container_title"><?php /*echo $write_table */?><span class="sound_only"> 목록</span></h2>
<h2 id="container_title"><?php /*echo $bo_table */?><span class="sound_only"> 목록</span></h2>
<h2 id="container_title"><?php /*echo $_GET['sca'] */?><span class="sound_only"> 목록</span></h2>-->
                                ...
                                <a href="<?php echo $list[$i]['href'] ?>" class="title">
                                    ...
                                    <?php
                                        ...
                                        <?php }else{
                                            //사용자 메뉴얼이 없을 경우
                                            ?>
                                            <a class="down_btn" href="javascript:;" onclick="alert('사용자 메뉴얼이 존재하지 않습니다.')">
                                                사용자 메뉴얼
                                                <i class="fa-light fa-arrow-down-to-line"></i>
                                            </a>
                                        <?php }?>
