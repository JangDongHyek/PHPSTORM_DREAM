...
<article id="bo_v" style="width:<?php echo $width; ?>">
	...
	<div id="contact_list">
    	<dl>
       	 <dt>title</dt> <dd><?php echo $view['wr_1'] ?></dd>
        </dl>
    	<dl>
       	 <dt>Name</dt> <dd><?php echo $view['name'] ?></dd>
        </dl>
        <dl>
    		<dt>e-mail</dt> <dd><?php echo $view['wr_email'] ?></dd>
        </dl>
        <dl>
    		<dt>Tel &amp; mobile</dt> <dd><?php echo $view['wr_subject'] ?></dd>
        </dl>
	</div>
