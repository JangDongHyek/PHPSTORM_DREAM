...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td><input type="text" name="wr_1" value="<?php echo $write['wr_1']; ?>" id="wr_1" class="frm_input required" required></td>
        </tr>
        <tr>
    ...
    <div class="btn_confirm">
        ...
        <a href="./write.php?bo_table=<?php echo $bo_table ?>" class="btn_cancel">취소</a>
