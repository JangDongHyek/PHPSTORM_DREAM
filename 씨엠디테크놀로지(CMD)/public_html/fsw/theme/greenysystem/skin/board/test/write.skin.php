...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="wr_2">DATE</label></th>
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input" maxlength="255">
                </div>
            </td>
        </tr>

		<tr>
            <th scope="row"><label for="wr_1">ABOUT THIS PROJECT</label></th>
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input" maxlength="255">
                </div>
            </td>
        </tr>
        ...
        <tr>
            <th scope="row">FILES #<?php echo $i+1 ?></th>
            <td>
