    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>">
				...
				<div class="hover">
					...
					<tr>
						<td align="center" valign="middle">
							<p class="title_p"><a href="<?php echo $list[$i]['href'] ?>" style="color:#fff;"><?php echo $list[$i]['subject'] ?></a></p>
			...
			if($thumb['src']) {
				...
				$img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" class="img" style="width:100%;">';
			} else {
