...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
		...
		<div class="tbl_frm01 tbl_wrap">
			...
			<tbody>
			<tr>
				<th scope="row" style="width:30%"><label for="wr_subject">회사이름<strong class="sound_only">필수</strong></label></th>
			...
			<tr>
				<th scope="row"><label for="wr_2">전화<strong class="sound_only">필수</strong></label></th>
			...
			<tr>
				<th scope="row"><label for="wr_content">메시지<strong class="sound_only">필수</strong></label></th>
				<td><?php echo $view["content"] ?></td>
			</tr>
			<tr>
				<th scope="row"><label for="wr_content">관심 서비스<strong class="sound_only">필수</strong></label></th>
				<td>
