...
define('G5_MYSQL_USER', 'cmdtech');
define('G5_MYSQL_PASSWORD', 'meyi98ou');
define('G5_MYSQL_DB', 'cmdtech');
...
$g5['menu_table'] = G5_TABLE_PREFIX.'menu_fsw'; // 메뉴관리 테이블
$g5['submenu_table'] = G5_TABLE_PREFIX.'submenu_fsw'; // 서브메뉴 테이블
