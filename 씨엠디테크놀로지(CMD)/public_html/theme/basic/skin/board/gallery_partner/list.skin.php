                ...
                ?>
                    ...
                    <ul class="gall_con">
                            ...
                            <a href="<?php echo $list[$i]['wr_link1'] ?>" target="_blank">
                                ...
                                <?php } else {
                                    ...
                                    if($thumb['ori']) {
                                        ...
                                        $img_content = '<img src="'.$board_skin_url.'/img/noimg.jpg" width="'.$board['bo_gallery_width'].'" height="'.$board['bo_gallery_height'].'"  class="img">';
                                    }
                        ...
                        <li class="gall_text_href">
                            ...
                            <?php } ?>
                            <a href="<?php echo $list[$i]['wr_link1'] ?>" target="_blank" class="title">
                            ...
                            <?php if ($is_admin) {  ?><a href="./write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?=$list[$i]['wr_id']?>" class="btn">수정</a><?php }  ?>
                            <?php
