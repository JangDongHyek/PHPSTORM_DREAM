...
<hr>
	...
	<div id="footer">
        <div class="ft_top">
            <ul class="ft_menu">
                <li><a href="<?php echo G5_BBS_URL ?>/content.php?co_id=company">CMD소개</a></li>
                <li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=product">로봇제품안내</a></li>
                <li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=case">적용사례</a></li>
                <!--<li><a href="<?php /*echo G5_BBS_URL */?>/board.php?bo_table=qna">온라인상담</a></li>-->
                <li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=faq">고객지원</a></li>
            </ul>
            <div class="ft_btn">
                <!--<a href="<?php /*echo G5_BBS_URL */?>/board.php?bo_table=qna">온라인상담</a>-->
