...
if ($is_admin)
{
    if($bo_table != "category" && $bo_table != "product") {
...
if($bo_table=="category"){
    goto_url(G5_ADMIN_URL.'/category_list.php?page=' . $page . $qstr);
}else if($bo_table=="product") {
    goto_url(G5_ADMIN_URL.'/product_list.php?page=' . $page . $qstr);
}else {
