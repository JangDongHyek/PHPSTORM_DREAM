...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="mb_name">기업명(실명)<strong class="sound_only">필수</strong></label></th>
        <td colspan="4"><input type="text" name="mb_name" value="<?php echo $mb['mb_name'] ?>" id="mb_name" required class="required frm_input" size="15" minlength="2" maxlength="20"></td>
...
<!--        <td><a href="./point_list.php?sfl=mb_id&amp;stx=--><?php //echo $mb['mb_id'] ?><!--" target="_blank">--><?php //echo number_format($mb['mb_point']) ?><!--</a> 점</td>-->
    ...
    <tr>
        ...
        <th scope="row"><label for="mb_1">담당자</label></th>
