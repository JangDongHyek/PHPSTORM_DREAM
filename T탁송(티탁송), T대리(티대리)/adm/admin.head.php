...
<header id="hd">
    <div id="hd_wrap">
        ...
        <div id="logo">
			<!--<a href="<?php echo G5_ADMIN_URL ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/logo.jpg" alt="<?php echo $config['cf_title'] ?> 관리자"></a>-->
			<? $hd_tit_name = ($member['mb_level'] == "10")? "T대리 분양플랫폼" : $member['mb_nick']; ?>
			<div style="line-height: 70px; padding: 0 20px; font-size: 12pt; color: #FFF; font-weight: bold;"><?=$hd_tit_name?> 관리자페이지</div>
		</div>
        ...
        <ul id="tnb">
            ...
            <?php } ?>
			-->
			<li><a href="javascript:void(0)"><?=$member['mb_nick']?>(<?=$member['mb_id']?>) 로그인중</a></li>
