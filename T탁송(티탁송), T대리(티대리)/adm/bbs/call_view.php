...
<div class="modal fade" id="myCancelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"><textarea name="cancel_response" id="cancel_response" class="form-control"></textarea></div>
		<div class="modal-foot">
			<button class="col-xs-12 col-md-12 btn btn-primary" type="button" onclick="request('-1')">취소하기</button>
		</div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<dl>
			<dt>본사지원</dt>
			<dd id="modal-bonsa-price1"><?=number_format($bonsaPrice)?>원</dd>
		</dl>
		<dl>
			<dt>기사수입</dt>
			<dd id="total-price1"><?=number_format($driverPrice)?>원</dd>
		</dl>
      </div>
    </div>
  </div>
...
<div class="collapse in" id="ft_req">
  <div class="well">
	...
	<li class="total">
		...
		<div class="col-xs-6 text-right">
			<dl>
				...
				<!--<dd id="price1"></dd>-->
				<dd>
					<? echo ($member['mb_level'] == "2")? number_format($customPrice) : number_format($driverPrice); ?>원
				</dd>
			</dl>
		</div>
	</li>
	...
	<div id="ongoing_area" style="display:<? echo ($member['mb_id'] == $row['driver_id'] && $call_status == "1")? "block" : "none"; ?>">
		<button class="btn state on" type="button" id="status-btn1" onclick="request('2')">진행중</button>
