...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    for($i=0; $i<count($list); $i++){
        ...
        <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <?php } ?>
            <div class="flex" onclick=location.href='<?php echo $list[$i]['href'] ?>'>
            <?php if($thumb['src']){ ?>
                <div class="img_area">
            ...
            <div>
                <p class="name sv_use"><?=$member["mb_name"]?></p>
                <p class="date"><?php echo $list[$i]['datetime2'] ?></p>
                <p class="num"><?php echo $list[$i]['wr_hit'] ?></p>
                <?php if ($is_good) { ?><p class="td_num"><?php echo $list[$i]['wr_good'] ?></p><?php } ?>
                <?php if ($is_nogood) { ?><p class="td_num"><?php echo $list[$i]['wr_nogood'] ?></p><?php } ?>
            </div>
            </div>
            </div>
        </li>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            <?php if ($_SESSION['ss_mb_id']=="lets080") { ?><li><a href="<?php echo $admin_href ?>"><i class="fas fa-cog"></i><span class="sound_only">관리자</span></a></li><?php } ?>
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>"><i class="fas fa-plus"></i><span class="sound_only">등록</span></a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
