...
// 각종 변수 검사;;
    ...
    if ( !zsfCheck( $zsfCode, $id ) ) { Error ('스팸차단코드가 틀렸습니다.'); }
 ...
 **************************************************************************/
	...
	if($file3_size>0&&$setup[use_pds]&&$file3) {
		...
		if($file3_size>0) {
			...
			if(eregi("\.inc",$s_file_name3)||eregi("\.pht",$s_file_name3)||eregi("\.htm",$s_file_name3)||eregi("\.shtml",$s_file_name3)||eregi("\.ztx",$s_file_name3)||eregi("\.php",$s_file_name3)||eregi("\.dot",$s_file_name1)||eregi("\.asp",$s_file_name3)||eregi("\.cgi",$s_file_name3)||eregi("\.pl",$s_file_name3)) Error("Html, PHP 관련파일은 업로드할수 없습니다");
	...
	if($file4_size>0&&$setup[use_pds]&&$file4) {
		...
		if($file4_size>0) {
			...
			if(eregi("\.inc",$s_file_name4)||eregi("\.pht",$s_file_name4)||eregi("\.htm",$s_file_name4)||eregi("\.shtml",$s_file_name4)||eregi("\.ztx",$s_file_name4)||eregi("\.php",$s_file_name4)||eregi("\.dot",$s_file_name1)||eregi("\.asp",$s_file_name4)||eregi("\.cgi",$s_file_name4)||eregi("\.pl",$s_file_name4)) Error("Html, PHP 관련파일은 업로드할수 없습니다");
	...
	if($file5_size>0&&$setup[use_pds]&&$file5) {
		...
		if($file5_size>0) {
			...
			if(eregi("\.inc",$s_file_name5)||eregi("\.pht",$s_file_name5)||eregi("\.htm",$s_file_name5)||eregi("\.shtml",$s_file_name5)||eregi("\.ztx",$s_file_name5)||eregi("\.php",$s_file_name5)||eregi("\.dot",$s_file_name1)||eregi("\.asp",$s_file_name5)||eregi("\.cgi",$s_file_name5)||eregi("\.pl",$s_file_name5)) Error("Html, PHP 관련파일은 업로드할수 없습니다");
 ...
 **************************************************************************/
	if($mode=="modify"&&$no) {
		...
		if(!$notice&&$s_data[headnum]<="-2000000000") {
			...
			@mysql_query("update $t_board"."_$id set headnum='$headnum',prev_no='$prev_no',next_no='$next_no',child='$child',depth='$depth',arrangenum='$arrangenum',father='$father',name='$name',email='$email',homepage='$homepage',subject='$subject',memo='$memo',sitelink1='$sitelink1',sitelink2='$sitelink2',use_html='$use_html',reply_mail='$reply_mail',is_secret='$is_secret',category='$category', date_free='$date_free', hit2='$hit2' $del_que1 $del_que2 $del_que3 $del_que4 $del_que5 where no='$no'") or error(mysql_error());
		...
		elseif($notice&&$s_data[headnum]>-2000000000) {
			...
			@mysql_query("update $t_board"."_$id set division='$division',headnum='$headnum',prev_no='$prev_no',next_no='$next_no',child='$child',depth='$depth',arrangenum='$arrangenum',father='$father',name='$name',email='$email',homepage='$homepage',subject='$subject',memo='$memo',sitelink1='$sitelink1',sitelink2='$sitelink2',use_html='$use_html',reply_mail='$reply_mail',is_secret='$is_secret',category='$category' $del_que1 $del_que2 $del_que3 $del_que4 $del_que5 where no='$no'") or error(mysql_error());
		...
		// 일반->일반, 공지->공지 일때 
			...
			@mysql_query("update $t_board"."_$id set name='$name',subject='$subject',email='$email',homepage='$homepage',memo='$memo',sitelink1='$sitelink1',sitelink2='$sitelink2',use_html='$use_html',reply_mail='$reply_mail',is_secret='$is_secret',category='$category', date_free='$date_free', hit2='$hit2' $del_que1 $del_que2 $del_que3 $del_que4 $del_que5 where no='$no'") or error(mysql_error());
			mysql_query("update $t_category"."_$id set num=num-1 where no='$s_data[category]'",$connect);
			mysql_query("update $t_category"."_$id set num=num+1 where no='$category'",$connect);
		}
 ...
 **************************************************************************/
		...
		// 답글 데이타 입력;;
		mysql_query("insert into $t_board"."_$id (division,headnum,arrangenum,depth,prev_no,next_no,father,child,ismember,memo,ip,password,name,homepage,email,subject,use_html,reply_mail,category,is_secret,sitelink1,sitelink2,file_name1,file_name2,file_name3,file_name4,file_name5,s_file_name1,s_file_name2,s_file_name3,s_file_name4,s_file_name5,x,y,reg_date,islevel) values ('$division','$headnum','$arrangenum','$depth','$prev_no','$next_no','$father','$child','$member[no]','$memo','$ip','$password','$name','$homepage','$email','$subject','$use_html','$reply_mail','$category','$is_secret','$sitelink1','$sitelink2','$file_name1','$file_name2','$file_name3','$file_name4','$file_name5','$s_file_name1','$s_file_name2','$s_file_name3','$s_file_name4','$s_file_name5
		','$x','$y','$reg_date','$member[is_admin]')") or error(mysql_error());    
 ...
 **************************************************************************/
		...
		mysql_query("insert into $t_board"."_$id (division,headnum,arrangenum,depth,prev_no,next_no,father,child,ismember,memo,ip,password,name,homepage,email,subject,use_html,reply_mail,category,is_secret,sitelink1,sitelink2,file_name1,file_name2,file_name3,file_name4,file_name5,s_file_name1,s_file_name2,s_file_name3,s_file_name4,s_file_name5,x,y,reg_date,islevel,date_free,hit2) values ('$division','$headnum','$arrangenum','$depth','$prev_no','$next_no','$father','$child','$member[no]','$memo','$ip','$password','$name','$homepage','$email','$subject','$use_html','$reply_mail','$category','$is_secret','$sitelink1','$sitelink2','$file_name1','$file_name2','$file_name3','$file_name4','$file_name5','$s_file_name1','$s_file_name2','$s_file_name3','$s_file_name4','$s_file_name5','$x','$y','$reg_date','$member[is_admin]','$date_free','$hit2')") or error(mysql_error());
		$no=mysql_insert_id();
