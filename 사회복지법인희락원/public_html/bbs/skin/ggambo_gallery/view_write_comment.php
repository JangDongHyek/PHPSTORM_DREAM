...
<tr>
 ...
 <td width=20 bgcolor=#F0F0F0><input type=image src=<?=$dir?>/comment.gif border=0 onfocus=blur() accesskey="s" class=submit2></td>
					...
					<tr><td width=100% colspan=2 class=list_eng><?if(!$member['no']){?><font color=silver>이름 : </font><?=$c_name?>&nbsp;&nbsp;<?}?>		<?=$hide_c_password_start?>
<font color=silver>비밀번호 : </font><input type=password name=password <?=size(8)?> maxlength=20 class=input><?=$hide_c_password_end?></td>
