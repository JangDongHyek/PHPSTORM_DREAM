 ...
 ******************************************************************************/
	...
	function member_info() {
		...
		global $HTTP_SESSION_VARS, $member_table, $REMOTE_ADDR, $member, $connect, $_member_info_included;

		if($_member_info_included) return $member;
		$_member_info_included = true;
