...
// ' 등의 특수문자때문에 붙인 \(역슬래쉬)를 떼어낸다
	...
	$file_name3=$reply_data[s_file_name3];
	$file_name4=$reply_data[s_file_name4];
	$file_name5=$reply_data[s_file_name5];
	$file_download1=$reply_data[download1];
	$file_download2=$reply_data[download2];
	$file_download3=$reply_data[download3];
	$file_download4=$reply_data[download4];
	$file_download5=$reply_data[download5];
	...
	if($file_name3) {
		$file_size3=@GetFileSize(filesize($reply_data[file_name3]));
		$a_file_link3="<a href=download.php?$href$sort&no=$reply_data[no]&filenum=3>";
	} else $a_file_link="Zeroboard";

	if($file_name4) {
		$file_size4=@GetFileSize(filesize($reply_data[file_name4]));
		$a_file_link4="<a href=download.php?$href$sort&no=$reply_data[no]&filenum=4>";
	} else $a_file_link="Zeroboard";

	if($file_name5) {
		$file_size5=@GetFileSize(filesize($reply_data[file_name5]));
		$a_file_link5="<a href=download.php?$href$sort&no=$reply_data[no]&filenum=5>";
	} else $a_file_link="Zeroboard";
	...
	if(eregi("\.jpg",$file_name3)||eregi("\.gif",$file_name3)||eregi("\.png",$file_name3)) $upload_image3="<img src=$reply_data[file_name3] border=0><br>";
	if(eregi("\.jpg",$file_name4)||eregi("\.gif",$file_name4)||eregi("\.png",$file_name4)) $upload_image4="<img src=$reply_data[file_name4] border=0><br>";
	if(eregi("\.jpg",$file_name5)||eregi("\.gif",$file_name5)||eregi("\.png",$file_name5)) $upload_image5="<img src=$reply_data[file_name5] border=0><br>";
