...
// 파일링크
	...
	if($file_name3) $a_download3="<a onfocus=blur() href='download.php?$href$sort&no=$no&file=3'>"; else $a_download3="<Zeroboard ";
	if($file_name4) $a_download4="<a onfocus=blur() href='download.php?$href$sort&no=$no&file=4'>"; else $a_download4="<Zeroboard ";
	if($file_name5) $a_download5="<a onfocus=blur() href='download.php?$href$sort&no=$no&file=5'>"; else $a_download5="<Zeroboard ";
...
// 파일 다운로드를 나타나게 하는 변수;;
	...
	if(!$file_name3) {$hide_download3_start="<!--";$hide_download3_end="-->";}
	if(!$file_name4) {$hide_download4_start="<!--";$hide_download4_end="-->";}
	if(!$file_name5) {$hide_download5_start="<!--";$hide_download5_end="-->";}
