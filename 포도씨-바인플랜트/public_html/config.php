...
define('G5_HTTP_DOMAIN', 'http://www.podosea.kr'); //https->http로 보내기 추가
...
//     define('G5_POSTCODE_JS', '<script src="https://spi.maps.daum.net/imap/map_js_init/postcode.v2.js"></script>');
//
//     // https->http로 보내기 - 수정문의(/qna) 메뉴에서 HTTPS에서 iframe src=HTTP 호출 시 에러 때문 (HTTPS에서 HTTP 호출 허용하지 않음)
...
//     define('G5_POSTCODE_JS', '<script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script>');
//
//     if(strpos($_SERVER['REQUEST_URI'], '/qna') !== false) {} // /qna 경로 http->https 예외 처리
//     else {
