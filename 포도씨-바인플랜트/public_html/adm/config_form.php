    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="3">
                <?php
                // 에디터추가
                $content = get_text($config['cf_privacy'], 0);
                ...
                $editor_html = editor_html('cf_privacy', $content, $is_dhtml_editor);
                $editor_js = '';
                $editor_js .= get_editor_js('cf_privacy', $is_dhtml_editor);
                $editor_js .= chk_editor_js('cf_privacy', $is_dhtml_editor);
