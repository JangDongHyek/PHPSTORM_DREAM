    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mb_id" value="<?php echo $ci['mb_id'] ?>" id="mb_id" class="frm_input" size="60" minlength="3" maxlength="20">
                </td>
                <th scope="row"><label for="mb_hp">휴대폰</label></th>
                <td><input type="text" name="mb_hp" value="<?php echo $ci['mb_hp'] ?>" id="mb_hp" class="frm_input" size="60" maxlength="20"></td>
            </tr>
            </tbody>
        </table>
        ...
        <table>
            ...
            <tbody>
            <tr>
                <th scope="row"><label for="ci_type">의뢰유형<strong class="sound_only">필수</strong></label></th>
                <td>
                    <input type="radio" name="ci_type" value="서비스" <?php echo $ci['ci_type'] == '서비스' ? 'checked' : 'disabled';  ?> class="frm_input"><span style="margin-right: 5px;">서비스</span>
                    <input type="radio" name="ci_type" value="부품" <?php echo $ci['ci_type'] == '부품' ? 'checked' : 'disabled';  ?> class="frm_input"><span style="margin-right: 5px;">부품</span>
                    <input type="radio" name="ci_type" value="선용품" <?php echo $ci['ci_type'] == '선용품' ? 'checked' : 'disabled';  ?> class="frm_input"><span style="margin-right: 5px;">선용품</span>
                    <input type="radio" name="ci_type" value="기타" <?php echo $ci['ci_type'] == '기타' ? 'checked' : 'disabled';  ?> class="frm_input"><span>기타</span>
                </td>
                <th scope="row"></th>
                <td></td>
            </tr>
            <tr>
                ...
                <td><input type="text" name="ci_vessel" value="<?php echo $ci['ci_vessel'] ?>" id="ci_vessel" class="frm_input" size="60"></td>
                <th scope="row"><label for="ci_imo_no">INO No.<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="ci_imo_no" value="<?php echo $ci['ci_imo_no'] ?>" id="ci_imo_no" class="frm_input" size="60"></td>
            </tr>
            <tr>
                <th scope="row"><label for="ci_subject">Subject<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="ci_subject" value="<?php echo $ci['ci_subject'] ?>" id="ci_subject" class="frm_input" size="60"></td>
                <th scope="row"><label for="ci_deadline_date">견적기한<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="ci_deadline_date" value="<?php echo $ci['ci_deadline_date'] ?>" id="ci_deadline_date" class="frm_input" size="60"></td>
            </tr>
            <tr>
                <th scope="row"><label for="ci_category">카테고리<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="ci_category" value="<?php echo $ci['ci_category'] ?>" id="ci_category" class="frm_input" size="60"></td>
                <th scope="row"><label for="ci_maker">Maker(제조사)<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="ci_maker" value="<?php echo $ci['ci_maker'] ?>" id="ci_maker" class="frm_input" size="60"></td>
            </tr>
            <tr>
                <th scope="row"><label for="ci_model">Model<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="ci_model" value="<?php echo $ci['ci_model'] ?>" id="ci_model" class="frm_input" size="60"></td>
                <th scope="row"><label for="ci_serial_no">Serial No.<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="ci_serial_no" value="<?php echo $ci['ci_serial_no'] ?>" id="ci_serial_no" class="frm_input" size="60"></td>
            </tr>
            <tr>
                <th scope="row"><label for="ci_contents">의뢰내용<strong class="sound_only">필수</strong></label></th>
                <td><textarea name="ci_contents" id="ci_contents" style="resize: unset;width: 400px;"><?php echo $ci['ci_contents'] ?></textarea></td>
                <th scope="row"><label for="ci_file">의뢰상세자료<strong class="sound_only">필수</strong></label></th>
                <td>
                <?php
            ...
            <tr>
                <th scope="row"><label for="ci_open">자료공개여부<strong class="sound_only">필수</strong></label></th>
                <td>
                    <input type="radio" name="ci_open" value="전체공개" <?php echo $ci['ci_open'] == 'open' ? 'checked' : 'disabled';  ?> class="frm_input"><span style="margin-right: 5px;">전체공개</span>
                    <input type="radio" name="ci_open" value="선택공개" <?php echo $ci['ci_open'] == 'private' ? 'checked' : 'disabled';  ?> class="frm_input"><span style="margin-right: 5px;">선택공개</span>
                </td>
                <th scope="row"></th>
                <td></td>
            </tr>
            <tr>
                ...
                <td><input type="text" name="ci_budget" value="<?php echo $company_budget[$ci['ci_budget']] ?>" id="ci_budget" class="frm_input" size="60"></td>
                <th scope="row"><label for="ci_delivery_to">Delivery To<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="ci_delivery_to" value="<?php echo $ci['ci_delivery_to'] ?>" id="ci_delivery_to" class="frm_input" size="60"></td>
            </tr>
            </tbody>
        </table>
    </div>
...
<div class="tbl_head02 tbl_wrap mb_tbl">
    ...
    <table>
        ...
        <tr>
            <td><?=$i+1?></td>
            <td><?=$row['mb_id']?></td>
            <td><?=number_format($row['ce_offer_price']).$row['ce_unit']?></td>
