			...
			<h2><?php if($w == ""){ ?>기업회원가입<? }else { ?>회원정보 확인 및 수정<?php } ?> <p></h2>
				<div class="box-body">
					...
					<!--<dl class="row">
						...
						<dd>
							<div class="input">
                                <input type="text" name="mb_name" value="<?/*=$mb_name*/?>" id="reg_mb_name" class="regist-input required f_empty" required <?/*=$readonly*/?> placeholder="이름을 입력해 주세요.">
							</div>
						</dd>
						<dd class="error col-xs-12"></dd>
					</dl>-->
					...
					<dl class="row hp">
						...
						<dd>
							<div class="input v1">
                                <input <?=$w=='u' ? 'style="width: 100% !important;"' : ''; ?> type="text" name="mb_email" id="reg_mb_email" class="regist-input required f_empty" minlength="3" maxlength="50" required placeholder="이메일을 입력해 주세요." value="<?=$mb_email?>">
					...
					<dl class="row">
						...
						<dd>
							<div class="input">
								<input type="tel" name="mb_hp" value="<?=$mb_hp?>" id="reg_mb_hp" class="regist-input required" required placeholder="휴대번호를 입력해 주세요." minlength="10" maxlength="13">
							</div>
						</dd>
						<dd class="error col-xs-12"></dd>
					</dl>
					...
					<dl class="row">
						...
						<dd>
							<div class="input">
								<input type="text" name="mb_company_name" value="<?php echo $member['mb_company_name'] ?>" id="reg_mb_company_name" class="regist-input required" required placeholder="회사명을 입력해 주세요.">
							</div>
						</dd>
						<dd class="error col-xs-12"></dd>
					</dl>
...
$(function (){
	...
	$("#reg_mb_hp").keyup(function (){
		...
		if (regHp.test(mb_hp)){
			...
			state.removeClass("pas").addClass("err");
			err.addClass("on").html("휴대번호는 10 ~ 12자리 숫자만 입력해 주세요.");
		}
