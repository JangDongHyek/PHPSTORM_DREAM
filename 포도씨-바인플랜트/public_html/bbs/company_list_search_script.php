...
<script>
    ...
    $(document).ready(function () {
        ...
        if ($('#type').val() != '') {
            // 의뢰유형(웹)
            $('.ci_type li').removeClass('active');
            $('.ci_type li').each(function () {
            ...
            // 의뢰유형(모바일)
            $('.m_ci_type li').removeClass('active');
            $('.m_ci_type li').each(function () {
                if ($(this)[0]['innerText'] == $('#type').val()) {
                    $(this).addClass('active');
                }
            });
        ...
        if ($('#category').val() != '') {
            // 카테고리(웹)
            $('.ci_category li').removeClass('active');
            $('.ci_category li').each(function () {
            ...
            // 카테고리(모바일)
            $('.m_ci_category li').removeClass('active');
            $('.m_ci_category li').each(function () {
                if ($(this)[0]['innerText'] == $('#category').val()) {
                    $(this).addClass('active');
                }
            });
