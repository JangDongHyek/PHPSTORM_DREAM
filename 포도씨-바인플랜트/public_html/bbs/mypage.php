		...
		<div class="inr v3">
				...
				<div class="myinfo">
					...
					<div class="top_box third_box">
						...
						<ul class="my_qna">
                            ...
                            ?>
                            <li><a href="<?=G5_BBS_URL?>/mypage_help.php"><?=number_format($q_count)?><em>질문</em></a></li>
							<li><a href="<?=G5_BBS_URL?>/mypage_help.php"><?=number_format($a_count)?><em>답변</em></a></li>
							<li><a href="<?=G5_BBS_URL?>/mypage_help.php"><?=number_format($s_count)?><em>채택된 답변</em></a></li>
						</ul>
			...
			<div id="mypage_wrap">
				...
				<div class="mypage_cont">
					<div class="box">
						<h3>나의질문<!--<i class="blue"><?/*=$q_count*/?></i>--></h3>
						<a href="<?=G5_BBS_URL?>/mypage_help.php" class="btn_more">더보기+</a>
						<div class="box_cont">
							<div class="table_wrap">
								<ul class="tbl_hd tbl">
                                    <li class="type w2">분류</li>
                                    <li class="subject w35">제목</li>
                                    <li class="select w1">베스트답변</li>
                                    <li class="select w1">우수답변</li>
                                    <li class="reply w1">답변수</li>
                                    <li class="data w15">작성일</li>
								</ul>
					...
					<div class="box">
						<h3>나의답변<!--<i class="blue"><?/*=$a_count*/?></i>--></h3>
						<a href="<?=G5_BBS_URL?>/mypage_help.php" class="btn_more">더보기+</a>
						<div class="box_cont">
							<div class="table_wrap">
								<ul class="tbl_hd tbl">
					...
					<div class="box">
						...
						<div class="box_cont">
							<ul class="tabs">
								...
								<li class="general_noshow" rel="tab2"><span>커리어</span></li>
							</ul>
