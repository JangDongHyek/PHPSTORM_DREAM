					...
					<ul class="list">
						<li>
							<a href="javascript:void(0);">
								<span>매물유형</span>
								<em class="em_pr_type">전체</em><!-- 선택한 카테고리 표시-->
							</a>
						...
						<li class="m_pr_category m_pr_category1" style="display: none;">
							<a href="javascript:void(0);">
								<span>카테고리</span>
								<em class="em_pr_category">전체</em><!-- 선택한 카테고리 표시-->
							</a>
                        ...
                        <li class="m_pr_category m_pr_category2" style="display: none;">
                            <a href="javascript:void(0);">
                                <span>카테고리</span>
                                <em class="em_pr_category">전체</em><!-- 선택한 카테고리 표시-->
                            </a>
                        ...
                        <li class="m_pr_category m_pr_category3" style="display: none;">
                            <a href="javascript:void(0);">
                                <span>카테고리</span>
                                <em class="em_pr_category">전체</em><!-- 선택한 카테고리 표시-->
                            </a>
