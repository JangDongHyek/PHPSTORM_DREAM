...
// 3. 공류 자료 경로
$share_path = 'https://www.podosea.com/bbs/shop_view.php?code='.$code;
// ==========
    ...
    <div class="area_view">
        <div class="inr v3">
            <div class="area_products">
                ...
                <input type="text" id="share_path" value="https://www.podosea.com/bbs/shop_view.php?code=<?=$code?>" style="opacity: 0;position: absolute;">
            </div>
        </div>
...
<form id="payfrm" name="payfrm" method="post">
    ...
    <input type="hidden" name="RetryURL" value="<?=G5_BBS_URL?>/shop_pay_result.php">
