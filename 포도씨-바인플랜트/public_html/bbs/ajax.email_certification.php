...
// 메일 제목
$subject = "[회원가입] PODOSEA 이메일 인증";

// 메일 내용
$content = "";
$content .= "<div style='width:600px;border:10px solid #f7f7f7;text-align: center;font-family:Nanum Gothic;'>";
$content .= "<span><h1>PODOSEA</h1></span><h1 style='color:#555;font-size:1.4em'> 이메일 인증 안내</h1>";
$content .= "<p style='font-size:18px;margin-bottom:0;padding-top: 15px;padding-bottom: 15px;font-family:Nanum Gothic;background:#f7f7f7;'>아래 인증하기 버튼을 클릭하세요.</p>";
$content .= "<a href='".$certify_href."' target='_blank' style='display:inline-block;background-color:#216bd1;padding:10px 32px;font-size:20px;color:#fff;text-decoration:none;margin-top: 20px;margin-bottom: 20px;'>인증하기</a>";
$content .= "</div>";

// 메일 발송
itforoneMailer( 'master@podosea.com','PODOSEA', $reg_mb_email, $reg_mb_email, $subject, $content);
