...
// 질문수
$co_q_count = sql_fetch(" select count(*) as count from g5_community where mb_id = '{$member['mb_id']}' and del_yn is null; ")['count'];
// 답변수
$co_a_count = sql_fetch(" select count(*) as count from g5_community_answer where mb_id = '{$member['mb_id']}' and del_yn is null; ")['count'];
?>
				...
				<div class="mypage_cont">
					<div class="box">
						...
						<div class="box_cont">
							...
							<ul class="tabs">
                                <li class="active" rel="tab1"><span>나의 작성글</span><em><?=number_format($co_q_count)?></em></li>
                                <li rel="tab2"><span>나의 댓글</span><em><?=number_format($co_a_count)?></em></li>
							</ul>	
								...
								<div id="tab1" class="tab_content">
									<div class="box_cont">
										<div class="table_wrap">
											<ul class="tbl_hd tbl">
												<li class="type w25">분류</li>
												<li class="subject w5">제목</li>
												<li class="reply w1">댓글</li>
