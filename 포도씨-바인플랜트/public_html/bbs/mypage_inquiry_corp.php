...
$ing_cnt = selectCount('g5_company_question', 'mb_no', $member['mb_no'], 'state', '처리중'); // 처리중
$com_cnt = selectCount('g5_company_question', 'mb_no', $member['mb_no'], 'state', '처리완료'); // 처리완료
?>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <ul id="sort_list" class="list_modal">
                        <li class="ing" onclick="inquiryAction('ing');">처리중</li>
                        <li class="com" onclick="inquiryAction('com');">처리완료</li>
                    </ul>
                </div>
            </div>
        </div>
			...
			<div id="mypage_wrap">
				...
				<div class="mypage_cont">
					<div class="box">
						...
						<div class="box_cont">
							<ul class="tabs">
								<li class="active" rel="tab1"><span>처리중</span><em><?=number_format($ing_cnt)?></em></li>
								<li rel="tab2"><span>처리완료</span><em><?=number_format($com_cnt)?></em></li>
							</ul>
