                ...
                <div id="join_info">
                    ...
                    <div class="profile_content">
                        <dl class="row add first">
                            <dt>보유 인증, 특허<em>*선택</em><button type="button" onclick="add_patent();">+추가</button></dt>
                            <dd>
                                <div class="input">
                                    <ul class="catalog_list patent_list">
                                        ...
                                        <li class="patent_1">
                                            ...
                                            <input type="text" id="mb_patent_1" name="mb_patent[]" class="regist-input patent" placeholder="보유 인증, 특허를 입력해 주세요.">
                                        </li>
                                        <?php } ?>
                                        <?php
                                        ...
                                        <li class="patent_<?=$i+1?>">
                                            ...
                                            <input type="text" id="mb_patent_<?=$i+1?>" name="mb_patent[]" value="<?=$mb_patent[$i]?>" class="regist-input patent" placeholder="보유 인증, 특허를 입력해 주세요.">
                                        </li>
                                        <?php
                                            }
                                        }
                        ...
                        <dl class="row">
                            ...
                            <dd>
                                <div class="input">
                                    <ul class="catalog_list catalog_file v2">
                                        ...
                                        <li class="file_<?=$i?>">
											...
											<div class="area_img upload cover_<?=$i?>" <?php if(empty($cover['img_file'])) { ?>onclick="cover_add(<?=$i?>);"<?php } ?>>
                                                <button type="button" class="btn_img_close" onclick="cover_del(<?=$i?>, 'u');">삭제</button>
                                    ...
                                    <em>※ 카달로그 파일의 용량은 10MB이하로 가능합니다.</em>
                        ...
                        <dl class="row">
                            <dt>회사 소개 영상<em>*선택</em></dt>
                            <dd>
                                <div class="input">
                                    <input type="text" id="mb_video_link" name="mb_video_link" value="<?=$member['mb_video_link']?>" class="regist-input " placeholder="유튜브 또는 동영상 링크를 입력하세요.">
                                </div>
                            </dd>
                            <!--<dd class="error col-xs-12">프리미엄 회원 기능입니다. 계정을 업그레이드 하세요.</dd>-->
                        </dl>
                        <div class="area_btn">
                            <a href="javascript:void(0);" class="btn_prev"><span onclick="pre_move('company_update02', '<?=$company?>');">이전단계<em class="pc">로 이동하기</em></span></a>
                            <!-- input 작성하면 다음버튼으로 나오게 해주세요 -->
                            <a href="javascript:void(0)" class="btn_next active">다음</a>
...
<script>
    ...
    function form_check() {
        ...
        $('.home').attr('href', 'javascript:profile_update("company", "profile03", "update04", "", "'+param1+'");');
    }
    ...
    function add_patent() {
        ...
        var html = '<li class="patent_'+num+'"><button type="button" class="btn_close" onclick="del_patent('+num+');"></button><input type="text" id="mb_patent_'+num+'" name="mb_patent[]" class="regist-input patent" placeholder="보유 인증, 특허를 입력해 주세요." onkeyup="form_check();"></li>';
