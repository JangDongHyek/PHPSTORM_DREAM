...
$menu['menu300'] = array (
	...
	$menu['menu300'] = array (
		array('300000', '로또설정', G5_ADMIN_URL.'/lotto.config.php', 'lotto'),
		array('300100', '로또설정', G5_ADMIN_URL.'/lotto.config.php', 'lotto'),
		array('300200', '룰렛설정', G5_ADMIN_URL.'/roulette.config.php', 'roulette'),
		array('300300', '유튜브관리',G5_ADMIN_URL.'/bbs/board.php?bo_table=youtube', 'youtube'),
		array('300400', '공지사항',G5_ADMIN_URL.'/bbs/board.php?bo_table=notice', 'notice')
	);
}
?>