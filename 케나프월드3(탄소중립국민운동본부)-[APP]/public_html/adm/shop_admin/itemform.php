...
<section id="anc_sitfrm_skin" style="display:<?php echo $member[mb_id]=="lets080"?"":"none";?>">
...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="it_brand">상품소재</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
        ...
        <tr>
            ...
            <td class="td_grpset">
				...
				<tr>
                <th scope="row"><label for="it_sc_price">상품url</label></th>
                <td>
                    <input type="text" name="it_1" value="<?php echo $it['it_1']; ?>" id="it_1" class="frm_input" placeholder="http://" size="100"> 
                </td>
            </tr>
        </tbody>
        </table>
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
				<?php echo help(",(콤마)를 넣으면 가격이 입력이 안 됩니다."); ?>
                <input type="number" name="it_price" value="<?php echo $it['it_price']; ?>" id="it_price" class="frm_input" size="8"> 원
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="number" name="it_cust_price" value="<?php echo $it['it_cust_price']; ?>" id="it_cust_price" class="frm_input" size="8"> 원
            </td>
            <td class="td_grpset">
				...
				<!--
				<tr>
            <th scope="row"><label for="it_cust_price">시세등락</label></th>
            <td>
                <input type="text" name="it_2" value="<?php echo $it[it_2]?>" id="it_2" class="frm_input" size="8">원
            </td>
            <td class="td_grpset">
                <input type="radio" name="it_3" value="1" id="it_3_1"<?php echo $it[it_3]=="1"?" checked":"";?>>
                <label for="it_3_1">상승</label>
                <input type="radio" name="it_3" value="-1" id="it_3_2"<?php echo $it[it_3]=="-1"?" checked":"";?>>
                <label for="it_3_2">하락</label>
								<input type="radio" name="it_3" value="0" id="it_3_3"<?php echo $it[it_3]=="0"?" checked":"";?>>
                <label for="it_3_3">변동없음</label>
            </td>
        </tr>-->
        ...
        <tr>
            ...
            <td>
                ...
                <input type="number" name="it_point" value="<?php echo $it['it_point']; ?>" id="it_point" class="frm_input" size="8"> <span id="it_point_unit"><?php if($it['it_point_type']) echo '%'; else echo '점'; ?></span>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="number" name="it_supply_point" value="<?php echo $it['it_supply_point']; ?>" id="it_supply_point" class="frm_input" size="8"> 점
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="number" name="it_stock_qty" value="<?php echo $it['it_stock_qty']; ?>" id="it_stock_qty" class="frm_input" size="8"> 개
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="number" name="it_noti_qty" value="<?php echo $it['it_noti_qty']; ?>" id="it_noti_qty" class="frm_input" size="8"> 개
            </td>
            <td class="td_grpset">
