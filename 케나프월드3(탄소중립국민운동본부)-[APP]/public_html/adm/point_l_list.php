...
$sql_common = " from {$g5['point_table_l']} ";
...
<section id="point_mng">
    ...
    <form name="fpointlist2" method="post" id="fpointlist2" action="./point_l_update.php" autocomplete="off">
...
<form name="fpointlist" id="fpointlist" method="post" action="./point_l_list_delete.php" onsubmit="return fpointlist_submit(this);">
<input type="hidden" name="sst" value="<?php echo $sst ?>">
<input type="hidden" name="sod" value="<?php echo $sod ?>">
<input type="hidden" name="sfl" value="<?php echo $sfl ?>">
<input type="hidden" name="stx" value="<?php echo $stx ?>">
