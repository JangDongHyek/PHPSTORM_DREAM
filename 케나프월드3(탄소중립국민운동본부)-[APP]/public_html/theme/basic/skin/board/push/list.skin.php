...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx">
        ...
        <?php /*?><?php if ($rss_href || $write_href) { ?>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <?php /*?><td class="td_name sv_use hidden-xs"><?php echo $list[$i]['name'] ?></td><?php */?>
            <td class="td_date"><?php echo $list[$i]['datetime2'] ?></td>
            <?php /*?><td class="td_num hidden-xs"><?php echo $list[$i]['wr_hit'] ?></td>
    ...
    <div class="bo_fx">
		...
		?>
        <?php if (($list_href || $write_href) and !$mobile) { ?>
        <ul class="btn_bo_user">
...
function send_gcm(wrid, wr1, wr2){
	var post_no = 10;
	var post_title = "국제라이온스";
	var post_content = "새로운 알림이 있습니다.";
	var post_url = "<?=G5_BBS_URL?>/board.php?bo_table=push&wr_id="+wrid;
	var post_user = wr1;
	var post_update = true;
	var post_wrid = wrid;
	var post_botable = "push";
	...
	$.ajax({
		...
		data: {
			...
			"post_wrid": post_wrid,
			"post_botable": post_botable
		},
		success:function(data){
			var count = Number(wr2) + 1;
