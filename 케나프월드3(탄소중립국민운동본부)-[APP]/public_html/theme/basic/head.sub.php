...
<head>
<meta charset="utf-8">
<link rel="shortcut icon" type="image/x-icon" href="<?php echo G5_URL ?>/img/favicon_FAB_icon.ico"/>
<link rel="apple-touch-icon-precomposed" href="<?php echo G5_URL ?>/img/favicon96.png"/>
<link rel="apple-touch-icon" sizes="114x114" href="<?php echo G5_URL ?>/img/favicon114.png"/>
<link rel="apple-touch-icon" href="<?php echo G5_URL ?>/img/favicon72.png"/>

<meta property="og:type" content="website">
<meta property="og:title" content="C^-zero">
<meta property="og:description" content="C^-zero">
<meta property="og:image" content="<?php echo G5_URL; ?>/img/ogimg.jpg">
...
<script src="<?php echo G5_THEME_JS_URL ?>/modal.js"></script>
