    ...
    <section id="sit_ov" class="col-lg-6 col-md-6 col-xs-12">
        ...
        <div class="sit_ov_tbl">
            ...
            <tr>
                ...
                <td><?php echo str_replace('P','원',display_price($it['it_cust_price'])); ?></td>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <td class="td_price">
                    ...
                    <input type="hidden" id="it_price" value="<?php echo get_price($it); ?>">
									...
									<!--	<? if($it[it_3]!="0"&&$it[it_3]!=""){?>
										<div class="sise <?=$siseArr[$it[it_3]]?>">
									<?php echo $it[it_3]<0?"-".number_format($it[it_2]):number_format($it[it_2]);?>원 <i class="fas <?=$siseFaArr[$it[it_3]]?>"></i></div>
									<? }else if($it[it_3]=="0"){?>
									 <div class="ssame">변동없음 <i class="fas fa-minus"></i></div>
									<? }else if($it[it_3]==""){?>
									<? }?>-->
            ...
            */
			...
			<!--포인트관련-->
            <?php /*?><?php if ($config['cf_use_point']) { // 포인트 사용한다면 ?>
            <tr>
			...
			<ul id="sit_opt_added">
                            <li class="sit_opt_list">
                                ...
                                <span class="sit_opt_subj">상품갯수</span>
                                
                                <div class="sit_opt_qty">
                                    <input type="text" id="ct-qty" name="ct_qty[<?php echo $it_id; ?>][]" value="<?php echo $it['it_buy_min_qty']; ?>" class="frm_input" size="5">
                        ...
                        $(function() {
                            price_calculate();
							$(".sit_qty_plus").click(function(){
								var qty=parseInt($("#ct-qty").val());
								qty++;
								$("#ct-qty").val(qty);

							});
							$(".sit_qty_minus").click(function(){
								var qty=parseInt($("#ct-qty").val());
								qty--;
								if(0<qty){
									$("#ct-qty").val(qty);
									...
									qty=1;
									alert("최소 구매 수량 이하는 구매하실 수 없습니다.");
									return;
								}
...
//                    if(!$option_item) {
                    ...
                    ?>
                        <ul id="sit_opt_added">
                            <li class="sit_opt_list">
                                ...
                                <span class="sit_opt_prc">(+0P)</span>
                                <div class="sit_opt_qty">
			   ...
			   <script>
                ...
                <div id="sit_ov_btn">
                    ...
                    <?php } ?>
                    <?php /*?><?php if(!$is_orderable && $it['it_soldout'] && $it['it_stock_sms']) { ?>
                    <a href="javascript:popup_stocksms('<?php echo $it['it_id']; ?>');" id="sit_btn_buy" class="sit_btn_buy_alarm">재입고알림</a>
                    <?php } ?><?php */?>
                    <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');"<?php if(!$is_orderable){ echo "class='w100'"; } ?> id="sit_btn_wish">위시리스트</a>
                </div>
        </div>
        <!-- }퀵구매버튼 -->
    </section>
...
<div role="tabpanel" id="sit_tab">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <?php /*?><li role="presentation"><a href="#review" aria-controls="review" role="tab" data-toggle="tab"><span class="hidden-xs">상품</span>후기<span class="item_use_count"><?php echo $item_use_count; ?></span></a></li>
        <li role="presentation"><a href="#qa" aria-controls="qa" role="tab" data-toggle="tab"><span class="hidden-xs">상품</span>문의<span class="item_qa_count"><?php echo $item_qa_count; ?></span></a></li><?php */?>
