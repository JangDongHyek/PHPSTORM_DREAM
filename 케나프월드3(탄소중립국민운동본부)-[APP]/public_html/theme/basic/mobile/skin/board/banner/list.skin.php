...
<!-- 게시판 목록 시작 { -->
<div id="bo_gall" style="width:<?php echo $width; ?>; max-width:1100px; margin:0 auto;">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li style="text-align:right"><a href="<?php echo $write_href ?>" class="btn_b02">등록하기</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
