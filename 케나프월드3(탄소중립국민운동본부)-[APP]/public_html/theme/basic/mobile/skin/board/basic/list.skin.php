...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>" style="<?php if($list[$i]['wr_good'] >= 10) echo "font-weight:bold;";?>color:black">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php /*?><?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">등록하기</a></li><?php } ?><?php */?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
	...
	<fieldset id="bo_sch">
		...
		<select name="sfl" id="sfl">
			...
			<option value="wr_name,1"<?php echo get_selected($sfl, 'wr_name,1'); ?>>닉네임</option>
...
<?php /*?>        <div id="bo_list_total">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02"><i class="fa fa-pencil-square-o"></i> 등록하기</a></li><?php } ?>
