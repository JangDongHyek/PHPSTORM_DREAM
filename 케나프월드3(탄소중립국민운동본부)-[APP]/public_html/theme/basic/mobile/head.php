...
if (strpos($_SERVER[ "REQUEST_URI" ],canadaw5)) {
    $shareLink = "/~canadaw5";
} else {
    $shareLink = "";
}
...
<!--상단 메뉴부분 시작-->
<div id="header">
    <h1 class="logo"><a href="<?php echo G5_URL ?>"><img src="<?php echo G5_THEME_IMG_URL ?>/common/zeros_logo.png" alt="<?php echo $config['cf_title']; ?>"/></a></h1>
	<?php/* if($is_member){ ?>
	<div id="my_csgold">
		<dl>
...
-->
    ...
    <div id="gnb2">
        <ul>
            ...
            <li><a <?php if(strpos(SCRIPT_NAME, "stock_change.php")) echo 'class="on"';?> href="<?php echo G5_BBS_URL;?>/stock_change.php">친구</a></li>
...
btnShare.addEventListener("click", function(){
    ...
    var shareTitle = "C^-ZERO";
    var shareText = '사단법인 C^-ZERO 탄소중립 실천연합';
    var contentURL = "<?php echo $shareLink;?>";
    var URLPreFix = "";
    ...
    var shareURL = contentURL + '/bbs/register_form.php?rcmmid=' + rcmmid;
