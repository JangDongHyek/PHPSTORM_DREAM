...
<!--							<img src="<?php echo G5_SHOP_CSS_URL ?>/img/pro_img.jpg">-->
            ...
            <dl><a href="<?=$this->href.$row['it_id']."&ca_id=".$_GET['ca_id']?>">
                ...
                <dd class="pro_sinfo"><?php echo $row[it_basic];?></dd>
								<? if($_GET['ca_id']=="10"){?>
                <dd class="pro_custprice"><?php echo $row[it_cust_price];?>원</dd>
								<? }?>
                <dd class="pro_price"><?php echo number_format($row[it_price]);?>원</dd>
        ...
        <div class="pro_list_more"><a>더보기 <i class="fal fa-plus"></i></a></div>
