...
$sql_search .= " and po_rel_table = '@wallet' ";
...
$write_pages = get_paging($rows, $page, $total_page, G5_BBS_URL.'/mywallet.php?'.$qstr.'&amp;page=');

include_once($mypage_skin_path.'/mywallet.skin.php');
