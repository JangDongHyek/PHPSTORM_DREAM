...
if($mb_id!="01058076119"){
	$mb_recommend   = trim($_POST['mb_recommend'])&&$_POST['mb_recommend']!="없음"      ? trim($_POST['mb_recommend'])   : "01058076119";
}else{
...
if ($w == '') {
	...
	*/
    ...
    //FIXME
	alert("회원가입에 성공했습니다. 청원서 작성을 하시면 5,000포인트가 무료로 지급됩니다.", G5_BBS_URL."/petition.php");
