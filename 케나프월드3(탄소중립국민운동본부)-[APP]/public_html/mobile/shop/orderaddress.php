...
<div id="sod_addr" class="new_win">
    <h1 id="win_title"><i class="fal fa-map-marker-alt"></i> 배송지 목록
    <button type="button" onclick="self.close();" class="btn_close"><i class="fal fa-times"></i></button>
     </h1>
            ...
            <li>
                ...
                <div class="addr_box">
                    ...
                    <div class="addr_info">
                        ...
                        <div class="addr_tel">
                        <i class="fas fa-phone-alt"></i> 전화 : <?php echo $row['ad_tel']; ?><br />
                        <i class="fal fa-mobile"></i> 휴대폰 : <?php echo $row['ad_hp']; ?>
                        </div><!--.addr_tel-->
                    </div>
                    <div class="addr_btn">
