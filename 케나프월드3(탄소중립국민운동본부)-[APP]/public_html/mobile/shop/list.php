...
<script type="text/javascript">
		var page=2;
			$(function(){
				$("#btn_more_item").click(function(){
						$.ajax({
							url:"./ajax.item.list.php",
							data:"ca_id=10&sort=&sortodr=&page="+page,
							dataType:"html",
							type:"POST",
							success:function(data){
								...
								if(data.toString().trim()==""){
									...
									$("#pro_list_wrap").append(data);
									page++;
								}
								$("#item_load_msg").css("display","none");
							}
						});
				});
			});
