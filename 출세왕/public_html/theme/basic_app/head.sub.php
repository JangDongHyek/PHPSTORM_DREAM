...
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=2.0,user-scalable=no,target-densitydpi=medium-dpi">
<?php
if (G5_IS_MOBILE) {
...
<script src="<?php echo G5_JS_URL ?>/common.js?ver=1.2"></script>
