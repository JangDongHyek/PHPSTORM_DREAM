...
<div id="my_reser">
    ...
    <ul class="cate cf cateFlex">
        <li <?=($_REQUEST['car_date_type'] == 3 || $_REQUEST['car_date_type'] == '') ?  'class="active"' : '';?>><a href="<?=G5_BBS_URL?>/my_money.php?car_date_type=3&ma_step=<?= $_REQUEST['ma_step']?>">단기세차</a></li>
        <li <?=($_REQUEST['car_date_type'] == 5) ?  'class="active"' : '';?>><a href="<?=G5_BBS_URL?>/my_money.php?car_date_type=5&ma_step=<?= $_REQUEST['ma_step']?>">실내세차</a></li>
        ...
        <li <?=($_REQUEST['car_date_type'] == 1) ?  'class="active"' : '';?>><a href="<?=G5_BBS_URL?>/my_money.php?car_date_type=1&ma_step=<?= $_REQUEST['ma_step']?>">한달만서비스</a></li>
