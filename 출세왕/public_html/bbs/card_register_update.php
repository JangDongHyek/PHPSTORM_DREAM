...
$nextDate=date("d")<25?date("Y-m-25"):date("Y-m-d",strtotime(date("Y-m-25")." +1 month"));
//      if (데이터베이스 등록 성공 유무 조건변수 = true)
//      {
/*$sql="insert g5_autoPay set ";
...
$nextDate=date("d")<25?date("Y-m-25"):date("Y-m-d",strtotime(date("Y-m-25")." +1 month"));
$sql.="NextDate=''";*/
$cardNum = mb_substr($_POST['cardNum'], '0', -8) . "********";
$sql="insert g5_autoPay set					
									...
									authDate='$authDate',
									authCode='$authCode',
									appCardCode='$cardCode',
									cardNum='{$cardNum}',
									appCardName='$cardAcquireName',
									arsTid='$arsTid',
									billKey='$billKey',
									moid='$moid',
									payExpDate='',
