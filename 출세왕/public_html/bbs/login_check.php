...
if($mb["mb_level"] != $_REQUEST["level"]){
    alert("분류가 맞지않습니다. 다시 한번 확인해주세요.");
}

if ( $mb['mb_1'] != 'Y' &&$mb["mb_level"] == 3) {
    alert("관리자 승인 후 사용가능합니다.");
...
if ($url) {
    ...
    //매니저는 my_order.php로이동
    if ($mb['mb_level'] == 3){
        $link = G5_BBS_URL."/my_order.php";
    }
