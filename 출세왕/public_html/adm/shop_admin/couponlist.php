...
?>
<!--
<link href="<?php echo G5_THEME_CSS_URL ?>/main.css" rel="stylesheet" type="text/css">
-->
...
<style>
    ...
    <div class="local_ov01 local_ov">
        <span class="ov_txt">전체 </span><span class="ov_num"> <?php echo number_format($total_count) ?> 개</span>
    </div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td style="display: none"><?php echo $cp_method; ?></td>
        <td><?php echo $row['cp_id']; ?></td>
        <td class="td_left"><?php echo $row['cp_subject']; ?></td>
        <td class="td_left"><?php echo $row['cp_price'].'원'; ?></td>
        <!--
...
<div class="btn_fixed_top">
    <div class="btn_add01 btn_add" style="float: left">
        <input type="submit" name="act_button" value="선택삭제" onclick="document.pressed=this.value" class="btn btn_02 sel_del_btn" >
    </div>
</div>
