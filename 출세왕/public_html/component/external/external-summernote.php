            ...
            mounted() {
                ...
                this.$nextTick(() => {
                    $(document).ready(function() {
                        $(`#${component.component_idx}`).summernote({
                            ...
                            callbacks: {
                                ...
                                onChange: function(contents) {
                                    console.log(1)
                                    component.datum[component.field] = contents; // Vue 데이터 동기화
                                }
                            }
                        ...
                        if(component.datum[component.field]) $(`#${component.component_idx}`).summernote('code', component.datum[component.field]); // 에디터 내용 불러오기
