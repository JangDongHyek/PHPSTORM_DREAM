...
//========================= 첨부파일처리 =================================================
?>
					<form method='POST' name='writeform' enctype='multipart/form-data' onsubmit='board_checkform(); return false' action="https://www.topline.kr:8040/market/board/board_edit.php"> 
...
<?
	...
	if( $board_class == 0 ){
		...
		if( $passwd_db != $passwd ){
			...
			");
			echo "<meta http-equiv='refresh' content='0; URL=http://www.topline.kr/market/board/board_read.php?mart_id=$mart_id&index_no=$index_no&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'>";
			exit;
		}
	}
