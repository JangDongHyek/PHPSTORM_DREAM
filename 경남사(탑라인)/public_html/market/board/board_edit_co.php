...
?>
					...
					<table width="96%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="../image/helpdesk/table1_bg.gif"> &nbsp;&nbsp;<input name="writer" value='<?=$writer?>' type="text" class="category_2" size="30" style='ime-mode:active'></td>
					...
					<table width="96%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="10"></td>
							<td><input type="text" class="input_03" size="20" name="email" value='<?=$email?>' style='ime-mode:active'>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="10"></td>
							<td ><input name="subject_new" value='<?=$subject_new?>' type="text" class="input_03" size="90" style='ime-mode:inactive'></td>
						</tr>
						<tr>
							<td bgcolor="E1E1E1" height="1" colspan="4"></td>
						</tr>
