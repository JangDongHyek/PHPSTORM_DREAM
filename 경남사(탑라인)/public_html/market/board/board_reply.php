...
?>
					...
					<form method="POST" name='writeform' enctype="multipart/form-data" onsubmit='board_checkform(); return false' action="https://www.topline.kr:8040/market/board/board_reply.php"> 
...
#######################################################################
	...
	echo "<meta http-equiv='refresh' content='0; URL=http://www.topline.kr/market/board/board_list.php?mart_id=$mart_id&bbs_no=$bbs_no&page=$page&keyset=$keyset&searchword=$searchword'>";
}
?>
<?
mysql_close($dbconn);
