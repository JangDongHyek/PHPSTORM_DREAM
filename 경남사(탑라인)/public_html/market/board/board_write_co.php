...
<!---------------------- 게시판 시작 ---------------------------------------------------->
					...
					//echo $co_sql;
						...
						?>
							...
							<td width="60" align="center" background="../image/helpdesk/table1_bg.gif">업소명</td>
							<td width="1"><img src="../image/helpdesk/table1_line.gif" width="1" height="40"></td>
							<td background="../image/helpdesk/table1_bg.gif"> &nbsp;&nbsp;<input type="text" class="input_03" size="20" name="writer" value='<?=$co_rows[co_name]?>' style='ime-mode:active'></td>
					...
					<table width="96%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="70" height="30" align="center">전화번호</td>
							<td width="1"><img src="../image/helpdesk/view_line.gif" width="1" height="30"></td>
							<td width="10"></td>
							<td><input name="email" value='<?=$co_rows[co_tel]?>' type="text" class="input_03" size="30" style='ime-mode:inactive'>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="10"></td>
							<td ><input name="subject_new" type="text" size="90" style='ime-mode:active' class="input_03" value="<?=$co_rows[co_address1]?> <?=$co_rows[co_address2]?>"></td>
						</tr>
						<tr>
							<td bgcolor="E1E1E1" height="1" colspan="4"></td>
						</tr>
...
?>
						<tr>
							<td height="30" align="center" valign="top">간단소개</td>
