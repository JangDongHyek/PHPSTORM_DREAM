...
<table border="0" cellpadding="0" cellspacing="0" width="100%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
  <tr>
	 ...
	 <table cellSpacing="0" cellPadding="0" width="100%" border="0">
		<tr>
		  <td width="90%" height="50" bgColor="#ffffff"><b>&nbsp;&nbsp; [개별업체회원 이메일 발송]</b> <br>
		  <font color="red">&nbsp;&nbsp; 개별업체회원에게 메일을 발송합니다.<br></font></td>
		</tr>
		<tr>
		  <td></td>
		</tr>
			 ...
			 <tr>
				<td width="100%" bgColor="#999999"><table cellSpacing="1" cellPadding="3" width="100%" border="0">
				  ...
				  if($keyset == '' && $searchword == '') 
							$SQL = "select * from $Mart_Member_NewTable where mart_id='$mart_id' and username='$username'";
							$dbresult = mysql_query($SQL, $dbconn);
				  ...
				  <tr>
					 <td align="left" width="51%" bgColor="#ffffff" colSpan="2"><p align="center">
					 <!-- <input onclick="setEditMode('html');" type="radio" value="html" name="editmode">에디터
					 <input onclick="setEditMode('text');" type="radio" value="text" name="editmode">HTML 직접입력 <br>
