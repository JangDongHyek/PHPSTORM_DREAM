...
?>
		...
		<td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="50" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>업체회원그룹관리</b></td>
				</tr>
			</table>
			...
			<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
				...
				<tr>
				  <td vAlign="top" width="100%" bgColor="#ffffff" height="3"><table width="100%" border="0">
					 <tr>
						<td width="100%" colSpan="2" height="20"><p align="center"><strong>[업체회원그룹관리]</strong></td>
					 </tr>
					 <?
					 ...
					 <tr>
						...
						<table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
						  <tr>
							 ...
							 <td align="middle" width="12%" bgColor="#e7e7e7"><strong>업체회원수</strong></td>
