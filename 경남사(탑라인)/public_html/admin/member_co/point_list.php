...
?>
		...
		<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
			<tr>
			  <td vAlign="top" width="90%" bgColor="#ffffff">쿠폰을 포인트로 전환한 업체회원들의 포인트를 기록/관리하는 곳입니다. <br>업체회원명을 클릭하시면 포인트를 추가 또는 삭감하실 수 있습니다.</td>
			</tr>
			<tr>
			  ...
			  <table width="97%" border="0">
				 <tr>
					...
					<tr bgColor="#CCCCCC" height="28" align="center">
						...
						<td width="10%"><b>업체회원 ID</b></td>
						<td width="15%"><b>업체회원명</b></td>
						<td width="19%"><b>쿠폰발급업체회원사</b></td>
...
while( $row = mysql_fetch_array($result) ){
	...
	$provider_id = $row[provider_id];//쿠폰을 지급한 업체회원사
