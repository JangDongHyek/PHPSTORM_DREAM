							...
							<table border="0" width="97%">
								<tr>
									<td width="100%" bgcolor="#999999">
										...
										<tr>
											<td bgcolor="#C8DFEC" align="left">직업</td>
											<td bgcolor="#FFFFFF" align="left" colspan=3><input name="ext1_content" value="<?=$ext1_content?>" size="30" class="input_03" style="width:80%"></td>
										...
										<tr>
											 <td align="left" bgColor="#c8dfec">회원구분</td>
											 <td align="left" bgColor="#ffffff" colSpan="3">
												<?
												if($member_type == "C"){echo"업체회원";}else{echo"일빈회원";}?>			 
										...
										?>
										<tr>
											 <td align="left" bgColor="#c8dfec">업소명</td>
											 <td align="left" bgColor="#ffffff" colSpan="3">
												<input name="co_name" value='<?=$co_name?>' size="50" class="input_03" style="width:40%">	
											 </td>
										  </tr>
										<tr>
											 <td align="left" bgColor="#c8dfec">전화번호</td>
											 <td align="left" bgColor="#ffffff" colSpan="3">
												<input name="co_tel" value='<?=$co_tel?>' size="50" class="input_03" style="width:40%">	
											 </td>
										  </tr>
										<tr>
											 <td align="left" bgColor="#c8dfec">주소</td>
											 <td align="left" bgColor="#ffffff" colSpan="3">
												<input name="co_zip" value='<?=$co_zip?>' size="7" class="input_03" style="width:10%">	<BR>
												<input name="co_address1" value='<?=$co_address1?>' size="50" class="input_03" style="width:80%">	<BR>
												<input name="co_address2" value='<?=$co_address2?>' size="50" class="input_03" style="width:80%">	

											 </td>
										  </tr>
										<tr>
											 <td align="left" bgColor="#c8dfec">사업자번호</td>
											 <td align="left" bgColor="#ffffff" colSpan="3">
												<input name="co_number" value='<?=$co_number?>' size="50" class="input_03" style="width:40%">	
											 </td>
										  </tr>
										<tr>
											 <td align="left" bgColor="#c8dfec">간단소개</td>
											 <td align="left" bgColor="#ffffff" colSpan="3">
												<textarea cols=50 rows=5 name=co_content><?=$co_content?></textarea>
											 </td>
										  </tr>
										<?
										}
