...
?>
				 ...
				 <tr>
					...
					회원사수 : 총 <font color="#ff0000"><?=$total?></font></b></td>
			  ...
			  <table width="97%" border="0">
				 <tr>
					...
					<tr align="middle" height="30">
						<td width="10%" bgColor="#cccccc"><b>번 호</b></td>
						<td width="20%" bgColor="#cccccc"><b>회원사명</b></td>
						<td width="20%" bgColor="#cccccc"><b>연락처</b></td>
						<td width="20%" bgColor="#cccccc"><b>이메일</b></td>
						<td width="30%" bgColor="#cccccc"><b>지불금액</b></td>
					  </tr>
<?
...
?>
					  <tr align='center' height="25">
						 ...
						 <td bgColor='#ffffff'><b><?=$sum_str?>원</b></td>
					  </tr>
<?								
}
?>
