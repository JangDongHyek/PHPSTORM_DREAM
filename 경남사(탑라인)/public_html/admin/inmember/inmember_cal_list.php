...
?>
				 ...
				 <tr>
					...
					<input class='butt_none' style='width:40' type="submit" value="검 색"> </td>
				 </tr>
				 </form>
			  </table>
			  </td>
...
if($order == 'username'){
	if($orderby == 'desc'){	
?>
						<a class='dd' href='<?=$PHP_SELF?>?page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&order=username&orderby=asc&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'>ID</a><small>▼</small>
<?
	}else{
?>
						<a class='dd' href='<?=$PHP_SELF?>?page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&order=username&orderby=desc&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'>ID</a><small>▲</small>
<?
	}	
}else{
?>
						<a class='dd' href='<?=$PHP_SELF?>?page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&order=username&orderby=desc&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'>ID</a>
<?
}
?>
						</b></td>
...
if($order == 'name'){
	if($orderby == 'desc') {
?>
						<a class='dd' href='<?=$PHP_SELF?>?page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&order=name&orderby=asc&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'>입점몰명</a><small>▼</small>
<?
	}else {
?>
						<a class='dd' href='<?=$PHP_SELF?>?page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&order=name&orderby=desc&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'>입점몰명</a><small>▲</small>
<?
	}	
}else{
?>
						<a class='dd' href='<?=$PHP_SELF?>?page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&order=name&orderby=desc&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'>입점몰명</a>
<?
}
?>
						 </b></td>
...
?>
					  <tr align='center' height="25">
						 <td bgColor='#ffffff'><a href='inmall_cal_view.php?page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&username=<?=$username?>&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'><b><?=$username?></b></a></td>
						 <td bgColor='#ffffff'><a href='inmall_cal_view.php?page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&username=<?=$username?>&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'><b><?=$name?></b></a></td>
...
?>
				<a href='<?=$PHP_SELF?>?page=1&keyset=<?=$keyset?>&searchword=<?=$searchword?>&order=<?=$order?>&orderby=<?=$orderby?>&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'>처음</a> 
<?
}
if($start_page > 1){
?>
...
?>
				<a href='<?=$PHP_SELF?>?page=<?=$total_page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>&order=<?=$order?>&orderby=<?=$orderby?>&QryFromDate1=<?=$QryFromDate1?>&QryToDate1=<?=$QryToDate1?>'>끝</a> 
<?
}
?>
				</td>
