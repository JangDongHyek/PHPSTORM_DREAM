...
function toggle3(val) {
	dl = document.best_list;

    for (i = 0; i < dl.elements.length; i++) {
      if (dl.elements[i].name == 'best_checkSel[]')
        dl.elements[i].checked = val;
    }
}
...
function checkitems3(){
	var i;
	a_checkbox  = document.getElementsByName("best_checkSel[]");
	for(i=0; i<a_checkbox.length; i++)
	{
		if(a_checkbox[i].checked == true)
			break;
...
for($i=0; $i < $tot0; $i++){
	...
	if($i < $tot0 - 1){
		$down_str = "<a href='theme_item_old.php?new_item_no=$new_item_no&new_item_order=$new_item_order&flag=down'><img src='../images/dn_subcategory.gif' width='13' height='13' border='0' alt='한단계내리기'>";
	}else{
		$down_str = "<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'> ";
	}

	if($i > 0){
		$up_str = "<a href='theme_item_old.php?new_item_no=$new_item_no&new_item_order=$new_item_order&flag=up'><img src='../images/up_subcategory.gif' width='13' height='13' border='0' alt='한단계올리기'>";
	}else{
...
?>
									...
									<input type='hidden' name='new_no[]' value='<?=$new_item_no?>'>
										...
										<!-- <td><?=$new_main_str?></td> -->
										<td><input onclick="document.location.href='theme_item_old.php?flag=del&target=new&new_item_no=<?=$new_item_no?>'" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='삭제'></td>
									</tr>
<?
}
?>
...
<!---------------------------- 인기상품 관리 시작 ------------------------------->
									<form name='fav_list' action='theme_item_old.php' method='post'>
									<input type='hidden' name='flag' value='fav_item'>
									<tr>
										<td width="53%" bgcolor="#8FBECD" align="left" colspan="5" height="1">
											<table border="0" width="100%" cellspacing="0" cellpadding="0">
												<tr>
													<td width="50%"><b>인기상품 관리</b></td>
													<td width="50%" align="right"><input onclick="javascript:toggle2(1)" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #3D918A 1px solid; BORDER-LEFT:  #3D918A 1px solid; BORDER-RIGHT: #3D918A 1px solid; BORDER-TOP: #3D918A 1px solid; COLOR:#3D918A;  HEIGHT: 18px" type="button" value="전체선택">&nbsp;<input onclick="javascript:toggle2(0)" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #3D918A 1px solid; BORDER-LEFT:  #3D918A 1px solid; BORDER-RIGHT: #3D918A 1px solid; BORDER-TOP: #3D918A 1px solid; COLOR:#3D918A;  HEIGHT: 18px" type="button" value="선택해제">&nbsp;<input onclick="fav_del_item(this.form)" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #3D918A 1px solid; BORDER-LEFT:  #3D918A 1px solid; BORDER-RIGHT: #3D918A 1px solid; BORDER-TOP: #3D918A 1px solid; COLOR:#3D918A;  HEIGHT: 18px" type="button" value="선택삭제">&nbsp;<input onclick="window.location.href='fav_item_new.php'" style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" type="button" value="인기상품 등록">&nbsp;&nbsp;
													<input type='submit' style="BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px" value="인기상품 순서 변경">
													</td>
												</tr>
											</table>
										</td>
...
?>
									<tr>
										<td width="53%" bgcolor="#FFFFFF" colspan="5" align="center">총 <?=$tot2?>개의 인기상품이 등록되어 있습니다.</td>
									</tr>
									<tr align="center" bgcolor="#FFFFFF">
										<td width="8%">번호</td>
										<td width="10%">순서</td>
...
for ($i=0; $i < $tot2; $i++){
	...
	if( $fav_main == 'y' ){
		$fav_main_str = "<input onclick=\"document.location.href='theme_item_old.php?flag=fav&target=main&fav_item_no=$fav_item_no'\" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: blue; HEIGHT: 18px' type='button' value='메인상품'>";
	}else{
		$fav_main_str = "<input onclick=\"document.location.href='theme_item_old.php?flag=fav&target=list&fav_item_no=$fav_item_no'\" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='일반상품'>";
	}
	...
	if($i < $tot2 - 1){
		$down_str = "<a href='theme_item_old.php?fav_item_no=$fav_item_no&fav_item_order=$fav_item_order&flag=down'><img src='../images/dn_subcategory.gif' width='13' height='13' border='0' alt='한단계내리기'>";
	}else{
		$down_str = "<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'> ";
	}

	if($i > 0){
		$up_str = "<a href='theme_item_old.php?fav_item_no=$fav_item_no&fav_item_order=$fav_item_order&flag=up'><img src='../images/up_subcategory.gif' width='13' height='13' border='0' alt='한단계올리기'>";
	}else{
		$up_str = "<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'>";
	}
...
?>								
									...
									<input type='hidden' name='fav_no[]' value='<?=$fav_item_no?>'>
										...
										<td align="center"><input onclick="document.location.href='theme_item_old.php?flag=del&target=fav&fav_item_no=<?=$fav_item_no?>'" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='삭제'></td>
									</tr>
<?
}
?>
...
<!---------------------------- 베스트상품 관리 시작 ------------------------------------->
									<form name='best_list' action='theme_item_old.php' method='post'>
...
for($i=0; $i < $tot6; $i++){
	...
	if( $best_main == 'y' ){
		$best_main_str = "<input onclick=\"document.location.href='theme_item_old.php?flag=best&target=main&best_item_no=$best_item_no'\" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: blue; HEIGHT: 18px' type='button' value='메인상품'>";
	}else{
		$best_main_str = "<input onclick=\"document.location.href='theme_item_old.php?flag=best&target=list&best_item_no=$best_item_no'\" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='일반상품'>";
	}
	...
	if($i < $tot6 - 1){
		$down_str = "<a href='theme_item_old.php?best_item_no=$best_item_no&best_item_order=$best_item_order&flag=down'><img src='../images/dn_subcategory.gif' width='13' height='13' border='0' alt='한단계내리기'>";
	}else{
		$down_str = "<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'> ";
	}

	if($i > 0){
		$up_str = "<a href='theme_item_old.php?best_item_no=$best_item_no&best_item_order=$best_item_order&flag=up'><img src='../images/up_subcategory.gif' width='13' height='13' border='0' alt='한단계올리기'>";
	}else{
		$up_str = "<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'>";
	}
...
?>
									...
									<input type='hidden' name='best_no[]' value='<?=$best_item_no?>'>
										<td><?=$j?><input type='checkbox' name='best_checkSel[]' value='<?=$best_item_no?>'></td>
										...
										<td align='left' colspan='2'><?=$upperclass_str?> &gt; <a onclick="window.open( '../good/item_edit_old.php?item_no=<?=$item_no?>', 'mainpage','toolbar=no,width=700,height=600,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no');" style='cursor:hand'><?=$item_name?></a></td>
										<!-- <td><?=$best_main_str?></td> -->
										<td><input onclick="document.location.href='theme_item_old.php?flag=del&target=best&best_item_no=<?=$best_item_no?>'" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='삭제'></td>
									</tr>
<?
}
?>
...
<!---------------------------- 추천상품 관리 시작 --------------------------------------->
									<form name='rec_list' action='theme_item_old.php' method='post'>
...
for($i=0; $i < $tot4; $i++){
	...
	if( $rec_main == 'y' ){
		$rec_main_str = "<input onclick=\"document.location.href='theme_item_old.php?flag=rec&target=main&rec_item_no=$rec_item_no'\" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: blue; HEIGHT: 18px' type='button' value='메인상품'>";
	}else{
		$rec_main_str = "<input onclick=\"document.location.href='theme_item_old.php?flag=rec&target=list&rec_item_no=$rec_item_no'\" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='일반상품'>";
	}
	...
	if($i < $tot4 - 1){
		$down_str = "<a href='theme_item_old.php?rec_item_no=$rec_item_no&rec_item_order=$rec_item_order&flag=down'><img src='../images/dn_subcategory.gif' width='13' height='13' border='0' alt='한단계내리기'>";
	}else{
		$down_str = "<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'> ";
	}

	if($i > 0){
		$up_str = "<a href='theme_item_old.php?rec_item_no=$rec_item_no&rec_item_order=$rec_item_order&flag=up'><img src='../images/up_subcategory.gif' width='13' height='13' border='0' alt='한단계올리기'>";
	}else{
		$up_str = "<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'>";
	}
...
?>
									...
									<input type='hidden' name='checkSel[]' value='<?=$rec_item_no?>'>
										...
										<td align='left' colspan='2'><?=$upperclass_str?> &gt;  <a onclick="window.open( '../good/item_edit_old.php?item_no=<?=$item_no?>', 'mainpage','toolbar=no,width=700,height=600,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no');" style='cursor:hand'><?=$item_name?></a></td>
										<td><input onclick="document.location.href='theme_item_old.php?flag=del&target=rec&rec_item_no=<?=$rec_item_no?>'" style='BACKGROUND-COLOR: white; BORDER-BOTTOM: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; COLOR: black; HEIGHT: 18px' type='button' value='삭제'></td>
									</tr>
<?
	}else {
?>
...
<?
		if($i < $tot4 - 1){
?>
											<a href='theme_item_old.php?rec_item_no=<?=$rec_item_no?>&rec_item_order=<?=$rec_item_order?>&flag=down'><img src='../images/dn_subcategory.gif' width='13' height='13' border='0' alt='한단계내리기'></a>
<?
		}else{
?>
...
<?
		...
		if($i > 0){	
?>
											<a href='theme_item_old.php?rec_item_no=<?=$rec_item_no?>&rec_item_order=<?=$rec_item_order?>&flag=up'><img src='../images/up_subcategory.gif' width='13' height='13' border='0' alt='한단계올리기'></a>
<?
		}else{
?>
											<img src='../images/blank_subcategory.gif' width='13' height='13' border='0'> 
...
if($flag=="del_item1"){
	...
	echo "<meta http-equiv='refresh' content='0; URL=theme_item_old.php'>";
}
//================== 인기상품 체크박스 삭제 =================================
...
if($flag=="del_item3"){
	for($i=0; $i<count($best_checkSel); $i++) {
			$sql = "delete from $Best_ItemTable where best_item_no = '$best_checkSel[$i]'";
			$res = mysql_query($sql, $dbconn);
