    	...
    	<table border="0" width="100%" cellspacing="0" cellpadding="0">
      	<tr>
        	<td width="90%" bgcolor="#FFFFFF" valign="top">　
        		...
        		추천상품 등록갯수제한은 없으나 3~6개 정도를 권장합니다.<br>
        		<br>
        		</td>
      	</tr>
      	<tr>
                        					...
                        					<td width="100%" bgcolor="#F7F7F7" height="20">
                        						...
                        						<tr>
                        							...
                        							<td width="50%"><strong><p align="right"></strong>
                        								...
                        								<option value="fav_item_new.php">인기상품 등록</option>
...
if ($flag == "to_rec_item"){
	for($i=0; $i<count($checkSel); $i++) {
		...
		$SQL = "insert into $Rec_ItemTable (item_no, mart_id, provider_id, rec_item_order) values ($item_no, '$mart_id', '$provider_id', $maxRec_Item_order)";
		$dbresult = mysql_query($SQL, $dbconn);
		if ($dbresult == false) echo "쿼리 실행 실패!";
	}
