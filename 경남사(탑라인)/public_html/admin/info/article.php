...
?>
		...
		<td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="50" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>이용약관</b></td>
				</tr>
			</table>
...
<input type="hidden" name="flag" value="update">
		...
		<tr>
		  <td width="100%" bgcolor="#FFFFFF" align="center" height="35"><strong>2, 개인정보보호정책 입력 </strong>(★부분에 회사명등 쇼핑몰에 맞게 변경하세요.)</td>
		</tr>
		<tr>
