...
<!----------------------------------- 내용 시작 ----------------------------------------->
				...
				<table width="720" border="0" cellspacing="0" cellpadding="0">
					...
					<!-- <tr><td colspan=2 bgcolor=white><img src=nalog_image/logo_small.gif border=0></td></tr> -->
					<!-- <tr><td colspan=2 bgcolor=white>
				 		<table width=100% cellpadding=0 cellspacing=0>
						<tr>
						<td><font color=#008CD6 size=4><b>&nbsp;<?=$title?></font></td>
						<td align=right> <?=$close?> <?=$help?> <?=$manual?> 
						<?if(!$HTTP_COOKIE_VARS[nalog_admin]){?><font color=#008CD6 size=1><a href=login.php?go=admin_counter.php?counter=<?=$counter?>>LOGIN</a></font><?}
						else{?><font color=#008CD6 size=1><a href=logout.php?go=admin_counter.php?counter=<?=$counter?>>LOGOUT</a></font><?}?>
						<?=$go_root?></td>
						</tr>
						</table>
					</td></tr> -->
