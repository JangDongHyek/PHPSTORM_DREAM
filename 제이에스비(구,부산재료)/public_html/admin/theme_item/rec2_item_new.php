						...
						<table border="0" width="100%">
							...
							<tr>
								<td width="100%" bgcolor="#CCCCCC">
									...
									<form action='rec2_item_new.php' method='post' name='list'>
...
if ($flag == "to_rec_item"){
	for($i=0; $i<count($checkSel); $i++) {
		...
		$SQL = "select count(*) from $Rec2_ItemTable where mart_id='$mart_id' and item_no = $item_no";
		$dbresult = mysql_query($SQL, $dbconn);
		...
		$SQL = "select max(rec_item_order), count(*) from $Rec2_ItemTable";
		$dbresult = mysql_query($SQL, $dbconn);
		...
		$SQL = "insert into $Rec2_ItemTable (item_no, firstno, prevno, category_num, mart_id, provider_id, rec_item_order) values ( '$item_no', '$firstno', '$prevno', '$category_num', '$mart_id', '$provider_id', $maxRec_Item_order)";
