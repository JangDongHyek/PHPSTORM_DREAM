    	...
    	<table border="1" cellpadding="5" cellspacing="0" width="90%" bordercolordark="white" bordercolorlight="#E1E1E1" align="center">
      	<tr>
        	<td width="90%" bgcolor="#FFFFFF" valign="top">
        		<strong><span class="cc">[세공재료 등록]</span></strong> 등록되어진 제품 중 세공재료으로 등록합니다.<br>등록한 세공재료은 메인화면의 세공재료영역에 출력됩니다<br>
					</td>
      	</tr>
      	<tr>
          		...
          		<tr>
            		<td width="100%" bgcolor="#CCCCCC">
            			<table border="0" width="100%" bgcolor="#F7F7F7" cellspacing="1" cellpadding="3">
              			...
              			<form action='new_item_new.php' method='post' name='list'>
...
if ($flag == "to_new_item"){
	for($i=0; $i<count($checkSel); $i++) {
		...
		$SQL = "select max(new_item_order), count(*) from $New_ItemTable";
		$dbresult = mysql_query($SQL, $dbconn);
		...
		$SQL = "insert into $New_ItemTable (item_no, firstno, prevno, category_num, mart_id, provider_id, new_item_order) values ( '$item_no', '$firstno', '$prevno', '$category_num', '$mart_id', '$provider_id', $maxNew_Item_order)";
		$dbresult = mysql_query($SQL, $dbconn);
		if ($dbresult == false) echo "쿼리 실행 실패!";
	}
