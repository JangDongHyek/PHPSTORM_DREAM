...
?>
										&nbsp;<b><?=$category_name?> (<?=$category_num?>)</b>&nbsp;<?=$hide_str?></a>
									</td>
...
?>				
										<span class='aa'>[<?=$k?>]
										<?=$category_name2?> (<?=$category_num2?>)&nbsp;<?=$hide2_str?></a>
									</td>
...
?>				
										<span class='aa'>[<?=$p?>]
										<?=$category_name3?> (<?=$category_num3?>)&nbsp;<?=$hide3_str?></a>
									</td>
...
?>
			...
			?>				
													<span class='aa'>[<?=$p?>]
													<?=$category_name4?> (<?=$category_num4?>)&nbsp;<?=$hide4_str?></a>
												</td>
