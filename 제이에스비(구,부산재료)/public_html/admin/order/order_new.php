...
if($update_flag == ''){
	...
	$method = "<a href='http://pgweb.dacom.net/' target='_new'>[DACOM 카드결제현황]</a>";
										...
										<tr height="10">
										 ...
										 <tr>
											...
											<td width="59%" colspan="2">
												...
												<option value="8" <?if($status_flag == 8) echo " selected";?>>고객주문취소</option>
												</select>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
for ($i=$skipNum; $i < ($cnfPagecount+$skipNum); $i++) {	
	...
	for ($k=0; $k<$numRows1; $k++) {
		...
		$item_detail_body .= "<td width='50%'><img src='../images/dot.gif' width='5' height='7'>$item_name $item_code_str : $quantity</td>";
	...
	if($ary[index_no] < 297 || $ary[index_no] > 304){
