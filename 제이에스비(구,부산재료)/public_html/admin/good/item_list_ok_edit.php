...
function cal(){
	...
	var tot; 
	tot = Math.ceil( ( ( here.z_price.value * (100 - here.g_margin.value) ) / 100 ) / 10 ) * 10;
      	...
      	<tr>
        	<td width="100%" bgcolor="#FFFFFF" valign="top" align="center">
        		<table border="0" width="95%">
          		<form action='item_modify.php?item_no=<?=$item_no?>&back=ok' method="post" name='writeform' onsubmit="return checkform(this)" enctype="multipart/form-data">
...
?>
			              ...
			              <tr>
			                <td align="left" width="26%" bgColor="#ffffff" align="center">
<?
...
?>
			              ...
			              <tr>
			                ...
			                <td width="87%" bgColor="#ffffff" colspan="4">
								&nbsp;<input name="img_sml" value='<?=$img_sml?>' class='input' size="25">
			              ...
			              <tr>
			                ...
			                <td width="87%" bgColor="#ffffff" colspan="4">
								&nbsp;<input name="img" value='<?=$img?>' size="25" class='input'>
			              ...
			              <tr>
			                ...
			                <td width="87%" bgColor="#ffffff" colspan="4">
								&nbsp;<input name="img_big" value='<?=$img_big?>' class='input' size="25"> 
								...
								플래쉬 가로길이
								<input name="flash_big_width" value='<?=$flash_big_width?>' class='input' size="3">&nbsp;&nbsp;&nbsp; 
								세로길이
								<input name="flash_big_height" value='<?=$flash_big_height?>' class='input' size="3">&nbsp;&nbsp;&nbsp; <br>
								<font color="#0000ff">플래쉬 파일을 올릴경우 가로와, 세로 길이를 입력해주세요.단위는 px 입니다.</font>
							</td>
			              </tr>
			              <tr>
			                <td width="100%" bgColor="#ffffff" colSpan="6" align="left">
								...
								상세설명 페이지의 사이즈는 120*120 px 고정입니다.<br>
								확대이미지의 권장사이즈는 240*240 px이고, 임의대로 사이즈조정 
								가능합니다.<br>
			              ...
			              <!--<tr>
							<td align="middle" width="8%" bgColor="#c8dfec"><span class="aa">고화질<br>이미지</span></td>
							<td align="middle" width="94%" bgColor="#FFFFFF" colspan="5"><p align="left">　
								...
								<input onclick="javascript:fileup('writeform','img_high');" class="aa" style="BORDER-RIGHT: #5a5a5a 1px solid; BORDER-TOP: #5a5a5a 1px solid; BORDER-LEFT: #5a5a5a 1px solid; COLOR: black; BORDER-BOTTOM: #5a5a5a 1px solid; height: 18px; BACKGROUND-COLOR: white" type="button" value="찾아보기" style='cursor:hand'>&nbsp; <br>
							</td>
						  </tr>
						  <tr>
							<td align="left" width="100%" bgColor="#ffffff" colSpan="6">
								<img height="15" src="../images/tip.gif" width="30"> <font color="#0000ff">고화질 이미지는 이미지줌프로그램을 
              			...
              			<tr>
                			<td width="100%" bgcolor="#FFFFFF" align="center" colspan="6">
								<object id="explain_txt" codebase="<?=$edit_url?>GsWebEdit.cab#version=1,0,0,62" height="350" width="100%" classid="CLSID:8B844CB2-4E1B-4707-B3D5-31C00D717398">
...
?>	
      	...
      	<tr>
        	<td width="100%" bgcolor="#FFFFFF" valign="top"><p align="center"><br>
        		...
        		<input onclick="location.href='item_list.php?category_num=<?=$category_num?>&page=<?=$page?>&searchword=<?=$searchword?>'" class='butt_none' style='width:60' type="button" value="리스트" style='cursor:hand'>
        	</td>
      	</tr>
