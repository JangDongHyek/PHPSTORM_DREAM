	...
	<tr valign="top">
		<td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
				<td width="100%" height="50" bgcolor="F2F2F2" class="title"><img src="../images/icon_1.gif" width="30" height="17" align="absmiddle"><b>상품 관리 </b><br> [전체 상품수 : <?=$item_count?>개]</b></td>
				</tr>
			</table>
...
<?
		...
		{
?>
			insDoc(foldersTree, gLnk(0, "<?=$category_name?>", "./all_item_list.php?pu=1&category_num=<?=$category_num?>"))
<?
		}else{
?>
			aux1 = insFld(foldersTree, gFld("<font color='blue'><?=$category_name?></font>","./all_item_list.php?pu=1&category_num=<?=$category_num?>"));
<?
		}
	}
...
?>
			//insDoc(aux1, gLnk(0, "<?=$category_name2?>", "./all_item_list.php?pu=2&category_num=<?=$category_num2?>"))
			aux2 = insFld(aux1,gFld("<font color='blue'><?=$category_name2?></font>","./all_item_list.php?pu=2&category_num=<?=$category_num2?>"))
<?
		}
...
?>
					insDoc(aux2, gLnk(0, "<?=$category_name3?>", "./all_item_list.php?category_num=<?=$category_num3?>"))
<?
				}
				else { 
?>
					aux3 = insFld(aux2,gFld("<font color='blue'><?=$category_name3?></font>","./all_item_list.php?pu=3&category_num=<?=$category_num3?>"))
					//insDoc(aux2, gLnk(0, "<font color='blue'><?=$category_name3?></font>", "./all_item_list.php?pu=3&category_num=<?=$category_num3?>"))
<?					
					//================== 3차 카테고리 ================================================
...
?>
							insDoc(aux3, gLnk(0, "<?=$category_name4?>", "./all_item_list.php?pu=4&category_num=<?=$category_num4?>"))
<?
						}
					}
				}
