...
?>	
	            		<tr>
                			...
                			<td width="53%" bgcolor="#FFFFFF" align="left" colspan="3" rowspan="8">
...
for($i=1;$i< $op1_count;$i++){
	...
	if(!empty($op1_1[3])) $mem_price_str = "코드:".$op1_1[3];
	else $mem_price_str = '';

	if(!empty($op1_1[4])) $op_name1_2 = $op1_1[4].":";
	else $op_name1_2 = '';

	if(!empty($op1_1[4])) $pro_color = $op1_1[5];
	else $pro_color = '';

	echo ("
		<option value='$op1[$i]'>$op1_1[0]($op1_1[1] 원)$bonus_str $mem_price_str $op_name1_2 $pro_color</option>
	");
}
?>		
	            				</select><br>
	            				<span class="aa">M: 포인트 </span>
							</td>
              			</tr>
              			<tr>
              			...
              			<tr>
                			...
                			<td width="35%" bgcolor="#FFFFFF">
                				<input class='input' name="op_name1_2" size="14" value="<?=$op1_1[4]?>">
							</td>
              			</tr>
              			<tr>
                			<td width="21%" bgcolor="#C8DFEC" align="center" colspan="2">
               			...
               			<tr>
                			...
                			<td width="35%" bgcolor="#FFFFFF">
                				<input name="pro_mem_price1" size="36" class='input'">
							</td>
              			</tr>
             			<tr>
                			<td width="47%" bgcolor="#FFFFFF" align="center" colspan="3">
                				<input onclick="pro_add1(this.form,document.all.pro_value1.value,document.all.pro_price1.value,document.all.pro_bonus1.value,document.all.pro_mem_price1.value,document.all.op_name1_2.value,document.all.pro_color.value)" class='butt_none' style='width:60' type="button" value="입 력" style='cursor:hand'> 
                				...
                				<table border="0" width="80%">
                  				...
                  				<tr>
                    				<td width="100%">
                    					<br>
                    					1. 가격차등 옵션사용<br>
                    					예)사이즈에 따라 가격이 같을 경우는 가격을 입력하지 마시고 가격이 다를 경우 가격을 입력하셔야 합니다.<br>
                    					옵션제목: 사이즈<BR>
										옵션항목: 123*456<BR>
										가격입력 : 1000 또는 공란<BR>
										옵션제목2 : 색상<BR>
										옵션항목2 : 빨강,파랑,초록(옵션항목2는 ","로 구분됩니다)<br>
										코드입력 : T1,T2,T3(사이즈와  색상에 따른 코드입력 예제)<BR><BR>

										※사이즈에 따른 코드입력은 그냥 그사이즈에 맞는 코드값을 입력하시면 되고 사이즈와 색상에 따른 코드값은 옵션항목2와 순서를 같이 맞춰서 ","로 구분하셔셔 입력하시면 됩니다.								
                    					<!--<br>
                    					2. 가격동일 옵션사용의 경우<br>
