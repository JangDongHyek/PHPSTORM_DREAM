				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						...
						<table width="100%"  border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<input type='image' onfocus='blur();' src="../image/helpdesk/bu_ok.gif" align="absmiddle" border="0">&nbsp;<a href="board_list.php?mart_id=<?=$mart_id?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>"><img src="../image/helpdesk/bu_list.gif" border="0" align="absmiddle"></a>
								</td>
							</tr>
						</table>
						<!--버튼 End -->
...
<? 
		if( $userfile ){ 
?>
								<a href='down.php?mart_id=<?=$mart_id?>&index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&mode=file'><?=$userfile?></a> (<?=$size?>)&nbsp;
<?
		}
?>
<? 
		if( $userfile1 ){ 
?>
								<a href='down.php?mart_id=<?=$mart_id?>&index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&mode=file1'><?=$userfile1?></a> (<?=$size1?>)
<?
		}
?>
							</td>
...
?>
						<tr>
							<td align="center" style="padding:20px;"><a href='#1' onClick="window.open('big.html?file=<?=$userfile?>&mart_id=<?=$mart_id?>','원본사진보기','width=<?=$img_width?>,height=<?=$img_height?>,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no')" onFocus='blur();'><?=$img_file?></a></td>
						</tr>
<?
	}
?>
...
?>
						...
						<tr>
							<td align="center" style="padding:20px;"><a href='#1' onClick="window.open('big.html?file=<?=$userfile1?>&mart_id=<?=$mart_id?>','원본사진보기','width=<?=$img_width1?>,height=<?=$img_height1?>,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no')" onFocus='blur();'><?=$img_file1?></a></td>
						</tr>
<?
	}
?>
						<tr>
							<td>
								<table width="100%"  border="0" cellspacing="0" cellpadding="10">
									<tr>
										<td height="250" valign="top" style="padding:20px;"><p align='justify'><?=$content?></p></td>
									</tr>
								</table>
							</td>
						</tr>
...
?>
					<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="50">
								<?=$mod_perm?><?=$del_perm?><a href='board_reply.php?mart_id=<?=$mart_id?>&index_no=<?=$index_no?>&bbs_no=<?=$bbs_no?>&page=<?=$page?>&keyset=<?=$keyset?>&searchword=<?=$searchword?>'><img src="../image/helpdesk/bu_reply.gif" border="0"></a>
							</td>
...
<input type="Hidden" name="searchword" value="<?=$searchword?>">
            	...
            	<tr>
            		<td><img src="../image/helpdesk/table3_top.gif"></td>
           		</tr>
            	<tr>
            		<td background="../image/helpdesk/table3_bg.gif"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                	<tr>
                		...
                		<td width="60"><img src="../image/helpdesk/add_pass.gif"></td>
            	...
            	<tr>
            		<td><img src="../image/helpdesk/table3_bottom.gif"></td>
           		</tr>
            	</table>
					<!--덧글작성 End-->
					</td>
