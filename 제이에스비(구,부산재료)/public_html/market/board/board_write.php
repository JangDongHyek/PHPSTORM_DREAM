...
?>
<!---------------------- 게시판 시작 ---------------------------------------------------->
					<form method="POST" name='writeform' enctype="multipart/form-data" onsubmit='board_checkform(); return false' action="https://www.jsbusan.com:8026/market/board/board_write.php"> 
					...
					<table width="96%" align="center" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="../image/helpdesk/table1_bg.gif"> &nbsp;&nbsp;<input name="subject_new" type="text" size="90" style='ime-mode:active' class="input_03" id="subject_new"></td>
...
#######################################################################
	...
	if( $return == "product" ){
		...
		echo "<meta http-equiv='refresh' content='0; URL=http://www.jsbusan.com/market/board/board_list.php?mart_id=$mart_id&bbs_no=$bbs_no'>";
	}
}
?>
<?
