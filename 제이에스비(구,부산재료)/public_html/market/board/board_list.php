...
<!---------------------- FAQ 답변 시작 -------------------------------------------------->
						...
						<table width="96%" align="center"  border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td><img src="../image/helpdesk/view_table_top.gif"></td>
							</tr>
							<tr>
							...
							<tr>
								<td><img src="../image/helpdesk/view_table_bottom.gif"></td>
							</tr>
							<tr>
								<td height="10"></td>
							</tr>
...
<!---------------------- 검색 시작 ------------------------------------------------------>
						<table width='96%' align="center"  border='0' cellspacing='0' cellpadding='0'>
							...
							<input type="hidden" name="bbs_no" value="<?=$bbs_no?>">
								<td width='10'><img src='../image/helpdesk/table2_left.gif'></td>
					          ...
					          <option value="subject_new" selected>제목</option>
								...
								<td width='10'><img src='../image/helpdesk/table2_right.gif'></td>
							</form>
							</tr>
						</table>
<!---------------------- 검색 끝 -------------------------------------------------------->
