...
?>
                         <tr>
                        	<td bgcolor="#F7F7F7" class="text_14_s2"><img src="../image/icon_4.gif" width="15" height="9" align="absmiddle">부가세</td>
                        	<td><span class="text_red"><?=number_format($tax_price)?>원</span></td>
                       	</tr>
						<tr>
