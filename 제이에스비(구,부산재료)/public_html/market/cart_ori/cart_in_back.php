...
if($flag == "addorder"){
	...
	if ($numRows > 0) {
		...
		$SQL = "insert into $Order_ProTable (order_num, mart_id, item_no, item_name, item_code, opt, opt1_5, z_price, quantity, bonus, use_bonus, status, date, provider_id, provide_price) values ('$order_num', '$mart_id', $item_no, '$item_name', '$item_code', '$opt', '$opt1_5', $z_price, $quantity, $bonus, $use_bonus, '0', '$cur_date', '$provider_id', '$provide_price')";		
		$dbresult = mysql_query($SQL, $dbconn);
	}
