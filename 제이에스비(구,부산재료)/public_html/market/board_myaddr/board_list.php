...
function val_sel(rn,ra,rad,rt,rm,rz){

	opener.parent.document.f.receiver.value = rn;
	opener.parent.document.f.address.value= ra;
	opener.parent.document.f.address_d.value= rad;
	opener.parent.document.f.rev_tel.value=rt;
	opener.parent.document.f.rev_tel1.value=rm;
	opener.parent.document.f.zip.value=rz;
	window.close();
}
...
?>
						<table width="96%" align="center" border="0" cellspacing="0" cellpadding="0">
							<tr height='30'>
								<td colspan='2' align='center'><b>등록된 배송지가 없습니다</b></td>
							</tr>
							<tr>
							...
							<input type="hidden" name="bbs_no" value="<?=$bbs_no?>">
								...
								<td align='center' background='../image/helpdesk/table2_bg.gif'><img src='../image/helpdesk/search_type.gif' width='115' height='20' hspace='10' align='absmiddle'>
									<select name="keyset" class='input_03'>
										<option value="subject_new" selected>배송지</option>
										<option value="writer">수령인</option>
									</select>					  
