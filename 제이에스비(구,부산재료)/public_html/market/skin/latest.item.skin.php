...
<div id="floater" style="Z-INDEX: 10; LEFT: 943px; WIDTH: 0px; TOP: 281px; HEIGHT: 53px">
<table width="58" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><img src="../images/banner_1.gif" width="59" height="21" /></td>
  </tr>
  <tr>
    <td><img src="../images/banner_2.gif" width="59" height="7" onclick="upPrdWings(prdWings)" style="cursor:hand" /></td>
  </tr>
  <tr>
    <td height="100" bgcolor="#FFFFFF">
			<div style="height:197px; width:58px;overflow:hidden;">
		...
		?>
					...
					<tr>
						<td>
							<table width="58" border="0" cellspacing="0" cellpadding="0" style='border:1 solid #CCCCCC ;table-layout:fixed;'>
								<tr>
  ...
  <tr>
    <td><img src="../images/banner_4.gif" width="59" height="7" onclick="downPrdWings(prdWings)" style="cursor:hand" /></td>
  </tr>
  <tr>
    <td><a href="#"><img src="../images/banner_5.gif" width="59" height="21"  border="0"></a></td>
  </tr>
    <tr>
    <td><img src="../images/favorite.gif" width="59" height="20"  border="0" onclick="bookmark();" style="cursor:hand;"></a></td>
  </tr>
</table>
</div>