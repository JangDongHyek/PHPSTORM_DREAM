...
<!--
	...
	{
		if(document.getElementById("from_price").value == "" && document.getElementById("to_price").value == "" && !document.getElementById("item_name").value && !document.getElementById("item_company").value && !document.getElementById("item_explain").value && !document.getElementById("item_code").value && !document.getElementById("item_kyukyuk").value)
		{
                            ...
                            <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                      ...
                                      <!--상품코드 검색-->
                                      <tr>
                                        <td height="25"><img src="../image/search_type_7.gif" width="50" height="20" align="absmiddle"></td>
                                        <td><input name="item_code" id="item_code" value='<?=$item_code?>' type="text" class="input_04" size="37" style='ime-mode:active'></td>
                                      </tr>
                                      <!--상품규격 검색-->
                                      <tr>
                                        <td height="25"><img src="../image/search_type_8.gif" width="50" height="20" align="absmiddle"></td>
                                        <td><input name="item_kyukyuk" id="item_kyukyuk" value='<?=$item_kyukyuk?>' type="text" class="input_04" size="37" style='ime-mode:active'></td>
                                      </tr>
                                      <!--상품명 검색-->
                                      <tr>
