...
if($baguni == "y"){
	$backUrl = urlencode("http://jsbusan.com/mobile/cart/cart.html?mart_id=jsbusan");
}else{
	$backUrl = urlencode("http://jsbusan.com/mobile/main/product_info.html?mart_id=jsbusan&category_num=$category_num&item_no=$item_no");
}
