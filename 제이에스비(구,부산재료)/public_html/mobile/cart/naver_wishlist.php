...
//while(...) {
	...
	$url = "http://jsbusan.com/market/main/product_info.html?pagetype=$_SESSION[PageType]&mart_id=jsbusan&category_num=$rows[category_num]&item_no=$rows[item_no]";
...
//echo ($itemId."<br>\n");
$wishlistPopupUrl = "https://checkout.naver.com/mobile/customer/wishList.nhn";
?>
<html>
<body>
