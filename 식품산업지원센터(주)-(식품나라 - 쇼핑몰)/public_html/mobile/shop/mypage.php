...
x<div id="smb_my">
	...
	<section id="smb_my_wish">
        <h2><a href="<?php echo G5_SHOP_URL; ?>/month_menu_order_list.php">최근 도시락 주문내역</a></h2>

        <ul>
            <?php
           $sql="select * from lunch_order where mb_id='$member[mb_id]' order by idx desc limit 0,3";
