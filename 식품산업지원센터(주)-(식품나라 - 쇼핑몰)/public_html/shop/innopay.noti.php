...
if($pgResultCode=="0000"){
		...
		$msg1="주문이 신청되었습니다. 주문번호 : {$od_id} 관리자 페이지에서 확인해 주세요";
		$msg2="{$od_name}님 주문이 신청되었습니다. 주문번호:{$od_id} 감사합니다!";
		//sms 보내기
		goSms("01080015096","0516233775",$msg1);
		goSms($od_hp,"0516233775",$msg2);

		goSms("01042421950","0516233775",$msg1);
		$sql_card_point = "";
...
?>
	<script type="text/javascript">
		opener.document.location.href="<?php echo G5_SHOP_URL?>/orderinquiryview.php?od_id=<?=$od_id?>";
		self.close();
	</script>
<?php
