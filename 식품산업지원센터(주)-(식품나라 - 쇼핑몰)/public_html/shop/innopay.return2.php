...
if($ResultCode=="3001"){
	...
	<script type="text/javascript">
		<?
			if($FORWARD=="Y"){
		?>
			opener.document.getElementsByName("t_no")[0].value="<?=$TID?>";
			...
			opener.document.form.action="<?=G5_SHOP_URL?>/month_menu_update.php";
			opener.document.form.target="";
			opener.document.form.submit();
			self.close();

		<? }else{?>
			parent.document.getElementsByName("t_no")[0].value="<?=$TID?>";
			...
			parent.document.form.action="<?=G5_SHOP_URL?>/month_menu_update.php";
			parent.document.form.target="";
