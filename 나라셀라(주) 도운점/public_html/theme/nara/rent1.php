...
<section id="event" class="f6">
    ...
    <h1><span>1F DOWOON LOUNGE</span>대관 안내</h1>
...
<div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2 wow fadeInUp animated" data-wow-delay="0s" data-wow-duration="2s">
	<div class="swiper-wrapper">
		<div class="swiper-slide">
			<img src="<?php echo G5_THEME_IMG_URL ?>/sub/1r_1.jpg">
		</div>
		<div class="swiper-slide">
			<img src="<?php echo G5_THEME_IMG_URL ?>/sub/1r_2.jpg">
		</div>
	</div>
...
* 시간당 대여는 불가능 합니다. (6시간/12시간 옵션 선택)<br>
* 대관 시간은 공간 이용을 위한 준비 및 마무리 시간까지 포함입니다.<br>
* 세부적인 견적 및 문의 사항은 인스타 @the_dowoon DM 문의 바랍니다. 
	</p>
        </div>
        <div>
            <h6>주차 안내</h6>
