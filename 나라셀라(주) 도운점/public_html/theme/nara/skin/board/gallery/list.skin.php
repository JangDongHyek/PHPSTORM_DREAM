...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul">
        ...
        <?php } ?>
        <?php if (count($list) == 0) { echo "<li class=\"empty_list\" style=\"width:100%;text-align:center;font-size:1.5em\">게시물이 없습니다.</li>"; } ?>
    </ul>
...
<fieldset id="bo_sch">
    ...
    <div style="display: flex; gap: 5px; max-width: 350px">
        <input type="hidden" name="bo_table" value="<?php echo $bo_table ?>">
        ...
        <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="frm_input sch_input required" maxlength="20" style="width: 100%">
        <input type="submit" value="검색" class="btn_submit02" style="width: fit-content; height: 28px">
    </div>
    </form>
</fieldset>
<!-- } 게시물 검색 끝 -->
