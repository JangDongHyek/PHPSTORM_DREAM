...
<div id="bo_list">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <caption><?php echo $board['bo_subject'] ?> 목록</caption>
				<colgroup>
					<col width="*">
					 <?php if ($admin_href) { ?><col width="*"><?php } ?>
					<col width="*">
					<col width="100px">
					<col width="100px">
					<col width="150px">
        ...
        <tr>
            ...
            <td class="td_name"><?php echo $list[$i]['qa_name']; ?></td>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            <?php if ($list_href) { ?><li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=fna" class="btn_b01">자주묻는질문</a></li><?php } ?>
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">문의등록</a></li><?php } ?>
        </ul>
    </div>
    </form>
