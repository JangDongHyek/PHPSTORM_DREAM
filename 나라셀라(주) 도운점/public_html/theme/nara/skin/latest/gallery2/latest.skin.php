...
<div id="oneshot_2_7">
            ...
            <div id="border">
               ...
               <div class="img_set">
                ...
                <div class="subject_set">
                    <div class="sub_title">	
                      <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=case"><?php echo cut_str($list[$i]['subject'], 20, "..") ?></a>
                    </div>
    ...
    <li class="empty_li" style="text-align: center; width: 100%!important">등록된 게시물이 없습니다</li>
    <?php }  ?>
     </ul>
</div><!--#oneshot_2_7-->
