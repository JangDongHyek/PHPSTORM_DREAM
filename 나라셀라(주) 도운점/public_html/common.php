...
define('IP', trim($_SERVER['REMOTE_ADDR'])); /* IP */
define('IS_COMPANY', (IP == '183.103.22.103')); /* 회사 IP 여부 */
define('LASTEST_FILE_VER', '?naraV='.strtotime(date('Y-m-d H:i:s'))); /* 파일버전 공통 */

/* WEB COMMON */
$DATE_HI = date('Y-m-d H:i'); /* date(Y-m-d H:i) */
define('DATE_HI', $DATE_HI); /* date(Y-m-d H:i) */

define('RENT_FLOOR', [ 1=>'Dowoon Lounge', 2=>'Dowoon Hall', 6=>'Dowoon Space']); /* RENT 위치 이름 */
define('STATUS', ['W' => '미답변', 'F' => '답변완료', 'C' => '취소']); /* STATUS 상태 */

define('CLASS_FLOOR', [ 2=>'Dowoon Hall', 6=>'Dowoon Space']); /* RENT 위치 이름 */
define('CLASS_STATUS', ['I' => '진행중', 'F' => '종료']); /* CLASS STATUS 상태 */
define('CLASS_APP_STATUS', ['DEPOSIT_WAIT' => '입금대기', 'WAIT' => '대기', 'CONFIRMED' => '예약확정', 'REFUND' => '환불요청', 'REFUND_END' => '환불완료', 'CANCEL' => '취소']); /* CLASS APP STATUS 상태 */
...
/* 이노페이 */
define('MID_2FLOOR', 'pgnrcell1m');
define('LICENSE_KEY_2FLOOR', 'NvEIluQLani5M8manBw8FV9pUVqVRz/9LC5nzWGeaqcYlPkue25u5mHkDb9KjtxC6QJNraUirqQrMI0Do6jLVQ==');

define('MID', 'pgdowoon1m');
define('LICENSE_KEY', 'nLk7IoCHUe6W0j/bKCTefZW7t8lfBRXjBjqwhAdtUF6khLPyiRL/omvdcpH63BU992/Xygg8AIUazziDy9guxw=='); 
define('CANCEL_PWD', '123456');
define('INNOPAY_BANK', array(
    '001' => '한국은행',
    '002' => '산업은행',
    '003' => '기업은행',
    '004' => '국민은행',
...
// 알림톡
define('WIDESHOT_KEY', 'UVVTRmtVQ0RTTEJDRkpiZkJqdVdrUHFrK2dHMGFhYlQwRi8xbGZrTGJXczVlRGJMNUZmM0ROeHIrdjdTeDM0VA==');
define('WIDESHOT_SERVER', 'https://apimsg.wideshot.co.kr');
define('WIDESHOT_CH_KEY', '52895df380df24fd2245eb500507f96724eb847c');	// 카카오 프로필키(채널키)
define('WIDESHOT_PULSFRIEND', '@도운');	// 플러스친구명
