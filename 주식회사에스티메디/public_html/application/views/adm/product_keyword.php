        ...
        <div class="panel">
            ...
            <span>
                ...
                <?php if($memberId == 'lets080'){ ?>
                    ...
                    <button type="button" class="btn btn_orange" data-toggle="modal" data-target="#defaultFeeModal">정산 수수료 일괄 설정</button>
                <?php } ?>
    ...
    <div class="boxline">
        ...
        <div class="table adm">
            <table>
                ...
                <thead>
                <tr>
                    <th rowspan="2" class="text_left">No.</th>
                    <!--
                    <th>카테고리</th>
                ...
                foreach($listData as $list) {
                    ...
                    <tr>
                        ...
                        <td tag="agency_fee"><input type="text" class="num" name="agency_fee[<?=$idx?>]" value="<?=$list['agency_fee']?>" maxlength="5" max="5" />%</td>
