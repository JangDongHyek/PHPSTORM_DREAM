...
<section class="member agency">
    <form name="searchFrm" autocomplete="off">
        ...
        <div class="panel">
            ...
            <div>
                <select name="sfl">
                    <option value="gname">에이전시명</option>
                </select>
            ...
            <button type="button" class="btn btn_blue" onclick="openRegisterModal()">등록하기</button>
        </div>
    </form>
    <div class="boxline">
        <div class="table adm">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn_blueline" onclick="commonActionDelete('/apiAdmin/deleteMemberGroup', '<?=$list['idx']?>')">삭제</button>
                    </td>
                </tr>
                <?php
                    $paging['listNo']--;
                ...
                <tr><td colspan="20" class="noDataAlign">등록된 에이전시가 없습니다.</td></tr>
                <?php } ?>
                </tbody>
            </table>
        </div>
