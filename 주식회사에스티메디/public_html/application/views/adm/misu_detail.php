...
<section class="order1">
    <form name="searchFrm" autocomplete="off" method="get">
        <div class="panel">
            ...
            <span>
            <button type="button" class="btn btn_blue" data-toggle="modal" data-target="#misu01">외상거래 등록</button>
            ...
            <table class="calculate">
                ...
                <tr>
                    ...
                    <td class="text-center">
						...
						<button type="button" class="btn btn_blueline" onclick="deleteTrans(<?=$idx?>)" <?=$btnDisabled?>>삭제</button>
                    </td>
                </tr>
				<?php
					$paging['listNo']--;
