    ...
    <form name="searchFrm" autocomplete="off" method="get">
        <div class="panel">
            ...
            <div>
                <select name="sfl">
                    <<?
					$sflList = ['cname' => '병원명', 'id'=>'아이디', 'name' => '이름'];
        ...
        <div class="table adm">
            <table class="calculate">
                ...
                <tr>
                    ...
                    <td class="text_right txt_sky"><?=($monthDepAmt>0)?'-':''?><?=number_format($monthDepAmt)?></td>
                    <td class="text_right txt_blue"><?=number_format($monthCreditAmt)?></td>
