    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="groupmodal01Label">에이전시 <span class="labelMsg">등록</span></h5>
            </div>
            <form name="groupFrm" method="post" autocomplete="off">
                <input type="hidden" name="idx" value="">
                <div class="modal-body">
                    <label>에이전시명</label>
                    <input type="text" name="groupName" placeholder="에이전시명을 입력해주세요">
                    <!--label>할증 (%)</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn_blue"><span class="labelMsg">등록</span></button>
                </div>
            </form>
        </div>
    </div>
