<section id="user">
    ...
    <div class="inr flex js">
        <section>
            ...
            <div id="drugs_list_recent_modal">

                <? /*hdiv class="flex js sub">
                    <select class="none">
                        <option>최근 주문순</option>
                        <option>최다 주문순</option>
                    </select>
                    <span class="mari-auto flex">
					<strong>주문일</strong> <input type="date" class="none"/>
				</span>
                </div>
                <div class="search">
                    <form autocomplete="off" onsubmit="">
                        <input type="search" name="hstx" placeholder="원하시는 제품을 검색하세요" value="<?=$_GET['hstx']?>">
                        <button type="submit" class="btn"><i class="fa-regular fa-magnifying-glass"></i></button>
                    </form>
                </div>
                <div class="drugs_list my_list">
                    <ul>
                        <li>
							<div class="flex">
								<input type="checkbox" name="checkIdx" id="checkIdx16" value="5">
								<label for="checkIdx16">
									<div>
									...
									<div class="area_text">
										<p class="p_date"><span>24.01.17</span><br>구매 1회</p>
        ...
        <section id="simple">
            ...
            <div>
                <? /*div class="flex js sub">

                    <span class="select blue">
                        <input type="checkbox" name="cate" id="cate0"/> <label for="cate0">전체 상품</label>
                        <input type="checkbox" name="cate" id="cate1"/> <label for="cate1">의약품</label>
                        <input type="checkbox" name="cate" id="cate2"/> <label for="cate2">소모품</label>
                    </span>
                </div*/ ?>
                ...
                <form name="searchFrm" autocomplete="off" method="get">
                    ...
                    <div class="sch_initial">
                        <div class="box_in">
                            ...
                            <input type="radio" id="select2" name="initial" value="ㄱ" class="red"/><label for="select2">ㄱ</label>
                            <input type="radio" id="select3" name="initial" value="ㄴ" class="red"/><label for="select3">ㄴ</label>
                            <input type="radio" id="select4" name="initial" value="ㄷ" class="red"/><label for="select4">ㄷ</label>
                            <input type="radio" id="select5" name="initial" value="ㄹ" class="red"/><label for="select5">ㄹ</label>
                            <input type="radio" id="select6" name="initial" value="ㅁ" class="red"/><label for="select6">ㅁ</label>
                            <input type="radio" id="select7" name="initial" value="ㅂ" class="red"/><label for="select7">ㅂ</label>
                            <input type="radio" id="select8" name="initial" value="ㅅ" class="red"/><label for="select8">ㅅ</label>
                            <input type="radio" id="select9" name="initial" value="ㅇ" class="red"/><label for="select9">ㅇ</label>
    ...
    <div class="drugs_cart">
        ...
        <div class="total">
            <div class="total_price">
                ...
                <p class="price txt_blue"><span class="totalPriceDisplay">0</span>원</p>
            </div>
            <div class="btn_wrap">
