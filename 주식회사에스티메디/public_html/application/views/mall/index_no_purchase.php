<section id="first00">
    <div class="inr">
        <h6><span>간편하고 저렴한 의약품 구매</span></h6>
        <h5>첫 이용을 환영해요!</h5>
        <p><em>에스티메디</em> 특별가로 구매해요</p>
        <img src="<?= ASSETS_URL ?>/img/main/main.png" class="animate__animated animate__bounce animate__infinite">
    </div>
</section>
<section id="first01">
    <div class="inr">
        <h6><span>구매가 망설여진다면</span></h6>

        <!-- Swiper -->
        <div class="swiper drugs">
            <? include_once VIEWPATH . 'mall/mainSwiper.php'; // 상단메뉴 ?>
        </div>
        <script>
        </script>
        <p><span>간편 비교 견적 해봐요!</span></p>
    </div>
</section>
<section id="first02">
    <div class="inr">
        ...
        <div class="flex js info">
            ...
            <span>
					...
					<p>&nbsp;| &nbsp; Order Number : <?php echo date('Ymd', time()); ?>0001</p>
				</span>
        </div>
        <div class="box_red">
            <p>
