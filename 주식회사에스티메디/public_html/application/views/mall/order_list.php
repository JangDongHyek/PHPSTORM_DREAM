                ...
                foreach($listData as $list) {
                    ...
                    <li>
                        <div class="number_order">
                            ...
                            <span class="txt_sky txt_under txt_bold" onclick="location.href='<?=$viewLink?>'" style="cursor: pointer"><?=$list['ord_no']?></span>
                        </div>
                        <div class="flex js">
                            <div class="div_pro">
                            ...
                            <div class="btn_wrap">
                                <!--
                                <a class="btn btn_green" onclick="showAlert('서비스 오픈 예정이에요!')">배송조회</a>
                                -->
