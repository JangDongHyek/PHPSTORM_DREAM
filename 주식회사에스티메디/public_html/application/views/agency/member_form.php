...
<section class="member write">
    <form name="member" autocomplete="off" method="post">
        <div class="flex">
            <button type="button" class="btn btn_gray" onclick="location.href='<?=PROJECT_URL?>/agency'">목록</button>
            <span>
                <?php if($isModify) { ?>
                    <?php if($memberData['auth_yn'] == 'Y') { ?>
                    <button type="button" class="btn btn btn_black" onclick="authCheck('N')">에이전시 승인취소</button>
                    <?php } else { ?>
                    <button type="button" class="btn btn btn_blue" onclick="authCheck('Y')">에이전시 승인</button>
                    <?php } ?>
                <?php } ?>
        ...
        <div class="box">
            ...
            <div class="flex jc-sb">
                ...
                <div>
                    ...
                    <a href="<?=PROJECT_URL?>/file/download?path=file/contract.hwp" class="btn btn_large btn_blueline">계약서 파일 다운로드</a>
                    -->
                </div>
            </div>
