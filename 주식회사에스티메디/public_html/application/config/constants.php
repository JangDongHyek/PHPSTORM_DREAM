...
const IPAY_MID = 'pgstmedi1m';
const IPAY_KEY = '7p1Q9/Hd7urBHa3a5WfTwxYfZXZc2/w398G6tPUYNj5IJZ8BYbsouudtE2SQipfPv8IxN/RWSNhnU7IYponeKQ==';
/**
 *  상수
 */
define("CSS_VER", time());
...
//const PROJECT_URL = 'https://dreamforone.kr/~stmedi';

const PROJECT_URL = "https://stmedi.co.kr";
const ASSETS_URL = PROJECT_URL . '/assets';
const ADM_URL = PROJECT_URL . '/adm';
const AGENCY_URL = PROJECT_URL . '/agency';
...
// 상품 카테고리
const PRODUCT_CATEGORY = ['CA02' => '의약품', 'CA01' => '소모품',];
...
const ACCOUNT_LIST_PRODUCT = [
	'계산서' => ['number' => 'NH농협 301-0340-3603-71', 'name' => '(주)에스티메디'],
	'현금영수증' => ['number' => 'NH농협 301-0340-3603-71', 'name' => '(주)에스티메디'],
	'미발행' => ['number' => 'NH농협 301-0340-3603-71', 'name' => '(주)에스티메디'],
];
// 현금결제시 영수증 발행목록
...
$open_url  = false;
$ip_list = array("121.140.204.65");
$id_list = array("test01","test02");

for($i=0; $i<count($ip_list); $i++){
    if($ip == $ip_list[$i]){
        $is_force_login = true;
        $open_url = true;
        break; // 첫 일치하는 항목을 찾으면 루프 중지
    }
}
