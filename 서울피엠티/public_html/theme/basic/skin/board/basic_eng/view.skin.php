...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        COMNAPY NAME <strong><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong>

        <span class="sound_only">작성일</span><strong><?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong>
        Hits<strong><?php echo number_format($view['wr_hit']) ?></strong>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?><li><a href="<?php echo $prev_href ?>" class="btn_b01">Previous</a></li><?php } ?>
        ...
        <ul class="bo_v_com">
            ...
            <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn_b01">Answer</a></li><?php } ?>
    ...
    <section id="bo_v_atc">
        ...
        if($v_img_count) {
         ...
         ?>
				<div>EMAIL : <?=$view[wr_1]?></div>
				<div>SENDING BY : <?=$view[wr_1]?></div>
