    ...
    <div v-if="load">
        <external-bs-modal :modal="modal">
            ...
            <template v-slot:default>
                <a class="btn btn-blueline w100" href="../file/price_sample.xlsx" download="기초단가 엑셀샘플"><img :src="jl.root + 'img/common/excel_green.svg'"> 샘플 다운로드</a>
                <div class="flex ai-c">
