...
//영페이꺼
define('WIDESHOT_CH_KEY', 'ff9595c9460a48b88b54b1e31cec342ed8a95b24');	// 카카오 프로필키(채널키)
define('WIDESHOT_PULSFRIEND', '@jhg7353');	// 플러스친구명

// 카카오톡 보내기
define('WIDESHOT_KEY', 'eTNDTVJIMStFdWZ6QzByRFExbC9lNHVPZXlsYVpwWWJCa0tGdG42TnVQVjBDOHk0eEkyRTBxb0pIeHFUTko5WA==');
