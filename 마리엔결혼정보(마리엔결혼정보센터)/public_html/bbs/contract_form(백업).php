                ...
                <div class="info">
                    ...
                    <div class="box_white ver2">
                        ...
                        <dl class="matching <?= $is_admin ? '' : 'admin_only' ?>">
                            <dt>
                                매칭방법 <span>환불규정은 기본매칭횟수를 적용합니다. 제안매칭은 서비스 매칭입니다.</span>
                                <p>이 계약은 1년간 유효합니다</p>
                            </dt>
                            <dd>
                                <p>
                        ...
                        <div>
                            ...
                            <div class="table">
                                <table>
                                    <tbody>
                                    <tr>
                                        <th>사업자(을)의 책임 있는 사유로 계약해제 및 해지 시 환급기준</th>
                                    </tr>
                                    <tr>
                                        <td>
                                            1. 회원가입계약 성립 후 정보(프로필) 제공 전에 해지된 경우: 가입비 환급 및 가입비의 10% 배상 2. 정보(프로필) 제공 후
                                            만남일자 확정 전에 해지된 경우: 가입비 환급 및 가입비의 15% 배상
                                            3. 만남일자 확정 후에 해지된 경우: 가입비 환급 및 가입비의 20% 배상
                                            4. 1회 만남 후 해지된 경우: (횟수제) 가입비*(잔여 횟수/총횟수)+가입비의 20% 환급 (기간제) 가입비* (잔여
                                            일수/총일수)+가입비의 20% 환급
                                        </td>
                                    <tr>
                                        <th>사업자(을)의 책임 없는 사유로 계약해제 및 해지시 환급기준
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>
                                            1. 회원가입계약 성립 후 정보(프로필) 제공 전에 해지된 경우: 가입비의 90% 환급 2. 정보(프로필) 제공 후 만남일자 확정 전에
                                            해지된 경우: 가입비의 85% 환급
                                            3. 만남일자 확정 후에 해지된 경우: 가입비의 80% 환급
                                            4. 1회 만남 후 해지된 경우: (횟수제) 가입비의 80%* (잔여횟수/총횟수) 환급 (기간제) 가입비의 80%* (잔여일수/총일수)
                                            환급
                                        </td>
                                    </tr>
