...
<link href="<?php echo G5_THEME_CSS_URL; ?>/main2.css" rel="stylesheet" type="text/css"><!--메인컨텐츠-->
<link href="<?php echo G5_THEME_CSS_URL; ?>/sub.css" rel="stylesheet" type="text/css"><!--서브페이지-->

<!--<link href="https://gcore.jsdelivr.net/npm/smartwizard@6/dist/css/smart_wizard_all.min.css" rel="stylesheet" type="text/css" />-->
...
if (defined('G5_IS_ADMIN')) {
    ...
    echo '<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/'.(G5_IS_MOBILE?'mobile':'default2').'.css">'.PHP_EOL;
}
?>
...
<script type="text/javascript">
      kakaoPixel('7368812152953356128').pageView();
</script>
<!-- 카카오스트립트 끝-->
...
if ($is_member) { // 회원이라면 로그인 중이라는 메세지를 출력해준다.
    ...
    echo '<a href="'.G5_BBS_URL.'/logout.php">로그아웃<!-- AceCounter Mobile START --><script type="text/javascript">var m_id="member";</script><!-- AceCounter END --></a></div>';
}
?>