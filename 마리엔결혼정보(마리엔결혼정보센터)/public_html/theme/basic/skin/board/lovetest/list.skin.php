...
?>
<style>
#bo_list .tbl_head01 td{ text-align:center !important}
</style>
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
          ...
          <th scope="col">결혼상대직업</th>
          <th scope="col">거주지</th>
          <th scope="col" rowspan="4"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜</a></th>
        </tr>
        <tr>
            <?php if ($is_checkbox) { ?>
            <?php } ?>
            <th scope="col">결혼필수조건</th>
            <th scope="col">결혼전합의조건</th>
            <th scope="col">선호하는성격</th>
            <th scope="col">내관심분야</th>
            <th scope="col">결혼상대연령</th>
            <th scope="col">결혼상대연봉</th>
            <th scope="col">결혼상대학력</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
          ...
          <td class="td_name sv_use"><?php echo $list[$i]['wr_name'] ?><br /><?php echo $list[$i]['wr_11'] ?>/<?php echo $list[$i]['wr_12'] ?></td>
          <td class="td_name sv_use"><?php echo $list[$i]['wr_content'] ?> 년생</td>
          <td class="td_name sv_use"><?php echo $list[$i]['wr_homepage'] ?></td>
          <td class="td_name sv_use"><?php echo $list[$i]['wr_link1'] ?></td>
          <td class="td_name sv_use"><?php echo $list[$i]['wr_10'] ?></td>
          <td class="td_name sv_use"><?php echo $list[$i]['wr_7'] ?></td>
          <td class="td_name sv_use"><?php echo $list[$i]['wr_8'] ?></td>
          <td class="td_date" scope="col" rowspan="2"><?php echo $list[$i]['datetime'] ?></td>
        </tr>
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            <?php if ($is_checkbox) { ?>
            <?php } ?>
...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl">
        ...
        <option value="wr_homepage"<?php echo get_selected($sfl, 'wr_homepage'); ?>>휴대폰번호</option>
    </select>
    </span>
