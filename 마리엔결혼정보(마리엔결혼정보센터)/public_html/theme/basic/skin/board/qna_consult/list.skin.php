...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col">부모님성함</th>
            <th scope="col">부모님 전화번호 </th>
            <th scope="col">자녀성함</th>
            <th scope="col">자녀성별</th>
            <th scope="col">자녀 전화번호</th>
            <th scope="col">자녀 출생년도</th>
            <th scope="col">자녀 거주지역</th>
            <th scope="col">자녀 직업</th>
            <th scope="col">자녀 학력</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_name"><?php echo $list[$i]['wr_4'] ?></td>
            <td class="td_name"><?php echo $list[$i]['wr_2'] ?></td>
            <td class="td_name"><?php echo $list[$i]['wr_5'] ?>년 출생</td>
            <td class="td_name"><?php echo $list[$i]['wr_6'] ?></td>
            <td class="td_name"><?php echo $list[$i]['wr_7'] ?></td>
