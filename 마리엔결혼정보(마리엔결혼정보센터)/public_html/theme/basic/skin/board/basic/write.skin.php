    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php for ($i=1; $i<=20; $i++) { ?>
            <tr>
                ...
                <td class="td_extra">
                     <label for="wr_<?php echo $i ?>">여분필드 <?php echo $i ?> 값</label>
                    <input type="text" name="wr_<?php echo $i ?>" value="<?php echo get_text($write['wr_'.$i]) ?>" id="wr_<?php echo $i ?>" class="frm_input">
                </td>
            </tr>
        <?php } ?>
