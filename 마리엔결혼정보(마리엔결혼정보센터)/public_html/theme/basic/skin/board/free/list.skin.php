    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_name sv_use"><?php echo $list[$i]['wr_name'] ?></td>
                   <?php 
					// 나이계산
					$mb_age1 = date("Ymd", strtotime($list[$i]['wr_1'])); // 생년월일
					$nowday = date("Ymd"); // 현재날짜
					$mb_age = floor (($nowday - $mb_age1) / 10000);
				   ?>	
            <td class="td_name sv_use"><?php echo $list[$i]['wr_1'] ?> / 나이 : <?=$mb_age?>살</td>
            ...
            <td class="td_name sv_use"><?php echo $list[$i]['wr_12'] ?></td>
            <td class="td_date hidden-xs"><?php echo $list[$i]['datetime'] ?></td>
            <?php if ($is_good) { ?><td class="td_num"><?php echo $list[$i]['wr_good'] ?></td><?php } ?>
            <?php if ($is_nogood) { ?><td class="td_num"><?php echo $list[$i]['wr_nogood'] ?></td><?php } ?>
        </tr>
        <?php } ?>
        <?php if (count($list) == 0) { echo '<tr><td colspan="'.$colspan.'" class="empty_table">무료 상담 신청 건이 없습니다.</td></tr>'; } ?>
        </tbody>
        </table>
    </div>
