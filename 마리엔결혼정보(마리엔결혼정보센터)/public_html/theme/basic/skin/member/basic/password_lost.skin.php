...
<div id="find_info" class="new_win mbskin">
    <h1 class="title">회원정보 찾기<span class="find_tip"><button type="button" data-toggle="popover" data-placement="bottom" data-content="회원가입 시 등록하신 이메일 주소를 입력해 주세요.
해당 이메일로 아이디와 비밀번호 정보를 보내드립니다."><i class="fas fa-question-circle"></i></button></span></h1>
