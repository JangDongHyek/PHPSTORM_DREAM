...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <ul id="tnb">
            ...
            <?php if ($is_member) {  ?>
            <?php if ($is_admin) {  ?>
            <li><a href="<?php echo G5_ADMIN_URL ?>" class="admin" title="관리자"><i class="fas fa-cog"></i></a></li>
            <?php }  ?>
            ...
            <li><a href="<?php echo G5_BBS_URL ?>/register.php" title="회원가입"><i class="fas fa-heart"></i></a></li>                    
            <?php }  ?>
        </ul>
    ...
    <div id="container_index">
     ...
     <div id="svisual" class="a wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="0.8s">
    	<div class="s_text">
        	...
        	<span class="wow fadeInLeft animated" data-wow-delay="0.4s" data-wow-duration="0.8s">유니코리아 소개</span>
        </div><!--.s_text-->
     </div><!--svisual-->
     ...
     <div id="svisual" class="b wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="0.8s">
    	<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="0.8s">Wedding Program</h3>
        	<span class="wow fadeInLeft animated" data-wow-delay="0.4s" data-wow-duration="0.8s">성혼프로그램 안내</span>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } else if ($co_id== "viet01" || $co_id == "viet02") { ?>
     <div id="svisual" class="c wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="0.8s">
    	<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="0.8s">Marriage in Vietnam</h3>
        	<span class="wow fadeInLeft animated" data-wow-delay="0.4s" data-wow-duration="0.8s">베트남 국제결혼</span>
        </div><!--.s_text-->
     </div><!--svisual-->
     ...
     <div id="svisual" class="d wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="0.8s">
    	<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="0.8s">Membership</h3>
        	<span class="wow fadeInLeft animated" data-wow-delay="0.4s" data-wow-duration="0.8s">회원안내</span>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } else if ($bo_table == "consult") { ?>
     <div id="svisual" class="e wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="0.8s">
    	<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="0.8s">Counseling</h3>
        	<span class="wow fadeInLeft animated" data-wow-delay="0.4s" data-wow-duration="0.8s">무료상담신청</span>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } else if ($bo_table == "data") { ?>
     <div id="svisual" class="f wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="0.8s">
    	<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="0.8s">Data Room</h3>
        	<span class="wow fadeInLeft animated" data-wow-delay="0.4s" data-wow-duration="0.8s">자료실</span>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } else if ($bo_table == "pro01" || $bo_table == "notice" || $bo_table == "qna") { ?>
     <div id="svisual" class="g wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="0.8s">
    	<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="0.8s">Community</h3>
        	<span class="wow fadeInLeft animated" data-wow-delay="0.4s" data-wow-duration="0.8s">커뮤니티</span>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } else  { ?>
     <div id="svisual" class="wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="0.8s">
    	<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="0.8s">Wedding Story</h3>
        	<span class="wow fadeInLeft animated" data-wow-delay="0.4s" data-wow-duration="0.8s">유니코리아</span>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } ?>
