...
<link href="<?php echo G5_THEME_CSS_URL; ?>/smart_wizard_all.min.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo G5_THEME_JS_URL ?>/jquery.smartWizard.min.js" type="text/javascript"></script>
