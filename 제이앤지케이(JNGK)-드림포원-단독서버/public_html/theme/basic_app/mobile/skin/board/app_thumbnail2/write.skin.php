...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <div class="you_link">
            <h3><label for="wr_link<?php echo $i ?>">제휴 이벤트 링크 주소<strong class="sound_only">필수</strong></label></h3>
            <input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" required class="frm_input" size="50" placeholder="제휴 이벤트 링크 주소를 입력해주세요">
        </div><!--.you_link-->
        <?php } ?>
		...
		<!--첨부파일//-->
		<div class="file_tit">
        	<div class="fti">※이미지 등록시 참고사항</div>
        	<ul>
            	<li><strong>사진첨부#1</strong> 앱화면 <span>리스트</span> 출력 이미지 <span>(권장사이즈 800px X 300px)</span></li>
            	<li><strong>사진첨부#2</strong> 앱화면 <span>상세페이지</span> 출력 이미지</li>
            </ul>
        </div>
        <?php
        if (G5_IS_ADMIN == 1) {
