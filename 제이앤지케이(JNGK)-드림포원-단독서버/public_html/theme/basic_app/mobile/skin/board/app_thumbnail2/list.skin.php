...
<div id="bo_list" style="width:<?php echo $width; ?>">
	...
	<li>
       ...
       <a onclick="location.href='<?php echo $list[$i]['href'] ?>'" onmouseover="window.status='<?php echo $list[$i]['href'] ?>'" onmouseout="window.status=''"> 
        <p>
			<?php if($thumb['src']){ ?>
			<div class="img_area">
			<?php /*?><img src="<?php echo $thumb['src']?>" alt="<?php echo $thumb['alt']?>" width="<?php echo $board['bo_gallery_width']?>" height="<?php echo $board['bo_gallery_height']?>" /><?php */?>
			...
			<?php }?>
			<div class="txt_area" style="display:none;">
			<ul>
				<li class="zine_tit"><?php echo $list[$i]['wr_subject']?></li>
				<li class="zine_con"><?php echo $str_content?></li>
				<li class="zine_info"><span><?php echo $list[$i]['datetime2']?></span> <span>조회 <strong><?php echo number_format($list[$i]['wr_hit']) ?></strong></span></li>
				<li></li>
			</ul>
			</div>
		</p>
