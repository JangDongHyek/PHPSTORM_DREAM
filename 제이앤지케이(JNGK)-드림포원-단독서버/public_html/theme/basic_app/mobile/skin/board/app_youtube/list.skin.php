...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            ...
            <ul class="gall_con">
            	<a href="<?php echo $list[$i]['href'] ?>"><span><i class="far fa-play-circle"></i></span></a>
                <li class="gall_href">
                    ...
                    <?php } else {
                        ...
                        if($thumb['src']) {
							...
							if($youtube_key){
	                            ...
	                            $img_content = '<span class="noimg"><img src="'.$board_skin_url.'/img/noimg.gif" alt="noimage" width="100%"/></span>';
							}
                        }						
                ...
                <div class="gall_subject">
                    <?php /*?><span>작성자 </span><?php echo $list[$i]['name'] ?><?php */?>
                    <span><!--작성일--> <?php echo $list[$i]['datetime'] ?></span>
    ...
    <div class="bo_fx">
        <?php if ($is_checkbox) { ?>
        <ul class="btn_bo_adm">
            <li><button type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value">
            <i class="fas fa-trash"><span class="sound_only">선택삭제</span></i></button></li>
        </ul>
        <?php } ?>
