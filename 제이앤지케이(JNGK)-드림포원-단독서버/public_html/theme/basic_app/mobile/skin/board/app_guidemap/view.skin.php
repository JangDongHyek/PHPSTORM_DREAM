	...
	<div id="list_store">
        ...
        <div class="list_store">
            ...
            <dl class="info_box">
                ...
                <dd>
					<ul class="fa-ul info">
                        <li><i class="fa-li fa fa-map-marker" aria-hidden="true"></i><strong>주　　소</strong> <span><?php echo $view['wr_1']; ?> <?php echo $view['wr_2']; ?></span></li>
                        <li><i class="fa-li fa fa-phone" aria-hidden="true"></i><strong>전화번호</strong> <span><?php echo $view['wr_4']; ?></span></li>
                        <li><i class="fa-li fa fa-car" aria-hidden="true"></i><strong>주차여부</strong> <span><?php echo $view['wr_6']; ?></span></li>
					</ul>
                </dd>
            </dl>
