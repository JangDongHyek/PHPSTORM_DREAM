...
else if ($w == 'u')
{
    ...
    $sql = " select mb.* from g5_member as mb left join g5_sales as sa on mb.sales_idx = sa.idx where mb.mb_no = {$mb_no} ";
    $mb = sql_fetch($sql);
...
<input type="hidden" id="time_set_idx" name="time_set_idx">
<input type="hidden" id="app_member" name="app_member" value="Y">
...
<div id="adm_mw_box">
    ...
    <div class="tbl_frm01 tbl_wrap member_state new_member">
        ...
        <tr>
            ...
            <td>
                <input type="date" name="lesson_start_date" value="<?php echo empty($mb['lesson_start_date']) ? '' : $mb['lesson_start_date'] ?>" id="lesson_start_date"  class="frm_input"><!-- 일자 -->
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="fees" value="<?php echo empty($mb['fees']) ? '' : number_format($mb['fees']) ?>" id="fees" class="frm_input readonly" size="30" placeholder="수수료" style="margin-bottom: 5px;text-align: right;" onkeyup="add_comma(this);" readonly>원<br>
    ...
    <div class="tbl_frm01 tbl_wrap member_state one_point_lesson" style="display: none;">
        <table>
                ...
                <td>
                    <div class="cf">
                        <div style="margin:0 5px 5px 0;">
                            <input type="text" name="mb_name2" value="<?=$mb['mb_name'] ?>" id="mb_name2" required class="required frm_input" size="30" minlength="2" maxlength="20" placeholder="이름">
                        </div>
                    ...
                    <input type="text" name="fees2" value="<?php echo empty($mb['fees']) ? '' : number_format($mb['fees']) ?>" id="fees2" class="frm_input readonly" size="30" placeholder="수수료" style="margin-bottom: 5px;text-align: right;" onkeyup="add_comma(this);" readonly>원<br>
                    ...
                    <input type="date" name="one_point_le_date" value="<?php echo empty($mb['one_point_le_date']) ? date('Y-m-d') : $mb['one_point_le_date'] ?>" id="one_point_le_date"  class=" frm_input" onchange="change_date(this.value);"><!-- 일자 -->
            ...
            <tr>
                <td colspan="2">
                    <textarea class="frm_text" style="margin-bottom: 5px;" readonly><?=$config['cf_stipulation']?></textarea><br>
                    <input type="checkbox" name="agree_chk2" value="Y"> 이용약관 및 회원 준수사항에 동의합니다.
                </td>
            </tr>
            <tr>
...
function change_date(date, op) {
    ...
    $.ajax({
        ...
        data: {reser_date : date, pro_mb_no : $('#pro_mb_no2').val(), reser_time : '<?=substr($mb['one_point_le_time'],0,5)?>', mode : '<?=$w?>'},
        type: 'POST',
        success : function(data) {
            if(data){
