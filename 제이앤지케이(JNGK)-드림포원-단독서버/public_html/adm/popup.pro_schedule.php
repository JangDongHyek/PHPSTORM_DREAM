...
<div id="pro_sch_box" class="pro_sch_box2" style="margin:20px;">
    <div class="psch_list psch_list2">
        ...
        <ul>
            <?php
            $today_sql = " select mb.mb_no, mb.history_idx, mb.lesson_idx, re.reser_time, re.reser_state, mb.mb_name, mb.mb_id_no, le.lesson_name, le.lesson_count
            ...
            for($i=0; $row=sql_fetch_array($today_result); $i++) {
                ...
                // $lesson_reamin_count = $row['lesson_remain_count'];
