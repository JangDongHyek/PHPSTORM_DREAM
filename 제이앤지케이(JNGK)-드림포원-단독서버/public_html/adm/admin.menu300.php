...
if($_SESSION['ss_mb_id']!="lets080" && ($member['mb_level'] == 10 || $member['mb_level'] == 9)) {
    $menu['menu300'] = array (
        array('300000', '게시판관리', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=event', 'event'),
        array('300100', 'EVENT', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=event', 'event'),
        array('300200', '홍보영상', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=video', 'video'),
        array('300300', '제휴이벤트', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=event2', 'event2'),
    );
}
?>