...
if (defined('G5_IS_ADMIN')) {
    if(!defined('_THEME_PREVIEW_'))
        echo '<link rel="stylesheet" href="'.G5_ADMIN_URL.'/css/admin.css?v='.G5_CSS_VER.'">'.PHP_EOL;
} else {
...
<?php
add_stylesheet('<link rel="stylesheet" href="'.G5_ADMIN_URL.'/css/style.css">', 0);//어드민 추가된 스타일
