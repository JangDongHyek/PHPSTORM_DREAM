...
if ($auto_login) {
    ...
    set_cookie('ck_mb_id', $mb['mb_id'], 86400 * 1 * 1);
    set_cookie('ck_auto', $key, 86400 * 1 * 1);
    // 자동로그인 end ---------------------------
} else {
...
$url = (empty($url) || strpos($url, "new_schedule") !== false)? "http://letsit.kr/~itforone_test2/bbs/board.php?bo_table=new_schedule" : $url;
