...
<div class="inr">
		...
		<form name="frm" autocomplete="off" onsubmit="return frmSubmit(this)">
			...
			<dl>
				...
				<dd>
					...
					<span class="conts"><input type="text" class="inputFull" name="qa_subject"
							value="<?=$row['qa_subject']?>" required maxlength="100"></span>
				</dd>
				<dd>
					<span class="subj">담당자명</span>
					<span class="conts"><input type="text" name="qa_name" value="<?=$row['qa_name']?>"
							maxlength="40"></span>
				</dd>
				<dd>
					<span class="subj">연락처</span>
					<span class="conts"><input type="text" name="qa_tel" value="<?=$row['qa_tel']?>"
							maxlength="40"></span>
				</dd>
				<dd>
	...
	<!-- 광고영역 -->
	<iframe src="http://letsit.kr/~itforone_test2/qna/ad_write.php?iframe=y" class="adFrame" scrolling="no"
