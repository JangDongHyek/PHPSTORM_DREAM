            ...
            <ul class="gall_con">
                <li class="gall_href">
                    ...
                    if ($list[$i]['is_notice']) { // 공지사항  ?>
                        <strong style="width:<?php echo $board['bo_gallery_width'] ?>px;height:<?php echo $board['bo_gallery_height'] ?>px">Notice</strong>
                    <?php 
					} else {
                        echo "<script>console.log('".json_encode($board['bo_table']."//").json_encode($list[$i]['wr_id']."//").json_encode($imgmaxwidth."//").json_encode($imgmaxheight)."');</script>";
