...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php if ($is_name) { ?>
        <tr>
            <th scope="row"><label for="wr_name">이름<strong class="sound_only">required</strong></label></th>
        ...
        <?php if ($is_password) { ?>
        <tr>
            <th scope="row"><label for="wr_password">비밀번호<strong class="sound_only">required</strong></label></th>
        ...
        <tr>
            <th scope="row"><label for="wr_subject">Title<strong class="sound_only">required</strong></label></th>
            <td>
                <div id="autosave_wrapper">
                    ...
                    <button type="button" id="btn_autosave" class="btn_frmline">Temporarily saved post (<span id="autosave_count"><?php echo $autosave_count; ?></span>)</button>
                    <div id="autosave_pop">
                        <strong>List of temporarily saved posts</strong>
        ...
        <tr>
            ...
            <td>
                <input type="file" name="bf_file[]" title="File attachment <?php echo $i+1 ?> : Volume <?php echo $upload_max_filesize ?> Only the following can be uploaded" class="frm_file frm_input">
                <?php if ($is_file_content) { ?>
                <input type="text" name="bf_content[]" value="<?php echo ($w == 'u') ? $file[$i]['bf_content'] : ''; ?>" title="Please enter a file description." class="frm_file frm_input">
                <?php } ?>
        ...
        <tr>
            <th scope="row">Automatic registration prevention</th>
            <td>
