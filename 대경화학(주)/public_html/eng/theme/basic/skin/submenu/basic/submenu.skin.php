...
<div id="lnb">
    <div class="title">
        <h4 class="wow fadeInLeft"><?php echo $title['sm_name'] ?></h4>
        <p class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="1.2s">We will be a reliable partner that offers excellent technologies and expertise.</p>
    </div>

    <dl class="wow fadeInUp animated" data-wow-delay="0.4s" data-wow-duration="0.5s">
