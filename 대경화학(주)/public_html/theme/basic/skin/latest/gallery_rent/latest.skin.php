...
.picL li{overflow:hidden;position:relative;float:left; display:inline; width:300px;height:auto;margin:0px; zoom:1; transition:all 0.5s; border-top:1px solid #e8e7eb; border-left:1px solid #e8e7eb; border-bottom:1px solid #e8e7eb; text-align:center}
.picL li:nth-child(4n){ border-right:1px solid #e8e7eb; }
...
.picL li .text p.code{color:#777; line-height:1.6em; font-size:1em; font-weight:400}
.picL li .text p.spec{color:#2a5dc5; line-height:1.6em; font-size:1.40em}
	...
	<ul class="picL" id="picLsy" >
		...
		<li>
			...
			<div class="text">
                ...
                <p class="code"><?php echo mb_strimwidth($list[$i]['wr_1'], '0', '25', '', 'utf-8');?></p>
                <p class="spec">월 <?php echo mb_strimwidth($list[$i]['wr_2'], '0', '25', '', 'utf-8');?>원</p>
			</div>
		</li>
		<? } ?>
