...
if($w == '' && $bo_table == "request"){
	$conn_db=mysql_connect("211.51.221.165","emma","wjsghk!@#");
	mysql_select_db("emma");
	
	
	$tran_phone4 = "010-7601-4341";//받는 사람 번호 관리자
	$tran_callback4 = "010-7601-4341";//보내는 사람 번호 
	$send_date = date("YmdHis");
	$mart_id = "bychem";


	$scontent4 = "견적문의가 게시판에 등록되었습니다.";

	$tran_msg4 = iconv("utf-8","euc-kr", $scontent4);
	$_POST['wr_4'] =  iconv("utf-8","euc-kr", $_POST['wr_4']);
	$tran_msg4 =	$_POST['wr_4']." ".$_POST['wr_1']." ".$tran_msg4;
	...
	$sms_query4 = "Insert into emma.em_tran (tran_pr,tran_id,tran_phone,tran_callback,tran_status,tran_date,tran_msg) values (null,'$mart_id','$tran_phone4','$tran_callback4','1','$send_date','$tran_msg4')";
	mysql_query($sms_query4,$conn_db);

	//전체기록남기기
	$all_query4 = "Insert into emma.em_all_log (tran_pr,tran_id,tran_phone,tran_callback,tran_status,tran_date,tran_msg,reg_date) values (null,'$mart_id','$tran_phone4','$tran_callback4','1','$send_date','$tran_msg4',curdate())";
	mysql_query($all_query4,$conn_db);
