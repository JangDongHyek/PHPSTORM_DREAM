...
;(function ($, window, document, undefined)
{
    ...
    Plugin.prototype = {
        ...
        init: function ()
        {
            ...
            if (this.settings.tabsPosition == 'vertical02') {

                this.settings.verticalPosition == 'left0'
                    ? container.addClass('pws_tabs_vertical02 pws_tabs_vertical_left')
                    : container.addClass('pws_tabs_vertical02 pws_tabs_vertical_right');

            } else {

                this.settings.horizontalPosition == 'top'
                    ? container.addClass('pws_tabs_horizontal02 pws_tabs_horizontal_top')
                    : container.addClass('pws_tabs_horizontal02 pws_tabs_horizontal_bottom');
            ...
            if (this.settings.tabsPosition == 'vertical02') {
                ...
                this.settings.verticalPosition == 'left' 
                    ? container.prepend('<ul class="pws_tabs_controll02"></ul>')
                    : container.append('<ul class="pws_tabs_controll02"></ul>');
