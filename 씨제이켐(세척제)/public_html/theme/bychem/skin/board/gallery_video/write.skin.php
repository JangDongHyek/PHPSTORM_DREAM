...
<section id="bo_w">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td><input type="text" name="wr_homepage" value="<?php echo $homepage ?>" id="wr_homepage" class="frm_input" size="20"></td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td>
				<div id="autosave_wrapper">
					<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input required" size="20" maxlength="255">
		...
		<tr>
			<th scope="row"><label for="wr_10">동영상<br />추가</label></th>
			<td>
				<div class="help11 blue">유튜브<!-- 나 다음팟--> 영상의 주소를 붙여넣으면 영상이 본문에 보여집니다.</div>
				<input type="text" name="wr_10" value="<?php echo $write['wr_10'] ?>" id="wr_10" class="frm_input" size="20">
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="bf_content[]" value="<?php echo ($w == 'u') ? $file[$i]['bf_content'] : ''; ?>" title="파일 설명을 입력해주세요." class="frm_file frm_input" size="20">
				<?php } ?>
