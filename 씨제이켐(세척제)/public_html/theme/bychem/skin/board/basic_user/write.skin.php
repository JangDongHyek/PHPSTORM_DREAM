...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<a href="#" onclick="add_file();" title="첨부파일 추가"><img src="<?php echo $board_skin_url ?>/img/btn_file_add.gif"/></a>
			<a href="#" onclick="del_file();" title="첨부파일 삭제"><img src="<?php echo $board_skin_url ?>/img/btn_file_minus.gif"/></a>
			</th>
			<td>
