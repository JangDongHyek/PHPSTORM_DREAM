            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="title">
						...
						<p class="t_margin10"><span class="box"><?php echo $list[$i]['wr_8'] ?><!-- 서브 제품명 --></span></p>
						<p class="t16 t_margin10"><?=cut_str($list[$i]['wr_text1'],60)?> <!-- 간략설명 --></p>
