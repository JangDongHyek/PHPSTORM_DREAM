...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/animate.min.css"><!--애니메이션-->
...
<script src="<?php echo G5_THEME_JS_URL ?>/jquery-1.12.4.min.js"></script><!--메인슬라이더에 필요한 js-->
<script src="<?php echo G5_THEME_JS_URL ?>/jquery.menu.js"></script><!--상단메뉴(pc및모바일) 및 그외 JS추가부분-->
<script src="<?php echo G5_JS_URL ?>/common.js"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/wrest.js"></script>
