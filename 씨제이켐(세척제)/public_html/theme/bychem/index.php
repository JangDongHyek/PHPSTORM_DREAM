...
<input type=hidden name="co_id" value="<?=$co_id?>">
                ...
                <dd class="visible-xs  col-xs-9 wow fadeInDown" data-wow-delay="0.2s">
                   <ul class="map_info">
					   <li>상호. <span><?php echo $config['cf_title']; ?></span></li>
					   <li>대표. <span>박상훈</span></li>
					   <li>주소. <span><?php echo $config['cf_1']; ?></span>					    </li>
					   <li>대표번호. <span><?php echo $config['cf_3']; ?></span></li>
					   <!--li>전화. <span>031-364-8867</span></li-->
					   <li>팩스. <span><?php echo $config['cf_5']; ?></span></li>
					   <li>메일. <span><a href="mailto:cj_chem@naver.com"><?php echo $config['cf_6']; ?></a></span></li>
                   </ul> 
                </dd>
