...
<div id="my_reser" class="view">
    ...
    <div class="bt_reser cf">
    <?php if($view['cw_step'] == '0' ){ ?>
        <a href="javascript:;" class="cancel" data-toggle="modal" data-target="#myModal2">예약취소</a>
   <?php }else{
        $all = 'all';
    } ?>
        <a href="<?php echo G5_BBS_URL.$back_url ?>" class="list <?= $all ?>">목록</a>
<!--   기능 임시로 달아놓음.   -->
    </div>
