...
$menu['menu260'] = array(
    array('260000', '결제 관리', G5_ADMIN_URL . '/service_payment_list.php', 'service_payment'),
    array('260100', '매니저정산 관리', G5_ADMIN_URL . '/adm_service_manager_list.php?cw_step=2', 'sevice_manager'),
    /*
