...
?>
    <style>
        .btn_add01 input, .btn_add01 button {
            padding: 10px;
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="checkbox" name="chk_all_mb" id="chk_all_mb" value="1" style="display: none">
            <label for="chk_all_mb" style="display: none">전체회원</label>
        </td>
    </tr>
    <tr>
    ...
    <tr style="display: none">
        ...
        <td>
           ...
           <select name="cp_type" id="cp_type">
                ...
                <option value="0"<?php echo get_selected('0', $cp['cp_type']); ?> selected>정액할인(원)</option>
                <!--
    ...
    <tr>
        ...
        <td>
            <input type="text" name="cp_price" value="<?php if($cp['cp_price']){ echo stripslashes($cp['cp_price']);}else{ echo '5000';} ?>" id="cp_price" required class="frm_input required" readonly> <span id="cp_price_unit">원<?php //echo $cp['cp_type'] ? '%' : '원'; ?></span>
        </td>
    </tr>
    <tr id="tr_cp_trunc" style="display: none">
        ...
        <td>
            <select name="cp_trunc" id="cp_trunc">
                <option value="10"<?php echo get_selected('10', $cp['cp_trunc']); ?> selected>10원단위</option>
                <!--
...
<div class="btn_fixed_top">
    <div class="btn_add01 btn_add" style="float: left">
        ...
        <input type="submit" value="확인" class="btn_submit btn" accesskey="s" style="background-color: red">
    </div>
