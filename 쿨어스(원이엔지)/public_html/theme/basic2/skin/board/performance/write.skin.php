...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php } ?>
        <tr>
            <th scope="row"><label for="wr_1">총개발기간(시작~종료일)</label></th>
            <td><input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input" size="20"></td>
        </tr>
        <tr>
            <th scope="row"><label for="wr_subject">과제명<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <!--<tr>
            <th scope="row"><label for="wr_content">과제명<strong class="sound_only">필수</strong></label></th>
            <td class="wr_content">
