...
{
    // $mb = get_member($mb_id);
    $mb = sql_fetch(" select * from {$g5['member_table']} where mb_no = '{$mb_no}' ");
    if (!$mb['mb_id'])
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <table>
        ...
        <?php if($mb['mb_category'] == '기업') { ?>
        <tr>
            <th scope="row"><label for="mb_company_name">회사명(한글)<?php echo $sound_only ?></label></th>
            <td><input type="text" name="mb_company_name" value="<?php echo $mb['mb_company_name'] ?>" id="mb_company_name" class="frm_input" size="50"></td>
        ...
        <tr>
            ...
            <td><input type="text" name="mb_company_sector_detail" value="<?php echo $mb['mb_company_sector_detail'] ?>" id="mb_company_sector_detail" class="frm_input" size="50"></td>
        </tr>
        <?php } ?>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td><textarea name="mb_company_introduce" id="mb_company_introduce" style="resize: unset;width: 400px;"><?php echo $mb['mb_company_introduce'] ?></textarea></td>
    ...
    <table>
        ...
        <?php if($mb['mb_category'] == '일반') { ?>
            ...
            <tr>
                ...
                <td><?php echo !empty($mb['mb_push']) ? $mb['mb_push'] : '-'; ?></td>
                <th scope="row"></th>
                <td></td>
            </tr>
        <?php } ?>
...
<div class="btn_confirm01 btn_confirm">
    ...
    <?php } ?>
    <input type="button" value="<?=$btn_txt;?>" class="btn_submit" onclick="memberIntercept('<?=$mb['mb_id']?>')">
...
function memberIntercept(mb_id) {
    $.ajax({
        url: './ajax.member_intercept.php',
        type: 'post',
        data: {mb_id: mb_id},
