		...
		<div id="help_list" class="career">
			...
			<ul class="btn_link">
				...
				<li>
                    ...
                    ?>
                    <a href="<?=G5_BBS_URL?>/career_apply.php?idx=<?=$idx?>" class="btn_confirm">지원하기</a>
                    <?php
                    }
                    ?>
                </li>
				...
				<li <?=$member['mb_category'] == '일반' ? '' : 'class="full"'; ?>><a onclick="site_link(this, '<?php echo empty(!$cr['cr_site']) ? $cr['cr_site'] : G5_BBS_URL.'/company.php?mb_no='.$cr['mb_no']; ?>');" class="btn_confirm" target="_blank">채용사이트 <div class="m">바로가기</div></a></li>
			</ul>
