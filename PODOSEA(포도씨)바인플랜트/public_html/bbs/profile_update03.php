            ...
            <div id="area_join" class="profile">
                <div id="join_info">
                    ...
                    <div class="profile_content">
                        ...
                        <h3>학력, 전공을 작성해주세요.<em>선택사항</em></h3>
                        <dl class="row">
                            <dt>학교명</dt>
                            <dd>
                                <div class="input">
                                    <input type="text" id="mb_school" name="mb_school" class="regist-input" placeholder="예)포도씨고등학교, 포도씨대학교">
                                </div>
                            </dd>
                        </dl>
                        <dl class="row">
                            ...
                            <dd>
                                <div class="input">
                                    <input type="text" id="mb_school_major" name="mb_school_major" class="regist-input" placeholder="예)포도씨학과">
                                </div>
                            </dd>
                        </dl>
                        <dl class="row">
                        ...
                        <div class="area_btn">
                            <a href="javascript:void(0);" class="btn_prev"><span onclick="pre_move('update02');">이전단계<em class="pc">로 이동하기</em></span></a>
    ...
    function form_check() {
        ...
        if($('.profile_info li').length > 0) {
            ...
            if('<?=$flag?>') {
                ...
                $('.btn_next').attr('href', '<?php echo G5_BBS_URL ?>/profile_update04.php');
            }
        }
    }
