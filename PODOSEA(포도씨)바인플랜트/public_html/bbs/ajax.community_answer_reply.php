...
<li>
    ...
    <!-- 댓글 수정 삭제 -->
    <ul class="edit">
        <li class="modify"><a href="javascript:reply_action_info(<?=$community_an_idx?>, <?=$reply['idx']?>, '<?=$reply['contents']?>');">수정</a></li>
        <li class="delete"><a href="javascript:reply_action(<?=$community_an_idx?>, 'd', <?=$reply['idx']?>);">삭제</a></li>
    </ul>
    <!-- //댓글 수정 삭제 -->
    <?php } ?>
</li>
