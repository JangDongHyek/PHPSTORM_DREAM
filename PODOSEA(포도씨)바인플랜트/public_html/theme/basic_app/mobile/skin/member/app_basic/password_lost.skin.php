	...
	<div class="tab-content">
	  ...
	  <div role="tabpanel" class="tab-pane active" id="id-find">
		...
		<fieldset id="info_fs">
			...
			<input type="tel" name="" id="mb_hp1" required class="required frm_input" size="30" placeholder="휴대폰번호" maxlength="11" onkeyup="only_number(this)">
		</fieldset>-->
        <fieldset id="info_fs">
            <label for="mb_email1">이메일<strong class="sound_only">필수</strong></label>
            <input type="text" name="" id="mb_email1" required class="required frm_input" size="30" placeholder="이메일">
            * 회원가입 시 등록한 이메일
        </fieldset>
	  ...
	  <div role="tabpanel" class="tab-pane" id="pass-find">
		...
		<!--<fieldset id="info_fs">
			<label for="mb_hp">휴대폰번호<strong class="sound_only">필수</strong></label>
			<input type="tel" name="mb_hp" id="mb_hp2" required class="required frm_input" size="30" placeholder="휴대폰번호" maxlength="11" onkeyup="only_number(this)">
		</fieldset>-->
		<fieldset id="info_fs">
		...
		<div class="win_btn">
			<input type="submit" value="확인" class="btn03">
			<button type="button" onclick="javascript:history.back();" class="btn01">뒤로</button>
		</div>
		</form>
	  </div>
...
$(function(){
	...
	$("#id-btn").click(function(){
		...
		$.ajax({
			...
			data:{"mb_name":$("#mb_name1").val(),"mb_hp":$("#mb_hp1").val(), "mb_email": $("#mb_email1").val()},
			dataType:"html",
			type:"POST",
