...
function productSlider(){
	if(!($('#helpme.best .swiper-container').length > 0)) return;
	var swiper = new Swiper('#helpme.best .swiper-container', {
		loop:false,
		autoplay: {
		  delay: 5000,
		...
		spaceBetween: 0,
		navigation: {
			nextEl: '#helpme.best .swiper-button-next',
			prevEl: '#helpme.best .swiper-button-prev',
      },
		breakpoints: {
			1400: {
				slidesPerView: 4,
