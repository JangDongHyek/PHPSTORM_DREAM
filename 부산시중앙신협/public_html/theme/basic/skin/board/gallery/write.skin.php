...
<section id="bo_w" class="inr">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			<th scope="row"><label for="wr_5"><?= ($bo_table != "news") ? "간단설명" : "태그" ?><strong class="sound_only">필수</strong></label></th>
			<td><input type="text" name="wr_5" value="<?php echo $write['wr_5'] ?>" id="wr_5" class="frm_input" size="50"
                placeholder="<?= ($bo_table != "news") ? "간단설명을 입력해주세요" : "태그는 콤마로 구분합니다(ex)가을,아침)" ?>"
                ></td>
		</tr>
        <?php if ($bo_table == "event"){ ?>
		<tr>
			<th scope="row"><label for="wr_5">이벤트 기간<strong class="sound_only">필수</strong></label></th>
			<td class="writ_date">
				<div class="dlBox">
			  <dl>
				...
				- 
				<dl>
					<dt><span class="sound_only">반납일시</span></dt>
					<dd>
        ...
        <tr>
            <th scope="row">플랫폼</th>
            <td>
                <input type='text' name="wr_7" id="wr_7" class="form-control calendar_ver" value="<?=$write[wr_7]?>"  placeholder="플랫폼을 입력해주세요."/>
            </td>
        </tr>
        <tr>
            <th scope="row">링크</th>
            <td>
                <input type='text' name="wr_8" id="wr_8" class="form-control calendar_ver" value="<?=$write[wr_8]?>"  placeholder="http://를 포함하여 링크를 입력해주세요."/>
            </td>
        </tr>
        <?php } ?>
