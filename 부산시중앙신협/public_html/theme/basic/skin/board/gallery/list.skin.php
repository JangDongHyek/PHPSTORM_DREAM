...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul">
        <?php /*?><?php for ($i=0; $i<count($list); $i++) {
         ...
         ?>
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" data-aos="fade-up">
            <?php if ($is_checkbox) { ?>
            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href">
                    ...
                    <?php } ?>
						...
						<p class="list_s_txt"><?php echo $list[$i]['wr_5'] ?></p>
						<div class="box">
							<div class="datebox">
								<div class="tit">기간</div>
								<div><?php echo $list[$i]['wr_2'] ?> - <?php echo $list[$i]['wr_4'] ?></div>
							</div>
							<a href="<?php echo $list[$i]['href'] ?>" class="title">자세히 보기</a>
