...
<div id="ft_menu">
	<ul>
		<li>
			<a href="<?php echo G5_BBS_URL ?>/content.php?co_id=priv_center">
			<img src="<?php echo G5_THEME_IMG_URL ?>/common/ico_01<?php if($co_id == "priv_center"){ echo ""; } ?>.png" alt="">프라이빗
			</a>
		</li>
		<li>
			<a href="<?php echo G5_BBS_URL ?>/content.php?co_id=golf_center">
			<img src="<?php echo G5_THEME_IMG_URL ?>/common/ico_02<?php if($co_id == "golf_center"){ echo ""; } ?>.png" alt="">골프센터
			</a>
		</li>
		<li>
			<a href="<?php echo G5_BBS_URL ?>/content.php?co_id=cu_center">
			<img src="<?php echo G5_THEME_IMG_URL ?>/common/ico_03<?php if($co_id == "cu_center"){ echo ""; } ?>.png" alt="">문화센터
			</a>
		</li>
		<li>
			<a href="<?php echo G5_BBS_URL ?>/content.php?co_id=trv_service">
			<img src="<?php echo G5_THEME_IMG_URL ?>/common/ico_04<?php if($co_id == "trv_service"){ echo ""; } ?>.png" alt="">여행서비스
			</a>
		</li>
	</ul>
</div>
