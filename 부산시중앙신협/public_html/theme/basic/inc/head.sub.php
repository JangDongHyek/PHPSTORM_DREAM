...
<link href="<?php echo G5_THEME_CSS_URL; ?>/all.css" rel="stylesheet" type="text/css"><!--전체추가-->
...
<script src="http://samin2020.cafe24.com/js/jquery-1.12.4.min.js"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/aos.js"></script><!--jngk JS-->
...
<script src="<?php echo G5_THEME_JS_URL ?>/slick.min.js"></script><!--Slick JS-->
<script src="<?php echo G5_THEME_JS_URL ?>/fullpage.js"></script><!--fullfage JS-->
<script src="<?php echo G5_THEME_JS_URL ?>/jq_jngk.js"></script><!--jngk JS-->

<script src="<?php echo G5_THEME_JS_URL ?>/jquery-inertiaScroll.js"></script>
