...
if (strpos($_SERVER['REQUEST_URI'], 'golf') == false && strpos($_SERVER['REQUEST_URI'], 'v5_holiday') == false && $member["mb_level"] == 9) {
    alert("골프 예약관리자는 골프예약 페이지만 접근가능합니다.", G5_ADMIN_URL."/golf_reserve_list.php");
}
...
<header id="hd">
    <div id="hd_wrap">
        ...
        <ul id="tnb">
            ...
            <?php } ?>
			<li><a href="<?php echo G5_URL."/qna/list.php"?>"  target='_blank'>문의게시판</a></li>
