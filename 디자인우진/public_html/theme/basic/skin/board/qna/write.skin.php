...
<section id="bo_w">
    ...
    ?>
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tbody>
                    <tr>
                        <th scope="row">회사명</th>
                        <td><input type="text" name="wr_1" value="<?=$write[wr_1]?>" class="frm_input required" required></td>
                    </tr>
                    <?php if ($is_name) { ?>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="wr_2" value="<?=$write[wr_2]?>" class="frm_input required" required></td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row">자동등록방지(<span style="color:red;font-weight:normal;">스팸방지</span>)</th>
                        <td>
        ...
        <div class="btn_confirm">
            ...
            <? if($is_admin){?>
            <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<?=$bo_table?>" class="btn_cancel">목록보기</a>
            <? } ?>
