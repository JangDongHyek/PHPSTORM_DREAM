...
<div id="hd">
    ...
    <div id="hd_wrapper">
        <div id="logo">
            ...
            <a class="color" href="<?php echo G5_URL ?>/"><img src="<?php echo G5_THEME_IMG_URL ?>/common/logo_color.svg" alt="<?php echo $config['cf_title']; ?>"></a>
        </div><!--#logo-->
        
        <ul id="tnb">
            <li><a href="http://blog.naver.com/suk051" class="blog" title="블로그" target="_blank"><i class="fab fa-blogger-b"></i></a></li>
...
<!--            <li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=pro_01" title="제품소개"><i class="fas fa-cog"></i></a></li>-->
            ...
            <?php if($_SERVER['REMOTE_ADDR'] == "59.19.201.109" || $_SERVER['REMOTE_ADDR'] == "121.140.204.65"){ ?>
                <li><a href="<?php echo G5_BBS_URL ?>/payment.php" class="btn">
                        <i class="fal fa-credit-card"></i> 온라인 결제</a></li>
            <?php }?>
    	</ul>
        ...
        <nav id="gnb">
            ...
            <ul id="gnb_1dul">
                ...
                <?php } ?>
                <li class="gnb_1dli" style="z-index:<?php echo $gnb_zindex--; ?>">
                    <a href="https://blog.naver.com/suk051" target="_<?php echo $row['me_target']; ?>" class="gnb_1da"><?php echo $row['me_name'] ?>BLOG<span></span></a>
                </li>
            </ul>
        </nav>
...
<div id="wrapper">
    ...
    <div id="container_index">       
	 ...
	 <div id="svisual">
		<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="1.2s">ABOUT</h3>
        </div><!--.s_text-->
     </div><!--svisual-->
     
     <? } else if ($bo_table == "portfolio") { ?>
     <div id="svisual">
		<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="1.2s">PORTFOLIO</h3>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } else if ($co_id == "service") { ?>
     <div id="svisual">
		<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="1.2s">SERVICES</h3>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } else if ($bo_table == "contact") { ?>
     <div id="svisual">
		<div class="s_text">
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="1.2s">CONTACT</h3>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } else  { ?>
     <div id="svisual">
		<div class="s_text">
        	<span class="wow fadeInLeft animated" data-wow-delay="0.4s" data-wow-duration="1.2s">공익센터, 복지기관, 대학 및 교육기관 대상 전문기업</span>
            <h3 class="wow fadeInRight animated" data-wow-delay="0.1s" data-wow-duration="1.2s">디자인우진</h3>
        </div><!--.s_text-->
     </div><!--svisual-->
     <? } ?>
