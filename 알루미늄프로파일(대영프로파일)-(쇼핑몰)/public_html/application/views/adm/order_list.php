    ...
    <form name="searchFrm" autocomplete="off" method="get">
        <div class="panel">
            ...
            <div>
                ...
                <p>~</p>
                <input type="date" name="edt" value="" onchange="changeInputDate(this.value)">
            </div>
            <div>
                <span class="select">
            ...
            <span>
                ...
                <button type="button" class="btn btn_orange" onclick="location.href='/file/download?path=/file/invoice_form.xlsx'">송장 업로드 양식 다운로드</button>
        ...
        <div class="table adm">
            <table class="order">
                ...
                <tr>
                    ...
                    <td>
                        <span class="txt_orange txt_under txt_bold"><a href="<?=PROJECT_URL?>/admOrderView">230724-1420-27056</a></span>
                    </td>
                    <td>
                        <dl class="order_info">
                ...
                <tr>
                    <td><strong class="txt_orange">취소요청(07.26)</strong></td>
                    <td>[국내산] 어성초 300g<em> 외 3개</em>                    </td>
                    <td>
                            <div>
