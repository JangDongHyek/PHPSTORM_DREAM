    ...
    <div class="vertical_wrap">
        <div class="list_wrap">
            ...
            <div>
                <div class="boxline">
                    <details open>
                        <summary><h5>배송 정보 <button type="button" class="btn btn_greenline" onclick="modifyRecipient()">배송정보 수정</button></h5></summary>
                        <div class="details">
                            <div class="delivery">
                                <div>
                                    <h6>주문자</h6>
        ...
        <div class="sticky">
            ...
            <div class="total">
				...
				<div class="btn_wrap">
					<a class="btn btn_middle btn_green" onclick="history.back();">목록으로</a>
				</div>
            </div>
        </div>
