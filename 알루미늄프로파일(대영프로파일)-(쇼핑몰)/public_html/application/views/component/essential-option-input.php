<script type="text/x-template" id="essential-option-input-template">
...
<script>
    Vue.component('essential-option-input', {
        template: "#essential-option-input-template",
        props: {
        ...
        methods: {
            postData : function() {
                ...
                var res = ajax("/api/essentialOption/"+method+"Data", objs);
