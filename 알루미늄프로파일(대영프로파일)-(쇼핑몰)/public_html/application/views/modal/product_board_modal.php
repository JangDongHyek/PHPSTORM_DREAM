    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="write" autocomplete="off">
                ...
                <input type="hidden" name="cate" value="review">

                <div class="modal-body">존재하지 않는 정보입니다.
                    <div class="board_write">
                        ...
                        <div>
                            <input type="number" name="star" placeholder="별점" min="1" max="5" style="display: none">
                        </div>
                        <div>
                            <dl class="addFile">
                ...
                <div class="board_view">
                    ...
                    <div class="answer">
                        ...
                        <div class="answer_write hide">
                            ...
                            <a class="btn btn_green" onclick="registerAnswer()">답변등록</a>
                        </div>
                        <? } ?>
