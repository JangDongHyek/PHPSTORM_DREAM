...
<header id="header">
    <div class="hd_banner">믿음과 신뢰로 고객만족을 최우선으로 생각하는 <strong>알루미늄프로파일</strong></div>
	<h1 id="hd_h1">알루미늄프로파일</h1>
	<div id="hd_wrapper">
		<div class="area_top flex js">
			<div class="logo">
				<a href="<?=PROJECT_URL?>">
				    <img src="<?=ASSETS_URL?>/img/common/logo.png"/>
...
<div id="wrapper">
    <?php include_once VIEWPATH . "_common/category.php" // 카테고리 ?>
    <div class="container">
