...
<div id="cart">
	...
	<div class="vertical_wrap">
		<div class="list_wrap">
			<div class="chk_all">
                <input type="checkbox" id="chkAll" onclick="selectAllCart(this, 'checkIdx')"/>
			</div>
			<div class="product_cart box">
				...
				<div class="cart_list">
					<ul id="cartList">
                        ...
                        <li id="li<?=$cartIdx?>">
                            <div class="div_pro">
                                <input type="checkbox" name="checkIdx" value="<?=$cartIdx?>" <?=$soldOut?'disabled':''?>/>
                                <a href="<?=PROJECT_URL?>/medicinal/<?=$list['product_idx']?>" target="_blank" style="margin-left: 10px;">
                                    ...
                                    <div class="div_name">
                                        ...
                                        <p class="p_price prodPrice"><?=number_format($list['prod_price'])?>원</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <p class="p_price2">
                                <span><?=number_format($list['product_cnt']*$list['prod_price'])?>원</span>
                    ...
                    <?php
                    if(count($listData) == 0) { ?>
                    <div class="nodata" style="text-align: center">장바구니가 비어 있습니다.</div>
                    <?php } ?>
				</div>
			</div>
		</div>
		<div class="sticky">
			<div class="total">
				...
				<div class="total_price">
					...
					<p class="price txt_green"><span id="totalPriceDisplay">0</span>원</p>
				</div>
				<div class="btn_wrap">
					<a class="btn btn_middle btn_greenline" onclick="deleteCart(null, null, true);">장바구니 비우기</a>
					<a class="btn btn_middle btn_green" onclick="buy()">선택상품 주문하기</a>
				</div>
...
<script>
    ...
    const changeCount = async (e, value, input=false) => {
        ...
        const price = toNumber(parent.querySelector(`.div_pro .p_price`).textContent); // 상품금액
