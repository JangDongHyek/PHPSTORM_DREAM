...
class CommonExcelController extends CI_Controller {
	...
	public function downloadExcel()
	{
        ...
        $excelColumns = ["주문번호", "주문상태", "결제수단", "배송비", "추가배송비", "총 결제금액", "수취인명", "수취인 우편번호", "수취인 주소", "수취인 전화번호", "발송자명", "발송자 우편번호", "발송자주소", "발송자 전화번호", "배송메시지", "계산서 사업자번호", "계산서 이메일", "계산서 대표자명", "현금영수증 휴대폰번호or사업자번호", "주문날짜", "상품", "가격", "개수", "합계가"];
        $dbColumns = ["ord_no", "ord_status", "pay_method", "delivery_fee", "delivery_fee2", "total_price", "rec_name", "rec_zcode", "rec_addr_full", "rec_tel", "ord_name", "ord_zcode", "ord_addr_full", "ord_tel", "rec_memo", "invoice_biz_num", "invoice_email", "invoice_rep_name", "cash_receipt_auth_num", "reg_date", "item_name", "item_price", "item_cnt", "item_Amt"];
        $filename = "주문내역";
        ...
        $response = $this->OrderModel->getOrderListExcel($param);
