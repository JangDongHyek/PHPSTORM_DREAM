...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="it_basic">검색어</label></th>
            <td>
            ...
            <td>
                <div class="sit_option tbl_frm01">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="opt1" value="" id="opt1" class="frm_input" size="200">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                        ...
                        <td>
                            ...
                            <input type="text" name="opt2" value="" id="opt2" class="frm_input" size="200">
                        </td>
                    </tr>
                     <tr>
                        <th scope="row">
                        ...
                        <td>
                            ...
                            <input type="text" name="opt3" value="" id="opt3" class="frm_input" size="200">
                        </td>
                    </tr>
                    </tbody>
                    </table>
                ...
                $(function() {
                    ...
                    $(".opt-cell").each(function() {
                        ...
                        if(opt1 && $.inArray(opt1, arr_opt1))
                            arr_opt1.push(opt1);

                        if(opt2 && $.inArray(opt2, arr_opt2))
                            arr_opt2.push(opt2);

                        if(opt3 && $.inArray(opt3, arr_opt3))
                            arr_opt3.push(opt3);
                    });
                ...
                <div id="sit_supply_frm" class="sit_option tbl_frm01">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="spl[]" id="spl_item_<?php echo $seq; ?>" value="" class="frm_input" size="150">
                            <?php
                            if($i > 0)
