...
$sql_common = " from {$g5['g5_shop_cart_table']} where od_id = '{$od['cart_id']}' and (ct_status = '쇼핑' or ct_status='미완료') and ct_select = '1' ";
        ...
        <section id="anc_sodr_taker" class="compare_right">
            ...
            <div class="tbl_frm01">
				...
				<tr>
                    ...
                    <td><?php echo $data['od_delivery_date']; ?></td>
                </tr>
