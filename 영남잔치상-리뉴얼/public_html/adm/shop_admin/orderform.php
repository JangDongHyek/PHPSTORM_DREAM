...
<section id="anc_sodr_list">
	...
	<input type="hidden" name="send_phone" value="<?php echo $od[od_hp]?>">
    <div class="tbl_head01 tbl_wrap">
            ...
            */
            ...
            for($k=0; $opt=sql_fetch_array($res); $k++) {
                if($opt['io_type'])
                    ...
                    $opt_price = $sum['it_price'] + $opt['io_price'];
                // 소계
        ...
        if($i == 0){
            //23.11.07 ip로해서 최근꺼로 주문번호 적어주기 wc
            echo '<tr><td colspan="30"><a href="./orderform_lostupdate.php?od_id='.$od['od_id'].'&od_ip='.$od['od_ip'].'">상품불러오기</a></td></tr>';
        }
        ?>
        </tbody>
        </table>
...
<section id="anc_sodr_pay">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_numbig"><?php echo ($od['od_send_cost'] + $od['od_send_cost2']); ?></td>
        ...
        <!-- <section id="anc_sodr_chk" class="compare_left">
            ...
            <div class="tbl_frm01">
                ...
                ?>
                    ...
                    <td>
        						<?php 
        							echo $od['od_cash']=="1"?"[현금영수증]":"";
        							echo $od['od_e_tax']=="1"?"[전자세금계산서]":"";
        						?>
        					</td>
                </tr>
                </tbody>
		...
		<section id="anc_sodr_paymo">
            ...
            <div class="tbl_frm01">
                ...
                <!-- <tr>
                    ...
                    <td colspan="3"><?php echo str_replace($bank_account,"od_bank_account",""); ?></td>
                </tr> -->
                <?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br>
                        <?php } ?>
                        <input type="text" name="" value="<?php echo get_text($od['od_deposit_name']); ?>" id="" class="frm_input">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="od_receipt_point" value="<?php echo $od['od_receipt_point']; ?>" id="" class="frm_input" size="10"> 점
                        <!-- wc 포인트환전버튼 -->

                        <?php if($od['od_receipt_point']){ ?>
                            <button type="button" onclick="refund_point()" class="btn_02 color_06" style="padding: 5px">포인트 환불버튼</button>
                        <?php } ?>
				...
				<!--<tr>
                    <th scope="row">받는날짜</th>
                    <td><?php echo $od['od_delivery_date'] ?></td>
                </tr>
...
<section>
        ...
        <section id="anc_sodr_taker" class="compare_right">
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="od_delivery_date" id="od_delivery_date" value="<?php echo $od[od_delivery_date]?>" class="frm_input required" required/>
                    </td>
                </tr>
				<tr>
    ...
    <div class="btn_confirm01 btn_confirm">
		...
		<a href="javascript:;" onclick="printWindow('<?php echo $od_id?>')" class="btn02">인쇄하기</a>
    </div>
...
<script>
function printWindow(od_id){
	window.open(`./orderformprint.php?od_id=${od_id}`,'print','width=700,height=700,scrollbars=yes');
}
$(function() {
    // 전체 옵션선택
...
// 포인트 환불
function refund_point() {

    var od_receipt_point = <?=$od['od_receipt_point']?>;
    var od_id = '<?=$od_id?>';
    var mb_id = '<?=$od['mb_id']?>';

    if(confirm('포인트 환불하시겠습니까?')){
        $.ajax({
            url: g5_admin_url + '/shop_admin/ajax.refund_point.php',
            data: {
