...
?>
    <?
        ...
        // 현재 페이지가 orderform.php인지 확인합니다.
        if ($current_page == "orderform.php") {
            // 조건이 참이면, 원하는 메타 태그를 출력합니다.
...
<link rel="apple-touch-icon-precomposed" href="<?php echo G5_IMG_URL; ?>/mobile_homeicon.png" />
<meta name="referrer" content="no-referrer-when-downgrade" />
<meta property="og:type" content="website" />
<meta property="og:url" content="http://www.janchisang.com/" />
...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/all.min.css"><!--폰트어썸-->
...
<?php } else { ?>
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/subpage.css?ver=<?php echo G5_CSS_VER; ?>">
<?php } ?>
<?php /*?><?php
...
<!--<script src="http://itforone.com/~janchisang2/theme/playrun/js/bootstrap.min.js"></script> -->
