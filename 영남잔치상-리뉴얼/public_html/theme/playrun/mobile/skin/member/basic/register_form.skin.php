				...
				<div class="box-body">
					...
					<dl class="row adrBox">
						...
						<dd class="col-xs-11">
							...
							<input type="text" name="mb_zip" value="<?php echo $member['mb_zip1'].$member['mb_zip2']; ?>" id="reg_mb_zip" <?php echo $config['cf_req_addr']?"required":""; ?> class="required f_empty" size="5" maxlength="6" placeholder="우편번호" readonly onclick="win_zip('fregisterform', 'mb_zip', 'mb_addr1', 'mb_addr2', 'mb_addr3', 'mb_addr_jibeon');">
							...
							<input type="text" name="mb_addr1" value="<?php echo get_text($member['mb_addr1']) ?>" id="reg_mb_addr1" <?php echo $config['cf_req_addr']?"required":""; ?> class="required f_empty" size="50" placeholder="기본주소" readonly>
							<input type="text" name="mb_addr2" value="<?php echo get_text($member['mb_addr2']) ?>" id="reg_mb_addr2" class="f_empty" size="50" placeholder="상세주소">
