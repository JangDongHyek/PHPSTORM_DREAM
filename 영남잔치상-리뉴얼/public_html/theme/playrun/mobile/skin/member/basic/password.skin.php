...
?>
<div id="top" style="height: 300px; background:  url(../theme/playrun/img/common/top_bg.jpg) no-repeat center top;
    text-align: center;    padding-top: 200px;">
<img src="<?php echo G5_THEME_IMG_URL ?>/common/logo.png" alt="영남잔치상" title=""></div>
<div id="pw_confirm" class="mbskin">
    ...
    <p>
        ...
        <?php } else { ?>
        <strong>비밀글로 보호된 글입니다.</strong>
        작성자와 관리자만 열람하실 수 있습니다. <br class="visible-xs">본인이라면 비밀번호를 입력하세요.
        <?php } ?>
    </p>
    ...
    <div class="btn_confirm"><br><br><br>
