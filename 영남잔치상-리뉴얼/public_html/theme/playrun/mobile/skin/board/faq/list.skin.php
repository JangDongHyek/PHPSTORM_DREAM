...
<div id="bo_list" style="width:<?php echo $width; ?>">
	...
	<fieldset id="bo_sch">
		...
		<div class="searchBox">
    		...
    		<li class="bo_search col-md-12 col-xs-12"><input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx"  class="frm_input required" size="25" maxlength="15"> <input type="submit" value="검색" class="btn_submit" style="height:40px"></li>
    		</ul>
		</div>
		</form>
	</fieldset>
