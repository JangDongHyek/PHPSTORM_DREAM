...
<? if ($bo_table =="gall01"||$bo_table =="gall02") { ?>
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
        <?php /*?><caption><?php echo $board['bo_subject'] ?> 목록</caption><?php */?>
        <thead>
        <tr>
            <th scope="col">번호</th>
            <?php if ($is_checkbox) { ?>
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>">
                   <?php
					...
					<?php }else{ 
						echo $list[$i]['icon_reply']?$list[$i]['wr_name']."님 답변 글입니다.":$list[$i]['wr_name']."님 문의 글입니다.";
					}
					?>
                    <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><?php echo '<span style="padding-left:5px; color:#ff3300;">+'.$list[$i]['comment_cnt'].'</span>'; ?><span class="sound_only">개</span><?php } ?>
                </a>
