...
<!--        <caption><?php echo $g5['title'] ?></caption>-->
		...
		?>
        <tr>
            <th scope="row"><label for="wr_1">고객사<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_client" required class="frm_input required"></td>
        </tr>
		<?php }?>

        <tr>
            <th scope="row"><label for="wr_2">일자<strong class="sound_only">필수</strong></label></th>
            <td><input type="date" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input required" readonly></td>
        </tr>


       <!--  <tr>
            <th scope="row"><label for="wr_3">행사장소<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" required class="frm_input required"></td>
        </tr>
        
        
        <tr>
            <th scope="row"><label for="wr_4">세부내용<strong class="sound_only">필수</strong></label></th>
