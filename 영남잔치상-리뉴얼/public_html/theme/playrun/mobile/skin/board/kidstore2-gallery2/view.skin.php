...
-->
        ...
        <?php if($bo_table=="gall01"){?><b>고객사</b> <strong><?php echo $view['wr_1'] ?></strong><span class="line"></span><?php }?>
        <b>일자</b> <strong><?php echo $view['wr_day'] ?> <?php echo date("Y년 m월 d일",strtotime($view['wr_2']))?></strong><!--<span class="line"></span>-->
<!--
        <b>행사장소</b> <strong><?php echo $view['wr_place'] ?><?php echo $view['wr_3'] ?></strong><span class="line"></span><br>
        <b>세부내용</b> <strong><?php echo $view['wr_subcon'] ?><?php echo $view['wr_4'] ?></strong>
-->
    </section>
