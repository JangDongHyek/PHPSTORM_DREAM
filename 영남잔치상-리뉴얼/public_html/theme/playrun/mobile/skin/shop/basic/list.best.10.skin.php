...
if($this->total_count > 0) {
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        if ($this->href) {
            echo '<div class="sct_img"><a href="'.$this->href.$row['it_id'].'&ca_id='.$_GET['ca_id'].'" class="sct_a">'.PHP_EOL;
        }
        ...
        if ($this->href) {
            echo '<div class="sct_txt"><a href="'.$this->href.$row['it_id'].'&ca_id='.$_GET['ca_id'].'" class="sct_a">'.PHP_EOL;
        }
