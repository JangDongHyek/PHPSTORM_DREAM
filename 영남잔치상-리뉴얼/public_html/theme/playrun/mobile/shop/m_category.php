...
<div id="all_c_mo">
    <div id="menu_open"><i class="fal fa-bars"></i> 전체 카테고리</div>
...
<script>
$(function (){
    var $category = $("#category_m");

    $("#all_c_mo #menu_open").on("click", function() {
        $category.css("display","block");
    });

    $("#category_m .close_btn").on("click", function(){
        $category.css("display","none");
    });
});
$(document).mouseup(function (e){
	var container = $("#category_m");
