...
<div id="sod_fin">
    ...
    <section class="sod_fin_list">
        ...
        <ul id="sod_list_inq" class="sod_list">
            ...
            for($i=0; $row=sql_fetch_array($result); $i++) {
                ...
                $res = sql_query($sql);
                */
                $sql = " select a.ct_id, a.it_name, a.ct_option, a.ct_qty, a.ct_price, a.ct_point, a.ct_status, a.io_type, a.io_price, b.it_price
        ...
        <section id="sod_fin_pay">
            ...
            <div  class="odf_tbl">
                ...
                <tr>
                    ...
                    <td><span style="display: inline-block; width: 150px; word-break: keep-all;"><?php echo get_text($od['od_bank_account']); ?></span></td>
                </tr>
                <?php
                }
    ...
    <section id="sod_fin_cancel">
        ...
        if ($cancel_price == 0) {
            if ($custom_cancel) {
        ?>
        <button type="button" onclick="alert('고객센터에 문의하세요. \n051-528-1405')">주문 취소하기</button>
<!--
...
<script type="text/javascript">
var mi_type = "order";
var mi_val = "<?=$tot_price?>";
var mi_order_num = "<?=$od_id?>";
</script>
