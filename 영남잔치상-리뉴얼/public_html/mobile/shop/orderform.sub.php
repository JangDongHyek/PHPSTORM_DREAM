...
?>
    ...
    <ul class="sod_list">
        ...
        <li class="sod_li">
            ...
            <div class="li_prqty">
                <span class="prqty_price li_prqty_sp"><span>판매가 </span><?php echo number_format($row['it_price']); ?></span>
    ...
    <section id="sod_frm_orderer" >
        ...
        <div class="odf_tbl">
            ...
            <tr>
                ...
                <td><input type="text" name="od_tel" value="<?php echo get_text($member['mb_tel']); ?>" id="od_tel" required class="frm_input required" maxlength="20"  oninput="autoHyphen(this)"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="od_zip" value="<?php echo $member['mb_zip1'].$member['mb_zip2']; ?>" id="od_zip" required class="frm_input required" size="5" maxlength="6" readonly  onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');">
                    ...
                    <input type="text" name="od_addr1" value="<?php echo get_text($member['mb_addr1']) ?>" id="od_addr1" required class="frm_input frm_address required" readonly>
    ...
    <section id="sod_frm_taker">
        ...
        <div class="odf_tbl">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="ad_subject" id="ad_subject" class="frm_input" maxlength="20"><br>
			...
			<tr>
                <td colspan="2">
					<span style="color:#cc0000 !important">
						※ 배송지가 시외일 경우 아래 선택란을 꼭 체크를 하시고<br/>
							음식을 받으실 <b>터미널 또는 주소</b>를 기입해주세요.<br/>
						- 부산/김해/양산 외 지역만 체크 바랍니다. <b>(명절차례상은 터미널 수령만 가능합니다.)</b>
					</span><br/>
					<input type="radio" name="od_b_receive" id="receive0" value="해당없음" checked><label for="receive0">해당없음</label>
					<input type="radio" name="od_b_receive" id="receive1" value="터미널"><label for="receive1">터미널</label>
					<input type="radio" name="od_b_receive" id="receive2" value="집까지 수령"><label for="receive2">집까지 수령</label>
				</td>
            </tr>
            <tr>
                <th scope="row"><label for="od_b_tel">전화번호<strong class="sound_only"> 필수</strong></label></th>
                <td><input type="text" name="od_b_tel" id="od_b_tel" required class="frm_input required" maxlength="20" oninput="autoHyphen(this)"></td>
            </tr>
            <tr>
			...
			<tr>
                ...
                <td>
					<input type="radio" name="od_path" value="인터넷검색" id="path1" checked/><label for="path1">인터넷검색</label>&nbsp;&nbsp;
					<input type="radio" name="od_path" value="지인소개" id="path2"/><label for="path2">지인소개</label>&nbsp;&nbsp;
					<input type="radio" name="od_path" value="블로그" id="path3"/><label for="path3">블로그</label>&nbsp;&nbsp;
					<input type="radio" name="od_path" value="재구매" id="path4"/><label for="path4">재구매</label>&nbsp;&nbsp;
					<input type="radio" name="od_path" value="기타" id="path5"/><label for="path5">기타</label>
				</td>
            </tr>
            <tr>
    ...
    <section id="sod_frm_pay">
        ...
        if ($is_member && $config['cf_use_point'])
        {
            ...
            if ($member['mb_point'] >= $default['de_settle_min_point'])
            {
                ...
                echo '<div id="sod_frm_pt"><input type="hidden" name="max_temp_point" value="'.$temp_point.'">결제포인트 : <input type="text" id="od_temp_point" name="od_temp_point" value="0" class="frm_input" size="10">점 </div>';
...
$(function() {
    ...
    $("input[name=ad_sel_addr]").on("click", function() {
        ...
        if (addr[0] == "same") {
            ...
            if(zipcode != code) {
                calculate_sendcost(code,f.od_b_addr1.value);
            }
        }
    });
...
function calculate_sendcost(code,addr1)
{
    <?php
...
function pay_approval()
{
    ...
    if(settle_method != "무통장") {
        ...
        pf.good_mny.value = od_price + send_cost + send_cost2 - send_coupon - temp_point;
    ...
    if( jQuery(pf).triggerHandler("form_sumbit_order_"+form_order_method) !== false ) {
		...
		f.i_od_delivery_date.value = pf.od_delivery_date.value;
        <?php if($default['de_tax_flag_use']) { ?>
        ...
        {
            case "계좌이체":
                pf.PayMethod.value = "BANK";
                break;
            case "가상계좌":
                pf.PayMethod.value = "VBANK";
                break;
            case "휴대폰":
                pf.PayMethod.value = "HPP";
                break;
            case "신용카드":
                pf.PayMethod.value = "CARD";
                break;
           
            default:
                pf.PayMethod.value = "무통장";
                break;
        }
					pf.BuyerName.value = pf.od_name.value;//이름
//					pf.BuyerEmail.value = pf.od_email.value;//이메일
					pf.BuyerTel.value = pf.od_hp.value;//연락처
					/* 주소 */
					pf.BuyerPostNo.value = pf.od_b_zip.value;
					pf.BuyerAddr.value = pf.od_b_addr1.value;
					pf.BuyerAuthNum.value = pf.od_b_addr2.value;
					pf.Amt.value = pf.good_mny.value;//가격
					pf.GoodsName.value=pf.good_name.value;//상품명
					pf.Moid.value="<?=$s_cart_id?>";//주문번호
					if(pf.PayMethod.value!="무통장"){
