            ...
            <li>
                <div class="addr_title">
					<div class="addr_input">
						...
						<input type="text" name="ad_subject[<?php echo $i; ?>]" value="<?php echo $row['ad_subject']; ?>" class="ad_subject" maxlength="20" placeholder="배송지명을 입력하세요">
                    </div>

					<div class="btn_wrap">
						<input type="hidden" value="<?php echo $addr; ?>">
<!--						<button type="button" class="btn_sel sel_address">배송지 선택</button>-->
						<a href="" class="btn_sel sel_address">배송지 선택</a>
                ...
                <div class="addr_info">
                    ...
                    <div class="addr_tel">
                    <i class="fa fa-phone" aria-hidden="true"></i> <?php echo $row['ad_tel']; ?> <span class="line"></span> 
                    <i class="fa fa-mobile" aria-hidden="true"></i> <?php echo $row['ad_hp']; ?>
                    </div>
                </div>
				<div class="addr_btn">
