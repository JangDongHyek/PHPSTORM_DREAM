...
if($bo_table=="b_online"||$bo_table=="b_request"){
	if($s_wr_name&&$s_wr_password){
		$s_wr_password1=$s_wr_password;
		$s_wr_password = get_encrypt_string($s_wr_password);
//		echo  $s_wr_password;
//        $sql_search.=" and (wr_name like '%$s_wr_name%' or wr_name='최고관리자') and wr_password = '$s_wr_password'";
        $sql_search.=" and wr_name like '%$s_wr_name%' and wr_password = '$s_wr_password'";
		$qstr.="&s_wr_name=$s_wr_name&s_wr_password1=$s_wr_password1";
		
	}
}

if($board['gr_id']=="PRODUCT"&&!$is_admin){
	$sql_search.=" and wr_6 =''";
}
