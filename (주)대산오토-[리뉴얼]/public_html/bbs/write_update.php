...
if ($bo_table != 'g_part01'&&$bo_table != 'g_part02'&&$bo_table != 'g_part03'&&$bo_table != 'g_part04'&&$bo_table != 'g_part05'&&$bo_table != 'g_part06'&&$bo_table != 'g_part07'&&$bo_table != 'g_part_sale') {
    if ($wr_content == '') {
...
for ($i=0; $i<count($_FILES['bf_file']['name']); $i++) {
    ...
    if (is_uploaded_file($tmp_file)) {
		...
		/*if($board['gr_id']=="PRODUCT"){
			...
			$watermark = G5_THEME_PATH.'/img/watermark2.png'; // 워터마크 이미지를 교체하세요.
			add_watermark_image($dest_file, $watermark);
			//addImageWatermark($dest_file, $watermark, $dest_file, 20);
