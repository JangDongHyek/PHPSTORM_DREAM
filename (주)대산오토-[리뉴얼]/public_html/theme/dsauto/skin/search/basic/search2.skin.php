...
<p class="search_tit"><span>'<?php echo $_GET[stx] ?>'</span> 에 대한 검색결과 <?php echo number_format($total_count) ?>개</p>
...
<div id="bo_gall">
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
        ...
        <div class="sch_more"><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;sfl=<?=$sfl?>&stx=<?=$stx?>&sop=<?=$sop?>"><strong><?php echo $bo_subject[$idx] ?></strong> 결과 더보기</a></div>
