...
<fieldset id="bo_sch"  class="hidden-xs">
    ...
    <select name="sfl" id="sfl">
		<option value="wr_subject||wr_content||wr_1||wr_2||wr_3"<?php echo get_selected($sfl, 'wr_subject||wr_content||wr_1||wr_2||wr_3'); ?>>통합검색</option>
        <option value="wr_subject"<?php echo get_selected($sfl, 'wr_subject', true); ?>>품번</option>
        <option value="wr_1"<?php echo get_selected($sfl, 'wr_1'); ?>>제품명(한글)</option>
		<option value="wr_2"<?php echo get_selected($sfl, 'wr_2'); ?>>제품명(영문)</option>
		<option value="wr_3"<?php echo get_selected($sfl, 'wr_3'); ?>>차종</option>
            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="title">
						...
						<?php echo $list[$i]['wr_6']=="1"?"<span style='padding:5px;background-color:red;color:white;font-size:10px;border-radius:10px'>숨김</span>":"";?>
