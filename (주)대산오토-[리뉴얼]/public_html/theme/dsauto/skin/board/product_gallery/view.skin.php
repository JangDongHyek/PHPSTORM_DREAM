    ...
    <section id="bo_v_atc">
        ...
        <div class="clearfix header">
            ...
            <div class="col-md-6">
                    ...
                    <p class="t4 t_padding15">품번(Part number)<span><?=$view['wr_subject']?></p> <!-- 제품코드 -->
                    <!--<p class="wow bounceIn" data-wow-delay="1s" style="width:100%; border-bottom:1px solid #b6c3cb; margin:0px auto">&nbsp;</p>-->
                    <div class="pt_30"></div>
                    <p class="t4">제품명(영문)(English name)<span><?=$view['wr_2']?></span></p>
                    ...
                    <!--견적신청버튼-->
                    <div>
                        <a href="<?php echo G5_BBS_URL ?>/write.php?bo_table=b_online&wr_subject=<?php echo $view['wr_subject'];?>&wr_1=<?php echo $view[wr_1]?>&wr_2=<?php echo $view[wr_2]?>" class="counsel"><i class="fal fa-keyboard"></i>&nbsp;제품문의</a>
