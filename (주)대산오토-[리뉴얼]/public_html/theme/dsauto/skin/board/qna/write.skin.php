...
<section id="bo_w">
    ...
    echo $option_hidden;
    ?>
    <div class="text-center b_margin10"><a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_roll02"><i class="fal fa-file-search"></i> 내가 쓴 글 조회하기</a></div>
	<? if(!$is_admin&&$w!="r"){?>
    <div class="agree">
    	<h2>개인정보수집동의</h2>
        <div class="txt cf">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="email" name="wr_email" value="<?php echo $write[email] ?>" id="wr_email" class="frm_input email required" required  maxlength="100"></td>
        </tr>
        <?php } ?>
		<?php if(!$is_admin){?>
		<tr>
            <th scope="row"><label for="wr_1">연락처</label></th>
            <td><input type="tel" name="wr_1" value="<?php echo $write[wr_1] ?>" id="wr_1" class="frm_input required"  maxlength="100" required></td>
        </tr>
		<?php }?>
		<?php /*?
        <?php if ($is_homepage) { ?>
