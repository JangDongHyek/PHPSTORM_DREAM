    ...
    if ($is_notice || $is_html || $is_secret || $is_mail) {
		...
		if ($is_html) {
            if ($is_dhtml_editor) {
                ...
                $option .= "\n".'<input type="hidden" id="html" name="html" onclick="html_auto_br(this);" value="'.$html_value.'" '.$html_checked.'>'."\n".'<label for="html" style="display:none">html</label>';
            }
        }
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		*/ ?>
		...
		<?php
			if($is_admin){?>
		<tr>
            <th scope="row"><label for="wr_2">완료<strong class="sound_only">필수</strong></label></th>
            <td><input type="checkbox" name="wr_2" value="완료" id="wr_2" <?php echo $write[wr_2]=="완료"?"checked":"";?>> <label for="wr_2">완료하기</label></td>
        </tr>
		<?php }else{?>
