...
?>
    ...
    <dl id="sod_bsk_tot" style="font-size: 0.5em">
        <dt class="sod_bsk_sell">주문금액</dt>
        ...
        <?php } ?>
        <dt class="sod_bsk_point">적립금 사용</dt>
        <dd class="sod_bsk_point"><?php echo number_format($tot_point); ?> 점 보유 <strong><input type="text" class="frm_input" size="10" maxlength="10"> 사용</strong></dd>
        ...
        <dt class="sod_bsk_dvr2">추가배송비</dt>
        <dd class="sod_bsk_dvr2"><strong> 원</strong></dd>
	
        <?php } ?>
		
        <dt class="sod_bsk_cnt">총 주문금액</dt>
