...
//*************************************************************************************
if($ResultCode=="3001"){
	$sql = " select * from {$g5['g5_shop_order_data_table']} where od_id = '$od_id' or cart_id='$cart_id'";
		$od = sql_fetch($sql);
		$od_id=$od[od_id];
	...
	<script type="text/javascript">
		<?
			if($FORWARD=="Y"){
		?>
			/*opener.document.getElementsByName("tno")[0].value="<?=$TID?>";
			opener.document.getElementsByName("amount")[0].value="<?=$Amt?>";
			opener.document.getElementsByName("app_time")[0].value="<?=$AuthDate?>";
			opener.document.getElementsByName("card_name")[0].value="<?=$fn_name?>";
			opener.document.getElementsByName("bank_name")[0].value="<?=$BankName?>";
			opener.document.getElementsByName("app_no")[0].value="<?=$AuthCode?>";
			opener.document.forderform.action="<?=G5_HTTPS_MSHOP_URL?>/orderformupdate.php";
			opener.document.forderform.target="";
			opener.document.forderform.submit();*/
//			self.close();

		<? }else{?>
			/*parent.document.getElementsByName("tno")[0].value="<?=$TID?>";
			parent.document.getElementsByName("amount")[0].value="<?=$Amt?>";
			parent.document.getElementsByName("app_time")[0].value="<?=$AuthDate?>";
			parent.document.getElementsByName("card_name")[0].value="<?=$fn_name?>";
			parent.document.getElementsByName("app_no")[0].value="<?=$AuthCode?>";
			parent.document.getElementsByName("bank_name")[0].value="<?=$BankName?>";
			parent.document.getElementsByName("app_no")[0].value="<?=$AuthCode?>";
			parent.document.forderform.action="<?=G5_HTTPS_MSHOP_URL?>/orderformupdate.php";
			parent.document.forderform.target="";
			parent.document.forderform.submit();*/
			parent.document.location.href="<?php echo G5_SHOP_URL?>/orderinquiryview.php?od_id=<?=$od_id?>";
		<? }?>
	</script>
<?
}else{
