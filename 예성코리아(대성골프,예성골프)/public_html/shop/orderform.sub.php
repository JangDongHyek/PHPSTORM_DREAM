   ...
   <!--  <dl id="sod_bsk_tot">
    ...
    <section id="sod_frm_orderer">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                <th scope="row"><label for="od_email">이메일<strong class="sound_only"> 필수</strong></label></th>
            ...
            <tr>
                <th scope="row"><label for="od_memo">주문자 요청사항</label></th>
...
<!--                     <br>
			...
			<!-- <tr>
					...
					<?php
							...
							$currentSec=strtotime(date("Y-m-d")." +1 day");
