...
$content .= '<br/><span style="color:red;font-weight:bold">이 메일은 발신 전용 메일입니다.</span>';
$content .= '</p>';
...
$content .= '</div>';
$content .= '</div>';
itforoneMailer( "no-reply@dreamforone.com","골드엑스", $_POST['mb_email'],$mb['mb_name'], $subject, $content);
