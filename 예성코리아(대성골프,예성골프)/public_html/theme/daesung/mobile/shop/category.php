...
<div id="all_c">
    <div id="menu_open"><i class="fa-regular fa-bars-staggered"></i> <span class="hidden-sm hidden-xs">CATEGORY</span></div>
    
    <div id="category">
        <button type="button" class="close_btn"><i class="fa-regular fa-bars-sort"></i> CATEGORY<span class="sound_only">CLOSE</span></button>
        <div class="ct_wr">
            <?php
