...
//                        $sc_method = number_format($it[it_sc_price])."원";
						$sc_method = 0 < $it['it_price']?number_format($it[it_sc_price])."원":number_format($default[de_send_cost_list])."원";
					}
					//$sc_method = 0 < $it['it_sc_price']?number_format($it[it_sc_price])."원":number_format($default[de_send_cost_list])."원";
                }
            ?>
            <tr>
...
<img src="<?php echo G5_THEME_URL; ?>/img/detail_top.jpg" alt="" />
            <div id="sit_inf" class="win_desc">
                ...
                <div id="sit_inf_explan">
                    <?php echo str_replace("http://itforone.com/~sunmicookie2/","https://www.sunmicns.com/",($it['it_mobile_explan'] ? conv_content($it['it_mobile_explan'], 1) : conv_content($it['it_explan'], 1))); ?>
                </div>
                <?php } ?>
