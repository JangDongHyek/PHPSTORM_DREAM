...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="reg_mb_email">사업자등록증<strong class="sound_only">필수</strong></label></th>
            <td>
                <input type="file" name="mb_biz_f" class="frm_input">
				<input type="hidden" name="mb_biz" value="<?php echo $member[mb_biz]?>">
            </td>
        </tr>
