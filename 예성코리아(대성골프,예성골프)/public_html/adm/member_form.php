...
<div class="tbl_frm01 tbl_wrap">
	...
	<? if($mb[mb_level]=="3"){?>
	 <tr>
        <th scope="row">상호명</th>
        <td>
            <input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1" maxlength="100" size="30">
        </td>
        <th scope="row">사업자등록번호</th>
        <td>
            <input type="text" name="mb_2" value="<?php echo $mb['mb_2'] ?>" id="mb_2" maxlength="100" size="30">
			<input type="hidden" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" maxlength="100" size="30"><br/>
			<? if($mb[mb_3]){?>
