...
<div class="tbl_head01 tbl_wrap">
	...
	<tr class="orderlist<?php echo ' '.$bg; ?>">
		...
		<td scope="col" rowspan="2" class="td_left">
			...
			<div><strong>수령인</strong> <a href="<?php echo $_SERVER['SCRIPT_NAME']; ?>?sort1=<?php echo $sort1; ?>&amp;sort2=<?php echo $sort2; ?>&amp;sel_field=od_b_name&amp;search=<?php echo get_text($row['od_b_name']); ?>"><?php echo get_text($row['od_b_name']); ?></a></div>
            <?php } else { ?>
            비회원
            <? } ?>
		</td>
		...
		<!-- 판매자 -->
		<td scope="col" rowspan="2"><?=$seller_name?></td>
		<!-- 보기 -->
    ...
    <tr class="orderlist">
        ...
        <td colspan="2"><?php echo number_format($tot_itemcount); ?>건</td>
