...
function fitemlist_submit(f, mode)
{
	...
	<div class="tbl_head01 tbl_wrap">
		...
		<tr>
			...
			<th scope="col" rowspan="2"><?php echo subject_sort_link('it_price', 'sca='.$sca); ?>소매가격</a></th>
			<th scope="col" rowspan="2"><?php echo subject_sort_link('it_price2', 'sca='.$sca); ?>도매가격</a></th>
		...
		<tr class="<?=$bg?>" data-no="<?=$i?>">
			...
			<!-- 도매가격 -->
			<td rowspan="2"><input type="text" name="it_price2[<?=$i?>]" value="<?php echo $row['it_price2']; ?>" id="price_<?=$i?>" class="tbl_input sit_amt" size="7"></td>
			<!-- 시중가격 -->
			...
			<td rowspan="2" class="td_mng td_mng_s">
				...
				<a href="javscript:;" onclick="window.open('./itemcopy.php?it_id=<?=$it_id?>&amp;ca_id=<?php echo $row['ca_id']; ?>','copy','width=400,height=300')" class="itemcopy btn btn_02">복사</a>
