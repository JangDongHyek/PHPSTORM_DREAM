...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
        <tr>
            <th scope="row"><label for="it_price">소매가격</label><span class="noti">*</span></th>
            <td><input type="text" name="it_price" value="<?php echo $it['it_price']; ?>" id="it_price" class="frm_input" size="8" required> 원</td>
        </tr>
		<tr>
            <th scope="row"><label for="it_price2">도매가격</label><span class="noti">*</span></th>
            <td><input type="text" name="it_price2" value="<?php echo $it['it_price2']; ?>" id="it_price" class="frm_input" size="8" required> 원</td>
        </tr>
        <tr>
