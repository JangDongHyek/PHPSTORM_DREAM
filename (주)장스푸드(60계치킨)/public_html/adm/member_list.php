...
if($sst == "mb_leave_date"){
    $main_search .= " and mb_leave_date != ''";
} else if($sst == "mb_intercept_date") {
    $main_search .= " and mb_intercept_date != ''";
} else {
    $main_search .= " and mb_leave_date = ''";
}
...
$sql = " select count(*) as cnt {$sql_common} {$sql_search} and mb_leave_date = '' and mb_intercept_date = '' {$sql_order} ";
$row = sql_fetch($sql);
$total_count = $row['cnt'];
...
$sql = " select * {$sql_common} {$sql_search} {$main_search} {$sql_order} limit {$from_record}, {$rows} ";
