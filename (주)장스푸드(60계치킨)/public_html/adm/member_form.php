...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td><input type="text" name="mb_sex" value="<?php echo $mb['mb_sex'] ?>" id="mb_sex" required class="required frm_input" size="15" maxlength="20"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="mb_email" value="<?php echo $mb['mb_email'] ?>" id="mb_email" maxlength="100" required class="required frm_input" size="30"></td>
