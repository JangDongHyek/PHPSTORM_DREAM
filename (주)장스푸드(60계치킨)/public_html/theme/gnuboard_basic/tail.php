...
if ($config['cf_analytics']) {
    echo $config['cf_analytics'].'teee';
}

?>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-XPBQWPZ591">
        <script>
            window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-XPBQWPZ591');
    </script>
