    ...
    <div id="hd_wrapper">
        <div class="container">
                ...
                <ul id="tnb" class="col-xs-3">
                    ...
                    <li><a href="<?php echo G5_BBS_URL ?>/logout.php"><span class="hidden-sm hidden-xs">로그아웃</span><span class="visible-sm visible-xs"><i class="fa fa-user"></i></span></a></li>
                    <?php } else {  ?>

                    <li><a href="<?php echo G5_BBS_URL ?>/login2.php"><span class="hidden-sm hidden-xs">로그인</span><span class="visible-sm visible-xs"><i class="fa fa-user"></i></span></a></li>
        ...
        <ul id="gnb_1dul">
            ...
            <li class="gnb_1dli" style="z-index:<?php echo $gnb_zindex--; ?>;display:<?php echo $display;?>">
                ...
                <!--<a href="<?/*=G5_BBS_URL*/?>/board.php?bo_table=cs" target="_<?php /*echo $row['me_target']; */?>" class="gnb_1da"><?php /*echo $row['me_name'] */?></a>-->
                    <a href="<?=G5_BBS_URL?>/board.php?bo_table=customer" target="_<?php echo $row['me_target']; ?>" class="gnb_1da"><?php echo $row['me_name'] ?></a>
