...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">이벤트등록</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
			...
			<td class="text-right">
				<a href="./write.php?bo_table=event_join&wr_subject=<?=$list[$i]['wr_subject']?>&id=<?=$list[$i]['wr_id']?>" class="event_btn">참여하기</a>
			</td>
        </tr>
        <?php } ?>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
			...
			<?if($is_admin){?><li><a href="./board.php?bo_table=event_join" class="btn_b02">이벤트 참여리스트</a></li><?}?>
			<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">이벤트등록</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
