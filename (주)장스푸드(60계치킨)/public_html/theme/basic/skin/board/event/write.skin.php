...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_subject">이벤트명<strong class="sound_only">필수</strong></label></th>
            <td>
    ...
    <div class="btn_confirm">
        <input type="submit" value="이벤트등록" id="btn_submit" accesskey="s" class="btn_submit">
