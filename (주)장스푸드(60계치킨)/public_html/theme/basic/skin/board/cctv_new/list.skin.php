    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            if ($list[$i]['is_notice']) // 공지사항
                ...
                echo $list[$i]['num'];
			//if(!$list[$i]['is_notice']){
				$list[$i]['href']=$member[mb_level]=="10"?$list[$i]['href']:$list[$i]['wr_link1'];
				$list[$i]['target']=$member[mb_level]=="10"?"_self":"_blank";
			//}
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>" target="<?php echo $list[$i]['target']?>">
