...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($_SESSION['ss_mb_id']=="lets080") { ?><?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">등록하기</a></li><?php } ?><? } ?>
        </ul>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl">
        <option value="wr_4"<?php echo get_selected($sfl, 'wr_4'); ?>>매장명</option>
