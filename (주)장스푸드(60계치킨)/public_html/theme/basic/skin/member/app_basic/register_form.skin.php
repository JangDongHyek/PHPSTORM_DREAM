...
<?php if(!$w == ""){ ?>
    <style>
        #join_info label {font-size: 0.9em; padding-left: 10px; margin-bottom: 5px; display: block;}
        .box-article.btn_flex{display: flex; align-items: center; justify-content: center;}
        .box-article.btn_flex a{display:block; margin:10px; background:#221A18; border:0; width:calc(100% - 20px); padding:10px 0 10px 0; border-radius:0px; font-size:1.4em;}
    </style>
<?php } ?>
<div class="mbskin form">
	...
	<article class="box-article">
		...
		<h2>회원 정보 입력</h2>
            <div class="box-body">
                <dl class="row">
                    ...
                    <!--<dd class="exp">영문 소문자, 숫자로만 입력가능합니다.</dd>-->
                ...
                <dl class="row">
                    ...
                    <dd class="status_ico"><i class="fas fa-check"></i></dd>
                    <dd class="error"></dd>
                    <dd><a class="btn btn_gray">휴대폰인증</a></dd>
                </dl>
            ...
            <div class="box-body chk">
                <dl class="row agree-row">
                    <dd data-for="reg_req1">
                        <p><input type="checkbox" name="reg_req[]" id="reg_req1" value="0" onclick="ag_check(this)">
                            <label for="reg_req1">이용약관 동의<span>(필수)</span></label></p>
                        <input type="button" value="내용보기" class="btn btn_line btn-agr">
                    </dd>
                ...
                <dl class="row agree-row">
                    <dd data-for="reg_req2">
                        <p><input type="checkbox" name="reg_req[]" id="reg_req2" value="0" onclick="ag_check(this)">
                            <label for="reg_req2">개인정보처리방침 동의<span>(필수)</span></label></p>
                        <input type="button" value="내용보기" class="btn btn_line btn-agr">
                    </dd>
        ...
        <div class="ft_btn">
		    <input type="submit" class="btn_submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" accesskey="s">
            <a href="<?php echo G5_URL ?>" class="btn_cancel">회원탈퇴</a>
        </div>
	</article>
    </form>
</div>
...
$(function (){
	...
	$("#reg_mb_id").keyup(function (){
		...
		if (regId.test(mb_id)){ 
			...
			$(this).parents(".row").find(".error").addClass("on").html("영문 소문자와 숫자, 4 ~ 12자리까지 입력가능합니다.");
