...
?>
<style>
    html, body{width:100%;height:100%;min-height:500px;background:url(<?php echo $member_skin_url ?>/img/bg.jpg) no-repeat #E3E3E3 50% 50%/cover; overflow-y:hidden; overflow-x:hidden;}
</style>
