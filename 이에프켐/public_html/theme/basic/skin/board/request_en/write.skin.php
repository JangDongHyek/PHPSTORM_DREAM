...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
				<tr>
					<th colspan="2" align="center" class="top">
						<input type="radio" name="wr_1" value="견적/샘플요청" <? echo $write[wr_1]=="견적/샘플요청"||$w==""?" checked":"";?>>견적/샘플요청&nbsp;&nbsp;&nbsp;
						<input type="radio" name="wr_1" value="제품/기술문의" <? echo $write[wr_1]=="제품/기술문의"?" checked":"";?>>제품/기술문의&nbsp;&nbsp;&nbsp;
						<input type="radio" name="wr_1" value="파트너쉽 문의" <? echo $write[wr_1]=="파트너쉽 문의"?" checked":"";?>>파트너쉽 문의
					</th>
				</tr>
        <tr>
            ...
            <td><input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="frm_input required" size="10" maxlength="20"></td>
				...
				<tr>
            <th scope="row"><label for="wr_2">Tel</label></th>
            ...
            <td><input type="email" name="wr_email" value="<?php echo $email ?>" id="wr_email" class="frm_input email"></td>
				...
				<tr>
            <th scope="row"><label for="wr_5">Product</label></th>
            <td>
							<select name="wr_5">
				...
				<tr>
            <th scope="row"><label for="wr_4">Quantity</label></th>
        ...
        <tr>
            <th scope="row"><label for="wr_7">Etc</label></th>
