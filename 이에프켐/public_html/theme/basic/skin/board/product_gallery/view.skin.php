...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div class="clearfix" style="background:#eff4ee; padding:30px; border:0px">
            ...
            <div class="col-md-6">
               		<p class="t5 t_margin40"><?=$view['wr_1']?></p> <!-- 제품카테고리 -->
					...
					<!--<p class="t5 t_margin20">색상&nbsp;&nbsp;&nbsp;&nbsp;<span>|</span>&nbsp;&nbsp;&nbsp;&nbsp;<?=$view['wr_2']?></p> --><!-- 제품색상 -->
                    <p class="wow bounceIn" data-wow-delay="0.2s" style="width:100%; border-bottom:1px solid #b6c3cb; margin:0px auto">&nbsp;</p>
                    <p class="t4" style="padding:15px 0 0">제품용도</p>
					<p class="t6" style="padding:15px 0 0"><?=$view['wr_text1']?></p> <!-- 간략설명 -->
                    <p class="wow bounceIn" data-wow-delay="0.4s" style="width:100%; border-bottom:1px solid #b6c3cb; margin:0px auto">&nbsp;</p>
                    <!--<div class="clearfix t_margin30 wow bounceIn" data-wow-delay="0.6s"><a href="../bbs/write.php?bo_table=b_estimate" class="btn_req">Request</a></div>-->
					<!--<p class="t9 t_margin20"><?=$view['wr_3']?><span>원</span></p> --><!-- 제품가격 -->
            </div>
        </div>

        <!-- 본문 내용 시작 { -->
        <div style="padding:20px 0"><?php echo get_view_thumbnail($view['content']); ?></div>
        <!--<div class="wrapper">
	    <div class="tabs cf">
		...
		<div id="tab-content1" class="tab-content"><?php echo get_view_thumbnail($view['content']); ?></div>
		<div id="tab-content2" class="tab-content"><?php echo get_view_thumbnail($view['wr_text2']); ?></div>
		<div id="tab-content3" class="tab-content"><?php echo get_view_thumbnail($view['wr_text3']); ?></div>
	    </div>
        </div>-->
