...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl">
		...
		<option value="wr_text1"<?php echo get_selected($sfl, 'wr_text1', true); ?>>제품용도</option>
		<option value="wr_content"<?php echo get_selected($sfl, 'wr_content', true); ?>>제품설명</option>
		<? /*
