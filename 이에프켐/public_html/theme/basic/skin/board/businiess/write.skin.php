...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php if ($is_name) { ?>
        <tr>
            <th scope="row"><label for="wr_name">회사명 <span class="en">Company Name</span><strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="frm_input required" size="10" maxlength="20"></td>
        </tr>
        <?php } ?>
				 <tr>
            <th scope="row"><label for="wr_1">휴대폰번호 <span class="en">Tel</span><strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_1" value="<?php echo $write[wr_1] ?>" id="wr_2" required class="frm_input required" size="10" maxlength="20"></td>
        </tr>

        <?php if ($is_password) { ?>
        <tr>
            <th scope="row"><label for="wr_password">비밀번호 <span class="en">Password</span><strong class="sound_only">필수</strong></label></th>
        ...
        <?php if ($option) { ?>
        <tr>
            <th scope="row">옵션 <span class="en">Option</span></th>
        ...
        <?php if ($is_category) { ?>
        <tr>
            <th scope="row"><label for="ca_name">분류 <span class="en">Group</span><strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="wr_link<?php echo $i ?>">링크 # <?php echo $i ?> <span class="en">Link</span></label></th>
        ...
        <tr>
            <th scope="row">파일 # <?php echo $i+1 ?> <span class="en">File</span></th>
            <td>
        ...
        <tr>
            <th scope="row">자동등록방지 <span class="en">Automatic registration prevention</span></th>
            <td>
    ...
    <div class="btn_confirm">
        ...
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_cancel">Cancel 취소</a>
				<? if($is_admin){?>
