...
?>
<style>
#gr_id {width: 0; height: 0; opacity: 0; position: absolute; top: -9999px;}
select {height: 22px;}
</style>
...
<fieldset id="sch_res_detail" style="padding: 10px 0;">
    <legend>상세검색</legend>
    ...
    <select name="sfl" id="sfl">
        <option value="wr_subject||wr_content||wr_text1"<?php echo get_selected($_GET['sfl'], "wr_subject||wr_content||wr_text1") ?>>전체</option>
        <option value="wr_subject"<?php echo get_selected($_GET['sfl'], "wr_subject") ?>>제품명</option>
		<option value="wr_text1"<?php echo get_selected($_GET['sfl'], "wr_text1") ?>>제품용도</option>
        <option value="wr_content"<?php echo get_selected($_GET['sfl'], "wr_content") ?>>제품설명</option>
		<!--
